[![Supabase Logo](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--light.daaeffd3.png&w=256&q=75&dpl=dpl_HhCTK4WGReW2ZvVRyjDwvVHhJQDx)![Supabase Logo](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--dark.b36ebb5f.png&w=256&q=75&dpl=dpl_HhCTK4WGReW2ZvVRyjDwvVHhJQDx)](https://supabase.io/)
...
2\. Access and Use.[#](#2-access-and-use)
-----------------------------------------

### 1\. Provision of Access.[#](#1-provision-of-access)
...
### 2\. Documentation License.[#](#2-documentation-license)
...
### 3\. Use Restrictions.[#](#3-use-restrictions)
...
### 4\. Reservation of Rights.[#](#4-reservation-of-rights)
...
### 6\. Aggregated Data.[#](#6-aggregated-data)
...
3\. Customer Responsibilities.[#](#3-customer-responsibilities)
---------------------------------------------------------------
...
### 2\. Third-Party Products.[#](#2-third-party-products)
...
### 3\. Customer Control and Responsibility.[#](#3-customer-control-and-responsibility)
...
5\. Fees and Taxes.[#](#5-fees-and-taxes)
-----------------------------------------
...
### 3\. Return of Materials; Effects of Termination/Expiration.[#](#3-return-of-materials-effects-of-terminationexpiration)
...
7\. Personal Information.[#](#7-personal-information)
-----------------------------------------------------
...
8\. Intellectual Property Ownership; Feedback.[#](#8-intellectual-property-ownership-feedback)
----------------------------------------------------------------------------------------------

### 1\. Supabase IP.[#](#1-supabase-ip)
...
### 2\. Customer Data.[#](#2-customer-data)
...
9\. Warranty Disclaimer.[#](#9-warranty-disclaimer)
---------------------------------------------------
...
### 1\. Supabase Indemnification.[#](#1-supabase-indemnification)
...
### 2\. Customer Indemnification.[#](#2-customer-indemnification)
...
11\. Limitations of Liability.[#](#11-limitations-of-liability)
---------------------------------------------------------------
...
12\. Subscription Period and Termination.[#](#12-subscription-period-and-termination)
-------------------------------------------------------------------------------------

### 1\. Subscription Period.[#](#1-subscription-period)
...
### 3\. Effect of Expiration or Termination.[#](#3-effect-of-expiration-or-termination)
...
### 3\. Force Majeure.[#](#3-force-majeure)
...
### 4\. Amendment and Modification.[#](#4-amendment-and-modification)
...
### 7\. Governing Law; Submission to Jurisdiction.[#](#7-governing-law-submission-to-jurisdiction)
...
### 9\. Export Regulation.[#](#9-export-regulation)
...
### 10\. US Government Rights.[#](#10-us-government-rights)
...
### 11\. Equitable Relief.[#](#11-equitable-relief)
...
[![Supabase Logo](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--light.daaeffd3.png&w=384&q=75&dpl=dpl_HhCTK4WGReW2ZvVRyjDwvVHhJQDx)![Supabase Logo](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--dark.b36ebb5f.png&w=384&q=75&dpl=dpl_HhCTK4WGReW2ZvVRyjDwvVHhJQDx)](https://supabase.io/)
...
* [Acceptable Use Policy](https://supabase.io/aup)
