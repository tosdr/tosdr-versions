...
_Last Modified: 22 May 2024_

Previous Version: [10 May 2024](https://supabase.io/privacy-240510)
...
| **How we may use the Personal Information** | **Legal Bases for Processing** | **Recipients of Personal Information** |
| --- | --- | --- |
| We use this information to process your orders through the Service. | The processing is necessary for the performance of a contract. | We may share this information with the following service providers through the provision of the Service: Stripe, Tableau, PandaDoc, Hubspot, and Amazon Web Services. |
