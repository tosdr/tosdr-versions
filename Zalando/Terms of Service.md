...
* [Cyber Weekend](https://www.zalando.nl/outlet/)
* [Nieuw](#)
...
Zalando biedt een inruiloptie voor ongedragen en tweedehands kleding die zo goed als nieuw is (‘pre-owned fashion’). Alle pre-owned fashion-artikelen moeten voldoen aan de [Inruilvoorwaarden](https://www.zalando.nl/faq/what-pre-owned-items-are-eligible-for-resale.html) van Zalando.  
...
2.10. Als u gebruikmaakt van de optie een Zalando-cadeaubon te ontvangen, zal Zalando deze per e-mail en in uw klantenaccount beschikbaar stellen. Zalando behoudt zich het recht voor om in de toekomst de wijze waarop de cadeaubon worden overhandigd, te wijzigen. Zalando zal u hierover vooraf informeren. De Zalando-cadeaubon kan op [www.zalando.nl](https://www.zalando.nl/) worden ingewisseld, is overdraagbaar en onbeperkt geldig. Overige voorwaarden vindt u [hier](https://www.zalando.nl/faq/what-can-i-use-my-gift-card-for.html). De aanspraak op compensatie wordt vervuld zodra de Zalando-cadeaubon is verstrekt.  
