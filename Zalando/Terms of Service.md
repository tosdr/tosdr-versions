...
* [Streetwear](https://www.zalando.nl/heren-sneaker-trends/)
* [Accessoires](https://www.zalando.nl/accessoires/)
* [Designer & luxe](https://www.zalando.nl/premium-dames-home/)
...
**  
De Algemene Voorwaarden geven u een overzicht van onze prestaties op Zalando.de. Ons  
aanbod richt zich uitsluitend op consumenten die de aankoop doen voor privédoeleinden. Wij bieden u een gepersonaliseerde shopping- en service-ervaring voor artikelen van Zalando, van Zalando Partners, en Zalando pre-owned artikelen Artikelen van Zalando-partners worden als zodanig gelabeld en zijn afkomstig van commerciële handelaars, terwijl Zalando pre-owned artikelen gebruikt zijn en ook speciaal worden gelabeld.

1\. Over de overeenkomst: Door een bestelling op de website van Zalando te plaatsen, verklaart u dat u uitsluitend voor privédoeleinden handelt. Uw contractpartner is Zalando SE of de respectieve Zalando Partner, afhankelijk van het soort producten dat u bestelt. De overeenkomst wordt werkzaam door te klikken op de knop Bestel nu! en de ontvangst van de bestelbevestiging. We behouden ons het recht voor om bestellingen te weigeren of te annuleren, die zijn aangemaakt door automatische programma’s of diensten van derden.  
2\. Over prijzen, verzendkosten en levervoorwaarden: De prijzen die worden vermeld op het moment van de bestelling zijn eindprijzen, met inbegrip van de toepasselijke btw. De verzendkosten worden overgenomen door Zalando, tenzij er bij de bestelling specifieke verzendmethodes zijn geselecteerd, zoals expreslevering. Daarnaast kunnen er voor bestellingen onder de minimumbestelwaarde verzendkosten in rekening worden gebracht. U wordt over het bedrag geïnformeerd voordat u een bestelling plaatst en ontvangt meer informatie hierover in de uitgebreide AV.  
3\. Over de verschillende betaalmethoden: Er worden verschillende betaalmethoden aangeboden, bijvoorbeeld vooruitbetaling, creditcard, factuur of PayPal. De betaalmethoden die mogelijk zijn op het tijdstip van bestelling kunnen variëren. Voordat u een bestelling plaatst, wordt u geïnformeerd over de aangeboden betaalmethoden.  
...
Op onze website bieden we u de mogelijkheid om bij ons producten of overige inhoud te melden die volgens u in strijd zijn met de toepasselijke wetgeving of onze gebruiksvoorwaarden (melding). We zullen deze meldingen controleren en u informeren over het resultaat. Als wij beslissen om geen maatregelen te nemen, hebt u de mogelijkheid om deze beslissing te laten herzien (klacht). Bovendien hebt u de mogelijkheden van buitengerechtelijke geschillenbeslechting en de normale gerechtelijke weg.

Bij misbruik van dit mechanisme zullen wij de verwerking van meldingen en klachten tijdelijk of blijvend stopzetten. Er is sprake van misbruik als u vaak duidelijk ongegronde meldingen of bezwaren indient. Bij de beoordeling van het misbruik en bij de beslissing of en eventueel hoelang wij de verwerking van meldingen en klachten stopzetten, zullen wij rekening houden met alle feiten en omstandigheden die bij ons bekend zijn. Dit omvat het absolute aantal duidelijk ongegronde meldingen of bezwaren, het relatieve aandeel ongegronde meldingen en bezwaren in hun totale aantal, de ernst van het misbruik en, als dit vast kan worden gesteld, de beoogde bedoelingen van de melder.

Voordat we de verwerking van meldingen en klachten onderbreken, geven we een waarschuwing. Hierin wordt u ook geïnformeerd over de duur van een mogelijke onderbreking.
...
Deel I - ALGEMENE EN AANVULLENDE VOORWAARDEN
--------------------------------------------
...
c) bij overeenkomsten voor regelmatige levering van producten gedurende een bepaalde periode: de dag waarop de consument, of een door hem aangewezen derde, het eerste product heeft ontvangen.Bij levering van diensten en digitale inhoud die niet op een materiële drager is geleverd:  
...
4\. Een klacht over een product, dienst of de service van de ondernemer kan eveneens worden ingediend via een klachtenformulier op de consumentenpagina van de website van de Nederlandse Thuiswinkel Organisatie [www.thuiswinkel.org](https://www.thuiswinkel.org/). De klacht wordt dan zowel naar de betreffende ondernemer als naar de Nederlandse Thuiswinkel Organisatie gestuurd.  
5\. De consument dient de ondernemer in ieder geval 4 weken de tijd te geven om de klacht in onderling overleg op te lossen. Na deze termijn ontstaat een geschil dat vatbaar is voor de geschillenregeling.

**Artikel 17 - Geschillen**

1\. Op overeenkomsten tussen de ondernemer en de consument waarop deze algemene voorwaarden betrekking hebben, is uitsluitend Nederlands recht van toepassing.  
2\. Geschillen tussen de consument en de ondernemer over de totstandkoming of uitvoering van overeenkomsten met betrekking tot door deze ondernemer te leveren of geleverde producten en diensten, kunnen, met inachtneming van het hierna bepaalde, zowel door de consument als de ondernemer worden voorgelegd aan de Geschillencommissie Thuiswinkel, Postbus 90600, 2509 LP te Den Haag ([www.sgc.nl](https://www.degeschillencommissie.nl/consumenten/)).  
...
**Bijlage I: Modelformulier voor herroeping**[Modelformulier voor herroeping](https://mosaic03.ztat.net/seo/pdf/2010-12-22%20modelformulier_voor_herroeping.pdf)  
(dit formulier alleen invullen en terugzenden wanneer u de overeenkomst wilt herroepen)  
\- Aan: Zalando SE, Valeska-Gert-Straße 5, 10243 Berlijn, Duitsland, fax: +49 (0)30 2759 46 93, e-mail: [herroeping@zalando.nl](mailto:herroeping@zalando.nl)  
...
1.2 Overeenkomsten via [www.zalando.nl](https://www.zalando.nl/) worden uitsluitend in de Nederlandse taal afgesloten. Bij de bestelling van Zalando-artikelen is uw contractspartij Zalando SE, Valeska-Gert-Straße 5, 10243 Berlin (Duitsland). Wanneer u Zalando-partnerartikelen bestelt, hebt u, afhankelijk van het product dat je selecteert, ofwel een exclusief contract met de respectieve Zalando-partner of met beide, Zalando SE en de respectieve Zalando-partner samen (gezamenlijke verkoper).Informatie over de respectieve contractuele relatie wordt weergegeven op elke pagina met productdetails. De betreffende Zalando-partner is niet aangesloten bij de Nederlandse Thuiswinkel Organisatie.  
1.3 Door het aanklikken van de knop “Nu kopen” plaatst u een bindende bestelling ten aanzien van de artikelen in uw winkelwagentje. De ontvangst van uw bestelling bevestigen wij u direct na het versturen van uw bestelling door middel van een e-mail. Een bindende koopovereenkomst komt met ontvangst van de bestelbevestiging tot stand. Houdt u er rekening mee, dat de levering van het bestelde product bij vooruitbetaling (reservering) pas na creditering van het volledige bedrag, inclusief verzendkosten op onze rekening plaatsvindt. In verband daarmee verzoeken wij u om de overboeking van de koopprijs onmiddellijk na ontvangst van de bestelbevestiging, maar in ieder geval binnen 7 dagen na ontvangst van de bestelbevestiging uit te voeren.  
1.4 U stemt in met de overdracht van de vorderingen van de verkoper tot betaling van de aankoopprijs aan derden, in het bijzonder aan Zalando Payments GmbH.  
...
1.7 Wij behouden het recht een bestelling niet te aanvaarden of de bestelling te annuleren als deze is geplaatst door het gebruik van software, een robot, crawler, spider of een geautomatiseerd systeem of gescript gedrag en het gebruik van externe diensten om een opdracht namens u te plaatsen.
...
2.2 Voor bestellingen ter waarde van € 25,00 of hoger is de levering gratis. Voor  
bestellingen van minder dan € 25,00 worden leveringskosten ter hoogte van € 3,95  
inclusief btw in rekening gebracht. De vergoeding heeft betrekking op kosten die  
voortvloeien uit de omvang van de bestelling, onder meer verzending, afhandeling en andere  
diensten. De kosten nemen toe en worden geheven door Zalando.  
...
2.4 Afhankelijk van waar uw artikel vandaan wordt verzonden, kunnen verzendkosten over lange afstanden van € 3,95 inclusief btw van toepassing zijn. Voordat uw bestelling wordt geplaatst, zullen wij u ervan op de hoogte stellen of verzendkosten over lange afstanden van toepassing zijn op het door u geselecteerde artikel. De verzendkosten over lange afstanden worden door ons berekend. Als u besluit om een artikel te retourneren waarvoor deze kosten in rekening zijn gebracht, zullen wij deze kosten aan u terugbetalen. Wij mogen wachten met terugbetaling tot wij de goederen hebben teruggekregen, of u heeft aangetoond dat u de goederen heeft teruggezonden, al naar gelang welk tijdstip eerst valt.
...
**5\. VOORWAARDEN VOOR ZALANDO CADEAUBONNEN**

5.1 Zalando cadeaubonnen worden uitgegeven door Zalando Payments GmbH. Zalando Payments GmbH is een instelling voor elektronisch geld met vergunning in Duitsland. **Maar Zalando cadeaubonnen zijn geen elektronisch geld.**  
De Zalando cadeaubonnen zijn geen elektronisch geld maar niet-gereguleerde opgeslagen waarde. Dit betekent dat Zalando cadeaubonnen niet onder toezicht staan van de bevoegde toezichthoudende autoriteit en de wettelijke bescherming voor elektronisch geld niet van toepassing is. U hebt niet het recht om ze in te wisselen voor contant geld.  
5.2 Zalando cadeaubonnen kunnen worden ingewisseld op [www.zalando.nl](https://www.zalando.nl/) en op de Zalando-app voor de aankoop voor producten die in aanmerking komen en die worden aangeboden door Zalando SE of andere verkopers (Zalando partners). Goederen en diensten die in aanmerking komen, zijn producten bedoeld voor het uiterlijk van iemand (bijv. kleding, schoenen). Meer informatie vindt u [hier](https://www.zalando.nl/faq/Kortingscodes-and-cadeaubonnen/what-items-can-i-purchase-with-my-gift-card.html). Een Zalando cadeaubon kan niet worden gebruikt om een andere Zalando cadeaubon te kopen.  
5.3 Zalando cadeaubonnen zijn geldig voor een periode van 5 jaar vanaf de aankoopdatum. Inwisselen in contant geld of restitutie in het geval van verlies of schade is niet mogelijk.  
5.4 Zalando cadeaubonnen zijn beperkt tot een maximumwaarde van € 200,- per Zalando cadeaubon en een maximumwaarde van € 200,- aan Zalando cadeaubonnen per aankoop. Het is mogelijk om per aankoop verschillende Zalando cadeaubonnen te kopen met een maximumwaarde van € 200,- in totaal. Een resterend bedrag op uw Zalando cadeaubon kan worden gebruikt voor toekomstige aankopen. De maximumwaarde van Zalando cadeaubonnen die kan worden gebruikt is € 5000,- per kalendermaand. De maximumwaarde van cadeaubonnen die kan worden gekoppeld aan uw klantenaccount is € 5000,- per kalendermaand.  
5.5 De Zalando cadeaubon wordt meestal binnen 24 uur na aankoop geactiveerd.  
5.6 Zalando cadeaubonnen kunnen alleen vóór uw bestelling worden gebruikt en niet met terugwerkende kracht.  
5.7 Als u uw bestelling annuleert of goederen retourneert waarvoor u een Zalando cadeaubon hebt ingewisseld, wordt het betaalde bedrag teruggestort op uw Zalando cadeaubon en beschikbaar gesteld voor toekomstige aankopen. Als u goederen retourneert waarvoor u gedeeltelijk hebt betaald met een Zalando cadeaubon, wordt de aankoopprijs van alle goederen die u houdt en die in aanmerking kwamen voor aankoop met een Zalando cadeaubon eerst betaald door de Zalando cadeaubon in te wisselen. Het resterende restitutiebedrag wordt terugbetaald via de andere betaalmethode waarvan u gebruik hebt gemaakt.
...
Als u de overeenkomst met Zalando wenst te herroepen kunt u gebruik maken van [dit formulier](https://www.thuiswinkel.org/data/uploads/reglementen/Modelformulier_voor_herroeping.docx). Dit kunt u dan bij de retourzending voegen of ons toesturen.
...
vooraf willen we u informeren dat u in geval van het retourneren van goederen het bij uw bestelling bijgevoegde retouretiket kunt gebruiken. Indien u een nieuw retouretiket nodig heeft, kunt deze via de klantenservice (contactgegevens, zie hieronder) opvragen. Wij verzoeken u vriendelijk ons te helpen om onnodige kosten te vermijden en de goederen niet zonder retouretiket te retourneren.  
HERROEPINGSRECHT:  
U heeft het recht om binnen een termijn van 14 dagen zonder opgave van redenen de overeenkomst te herroepen. De herroepingstermijn verstrijkt 14 dagen na de 1. dag, waarop u of een door u aangewezen derde, die niet de vervoerder is, het laatste product fysiek in bezit krijgt. Om het herroepingsrecht uit te oefenen, moet u Zalando SE, Valeska-Gert-Straße 5, 10243 Berlijn, Duitsland, fax: +49 (0)30 2759 46 93, Telefoon: 08000227087, e-mail: herroeping@zalando.nl, of de betreffende Zalando-partner via een ondubbelzinnige verklaring (bv. schriftelijk per post, fax of e-mail) op de hoogte stellen van uw beslissing de overeenkomst te herroepen. U kunt hiervoor gebruikmaken van het bijgevoegde modelformulier voor herroeping, maar bent hiertoe niet verplicht. De respectieve contactgegevens zijn ook te vinden op elke productdetailpagina, door op de naam van de partner te klikken en omlaag te scrollen naar de herroepingsinformatie in het pop-upvenster dat op de pagina wordt weergegeven. Daarnaast vindt u contactinformatie omtrent de Zalando-partner in de informatie ten aanzien van het herroepingsrecht welke wij u in bestelbevestiging als pdf hebben gestuurd. U kunt het modelformulier of een andere ondubbelzinnige verklaring ook via het contactformulier op onze website digitaal invullen en versturen. Indien u van deze mogelijkheid gebruik maakt, ontvangt u van onz direct (bijv. per e-mail) een ontvangstbevestiging. Om de herroepingstermijn na te leven volstaat het om uw mededeling betreffende uw uitoefening van het herroepingsrecht te verzenden voordat de herroepingstermijn is verstreken.Gevolgen van het herroepingsrecht Als u de overeenkomst herroept, ontvangt u alle betalingen die u tot op dat moment heeft gedaan, inclusief leveringskosten (met uitzondering van eventuele extra kosten ten gevolge van uw keuze voor een andere wijze van levering dan de door ons geboden goedkoopste standaard levering) onverwijld en in ieder geval niet later dan 14 dagen nadat wij op de hoogte zijn gesteld van uw beslissing de overeenkomst te herroepen, van ons terug. Wij betalen u terug met hetzelfde betaalmiddel als waarmee u de oorspronkelijke transactie heeft verricht, tenzij u uitdrukkelijk anderszins heeft ingestemd; in ieder geval zullen u voor zulke terugbetaling geen kosten in rekening worden gebracht. Wij mogen wachten met terugbetaling tot wij de goederen hebben teruggekregen, of u heeft aangetoond dat u de goederen heeft teruggezonden, al naar gelang welk tijdstip eerst valt. U dient de goederen onverwijld, doch in ieder geval niet later dan 14 dagen na de dag waarop u het besluit de overeenkomst te herroepen aan ons heeft medegedeeld, aan de Zalando-partner terug te zenden of te overhandigen. Informatie over de identiteit van de betreffende Zalando-partner, inclusief contactgegevens is op de van toepassing zijnde artikelpagina verlinkt. Daarnaast vindt u contactinformatie omtrent de Zalando-partner in de informatie ten aanzien van het herroepingsrecht welke wij u in bestelbevestiging als pdf hebben gestuurd. U bent op tijd als u de goederen terugstuurt voordat de termijn van 14 dagen is verstreken. Wij dragen de kosten van de retourzending als u het retouretiket gebruikt dat wij ter beschikking stellen. Indien u dat niet gebruikt, dient u kosten voor de verzending te betalen. U bent alleen aansprakelijk voor de waardevermindering van de goederen die het gevolg is van het gebruik van de goederen, dat verder gaat dan nodig is om de aard, de kenmerken en de werking van de goederen vast te stellen.Modelformulier voor herroeping (Dit formulier alleen invullen en terugzenden als u de overeenkomst wilt herroepen)  
...
— Adres consument(en)  
— Datum (\*) Doorhalen wat niet van toepassing is.  
Als u de overeenkomst met Zalando wenst te herroepen kunt u gebruik maken van d[it formulier](https://www.thuiswinkel.org/data/uploads/reglementen/Modelformulier_voor_herroeping.docx). Dit kunt u dan bij de retourzending voegen of ons toesturen.  
...
8.4 In geval van een retourzending van Zalando-partner-artikelen kunt u het bij uw bestelling bijgevoegde retouretiket gebruiken. Overigens vindt u de contactgegevens van de betreffende Zalando-partner op de betreffende artikelpagina verlinkt; daarnaast vindt u de contactgegevens in de informatie ten aanzien van het herroepingsrecht welke wij u met de bestelbevestiging als pfd hebben gestuurd.  
...
De klantendienst kan worden gecontacteerd via onze [FAQs](https://www.zalando.nl/faq/). De klantendienst is bereikbaar via chat, messenger, telefoon en het [contactformulier](https://www.zalando.nl/contact/).
...
12.6 Indien u niet tevreden bent met de afhandeling van uw klacht dan kunt u deze ook voorleggen aan de Geschillencommissie Thuiswinkel (www.sgc.nl) of aan deze Geschillencommissie via het [Europees ODR Platform](https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home.chooseLanguage).  
12.7 In de aanbevelingssystemen laten we je artikelen zien waarvan wij denken dat je ze wellicht leuk vindt. Dit doen we om het zoeken gemakkelijker te maken. Hiertoe gebruiken we diverse parameters, om zo aanbevelingen te kunnen geven die zo goed mogelijk bij je passen. De belangrijkste van deze parameters zijn onder meer het land, de filter- en sorteringselectie, evenals favoriete maten en de populariteit van artikelen zoals voorkeuren, aankopen en browseractiviteiten. De parameters die de weergave van producten op de cataloguspagina beduidend beïnvloeden zijn: 1. de populariteit, 2. het moment van invoering van het artikel, 3. actuele verkoopcampagnes en 4. de prijs. De betreffende parameters voor een persoonlijk aanbevelingssysteem zijn toegankelijk via het "info-i"-symbool bij het aanbevelingssysteem, bijvoorbeeld op de cataloguspagina. Via de volgende link is meer informatie te vinden over de door ons gebruikte profielinformatie en de mogelijkheid om het gebruik ervan voor aanbevelingssystemen op het volledige platform te beïnvloeden: [https://www.zalando.nl/myaccount/recommendation-preferences/](https://protect-eu.mimecast.com/s/hRtRCNxZnfpQDV8Im8Mh_/).  
...
Zalando biedt een inruiloptie voor ongedragen en tweedehands kleding die zo goed als nieuw is (‘pre-owned fashion’). Alle pre-owned fashion-artikelen moeten voldoen aan de [Inruilvoorwaarden](https://www.zalando.nl/faq/Pre-owned/Wat-zijn-de-voorwaarden-voor-het-inruilen-van-mijn-items.html?type=non_order_related) van Zalando.  
1\. Toepassingsgebied, verhouding tot andere algemene voorwaarden  
1.1. De inruiloptie is een aanbod van Zalando SE; meer informatie vindt u in [ons](https://www.zalando.nl/zalando-colofon/).  
1.2. Deze voorwaarden gelden uitsluitend voor het inleveren van pre-owned fashion-artikelen aan Zalando in ruil voor vergoeding. Voor de aankoop van artikelen van Zalando en artikelen van partners alsook voor onze overige diensten gelden daarnaast onze [Algemene voowaarden](https://mosaic02.ztat.net/cnt/contentful-apps/uploads/9632e528-de61-4308-ba15-e3bf113e9d6d.pdf) voor bestellingen via [www.zalando.nl](https://www.zalando.nl/)\>.  
...
2.10. Als u gebruikmaakt van de optie een Zalando-cadeaubon te ontvangen, zal Zalando deze per e-mail en in uw klantenaccount beschikbaar stellen. Zalando behoudt zich het recht voor om in de toekomst de wijze waarop de cadeaubon worden overhandigd, te wijzigen. Zalando zal u hierover vooraf informeren. De Zalando-cadeaubon kan op [www.zalando.nl](https://www.zalando.nl/) worden ingewisseld, is overdraagbaar en onbeperkt geldig. Overige voorwaarden vindt u [hier](https://www.zalando.nl/faq/Kortingscodes-and-cadeaubonnen/Voorwaarden-kortingscode-of-cadeaubon.html). De aanspraak op compensatie wordt vervuld zodra de Zalando-cadeaubon is verstrekt.  
...
7.2.  Geschillen tussen u en Zalando over de totstandkoming of uitvoering van overeenkomsten met betrekking tot door Zalando te leveren of geleverde producten en diensten, kunnen, met inachtneming van het hierna bepaalde, zowel door u als door Zalando worden voorgelegd aan de Geschillencommissie Thuiswinkel, Postbus 90600, 2509 LP te Den Haag ([www.sgc.nl](http://www.sgc.nl/)).  
...
[Meer informatie (hiervoor moet je zijn ingelogd)](https://www.zalando.nl/messages)

Mijn inschrijving bevestigen

Bekijk ons [privacybeleid](https://www.zalando.nl/zalando-privacy-policy#chapter-06) voor meer informatie over hoe wij jouw gegevens verwerken. Je kan je op elk moment kosteloos [uitschrijven](https://www.zalando.nl/faq/My-Account/How-do-I-unsubscribe-from-the-Zalando-newsletter.html).

_help_Hulp & ContactHulp & Contact
...
* [Terugbetaling](https://www.zalando.nl/faq/Retour-and-Terugbetaling/Terugbetaling.html)
* [Verzenden](https://www.zalando.nl/faq/Bestellen/Wat-is-de-levertijd.html)
* [Retourneren](https://www.zalando.nl/faq/Retour-and-Terugbetaling)
* [Betalen op rekening](https://www.zalando.nl/faq/Betalen/Hoe-betaal-ik-op-rekening.html)
* [Wachtwoord wijzigen](https://www.zalando.nl/faq/Mijn-account/Wachtwoord-wijzigen.html)
...
* [Cadeaubon inwisselen](https://www.zalando.nl/faq/Kortingscodes-and-cadeaubonnen/Cadeaubon-verzilveren.html)
* [Kortingscode inwisselen](https://www.zalando.nl/faq/Kortingscodes-and-cadeaubonnen/Kortingscode-inwisselen.html)
* [Voorwaarden kortingscode](https://www.zalando.nl/faq/Kortingscodes-and-cadeaubonnen/Voorwaarden-kortingscode-of-cadeaubon.html)
...
* [Tech Blog](https://jobs.zalando.com/en/tech/blog/)
...
* [](https://www.zalando.nl/faq/Betalen/Betalen-met-creditcard.html)
* [](https://www.zalando.nl/faq/Betalen/Betalen-met-creditcard.html)
* [_paypal_](https://www.zalando.nl/faq/Betalen/Betalen-met-PayPal.html)
* [](https://www.zalando.nl/faq/Betalen/Betalen-met-iDEAL.html)
* [_rekening_](https://www.zalando.nl/faq/Betalen/Hoe-betaal-ik-op-rekening.html)
* [](https://www.zalando.nl/faq/Betalen/Betalen-met-creditcard.html)
...
* [Gratis standaard verzending vanaf €25,-](https://www.zalando.nl/faq/Verzending-and-Levering/Zijn-er-verzend-en-retourkosten.html)
* [100 dagen retourrecht](https://www.zalando.nl/faq/Retour-and-Terugbetaling/Voorwaarden-retourneren.html)
* [Gratis retour](https://www.zalando.nl/faq/Retour-and-Terugbetaling/Hoe-stuur-ik-een-artikel-retour.html)
...
* [__Thuiswinkelwaarborg__](https://www.thuiswinkel.org/leden/zalando.nl/certificaat)

* [Tech blog](https://engineering.zalando.com/)
* [Colofon](https://www.zalando.nl/zalando-colofon/)
* [Algemene Voorwaarden](https://www.zalando.nl/zalando-algemene-voorwaarden/)
* [Privacyverklaring](https://www.zalando.nl/zalando-privacy-statement/)
* [Data-instellingen](#uc-central-modal-show)

Zalando app
-----------

![QR Code Download App](https://mosaic02.ztat.net/rnd/ng/app-qr-code/app-qr.png)

* [_appstore nl_](https://apps.apple.com/nl/app/zalando-kleding-en-schoenen/id585629514)
* [_playstore nl_](https://play.google.com/store/apps/details?id=de.zalando.mobile&hl=nl-NL)

Meer inspiratie:
----------------

* [_instagram_](https://instagram.com/zalando "Instagram")
* [_facebook_](https://www.facebook.com/Zalando.be/ "Facebook")
* [_youtube_](https://www.youtube.com/user/ZalandoTV "Youtube")
* [_pinterest_](https://nl.pinterest.com/zalando/ "Pinterest")