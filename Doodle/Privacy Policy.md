...
* [Contact](https://help.doodle.com/hc/en-us/requests/new)
...
* [Privacy Policies](https://doodle.com/en/privacy-policy/)
    * [Your data at Doodle](https://doodle.com/en/privacy-policy/#your-data-at-doodle)
    * [Log data](https://doodle.com/en/privacy-policy/#log-data)
    * [Cookies](https://doodle.com/en/privacy-policy/#cookies)
    * [Advertising](https://doodle.com/en/privacy-policy/#advertising)
    * [Social Login](https://doodle.com/en/privacy-policy/#social-login)
    * [Outdated and completed polls](https://doodle.com/en/privacy-policy/#outdated-and-completed-polls)
    * [Inactive accounts](https://doodle.com/en/privacy-policy/#inactive-accounts)
    * [Unauthorized access](https://doodle.com/en/privacy-policy/#unauthorized-access)
    * [Inviting from Doodle](https://doodle.com/en/privacy-policy/#inviting-from-doodle)
    * [Contacts integration](https://doodle.com/en/privacy-policy/#contacts-integration)
    * [Calendar integration](https://doodle.com/en/privacy-policy/#calendar-integration)
    * [Communication between you and Doodle](https://doodle.com/en/privacy-policy/#communication)
    * [For user surveys and market research](https://doodle.com/en/privacy-policy/#user-surveys-and-market-research)
    * [Payment processing](https://doodle.com/en/privacy-policy/#payment-processing)
    * [Location of data](https://doodle.com/en/privacy-policy/#location-of-data)
    * [Transfer of Personal Data abroad](https://doodle.com/en/privacy-policy/#transfer-of-personal-data-abroad)
    * [Sharing personal information](https://doodle.com/en/privacy-policy/#sharing-personal-information)
    * [Data retention](https://doodle.com/en/privacy-policy/#data-retention)
    * [Legal basis](https://doodle.com/en/privacy-policy/#legal-basis)
    * [Right of erasure](https://doodle.com/en/privacy-policy/#right-of-erasure)
    * [Your rights](https://doodle.com/en/privacy-policy/#your-rights)
    * [Contact person](https://doodle.com/en/privacy-policy/#contact-person)
    * [Changes](https://doodle.com/en/privacy-policy/#changes)
...
* Microsoft [https://privacy.microsoft.com](https://privacy.microsoft.com/en-GB/)
...
Advertising is one of Doodle’s revenue streams. Therefore, Doodle displays advertisements on some of the services, e.g. on certain web pages or in e-mails. These advertisements can be targeted based on the information that is available to Doodle, e.g. language, IP address, poll content, etc. This targeting is always an automated process; none of the information used for targeting is analyzed manually or made available to advertising customers. In some cases, Doodle displays advertisements from Google’s AdSense or AdExchange network. These advertisements can be targeted based on the poll content. Google does not disclose that information and only uses it for the intended purpose. You can review Google’s Ads Privacy Policy here: [http://www.google.com/policies/privacy/ads/](https://www.google.com/policies/privacy/ads/). Furthermore, you can use [Google’s Ads Preferences Manager](https://adssettings.google.com/) to configure the right ads settings for you. We also use other third-party advertising companies to serve ads when you visit our Web site. If you would like more information about this practice and to know your choices about not having this information used by these companies, please see: [http://www.networkadvertising.org/managing/opt\_out.asp](https://thenai.org/opt-out/).

This Site is affiliated with Publisher First, Inc. dba Freestar ("Freestar") for the purposes of placing certain advertising on the Site, and Freestar will collect and use certain data for advertising purposes. To learn more about Freestar’s data usage, click [_here_](https://go.freestar.com/e/962853/privacy-policy-/5qkkzf/245900160?h=_A8f-h4Pz9Y-xEjD1h7hA5qA3bQ2COf5h5wLn5n8sLs).

Doodle’s paid services ([Premium Doodle](https://doodle.com/en/premium/)) are ads-free.
...
Detailed information on LiveRamp’s data processing activities is available in LiveRamp’s privacy policy https://liveramp.com/privacy/. You have the right to withdraw your consent or opt-out to the processing of your personal data at any time [https://liveramp.com/opt\_out/](https://liveramp.com/opt_out/)
...
Doodle supports the leading payment processing provider, PayPal. You can find their privacy policies here: [PayPal](https://www.paypal.com/webapps/mpp/ua/privacy-full). To make payments as easy and user-friendly as possible, Doodle sends your name and e-mail address to Paypal during a payment process. All this information would be requested by the provider anyway. Doodle furthermore employs Stripe for credit card payments. You can find the privacy policy [here](https://stripe.com/de/privacy).

### 16\. Location of data

The listing and locations of subprocessors authorized to process data on Doodle’s behalf can be found [**here**](https://doodle.com/en/data-subprocessors/).
...
* by concluding EU Model Clauses with the appointed service providers, cf. 
    
* through the appointed service providers having in place Binding Corporate Rules (BCR) that are recognised by a European data protection authority, cf. 
...
If you have questions regarding data protection, need information or want your data to be deleted please [\[email protected\]](https://doodle.com/cdn-cgi/l/email-protection).
...
[https://www.eprivacy.eu](https://www.eprivacy.eu/home/)  

### 24\. Changes

Doodle reserves the right to update this Privacy Policy at any time. The most current version of this policy is available at [https://doodle.com/en/privacy-policy/](https://doodle.com/en/privacy-policy/).
