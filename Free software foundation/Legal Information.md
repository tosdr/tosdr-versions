...
You are here: [Home](https://www.fsf.org/) › [About](https://www.fsf.org/about) › Copyright Infringement Notification
...
by [Donald Robertson](https://www.fsf.org/author/donaldr3) [Contributions](https://www.fsf.org/contribs/donaldr3) — Published on Nov 12, 2012 02:42 PM

This page details information on copyright infringement notices for websites ("sites") maintained by the Free Software Foundation including: [fsf.org](http://www.fsf.org/), [gnu.org](http://www.gnu.org/), [ftp.gnu.org](http://ftp.gnu.org/), [audio-video.gnu.org](http://audio-video.gnu.org/), [libreplanet.org](http://libreplanet.org/), [defectivebydesign.org](http://www.defectivebydesign.org/), [playfreedom.org](http://playfreedom.org/), [directory.fsf.org](http://directory.fsf.org/), [savannah.gnu.org](http://savannah.gnu.org/), and [savannah.nongnu.org](http://savannah.nongnu.org/) (collectively "FSF's sites"). If you believe there is a work or multiple works on one of the FSF's sites that violates copyright law, let us know. Specifically, send us an email or letter that includes substantially the following:
...
**The notice should be sent to our designated agent, Craig Topham, via email (craigt@fsf.org) or fax (617-542-2652 x56).**

We may display a copy of your DMCA notice in place of the removed work.

Note: Under Section 512(f) of the DMCA, any person who knowingly materially misrepresents that material or activity is infringing may be subject to liability for damages. One company that sent an infringement notification seeking removal of online materials that were protected by the fair use doctrine was ordered to pay such costs and attorneys fees under this provision. See _Online Policy Group v. Diebold_, [http://www.eff.org/cases/online-policy-group-v-diebold](http://www.eff.org/cases/online-policy-group-v-diebold) for more information. In addition, “in order for a copyright owner to proceed under the DMCA with “a good faith belief that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law,” the owner must evaluate whether the material makes fair use of the copyright.” _Lenz v. Universal_, 572 F. Supp. 2d 1150, 1155 (2008).
...
If you believe material you posted to one of the FSF’s sites was not infringing, you can submit a counter-notice. If you need assistance in determining whether the material was not infringing, please contact the Electronic Frontier Foundation (via email at [info@eff.org](mailto:info@eff.org)), who may be able to help you find an independent attorney to evaluate your situation.
...
**Please send your counter-notice to Craig Topham, via email ([craigt@fsf.org](mailto:craigt@fsf.org)) or fax (617-542-2652 x56).**
...
_Updated August 25th, 2016_

Copyright © 2012 Free Software Foundation, Inc.  
Copyright © 2012 Electronic Frontier Foundation  
[![Creative Commons License](https://i.creativecommons.org/l/by/3.0/us/88x31.png)](http://creativecommons.org/licenses/by/3.0/us/deed.en_US)  
Copyright Infringement Notification by [Free Software Foundation](http://www.fsf.org/) is licensed under a [Creative Commons Attribution 3.0 United States License](http://creativecommons.org/licenses/by/3.0/us/deed.en_US) and is based on a work at [https://www.eff.org/copyright](https://www.eff.org/copyright).

##### Document Actions

* **[Share on social networks](https://www.fsf.org/share?u=https://www.fsf.org/about/dmca-notice&t=Copyright%20Infringement%20Notification)**
* Syndicate:
...
[Free software in the EU needs your help! Join the ongoing Digital Europe Freedom Programme consultation by September 20](https://www.fsf.org/blogs/community/free-software-in-the-eu-needs-your-help)
