...
#### Watermark Website Cookie Policy

What are cookies?
-----------------

Cookies act as a memory for a website, allowing that website to remember your device on your return visits. Cookies are small text files that are sent to your device when you visit a website. Cookies are then sent back to the originating website on each subsequent visit. Cookies can also remember your preferences, improve the user experience, as well as tailor advertisements that are most relevant to you.

You can find more information about cookies, including how to see what cookies have been set on your device and how to manage/delete them at [www.aboutcookies.org](https://www.aboutcookies.org/).

Managing your cookie preferences
--------------------------------

The cookie settings on this website are set to ‘allow all cookies’ to give you the very best, most personalized experience. If you continue without changing these settings, you are consenting to this default setting. To opt out from tracking in your current browser on this site, [click here](https://www.watermarkinsights.com/thank-you-opt-out/?marketo_opt_out=true).
