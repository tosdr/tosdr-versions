...
1. [This page is our Privacy Policy](#this-page-is-our-privacy-policy)
2. [Personal data? What is that?](#personal-data-what-is-that)
3. [Privacy and data protection laws](#privacy-and-data-protection-laws)
4. [Contacting us](#contacting-us)
5. [Complaints](#privacy-policy-complaints)
...
![Explorer House, headquarters of Ordnance Survey](/img-assets/meta-images/explorer-house-entrance.x35a5d4d7.jpg?w=3840&f=webp)
...
More information on Ordnance Survey and who we are can be found on our [About us page](https://www.ordnancesurvey.co.uk/about "about").
...
* Corresponding with us using services such as web contact forms, ChatBot and live webchat facility, telephone, email, or written letter.
...
If you have an OS Maps account, it ensures we can give you the help you need. Or if you win an event or competition we organised, your data ensures you can get your prize.
...
* Service providers such as Meta and Google will use Pseudonymised data to create marketing lists. These lists can then be used to target users more closely and improve relevancy of advertising. Users will be profiled into “Lookalike audiences” (Lookalike audiences are customers who have the same interest such as hiking or dog walking and may be interested in the same promotional content) which can be used to improve the marketing audience.

For more information on how Google may use the data we share with them, please see [Google’s privacy policy](http://www.google.com/policies/privacy/partners/).

For more information on how Meta may use the data we share with them, please see [Meta’s privacy policy](https://en-gb.facebook.com/privacy/policy/?section_id=1-WhatInformationDoWe).
...
* Service providers such as Mapbox, using their Telemetry Software development kits to enable the collection of anonymous data and device location to continuously update and improve maps. For more information see [Telemetry | Mapbox](https://www.mapbox.com/telemetry/).
...
* We may contact you via email to invite you to rate and review any services and/or products you received from us in order to collect your feedback and improve our services and products (the “Purpose”). We use an external company, Trustpilot A/S (“Trustpilot”), to collect your feedback which means that we will share your name, email address, and reference number with Trustpilot for the Purpose. If you want to read more about how Trustpilot process your data, you can find their [Privacy Policy here](https://uk.legal.trustpilot.com/for-businesses/business-privacy-policy). We may also use such reviews in other promotional material and media for our advertising and promotional purposes.
...
* To:
    * enforce or apply the terms of a relevant EULA, our Terms of Use ([os.uk/legal](http://www.os.uk/legal)), terms and conditions of supply ([OS Shop Terms of Sale and Supply (ordnancesurvey.co.uk](https://www.ordnancesurvey.co.uk/legal/shop-terms)) and other agreements or to investigate potential breaches; or
...
You may see Ordnance Survey banners and adverts while you are using other websites and apps, such as Google and social media platforms like Facebook and Instagram. We manage this through digital marketing networks and advert exchanges. We also use a range of advertising technologies.

The banners and adverts you see are based on information we hold about you, or your previous use of OS (for example, your OS search history, the content you read on our OS sites and any interactions to newsletter emails sent to you) or on OS banners and adverts you may have previously clicked on.

You can unsubscribe from marketing by clicking the "Unsubscribe" link in any promotional or marketing email or text received, by emailing [customerservicesosl@os.uk](mailto:customerservicesosl@os.uk) or clicking on our [opt out page](https://r1.dotdigital-pages.com/p/2I1H-71M/thank-you-we-will-opt-you-out-of-tailored-advertising).
...
**Right of Access** – You can write to us asking what information we hold on you and to request a copy of that information. This is called a Subject Access Request (SAR). We have one calendar month to respond to you once we are satisfied you have rights to see the requested records and we have successfully confirmed your identity. Details on how to submit a Subject Access Request if you are in the UK or EEA can be found on our [data protection page.](https://www.ordnancesurvey.co.uk/governance/policies/data-protection)
...
We will only ask for information relevant to your query, which may include:
...
We do not knowingly collect or maintain personal data from children without verifiable parental consent. In this instance, consent is obtained by The Duke of Edinburgh’s Award charity when a parent/guardian gives consent for a child to sign up to the DofE programme and are informed of third-party services used to facilitate participation.

We will use the information collected below to enable access to the OS Maps Web App Service and to send any service-related and/or downtime emails.
...
If you are accessing OS Sites and/or Services from Australia, you may have rights under Australian privacy laws including the _Privacy Act 1988_ (Cth) (the **Australian Privacy Act**).
...
If you have any concerns about privacy or the use or collection of your personal information by us, please contact our privacy officer at [DPO@os.uk](mailto:DPO@os.uk) and include the words 'ATT: THE PRIVACY OFFICER.’ We will respond as quickly as possible (our target response is 20 working days).

##### Marketing communications

We are committed to full compliance with the Unsolicited Electronic Messages Act 2007.

By subscribing to emails and/or text communications, or otherwise providing your email address and/or mobile number, you consent to receiving emails and/or texts which promote and market our products and services, or the products and services of others, from time to time.

You can unsubscribe from our email communications and/or text communications at any time by clicking the "Unsubscribe" link in any promotional or marketing email or text received, or by emailing [customerservicesosl@os.uk](mailto:customerservicesosl@os.uk)
...
These California subsections apply only to “personal information” about California residents, as that term is defined in the California Consumer Privacy Act (“CCPA”), and they supplement the information in the rest of our Privacy Policy. Data about individuals who are not residents of California may not be handled in exactly the same way and is not subject to the same California rights described below.
...
| **Name** | **Affiliates; vendors who provide data hosting facilities and IT and system administration services; vendors who administer email service, webchat service and API Services; marketing vendors; vendors who supply reseller services; governmental authorities.** |
| Addresses, phone number, and email addresses and similar contact details | Same as first row of this chart |
| Month of birth | Affiliates; vendors who provide data hosting facilities and IT and system administration services. |
| Personal profile description and photograph | Affiliates; vendors who provide data hosting facilities and IT and system administration services. |
| Reviews and ratings in our Apps | Affiliates; vendors who provide data hosting facilities and IT and system administration services; vendors who administer email service, webchat service and API Services; marketing vendors. |
| Routes and activity information in our Apps | Affiliates; vendors who provide data hosting facilities and IT and system administration services; vendors who administer email service, webchat service and API Services; marketing vendors; mapping partners. |
| Geolocation | Affiliates; vendors who provide data hosting facilities and IT and system administration services; vendors who administer API Services; mapping partners. |
| Device information | Affiliates; vendors who provide data hosting facilities and IT and system administration services; vendors who administer email service, webchat service and API Services; marketing vendors; mapping partners. |
| Inferences based on any of the above | Same third parties as indicated above for the relevant data. |

_CCPA “Sale” of California Personal Information_
...
To request to exercise your CCPA rights, please submit your request via [Contact our Customer Services team](https://www.ordnancesurvey.co.uk/contact-us) or by emailing [DPO@os.uk](mailto:DPO@os.uk)
...
If you are an agent making a request on behalf of a consumer, you must verify that you are authorised to make that request, which may include requiring you to provide us with written proof that satisfies CCPA requirements, such as an appropriate letter signed by the consumer or a power of attorney. We also may require the consumer to verify their identity directly with us.
...
Under Nevada law, certain Nevada consumers may opt out of the “sale” of “personally identifiable information” for monetary consideration to a “data broker” (as such terms are used in Nevada privacy law) or other person. We do not engage in such activity as of the effective date of this Privacy Policy. However, Nevada users may submit a request to opt out of any potential future “sales” under Nevada law by sending a request to [Contact our Customer Services team](https://www.ordnancesurvey.co.uk/contact-us) or by emailing [DPO@os.uk](mailto:DPO@os.uk)
...
The new terms may be displayed on-screen, and you may be required to read and accept them to continue your use of any Services or Apps.
...
**UK Information Commissioner**: Contact telephone number: 0303 123 1113. Website: ICO website [https://ico.org.uk/](https://ico.org.uk/)

**European Data Protection Authorities:** in the European Economic Area are available via the [European Commission website](https://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm)

**Office of the Australian Information Commissioner:** GPO Box 5218, Sydney NSW 2001, Telephone: 1300 363 992, Email: [enquiries@oaic.gov.au](mailto:enquiries@oaic.gov.au)

**Office of the New Zealand Privacy Commissioner:** Contact telephone number: 0800 803 909 (Monday to Friday, 10am to 3pm). Email: [enquiries@privacy.org.nz](mailto:enquiries@privacy.org.nz) Website: [www.privacy.org.nz/](https://www.privacy.org.nz/)
