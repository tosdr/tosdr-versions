...
You are here: [start](https://www.zotero.org/support/start "start") > [terms](https://www.zotero.org/support/terms/start "terms:start") > [terms\_of\_service](https://www.zotero.org/support/terms/terms_of_service "terms:terms_of_service")
...
In order to provide and ensure the quality of the Zotero Services, we may collect and store certain data consistent with our Privacy Policy, which can be found at [https://www.zotero.org/support/terms/privacy\_policy](https://www.zotero.org/support/terms/privacy_policy "https://www.zotero.org/support/terms/privacy_policy") and is incorporated herein by reference.
...
The fees for paid subscriptions are not license fees, but charges due for storage and related services. The Zotero research tool and server software are released for free public use under several open source licenses, primarily the AGPLv3 - see the license text included with the code for details. The source code is available at [https://github.com/zotero/](https://github.com/zotero/ "https://github.com/zotero/").
...
Please consult your legal advisor before submitting written notification, as the above-stated requirements may have changed. For further information about the DMCA, please visit the website of the U.S. Copyright Office at: [http://www.copyright.gov/onlinesp/](http://www.copyright.gov/onlinesp/ "http://www.copyright.gov/onlinesp/").
...
* [ZOTERO TERMS OF SERVICE](#zotero_terms_of_service)
    
* [1\. Your Account/Registration](#your_accountregistration)
    
* [2\. Your Submissions and Other Data](#your_submissions_and_other_data)
    
* [3\. Fees and Payment](#fees_and_payment)
    
* [4\. Renewals](#renewals)
    
* [5\. Paid Subscription Termination](#paid_subscription_termination)
    
* [6\. Acceptable Use and Conduct/User Restrictions](#acceptable_use_and_conductuser_restrictions)
    
* [7\. Changes to and Termination of the Services](#changes_to_and_termination_of_the_services)
...
* [14\. Local Laws and Export Control](#local_laws_and_export_control)
    
* [15\. Controlling Law and Jurisdiction](#controlling_law_and_jurisdiction)
    
* [16\. General](#general)
    

terms/terms\_of\_service.txt · Last modified: 2017/11/12 20:02 by 127.0.0.1

* [Old revisions](https://www.zotero.org/support/terms/terms_of_service?do=revisions "Old revisions [o]")

![](/support/lib/exe/taskrunner.php?id=terms%3Aterms_of_service&1733977669)
