...
네이버 개인정보 처리방침 (Ver.11.9)
------------------------

네이버는 이용자 개인정보 보호를 여러 경영요소 가운데 최우선의 가치로 두고 있습니다.

[이전 개인정보처리방침 보기](https://policy.naver.com/rules/privacy_v11_8.html)
...
* **수탁업체인 네이버클라우드㈜에서는 아래와 같이 개인정보를 국외에 보관하고 있습니다.**
    ...
    일부 서비스를 이용하는 과정에서 회의 또는 음성 통화를 진행하는 경우, 서비스 제공을 위해 개인정보를 국외에 처리위탁 하는 경우가 있습니다. 회의 또는 음성 통화 서비스 이용을 하지 않는 경우에는 개인정보 이전이 발생하지 않으며, 이전을 거부하시는 경우에는 해당 서비스 이용이 불가합니다. 이에 이전을 원치 않으실 경우, 해당 서비스를 이용하지 않는 것으로 국외 이전을 거부하실 수 있습니다.
    
    |     |     |
    | --- | --- |회사의 위탁관련 사항 안내   
    | **수탁업체** | 라인플러스 주식회사 |     |
    | **이전 국가** | 일본  |     |
    | **위탁 일시 및 방법** | 이용자가 서비스를 이용하는 시점에 네트워크를 이용한 원격지 전송 |     |
    | **이전받는 자의 연락처** | privacy\_kr@linecorp.com |     |
    | **위탁하는 개인정보 항목** | 내부에서 생성한 이용자 식별자, 영상/음성 정보 |     |
    | **위탁업무 내용** | 영상/음성통화 및 화상회의 서비스 제공 |     |
    | **개인정보의 보유 및 이용기간** | 영상/음성정보는 회의 및 통화 종료 시 즉시 파기, 이용자 식별자 1년 보관 |     |
