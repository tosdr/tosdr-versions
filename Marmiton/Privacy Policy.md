...
Les données vous concernant que nous utilisons et la façon dont nous les obtenons sont détaillées ci-dessous.
...
| Déduction par nos outils techniques au fur et à mesure de votre utilisation de nos services | **Données d’Intérêts** | Sur la base d’une combinaison de certaines de vos **Données de Compte**, comme votre email et votre date de naissance, de vos **Données de Profil**, de vos **Données Techniques**, de vos **Données de Navigation** et des **Données Tierces**, nous déduisons des informations relatives à votre profil, tels que vos centres d’intérêt supposés, à des fins publicitaires.  <br>A titre d’illustration, si vous avez consulté la rubrique “Végétarien, vegan, flexitarien” de nos services (https://www.marmiton.org/bien-choisir-ses-aliments/vegetarien-vegan-flexitarien-tp125268.html), nous pourrons en déduire un centre d’intérêts pour la thématique “Vegan” et enrichir votre profil avec cette information. |

Quelles sont les utilisations que nous faisons de vos données ?

Les différentes utilisations que nous pouvons faire de vos données sont listées ci-dessous.

|     |     |     |
| --- | --- | --- |
| **UTILISATION** | **DESCRIPTION** | **FONDEMENT LÉGAL** |
| Gérer votre Compte Utilisateur et/ou votre Compte Client | Nous utilisons vos **Données de Compte** afin d’administrer votre **Compte Utilisateur** et/ou votre **Compte** **Client**, de vous permettre de vous y connecter et de vous adresser des communications nécessaires au bon fonctionnement de ceux-ci.<br><br>Lors de la création de votre **Compte Utilisateur** et de votre **Compte Client**, les champs obligatoires sont indiqués par des astérisques. La création de votre **Compte Utilisateur** et de votre **Compte Client** ne sera possible qu’à condition que vous ayez renseigné l’ensemble des champs obligatoires. | Exécution du contrat |
| Vous permettre de profiter de nos services | Nous utilisons vos **Données de Compte**, vos **Données de Services** et vos **Données de Géolocalisation**, si vous avez consenti à ce que nous y ayons accès en arrière-plan, afin de vous permettre de profiter de nos services, et notamment :<br><br>* pour mettre en avant des recettes adaptées à vous (en fonction de vos préférences alimentaires et de votre niveau de cuisine) et/ou une sélection de recettes régionales en lien avec la région dans laquelle vous vous situez (en fonction de vos **Données de Géolocalisation**) ;<br>* pour adapter les portions affichées dans nos recettes à votre foyer (en fonction de la composition de votre foyer) ;<br>* pour traiter vos contributions à nos forums et/ou contenus éditoriaux (recettes, avis, commentaires, etc.) ;<br>* gérer votre participation à des tests de produits. | Exécution du contrat |
| Gérer vos commandes dans la Boutique | Nous utilisons vos **Données de Compte** et vos **Données de Services** afin de gérer vos commandes dans la **Boutique et/ou sur le site** (gestion des abonnements/commandes, facturation, perception des paiements, livraisons et suivi de commandes, service-après-vente, etc.). | Exécution du contrat |
| Vous adresser des notifications relatives à l’activité de votre compte utilisateur | Sous réserve de votre consentement exprimé dans les paramètres de votre **Compte Utilisateur**, nous pourrons vous adresser des notifications relatives à l’activité de votre **Compte Utilisateur**, éventuellement personnalisées en fonction de vos **Données de Compte** et/ou vos **Données de Profil**.<br><br>Ces notifications ont vocation à vous avertir par exemple qu’un autre utilisateur a interagi avec vous sur nos forums. | Votre consentement |
| Améliorer la qualité de nos services et en développer de nouveaux | Nous sommes susceptibles d’utiliser vos **Données de Compte**, vos **Données de Services**, vos **Données Techniques** et vos **Données de Navigation** afin de réaliser des statistiques globales et agrégées sur la façon dont nos services sont utilisés. Ces statistiques ne contiennent aucune donnée vous concernant et sont utilisées afin d’améliorer la qualité de nos services de façon continue et de développer de nouveaux services ou de nouvelles fonctionnalités. | Notre intérêt légitime |
| Vous adresser des communications commerciales personnalisées et en mesurer la performance | Si vous avez accepté de recevoir des communications commerciales de notre part, y compris nos newsletters, nous pourrons utiliser vos **Données de Compte** et vos **Données de Services** afin de vous les adresser et d’en mesurer la performance.<br><br>Il en va de même si vous avez accepté de recevoir des communications commerciales de notre part de nos partenaires. Auquel cas, aucune donnée vous concernant ne sera transmise à nos partenaires.<br><br>Afin d’améliorer la pertinence des communications que nous vous adressons, nous sommes susceptibles d’en personnaliser le contenu en fonction de vos **Données de Compte** et de vos **Données de Services**, notamment votre date de naissance pour vous souhaiter un joyeux anniversaire. | Votre consentement |
| Produire des études statistiques globales et agrégées, sur la base de vos réponses à nos enquêtes | Si vous participez à nos enquêtes, nous pourrons utiliser vos **Données de Services**, en l’occurrence les réponses à vos questions, pour produire des études statistiques relatives au sujet de l’enquête.<br><br>Ces études sont globales et agrégées, cela signifie qu’elles ne contiennent aucune donnée vous concernant, et sont susceptibles d’être communiquées à des tiers. | Notre intérêt légitime |
| Gérer votre participation à des jeux-concours | Si vous participez à nos jeux-concours, nous pourrons utiliser vos **Données de Services**, en l’occurrence les informations que vous avez renseignées dans le formulaire de participation, pour prendre en compte votre participation au jeu-concours, assurer l’organisation de celui-ci et adresser les lots aux gagnants. | Exécution du contrat |
...
Quels sont nos partenaires publicitaires ?
...
Le cas échéant, lorsque ces pays ne bénéficient pas d’une décision d’adéquation au titre de l’article 45 du RGPD, nous utilisons diverses mesures pour garantir que vos données à caractère personnel transférées vers ces pays bénéficient d’une protection adéquate, comme la signature des [clauses contractuelles types adoptées par la Commission européenne](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32010D0087).

Combien de temps vos données sont-elles conservées ?

|     |     |
| --- | --- |
| **UTILISATION** | **DURÉE DE CONSERVATION** |
| Gérer votre Compte Utilisateur et/ou votre Compte Client<br><br>Vous adresser des notifications relatives à l’activité de votre compte utilisateur<br><br>Vous adresser des communications commerciales personnalisées<br><br>Améliorer la qualité de nos services et en développer de nouveaux<br><br>Fournir les fonctionnalités nécessaires au fonctionnement de nos services | 3 ans à compter de votre dernière activité constatée sur votre Compte Utilisateur et/ou votre Compte Client pour vos **Données de Compte** et vos **Données de Services**.<br><br>Si vous demandez vous-même la suppression de votre compte utilisateur, celui-ci sera supprimé dans les meilleurs délais et vos **Données de Compte** et vos **Données de Services** pourront être archivées pendant 1 an afin de répondre aux obligations légales ou réglementations pesant sur nous.<br><br>A la suite de la suppression de votre compte, vos contributions aux forums et/ou à nos contenus éditoriaux (recettes, avis, commentaires, etc.) pourront être anonymisées afin de continuer à apparaître sur nos services. Elles pourront être utilisées pour produire des études sémantiques et statistiques relatives à des tendances générales en lien avec les forums.<br><br>13 mois maximum pour vos **Données Techniques** et vos **Données de Navigation**. |
| Gérer vos commandes dans la Boutique | 3 ans à compter de votre dernière activité constatée sur votre Compte Client pour vos **Données de Compte** et vos **Données de Services**, à l’exception de vos coordonnées bancaires qui sont conservées jusqu’au paiement effectif ou, dans le cadre d’un abonnement, jusqu’à de la dernière échéance de paiement puis sont conservées en archivage intermédiaire 13 mois suivant la date de débit (ou 15 mois en cas de CB à débit différé) à des fins de preuve en cas de contestation de la transaction. |
| Vous permettre de profiter de nos services | Durée nécessaire au regard des utilisations qui seront faites de vos **Données de Compte** et vos **Données de Services** en fonction de la nature de nos services, dans la limite de 3 ans à compter de votre dernière activité constatée sur votre Compte Utilisateur et/ou votre Compte Client. Si vous demandez vous-même la suppression de votre compte utilisateur, celui-ci sera supprimé dans les meilleurs délais et vos **Données de Compte** et vos **Données de Services** pourront être archivées pendant 1 an afin de répondre aux obligations légales ou réglementations pesant sur nous. A la suite de la suppression de votre compte, vos contributions aux forums et/ou à nos contenus éditoriaux (recettes, avis, commentaires, etc.) pourront être anonymisées afin de continuer à apparaître sur nos services. Elles pourront être utilisées pour produire des études sémantiques et statistiques relatives à des tendances générales en lien avec les forums.  <br>  <br><br>Si vous avez consenti à ce que nous ayons accès en arrière-plan à vos **Données de Géolocalisation**, celles-ci seront supprimées définitivement à l'issue de l'affichage de la sélection de recettes régionales en lien avec la région dans laquelle vous vous situez, sans jamais que vos **Données de Géolocalisation** ne soient stockées dans nos bases de données. |
| Produire des études statistiques globales et agrégées, sur la base de vos réponses à nos enquêtes | 13 mois maximum |
| Gérer votre participation à des jeux-concours | 3 mois |
| Réaliser des mesures d’audience | 13 mois maximum |
| Construire un profil vous concernant regroupant vos centres d’intérêts présumés<br><br>Vous proposer des contenus éditoriaux susceptibles de vous intéresser, sur la base de votre profil utilisateur supposé<br><br>Vous proposer des publicités susceptibles de vous intéresser, sur la base de votre profil utilisateur supposé | Période glissante de 13 mois maximum |
| Répondre à des obligations légales ou règlementaires pesant sur nous et à des décisions de justice | Durée nécessaire au regard des obligations légales ou réglementations pesant sur nous |
| Gérer l’offre d’accès à nos services sans publicité ciblée | 13 mois à compter de votre souscription à l’offre, à l'exception de vos données bancaires qui seront supprimées dès la transaction réalisée |

Quels sont vos droits en matière de vie privée ?

A tout moment, vous pouvez :

* Obtenir la rectification de vos données,
* Obtenir une copie de vos données,
* Vous opposer à toute utilisation de vos données à des fins de marketing.

De plus, en fonction des circonstances, vous pouvez:

* Retirer votre consentement lorsque l’une de nos utilisations est basée sur ce dernier,
* Vous opposer pour une raison tenant à votre situation à toute utilisation basée sur notre intérêt légitime,
* Demander la transmission à toute personne de vos données lorsque nous les détenons sur la base d’un contrat ou de votre consentement (droit à la portabilité),
* Demander la limitation du traitement de vos données dans l’hypothèse pendant que nous examinons votre demande d’opposition,
* Nous demander la suppression de vos données lorsque ces dernières ne sont plus nécessaires, lorsque vous avez retiré votre consentement ou vous êtes opposé à une utilisation (droit à l'oubli),
* Définir des directives relatives au sort de vos données personnelles après votre mort.
