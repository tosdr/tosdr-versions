...
[Privacy Policy](https://august.com/pages/privacy-policy) [Cookie Policy](https://august.com/pages/cookie-policy)

End User Agreement

[Warranty](https://august.com/pages/warranty) [Terms of Service](https://august.com/pages/terms-of-service) [AVR](https://august.com/pages/avr-terms) [Terms Notices](https://august.com/pages/terms-notices) [Security Center](https://august.com/pages/security-center)
...
**This is a legal agreement between y****ou and August Home Inc.** 

This End User License Agreement (“Agreement”) is a legal agreement between you and August Home, Inc. (on behalf of itself or its applicable subsidiary or affiliate, “August”) for the August software (the “Licensed Software”) that is provided in the form of pre-installed, embedded software on any of the August devices installed in the United States, American Samoa, Guam, Northern Mariana Islands, Puerto Rico, US Virgin Islands or Canada (“Territory”) (each and collectively referred to as “Device”), and all updates thereto provided by August (unless provided under different terms at the time of download or update). 

The Licensed Software is used in connection with the August mobile software application downloaded and installed on your mobile device (the “Application”). These terms also apply if you purchased an August product sold under the “Yale” brand that directed you to register an August account and use the Application.  This Agreement is separate from, and in addition to, any Terms of Services or other documentation with respect to the Device, the Licensed Software and/or the Application.
...
1. **Updates to the Licensed Software** 

The Licensed Software may, without additional notice, check for updates that are available for automatic download and installation to your Device and let August know the Licensed Software is successfully installed. If you do not want such updates, your remedy is to stop using the Device and provide August written notice of termination of this Agreement. If you do not cease using the Device, you will receive updates automatically. You acknowledge that you may be required to install updates to use the Device and the Licensed Software, and you agree to promptly install any updates that August provides. Your continued use of the Device is your consent to these updates. Failure to install these updates may expose you to security risks and/or limit the functionality of the Device, Services, or Application.

1. **Our Privacy Policy applies to your use of the Licensed Software** 

We value your privacy. All information provided to August in connection with your use of the Licensed Software is covered by our Privacy Policy, available at [www.august.com/pages/privacy-policy](https://august.com/pages/privacy-policy). Please review this policy prior to using the Licensed Software, as by entering into this Agreement and using the Licensed Software you are agreeing to the terms of our Privacy Policy.
...
1. **Certain Disclaimers Concerning the Device and the Licensed Software** 
...
All waivers by August will be effective only if in writing. Any waiver or failure by August to enforce any provision of this Agreement on one occasion will not be deemed a waiver of any other provision or of such provision on any other occasion.
...
If you have questions regarding this Agreement, or wish to obtain additional information, please send an e-mail to support@august.com.
