[![logo](/assets/img/t2bot-banner.png)](https://t2bot.io/)

[#community:t2bot.io](https://matrix.to/#/#community:t2bot.io) [status.t2bot.io](https://status.t2bot.io/) [#help:t2bot.io](https://matrix.to/#/#help:t2bot.io)

Copyright Notice

_Last updated: May 18th, 2024_

Introduction
============

When you read 'the t2bot.io homeserver' or 'the Service' below, it refers to the services made available at t2bot.io which store your account and personal conversation history, provide services such as bots and bridges, and communicate via the open Matrix decentralised communication protocol with the public Matrix Network.
...
* [Privacy Notice](https://t2bot.io/docs/legal/privacy-v1)
* [Terms and Conditions](https://t2bot.io/docs/legal/terms-v1)
* [Code of Conduct](https://t2bot.io/docs/legal/code-of-conduct-v1)
* [Security Disclosure Policy](https://t2bot.io/docs/legal/security-disclosure-policy-v1)
* [Copyright Policy](https://t2bot.io/docs/legal/copyright-v1)

#### Learn more

* [Donations](https://t2bot.io/donations)
* [Infrastructure](https://t2bot.io/infrastructure)
* [Public rooms](https://t2bot.io/docs/directory)
* [Blog](https://t2bot.io/blog)
* [status.t2bot.io](https://status.t2bot.io/)

[![matrix.org](/assets/img/made-for-matrix.svg)](https://matrix.org/)

[Follow TravisR on Mastodon](https://mstdn.ca/@travisr)
