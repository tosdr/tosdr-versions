[![37signals](/assets/images/logo-black.svg)](https://www.hey.com/)
...
This policy applies to all products built and maintained by 37signals LLC including Basecamp (all versions), HEY, Highrise, Campfire, Backpack, Ta-da List, and Writeboard (together, “37signals”). If you are applying for a job at 37signals, please review our [Recruitment Privacy Policy](https://www.hey.com/policies/privacy/recruitment/).
...
If you are a California resident, please [click here to see our California Notice at Collection](https://www.hey.com/policies/privacy/regulations/ccpa/), which includes additional disclosures as required by California law.
...
**To provide products or services you’ve requested.** We use some third-party subprocessors to help run our applications and provide the Services to you. You can view the third-party subprocessors we use for each of our products: [Basecamp](https://www.hey.com/policies/privacy/basecamp-subprocessors/), [HEY](https://www.hey.com/policies/privacy/hey-subprocessors/), [Highrise](https://www.hey.com/policies/privacy/highrise-subprocessors/), [Campfire](https://www.hey.com/policies/privacy/campfire-subprocessors/), [Backpack](https://www.hey.com/policies/privacy/backpack-subprocessors/). We also use third-party processors for other business functions such as managing newsletter subscriptions, sending customer surveys, and providing our company storefront. You can view the list at [Company Processors](https://www.hey.com/policies/privacy/company-processors/).
...
The European Data Protection Board (EDPB) has issued guidance that personal data transferred out of the EU must be treated with the same level of protection that is granted under EU privacy law. UK law provides similar safeguards for UK user data that is transferred out of the UK. Accordingly, 37signals has adopted a data processing addendum with Standard Contractual Clauses to help ensure this protection. 37signals’ DPA is available at: [37signals.com/policies/privacy/regulations/37signals-gdpr-dpa](https://www.hey.com/policies/privacy/regulations/37signals-gdpr-dpa.pdf)
...
We may update this policy as needed to comply with relevant regulations and reflect any new practices. If we make significant changes, we will refresh the date at the top of this page and notify users who have signed up to our [policy updates mailing list](https://www.hey.com/policies/updates/).

Have any questions, comments, or concerns about this privacy policy, your data, or your rights with respect to your information? Please get in touch by emailing us at [privacy@37signals.com](mailto:privacy@37signals.com).
