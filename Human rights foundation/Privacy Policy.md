...
[![Human Rights Foundation](data:image/svg+xml;nitro-empty-id=MTEzNjo2NDM=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjgzMiA3NzkiIHdpZHRoPSIyODMyIiBoZWlnaHQ9Ijc3OSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)](https://hrf.org/)

* [About Us](https://hrf.org/about-us/) Close About Us Open About Us
    
    [Our Organization
    
    Discover our mission and dedication to protecting human rights across the globe.](https://hrf.org/our-organization/)[Our People
    
    Get to know the passionate team behind our work.](https://hrf.org/our-people/)[Work With Us
    
    When we rise, tyranny falls.](https://hrf.org/work/)[Annual & Financial Reports
    
    Review and access our complete collection of annual and financial reports.](https://hrf.org/annual-and-financial-reports/)
    
* [Our Work](https://hrf.org/our-work/) Close Our Work Open Our Work
    
    [Programs
    
    Explore our programs dedicated to advancing freedom and democracy in every corner of the globe.](https://hrf.org/allprograms/)[Research Reports
    
    Delve into our original research examining the human rights abuses and violations taking place under authoritarian regimes.](https://hrf.org/research-reports/)
    
* [Latest](https://hrf.org/latest/) Close Latest Open Latest
    ...
    Keep informed of our latest news and updates.](https://hrf.org/press-releases/)[Reports
    
    Review and access our most recent reports.](https://hrf.org/reports/)[Op-eds
    
    Check out our team’s contributions in international news outlets.](https://hrf.org/op-eds/)
    
* [Take Action](https://hrf.org/take-action/)
...
![](data:image/svg+xml;nitro-empty-id=MTU5NTo0Mzg=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTUwIDE1MCIgd2lkdGg9IjE1MCIgaGVpZ2h0PSIxNTAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
* [Press Releases](https://hrf.org/press-releases/)
* [Reports](https://hrf.org/reports/)
* [Op-eds](https://hrf.org/op-eds/)
...
* **Company** (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Human Rights Foundation, 350 5th Ave #6500, New York, NY 10118. For the purpose of the GDPR, the Company is the Data Controller.
* **Affiliate** means an entity that controls, is controlled by, or is under common control with a party, where “control” means ownership of 50% or more of the shares, equity interest, or other securities entitled to vote for the election of directors or other managing authority.
* **Account** means a unique account created for You to access our Service or parts of our Service.
* **Website** refers to Human Rights Foundation (HRF), accessible from www.hrf.org.
...
* **Facebook Fan Page** is a public profile named Human Rights Foundation’s Facebook Page specifically created by the Company on the Facebook social network, accessible from www.facebook.com/humanrightsfoundation.
...
* **Data Controller**, for the purposes of the GDPR, refers to the Company as the legal person who, alone or jointly with others, determines the purposes and means of processing Personal Data.
...
We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and improve and analyze Our Service.
...
**Mailchimp**Mailchimp is an email marketing sending service by The Rocket Science Group LLC.  
...
* **X**X remarketing service is provided by X Corp.  
    You can opt out of X’s interest-based ads by following their instructions: [https://support.twitter.com/articles/20170405.](https://support.twitter.com/articles/20170405)You can learn more about X’s privacy practices and policies by visiting their Privacy Policy page: [https://twitter.com/privacy](https://twitter.com/privacy).
...
The Company is the Data Controller of Your Personal Data collected while using the Service. As the operator of the Facebook Fan Page (www.facebook.com/humanrightsfoundation), the Company and the operator of the social network Facebook are Joint Controllers.
...
* **The right to delete Personal Data.** You also have the right to request the deletion of Your Personal Data collected in the past 12 months.
...
To exercise Your rights under the CCPA, and if you are a California resident, You can email or call us or visit our “Do Not Sell My Personal Information” section or web page.

The Company will disclose and deliver the required information free of charge within 45 days of receiving Your verifiable request. The time period to provide the required information may be extended once by 45 days when reasonably necessary and with prior notice.

##### Do Not Sell My Personal Information

We do not sell personal information. However, the Service Providers we partner with (for example, our advertising partners) may use technology on the Service that “sells” personal information as defined by the CCPA law.

If you wish to opt out of using your personal information for interest-based advertising purposes and these potential sales as defined under CCPA law, you may do so by following the instructions below.
...
If you’d like to request more information under the California Shine the Light law and are a California resident, You can contact Us using the contact information provided below.
...
![HRF](data:image/svg+xml;nitro-empty-id=MjE5ODoxNjY=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjY0IDcyIiB3aWR0aD0iMjY0IiBoZWlnaHQ9IjcyIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
[Contact](https://hrf.org/contact-us/)

Reach out with any questions or support needs.

[](https://hrf.org/work/)

[Careers](https://hrf.org/work/)
...
* [Legal & Privacy Policy](https://hrf.org/privacy-policy/)
...
Art in Protest Belarus Solidarity Fund CCP Disruption Initiative Celebrities & Dictators Combating Kleptocracy Digital Champions Dissidents and Dictators Financial Freedom Flash Drives For Freedom Freedom Fellows Impact Litigation Micro Grants Oslo Scholars Ukraine Solidarity Fund Venezuela Solidarity Fund Wear Your Values Press General Inquiries
