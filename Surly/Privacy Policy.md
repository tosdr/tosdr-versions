...
* [Features](https://sur.ly/#features)
* [How it works](https://sur.ly/#how-it-works)
* [Pricing](https://sur.ly/#pricing)

* [Sign in](#)
* [Get Sur.ly](#)

Privacy Policy of **Sur.ly**
============================
...
**Owner contact email:** surdotly@gmail.com

Types of Data collected
-----------------------

Among the types of Personal Data that this Website collects, by itself or through third parties, there are: Trackers; Usage Data; city; ZIP/Postal code; state; province; country; county; latitude (of city); longitude (of city); metro area; geography/region; IP address; device information; app information; device logs; operating systems; browser information; language; launches; number of sessions; session duration; scroll-to-page interactions; mouse movements; scroll position; keypress events; motion sensor events; touch events; video views; clicks; browsing history; search history; session statistics; page views; interaction events; page events; custom events; Application opens; company name; email address.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Analytics, Advertising, Tag Management, Spam and bots protection, Traffic optimization and distribution and Contacting the User.
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://sur.ly/cookie-policy "Cookie Policy").
...
* We have released [Sur.ly Surfguard](https://sur.ly/browser-extension) — a brand new browser extension that prevents users from accidental visits to malicious or concerning websites. 01 September 2023
    
* Updated [FAQ section](https://sur.ly/faq): up-to-date answers and instructions are ready to guide you on Sur.ly’s features and best practices.
    
    05 September 2020
    
* Good news for Blogger users! Sur.ly is [now available](https://sur.ly/downloads#plugins) on this popular free blogging platform.
...
* [CMS plugins](https://sur.ly/downloads#plugins)
* [SDKs](https://sur.ly/downloads#sdks)

Company

* [Web safety tools](https://sur.ly/web-safety-tools)
* [Browser extension](https://sur.ly/browser-extension)
* [Terms of service](https://sur.ly/terms)
* [Privacy policy](https://sur.ly/privacy-policy)
* [Cookie policy](https://sur.ly/cookie-policy)
* [Removal request](https://sur.ly/contacts)

Help center

* [FAQ](https://sur.ly/faq)
* [Installation](https://sur.ly/installation)
* [Set up a subdomain](https://sur.ly/setting_subdomain)
* [Developers](https://sur.ly/developers)
...
[Google](https://accounts.google.com/o/oauth2/auth?redirect_uri=https://sur.ly/analytics/auth/google&response_type=code&client_id=639890009009.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile&state=surly_access)

[](#)

Enter credentials[New sign up](#)
