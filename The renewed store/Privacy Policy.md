...
The Renewed Store Limited ("We") are committed to protecting and respecting your privacy.
...
The Renewed Store Limited is the data controller. This means we decide how your personal data is processed and for what purposes. Our contact details are: The Renewed Store Limited, Units 5&6 Colhook Industrial Park, Petworth, West Sussex, GU28 9LP. For all data matters contact Karen Champness on 01428 620604.

### **The purpose(s) of processing your personal data**

We use your personal data for the following purposes:

To fulfil an order as per customer instructions, to maintain our accounts and records and to inform individuals of news, events, or activities.

You may give us information about you by filling in forms on our site, [www.therenewedstore.com](http://www.therenewedstore.com/), or by corresponding with us by phone, email or otherwise.  This includes information you provide when you search for a product, place an order on our site, participate in discussion boards or other social media functions on our site and when you report a problem with our site.

### **The categories of personal data concerned**

With reference to the categories of personal data described in the definitions section, we process the following categories of your data:

* Personal data:- name, company name, address, telephone number, email address.
...
This means any consent that has been given to keep an individual or company informed of special offers or any other material that The Renewed Store Limited deem of interest to the individual or company.

**Processing necessary for the performance of a contract with the data subject or to take steps to enter a contract**

This means any request made by a customer to purchase from The Renewed Store Limited.  Customer details would be necessary for us perform this request and subsequently manage invoices and payment.

**Processing necessary for the purposes of the legitimate interests of the data controller or a third party, except where such interests are overridden by the interests or fundamental rights or freedoms of the data subject**

This means any information that we would pass on for the purposes of retrieving outstanding debts to The Renewed Store Limited.

### **Sharing your personal data**

Your personal data will be treated as strictly confidential and will be shared, in the case of our customers, only with courier companies to deliver your goods. 

### **How long do we keep your personal data?**

We only keep a modest amount of data.  If personal data has been recorded because of a relationship with The Renewed Store Limited, although the data may not be used in future, there are various legal requirements and professional guidelines about keeping certain kinds of records – such as information needed for accounting or audit purposes.

### **Providing us with your personal data**

We require your personal data as it is necessary to perform a service for you as a customer or supplier.
...
To exercise all relevant rights, queries, or complaints please in the first instance contact our Data Representative, Karen Champness on 01428 620604.
