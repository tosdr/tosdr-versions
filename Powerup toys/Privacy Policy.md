...
At **POWER**UP **Toys**, we value our customers and respect their privacy. We only collect as little customer information as needed in an effort to provide you with a great shopping experience.

**POWER**UP **Toys** Privacy Policy
-----------------------------------

This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.poweruptoys.com (the “Site”).

PERSONAL INFORMATION WE COLLECT
-------------------------------

When you visit the Site, we automatically collect certain information about your device, including information about your web browser, IP address, time zone, and some of the cookies that are installed on your device. Additionally, as you browse the Site, we collect information about the individual web pages or products that you view, what websites or search terms referred you to the Site, the duration that you visit the Site and information about how you interact with the Site. We refer to this automatically-collected information as “Device Information”.

We collect Device Information using the following technologies:
---------------------------------------------------------------

\- “Cookies” are data files that are placed on your device or computer and often include an anonymous unique identifier such as :(1) Site functionality cookies – these cookies allow you to navigate the site and use our features, such as “Add to Bag” and “Save for Later”.(2) Site analytics cookies – these cookies allow us to measure and analyse how our customers use the site, to improve both its functionality and your shopping experience. (3) Customer preference cookies – when you are browsing or shopping on the Site, these cookies will remember your preferences (like your language or location), so we can make your shopping experience as seamless as possible, and more personal to you. (4) Targeting or advertising cookies – these cookies are used to deliver ads relevant to you. They also limit the number of times that you see an ad and help us measure the effectiveness of our marketing campaigns. For more information about cookies, and how to disable cookies, visit [http://www.allaboutcookies.org](http://www.allaboutcookies.org/).

By using the Site, you agree to POWERUP Toys placing different sorts of cookies on your device and accessing them when you visit the site in the future.

\- “Log files” track actions occurring on the Site, and collect data including your IP address, browser type, Internet service provider, referring/exit pages, and date/time stamps.

\- “Web beacons”, “tags”, and “pixels” are electronic files used to record information about how you browse the Site.

When you make a purchase or attempt to make a purchase through the Site, we collect certain information from you, including your name, billing address, shipping address, payment information ( PayPal email addresses), email addresses, and phone number. We refer to this information as “Order Information”.

Although you may submit credit card information at the time you make a purchase, POWERUP Toys does not collect or store that information. All credit card transactions are entirely handled by Stripe.

\-When you make an attempt to make a purchase through the Site, after you added products to your cart, we collect the information you type into those checkout fields, and we use this information to send an automated email if you do not complete the checkout process. This email contains a link for you to contact us in case there is something we can help you with.

\-When you fill out the form on our Contact us page or if you send an email to support@poweruptoys.com,  we record all the information you provide us in Zendesk. Zendeskis a 3rd party tool that helps us provide better service to our customers. You can read more about how Shopify uses your Personal Information here: [https://www.freshworks.com/privacy/?utm\_source=freshdesk&utm\_medium=referral](https://www.freshworks.com/privacy/?utm_source=freshdesk&utm_medium=referral)

\-If you sign up or opt in to our POWERUP Toys Newsletter we will collect your name and email address for the purpose of sending you occasional updates about our company. We will not share or sell this information to anybody without your consent, and you can unsubscribe at any time.

\-When we talk about “Personal Information” in this Privacy Policy, we are talking both about Device Information and Order Information or any of the above-mentioned situations where you enter the site and leave your information deliberately.
...
We do not sell, trade, or otherwise transfer to outside parties your Personal Information. This does not include trusted We share your Personal Information with third parties that are helping us use your Personal Information, as described above, or who assist us in operating our website, conducting our business, or servicing you, so long as those parties agree to keep this information confidential. We may also release your Personal Information when we believe release is appropriate to comply with the law, to respond to a subpoena, search warrant or other lawful requests for information we receive, or to otherwise protect our rights, enforce our site policies, or protect ours or others rights, property, or safety. However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.

Our 3rd party business partners include, for example:

**Shopify -**  We use Shopify to power our online store. You can read more about how Shopify uses your Personal Information here:[https://www.shopify.com/legal/privacy](https://www.shopify.com/legal/privacy).
...
**MailChimp -** Mailchimp help us manage all of our outgoing email campaigns including abandoned cart emails. You can read more about how Mailchimp uses your Personal Information here: [https://mailchimp.com/legal/privacy](https://mailchimp.com/legal/privacy).

**Instapage -** Instapage helps us create responsive pages for our site. You can read more about how Shogun uses your Personal Information here: [https://instapage.com/security](https://instapage.com/security)

**Shogun** **\-** Shogun helps us create responsive pages for our site. You can read more about how Shogun uses your Personal Information here: [https://www.zendesk.com/company/customers-partners/privacy-policy/](https://www.zendesk.com/company/customers-partners/privacy-policy/)

**Zendesk** - Zendesk helps us maintain relaiable customer support systemr for our company. You can read more about how Shogun uses your Personal Information here:[https://getshogun.com/privacy](https://getshogun.com/privacy).
...
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at support@poweruptoys.com or by mail using the details provided below:

POWERUP Toys - Tailor Toys LLC
