Privacy Policy of **highlandscurrent.org**
==========================================
...
**Owner contact email:** tech@highlandscurrent.org
...
* ### Advertising
    ...
    * a Sharing in California
    ...
    Place of processing: United States – [Privacy Policy](https://business.safety.google/privacy/) – [Opt Out](https://adssettings.google.com/authenticated).
...
* ### Analytics
    ...
    * a Sale in Virginia, Colorado, Connecticut, Utah, Texas, Oregon and Montana
    ...
    Place of processing: United States – [Privacy Policy](https://www.facebook.com/privacy/policy/) – [Opt out](https://www.facebook.com/adpreferences/ad_settings).
...
* ### Displaying content from external platforms
    ...
    * a Sale in California
    ...
    #### Getty Images widget (Getty Images, Inc.)
    
    Getty Images is an image delivery service provided by Getty Images, Inc. that allows this Website to incorporate content of this kind on its pages.
    
    Personal Data processed: Cookies; Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://www.gettyimages.com/company/privacy-policy).
...
* ### Handling payments
    ...
    Personal Data processed: payment info; various types of Data as specified in the privacy policy of the service.
...
* ### Heat mapping and session recording
    ...
    Personal Data processed: clicks; interaction events; session duration.
...
* ### Hosting and backend infrastructure
    ...
    Place of processing: Italy – [Privacy Policy](https://www.iubenda.com/privacy-policy/252372).
...
* ### SPAM protection
    ...
    Place of processing: United States – [Privacy Policy](https://automattic.com/privacy-notice/).
...
* ### iubenda Cookie Solution (consent Cookie)
    ...
    iubenda consent Cookie (\_iub\_cs-X) is set by the iubenda Cookie Solution and stores User preferences related to Trackers in the local domain.
    
* ### iubenda Cookie Solution (remote consent Cookie)
    
    Remote iubenda consent Cookie (\_iub\_cs-X) is set by the iubenda Cookie Solution and stores User preferences related to Trackers under the .iubenda.com domain.
    
* ### iubenda Consent Solution localStorage
    
    iubenda ConS JS library localStorage (IUB\_DATA) temporarily stores pending data in a storage space internal to the User's browser (localStorage) until it's received by the API, then it is deleted.
...
[Show the simplified Privacy Policy](https://www.iubenda.com/privacy-policy/25776182 "Show the simplified Privacy Policy")