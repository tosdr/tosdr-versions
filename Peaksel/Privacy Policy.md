...
| Email address | This data is collected based on your consent when using Google Authentication. | We collect and store your email address for account creation, authentication, and user access. |
