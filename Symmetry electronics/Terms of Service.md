...
Welcome to SymmetryElectronics.com. SymmetryElectronics.com and its affiliates provide their services to you subject to the following conditions. **If you visit or shop at SymmetryElectronics.com, you accept these conditions.** Please read them carefully. In addition, when you use any current or future SymmetryElectronics.com service or visit or purchase from any business affiliated with SymmetryElectronics.com, whether or not included in the SymmetryElectronics.com Web site, you also will be subject to the guidelines and conditions applicable to such service or business. No change, alteration, deletion or modification of any of these terms and conditions is permitted. No person is authorized to accept, confirm or vary these terms and conditions.
...
[Please click here for Payment Terms](https://www.symmetryelectronics.com/about/payment-terms/)

YOUR ACCOUNT
------------

If you use this site, you are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer, and you agree to accept responsibility for all activities that occur under your account or password. SymmetryElectronics.com and its affiliates reserve the right to refuse service, terminate accounts, remove or edit content, or cancel orders in their sole discretion.

PRICING
-------

SymmetryElectronics.com website product listings, specifications and pricing are subject to change without notice. Prices shown are in US Dollars and herein reflect the latest information available at the time. Prices charged will be those prevailing when an order is placed. Prices shown do not include any Federal, State or local taxes or any present or future sales, use, excise, value-added or similar taxes. Where applicable, such taxes shall be billed as a separate item and paid by the customer. Orders are accepted with the understanding that such taxes will be added, as the law requires. SymmetryElectronics.com charges local sales tax, unless a sales tax exemption certificate is on file with SymmetryElectronics.com or Symmetry Electronics Corporation. With respect to items sold by SymmetryElectronics.com, we cannot confirm the price of an item until you order; however, we do NOT charge your credit card until after your order has entered the shipping process. Despite our best efforts, a small number of the items in our website may be mispriced. If we discover a mispricing, we will do one of the following:
...
Upon receiving your order, a sales representative from SymmetryElectronics.com will advise you via email of the delivery time for a product. Your credit card or account will not be charged until your order ships from our warehouse. You may request availability information prior to placing your order by calling our sales desk at (310) 643-3470 or [email us](https://www.symmetryelectronics.com/contact/).

SHIPPING DOMESTIC ORDERS
------------------------

In the event of merchandise returns, this fee will be retained by SymmetryElectronics.com. All orders are shipped via the common carrier selected and freight is PP&A Ex-works Fort Worth, TX. unless other arrangements are made in writing. The calculated shipping and handling charges will be added to your order (PP&A). SymmetryElectronics.com does not ship to P.O. Boxes. Upon shipping an invoice will be emailed to you with a detail of all charges. Title shall pass upon delivery to the carrier at point of shipment and thereafter (ex-works origin), all risk of loss or damage shall be upon the customer.

SHIPPING INTERNATIONAL/EXPORT ORDERS
------------------------------------

Payment for international orders is by credit card or advance wire transfer only. Upon receipt of your order, a proforma invoice will be presented for payment. All products purchased under these terms and conditions are subject to export control laws, restrictions, regulations and orders of the United States of America. The customer agrees to comply with all applicable export laws, restrictions and regulations of the United States or foreign agencies or authorities, and shall not export, or transfer for the purpose of re-export, and product to any prohibited or embargoed country or to any denied, blocked or designated person or entity as mentioned in such U.S. or foreign law or regulation. The customer represents and warrants that it is not on the Denied Persons, Specially Designated Nationals or Debarred Persons list of the U.S. government and is not otherwise prohibited by law from purchasing the products or services hereunder. The customer shall be responsible to obtain any license to export, re-export or import as may be required and is responsible for any and all taxes and duties. All orders are Ex Works (EXW) origin and Title shall pass upon delivery to the carrier at point of shipment and thereafter, all risk of loss or damage shall be upon the customer. Customer is responsible for all local duty and taxes at country of import. If the order is refused or undeliverable, the customer will be liable for outbound and inbound freight (Freight x2). As well as a 20% restocking charge. It is important to determine international fees and deliverability with your local government before placing an order to avoid these charges.

Customer shall not sell, export, or re-export, directly or indirectly, to the Russian Federation or for use in the Russian Federation, any goods supplied by SymmetryElectronics.com that fall under the scope of Article 12g of Council Regulation (EU) 833/2014 (“Article 12g”). In addition, the customer shall maintain a monitoring mechanism to detect conduct by third parties and resellers that may circumvent Article 12g or these Terms and Conditions and shall use its best efforts to ensure that such parties do not attempt circumvention. Any violation of this requirement shall constitute a material breach of an essential element of these Terms and Conditions and SymmetryElectronics.com shall be entitled to seek appropriate remedies, including but not limited to termination of business. Customer agrees to inform SymmetryElectronics.com of any breach of this section, including activities of third parties that attempt to circumvent Article 12g.
...
* Products returned due to customer error or non delivery may be subject to a 25% restocking charge. Special order and custom items or “Non-Cancelable/Non-Returnable” items are not eligible for return.
...
CANCELLATIONS OR RESCHEDULING ORDERS
------------------------------------

Cancellations or rescheduling orders will not be accepted within 30 days of scheduled delivery.

DISCREPANCIES
-------------

Customer shall report all order and invoice discrepancies (e.g., shortages, breakages, etc.) within ten (10) business days of receipt of goods.

PRIVACY
-------

Please review our Privacy Notice, which also governs your visit to SymmetryElectronics.com, to understand our practices.

PROHIBITIONS
------------

Products sold by SymmetryElectronics.com are not authorized or recommended for use in life support systems, surgical implant, nuclear, military or commercial aircraft applications, or for any use or application in which the failure of a single component could cause substantial harm to persons or property. The customer assumes all risk and liability for use in such applications and agrees to indemnify SymmetryElectronics.com and its affiliates for all damages that may be incurred due to the use of these SymmetryElectronics.com products in these prohibited applications.

PRODUCT LIABILITY
-----------------

SymmetryElectronics.com’s sole obligation for products that prove to be defective within 30 days of purchase will be for replacement or refund. SymmetryElectronics.com gives no warranty; either expressed or implied, and specifically disclaims all other warranties. In no event shall SymmetryElectronics.com’s liability exceeds the buyer’s purchase price.

FORCE MAJEURE:
--------------

SymmetryElectronics.com shall not be liable for loss or damage caused by any delay or failure to perform resulting in whole or in part from Acts of God, severe weather conditions, labor disruptions, governmental decrees or controls, insurrections, war, risks, shortages, inability to procure or ship product or obtain permits and licenses, insolvency or other inability to perform by the manufacturer, delay in transportation, any other commercial impracticability and any other circumstances beyond the control of SymmetryElectronics.com in its business operations.

ELECTRONIC COMMUNICATIONS
-------------------------

When you visit SymmetryElectronics.com or send e-mails to us, you are communicating with us electronically. You consent to receive communications from us electronically. We will communicate with you by e-mail or by posting notices on this site. You agree that all agreements, notices, disclosures and other communications that we provide to you electronically satisfy any legal requirement that such communications be in writing.

COPYRIGHT
---------

All content included on this site, such as text, graphics, logos, button icons, images, audio clips, digital downloads, data compilations, and software, is the property of SymmetryElectronics.com or its content suppliers and protected by United States and international copyright laws. The compilation of all content on this site is the exclusive property of SymmetryElectronics.com and protected by U.S. and international copyright laws. All software used on this site is the property of SymmetryElectronics.com or its software suppliers and protected by United States and international copyright laws.

LICENSE AND SITE ACCESS
-----------------------

SymmetryElectronics.com grants you a limited license to access and make personal use of this site and not to download (other than page caching) or modify it, or any portion of it, except with express written consent of SymmetryElectronics.com. This license does not include any resale or commercial use of this site or its contents; any collection and use of any product listings, descriptions, or prices; any derivative use of this site or its contents; any downloading or copying of account information for the benefit of another merchant; or any use of data mining, robots, or similar data gathering and extraction tools. This site or any portion of this site may not be reproduced, duplicated, copied, sold, resold, visited, or otherwise exploited for any commercial purpose without express written consent of SymmetryElectronics.com. You may not frame or utilize framing techniques to enclose any trademark, logo, or other proprietary information (including images, text, page layout, or form) of SymmetryElectronics.com and our affiliates without express written consent. You may not use any meta tags or any other "hidden text" utilizing SymmetryElectronics.com's name or trademarks without the express written consent of SymmetryElectronics.com. Any unauthorized use terminates the permission or license granted by SymmetryElectronics.com. You are granted a limited, revocable, and nonexclusive right to create a hyperlink to the home page of SymmetryElectronics.com so long as the link does not portray SymmetryElectronics.com, its affiliates, or their products or services in a false, misleading, derogatory, or otherwise offensive matter. You may not use any SymmetryElectronics.com logo or other proprietary graphic or trademark as part of the link without express written permission.

PRODUCT DESCRIPTIONS
--------------------

SymmetryElectronics.com and its affiliates attempt to be as accurate as possible. However, SymmetryElectronics.com does not warrant that product descriptions or other content of this site is accurate, complete, reliable, current, or error-free. If a product offered by SymmetryElectronics.com itself is not as described, your sole remedy is to return it in unused condition.

INTELLECTUAL PROPERTY RIGHTS
----------------------------

The products offered for sale by SymmetryElectronics.com may be subject to patent, trademark, copyright, design or other rights of third parties. SymmetryElectronics.com shall in no event whatsoever be responsible or liable in the event of any claim of infringement of any such rights.

DISPUTE RESOLUTION:
-------------------

Actions by SymmetryElectronics.com for nonpayment by the customer for the purchase price of products sold by SymmetryElectronics.com, or for redress of other breaches by the customer of these terms and conditions of sale may be brought by SymmetryElectronics.com, at its option, before any U.S. or foreign judicial court of competent jurisdiction or at SymmetryElectronics.com’s option, disputes between SymmetryElectronics.com and the customer including all claims for non-performance by SymmetryElectronics.com , shall be finally settled by arbitration in Los Angeles California, U.S.A. under the Commercial Rules of the American Arbitration Association, by a single arbitrator appointed in accordance with said Rules applying these Terms and Conditions of Sale and consistent provisions of the federal and state laws (except conflict of law rules) of the State of California, U.S.A.

DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY
----------------------------------------------------

THIS SITE IS PROVIDED BY SymmetryElectronics.com ON AN "AS IS" AND "AS AVAILABLE" BASIS. SymmetryElectronics.com MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THIS SITE OR THE INFORMATION, CONTENT, MATERIALS, OR PRODUCTS INCLUDED ON THIS SITE. YOU EXPRESSLY AGREE THAT YOUR USE OF THIS SITE IS AT YOUR SOLE RISK.

TO THE FULL EXTENT PERMISSIBLE BY APPLICABLE LAW, SymmetryElectronics.com DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE. SymmetryElectronics.com DOES NOT WARRANT THAT THIS SITE, ITS SERVERS, OR E-MAIL SENT FROM SymmetryElectronics.com ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. SymmetryElectronics.com WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND ARISING FROM THE USE OF THIS SITE, INCLUDING, BUT NOT LIMITED TO DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, AND CONSEQUENTIAL DAMAGES.
...
By visiting SymmetryElectronics.com, you agree that the laws of the state of California, without regard to principles of conflict of laws, will govern these Conditions of Use and any dispute of any sort that might arise between you and SymmetryElectronics.com or its affiliates.
