...
Our Services may be accessed from all around the world, so it is your responsibility to assess whether your use of the Services is in compliance with applicable laws and regulations. You may not be able to access the Services if you are located in any of the countries where using, accessing, or subscribing to the Services would violate our [Export Control Policy](https://cms.kape.com/p/tos/export-control-policy).
