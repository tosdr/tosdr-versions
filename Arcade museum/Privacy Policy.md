...
3. Privacy Policy
 ...
 [![Share on Facebook](/images/social-facebook-24.png)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy)[![Share on Reddit](/images/social-reddit-24.png)](https://www.reddit.com/submit?url=https%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy)[![Share on Twitter](/images/social-twitter-24.png)](https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy)[![Share on Messenger](/images/social-facebook-messenger-24.png)](fb-messenger://share/?link=https%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy)[![Share on Whatsapp](/images/social-whatsapp-24.png)](whatsapp://send?text=I%20found%20this%20fun%20retro%20page%20at%20the%20Museum%20of%20the%20Game%20(KLOV):%0A%0Ahttps%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy%0A%0A)[![Share on Telegram](/images/social-telegram-24.png)](https://t.me/share/url?url=I%20found%20this%20fun%20retro%20page%20at%20the%20Museum%20of%20the%20Game%20(KLOV):%0A%0Ahttps%3A%2F%2Fwww.arcade-museum.com%2Fprivacy-policy%0A%0A)[\[email protected\]](https://www.arcade-museum.com/cdn-cgi/l/email-protection)
...
WebMagic, Inc. ("WebMagic") respects your private information and utilizes the following practices ("Privacy Policy") in regards to the collection and use of any information we are provided about the users of the WebMagic web sites. Please review this Privacy Policy prior to using our websites, and in particular before posting any personal information to them since our Privacy Policy may be changed periodically without notice to you. Additionally, our online Terms of Use describe the obligations and restrictions that you agree to in exchange for being allowed to use our services. They are a legally binding contract between you and us. This Privacy Policy applies to all the products, services, and websites offered by WebMagicand governs data collection and usage. Specific products, services, and websites may have additional and over-riding written policies. Additionally, content made available for licensing will be subject to our license policy. For the purposes of this Privacy Policy, unless otherwise noted, all references to WebMagic include all our products, services and websites (collectively, the services). By using the WebMagic services, you consent to the data practices described in this statement.

By using our services and providing personal information to WebMagic, you are agreeing to allow us to collect and utilize this information as you use our web sites, and you are agreeing to allow us to disclose that information and details of any transactions with WebMagic's offices, subsidiaries, affiliates, and payment processors. Due to the structure of the Internet, such data may pass through any country.

**Collection of your Personal Data**

In order to provide services, WebMagic may require you to provide certain information to us, and WebMagicmay collect other information automatically. Common items may include, but are not limited to, your name, company name, address, email, phone number, credit card information (ie: on ecommerce sites), search preferences, and preferred password. Ecommerce and message forum offerings in particular collect a variety of user data.

Some pieces of data shall be provided optionally, and some are required as a condition for registration. Required pieces of information vary depending upon the individual web site or service requested. For the few services on our network that require payment, we request credit card or other payment account information which we may maintain on our servers.

We may combine the information you submit under your account with information from our other services or third parties in order to provide you with a better experience and to improve the quality of our services. For certain services, we may give you the opportunity to opt out of combining such information. We may gather additional personal or non-personal information in the future.
...
WebMagic collects, stores and uses your personal information to operate its website(s) and to deliver the services you have requested.

WebMagic may also contact you via surveys to conduct research about your opinion of current services or of potential new services that may be offered.

WebMagic may also use your personally identifiable information to inform you of other products or services available from WebMagicand its affiliates.

WebMagic may keep track of the websites and pages our users visit within our network, in order to determine which WebMagic services are the most popular. This data is used to deliver customized content and advertising within WebMagic to customers whose behavior indicates that they are interested in a particular subject area.

Our Privacy Policy exists to protect all our visitors and our sites--not the rare individual with evil intent. If we, in our sole discretion, believe that any visitor(s) has or has had dishonorable intentions against us or other users on our network, we reserve the right to use any of your information in any way we see fit, in particular in ways to protect us, our other users, and society as a whole, and to inform and educate our other users. This includes any users who we suspect are spamming us or our users, data mining our sites, attempting fraud against us or our users, harassment of us or our users, or any other activity which we deem to be anti-social. In the past, we have felt the need to take this action against well less than 1/10 of 1% of our visitors. When it does happen, it usually involves a visitor trying to bring harm to message forums or other users on message forums.
...
WebMagic may from time to time contact you on behalf of external business partners about a particular offering that may be of interest to you. In those cases, your unique personally identifiable information (such as e-mail address, name, mailing address, or phone number) is not transferred to the third party.

WebMagic may share your data with trusted partners to help perform payment processing, security services, statistical analysis, email servicing, postal mail, customer support, surveys, direct marketing, or to arrange for deliveries. Service providers will only be provided such information as is related to their roles in assisting WebMagic. Except as authorized by you, all such third parties are prohibited from using your personally identifiable information except to provide these services to WebMagic, and they are required to maintain the confidentiality of such information.

WebMagic's pages may include advertising operated and controlled by third parties, in particular Google and Yahoo. Their own privacy policies likely apply to this sponsored content.

Except as otherwise noted in this Privacy Policy or as you authorize, WebMagic does not disclose or release personally identifiable information to third parties; provided that, to the extent permitted by law, WebMagic may use or disclose personal information: (a) for compliance purposes, such as for customs control, security, and legal support; (b) in connection with legal requests from (i) governmental authorities or (ii) third parties pursuant to a subpoena or other legal process; (c) to perform payment or identity verifications, debt reporting or collection, or to otherwise protect the rights or property of WebMagic, its officers, employees, customers, affiliates, or end users, or (d) if we sell or otherwise transfer substantially all of our assets related to any website that we own or operate or any product or service that we offer, in which event, we will require such third party to honor our current Privacy Policy, until the third party provides you with notice of changes to the Privacy Policy and permits you to exercise any rights you may have under applicable law to limit disclosures of information about you.

Beyond the policies listed herein, WebMagic will disclose your personal information, without notice, only if required to do so by law or in the good faith belief that such action is necessary to: (a) conform to the edicts of the law or comply with legal process served on WebMagic or its sites; (b) protect and defend the rights or property of WebMagic; and (c) act under exigent circumstances to protect the personal safety of users of WebMagic, or the public.

**Web Page Links**

We do not control, nor are we responsible for, the practices employed by sites linked to or from our web sites or the information or content contained therein. Often links to other sites are provided solely as pointers to information on topics that may be useful to the users of our website. We do not endorse, approve, certify or control these sites and we do not guarantee the accuracy of the information presented on any third party site. Our Privacy Policy is not applicable to third party sites. WebMagic encourages you to review the privacy statements of websites that link to, or are linked from, WebMagic's sites so that you can understand how those websites collect, use and share your information.

**Browser Cookies**

When you visit WebMagic sites, our servers may send one or more cookies - a small file that contains a string of characters - to your browser. These cookies help to uniquely identify your browser and to improve the quality of our services. Cookies cannot be used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you, and can typically only be read by a web server in the domain that issued the cookie to you. One of the primary purposes of cookies is to provide a convenience feature to save you time. The purpose of a cookie is to tell the Web server that you have returned to a specific site or page. WebMagic uses cookies to allow you to log in and stay logged into our sites, to store user preferences, to track trends, to troubleshoot customer support issues, to provide customized content and search results, and to otherwise create and provide the highest quality of services we can. On some of our sites, they are required for even basic functioning of the site to work. Additionally, for pages that contain advertising, our advertising partners (usually Yahoo or Google) may set their own browser cookies. With the use of cookies, when you return to the same WebMagic website, the information you previously provided can often be retrieved, so you can easily use the WebMagic features that you customized.
...
**Browser Cookies - Third Party Advertising, Analytics, and Tools**
...
WebMagic's websites and the content therein are intended for use by persons age 16 and older for visitors from Europe, and by persons age 13 and older in all other regions. WebMagicdoes not knowingly collect personally identifiable information from children under the age of thirteen. Anyone under the age of 16 in Europe and under the age of 13 elsewhere should not establish an account on our sites and should not provide any personal information to WebMagic. Additionally, will may provide additional restrictions for all visitors between our minimal ages and 17. Anyone under the age of 18 should not conduct any financial transaction on or through our sites, nor shall advertise for, or respond to advertising for, any financial transaction on our site, nor should provide any financial data such as credit card numbers.

**User communications**

When you send email or other communications to WebMagic, we may retain those communications in order to process your inquiries, respond to your requests, track pending issues, and improve our services. When you sign-up for an account, we will send you a validation email that contains a link that you will need to click on before you may use your free account. Additionally, if you join one of our message forums, you have the option (not the default) of receiving notices of updates to threads you have expressed interested, and/or notices of incoming private messages from other users. If you no longer wish to receive these forum message, turn the option off on the same settings page in which you turned it on in the first place (access via the forum user control panel or clicking the opt-out link at the bottom of any subscription email). A few of our business to business web sites (such as www.efootage.com) may send out weekly (or less frequent) emails to members that have specifically requested them. Each email has a link at the bottom you can click if you no longer wish to receive these weekly newsletters.

**Links**

WebMagic may present links in a format that enables us to keep track of whether these links have been followed. We use this information to improve the quality of our offerings, customized content, and advertising.
...
**Account Closures and Removal of Data**

An account closure, initiated by either you or us, may not result in the deletion of all your data. If you are utilizing one of our sites which allow users to post personal information publicly, such as in the form of a personal profile, please feel free to make specific requests regarding working to remove any such information. We will review such requests on a case-by-case basis. Please do not ask us to delete messages in bulk that you posted to public message forum threads, as it is typically not possible to remove such messages without damaging the context of the message threads in which they appear. In general, we are unable and unwilling to remove public posts on discussions forums, but are able to edit posts upon requests them to remove your name or contact information, and alter usernames if you originally chose a username that is identical to your first and last name. Personally identifiable contact information in our databases is deleted if and as required by law, however, we do not delete data for the very few users suspected of utilizing our systems to break laws or defraud others.

**Policy Changes**

We reserve the right to change the terms of this privacy policy at any time. Furthermore, we expect to make periodic changes to it. When we do, the only notice of said changes will occur on the policy itself. When we make changes, we will revise the "last updated" date at the top of the policy. WebMagic encourages you to review this policy whenever you visit our website, or at least when you intend to specifically post personal data to it.

**Privacy Policy Contacts**

If you have questions or comments about this Privacy Policy, or if you have any concerns about our implementation of same, please feel free to contact us at:

Privacy and Data Department  
WebMagic, Inc.  
...
Please note that email may be get lost or caught up in spam protection measures. As such, if you do not receive an anticipated response to an email about this Policy, please feel free to contact us by postal mail.

**Terms of Use**

Your use of our web site or other services constitutes an acceptance of our [Privacy Policy](https://www.arcade-museum.com/privacy-policy) as well as our [Terms of Use](https://www.arcade-museum.com/terms-of-use).
