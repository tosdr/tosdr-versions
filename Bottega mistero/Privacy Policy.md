Privacy Policy di **bottegamistero.com**
========================================
...
Questo documento contiene [una sezione dedicata ai consumatori della California e ai loro diritti relativi alla privacy](#california_info).

Questo documento contiene [una sezione dedicata ai consumatori della Virginia e ai loro diritti relativi alla privacy](#virginia_info).

Questo documento contiene [una sezione dedicata ai consumatori del Colorado e ai loro diritti relativi alla privacy.](#colorado_info)

Questo documento contiene [una sezione dedicata ai consumatori del Connecticut e ai loro diritti relativi alla privacy.](#connecticut_info)

Questo documento contiene [una sezione dedicata ai consumatori dello Utah e ai loro diritti relativi alla privacy.](#utah_info)

Questo documento contiene [una sezione dedicata agli Utenti in Svizzera e ai loro diritti alla privacy](#fadp_info).

Questo documento contiene [una sezione dedicata agli Utenti residenti in Brasile e ai loro diritti relativi alla privacy](#brazil_info).
...
**Indirizzo email del Titolare:** bottegamistero@gmail.com

Tipologie di Dati raccolti
--------------------------

Fra i Dati Personali raccolti da questo Sito Web, in modo autonomo o tramite terze parti, ci sono: Cookie; Dati di utilizzo; email; username; sito web; nome; varie tipologie di Dati.
...
* ### Commento dei contenuti
    ...
    Dati Personali trattati: Cookie; email; sito web; username.
    
    Categoria di informazioni personali raccolte ai sensi del CCPA: identificatori; informazioni su relative alle attività su internet o altri network.
    
    Questo tipo di trattamento costituisce:
    
    * una vendita ai sensi del CPA, CTDPA e UCPA
    * pubblicità mirata ai sensi del CPA, CTDPA e UCPA
    
    #### Sistema di votazioni e sondaggi
    
    I sistemi di votazione e sondaggi gestiti dal sito potrebbero registrare l'indirizzo IP per evitare scelte multiple da parte dello stesso utente.
    
    Questo tipo di trattamento costituisce:
    
    * una vendita ai sensi del CCPA, VCDPA, CPA, CTDPA e UCPA
    * una condivisione ai sensi del CCPA
    * pubblicità mirata ai sensi del VCDPA, CPA, CTDPA e UCPA
...
* ### Contattare l'Utente
    ...
    * una vendita ai sensi del VCDPA, CPA, CTDPA e UCPA
    
    #### Modulo di contatto (questo Sito Web)
    
    L’Utente, compilando con i propri Dati il modulo di contatto, acconsente al loro utilizzo per rispondere alle richieste di informazioni, di preventivo, o di qualunque altra natura indicata dall’intestazione del modulo.
    
    Dati Personali trattati: email; nome; varie tipologie di Dati.
    
    Categoria di informazioni personali raccolte ai sensi del CCPA: identificatori; informazioni su relative alle attività su internet o altri network.
    
    Questo tipo di trattamento costituisce:
    
    * una vendita ai sensi del VCDPA
...
* ### Gestione dei feed RSS
    ...
    Feedburner è un servizio di gestione dei feed RSS fornito da Google LLC oppure da Google Ireland Limited, a seconda di come il Titolare gestisce il trattamento dei Dati. che permette di raccogliere dati statistici sulla consultazione dei contenuti e di integrare annunci pubblicitari all'interno di essi.
    
    Dati Personali trattati: Dati di utilizzo; Strumenti di Tracciamento.
    
    Luogo del trattamento: Stati Uniti – [Privacy Policy](http://www.google.com/intl/it/policies/privacy/); Irlanda – [Privacy Policy](https://policies.google.com/privacy).
    ...
    * una vendita ai sensi del CCPA, CPA, CTDPA e UCPA
    * pubblicità mirata ai sensi del CPA, CTDPA e UCPA
...
* ### Gestione dei pagamenti
    ...
    Questo Sito Web non è coinvolta nella raccolta e nell'elaborazione di tali informazioni: riceverà invece solo una notifica da parte del fornitore di servizi di pagamento in questione circa l'avvenuto pagamento.
    ...
    Luogo del trattamento: Consulta la privacy policy di Paypal – [Privacy Policy](https://www.paypal.com/webapps/mpp/ua/privacy-full).
...
* ### Ottimizzazione e distribuzione del traffico
    ...
    Luogo del trattamento: Stati Uniti – [Privacy Policy](https://www.cloudflare.com/privacypolicy/).
...
* ### Pubblicità
    ...
    Google AdSense è un servizio di advertising fornito da Google LLC oppure da Google Ireland Limited, a seconda di come il Titolare gestisce il trattamento dei Dati. Questo servizio usa il Cookie “DoubleClick”, che traccia l’utilizzo di questo Sito Web ed il comportamento dell’Utente in relazione agli annunci pubblicitari, ai prodotti e ai servizi offerti.  
    L’Utente può decidere in qualsiasi momento di disabilitare tutti i cookie DoubleClick andando su: [Impostazioni Annunci](https://adssettings.google.com/authenticated?hl=it).
    
    Per una comprensione dell'utilizzo dei dati da parte di Google, si prega di consultare le [norme per i partner di Google](https://policies.google.com/technologies/partner-sites).
    
    Dati Personali trattati: Cookie; Dati di utilizzo.
    
    Luogo del trattamento: Stati Uniti – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://adssettings.google.com/authenticated?hl=it); Irlanda – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://adssettings.google.com/authenticated#display_optout).
...
* ### Statistica
    ...
    Luogo del trattamento: Stati Uniti – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://tools.google.com/dlpage/gaoptout?hl=it); Irlanda – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://tools.google.com/dlpage/gaoptout?hl=en).
    ...
    * pubblicità mirata ai sensi del CPA, CTDPA e UCPA
    ...
    Luogo del trattamento: Stati Uniti – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://tools.google.com/dlpage/gaoptout?hl=it%22); Irlanda – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://tools.google.com/dlpage/gaoptout?hl=it%22).
...
* ### Visualizzazione di contenuti da piattaforme esterne
    ...
    * pubblicità mirata ai sensi del CPA, CTDPA e UCPA
    ...
    Mapbox è un servizio di visualizzazione di mappe gestito da Mapbox Inc. che permette a questo Sito Web di integrare tali contenuti all’interno delle proprie pagine.
    
    Dati Personali trattati: Cookie; Dati di utilizzo.
    
    Luogo del trattamento: Stati Uniti – [Privacy Policy](https://www.mapbox.com/privacy/).
...
Questo Sito Web fa utilizzo di Strumenti di Tracciamento. Per saperne di più, gli Utenti possono consultare la [Cookie Policy](https://www.iubenda.com/privacy-policy/420485/cookie-policy "Cookie Policy").
...
[Visualizza la Privacy Policy semplificata](https://www.iubenda.com/privacy-policy/420485 "Visualizza la Privacy Policy semplificata")