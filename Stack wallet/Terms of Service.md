...
These Terms of Use ("**Terms**") are entered into by you and Stack Wallet LLC, a New Mexico limited liability company ("**Stack Wallet**," "**Company**," "**us**," "**our**," and "**we**"), and set forth the legally binding terms and conditions that govern your use and access to our website located at [https://stackwallet.com](https://stackwallet.com/) (the "**Website**") and our smobile device application, Stack Wallet (the "**Mobile Application**"; together with the Website, collectively, the "**Application**"), including related trademarks, software code, and other intellectual property, and any services we provide through the Application (the "**Services**"). These Terms expressly cover your rights and obligations, and our disclaimers and limitations of legal liability, relating to your use of, and access to, the Application.

The Application is a copyrighted work belonging to Stack Wallet. Please refer to our Privacy Policy (our "**Privacy Policy**") for information on how we collect, use, and disclose information from our users. You acknowledge and agree that your use of the Services is subject to, and we can collect, use, and/or disclose your information (including any personal data you provide to us) in accordance with, our Privacy Policy. All such additional terms, guidelines, and rules, including our Privacy Policy, are incorporated by reference into these Terms.

By clicking "I agree" or by accessing or using the Application, you are accepting these terms (on behalf of yourself or the entity that you represent, including without limitation, the mandatory arbitration provision in Section 11. If you do not agree with all of the provision of these terms or our Privacy Policy, do not access or use the Application.
...
**1.2.** We do not charge any fees for your use of the Application. However, through the Application, you may gain access to services provided by a third party. The fees and price estimates in connection with your use of those third-party services are not governed by these Terms, but are instead governed by the terms of use of the applicable third parties providing such services. We recommend that you review the terms and conditions of such third parties carefully before using any services provided by such third parties.
...
**2.1.** You may not use the Application to engage in the categories of activity set forth below ("**Prohibited Uses**"). The specific activities set forth below are representative, but not exhaustive, of Prohibited Uses. If you are uncertain as to whether or not your use of the Application involves a Prohibited Use or have other questions about how these requirements apply to you, then please contact us at [\[email protected\]](https://stackwallet.com/cdn-cgi/l/email-protection). By using the Application, you confirm that you will not use the Application to do any of the following:
...
**4.2.** The Services may incorporate, or provide access to, applications or materials that are hosted by a third party, including but not limited to cryptocurrency exchanges such as [ChangeNow](https://changenow.io/) ("**Third-Party Providers**"). You understand and agree that all cryptocurrency exchanges and information provided through the Services are executed by Third-Party Providers, and that Stack Wallet does not itself directly exchange virtual currencies or provide information relating to any crypto asset prices. Access to Third-Party Providers may be geo-blocked for residents of certain countries and certain states of the United States.

**4.3.** Third-Party Providers may require you to share certain personal information in order to provide with you with their services subject to the terms and conditions of each relevant Third-Party Provider, including any such information the Third-Party Providers may require for "Know-Your-Customer" purposes in order to comply with the relevant laws or regulations to which such Third-Party Providers may be subject. Unless otherwise set forth in Stack Wallet's Privacy Policy, Stack Wallet does not collect or control any such personal information collected by Third-Party Providers. We do not control the terms, policies, or performance of any third party, and are not responsible for any performance, or failure to perform, of any third-party software, website, or services, including pricing information, exchange rates, processing of crypto asset purchases, and similar activities. We do not provide customer support for transactions performed on Third-Party Providers' software, website, or services.
...
**13.9.** We welcome feedback, comment, ideas, and suggestions for improvements to the Services ("**Feedback**"). You can submit Feedback by emailing us at [\[email protected\]](https://stackwallet.com/cdn-cgi/l/email-protection). You grant to us a non-exclusive, worldwide, perpetual, irrevocable, fully-paid, royalty-free, sublicensable and transferable license under any and all intellectual property rights that you own or control to use, copy, modify, create derivative works based upon and otherwise exploit the Feedback for any purpose.

![](/img/stack-logo-full.svg)

* [](https://t.me/stackwallet)
* [](https://discord.gg/mRPZuXx3At)
* [](https://www.reddit.com/r/stackwallet/)
* [](https://twitter.com/stack_wallet)
...
Most wallets were some combination of the above, but never all of them at once. Enter Stack Wallet, the first multicoin, open-source wallet, that sticks to its ideals, and looks good doing it.

Copyright © 2022 Stack Wallet LLC

[RSS Feed](https://stackwallet.com/feed.xml)

[Terms of service](https://stackwallet.com/terms-of-service.html)

[Privacy policy](https://stackwallet.com/privacy-policy.html)

[Codebase](https://github.com/cypherstack/stack_wallet)