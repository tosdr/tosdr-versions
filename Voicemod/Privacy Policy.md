...
Allow us to give a quick introduction. Voicemod is the proud owner of the domain name voicemod.net and all the websites hosted there. This privacy policy is a part of our General Terms of Use (TOU), and applies to how we handle your personal data whenever you use our websites, products, services, and applications (AKA any Voicemod Products).

If there’s one thing we want you to take away from this, it’s that we care about your privacy and are committed to protecting your information. This policy explains how we collect and process your data, making sure we comply with all the relevant regulations, like the European General Regulation on Data Protection (GDPR).

The access, use and maintenance of Voicemod Products involves the processing of personal information of its users according to the purposes informed in this policy.

By accessing and using Voicemod’s Products, you’re agreeing to the terms and conditions laid out in our policy. For any information  you provide or we collect from you, by using our Voicemod Products you accept that we’ll use it for the purposes we’re about to outline below and that you’ll follow our conditions and policies.

It’s important that you read this policy carefully to fully understand how we handle your data. We also encourage you to check back regularly for any updates or changes we may make.
...
* Community Content Hub -Community voices and Community sounds- (previously known as Tuna)
* Voicemod Go
...
**Purpose:** Managing copyright infringement notices
...
**Purpose:** provide you with the Voicemod Desktop service
...
**Purpose**: provide you with the services in the Controller app (i.e. to control Voicemod Desktop from your mobile device).
...
**Purpose:** Provide you with the Products and App’s services
...
**Purpose:** Provide you with the services
...
**Purpose:** Provide you with our services to be enjoyed in a Telegram-like app
...
We mainly work with American vendors with servers all around the globe and mostly in Europe, which privacy rules are applicable to us due to our seat in Spain. However it’s also possible that personal data processing is carried out in other countries where our suppliers operate, including the United Kingdom, for example. In these instances, the processors involved are responsible for ensuring that your data is protected.

For EEA residents, please note that our international transfers outside the EEA either rely on the European Commission Standard Contractual Clauses which we sign with every vendor or the European Commission’s Adequacy Decisions on specific countries. In short, we make sure everything meets the GDPR’s standards, so your data is always in good hands.
...
That being said, although we do everything we can to protect your information, no security system is 100% foolproof. So, in the unlikely event that there is a breach or unauthorised access, Voicemod will not be liable. But rest assured, anyone working with Voicemod who needs access to your data is required to follow strict regulations to keep it safe. We don’t mess around with our users and their rights.
...
**Legal basis:**  Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract 
...
**Legal basis:** Consent by the data subject (you) to the processing of his or her (your) personal data for the purposes hereinafter mentioned
