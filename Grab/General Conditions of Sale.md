...
1.2 Grab may amend the terms in the Agreement at any time. Such amendments shall be effective once they are posted on [http://www.grab.com](http://www.grab.com/) or the Application. It is your responsibility to review the Terms of Service and Grab Policies regularly. Your continued use of the Service after any such amendments, whether or not reviewed by you, shall constitute your agreement to be bound by such amendments.

1.3 If you use the Service in a country other than the country where you registered for the Application (the “**Alternate Country**“), you must regularly review the Terms of Service applicable in the Alternate Country which can be found at [https://www.grab.com](https://www.grab.com/) as it may differ from the country where you registered for the Application. By using the Service in the Alternate Country, you agree to be bound by prevailing Terms of Service in the Alternate Country.

1.4 GRAB IS A **TECHNOLOGY COMPANY** WHICH PROVIDES A PLATFORM FOR CONSUMERS TO VIEW, OBTAIN OR PROCURE GOODS AND SERVICES. DEPENDING ON THE GOODS OR SERVICES IN QUESTION, THE GOODS OR SERVICES MAY BE SUPPLIED BY GRAB OR A PARTNER. WHERE THE GOODS/SERVICES ARE OFFERED AND/OR PROVIDED BY A PARTNER, GRAB’S ROLE IS MERELY TO LINK THE CONSUMER WITH SUCH PARTNERS OR TO ENABLE CONSUMERS TO VIEW INFORMATION IN RESPECT OF THE PARTNER’S GOODS/ SERVICES. GRAB IS NOT RESPONSIBLE FOR THE ACTS AND/OR OMISSIONS OF ANY PARTNER OR INFORMATION RELATING TO THE SAME. PARTNERS SHALL BEAR ALL LIABILITY IN RELATION TO SUCH GOODS/SERVICES. PARTNERS ARE NOT, AND SHALL NOT HOLD THEMSELVES OUT TO BE, AN AGENT, EMPLOYEE OR STAFF OF GRAB AND THE SOLUTIONS PROVIDED BY PARTNERS SHALL NOT BE DEEMED TO BE PROVIDED BY GRAB.
...
2.4.2 Grabcar Pte Ltd in relation GrabCar, GrabShare, JustGrab, GrabFamily, GrabAssist, GrabPet, Hire, GrabHitch, GrabCoach, GrabFood, GrabExpress (including GrabAssistant) and GrabMart;
...
2.4.7 the relevant subsidiary, affiliate, associated company of or entity jointly controlled by Grabtaxi Holdings Pte Ltd.

2.5. “**Grab Policies**” means the following:

2.5.1 the [Privacy Notice](https://www.grab.com/sg/terms-policies/privacy-notice/);

2.5.2 the [Code of Conduct: Driver/Delivery Partner](https://www.grab.com/sg/terms-policies/code-of-conduct-driver/), [Code of Conduct: Consumer](https://www.grab.com/sg/terms-policies/code-of-conduct-consumer/), [Code of Conduct: Supplier](https://www.grab.com/sg/terms-policies/code-of-conduct-suppliers/) or [Code of Conduct: Merchant](https://www.grab.com/sg/terms-policies/code-of-conduct-merchant/), as may be applicable; 

2.5.3 the [Copyright Notice](https://www.grab.com/sg/terms-policies/copyright-notice/); 

2.5.4 the [Family Account: Terms of Service](https://www.grab.com/sg/terms-policies/family-account/);

2.5.5 the [GrabChat Guidelines](https://www.grab.com/sg/terms-policies/grabchat-guidelines/); 

2.5.6 all policies, guidelines and terms of service published on [https://www.grab.com/sg/terms-policies/](https://www.grab.com/sg/terms-policies/); and

2.5.7 all other forms, policies, notices, guidelines, frequently asked questions (FAQs), in-app or website product/service descriptions and information cards, or agreements provided to or entered into by you from time to time;
...
2.10 “**Privacy Notice**” means our Privacy Notice accessible at: [https://www.grab.com/sg/privacy/](https://www.grab.com/sg/privacy/) as amended from time to time;
...
2.14.12 GrabExpress (including GrabAssistant);
...
6.1.6 **Driver’s Credit Balance**: In addition to your Driver’s Cash Balance, you must also maintain with Grab a **Driver’s Credit Balance**. The Driver’s Credit Balance comprises a pre-payment to Grab by you of Grab service fees and other fees and charges applicable under these Terms of Service. You must at all times maintain a minimum credit balance (“**Minimum Balance**”) in your Driver’s Credit Balance in order for you to use the Service. The amount of such Minimum Balance shall be prescribed by Grab, and shall be notified to you via the Application. It may be changed at any time at Grab’s sole discretion.
...
7.2.3 If you feel you were incorrectly charged a Cancellation Fee, you may contact Grab via [Help Centre](https://help.grab.com/hc/en-sg/) on Grab’s website for assistance. Grab reserves its absolute discretion to any refunds to you and such refunds may be credited to the payment card you used for the journey, or to your GrabPay Wallet or by such other method as is deemed reasonable by Grab.
...
8.2 The terms of the GrabRewards Loyalty Programme will be governed by the GrabPay Terms of Service, accessible via the [https://www.grab.com/sg/terms-policies/payment-rewards/](https://www.grab.com/sg/terms-policies/payment-rewards/) website.
...
9.3 Any complaints between Partners and Consumers must be taken up with each other directly.

9.4 Please contact our [Help Center](https://help.grab.com/passenger/en-sg/) if you have any questions or comments in relation to the Platform.

**10\. Estimated Timings for Partners and Consumers**

10.1 All delivery times, arrival times or pick-up times shown to you on the Platform (as may be applicable to the Solution or Service) are estimates only. Actual delivery, arrival or pick-up times may vary.
...
20.1.5 Number Masking. Under GrabLite, there will be no number masking. This means that your number will be available to Partners. By continuing to confirm the booking, you hereby acknowledge that you understand and agree to this condition.

20.1.6 No GrabRewards Points. Any ride booked via GrabLite will not be entitled to any GrabRewards Points.

20.1.7 No Chat Function. The chat function in GrabLite will be disabled. Therefore, the only means of communication with the Partners will need to be conducted via calls.
...
1.1.1 The Platform allows you to (1) place orders for goods and products (including but not limited to food and beverage) made available for sale on the Platform (“**Goods**“) from Partners who are merchants or other merchants which at your option when placing the order(s), may be delivered to you by Partners who are delivery-partners or may be made available for pick-up (if such pick-up option is available) from the respective merchants during the time period as specified in the Platform or otherwise communicated by Grab; and (2) view Third Party Content such as reviews or general information about restaurants or shops that have no relationship with Grab. Grab does not control any of these Partners, or Goods or services provided by them; Third Party Content or third parties related to the same per Clause 16 above. You understand that any order that you place shall be subject to the product availability and location serviceability on the part of the Partners.
...
1.2 **For GrabMart- Best Match Consumers**

By selecting the “Best Match” option (“Best Match”), you agree and acknowledge that:

1.2.1 You agree and authorise the Merchant to choose a replacement item on your behalf (“Replacement Item”), when your originally selected item (“Original Item”) is unavailable. Upon selecting the Best Match option, you voluntarily and consciously release the responsibility of selecting the Replacement Item to the Merchant and accept the discretion of Merchant in providing a reasonable substitute.

1.2.2 The Replacement Item will be chosen at the Merchant’s absolute discretion. The Merchant is under no obligation and makes no representation or warranty that the Replacement Item will satisfy any of your specific intended purpose nor cater to your dietary needs, requirements or preferences.

1.2.3 The cost of the Replacement Item may be higher or lower than the cost of the Original Item. In the event Replacement Item is priced higher than the Original Item, you will be obligated to pay the Replacement Item price irrespective of your non selection.  The total maximum increase in the value of the order, will  be capped at 20%. 

1.2.4 Grab and any of its directors, officers, employees, agents or affiliates shall not be liable for any and all claims, losses, liabilities, expenses, damages, costs, or any similar charges or costs suffered or incurred by you or any third party with the use or consumption of the Replacement Item chosen by the Merchant including but not limited to any and all claims, losses, liabilities, expenses, damages, costs, or any similar charges or costs arising from personal/ bodily injury, foodborne illness, food poisoning, and death. 

1.2.5 To the fullest extent permitted by the applicable laws, the total aggregate liability of Grab and any of its directors, officers, employees, agents or affiliates howsoever arising from or in connection with the Best Match shall not exceed SGD30.

1.2.6 If you find the quality, suitability, or condition of the Replacement Item unsatisfactory and seek a refund, Grab will process your request in accordance with Grab’s refund policies. 

**1.3 For GrabFood/GrabMart (Delivery-Partners):**
...
**2\. GrabExpress (including GrabAssistant)**

**2.1** **For GrabExpress (including GrabAssistant) Partners:**
...
* Fragile or breakable items (including but not limited to: flowers, cakes, glass items, laboratory materials, porcelain items, valuable collectibles)
...
* Illegal items and substances (e.g. illegal drugs, pornographic magazines and imitation weapons)
* Tobacco products
...
* Any item(s) of an aggregate value exceeding **SGD 500** (Singapore Dollars Five Hundred)
* Letters weighing 500g and below

**2.2** **For GrabExpress (including GrabAssistant) Consumers:**
...
2.2.2 Where applicable, you represent and warrant that you are either the owner or authorised representative of the owner of the delivery item, and that you are authorised to accept and you accept these Terms of Service for yourself or as a representative acting for and on behalf of the owner of the delivery item.
...
2.2.10 You acknowledge that in the ordinary course of delivering the item, the Partner may disclose your details to the recipient. GrabExpress (including GrabAssistant) is not provided as an anonymous service. Therefore, you are solely responsible in determining your choice of recipient and Grab shall not be liable or be responsible for any losses (direct or indirect) suffered by or caused to you or arising out of or in connection with or by reason of your expectation of anonymity through the use of GrabExpress (including GrabAssistant).
...
Creation and monitoring of self-funded marketing activities is a self-serve service available in the Marketing Manager Services platform. In the event you choose to utilize such self-serve services, you shall comply and be subject to the terms stipulated under the [Marketing Manager Service Terms](https://www.grab.com/sg/terms-policies/marketing-manager-service-terms/).
...
* The start and end dates of your ad campaign must reflect the duration of the offer or the saving period so that ads do not run on dates when the offer or the savings do not apply.
* Campaigns must be scheduled to end on the last day of the promotion.
* Campaign dates for a specific holiday or seasonal event (for example, Ramadan, Valentine’s Day or Christmas) must start within a reasonable time frame leading up to the event and must end within 24 hours after the event date, or a reasonable time after that depending on the event.
...
8.11 Without prejudice to the generality of the other provisions of these Terms, you further represent and warrant that your ads as well as any related content do not infringe any third party rights including without limitation trademark rights. If Grab receives any complaint in respect of your ads content, campaign details and targeting decisions or otherwise deem that they or any part thereof are not compliant with the Content Specifications, we reserve the right to remove the same, suspend our services to you, and/or require that you modify the affected material. We may, but are not obliged to, review the ads as well as the related content or information submitted or amended by you from time to time. 

8.12 If you believe that any content made available on our platform violates your intellectual property rights, please contact us with details provided via “**Help Centre**” feature.

**Marketing Manager**

8.13 If you use the ads self-serve services under the Marketing Manager Services Platform, you shall comply and be subject to the terms stipulated under the [Marketing Manager Service Terms](https://www.grab.com/sg/terms-policies/marketing-manager-service-terms/).

**9\. GrabGeo Additional Terms of Use**
...
9.8 You must provide a hypertext link to the Geo T&Cs either at the bottom of each page in your Application where the Services can be accessed or viewed or within the terms of use of your Application.
...
9.21 Grab’s Privacy Notice applies to use of the Service, and its terms are made a part of these Geo T&Cs by this reference. At all times your information will be treated in accordance with Grab’s Privacy Notice, which can be found at: [https://www.grab.com/sg/terms-policies/privacy-notice/](https://www.grab.com/sg/terms-policies/privacy-notice/).
...
9.23.3 Google Building Footprint Data ([https://sites.research.google/open-buildings/](https://sites.research.google/open-buildings/)) made available under CC BY-4.0_;_
...
9.23.12 Land Transport Authority of Singapore ([https://www.lta.gov.sg/content/ltagov/en.html](https://www.lta.gov.sg/content/ltagov/en.html)), made available under the terms of the Singapore Open Data Licence version 1.0 (https://data.gov.sg/open-data-licence);

9.23.13 Singapore Land Authority’s OneMap ([https://www.onemap.sg/main/v2/](https://www.onemap.sg/main/v2/)), made available under the terms of the Singapore Open Data Licence version 1.0 (https://data.gov.sg/open-data-licence);

9.23.14 National Environment Agency of Singapore ([https://www.nea.gov.sg/](https://www.nea.gov.sg/)), made available under the terms of the Singapore Open Data Licence version 1.0 (https://data.gov.sg/open-data-licence);
...
9.23.17 OpenWeatherMap accessed on 01 April 2021, made available under the terms of the Singapore Open Data Licence version 1.0 (https://data.gov.sg/open-data-licence); 

9.23.18 Specific portions of the Services are powered by [Tomorrow.io](http://tomorrow.io/) ([https://www.tomorrow.io/](https://www.tomorrow.io/)); and

9.23.19 “Places Theme” and “Administrative Boundaries Theme” from Overture Maps Foundation licenced under the CDLA Permissive v 2.0 licence ([https://cdla.dev/permissive-2-0/](https://cdla.dev/permissive-2-0/)).
...
Users who subscribe to GrabUnlimited will receive benefits such as vouchers monthly, depending on the applicable  subscription  plan. Vouchers will be available in the ‘My Rewards’ page in the Application. Unless otherwise stated, vouchers must be used in Singapore by the stated expiry date, if any. Vouchers can only be redeemed when making purchases in the Application with your GrabPay Wallet, eligible credit or debit card, or through PayLater. 
...
If you subscribed for GrabUnlimited directly with Grab through the Application and are billed by Grab, the subscription fee will be deducted from your selected payment method on each billing date. **Take note that your GrabUnlimited subscription will automatically renew unless you cancel it via the Application before the billing date.** If your selected payment method is unavailable, we will automatically deduct the amount from another linked card you have on the Application or your GrabPay wallet. If the deduction or charge is unsuccessful, your subscription will be cancelled.
...
This section applies to purchases of GrabUnlimited subscriptions by businesses registered in Singapore. If you are a Grab for Business client or are using the Grab for Business portal, these terms and conditions apply in addition to the Grab for Business terms and conditions.

You may submit an order for GrabUnlimited subscription plans through the channels notified by Grab (“**GrabUnlimited Order**”). Grab will invoice you following your GrabUnlimited Order. You must make payment in accordance with the payment instructions and deadline stated in the invoice.
...
* [#### Section A – General Terms](#clause-a1)
* [1\. Introduction](#clause-a1)
* [2\. Definitions](#clause-a2)
* [3\. Representations, Warranties and Undertakings](#clause-a3)
* [4\. Compatibility](#clause-a4)
* [5\. License Grant and Restrictions](#clause-a5)
* [6\. Payments](#clause-a6)
* [7\. Cancellation](#clause-a7)
* [8\. GrabRewards Loyalty Programme and Promotions for Consumers](#clause-a8)
* [9\. Ratings; Complaints](#clause-a9)
* [10\. Estimated Timings for Partners and Consumers](#clause-a10)
* [11\. Repair and Cleaning Fees for Consumers](#clause-a11)
* [12\. Intellectual Property Ownership](#clause-a12)
* [13\. Taxes](#clause-a13)
* [14\. Confidentiality](#clause-a14)
* [15\. Data Privacy and Personal Data Protection Policy](#clause-a15)
* [16\. Third Party Interactions](#clause-a16)
* [17\. Indemnification](#clause-a17)
* [18\. Disclaimer of Warranties](#clause-a18)
* [19\. Internet Delays](#clause-a19)
* [20\. GrabLite](#clause-a20)
* [21\. Limitation of Liability](#clause-a21)
* [22\. Notice](#clause-a22)
* [23\. Assignment](#clause-a23)
* [24\. Dispute Resolution](#clause-a24)
* [25\. Relationship](#clause-a25)
* [26\. Severability](#clause-a26)
* [27\. No Waiver](#clause-a27)
* [28\. Entire Agreement](#clause-a28)
* [29\. Suspension and Termination](#clause-a29)
* [30\. No Third Party Rights](#clause-a30)
* [#### Section B – Additional Terms](#clause-b1)
* [1\. GrabFood/GrabMart](#clause-b1)
* [2\. GrabExpress](#clause-b2)
* [3\. For GrabMerchants ("Merchants")](#clause-b3)
* [4\. For GrabHitch Partners](#clause-b4)
* [5\. For GrabAds Shops Consumers](#clause-b5)
* [6\. Grab for Business](#clause-b6)
* [7\. Purchase and Use of GrabGifts](#clause-b7)
* [8\. GrabAds Terms](#clause-b8)
