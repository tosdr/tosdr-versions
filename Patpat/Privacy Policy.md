...
Privacy Policy of **www.patpat.com/**
=====================================
...
Interfocus, Inc--650 Castro Street Suite 120 458 Mountain View, CA 94041 United States

**Owner contact email:** copyright@patpat.com

Types of Data collected
-----------------------

Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Trackers; Usage Data; unique device identifiers for advertising (Google Advertiser ID or IDFA, for example); email address; geographic position; language; Universally unique identifier (UUID); Data communicated while using the service; various types of Data; device information.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Handling payments, Access to third-party accounts, Advertising, Traffic optimization and distribution, Analytics, Managing contacts and sending messages, Interaction with external social networks and platforms, Commercial affiliation, Remarketing and behavioral targeting, User database management, Interaction with live chat platforms, Registration and authentication, Infrastructure monitoring, Tag Management, Content performance and features testing (A/B testing), Displaying content from external platforms and Collection of privacy-related preferences.
...
* ### Advertising
    ...
    * a Sharing in California
    ...
    Users can opt out of Facebook's use of Trackers for ads personalization by visiting this [opt-out page](https://www.aboutads.info/choices/).
...
* ### Content performance and features testing (A/B testing)
    ...
    * a Sale in California
    ...
    This service allows the Owner to target groups of Users on the base of their past use of this Application. Users that [opt-out](https://tools.google.com/dlpage/gaoptout?hl) of tracking by Google Analytics will not be included in experiments created in Google Optimize 360.
...
* ### Handling payments
    ...
    Adyen is a payment service provided by Adyen B.V.
...
* ### User database management
    ...
    We are committed to protecting the personal data you provide to us. Accordingly, if you have several user accounts and some user accounts are barely used, we will suspend the user accounts are barely used for the purpose of preventing your accounts been accessed without your knowledge.  
      
    We'll combine your wallet、Voucher、Rewards、Pat Points in one place. Your asset in the suspended accounts will be transferred to the kept account. This is to ensure that your benefits continue uninterrupted.  
      
    Please note you can also decide to recover your suspended accounts. If you want to recover a suspended account or delete an account you no longer want to use, please contact us at [service@patpat.com.![](/images/icons/mail_small.gif)](mailto:service@patpat.com. "下列链接").  
      
    Click to agree to the privacy policy to agree to the account merger, click to reject the privacy policy to reject the account merger.
...
This Application uses Trackers. To learn more, Users may consult the [Cookie Policy](https://www.patpat.com/en/cookie_policy "Cookie Policy").
