...
Concept Den Ltd. doing business as SendOwl will be the data controller of your personal data if you are a merchant using SendOwl to deliver products (“Merchant”) or a promoter of a Merchant’s product (“Affiliate”). Conversely, SendOwl will be the data processor if you are a customer to a SendOwl Merchant (“End Customer”). This Privacy Policy does not apply to the way we process Merchants’ End Customer information in our role as a service provider to our Merchants. Our Data Processing Addendum, which describes how we process and safeguard Merchants’ End Customer information as a service provider to our Merchants, is available upon request by emailing [dpa-requests@sendowl.com](mailto:dpa-requests@sendowl.com).
...
* [How We Use Information](#2)
* [How We Share Information](#3)
* [How Do We Respond to ‘Do Not Track’ Signals?](#4)
* [Cookies](#5)
* [Your Rights](#6)
* [Legal Bases for Processing](#7)
* [Retention and Withdrawal](#8)
* [Data Transfer](#9)
...
**Information We Automatically Collect**. For all visitors to our site, we collect aggregated information on pages viewed including IP address, timestamps, logins. This information may be collected via several technologies, including cookies, web beacons, clear GIFs, canvas fingerprinting and other means. You can control cookies in your browser to enable or disable them. Learn more in our [Cookie Policy](https://www.sendowl.com/cookies).

**Information You or Your Merchant Gives Us**. For our Merchants, we collect registration information including name, email address, telephone number; billing information including address; and information required to sell goods.

For End Customers who buy a digital product from a Merchant that is delivered by SendOwl, we collect information relating to any transactions recorded by us or returned by the payment gateway including name, email address, billing and shipping address.

We use payment processors for payment, analytics, and other business services. Payment processors collect identifying information about the devices that connect to its services. Payment processors use this information to operate and improve the services they provide to us, including for fraud detection. You can learn more about Stripe, our main payment processor, and read its privacy policy at [www.stripe.com/privacy](https://www.stripe.com/privacy).
...
* to respond to your enquiry, ask a question, contact you about your request or other reasons related to offering and improving our services;
* provide checkout capabilities on our site;
* to enable us to communicate with you and sellers;
* send you our monthly newsletter if you have signed up;
...
* for buyers who buy something that is delivered by SendOwl we collect data so we can provide them with access to their purchase;
...
We use third party vendors and hosting partners to provide the necessary equipment required to run the service and may share data with them accordingly in order to provide the services you have requested. Specifically: Cloudflare, Amazon Web Service, Rackspace, MailGun, Google Analytics, FreeAgent, HelpScout, Stripe and MailChimp. We have contracts in place with our third-party vendors that require them to use personal data only as necessary to perform services on our behalf and to implement appropriate security measures as required by law.
...
**Personalized Advertising**. We may also use targeted advertising cookies, such as Google Ads, to deliver tailored advertising on our Sites and other websites that you may visit. You can learn more about how to control advertising cookies by visiting the Network Advertising Initiative’s Consumer Opt-Out [link](https://optout.networkadvertising.org/?c=1), the DAA’s Consumer Opt-Out [link](http://www.aboutads.info/choices/) for browsers, or the DAA’s opt-out [link](https://youradchoices.com/AppChoices) for mobile devices. Please note that electing to opt-out will not stop advertising from appearing in your browser or applications and may make the ads you see less relevant to your

#### Your Privacy Rights

If you would like to unsubscribe from receiving our newsletter, you can click on the “unsubscribe” link included in our email or contact us as indicated below.
...
* Request to export the personal data that we process based on our contract with you or your consent and transfer it to another company (if technically feasible).
* Withdraw any consent you have previously provided to us.

If you wish to exercise any of the rights set out above, please contact us using the details in the [Contact Us](https://www.sendowl.com/contact) section.

If you are not happy with our response, you can contact the ICO in the UK, or other data protection regulator in your country. Important note: if you are a customer who has been delivered a product via SendOwl you will need to contact the Merchant regarding your data rights. SendOwl acts as a data processor and it is the Merchant who must complete your data subject requests as your purchase contract is with them, not us.
...
To make such a request, please contact us using the contact details listed in the [Contact Us](https://www.sendowl.com/contact) section below.
...
We do not sell your email address, shopping cart data, or other marketing information to third parties. However, under some U.S state laws, some sharing of personal information necessary to provide you with personalized ads may be considered a “sale,” even if no money is exchanged, such as our use of cookies and similar technologies. You may learn more about how to opt out of such personalized ads through our [Cookie Policy](https://www.sendowl.com/cookies).
...
With your consent, we may use your personal data to send you marketing materials, except as otherwise permitted by applicable law. You may also provide consent where we do not rely on another legal basis. Consent may be withdrawn at any time.

We may process data in compliance with a mandatory legal obligation. For example, accounting and tax requirements, which are subject to mandatory retention periods. We may also collect your personal data to record your requests to exercise your rights and to verify your identity for such requests.

In some limited cases, we may also have a legal obligation to collect personal information from you, in response to lawful requests by public authorities, including to meet law enforcement requirements, as described above in [How We Share Information](#3).
...
We may transfer your personal data to recipients in countries other than the country in which the personal data originally was collected. Those countries may not offer the same level of protection to your personal data. When we transfer your personal data to recipients outside of the European Economic Area (“EEA”), we will comply with applicable legal requirements by providing adequate protection for the transfer of personal data, including by (i) entering into the European Commission’s EU Standard Contractual Clauses with the data recipients, (ii) verifying that the recipient has implemented Binding Corporate Rules, or (iii) any other appropriate safeguards as required by applicable law for any personal information transferred internationally.

To obtain a copy of our Data Protection Addendum with Standard Contractual Clauses incorporated, please email [dpa-requests@sendowl.com](mailto:dpa-requests@sendowl.com).

#### Children’s Privacy

The Sites are not directed at individuals under the age of 16. We do not knowingly collect personal information from children under 16. If you become aware that a child has provided us with personal information, please contact us using the contact details provided in the [Contact Us](https://www.sendowl.com/contact) section below. If we become aware that a child under 16 has provided us with personal information, we will take steps to delete such information.
