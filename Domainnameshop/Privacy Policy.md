[![](/svg/logo-en.svg)](https://domainname.shop/)

[![](/png/flags/eu.png)](javascript: toggle_flagmenu();)  
[EUR](javascript: toggle_flagmenu();)

[![](/png/flags/no.png)](https://domene.shop/terms?currency=NOK&lang=no)[![](/png/flags/se.png)](https://xn--domn-noa.shop/terms?currency=SEK&lang=sv)[![](/png/flags/dk.png)](https://xn--domne-ura.shop/terms?currency=DKK&lang=da)[![](/png/flags/eu.png)](https://domainname.shop/terms?currency=EUR&lang=en)[![](/png/flags/uk.png)](https://domainname.shop/terms?currency=GBP&lang=en)[![](/png/flags/us.png)](https://domainname.shop/terms?currency=USD&lang=en)

[![](/png/menu.png)](javascript: toggle_mobilemenu();)

[![](/png/user.png)](https://domainname.shop/login)  
[Login](https://domainname.shop/login)

[![](/png/user.png)](javascript: toggle_mobilelogin();)

[![](/png/cart-0.png)](https://domainname.shop/?cart=1)  
[Shopping cart](https://domainname.shop/?cart=1)

![](/png/login-username.png)

![](/png/login-password.png)[![](/svg/password-show.svg "Show password")](javascript: toggle_mobilepassword();)

[Forgot your password?](https://domainname.shop/lostpassword)     

[](javascript: toggle_mobilemenu();)[Domain name](javascript: toggle_submenu(1);)

[Read more / order](https://domainname.shop/register)[Transfer to us](https://domainname.shop/transfer)[Change owner](https://domainname.shop/faq?id=27)[Expired domains](https://domainname.shop/expired)[Domain name watch](https://domainname.shop/domainwatch)[Whois search](https://domainname.shop/whois)

[Email](javascript: toggle_submenu(2);)

[Read more / order](https://domainname.shop/email)[Email configuration](https://domainname.shop/faq?id=41&section=13)[Email FAQ](https://domainname.shop/faq?section=13)[Webmail](https://webmail.domeneshop.no/)

[Web hosting](javascript: toggle_submenu(3);)

[Read more / order](https://domainname.shop/web)[Get started](https://domainname.shop/faq?section=17)[Install Joomla](https://domainname.shop/faq?id=253)[Install WordPress](https://domainname.shop/faq?id=220)

[Help](javascript: toggle_submenu(4);)

[Frequently asked questions](https://domainname.shop/faq)[Contact us](https://domainname.shop/contact)[Service announcements](https://domainname.shop/status)[Sign up](https://domainname.shop/order)[Price list](https://domainname.shop/pricelist)

[My account](javascript: toggle_submenu(5);)

[Login](https://domainname.shop/login)

**Service Agreement for Domainnameshop**
...
1. [General Terms and Conditions](#general): general provisions for all customers of Domainnameshop
2. [Registration Agreement](#registration): applies to registration, transfer and renewal of domain names
3. [Terms and Conditions for Hosting Services](#hosting): apply to email, web and other hosting services

In addition, the following appendices are included and incorporated into this Agreement:

1. [Privacy Policy](#privacy): describes how we collect and process personal data
2. [List of Registry Operators](#registries): links to the policies for the top-level domains that we offer
3. [Data Processing Agreement](#dpa): if you decide to use our hosting services to store or transfer personal data
...
4. **How you can access and update your personal data:** You can access and update your contact data for your domains and for your account with us at any time from the control panel at [https://domainnameshop.com/login](https://domainnameshop.com/login). Here you can also delete any information that is optional and not needed for the domain management process.
...
"**Privacy legislation**" means all applicable laws and regulations relating to data protection and privacy, including the GDPR and the Norwegian Personal Data Act _(Personopplysningsloven)_.
...
This Data Processing Agreement is an addendum to the [Terms and Conditions for Hosting Services](#hosting) ("**Hosting Agreement**") that comes into effect when the Data Controller uses any of Domainnameshop's hosting services (DNS, email, web hosting, etc.) to store, transfer or otherwise process personal data. It describes the rights and responsibilities for the customer as Data Controller and Domainnameshop as Data Processor.

The objective of this DPA is to:

1. regulate the Parties' rights and obligations when processing personal data;
2. ensure that the requirements of the Privacy legislation are complied with when implementing the Hosting Agreement; and
3. ensure that personal data are not processed unlawfully, comes into unauthorized hands or is processed for purposes other than those stipulated in this DPA.
...
1. define the categories of personal data and the types of personal data that are to be processed, and to determine the purposes for which and the manner in which any personal data are processed;
    
2. make sure that all personal data are processed according to current Privacy legislation, including the GDPR;
    
3. when transferring and storing personal data using Domainnameshop's hosting services, to pay attention to the security recommendations set out in [Schedule 1](#schedule1) of the DPA; and
    
4. immediately notify Domainnameshop if the Data Controller believes that instructions or demands from Domainnameshop are in breach of current Privacy legislation.
...
|     |     |
| --- | --- |
| [Domain name](https://domainname.shop/register)  <br>[Read more / order](https://domainname.shop/register)  <br>[Transfer to us](https://domainname.shop/transfer)  <br>[Change owner](https://domainname.shop/faq?id=27)  <br>[Expired domains](https://domainname.shop/expired)  <br>[Domain name watch](https://domainname.shop/domainwatch)  <br>[Whois search](https://domainname.shop/whois) | [Email](https://domainname.shop/email)  <br>[Read more / order](https://domainname.shop/email)  <br>[Email configuration](https://domainname.shop/faq?id=41&section=13)  <br>[Email FAQ](https://domainname.shop/faq?section=13)  <br>[Webmail](https://webmail.domeneshop.no/) |
...
 [![](/png/picts/mail-white.png) support@domainnameshop.com](https://domainname.shop/contact) [![](/png/picts/phone-white.png) +47 2294 3333 (08-12 / 13-16)](https://domainname.shop/contact)
...
© 2024 Domeneshop AS · [About us](https://domainname.shop/about) · [Terms](https://domainname.shop/terms) · [Privacy policy](https://domainname.shop/privacy)