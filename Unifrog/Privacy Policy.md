...
Unless you ask us not to, we will share some of your personal information with the Higher Education Access Tracker (HEAT) to find out which university or other education provider you have enrolled with (if any), for the reasons mentioned above (see [here](https://www.unifrog.org/privacy-policy#HOWWEUSEYOURINFORMATION)). HEAT may retain your data to enable statistical aggregation and analysis. Find HEAT's privacy policy [here](https://heat.ac.uk/privacy-notice/). If you enrol at a university or other education provider, we may remind this institution of any interactions you had with them on the Unifrog Platform before you applied to them.

Unless you ask us not to, we will share some of your personal information with the Higher Education Access Tracker to find out which university or other education provider you have enrolled with (if any), for the reasons mentioned above (see [here](https://www.unifrog.org/privacy-policy#HOWWEUSEYOURINFORMATION)) We may remind your university of any interactions you had with them on the Unifrog Platform before you applied to them.
