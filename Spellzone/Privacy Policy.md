...
[Who looks after your Personal Data?](#3)

[How we obtain your Personal Data](#4)

[Children and Young Peoples' Data](#5)

[Cookies](#6)

[Legal basis for processing Personal Data](#7)

[Legitimate interests pursued by Spellzone Limited and/or its clients](#8)
...
[Data Processing and Storage](#12)

[Your Rights as a Data Subject](#13)

[What identification will be required?](#14)
...
Spellzone is a long established, online English spelling resource suitable for students aged six to adult. It is used worldwide by schools, colleges, adult education centres, private tutors, families and individual students.

Spellzone works hard to make sure that all our users, especially young people, have a positive and safe experience.
...
* [Spellzone Data Sharing Agreement (example)](https://www.spellzone.com/pages/policies/data-sharing-agreement.cfm)

Personal Data
-------------

This document refers to Personal Data, which is defined as information concerning any living person (the Data Subject).

Anything that can identify you is your Personal Data. This could be your name, address or a photo of you, but it is also things like your email address or your online gamertag.

There are some types of data known as special category data. This could be something like your date of birth, an illness you have, or what religion you are.

**Spellzone does not collect any special category data.**
...
GDPR means [General Data Protection Regulation ((EU) 2016/679) (GDPR)](https://gdpr-info.eu/) and any national implementing laws, regulations and secondary legislation, as amended or updated from time to time, in the UK; and then any successor legislation to the [GDPR](https://gdpr-info.eu/) or the [Data Protection Act 1998](https://www.legislation.gov.uk/ukpga/1998/29/contents).

The Information Commissioners Office (ICO) guidance on Personal Data can be found [here](https://ico.org.uk/your-data-matters/).

Spellzone does not fall into the compliance thresholds the of [California Privacy Rights Act (CPRA)](https://oag.ca.gov/privacy/ccpa) 01/01/2023.
...
A **Data Controller** is in charge of the Personal Data collected about you. The Data Controller decides why and how the data is processed and is directly responsible for complying with data protection laws, ensuring data security and upholding data subjects’ rights.

A **Data Processor** collects or uses Personal Data in accordance with the instructions of the Data Controller.

If you are using Spellzone from a school or private tutor account:* Your school or private tutor is the **Data Controller**
* Spellzone is the **Data Processor**
  
If you are using Spellzone from a single student or family account:* Spellzone is the **Data Controller**

We may share your information to our key suppliers (third parties) which assist us in making the Spellzone website available to you. We have a data processing agreement (DPA) with them to ensure they will keep your information secure and not use it for other purposes.

Here is a list of who we could share your Personal Data with and why:

|     |     |     |
| --- | --- | --- |
| **Organisation** | **Data Categories** | **Reason for sharing** |
| [Bytemark](https://www.bytemark.co.uk/company/data-centres/yo26/) | All categories listed below | Spellzone website hosting |
| [MailJet](https://www.mailjet.com/) | Name and email address | Spellzone email provider |
| [YouCanBookMe](https://youcanbook.me/) | Name and email address | Staff training booking platform |
| [Whereby](https://whereby.com/) | Name and email address | Staff training platform |
...
| Account Management and Communications | Spellzone Activity and Results |
| --- | --- |
| * First Name<br>* Surname<br>* Job Title – _non mandatory  <br>    _(Administrators and Teachers)<br>* Username<br>* Password<br>* Organisation name  <br>    (schools, colleges and other organisations only)<br>* Billing Address<br>* Country<br>* Email Address<br>* Telephone numbers<br>* Class names  <br>    (schools, colleges and other organisations only)<br>* VAT number  <br>    (schools, colleges and other organisations only)<br>* Spellzone Invoices<br>* Email communications<br>* Telephone communications notes  <br>    (we do not mechanically record telephone conversations)<br>* Internet Protocol (IP) address and browser information. | * Spelling Ability Test results.<br>* Spellzone course and word list activity  <br>    and results.<br>* Word lists created by you.<br>* Teacher/student messages.  <br>    These are the messages sent by teachers and student responses from within Spellzone (not emails). |

Children and Young Peoples' Data
--------------------------------

To help ensure a safe, positive experience for children and young people, we adhere to the following policies:
...
* We do not distribute any personally identifiable information about children to third parties other than the key suppliers listed above, who assist us in making the Spellzone website available to you.
...
Spellzone Limited will only collect the information needed so that it can meet its contractual obligations to clients, provide you with access to the Spellzone website and to provide support and marketing information about the Spellzone website.  
...
All WorldPay transactions are subject to the [WorldPay Privacy Policy](https://www.worldpay.com/en-gb/privacy) and all PayPal transactions are subject to the [PayPal Privacy Policy](https://www.paypal.com/uk/legalhub/privacy-full).  
...
Through agreeing to this privacy notice you are consenting to Spellzone Limited processing your Personal Data for the purposes outlined.

We respect your privacy and your rights under the [General Data Protection Regulations (2018)](https://gdpr-info.eu/) or [GDPR](https://gdpr-info.eu/), which are part of the law called the [Data Protection Act 1998](https://www.spellzone.com/pages/policies/Data%20Protection%20Act%201998). You have the right to withdraw your consent for us to process your Personal Data at any time. Withdrawing your consent is easy and will not have any negative consequences. However, please note that some of our services may be affected if the processing of your data is essential for providing those services.  

To withdraw your consent if you are using Spellzone from a school account:

* Your school is the **Data Controller**.
* Please contact your Spellzone Administrator.
* They will delete your account.

To withdraw your consent if you are using a Spellzone single student or family account:

* Spellzone is the **Data Controller**.
* [Contact us](https://www.spellzone.com/pages/policies/contact.cfm) with your request.

Once we receive your request, we will stop processing your Personal Data based on your consent without undue delay. The withdrawal of consent does not affect the legality of our data processing activities before the withdrawal.

If you have any questions or need assistance, please do not hesitate to [contact us](https://www.spellzone.com/pages/policies/contact.cfm).
...
Spellzone Limited may also enforce its [Terms and Conditions](https://www.spellzone.com/pages/policies/terms.cfm), including investigating potential violations of its [Terms and Conditions](https://www.spellzone.com/pages/policies/terms.cfm) to detect, prevent or mitigate fraud or security or technical issues; or to protect against imminent harm to the rights, property or safety of Spellzone Limited, its clients and/or the wider community.
...
The processing and storage of Data shall be carried out within the United Kingdom and the EEA.

Your Rights as a Data Subject
-----------------------------

At any point whilst Spellzone Limited is in possession of or processing Personal Data, all data subjects have the following rights:

* **Right of access** – you have the right to request a copy of the information that we hold about you.
* **Right of rectificatio**n – you have a right to correct data that we hold about you that is inaccurate or incomplete.
...
In the event that you wish to make a complaint about how your Personal Data is being processed by Spellzone Limited, you have the right to complain to:  
...
If you do not get a response within 30 days you can complain to:
