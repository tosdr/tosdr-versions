[Get A Demo](https://www.klevu.com/get-a-demo/)

* [Solutions](#)
* [Capabilities](#)
* [Integrations](#)
* [Pricing](https://www.klevu.com/pricing/)
* [Resources](#)
* [Partners](#)
* [Support](#)
...
* [Company](#)
    * [About Us](https://www.klevu.com/about-us/)
    * [Careers](https://www.klevu.com/careers/)
    * [Inside Klevu](https://www.klevu.com/blog/category/inside-klevu/)
    * [Customer Referral Program](https://www.klevu.com/customer-referral-program/)
* [Contact Us](https://www.klevu.com/contact-us/)
* [Start Building](https://box.klevu.com/merchant/signup)
* [Log In](https://box.klevu.com/analytics/)
...
**Klevu has updated its Terms of Service as of May 1, 2024.** – There are no major changes in the substance of the terms and no specific action is required from our customers.

**Table of contents**

[1 Definitions and interpretation](#1-definitions-and-interpretation)

[2 Order Process](#2-order-process)

[3 Commencement and duration](#3-commencement-and-duration)

[4 Provision of the Solution](#4-provision-of-the-solution)

[5 Client obligations](#5-client-obligations)

[6 Support Services](#6-support-services)

[7 Subscription Fees](#7-subscription-fees)

[8 Warranties](#8-warranties)

[9 Intellectual property](#9-intellectual-property)

[10 Indemnities](#10-indemnities)

[11 Data Protection](#11-data-protection)

[12 Confidential Information](#12-confidential-information)

[13 Limitation of liability](#13-limitation-of-liability)

[14 Suspension](#14-suspension)

[15 Termination](#15-termination)

[16 Consequences of expiry or termination](#16-consequences-of-expiry-or-termination)

[17 Notices](#17-notices)

[18 General](#18-general)

[Schedule 1 – Data Processing Addendum](#schedule-1-data-processing-addendum)
...
|     |     |
| --- | --- |
| **Analytics Data** | the analytics data provided by Klevu to the Client, which is derived from data collected by the Solution in respect of Shoppers’ use of the Website. |
| **Authorised Users** | those Personnel of the Client authorised by the Client to use the Client Dashboard and/or to receive the Analytics Data. |
| **Business Day** | a day other than a Saturday, Sunday or bank or public holiday in Finland. |
| **Commencement Date** | the earlier of the date the Client is provided with access to the Klevu services and the subscription start date as set out in the Order. |
...
| **Client Dashboard** | the Klevu Merchant Centre provided as part of the Solution to allow the Authorised Users to review Client Data and Analytics Data. |
| **Client Data** | the data and materials provided by the Client to Klevu in connection with the performance of this Agreement. |
...
| **Contract** | the contract entered into between the parties, as defined in clause 2.2. |
| **Documentation** | the description of the Solution and instructions for installation of it (as updated from time to time), which can be accessed at www.klevu.com. |
| **Fees** | the fees to be paid by the Client for the Solution, calculated on a monthly basis, or as set out in the Order. |
...
| **Intellectual Property Rights** | any and all copyright, rights in inventions, patents, know-how, trade secrets, trade marks and trade names, service marks, design rights, rights in get-up, database rights and rights in data, semiconductor chip topography rights, utility models, domain names and all similar rights and, in each case:  <br>**(a)** whether registered or not;  <br>**(b)** including any applications to protect or register such rights;  <br>**(c)** including all renewals and extensions of such rights or applications;  <br>**(d)** whether vested, contingent or future; and  <br>**(e)** wherever existing. |
...
| **Notice Period** | the notice period for termination of a Contract, which shall be 30 days unless otherwise set out in the Order. |
| **Online Order Form** | the online mechanism, which may be completed by the Client when placing an Order. |
| **Order** | offer by the Client to enter into a Contract with Klevu as described in clause 2.1. |
...
| **Relevant Requirements** | as defined in clause 18.1.1 of these Terms. |
| **Service Hours** | 24 hours a day, 365 days a year, except for periods of Planned Maintenance and Unplanned Maintenance. |
| **Shopper** | the customers and potential customers of the Client (or the owner of the Website, if this is not the Client), who access the Website. |
| **Shopper Data** | personal data collected and processed by Klevu in connection with its provision of the Solution, that relates to the Shoppers and their shopping and browsing activities, as described in Schedule 1 Appendix 1 “Categories of Data”. |
| **Solution** | Klevu’s solutions for online stores, as described at [https://www.klevu.com/pricing/](https://www.klevu.com/pricing/) and any other software solutions offered by Klevu and being subscribed by the Client as per the Order |
| **Solution Usage Data** | anonymous and aggregated data collected by Klevu in respect of the usage of the Solution by Shoppers and Authorised Users. |
| **Subscription Period** | the subscription period (or minimum contractual term) is one year, unless otherwise set out in the Order. |
| **Subscription Start Date** | the date from which the agreed fees per the Order shall be billed to the client (free access may have been provided between the Commencement Date and Subscription Start Date). |
| **Support Request** | as defined in clause 6.3 of these Terms. |
| **Support Services** | the support services provided by Klevu to the Client as described in clause 6 of these Terms. |
| **Term** | the term of the Contract, calculated in accordance with clause 3. |
...
| **VAT** | United Kingdom value added tax, any other tax imposed in substitution for it and any equivalent or similar tax imposed outside the United Kingdom. |
...
| **Website** | the Client’s or a third party’s online store, in relation to which the Client wishes to use the Solution, as set out in the Order. |
...
**3.2** If additional Klevu services are acquired, subsequent to your 1st order with Klevu, your Subscription Start Date shall change to the date the new services are invoiced from.  Your Subscription Period will remain “as-is” meaning you will be committed for the length of the Subscription Period from the revised Subscription Start Date.

**3.3** The acquisition of additional usage will not change your Subscription Start Date.
...
**4.4** The Client acknowledges that Klevu may use LLM’s for certain services. Though Klevu strives to provide uninterrupted and accurate services, there may be some delays, inaccuracies, outages, etc. which are attributable to such LLM and out of Klevu’s control.

**4.5** Save as expressly set out in an Order, Klevu will not provide any professional services to the Client, including but not limited to customisation, installation or go-live support in respect of the Solution, enhancements to the standard version of the Solution, or preparation or maintenance of the Client’s environment. Any Order including such additional services will be subject to additional terms and conditions.
...
* **5.2.13** agree for Klevu to “health-check” the implementation of the Services prior to go-live
...
**6.1** During the Term Klevu shall use commercially reasonable efforts to make the Solution available in accordance with our 99.9% uptime guarantee except for: (i) Planned Maintenance; or (ii) Unplanned Outages; or (iii) Outages or delays attributable to LLM’s. Such efforts shall include monitoring performance indicators on the systems and network infrastructure (its own and that of third party suppliers) in order to gauge the overall performance of its hosting services, and taking commercially reasonable steps to address any issues.

**6.2** Klevu will use reasonable efforts to provide at least 5 days notice of any Planned Maintenance.

**6.3** In the event that the Solution is unavailable or otherwise not functioning correctly, the Client shall report the issue to support@klevu.com, providing as much information as possible in relation to the issue (a **Support Request**).
...
* **8.2.7** any delays or outages attributed to LLMs
* **8.2.8** any content generated by LLMs or any third party services used by Klevu in the Solution
* **8.2.9** the Client not allowing Klevu to “health check” the implementation prior to go-live
...
* **8.3.4** that the result provided by the Solution shall be 100% accurate.
...
* **10.4.5** results or outputs derived from an LLM
...
**13.4** The Solution may be subject to delays, interruptions, errors or other problems resulting from use of the internet or public electronic communications networks or LLM’s used by the parties or third parties. The Client acknowledges that such risks are inherent in cloud services and that Klevu shall have no liability for any such delays, interruptions, errors or other problems.
...
**16.3** The following provisions of these Terms will survive the expiry or termination of the Contract: clause 9 (_Intellectual Property_), clause 12 (_Confidential Information_), clause 13 (_Limitation of liability_), this clause 16 (_Consequences of expiry or termination_), and clauses 18.4 (_Entire Agreement_), 18.7 (_Waiver_), 18.11 (_Governing Law_) and 18.12 (_Jurisdiction_).
...
The Data Processing Addendum is available [here](https://www.klevu.com/data-processing-addendum/)

[![favicon](https://www.klevu.com/wp-content/uploads/2022/07/favicon.png)](https://www.klevu.com/)

A Global Finnish Company

* * *

* [Search & Discovery](#)
    * [Site Search](https://www.klevu.com/solutions/site-search/)
    * [Product Recommendations](https://www.klevu.com/solutions/product-recommendations/)
    * [Category Merchandising](https://www.klevu.com/solutions/category-merchandising/)
* [Solutions](#)
    * [Product Discovery](https://www.klevu.com/solutions/)
    * [Enterprise](https://www.klevu.com/solutions/enterprise/)
    * [Headless Commerce](https://www.klevu.com/solutions/headless-commerce/)
    * [B2B](https://www.klevu.com/solutions/b2b/)
    * [MOI: ChatGPT for Ecommerce](https://www.klevu.com/moi/)
    * [Algolia vs Klevu](https://www.klevu.com/solutions/klevu-vs-algolia/)
    * [Nosto vs Klevu](https://www.klevu.com/solutions/nosto-vs-klevu/)
    * [Adobe Sensei vs Klevu](https://www.klevu.com/solutions/klevu-vs-adobe-sensei/)
    * [Searchspring vs Klevu](https://www.klevu.com/solutions/searchspring-vs-klevu/)
    * [Attraqt vs Klevu](https://www.klevu.com/solutions/attraqt-vs-klevu/)
    * [MACH vs Klevu](https://www.klevu.com/solutions/algolia-bloomreach-constructor-vs-klevu/)

* [Capabilities](#)
    * [Machine Learning](https://www.klevu.com/capabilities/machine-learning/)
    * [Natural Language Processing](https://www.klevu.com/capabilities/natural-language-processing/)
    * [Personalization Engine](https://www.klevu.com/capabilities/personalization-engine/)
    * [Headless Architecture](https://www.klevu.com/capabilities/headless-architecture/)
    * [Security & Cloud Infrastructure](https://www.klevu.com/capabilities/security-and-cloud-infrastructure/)
* [Features](#)
    * [Multilingual Capabilities](https://www.klevu.com/capabilities/multilingual/)
    * [Faceted Navigation](https://www.klevu.com/capabilities/features/faceted-navigation/)
    * [Predictive Autocomplete](https://www.klevu.com/capabilities/features/predictive-autocomplete/)
    * [Visual Merchandising](https://www.klevu.com/capabilities/features/visual-merchandising/)
    * [Recommendation Engine](https://www.klevu.com/capabilities/features/recommendation-engine/)
    * [Segmentation](https://www.klevu.com/capabilities/features/segmentation/)
    * [Analytics](https://www.klevu.com/capabilities/features/analytics/)
    * [A/B Testing](https://www.klevu.com/capabilities/features/a-b-testing/)

* [Integrations](#)
    * [BigCommerce](https://www.klevu.com/integrations/bigcommerce/)
    * [Magento – Adobe Commerce](https://www.klevu.com/integrations/magento-adobe-commerce/)
    * [Shopify](https://www.klevu.com/integrations/shopify/)
    * [Salesforce Commerce](https://www.klevu.com/integrations/salesforce-commerce/)
    * [commercetools](https://www.klevu.com/integrations/commercetools/)
    * [Shopware](https://www.klevu.com/integrations/shopware/)
    * [Other platforms](https://www.klevu.com/integrations/other-platforms/)
    * [Klaviyo](https://www.klevu.com/integrations/klaviyo/)
* [Other Integrations](#)
    * [Feed Data Indexing](https://help.klevu.com/support/solutions/articles/5000871297-feed-format)
    * [API Data Indexing](https://docs.klevu.com/indexing-apis)
    * [Template JS](https://docs.klevu.com/template-js)
    * [Headless Integration](https://www.klevu.com/integrations/headless/)
    * [SDK Library](https://docs.klevu.com/headless-sdk)
    * [Storefront APIs](https://docs.klevu.com/apis)
    * [Web Components](https://webcomponents.klevu.com/)
* [Pricing](#)
    * [Pricing](https://www.klevu.com/pricing/)

* [Resources](#)
    * [Blog](https://www.klevu.com/blog/)
    * [Ebooks](https://www.klevu.com/ebooks/)
    * [Events](https://www.klevu.com/events/)
    * [Headless Commerce 101](https://www.klevu.com/headless-commerce/)
* [Case Studies](#)
    * [B2B](https://www.klevu.com/case-studies/industry/b2b/)
    * [Home & Garden](https://www.klevu.com/case-studies/industry/home-and-garden/)
    * [Fashion](https://www.klevu.com/case-studies/industry/fashion/)
    * [Food & Beverage](https://www.klevu.com/case-studies/industry/food-and-beverage/)
    * [Beauty](https://www.klevu.com/case-studies/industry/beauty/)
    * [Pharmaceuticals](https://www.klevu.com/case-studies/industry/pharmaceuticals/)
    * [Sports & Outdoor](https://www.klevu.com/case-studies/industry/sports-and-outdoor/)
* [Discovered](#)
    * [Discovered Articles](https://www.klevu.com/discovered/articles/)
    * [Discovered Events](https://www.klevu.com/discovered/events/)
    * [Discovered Magazines](https://www.klevu.com/discovered/magazines/)
    * [Discovered Podcasts](https://www.klevu.com/discovered/podcasts/)
    * [Discovered TV](https://www.klevu.com/discovered/videos/)

* [Partners](#)
    * [Partner Program](https://www.klevu.com/partners/partner-program/)
    * [Become a Partner](https://www.klevu.com/partners/become-a-partner/)
    * [Submit a Lead](https://www.klevu.com/partners/submit-a-lead/)
    * [Partner Portal](https://partners.klevu.com/login)
    * [Solution Partners](https://www.klevu.com/partners/?filter%5Bpartner-type%5D=solution-integrators)
    * [Technology Partners](https://www.klevu.com/partners/?filter%5Bpartner-type%5D=technology-integrators)
    * [Platform Partners](https://www.klevu.com/partners/?filter%5Bpartner-type%5D=platform-integrators)
* [Support](#)
    * [Support Services](https://www.klevu.com/support-services/)
    * [Documentation](https://docs.klevu.com/)
    * [Community Forum](https://community.klevu.com/)
    * [Server Status](https://status.klevu.com/)
    * [Submit a Ticket](https://help.klevu.com/support/tickets/new)
    * [Get started](https://help.klevu.com/support/solutions/5000174073)
    * [Platforms](https://help.klevu.com/support/search)
    * [Discovery Suite](https://help.klevu.com/support/discussions)
    * [Connectors](https://help.klevu.com/support/solutions/5000174079)
    * [FAQs](https://help.klevu.com/support/solutions/5000174078)
...
* [Company](#)
    ...
    * [Contact Us](https://www.klevu.com/contact-us/)
* [Social Networks](#)
    * [Linkedin](https://www.linkedin.com/company/klevuai)
    * [Youtube](https://www.youtube.com/c/klevusearch)
    * [Facebook](https://www.facebook.com/klevuai/)
    * [Instagram](https://www.instagram.com/klevuai/)
    * [X](https://twitter.com/klevuai)

* * *

[ToS](https://www.klevu.com/terms-of-service/) | [Privacy](https://www.klevu.com/privacy-policy/) | [Data Processing](https://www.klevu.com/data-processing-addendum/) | [Sub-Processors](https://www.klevu.com/sub-processors/) | [Support](https://www.klevu.com/technical-support-policy/) | [Service Credits](https://www.klevu.com/service-credits-sla/) | [Server Status](https://status.klevu.com/) | [Cookies](javascript:void(0);)

© Copyright Klevu 2024. All rights reserved.