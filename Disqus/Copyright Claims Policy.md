...
* Disqus usernames are provided on a first-come, first-served basis and may not be reserved. For information on why you may not be able to select a certain username, please see [What is the difference between my Username and my Display Name?](https://help.disqus.com/customer/portal/articles/1494710) 
    

Guidelines for fan accounts
===========================

Disqus users are allowed to create fan accounts. Disqus provides a platform for its users to share and receive a wide range of ideas and content, and we greatly value and respect our users' expression. Because of these principles, we do not actively monitor users' content and will not edit or remove user content, except in cases of violations of our [Terms of Service](https://help.disqus.com/customer/portal/articles/466260).
...
* Please see the [profile](https://help.disqus.com/customer/portal/articles/1255134-updating-your-disqus-settings#profile) and [avatar](https://help.disqus.com/customer/portal/articles/1255134-updating-your-disqus-settings#avatar) sections of our [Updating your Disqus Settings](https://help.disqus.com/customer/portal/articles/1255134) documentation for instructions on customizing your account. In particular, we recommend clearly stating your location, including your website if you have one, and clearly describing your brand or business in the bio, if applicable.
...
You do not need a Disqus account to submit a trademark report. Holders of registered trademarks can report possible violations to Disqus through our [Support Form](https://disqus.com/support?article=contact_trademark).
...
Intercom[We run on Intercom](https://www.intercom.com/intercom-link?company=Disqus&solution=customer-support&utm_campaign=intercom-link&utm_content=We+run+on+Intercom&utm_medium=help-center&utm_referrer=https%3A%2F%2Fhelp.disqus.com%2Fen%2Farticles%2F1717120-trademark-policy&utm_source=desktop-web)