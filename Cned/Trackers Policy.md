* [Aller au menu principal](#navigation-principale)
* [Aller au contenu](#contenu-principal)
* [Aller au bas de page](#footer)

[![Page d'accueil du Cned](/themes/custom/ud_cned/dist/img/logo.svg)](https://www.cned.fr/)Menu

* [Espace client](https://www.cned.fr/compte)
* Mes espaces
    
    * [Espace clientConnectez-vous à votre compte client](https://www.cned.fr/compte)
    * [Espace inscritAccédez à vos formations](https://espaceinscrit.cned.fr/)
    
* [Nombre d'articlesPanierPanier](https://www.cned.fr/panier)
* [Nous contacter](https://www.cned.fr/nous-contacter)
* [Rechercher](https://www.cned.fr/recherche)

Fermer le menu de navigation[![Page d'accueil du Cned](/themes/custom/ud_cned/dist/img/logo.svg)](https://www.cned.fr/)

* Nos formations
    
    * Retour Retour menu précédent
    * Scolaire
        * [École](https://www.cned.fr/primaire)
        * [Collège](https://www.cned.fr/college)
        * [Lycée](https://www.cned.fr/lycee)
    * Étudiant
        * [BTS](https://www.cned.fr/bts)
        * [Concours d'entrée en école](https://www.cned.fr/concours-d-entree-en-ecoles)
        * [Cursus universitaires](https://www.cned.fr/cursus-universitaires)
    * Vie active
        * [Remise à niveau](https://www.cned.fr/remise-a-niveau)
        * [CAP](https://www.cned.fr/cap)
        * [BTS](https://www.cned.fr/bts)
        * [Qualifications professionnelles](https://www.cned.fr/qualifications-professionnelles)
        * [Langues étrangères](https://www.cned.fr/langues)
    * Prépa concours
        * [Enseignement](https://www.cned.fr/concours-enseignants)
        * [Fonction publique](https://www.cned.fr/concours-fonction-publique)
        * [Santé / Social](https://www.cned.fr/concours-sante-social)
    * Accès libre
        * [B.A.-BA du climat et de la biodiversité](https://www.cned.fr/transition-ecologique/ba-ba-du-climat-et-de-la-biodiversite)
        * [Jules](https://www.cned.fr/college/jules-aide-devoirs-college)
        * [MaSpéMaths](https://www.cned.fr/lycee/maspemaths-revision-specialite-mathematiques)
        * [English for schools](https://www.cned.fr/primaire/english-for-schools-apprendre-anglais-ecole)
        * [Deutsch für Schulen](https://www.cned.fr/primaire/deutsch-fur-schulen-apprendre-allemand-ecole)
    
* Vous êtes
    
    * Retour Retour menu précédent
    * [Élève ou parent d'élève](https://www.cned.fr/eleve)
    * [Étudiant](https://www.cned.fr/etudiant)
    * [Salarié ou indépendant](https://www.cned.fr/salarie-travailleur-independant)
    * [Agent de la fonction publique](https://www.cned.fr/enseignant-agent-fonction-publique)
    * [En recherche d'emploi](https://www.cned.fr/en-recherche-d-emploi)
    
* [La Méthode Cned](https://www.cned.fr/notre-methode)
...
* Obtenir de l'aideObtenir de l'aide
    ...
    * [Accessibilité sourds et malentendants](https://www.cned.fr/nous-contacter/contactez-nous-par-telephone/accessibilite-telephonique)
...
* Nos fils d'actualitésNos fils d'actualités
    ...
    * [Lycée](https://www.cned.fr/l-actualite-de-la-formation/blog-lycee)
    * [Petite enfance](https://www.cned.fr/l-actualite-de-la-formation/blog-petite-enfance)
    * [Formation professionnelle](https://www.cned.fr/l-actualite-de-la-formation/blog-formation-professionnelle)
    * [Concours fonction publique](https://www.cned.fr/l-actualite-de-la-formation/blog-concours-fonction-publique)
    * [Secteur social](https://www.cned.fr/l-actualite-de-la-formation/blog-formations-social)
    * [Concours enseignants](https://www.cned.fr/l-actualite-de-la-formation/blog-devenir-professeur)
    
* [Rejoindre le Cned](https://www.cned.fr/espace-recrutement)
* [Espace presse](https://www.cned.fr/espace-presse)

* [Espace client](https://www.cned.fr/compte)
* [Espace inscrit](https://espaceinscrit.cned.fr/)
* [Nous contacter](https://www.cned.fr/nous-contacter)
...
2. [Définitions](#)
3. [Bases légales des traitements mis en œuvre par le Cned](#)
4. [DCP collectées et traitées par le Cned](#)
5. [Destinataires de vos données à caractère personnel](#)
6. [Protection des données](#)
7. [Utilisation des cookies par le Cned](#)
8. [L’exercice des droits](#)
9. [Conservation de vos données](#)
10. [Catégories de données traitées et finalités](#)
11. [Opposition au suivi de navigation](#)

La présente politique de protection des données à caractère personnel (ci-après la politique) a pour objectif de vous informer sur les données à caractère personnel que le Centre national d’enseignement à distance (Cned) collecte et sur l’utilisation qui en est faite dans le cadre des inscriptions et de la délivrance des services à ses inscrits.

Cette politique n’est pas applicable aux services spécifiques (tels que « Ma classe à la maison » ou encore « English for schools »), dès lors que ces services disposent de politiques de protection des données à caractère personnel propres.

Informations générales
----------------------

Le Cned est un établissement public administratif national sous tutelle du ministère de l’éducation nationale de la jeunesse et des sports ainsi que du ministère de l’enseignement supérieur, de la recherche et de l’innovation.

Il intervient notamment dans le cadre du service public du numérique éducatif défini à l’article L 131-2 du code de l’éducation et assure, pour le compte de l’état, le service public de l’enseignement à distance.

Dans ce contexte, la protection des données à caractère personnel (ci-après DCP) de ses inscrits est un souci constant de l’établissement.

### **Le Responsable de traitement**

Le Responsable de traitement est le Cned, représenté par son directeur général. Son siège est situé à l'adresse suivante :

Cned – Direction générale  
Téléport  , 2 boulevard Nicéphore Nièpce  
BP 80300  
86963 Chasseneuil - Futuroscope Cedex

### **Le délégué à la protection des données**

De par sa qualité d’établissement public administratif, le Cned s’est doté d’un délégué à la protection des données (ci-après DPO). En cas de besoin, il peut être contacté en écrivant à l’adresse suivante :
...
Bases légales des traitements mis en œuvre par le Cned
------------------------------------------------------
...
DCP collectées et traitées par le Cned
--------------------------------------
...
Conformément aux dispositions de l’article 8 du règlement 2016/679 (dit RGPD), lorsque la mise en œuvre d’un traitement nécessite le consentement de la personne dont les données sont traitées et que ce traitement concerne les données d’un enfant de moins de 16 ans, le consentement de l’un au moins des parents ou du responsable légal est requis.

Le consentement n’est pas requis lorsque le traitement est nécessaire à une mission de service public.

Utilisation des cookies par le Cned
-----------------------------------

Vous pouvez à tout moment revoir vos préférences concernant les cookies en cliquant sur le lien suivant : [Personnaliser mes choix](# "Personnaliser mes choix")
...
### Accéder aux données et les corriger
...
* ​​​soit archivées si une disposition légale  oblige le Cned ou si l’intérêt légitime du Cned le justifie (délai de prescription par exemple). Durant cette période d’archivage, les données sont conservées mais ne sont plus accessibles ni utilisées par les agents du Cned dans leur travail quotidien. À l’issue de la période d’archivage, les données sont définitivement supprimées.

_L’anonymisation est un procédé irréversible. Il ne s’agit donc plus de données à caractère personnel._

Catégories de données traitées et finalités
-------------------------------------------
...
Gestion des demandes d’informations et de documentation des prospects  
_Catégorie de données traitées : A, B, C, D_
...
Traitement des demandes d’inscription (par dossiers papiers et en ligne)   
_Catégorie de données traitées : A, B, C, D, F_
...
Éléments de la scolarité de l’inscrit  
_Catégorie de données traitées : A, B, C_

Bilans de fin de formation  
_Catégorie de données traitées : A, C_

Enquêtes de satisfaction   
_Catégorie de données traitées : aucune_

#### **Fourniture de l’espace pédagogique aux inscrits**

Mise à disposition des inscrits du Cned un ensemble de services dans le cadre de leur formation (annuaire, agenda, forums, messagerie interne, espace documentaire avec dépôt de documents personnels)  
_Catégorie de données traitées : A, B, C, E_

Mise à disposition des inscrits des documents relatifs à sa scolarité (certificats de scolarité, relevés de note, attestation d'inscription, fiche d'informations personnelles).  
_Catégorie de données traitées : A, B, C, E_

Fourniture d’un service de dématérialisation des copies  
_Catégorie de données traitées : A, C, E_

Fourniture d’accès à des services tiers  
_Catégorie de données traitées : A, E_
...
Opposition au suivi de navigation
---------------------------------

Si le module d'opposition au suivi de navigation n'apparait pas correctement, veuillez vider le cache de votre navigateur. Si cela ne fonctionne toujours pas, merci de contacter nos services par mail à l'adresse suivante : [dpo@ac-cned.fr](mailto:dpo@ac-cned.fr)

Pour recevoir toutes les actus du Cned, inscrivez-vous à notre newsletter

Retrouvez-nous sur

* [linkedin (nouvelle fenêtre)Ouvrir dans un nouvel onglet](https://fr.linkedin.com/school/cned/)
* [twitter (nouvelle fenêtre)Ouvrir dans un nouvel onglet](https://twitter.com/cned?lang=fr)
* [youtube (nouvelle fenêtre)Ouvrir dans un nouvel onglet](https://www.youtube.com/@CnedFrOfficiel)
* [facebook (nouvelle fenêtre)Ouvrir dans un nouvel onglet](https://www.cned.fr/reseaux-sociaux)
...
* © Cned 2024
* [Mentions légales](https://www.cned.fr/mentions-legales)
* [Règlement intérieur](https://www.cned.fr/reglement-interieur-formation-continue)
* [Conditions générales de vente](https://www.cned.fr/sites/cned.fr/files/pdf/cgv/CNED_CGV-CGU_2024.pdf)
* [Protection des données](https://www.cned.fr/protection-des-donnees)
* [Marchés publics](https://www.cned.fr/marches-publics)
* [Recueil des actes](https://www.cned.fr/recueil-des-actes)
* [Accessibilité : partiellement conforme](https://www.cned.fr/accessibilite)