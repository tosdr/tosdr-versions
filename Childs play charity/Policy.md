...
[Continue shopping](https://store.childsplaycharity.org/collections/all)

Have an account?

[Log in](https://store.childsplaycharity.org/account/login) to check out faster.
...
* [Impact](https://childsplaycharity.org/impact)
* [Testimonials](https://childsplaycharity.org/testimonials)
* [Get Involved](https://childsplaycharity.org/get-involved)
* [Game Guide](https://childsplaycharity.org/guide)
* [Sponsors](https://childsplaycharity.org/sponsors)

[Log in](https://store.childsplaycharity.org/account/login)
...
* [Zimbabwe USD $](#)
 ...
 Search [![Child's Play Charity](//store.childsplaycharity.org/cdn/shop/files/CP_Wordmark_Logo_Dark_BG_117deb7e-8326-4efe-9ec0-8c1a34c629ef.png?v=1678734515&width=600)](https://store.childsplaycharity.org/)
...
* [Sponsors](https://childsplaycharity.org/sponsors)
 ...
 Search [Log in](https://store.childsplaycharity.org/account/login) [Cart](https://store.childsplaycharity.org/cart)
...
USPS Priority (1-3 days) and Ground Advantage (2-5 days) are currently offered for domestic shipping.

International and military orders may experience delays in shipping due to inbound and outbound processing. Orders typically take 3-6 weeks for delivery.
...
Please note that UPS does not ship to PO Boxes. No tracking is available for First-Class International or Standard International Shipping Orders.

### Customs Charges

Most countries charge import duties and customs fees. These can vary widely. For example, in the United Kingdom VAT is owed on all goods valued £15 or more. These charges will also incur an £8 handling fee from Royal Mail. The recipient of your order will be responsible for any and all customs fees and duties. The whole customs clearance process can also cause delays beyond the shipping timelines listed above and while we're sorry when these delays happen, they are outside of our control. I know, they frustrate us too!

### I have more questions!

Email us at merch@childsplaycharity.org with any other questions you may have!
...
* [FAQ](https://childs-play-charity.myshopify.com/pages/help-faq)
* [Terms of Service](https://store.childsplaycharity.org/policies/terms-of-service)
* [Refund policy](https://store.childsplaycharity.org/policies/refund-policy)
* [Store](https://store.childsplaycharity.org/)
...
20-3584556  
Child’s Play is a 501 (c)(3)

![](//store.childsplaycharity.org/cdn/shop/files/CP_Circular_Logo_White_Circle_7.png?v=1676592393&width=760)
...
© 2024, [Child's Play Charity](https://store.childsplaycharity.org/) [Powered by Shopify](https://www.shopify.com/?utm_campaign=poweredby&utm_medium=shopify&utm_source=onlinestore)
