...
* [1 What is the DMCA?](#What_is_the_DMCA?)
* [2 I am a copyright owner and I don’t want my work displayed on Fanlore.](#I_am_a_copyright_owner_and_I_don’t_want_my_work_displayed_on_Fanlore.)
* [3 How do I initiate a DMCA takedown request?](#How_do_I_initiate_a_DMCA_takedown_request?)
* [4 Once you have initiated a DMCA takedown notice…](#Once_you_have_initiated_a_DMCA_takedown_notice…)
* [5 If you are an uploader of contested content…](#If_you_are_an_uploader_of_contested_content…)
* [6 What can I expect if I file a DMCA counternotice?](#What_can_I_expect_if_I_file_a_DMCA_counternotice?)
* [7 What happens to repeat copyright infringers?](#What_happens_to_repeat_copyright_infringers?)

What is the DMCA?
-----------------

[The Digital Millennium Copyright Act (17 U.S.C. § 512) (“DMCA”)](https://www.law.cornell.edu/uscode/text/17/512) creates a safe harbor, or a legal exemption, from copyright infringement liability for Internet service providers (ISPs) and other intermediaries. To encourage and maintain free speech on our sites, the OTW will push back against DMCA takedown requests if we believe that the content in question is actually lawful and [fair use](https://w2.eff.org/IP/eff_fair_use_faq.php). The law requires that DMCA requests be made by the holder of a valid copyright in the work or by an agent authorized to act on behalf of the owner, and requires that requests are made in good faith under penalty of perjury.
...
Adapted from [Wikipedia’s DMCA policy](https://wikimediafoundation.org/wiki/DMCA_Policy).

Retrieved from "[https://fanlore.org/w/index.php?title=Fanlore:DMCA\_Policy&oldid=992209](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&oldid=992209)"

[Category](https://fanlore.org/wiki/Special:Categories "Special:Categories"):
...
* [Create account](https://fanlore.org/w/index.php?title=Special:CreateAccount&returnto=Fanlore%3ADMCA+Policy "You are encouraged to create an account and log in; however, it is not mandatory")
* [Log in](https://fanlore.org/w/index.php?title=Special:UserLogin&returnto=Fanlore%3ADMCA+Policy "You need to log in to edit pages. [o]")

### Namespaces

* [Project page](https://fanlore.org/wiki/Fanlore:DMCA_Policy "View the project page [a]")
* [Talk](https://fanlore.org/w/index.php?title=Fanlore_talk:DMCA_Policy&action=edit&redlink=1 "Discussion about the content page (Click to create this page!) [t]")

 English

### Views

* [Read](https://fanlore.org/wiki/Fanlore:DMCA_Policy)
* [View source](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&action=edit "This page is protected.
    You can view its source [e]")
* [View history](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&action=history "Past revisions of this page [h]")
...
* [What links here](https://fanlore.org/wiki/Special:WhatLinksHere/Fanlore:DMCA_Policy "A list of all wiki pages that link here [j]")
* [Related changes](https://fanlore.org/wiki/Special:RecentChangesLinked/Fanlore:DMCA_Policy "Recent changes in pages linked from this page [k]")
* [Special pages](https://fanlore.org/wiki/Special:SpecialPages "A list of all special pages [q]")
* [Printable version](javascript:print(); "Printable version of this page [p]")
* [Permanent link](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&oldid=992209 "Permanent link to this revision of this page")
* [Page information](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&action=info "More information about this page")

* This page was last edited on 18 May 2017, at 01:06.
...
* [Mobile view](https://fanlore.org/w/index.php?title=Fanlore:DMCA_Policy&mobileaction=toggle_view_mobile)
