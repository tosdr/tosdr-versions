 [![](/static/vipps_frontend/973148/media/extra-images/vipps-logo.svg) Gå til forsiden](https://www.vipps.no/)
...
Her i Vipps tar vi sikkerhet og forenkling på alvor!
...
Vi anbefaler at du bytter til en litt nyere nettleser, så får du bedre sikkerhet, men også en raskere og bedre opplevelse på de fleste nettsteder.

Det finnes flere der ute du kan bytte til, eksempelvis Chrome, Edge eller Firefox.
...
![Girl with phone (1).png](/media/images/Girl_with_phone_1.width-200.png)
...
### 1.1. Når du har en Vipps profil
...
### 1.3 Når du bruker Vipps Logg inn
...
### 1.4 Når du bruker Vipps Hurtigkasse eller Vipps Checkout
...
### 1.6 Når vi viser deg dine fordeler i Vipps
...
* For mer informasjon se [Vipps under 15](https://www.vipps.no/produkter-og-tjenester/privat/send-og-motta-penger-med-vipps/vipps-under-15/) og husk at du kan alltid ta kontakt med oss via chat på [vipps.no](http://vipps.no/), e-post [privacy@vippsmobilepay.com](mailto:privacy@vippsmobilepay.com) eller telefon på 24 24 05 10.

![](/media/images/NS0018_Vipps-et-paskeegg_2_248.width-1056.jpegquality-75.png)
...
### 2.1 For at vi skal oppfylle krav i lover og regler
...
* **Tekniske data** (KundeID, Informasjonskapsler, User\_agent) 
* **Bruksdata** (visninger i app, tid og klikk i våre flater, søk, inn- og utlogginger)
...
### 2.6 Personopplysningssikkerhet
...
### 2.8 Rollefordeling mellom Vipps og brukersteder
...
_For å sende deg personopplysninger trenger vi ditt telefonnummer, og din Digipost-adresse._
...
Du har rett til å kreve at dine personopplysninger blir slettet dersom Vipps ikke lenger har rettslig grunnlag for behandlingen. Vil du slette din profil? Se [Hvordan sletter jeg alt om meg og min profil? (vipps.no)](https://www.vipps.no/hjelp/vipps/sikkerhet-og-personvern/hvordan-sletter-jeg-alt-om-meg-og-min-profil/)

### 3.4 Rett til å trekke tilbake samtykke
...
* **Innstillinger i appen:** f.eks. under Profil > Innstillinger eller under Profil > Kontoer og kort[Hvordan sletter jeg alt om meg og min profil? (vipps.no)](https://www.vipps.no/hjelp/vipps/sikkerhet-og-personvern/hvordan-sletter-jeg-alt-om-meg-og-min-profil/)
...
Du har også rett til å klage til [Datatilsynet](http://www.datatilsynet.no/)
...
Du finner også en del svar under hjelp: [Personvern og sikkerhet - spørsmål og svar](https://www.vipps.no/hjelp/vipps/sikkerhet-og-personvern/hvorfor-ber-dere-om-samtykke-til-relevant-markedsforing/)

![Hjelp_2x.png](/media/images/Hjelp_2x.width-200.png)

![](/static/vipps_frontend/973148/media/images/vipps-smile.svg)
