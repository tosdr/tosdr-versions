...
お客様が期限内に有料サービスの料金をお支払いいただけなかった場合、当社は本サービスの提供を停止し、または有料サービスにかかる機能等の利用を制限します。この場合、当社はお客様が利用可能なストレージ容量を１ＴＢまで減少させ、お客様がこの期間内に１ＴＢを超える容量を利用していた場合、１ＴＢ未満に利用容量を削減しない限り、それ以上のバックアップができなくなったり、特定の機能が利用できなくなったりします。当該措置によって、お客様に生じる損害については、お客様自身でその責任を負うものとします。
...
กรุณาส่งเอกสารแจ้งเกี่ยวกับลิขสิทธิ์มาได้ที่ [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
...
* किसी भी तरह से कानून का उल्लंघन करना, जिसमें धोखाधड़ी, मानहानि या भ्रामक सामग्री का भंडारण, प्रकाशन या साझा करना शामिल है;
* निजता का उल्लंघन या दूसरों के अधिकारों का उल्लंघन।
...
कृपया [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp) पर अधिकारों की सूचना भेजें।
...
* Menyelidiki, memindai, atau menguji kerentanan sebarang sistem atau jarangan;
* Melanggar atau menghindari tingdakan keamanan atau otentikasi;
* Mengakses, merusak, atau menggunakan area bukan public atau bagian layanan atau area bersama bagi layanan yang anda belum pernah diundang;
* Mengganggu atau mencampuri hal-hal pengguna, host, atau jaringan mana pun, misalnya dengan mengirimkan virus, membebani secara berlebihan, membanjiri, mengirim spam, atau membombardir bagian mana pun dari Layanan;
* Mengakses, mencari layanan, atau membuat akun layanan (misalnya, "merayapi" atau membuat akun secara massal) melalui cara lain (daripada antarmuka yang kami dukung secara publik);
* Antar informasi kominikasi, promosi atau iklan, email sampah tanpa keizinan dll;
* Mengirimkan informasi identifikasi sumber yang diubah, menipu, atau salah, termasuk "spoofing" atau "phishing";
* Tindakan mempromosikan atau mengiklankan produk atau layanan orang lain tanpa izin yang semestinya;
* Penyalahgunaan rekomendasi atau promosi untuk mendapatkan ruang simpanan yang melebihi jumlah yang semestinya, atau untuk menjual ruang simpanan yang diperoleh dari rekomendasi atau promosi;
* Menghindari batas ruang penyimpanan;
* Menjual jasa tanpa otorisasi khusus;
* Mempublikasikan atau membagikan materi pornografi atau tidak senonoh yang melanggar hukum, atau yang berisi tindakan kekerasan atau aktivitas teroris yang ekstrem, termasuk propaganda teror;
* Mendukung kefanatikan atau kebencian terhadap seseorang atau sekelompok orang berdasarkan ras, agama, etnis, jenis kelamin, identitas gender, orientasi seksual, kecacatan atau kecacatan mereka;
* Melanggar hukum dengan cara apa pun, termasuk menyimpan, menerbitkan, atau membagikan bahan yang curang, memfitnah, atau menyesatkan; atau
...
Silahkan kirim notis hak Anda kepada [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
...
Sebelum mengajukan klaim terhadap Perusahaan, Anda setuju untuk mencoba menyelesaikan perselisihan secara informal dengan menghubungi Terabox melalui [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp). Terabox akan berusaha untuk menyelesaikan perselisihan secara informal dengan menghubungi Anda melalui email. Jika perselisihan tidak diselesaikan dalam waktu 15 hari setelah pengajuan, Anda atau Perusahaan Flextech Inc.dapat mengajukan proses resmi.
...
* обнаружение, сканирование или тестирование уязвимостей какой-либо системы или сети;
* взлом или обход какой-либо меры безопасности или проверки подлинности;
* посещение, искажение или использование непубличных зон Сервисов или их частей, либо публичных зон Сервисов без получения приглашения;
* вмешательство в работу или нарушение работы какого-либо пользователя, хоста или сети, например, путем отправки вирусов, перегрузки, флуда, отправки спама либо "почтовых бомб" в отношении определенной части Сервисов；
* доступ к Сервисам, их поиск или создание учетных записей Сервисов иными способами (не через поддерживаемый нами интерфейс), например, "захват" или массовое создание учетных записей;
* рассылка нежелательных сообщений, информации для продвижения товаров или рекламы, спама и пр.;
* рассылка измененной, мошеннической или поддельной идентифицирующей информации об источнике, включая "электронное мошенничество" или "фишинг";
* действия, направленные на продвижение или рекламу чужих товаров или услуг без получения соответствующих прав;
* злоупотребление реферальными ссылками или рекламными акциями с целью получения пространства для хранения, превышающего надлежащий лимит, или для продажи пространства для хранения, полученного по реферальной ссылке или в рамках рекламной акции;
* обход лимита пространства для хранения;
* продажа услуг без специального разрешения;
* размещение или совместное использование информации, содержащей незаконное порнографическое или непристойное содержание либо материалов о насилии в крайних формах или о террористической деятельности (включая пропаганду терроризма);
* провоцирование предрассудков или ненависти в отношении какого-либо лица или группы лиц по признаку расы, религиозных убеждений, национальности, пола, гендерной идентичности, сексуальной ориентации, увечий или физических недостатков;
* какое-либо нарушение закона, включая хранение, распространение или совместное использование мошеннических, клеветнических или вводящих в заблуждение материалов;
* нарушение неприкосновенности частной жизни или прав других лиц.
...
Пожалуйста, отправьте уведомление о нарушении прав по адресу [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
...
Давайте сначала сами решим проблему. Мы надеемся решить вашу проблему, не прибегая к официальному разбирательству. Перед подачей иска против TeraBox вы соглашаетесь на то, что предпримите попытку разрешить спор в неофициальном порядке, связавшись с нами по электронной почте [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp). Мы также попытаемся урегулировать спор в неофициальном порядке, связавшись с вами через электронную почту. Если спор не будет разрешен в течение 15 дней с момента объявления о нём, вы или Flextech Inc. можете возбудить официальное разбирательство.
...
* Sondear, escanear o probar cualquier vulnerabilidad de sistema o red;
* Violar o eludir cualquier medida de seguridad o autenticación;
* Acceder, manipular o utilizar áreas o partes no públicas de los Servicios, o áreas compartidas de los Servicios a las que no ha sido invitado;
* Interferir o interrumpir a cualquier usuario, anfitrión o red, por ejemplo, enviar virus para sobrecargar o inundar ciertas partes de los Servicios, o enviarles spam o bombas de correo;
* Acceder, buscar servicios o crear cuentas de servicio (por ejemplo, "capturar" o crear cuentas de forma masiva) a través de otros medios (en lugar de las interfaces que la Compañía soporta públicamente);
* Enviar comunicaciones no solicitadas, información promocional o anuncios, spam, etc.;
* Enviar información alterada de identificación de fuente, engañosa o falsa, incluyendo "spoofing" o "phishing";
* Promocionar o publicitar productos o servicios de terceros sin la debida autorización;
* Abusar de las referencias o promociones para obtener más espacio de almacenamiento del merecido o para vender el espacio de almacenamiento recibido de referencias o promociones;
* Eludir los límites de espacio de almacenamiento;
* Vender servicios sin autorización especial;
* Publicar o compartir materiales que sean ilegalmente pornográficos o indecentes, o que contengan información sobre violencia extrema o actividades terroristas (incluida la propaganda terrorista);
* Incitar la intolerancia u odio contra cualquier individual o grupo de personas en función de su raza, religión, etnia, sexo, identidad de género, orientación sexual, discapacidad o impedimento;
* Violar la ley de cualquier forma, incluido el almacenamiento, la publicación o el intercambio de materiales fraudulentos, difamatorios o engañosos;
...
Envíe el aviso de derechos a [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
...
* أ - الكشف عن أي ثغرات في أي نظام أو شبكة أو مسحها ضوئيا أو اختبارها ؛
* ب - اختراق أو تجاوز أي تدابير أمنية أو تحقق ؛
* ج. الوصول أو العبث أو استخدام المناطق غير العامة أو أجزاء من الخدمة أو مناطق مشاركة الخدمة التي لم تتم دعوتها ؛
* د - تعطيل أو التدخل في أي مستخدم أو مضيف أو شبكة ، على سبيل المثال ، عن طريق إرسال فيروسات لزيادة التحميل أو إغراق أجزاء معينة من الخدمة ، أو إرسال بريد عشوائي أو قنابل بريدية إليهم ؛
* هـ. الوصول إلى الخدمات أو البحث عنها أو إنشاء حسابات الخدمة (على سبيل المثال ، "الزحف" أو إنشاء حسابات مجمعة) من خلال وسائل أخرى (بدلاً من الواجهة التي ندعمها علنًا) ؛
* و. إرسال اتصالات غير مرغوب فيها أو معلومات أو إعلانات ترويجية أو بريد عشوائي وإلخ ؛
* ز. إرسال معلومات تعريف المصدر متغيرة أو خادعة أو خاطئة ، ويحتوى على "الغش الإلكتروني" أو "التصيد الاحتيالي" ؛
* ح. فعل الترويج أو الإعلان عن منتجات أو خدمات الآخرين دون إذن مناسب ؛
* ط. إساءة استخدام التوصيات أو العروض الترويجية للحصول على مساحة تخزين تتجاوز المقدار المستحق ، أو بيع مساحة التخزين التي تم الحصول عليها من خلال التوصيات أو العروض الترويجية ؛
* ي - تجنب من قيود مساحة التخزين ؛
* ك - بيع الخدمات بدون ترخيص خاص ؛
* ل. نشر أو مشاركة المواد التي تحتوي على محتوى إباحي غير مشروع أو غير لائق ، أو تحتوي على عنف شديد أو معلومات عن نشاط إرهابي (بما في ذلك الدعاية الإرهابية) ؛
* م - التحريض على التحيز أو الكراهية ضد أي فرد أو مجموعة على أساس العرق أو المعتقد الديني أو العرق أو الجنس أو الهوية الجنسية أو التوجه الجنسي أو الإعاقة أو العيب ؛
* ن. انتهاك القانون بأي شكل ، بما في ذلك تخزين أو نشر أو مشاركة مواد احتيالية أو تشهيرية أو مضللة ؛
* س - التعدي على الخصوصية أوحقوق الآخرين.
...
يرجى إرسال إشعار الحقوق إلى[helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp).
...
دعونا نحل المشكلة بأنفسنا أولاً. نأمل في حل مشكلتك دون الحاجة إلى مقاضاة رسمية. قبل رفع دعوى قضائية ضد TeraBox ، فإنك توافق على محاولة حل النزاع بشكل غير رسمي عن طريق التواصل مع [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp). سنحاول أيضًا حل النزاعات بشكل غير رسمي عبر الاتصال بالبريد الإلكتروني. إذا لم يتم حل النزاع في غضون 15 يومًا بعد التقديم ، فيمكن حضرتك أو شركة Flextech رفع دعوى قضائية رسمية.
...
* Investigar, examinar ou testar a vulnerabilidade de qualquer sistema ou rede;
* Violar ou contornar quaisquer medidas de segurança ou autenticação;
* Acessar, adulterar ou usar áreas não públicas ou partes dos Serviços, ou áreas compartilhadas dos Serviços para os quais você não foi convidado;
* Interferir ou interromper qualquer usuário, host ou rede, por exemplo, enviando o vírus, sobrecarregando, inundando, enviando spam ou bombardeando qualquer parte dos Serviços;
* Acessar e pesquisar serviços, ou criar contas dos Serviços (por exemplo, "rastreamento" ou criação de contas em massa) por outros meios (em vez da interface que publicamente suportamos);
* Enviar comunicações, informações promocionais ou anúncios não solicitadas, ou spam, etc .;
* Enviar informações de identificação da fonte alteradas, enganosas ou falsas, incluindo "spoofing" ou "phishing";
* Promover ou anunciar produtos ou serviços de terceiros sem a devida autorização;
* Abuso de referências ou promoções para obter mais espaço de armazenamento do que o merecido, ou vender espaço recebido de referências ou promoções;
* Contornar os limites de espaço de armazenamento;
* Vender serviços sem autorização especial;
* Publicar ou compartilhar materiais que sejam ilegalmente pornográficos ou indecentes, ou que contenham atos extremos de violência ou atividade terrorista, incluindo propaganda terrorista;
* Advogar intolerância ou ódio contra qualquer pessoa ou grupo de pessoas com base em sua raça, religião, etnia, sexo, identidade de gênero, orientação sexual, deficiência ou deficiência;
* Violar a lei de qualquer forma, incluindo armazenamento, publicação ou compartilhamento de material fraudulento, difamatório ou enganoso; ou
...
Envie o Aviso para [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
...
* thăm dò, quét hoặc kiểm tra lỗ hổng của bất kỳ hệ thống hoặc mạng nào;
* vi phạm hoặc phá vỡ bất kỳ biện pháp bảo mật hoặc xác thực nào;
* truy cập, giả mạo hoặc sử dụng các khu vực hoặc các phần riêng tư của Dịch vụ, hoặc các khu vực dùng chung của Dịch vụ mà bạn chưa được mời;
* can thiệp hoặc làm gián đoạn bất kỳ người dùng, máy chủ lưu trữ hoặc mạng nào, chẳng hạn như bằng cách gửi vi-rút, làm quá tải, tràn ngập, gửi thư rác hoặc bom thư bất kỳ phần nào của Dịch vụ;
* gửi thông tin nhận dạng nguồn đã thay đổi, lừa đảo hoặc sai, bao gồm cả "giả mạo" hoặc "lừa đảo";
* lạm dụng giới thiệu hoặc khuyến mại để nhận nhiều không gian lưu trữ hơn hoặc để bán không gian lưu trữ nhận được từ giới thiệu hoặc khuyến mại;
* phá vỡ giới hạn không gian lưu trữ;
* xuất bản hoặc chia sẻ các tài liệu có nội dung khiêu dâm hoặc khiếm nhã một cách bất hợp pháp, hoặc có chứa các hành động bạo lực cực đoan hoặc hoạt động khủng bố, bao gồm cả tuyên truyền khủng bố;
* ủng hộ sự cố chấp hoặc thù hận chống lại bất kỳ người nào hoặc nhóm người nào dựa trên chủng tộc, tôn giáo, dân tộc, giới tính, khuynh hướng tình dục, khuyết tật hoặc suy giảm chức năng của họ;
* vi phạm luật theo bất kỳ cách nào, bao gồm lưu trữ, xuất bản hoặc chia sẻ tài liệu gian lận, phỉ báng hoặc gây hiểu lầm; hoặc
* vi phạm quyền riêng tư hoặc xâm phạm quyền của người khác.
...
Vui lòng chuyển Thông báo đến [helpdesk@flextech.co.jp](mailto:helpdesk@flextech.co.jp)
