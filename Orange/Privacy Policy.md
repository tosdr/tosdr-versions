...
* [1\. Quelles sont les données traitées ?](#donnees-perso-collectes-et-traitees)
* [2\. Pourquoi Orange traite vos données ?](#finalites-duree-conservation)
* [3\. Pendant combien de temps vos données sont conservées ?](#durees_conservation)
* [4\. Quelles personnes sont concernées par ces traitements de données ?](#personnes_concernees)
* [5\. Quels sont les destinataires de vos données ?](#destinataires_ donnees_personnelles)
* [6\. Vos données sont-elles traitées hors UE ?](#hors_UE)
* [7\. Comment vos données sont-elles sécurisées ?](#securité)
* [8\. Quels sont vos droits ?](#vos_droits)
* [9\. Comment exercer vos droits ?](#exercer_vos_droits)
* [10\. Y a-t-il des particularités pour certains services ?](#offres_services_specifiques)
* [11\. Modification de la Politique de protection des données](#modification_politique_protection_donnees_personnelles)