...
The Sentinel Group - 27475 Ynez Rd #708, Temecula, CA 92591

**Owner contact email:** info@thesentinelgroup.com

Types of Data collected
-----------------------

Among the types of Personal Data that this Website collects, by itself or through third parties, there are: Cookies; Usage Data; unique device identifiers for advertising (Google Advertiser ID or IDFA, for example); email address; first name; last name; phone number; company name; profession; country; state; ZIP/Postal code; various types of Data; city; field of activity; number of employees; website.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Analytics, Displaying content from external platforms, Tag Management, Remarketing and behavioral targeting, Interaction with external social networks and platforms, Advertising, Registration and authentication, Contacting the User, Platform services and hosting and Heat mapping and session recording.
...
* ### Analytics
    ...
    * a sale according to the CCPA, VCDPA, CPA, CTDPA and UCPA
    ...
    Users can opt out of Google's use of cookies by visiting Google's [Ads Settings](https://adssettings.google.com/authenticated).
    ...
    Place of processing: United States – [Privacy Policy](https://policies.google.com/privacy) – [Opt Out](https://tools.google.com/dlpage/gaoptout).
...
* ### Contacting the User
    ...
    Personal Data processed: city; company name; country; email address; field of activity; first name; last name; number of employees; phone number; profession; state; various types of Data; website; ZIP/Postal code.
    
    Category of personal information collected according to the CCPA: identifiers; commercial information; internet or other electronic network activity information; employment related information; inferences drawn from other personal information.
...
* ### Heat mapping and session recording
    ...
    Inspectlet is a session recording and heat mapping service provided by Inspectlet Inc.
    
    Personal Data processed: Cookies; Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://www.inspectlet.com/legal#privacy).
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://www.iubenda.com/privacy-policy/26016682/cookie-policy "Cookie Policy").
...
We have collected the following categories of personal information about you: identifiers, commercial information, internet or other electronic network activity information, employment related information and inferences drawn from other personal information.
...
[Show the simplified Privacy Policy](https://www.iubenda.com/privacy-policy/26016682 "Show the simplified Privacy Policy")