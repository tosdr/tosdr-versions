...
_Last updated: July 20, 2022_

Purity Cosmetics ("us", "we", or "our") uses cookies on 100% Pure (the "Service"). By using the Service, you consent to the use of cookies.
...
#### **How Purity Cosmetics uses cookies**
...
* **Cart Activity Cookies:**  These cookies help us keep track of items customers put into their shopping cart, including when they abandon their cart. This information is used to determine when to send cart reminder messages via SMS.
...
If you'd like to delete cookies or instruct your web browser to delete or refuse cookies, please visit the help pages of your web browser.  For example:
...
[Cookie settings in Edge](https://support.microsoft.com/en-us/help/4027947/microsoft-edge-delete-cookies)
