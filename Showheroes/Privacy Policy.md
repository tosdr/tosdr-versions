 [![](/app/uploads/2024/04/ShowHeroes-logo-icon-green.png "ShowHeroes-logo-icon-green") ![](/app/uploads/2024/04/ShowHeroes-logo-icon-green.png "ShowHeroes-logo-icon-green")](https://showheroes.com/)

[Advertisers](https://showheroes.com/advertisers/) [Publishers](https://showheroes.com/publishers/) [Showroom](https://showheroes.com/showroom/) [Better Media](https://showheroes.com/better-media/)
...
This Privacy Policy forms an integral and substantial part of the Terms and Conditions (“T&Cs”) of ShowHeroes Group, which includes ShowHeroes SE and its subsidiaries (“ShowHeroes”, “we”, “us”, or “our”).
...
ShowHeroes video player widgets also support various consent management platforms (CMPs) to protect the privacy wishes of every user with regard to affiliated advertising partners. See: [https://iabtechlab.com/standards/gdpr-transparency-and-consent-framework/](https://iabtechlab.com/standards/gdpr-transparency-and-consent-framework/).
...
email: [gdpr@showheroes.com](mailto:gdpr@showheroes.com)

Data Protection Officer (“DPO”):

Carlos de las Cuevas Otero

email: [dpo@showheroes-group.com](mailto:dpo@showheroes-group.com)
...
* Technical delivery of content on our website and in our products;
* optimize the content on our website as well as in our products;
* ensure the long-term viability of our information technology systems and website technology;
* provide law enforcement authorities with the information necessary for criminal prosecution in case of a cyber-attack. Therefore, ShowHeroes analyzes anonymously collected data and information statistically, with the aim of increasing the data protection and data security of our enterprise, and to ensure an optimal level of protection for the personal data we process. The anonymous data of the server log files are stored separately from all personal data provided by a data subject.
* marketing of the products and services of our Partner third-party companies, in order to present advertisements and commercial offers that meet your preferences as much as possible.
* profiling to carry out the marketing activity referred to above, to provide information on the delivery of advertising campaigns in line with the preferences you expressed during navigation and to limit the number of your views of the same element during a predefined time interval (so-called capping).
* Combination and enrichment of the data acquired with our cookies, in order to improve the profiling referred to in point above and to carry out the marketing activity.
...
[https://showheroes.atlassian.net/wiki/spaces/GDPR/pages/1702265742/Consent+Handling](https://showheroes.atlassian.net/wiki/spaces/GDPR/pages/1702265742/Consent+Handling)
...
The Internet pages of ShowHeroes use cookies, which are text files stored in a computer system via an Internet browser.

For our Cookie Policy click here: [Cookie Policy](https://docs.google.com/document/d/1DOiHPUIzTHa2EizCkyVqg8lQl8qimU3NoiB6R7xICxk/edit)

Settings management

Each browser has different procedures for managing settings. You can get specific instructions through the links below.

Internet Explorer: [https://windows.microsoft.com/it-it/windows7/block-enable-or-allow-cookies](https://windows.microsoft.com/it-it/windows7/block-enable-or-allow-cookies)

Google Chrome: [https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DAndroid&hl=en](https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DAndroid&hl=en)
...
Apple Safari: [https://www.apple.com/legal/privacy/it/cookies/](https://www.apple.com/legal/privacy/it/cookies/)
...
e-mail: [gdpr@showheroes-group.com](mailto:gdpr@showheroes-group.com)

[dpo@showheroes-group.com](mailto:dpo@showheroes-group.com)
...
For major security, the anti-fraud service Google’s re-Captcha is included, whose privacy policy can be consulted at the following link: [https://policies.google.com/](https://policies.google.com/)
...
Further information and the applicable data protection provisions of Google may be retrieved on the following links: [https://www.google.com/intl/en/policies/privacy/](https://www.google.com/intl/en/policies/privacy/) and [http://www.google.com/analytics/terms/us.html](http://www.google.com/analytics/terms/us.html).

Google Analytics is further explained under the following Link [https://www.google.com/analytics/](https://www.google.com/analytics/).
...
The setting of such cookies may be denied under [https://www.linkedin.com/legal/cookie-policy](https://www.linkedin.com/legal/cookie-policy).

The applicable privacy policy for LinkedIn is available under [https://www.linkedin.com/legal/privacy-policy.](https://www.linkedin.com/legal/privacy-policy)

The LinkedIn Cookie Policy is available under [https://www.linkedin.com/legal/cookie-policy](https://www.linkedin.com/legal/cookie-policy).
...
Further information and the applicable data protection provisions of DoubleClick may be retrieved under DoubleClick by Google [https://www.google.com/intl/en/policies/](https://www.google.com/intl/en/policies/).
...
Further information and the applicable data protection provisions of \[m\]PLATFORM are available at [https://www.groupm.com/mplatform-privacy-notice-eu/](https://www.groupm.com/mplatform-privacy-notice-eu/). To opt out of data collection via cookies from \[m\]PLATFORM please click here: [https://www.groupm.com/groupm-privacy-notice-opt-out-confirmation/](https://www.groupm.com/groupm-privacy-notice-opt-out-confirmation/).

Other Services with the related personal data collected and the purposes pursued:

Hotjar HeatMaps & Recordings: we collect Cookies, Usage Data and various types of Data as specified in the privacy policy of the service, to heat mapping and session records.

Google Cloud Storage: we collect various types of Data as specified in the privacy policy of the service to hosting and backend infrastructure.

Google Tag Manager: we collect Usage Data to tag Management.

Intercom: we collect cookies, email address, Usage Data and various types of Data as specified in the privacy policy of the service, to manage the User database.
...
[https://www.audiencerate.com/data-ethics-privacy/](https://www.audiencerate.com/data-ethics-privacy/)

[https://www.audiencerate.com/data-ethics-privacy/#Data-collection-policy](https://www.audiencerate.com/data-ethics-privacy/#Data-collection-policy)

Navegg:  
[Navegg’s Privacy Policy](https://www.navegg.com/en/privacy-policy/)

[Navegg’s “Your Profile”](https://www.navegg.com/en/privacy-policy/your-profile/)

[Navegg’s “Edit your data”](https://www.navegg.com/en/privacy-policy/your-profile/edit-your-profile/)

[Navegg’s “Opt-Out”](https://www.navegg.com/en/privacy-policy/opt-out-from-navegg/)

Xaxis:

[https://www.xaxis.com/privacy-notice/](https://www.xaxis.com/privacy-notice/)
...
In any case, the updated version of the privacy information will be published on this page.
 ...
 ![](/app/uploads/2024/04/SH-and-google-white.png "SH-and-google-white") ![](/app/uploads/2024/04/SH-and-google-black.png "SH-and-google-black")
...
* [About us](https://showheroes.com/about-us/)
* [ShowHeroes Group](https://showheroes-group.com/)
* [ShowHeroes Studios](https://showheroes-studios.com/)

#### Follow us

* [LinkedIn](https://www.linkedin.com/company/showheroes)
* [Instagram](https://www.instagram.com/showheroes_group)
