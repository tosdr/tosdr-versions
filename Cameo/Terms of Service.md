...
* For each Business CAMEO Video, you hereby grant to User and the Business for up to 90 days (and for any additional 90-day periods to which you agree) beginning from the earlier of (i) the date the Business Cameo Video is downloaded by the User from the Site or first used, reproduced, distributed or publicly displayed by the User or the Business and (ii) 30 days after the date that Cameo notified the User that the Business CAMEO Video was completed:  
