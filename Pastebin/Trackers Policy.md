...
If you disable your browser or device's ability to accept cookies, you will still be able to browse the website, but you will not be able to log in to your Pastebin account. Other functionality might be broken too.

Which cookies get stored and why

When you use pastebin various cookies get stored.  
  
cookie: '**social\_login**' - we store/use this cookie when you login to Pastebin with one of the 3 social media login options.  
cookie: '**pastebin\_user**' - is used to identify your Pastebin account when you are logged in.  
cookie: '**l2c**' - is used to hide notification messages that you have closed.  
cookie: '**\_\_cfduid**' - is used by our network provider CloudFlare. [more info](https://support.cloudflare.com/hc/en-us/articles/200170156-What-does-the-Cloudflare-cfduid-cookie-do-)  
cookies: '**\_ga**, **\_gat**, **\_gid**' - are used by Google Analytics, more info about that below.  
...
* [⭐Free Giftcards Method ⭐September 2024](https://pastebin.com/1ZGXfX8S)
    
    Python | 2 sec ago | 0.29 KB
    
* [☀️ FREE GIFT method latest 😍](https://pastebin.com/u0sVLf7z)
    
    Python | 10 sec ago | 0.30 KB
    
* [⭐ Free giftcards private guide](https://pastebin.com/9CyU42zC)
    
    Python | 22 sec ago | 0.32 KB
    
* [⭐Free Giftcards Method ⭐September 2024](https://pastebin.com/yGJqSvHX)
    
    Python | 31 sec ago | 0.31 KB
    
* [⭐Free Giftcards Method ⭐September 2024](https://pastebin.com/datJwqd1)
    
    Python | 40 sec ago | 0.31 KB
    
* [New free giftcards 0-day exploit](https://pastebin.com/T4RvzfSE)
    
    Python | 51 sec ago | 0.31 KB
    
* [⭐Free Giftcards Method ⭐September 2024](https://pastebin.com/dAnmtszy)
    
    Python | 58 sec ago | 0.31 KB
    
* [⭐ Free giftcards private guide](https://pastebin.com/0YxeFLfD)
    
    Python | 1 min ago | 0.31 KB
