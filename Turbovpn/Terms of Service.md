...
These Terms of Service (“Terms”) govern your use of and access to our website (“Website”), applications (“Apps”) and other services (collectively, the “Services”).

The Services are provided by Innovative Connecting Pte. Limited (“we,” “us,” “our,” or “Turbo”), whose address is 8 Marina View #43-052A Asia Square Tower 1, Singapore 018960. Please note that the Terms constitute a binding legal agreement between you ("User" or "You") and Turbo. By visiting our websites, installing, and/or using the Services, you acknowledge that you have read the Terms, understand them, and agree to be bound by these Terms. If you do not agree with these Terms or any provisions hereof, please do not install the Apps and do not use our Services. If you are accepting these Terms on behalf of your employer or another entity, you represent and warrant that: (i) you have full legal authority to bind your employer or such entity to the Terms; and (ii) you agree and consent to the Terms on behalf of the party that you represent.

1\. General
-----------

Our Services are virtual private network (“VPN”) services, which enhance internet security and privacy.
...
All users of Turbo Services are obliged to ensure that they are familiar with the most current wording of the Terms. The change of the Terms may be communicated to you by publishing the updated Terms on Turbo website, where the date of the most current wording of the Terms is indicated at the top of the web page. Since you agree to be bound by these Terms each time you use the Turbo services, please consider reviewing the terms each time when you use the Turbo services. Each update of the terms comes into force as of the moment when it is published on this web page. You understand and agree that any continued use and access to the Turbo Services after any updates to these terms are published, means that you voluntarily agree to be bound by the updated Terms.

3\. Privacy Policy
------------------

We do not log any user activity (sites visited, DNS lookups, emails etc.) We only log access attempts to our servers (for security and troubleshooting). We do not get involved in any form of censorship. Except for the items described in our Privacy Policy, we will not provide your personal information to any third party. We do not cooperate with any requests for information unless we are ordered by a court of competent jurisdiction and the vast majority of these requests would not be from a court of competent jurisdiction. We will protect you to the max and our system is setup to automatically do so. There are hundreds of good reasons for being anonymous and we respect them fully..
...
By subscribing to the Services, you agree to become a subscriber (“Subscriber”) for the period you have elected. A full list of subscription plans and pricing is available on the Website and Apps. We reserves the right to amend subscription fees or institute new fees at any time upon reasonable advance notice posted on the Website or Apps or sent via email. We may suspend or cancel the Services if we do not receive a full payment from you on time. Any changes to the pricing will not affect the Subscriber’s current subscription period, but may become effective upon subscription renewal, which will be decided solely at the discretion of Turbo. Subscription purchases and refunds are handled via multiple third-party payment companies. To find out more about these third party payment companies and how they process your data, please refer to our Privacy Policy.
...
We reserve the right to verify credit/debit card payments before completing the purchase. We also reserve the right to:

1. (i) retry failed payments to complete the transaction,
2. (ii) Inquire and continue to use the updated credit card account information (if applicable) through the card brand,
3. (iii) change or modify authorized payment companies to assist with payment processing.

7\. Refund Policy
-----------------

(1) If you purchased the Turbo VPN product (or Service) from the Turbo VPN official Website, we offer you a 30-day money-back guarantee. You may cancel your subscription for any reason within 30 days of your initial purchase and you will receive a full refund of the amount you paid. Please note that we do not grant money-back guarantee for the auto-renewed subscription if you cancel the subscription after the day of charge for such auto-renewal, unless applicable law provides otherwise.

Refunds beyond the 30-day purchase window will be considered, at the sole discretion of Turbo, if you can demonstrate that the Service was not available or usable during the subscription period and that reasonable attempts were made to contact Turbo to resolve the issue. In this case, Turbo may provide the Subscriber with a pro-rata refund of service fees paid during the period when the Service was not available or usable.

(2) If you purchased our Apps from the Apple App Store (iTunes), the 30-day money-back guarantee is not available. Instead, such subscriptions are subject to Apple's App Store Refund Policy, and you may request a refund through the App Store, at Apple's sole discretion.

(3) If you purchased the Turbo VPN product (or Service) from Google Play Store, you do not have access to the 30-day money-back guarantee. Only if you can demonstrate that the Service was not available or usable during the subscription period and that reasonable attempts were made to contact Turbo to resolve the issue, Turbo may provide you with a pro-rata refund of service fees paid during the period when the Service was not available or usable.

(4) If you purchased the Turbo VPN product (or service) from 3rd party platform (eg: Codashop, or others), your subscriptions will be subject to 3rd party platform refund policies, please kindly contact the respective platform support for assistance.
...
In order to protect the Services from being misused or used to harm someone, we reserves the right to take appropriate measures when our Services are being used contrary to these Terms and applicable laws. You agree that we may terminate your account or take any other legal measure provided by law, without providing a refund for Services already paid, if you misuse the Service.  
...
· Attempt to compile, utilize, or distribute a list of IP addresses operated by Turbo in conjunction with the Services.
...
· Violate, infringe, or misappropriate our licensors and/or any other third parties' copyright, other intellectual property rights, privacy, or other legal rights.
...
These Terms shall be governed by and construed in accordance with the laws of the Singapore, excluding its conflicts of law.
