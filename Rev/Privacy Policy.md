...
**This Privacy Policy was last updated on March 8, 2024.**

**‍**Our Policy:
----------------

Rev.com, Inc., together with its subsidiaries and affiliates ("related companies" or, collectively, "Rev," "we," "us," or "our"), provide access to this web site and associated transcription, video caption, translation, and document-related services (the “site” or "services") and may collect certain data of or about you pursuant to these terms. By voluntarily providing us with personal data, you acknowledge that you have read and agree to this Privacy Policy.We may update these terms from time to time as our services evolve and to comply with new and changing privacy laws, and we will notify you of such changes in compliance with applicable laws and our agreement with you.

In addition to this Privacy Policy, your access to and use of this Site is subject to any other agreements in place between us, including our Terms of Service located at: [https://www.rev.com/legal/terms](https://www.rev.com/legal/terms). If you’re under the age of 18, you may only sign up for or use our services with the consent of a parent or guardian.

### Data We Collect

In the course of our relationship with you, we may collect the following types of personal data:

* Identifiers (such as name and email address);
* Commercial information (such as transaction data);
* Internet or other network or device activity (such as browsing history, log data, and information stored in cookies);
* Location information (such as general location information inferred from an IP address);
* Financial data (such as credit card information); and
* Other information that identifies or can be reasonably associated with you

Note that Rev may process personal data that has been collected by our other customers subject to their instructions, contractual requirements, and applicable privacy and data protection laws. In those cases, it is the customer that determines what personal data is collected and how it may be used or shared with third parties such as Rev. If you have questions or concerns about the use of your personal data that has been collected by a Rev customer, please contact that customer directly.

### **How We Collect It**

**Data You Provide to Us.** We collect personal data from you when you voluntarily provide such information, such as when you register for access to the services (for example, your name and mailing address), use certain services, contact us with inquiries, or respond to one of our surveys.

‍**Data Collected by Automatic Means.** When you interact with Rev through the Site or Services, we receive and store certain automatically collected information collected passively via web server logs and cookies.

‍**Data Collected from Third Parties.** We collect personal data from third parties, such as lead generation firms.

### Use of Personal Data

‍**To provide, maintain, and improve our services**, including by analyzing the services and addressing security and business continuity issues. For instance, if you provide personal data to obtain access to the Services, we will use it as needed to provide you with those services and to monitor your use of such services. Also, if you contact us by email, we will use the personal data you provide to answer your question or resolve your problem.
...
‍**For legal reasons**, including as needed to comply with applicable laws and where we deem disclosure appropriate to protect rights, safety and property (for example, for national security or law enforcement). This includes the protection of our own legal rights and the enforcement of the terms governing use of the services.

‍**Related to a business transaction**, including any merger, acquisition, change in control, or reorganization.

**For other purposes** requested or permitted by you.

If Rev intends on using any personal data in any manner that is not consistent with this Privacy Policy, you will be informed of such anticipated use prior to or at the time at which the personal data is collected, consistent with applicable laws.

### Third Party Disclosures

Rev may disclose your personal data to third parties for any purpose consistent with this Privacy Policy, provided, however, that we will remain responsible for compliance with this Privacy Policy by such third parties.

Rev uses YouTube API Services and Google Calendar API Services to collect authorized data and fulfill services when authorized by you. You can learn more about the associated terms of service and privacy policies via the links below:
...
* YouTube API: [https://developers.google.com/youtube/terms/api-services-terms-of-service](https://developers.google.com/youtube/terms/api-services-terms-of-service)

You can revoke Rev's access to your data from YouTube and Google Calendar via the Google Security settings page here: [https://security.google.com/settings/security/permissions](https://security.google.com/settings/security/permissions). Note that revoking such authorizations may limit or eliminate certain functionality on Rev.

Our site and services may contain links to other web sites or services not operated or controlled by Rev (the **"**Third-Party Sites**"**). The policies and procedures we described here do not apply to the Third-Party Sites. The links from our Services do not imply that Rev endorses or has reviewed the Third-Party Sites. We suggest contacting those sites directly for information on their privacy policies.

### Data Protection and Retention

Rev is located in the United States, and our related companies and other third parties authorized to receive data under this Privacy Policy are located throughout the world. You acknowledge and agree that any personal data provided to us may be stored in or accessed from multiple countries, including the United States. Whenever we transfer personal information to other jurisdictions, we will ensure that the information is transferred in accordance with this Privacy Policy and applicable data protection laws.

Rev takes steps to protect personal data from loss, misuse, and unauthorized access, disclosure, alteration, or destruction. However, no Internet, email or other electronic transmission is ever fully secure or error free, so we cannot assure you that your personal data will never be used or disclosed in a manner that is inconsistent with this Privacy Policy, and you should take special care in deciding what information you provide to us. We may use de-identified data in some instances; we will not attempt to re-identify such data or, if it ever becomes necessary to do so, we will treat such data as personal data subject to applicable law.
...
This Additional California Privacy Notice applies solely to California residents. It applies to personal information we collect on or through the Services and through other means (such as information collected offline, in person, and over the telephone).

In the preceding twelve months, we or our service providers may have collected the categories of personal information about you (“Data We Collect”) from the sources (“How We Collect It”) and for the purposes (“Use of Personal Data”) each described above.

California law may permit California residents to request that we:

* Provide you the categories of personal information we have collected or disclosed about you in the last twelve months; the categories of sources of such information; the business or commercial purpose for collecting or selling your personal information; and the categories of third parties with whom we shared personal information.
* Provide access to and/or a copy of certain information we hold about you.
* Delete certain information we have about you.

You may have the right to receive information about the financial incentives that we offer to you, if any. You also have the right to not be discriminated against (as provided for in applicable law) for exercising certain of your rights. Certain information (such as information we collect about our employees or job applicants, or information we collect from employees, owners, directors, officers, or contractors of businesses in the course of our provision or receipt of business-related services) may be exempt from such requests under applicable law. We need certain types of information so that we can provide the Services. If you ask us to delete it, you may no longer be able to access or use the Services.
...
‍**California Privacy Rights Act Retention Disclosure**. We keep your personal information to enable your continued use of the service and for as long as required in order to fulfill the relevant purposes consistent with this Privacy Policy.
...
If you have any questions about this Privacy Policy or our Services, you may contact us as follows:
