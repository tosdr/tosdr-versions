...
[Trace Minerals ®](https://de.iherb.com/info/trace-minerals)
...
10. Programme
    ...
    **Werbeprämienguthaben** kann je nach den spezifischen Geschäftsbedingungen von Wettbewerben, Gewinnspielen oder Werbeaktionen, mit denen Sie Werbeprämienguthaben verdienen können, unterschiedliche Verfallsdaten haben. Weitere Informationen finden Sie in den offiziellen Bedingungen für Wettbewerbe, Gewinnspiele oder Werbeaktionen.
    ...
    iHerb behält sich das Recht vor, Prämienguthaben und Aktionsprämienguthaben sofort zu streichen, Programmteilnehmer zu suspendieren oder zu sperren und/oder iHerb-Accounts zu löschen, wenn betrügerische Aktivitäten, Missbrauch oder anderes Verhalten, wie z.B. die oben aufgeführten Beispiele, entdeckt oder vermutet werden.
    
    Von Prämien-Teilnehmern, die als "Werber" Prämien verdienen, wird erwartet, dass sie die Richtlinien des Prämien-Programms respektieren, indem sie nur echte, lebende Personen werben, die die in diesen Allgemeinen Geschäftsbedingungen genannten Kriterien erfüllen. Teilnehmer dürfen nicht mehrere Konten anlegen oder unter verschiedenen Identitäten am Prämien-Programm teilnehmen, weder als "Werber" noch als "geworbener Kunde". iHerb behält sich das Recht vor, nach eigenem Ermessen Personen zu disqualifizieren und alle damit verbundenen Accounts zu löschen, wenn solche Handlungen entdeckt werden.
    
    Bei Streitigkeiten über das iHerb-Prämien-Programm, das Prämienguthaben oder das Aktionsprämienguthaben behält sich iHerb das Recht vor, die endgültige Entscheidung zu treffen.Bei Streitigkeiten über das iHerb-Prämien-Programm, das Prämienguthaben oder das Aktionsprämienguthaben behält sich iHerb das Recht vor, die endgültige Entscheidung zu treffen.
    
    Account-Überprüfung
    
    Alle Accounts, berechtigten Einkäufe und/oder Prämienguthaben und/oder Werbeprämienguthaben unterliegen der Überprüfung nach alleinigem und eigenem Ermessen von iHerb. iHerb behält sich das Recht vor, Prämienguthaben oder Werbeprämienguthaben zu stornieren und Ihren Account von einer IP-Adresse oder einem Gerät aus auszusetzen/zu sperren, wenn eine betrügerische oder verdächtige Aktivität entdeckt oder vermutet wird. Sollten Abweichungen zwischen der Höhe des Prämienguthabens oder Werbeprämienguthabens, das Sie möglicherweise in Ihrem Account angesammelt haben und der aufgezeichneten Menge in Ihren und den internen Unterlagen von iHerb auftreten, so gilt die Menge in den Unterlagen von iHerb. Sollten sich Streitigkeiten bezüglich dieser Nutzungsbedingungen ergeben, ist eine von iHerb getroffene Entscheidung in jedem Fall endgültig und abschließend.
    ...
    iHerb sendet Ihnen eine E-Mail-Benachrichtigung, wenn Sie Ihr Prämienguthaben oder Werbeprämienguthaben für nichtig erklären und/oder Ihren Account pausieren oder sperren, vorausgesetzt, Sie haben sich für den Empfang von Benachrichtigungen bezüglich Prämien und Mitteilungen entschieden, die Sie unter den Einstellungen für[Benachrichtigungen](https://secure.iherb.com/communications/preferences/) überprüfen können.
    
    Beendigung des Prämienprogramms
    
    Im Falle der Beendigung Ihrer Teilnahme an dem Prämienprogramm und falls Sie die Nutzungsbedingungen einhalten, wird iHerb in seinem alleinigen Ermessen Prämienguthaben an Sie ausgeben, entweder in Form von Prämienguthaben, das für Einkäufe auf der Website verwendet werden kann, oder als Scheck. Eine solche Auszahlung ist auf ein Maximum von drei (3) Monaten an Prämienguthaben begrenzt, dessen Berechnung auf Grundlage Ihres Prämienguthabens für den Monat vor der Beendung des Prämienprogramms erfolgt. Jegliches verdientes Werbeprämienguthaben in Ihrem Account ist bis zum Ablaufdatum gültig.
    ...
    Die Vorteile von Spar-Abos, die auf der Seite mit den [häufig gestellten Fragen](https://www.iherb.com/info/autoship-save) zu Spar-Abos erläutert werden, sind Teil dieser Bedingungen. iHerb behält sich das Recht vor, die Vorteile von Spar-Abos, einschließlich der Rabattbeträge und der Berechtigung, die zur Bestimmung der Rabattbeträge verwendet werden, jederzeit nach eigenem Ermessen zu ändern. Alle Änderungen gelten für zukünftige Bestellungen, auch für aktuelle Abonnements.
    ...
    Die Vorteile von Spar-Abos sind auf Artikel beschränkt, bei denen die Spar-Abo-Informationen auf der Produktseite angezeigt werden. Eine vollständige Liste der berechtigten Artikel finden Sie unter [https://www.iherb.com/cl/autoship-save](https://www.iherb.com/cl/autoship-save). Ein Spar-Abo ist nur für Kunden verfügbar, die Sendungen in die USA, nach Japan, Singapur, Korea, und Hongkong erhalten. Ihre Teilnahme am Spar-Abo-Programm ist für Sie persönlich und Sie dürfen Ihr Abonnement oder einen der Vorteile ohne unsere Genehmigung nicht an Dritte abtreten oder übertragen.
    
    Rabatte durch „Spar-Abos“ und alle gültigen „Spar-Abo“-Sonderaktionsabonnements für begrenzte Zeit gelten nur für berechtigte Artikel, bei denen die Angebotsnachricht auf den „Spar-Abo“-Artikelinformationsseiten angezeigt wird, und nur dann, wenn Sie die Versandmethode „Spar-Abo“ auswählen. Abonnements sind möglich, solange der Vorrat reicht. Spezielle zeitlich begrenzte Abonnementwerbeaktionen gelten nur während ihrer Gültigkeitsdauer.
    
    Spar-Abos sind bei Verbot ungültig.
    
    Zahlung; Erneuerung
    
    Die Gesamtkosten, die Ihrer Zahlungsmethode für jede Spar-Abo-Bestellung in Rechnung gestellt werden, sind die Kosten des Artikels am Tag der Auftragsbearbeitung abzüglich des Spar-Abo-Rabatts, zuzüglich der jeweils geltenden Mehrwertsteuer und Versandkosten. Wenn Sie Prämienguthaben haben, wird das verfügbare Guthaben automatisch vor der Zahlung auf Ihre erste Spar-Abo-Bestellung und auf die darauf folgenden angewandt.
    
    Die Gebühr für jede Spar-Abo-Artikelsendung wird über die Zahlungsmethode berechnet, die Sie zum Erstellen Ihres Abonnements verwendet haben oder wie von Ihnen anderweitig festgelegt. Wenn wir Ihre Spar-Abo-Bestellung nicht mit der Zahlungsmethode abschließen können, die Sie zum Erstellen Ihres Abonnements verwendet haben, ermächtigen Sie uns, Ihr Abonnement mit einer anderen Zahlungsmethode in Ihrem Account zu aktualisieren und diese Zahlungsmethode für Ihre Spar-Abo-Bestellung zu verwenden.
    
    Kündigung
    
    Ihr Abonnement bleibt gültig, bis es gekündigt wird. Sie können jederzeit kündigen. Wenn Sie Ihr Abonnement kündigen und es dann erneut aktivieren, ist der Rabatt, der auf einen Spar-Abo-Artikel angewendet wird, möglicherweise nicht derselbe Rabatt, der zum Zeitpunkt der Kündigung gültig war. Wenn sich der Spar-Abo-Rabattprozentsatz für solche Artikel ändert, wird der neue Rabatt auf Ihre zukünftigen Sendungen dieses Artikels angewendet. Weitere Informationen zur Kündigung Ihres Spar-Abos finden Sie auf der Seite mit den [häufig gestellten Fragen](https://www.iherb.com/info/autoship-save) zu Spar-Abos.
    
    Vereinbarungsänderungen
    
    Wir können diese Bedingungen nach eigenem Ermessen ohne vorherige Ankündigung ändern. Sollte eine Änderung dieser Bedingungen für ungültig, nichtig oder aus irgendeinem Grund als nicht durchsetzbar befunden werden, kann diese Änderung als ungültig betrachtet werden und hat keinen Einfluss auf die Gültigkeit und Durchsetzbarkeit der verbleibenden Änderungen oder Bedingungen. IHRE FORTSETZUNG DER TEILNAHME NACH DER ÄNDERUNG DIESER BEDINGUNGEN STELLT IHRE ANNAHME DER ÄNDERUNGEN DAR. WENN SIE MIT DEN ÄNDERUNGEN NICHT EINVERSTANDEN SIND, MÜSSEN SIE IHRE ABONNEMENTS KÜNDIGEN.
    

### iHerb-Partnerprogramm

Das Partnerprogramm steht Websites offen, die ihren Datenverkehr monetarisieren möchten, indem sie Verkäufe über einen Affiliate-Link an iHerb weiterleiten. Zu den Websites, die zur Teilnahme berechtigt sind, gehören unter anderem: Coupon-Websites, Treue-Websites, Content-Websites, Unternetzwerke usw. Um mehr über das Partnerprogramm zu erfahren und sich für dieses zu bewerben, besuchen Sie [https://www.iherb.com/info/affiliates](https://www.iherb.com/info/affiliates) . Ihre Bewerbung unterliegt der Überprüfung und Genehmigung.
...
17. Salvatorische Klausel; Interpretation
    -------------------------------------
...
18. Geltendes Recht; Zuständigkeit; Schiedsklausel; Verzicht auf Schwurgerichtsverfahren; Verzicht auf Sammelklagen:
    ----------------------------------------------------------------------------------------------------------------
    ...
    **DIE PARTEIEN VEREINBAREN FERNER, DASS EIN SCHIEDSVERFAHREN AUSSCHLIESSLICH IN IHREN ODER UNSEREN KAPAZITÄTEN ERFOLGEN DARF, NICHT ALS SAMMELKLAGE, VORGEBLICHE SAMMELKLAGE, KOLLEKTIV- ODER ANDERE VERBANDSKLAGE.** DAS SCHIEDSGERICHT KANN NICHT MEHR ALS EINEN ANSPRUCH EINER EINZELPERSON ODER GESELLSCHAFT KONSOLIDIEREN ODER SICH DARAN BETEILIGEN UND DARF KEINE VERBANDSKLAGEN, KOLLEKTIVVERFAHREN ODER GRUPPENVERFAHREN PRÄSIDIEREN. SOLLTE IRGENDEIN TEIL DIESES SAMMELKLAGEVERZICHTS ALS UNGÜLTIG ODER NICHT DURCHSETZBAR ERACHTET WERDEN, SO WIRD DIESER NICHT GETRENNT UND DIE GESAMTE SCHIEDSVEREINBARUNG IST NICHT DURCHSETZBAR.
    ...
    Sofern Sie und iHerb keine andere Vereinbarung getroffen haben, wird das Schiedsverfahren in dem Landkreis, in dem Sie wohnhaft sind, von einem einzigen von den Parteien vereinbarten neutralen Schiedsgericht, oder, falls keine Einigung erfolgt, nach den aktuellen Regeln zur Beilegung von Streitigkeiten der American Arbitration Association (AAA). Das Schiedsverfahren wird in Übereinstimmung mit den zu der Zeit geltenden Regeln für die Beilegung von Streitigkeiten der American Arbitration Association (AAA) durchgeführt (verfügbar auf [www.adr.org](https://de.iherb.com/info/www.adr.org)), oder, wenn diese Regeln nicht mehr verfügbar sind, in Übereinstimmung mit den vom Schiedsgericht ausgewählten geltenden Regeln; es gelten jedoch keine Regeln, die Sammelklagen, Kollektivklagen, oder andere repräsentative Schiedsverfahren erlauben. Im Falle von Konflikten zwischen dieser Schiedsvereinbarung und den geltenden Regeln des Schiedsverfahrens, gelten die Bestimmungen dieser Schiedsvereinbarung.
...
19. Sonstiges:
    ...
    Sie sind nicht berechtigt, diesen Vertrag ohne unsere vorherige schriftliche Zustimmung kraft Gesetzes oder anderweitig zu übertragen. Vorbehaltlich dieser Einschränkung ist diese Vereinbarung für die Parteien und deren jeweilige Rechtsnachfolger und Abtretungsempfänger bindend und vollstreckbar.
...
20. Kontaktieren Sie uns:
    ...
    Wenn Sie Fragen zu dieser Vereinbarung haben, kontaktieren Sie bitte unser [Kundenserviceteam.](https://secure.iherb.com/info/Contact)
...
[Internet Explorer](https://www.microsoft.com/download/internet-explorer-11-for-windows-7-details.aspx)
