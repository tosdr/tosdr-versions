...
Toptal Cookie Policy
====================

Date of Last Revision: November 03, 2023

Introduction
------------

This cookie policy (“**Cookie Policy**”) describes the cookies and other technologies that Toptal, LLC (“**Toptal**”) uses on its websites and mobile application (the “**Site**”) and the choices that you have related to such tracking. This Cookie Policy forms part of our [Privacy Policy](https://www.toptal.com/privacy).

Depending on your location, you may be asked to consent to the use of cookies and other technologies on the Site in accordance with this Cookie Policy when you first visit the Site, and we will store such cookies on your computer if you accept.

This Cookie Policy includes an overview of cookies and other technologies that we use on the Site. The Cookie Policy also provides a list of the specific technologies that we use, a description of why we use the technology, for example, to improve our analytics and provide better services, and an explanation of how to opt-out of the cookie if possible. Please reach out to Toptal at [privacy@toptal.com](mailto:privacy@toptal.com) if you have any questions about our practices, or you may use the additional form of contact in the Contacting Toptal section of this Policy.
...
A cookie is a piece of information sent to your browser from a website and stored on your computer that the website can use to gather information. Cookies can help a website recognize repeat users and allow a website to see web usage behavior. If you are interested in cookies and similar technologies, you can learn more on websites like [All About Cookies](https://www.allaboutcookies.org/verify).

Cookies can be stored on your computer for different periods of time. “Session cookies” are deleted automatically once you close your browser. “Persistent cookies” cookies survive until a pre-defined expiration date set in the cookie, which is determined by the third party that placed the cookie. Persistent cookies help recognize your computer when you open your browser and browse the internet again. “First party cookies” are placed by a website directly and “third-party cookies” are placed by a third-party with a website’s permission to do so.

Our Site uses first party cookies and third-party cookies, as described below. We also use pixel tags from the third parties described below to see information about your usage of the Site and the Services and your interaction with email or other communications. Pixel tags are a technology like cookies that can be embedded in online content or within the body of an email for the purpose of seeing activity on websites, for example, to know when you have viewed particular content or a particular email message.
...
To provide users with the services available through our Site and to use some of its features, such as the ability to log-in and access secure areas. Toptal places these cookies, and they are essential for using the Site. Basic functions of our Site would not work without these cookies.

**Opt-out**

Because these cookies are strictly necessary to deliver the Site and our services, you cannot opt-out of them if you choose to use the Site.
...
* **CrazyEgg**. Learn more about CrazyEgg’s privacy practices [here](https://www.crazyegg.com/privacy).
* **Datadog**. Learn more about Datadog’s privacy practices [here](https://www.datadoghq.com/legal/privacy/).
* **FullStory**. Learn more about FullStory’s privacy practices [here](https://www.fullstory.com/legal/privacy/).
* **Google Analytics 360 and GA4**. Learn how Google uses data collected on our Site [here](https://policies.google.com/technologies/partner-sites?hl=en). Learn more about how these cookies expire [here](https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage).
* **Imperva**. Learn more about Imperva’s privacy practices [here](https://www.imperva.com/legal/privacy-policy/).
* **LogRocket**. Learn more about LogRocket’s privacy practices [here](https://logrocket.com/privacy/).
* **Microsoft App Store**. Learn more about Microsoft App Store’s privacy practices [here](https://privacy.microsoft.com/en-us/privacystatement)
* **Optimizely**. Learn more about Optimizely’s privacy practices [here](https://www.optimizely.com/privacy/).
* **Segment**. Learn more about Segment’s privacy practices [here](https://segment.com/legal/privacy/).
...
* **CrazyEgg**. To opt-out of CrazyEgg’s tracking, please visit [Opt-Out](https://www.crazyegg.com/opt-out).
* **FullStory**. To opt-out of Full Story’s tracking, please visit [Opt-Out](https://www.fullstory.com/optout/).
* **Google Analytics**. You can download and install the Google Analytics Opt-Out Browser Add-on for your current web browser at [Google Analytics Opt-Out Browser Add-on](https://tools.google.com/dlpage/gaoptout?hl=en).
* **Mouseflow**. To opt-out of Mouseflow’s tracking, please visit [Opt-Out](https://mouseflow.com/opt-out/).

#### 3\. Advertising/Targeting

**Purpose**

To collect information about browsing habits to make advertising more relevant:

* **Criteo**. Learn more about Criteo’s privacy practices [here](https://www.criteo.com/privacy/).
* **Demandbase.** Learn more about Demandbase’s privacy practices [here](https://www.demandbase.com/privacy/).
* **Google AdServices**. Learn more about Google’s privacy practices [here](https://policies.google.com/privacy?hl=en).
* **HubSpot**. Learn more about Hubspot’s privacy practices and the types of cookies used by Hubspot [here](https://knowledge.hubspot.com/account/hubspot-cookie-security-and-privacy).
* **LinkedIn Insights**. Learn more about LinkedIn’s privacy practices [here](https://www.linkedin.com/legal/privacy-policy).
* **LiveRamp**. Learn more about LiveRamp’s privacy practices [here](https://liveramp.com/privacy/).
* **Meta**. Learn more about Meta’s privacy practices [here](https://www.meta.com/help/accounts/meta-privacy-policies/) or [here](https://www.facebook.com/policies/cookies/).
* **Microsoft**. Learn more about Microsoft’s privacy practices [here](https://privacy.microsoft.com/en-us/privacystatement).
* **Quora**. Learn more about Quora’s privacy practices [here](https://www.quora.com/about/privacy).
* **Reddit**. Learn more about Reddit’s privacy practices [here](https://www.reddit.com/policies/privacy-policy).
* **Twitter**. Learn more about Twitter’s privacy practices [here](https://twitter.com/en/privacy).
...
* **Meta**. To opt out, please visit [About Facebook Ads](https://www.facebook.com/help/769828729705201).
* **Google AdServices**. To opt out, please visit [Ads Settings](https://adssettings.google.com/authenticated).
* **LinkedIn Insights**. To opt out, please visit [Manage Advertising Preferences](https://www.linkedin.com/help/linkedin/answer/62931/manage-advertising-preferences?lang=en).
* **LiveRamp**. To opt-out of LiveRamp’s tracking, please visit [Opt-Out](https://liveramp.com/opt_out/).
...
* [Microsoft Edge](https://support.microsoft.com/en-us/microsoft-edge/view-cookies-in-microsoft-edge-a7d95376-f2cd-8e4a-25dc-1de753474879) and [Internet Explorer](https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-11)
...
If you have any questions or concerns, you may contact us as follows: by email at [privacy@toptal.com](mailto:privacy@toptal.com), or by post at:

**Toptal, LLC**  
Attention: Cookie Policy Query  
