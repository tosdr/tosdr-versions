...
* Additional terms for npm Paid Services are available at [https://docs.npmjs.com/policies/private-terms](https://www.npmjs.com/policies/private-terms).
...
npm respects your privacy and limits use and sharing of information about you collected by npm Services. The privacy policy at [https://docs.npmjs.com/policies/privacy](https://www.npmjs.com/policies/privacy)(the _Privacy Policy_) describes these policies. npm will abide by the Privacy Policy and honor the privacy settings that you choose via npm Services.

npm respects the exclusive rights of copyright holders and responds to notifications about alleged infringement via npm Services per the copyright policy at [https://docs.npmjs.com/dmca](https://www.npmjs.com/policies/dmca) (the _Copyright Policy_).

npm resolves disputes about package names, user names, and organization names in the Public Registry per the policy at [https://docs.npmjs.com/disputes](https://www.npmjs.com/policies/disputes) (_Dispute Policy_). This includes "package squatting".

Use of all npm Services is governed by the code of conduct at [https://docs.npmjs.com/conduct](https://www.npmjs.com/policies/conduct) (_Code of Conduct_).

npm permits use of npm trademarks per the policy at [https://docs.npmjs.com/trademark](https://www.npmjs.com/policies/trademark).
...
1. You will abide by the [Code of Conduct](https://www.npmjs.com/policies/conduct) and the [Dispute Policy](https://www.npmjs.com/policies/disputes).
...
5. Content that exists only to "reserve" a name, whether a package name, user name, or organization name. The [Dispute Policy](https://www.npmjs.com/policies/disputes) governs how npm handles such cases of "squatting".
    

To find out how to report violations of Acceptable Content, refer to the [Code of Conduct](https://www.npmjs.com/policies/conduct).
...
2. Packages that display ads at runtime, on installation, or at other stages of the software development lifecycle, such as via [npm scripts](https://www.npmjs.com/misc/scripts). Packages with code that can be used to display ads are fine. Packages that themselves display ads are not.
...
There is no charge for use of npm Open Source. If you use Paid Services from npm, our Paid Services Terms at [https://docs.npmjs.com/policies/private-terms](https://www.npmjs.com/policies/private-terms) apply.
