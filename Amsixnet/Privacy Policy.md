...
881](https://www.ams-ix.net/ams/connected-networks)
...
When you contact us by email or through our contact form, or contact us in any other way, you respond to our offer to contact us (performance of the contract). For this purpose, we process the following personal data:
...
When you visit our website for the first time, we display a message with an explanation about cookies. We hereby request, as far as we are required, your consent to the use of cookies.  
  
We can use the following cookies:

* DoubleClick (Advertising cookies)
* LinkedIn Ads (Advertising cookies)
* Google Analytics (Analytical cookies)
* LinkedIn Analytics (Analytical cookies)
* GoogleTag Manager (Essential cookies)
