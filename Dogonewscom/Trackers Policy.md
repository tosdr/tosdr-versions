...
| Cookie Origin | Cookie Name(s) | Description |
| --- | --- | --- |
| dogonews.com  <br>dogobooks.com  <br>dogomovies.com | \_idogo32\_session | Keeps information about your browsing activities for the duration of the session. |
| dogonews.com  <br>dogobooks.com  <br>dogomovies.com | XSRF-TOKEN | Security token to prevent Cross-Site Request Forgery (CSRF), an attack that allows a malicious user to spoof legitimate requests to our servers. |
| dogonews.com  <br>dogobooks.com  <br>dogomovies.com | cookieconsent\_status | To track whether or not you have consented to the setting of non-essential cookies on our websites. |
| stripe.com | \_\_stripe\_mid  <br>\_\_stripe\_sid | Set by Stripe, our third party payment processing partner, and necessary in order to accept payments for DOGOnews for Teachers Pro subscriptions.  <br>[View Stripe's Privacy Policy](https://stripe.com/us/privacy/) |
| google.com | G\_AUTHUSER\_H  <br>G\_ENABLED\_IDPS | Set by Google Single-Sign On when a teacher logs into their Google account in order to import their Google Classroom roster. |
| cloudflare.com | \_\_cfduid | Set by Cloudflare, our third party content delivery network to identify trusted web traffic. It does not store any personally identifiable information. For more info see:  <br>[What does the Cloudflare cfduid cookie do?](https://support.cloudflare.com/hc/en-us/articles/200170156-What-does-the-Cloudflare-cfduid-cookie-do-)  <br>[View the Cloudflare Cookie Policy](https://www.cloudflare.com/cookie-policy/) |

### Category 2: Performance Cookies

These cookies collect information about how our visitors use the website. For example, it enables us to know which pages visitors go to most often, and if they get error messages from web pages.

| Cookie Origin | Cookie Name(s) | Description |
| --- | --- | --- |
| google.com | \_ga  <br>\_gid  <br>\_gat | Set by Google Analytics our third party analytics platform to generate statistical data to help us understand our audience. On our websites, we always enable IP anonymization when using Google Analytics. For more info see:  <br>[IP Anonymization in Google Analytics](https://support.google.com/analytics/answer/2763052?hl=en)  <br>[Google Analytics Cookie Usage on Websites](https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage) |

### Category 3: Functionality Cookies

These cookies allow you to set and store preferences such as, user name, for our websites. These cookies can also be used to remember changes you have made to text size, fonts and other parts of web pages that you’ve customized.

| Cookie Origin | Cookie Name(s) | Description |
| --- | --- | --- |
| dogonews.com  <br>dogobooks.com  <br>dogomovies.com | remember\_user\_token | To automatically keep you logged in when you leave and come back to our website. |
| dogonews.com  <br>dogobooks.com  <br>dogomovies.com | browser.timezone | To keep track of your timezone so that dates can be displayed in your local timezone. |
| vimeo.com | player | Set by Vimeo player when playing videos embedded from Vimeo. For more info see:  <br>[Vimeo Cookie List](https://vimeo.com/cookie_list)  <br>[Vimeo Cookie Policy](https://vimeo.com/cookie_policy) |

### Category 4: Display Banner Cookies

These cookies are only used to count display banner delivery for promotion of children's books, free book giveaways and educator resources. These cookies are only associated with the user's browser and do not contain any personally identifiable information (PII) or any persistent identifiers. We do not use third party advertising networks, or allow targeted or personalized advertising of any type.

| Cookie Origin | Cookie Name(s) | Description |
| --- | --- | --- |
| google.com | \_\_gads | The advertising cookie named ‘\_\_gads’ may be set to measure interactions with banner ads and prevent the same ones from being shown to you too many times. |

### Controlling and Deleting Cookies

For users from the European Union and the United Kingdom ("EU users") we allow you the ability to opt out of accepting cookies by clicking on the cookie banner when you first enter our websites.

If you would like to change how a browser uses cookies, including blocking or deleting cookies from our websites you can do so by changing the browser settings.
