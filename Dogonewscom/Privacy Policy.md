...
[DOGObooks](https://www.dogobooks.com/)[Teachers](https://www.dogonews.com/teachers)[Librarians](https://www.dogonews.com/school-libraries)[Parents](https://www.dogonews.com/homeschool) [Sign In](https://accounts.dogonews.com/auth/signin?callbackUrl=https%3A%2F%2Fwww.dogonews.com%2Fpages%2Fprivacy-policy)
...
DOGO Media is a proud signatory of the [Student Data Privacy Pledge](https://studentprivacypledge.org/privacy-pledge/).

Welcome to DOGO Media's websites. We respect and protect the privacy of our users and intend our websites to be a safe place for everyone who visits and corresponds with us. Our information practices are designed to comply with the United States Federal Trade Commission's Children's Online Privacy Protection Act (COPPA) and the European Union General Data Protection Regulation EU 2016/679 (GDPR) for users from the European Union and the United Kingdom.

**DOGO Media, Inc.** (collectively, “DOGO,” “we,” “us,” “our”) understand that Internet privacy is important to you, so we are providing this Privacy Policy to explain how we collect, use, and disclose personal information and personal data in clear, easy-to-understand language. This Privacy Policy applies to all of our websites, apps, mobile experiences, our application programming interface (“API”) and digital content that link to this Privacy Policy (collectively, the “DOGO websites”) and outlines how DOGO as a data controller collects, processes, uses and discloses the information you provide by using DOGO websites. We will use your personal data only for the purposes and in the manner set forth below, which describes the steps we take to ensure our processing of your personal data is in compliance with the GDPR.

1. [Information Collection – (i) From Account holders and (ii) From All users](#section-information-collection)
2. [User choices and opt-out](#section-user-choices-and-opt-out)
3. [Processing Grounds](#section-processing-grounds)
4. [Parental Consent](#section-parental-consent)
5. [Use of Personal Information](#section-use-of-personal-information)
6. [Sharing of Personal Information](#section-sharing-of-personal-information)
7. [Data Retention and Information Security](#section-data-retention-and-information-security)
8. [Parental Control of Personal Information](#section-parental-control-of-personal-information)
9. [California Privacy Rights and Do Not Track Disclosure](#section-california-privacy-rights-and-do-not-track-disclosure)
10. [International Visitors](#section-international-visitors)
11. [EU Personal Data and Your Rights under GDPR](#section-eu-personal-data-and-your-rights-under-gdpr)
12. [Links to Third Party Sites, Services, and Content](#section-links-to-third-party-sites-services-and-content)
13. [Updates](#section-updates)

### **Information Collection**

DOGO websites generally require little or no collection of personal information and you can use the services without registering for an account or providing any personal data. DOGO only collects personal information when a user knowingly and voluntarily provides it to us as part of the registration process for creating a user account.

### (i) From Account holders

**iDOGO accounts**

iDOGO is a service that allows children to create avatars, create a book list, bookmark content, earn points and badges, enter giveaways and contests, and link to other users' iDOGO pages. During the iDOGO account registration, we ask for (but do not save) a user's date of birth to determine whether parental consent is required for a child to use the iDOGO service. When children under the age of 16 create an iDOGO account, we ask them to provide a parent or guardian email. We use the provided parent or guardian email in order to send an email notifying the recipient that their child has created an iDOGO account. We inform them of their child's username and password and provide them with a link to cancel the account if they wish to. When children the age of 16 or over create an iDOGO account, we ask them to provide their email.

If a child uses a third party authentication service like Google, CLEVER or Microsoft Office365 to create an iDOGO account and if they are under the age of 16, we do not store the child’s email provided from the third party authentication service, but instead we ask the child for a parent or guardian email. If the child is the age of 16 or over, we fetch their email from the third party authentication service in order to pre-populate the email field on the registration page, which the child can always overwrite.

**Teacher accounts**

Teacher accounts allow educators to create classroom pages, student accounts, assign content, and enter giveaways. Teacher accounts may only be obtained by teachers who are 18 years of age or older. During the Teacher account registration, teachers are asked to provide first and last name, email, school name and address, and the grade they teach. We use the email to contact teachers about the service in the following situations: (i) request for a password reset; (ii) respond to a question or a concern; or (iii) to send email newsletters that the teacher opted-into. The email newsletters offer teachers the opportunity to unsubscribe and decline further communications.
...
If a teacher signs up for DOGOnews for Teachers PRO, which requires payment, we may collect payment information (such as credit or debit card) and pass the information to Stripe, our third party payment processor. All payments are processed by Stripe and all payment information is stored by them and is not available to us.
...
On DOGOnews.com, we may collect and store emails when a Teacher or Parent opts-in to receive the DOGOnews email newsletter. The email newsletters, offer recipients the opportunity to unsubscribe and decline further communication.

On DOGObooks.com, we may collect and use (but do not store) information about your general location (coarse geolocation) to help you locate nearby libraries. You may change the settings on your computer or mobile device to prevent it from providing us with any location information.

Our websites offer a share content via email button which asks for both the recipient’s and sender’s email address. These emails are discarded once the share email is sent

2\. User choices and opt-out
----------------------------
...
For users from the European Union and the United Kingdom (“EU users”) we will only use your Personal Data if we have a lawful basis for doing so. Lawful bases for processing include consent, contractual necessity, and our “legitimate interests” or the legitimate interest of others, as described below.

|     |     |
| --- | --- |
| **Purpose(s) for Processing** | **Lawful Basis for Processing** |
| • To create and maintain a user account.<br><br>• To provision premium services.  <br>• To provide software as a service.  <br>• To provide help and support. | Processing is necessary for the **performance of a contract** or to enter into such a contract with you. |
| • To provide newsletters or email updates.<br><br>• To enable you to watch videos.<br><br>• To gather audience data and improve our website experience.<br><br>• To deliver and measure advertising. | Your **consent** – which you can withdraw at any time. |
| • To manage and operate our websites – to keep our websites secure.<br><br>• To ensure that content on the Website is presented in the most effective manner for you and for your computer or mobile device.  <br>• To carry out our obligations arising from any contracts entered into between you and us.  <br>• To allow you to participate in interactive features of the Website, when you choose to do so.  <br>• To notify you about any changes to the Website, policies, products and services. | The processing is necessary to support our **legitimate business interests** in managing our business provided such interests are not overridden by your interests and rights. We have carried out a balancing test to ensure that your interests do not override this legitimate business interest of ours. **Please note that you have a right to object to processing of your personal data where that processing is carried on for our legitimate interest.**<br><br>**You have the right to object at any time.** |
...
We never collect, store, use, or disclose personal information from children under the age of 16 without prior parental consent. As outlined in Information Collection from Account holders – iDOGO accounts (Section 1 - i), we may collect and store a parent’s email from children under the age of 16 in order to notify the parent that his or her child signed up for an iDOGO account and to provide them with a link to cancel the account if they wish to.

From time to time, we may have special online promotions such as giveaways and contests on the DOGO websites that are open for iDOGO users under the age of 16. In order for the child to be awarded a prize we require a written parental consent form be signed by the parent and returned to us. The written parental consent form may ask for additional personal information necessary to award the prize. In these situations, we may email a parent or guardian as follows: (i) to inform them that their child has entered a giveaway or contest and provide them a link to cancel their child’s participation and (ii) to remind them at the conclusion of a promotion, that a written parental consent is required in order to consider their child for the promotion. Information given to us in this circumstance is used only for the purpose of awarding the prize and is stored in encrypted form on our secure servers for any future promotion the child may participate in. The special online promotions are only for users residing in the US, since we do not fulfill prizes to Non-US users.

5\. Use of Personal Information
-------------------------------

Except as outlined in Parental Consent (Section 3) and Information Collection from Account holders – Teacher accounts (Section 1 - ii), we do not use personal information that we collect through the DOGO websites.
...
1. We continually develop and implement features to keep your personal information safe
2. When you enter any information anywhere on DOGO websites we encrypt the transmission of that information using secure socket layer technology (SSL/TLS/HTTPD encryption)
3. The database where we store personal information is encrypted at rest, which converts all personal information stored in the database to an unintelligible form
4. We ensure passwords are stored and transferred securely using encryption and salted hashing. User passwords are not visible to DOGO administrators or employees
5. We restrict access to personal information to authorized employees only
6. Other security safeguards include but are not limited to data encryption, firewalls, and physical access controls to files
...
8\. Parental Control of Personal Information
--------------------------------------------
...
If you are under the age of 18, or the parent of a user under the age of 18, residing in California, you are entitled to request removal of content or information you have posted on DOGO websites. To request removal of your or your child’s content or information, please email us at [help@dogonews.com](mailto:help@dogonews.com) for assistance, or you can delete specific information (or delete your or your child’s account) directly. Please note that removal of your content or information does not ensure complete or comprehensive removal, as there may be de-identified or recoverable elements of your content or information on our servers in some form. Additionally, we will not remove content or information that we may be required to retain under applicable federal and state laws.

Currently, various browsers offer a “Do Not Track” or “DNT” option that relies on a technology known as a DNT header, which sends a signal to Web sites visited by the user about the user’s browser DNT preference setting. DOGO does not track users over time and across third-party websites and therefore does not respond to Do Not Track (DNT) signals. For more information on “do not track”, please visit www.allaboutdnt.org.

We do not share information that we collect through the DOGO websites with third parties for the third party’s direct marketing purposes.

10\. International visitors
---------------------------

DOGO websites are operated and managed on servers located within the United States. If you use DOGO websites from the European Union or other regions of the world with laws governing data collection and use that differ from U.S. law, then you acknowledge and agree that you are transferring your Personal Information outside of those regions to the United States and that, by providing your Personal Information on DOGO websites, you consent to that transfer.

11\. EU Personal Data and Your Rights under GDPR
------------------------------------------------

DOGO is committed to providing you control over and visibility to your Personal Data. If you are located in the EU, United Kingdom, Lichtenstein, Norway, or Iceland, you may have additional rights under the EU General Data Protection Regulation (the "GDPR") related to your Personal Data, as described below.

We may limit or reject your request in certain cases, such as if it is frivolous or extremely impractical, if it jeopardizes the rights of others, if it is not required by law, or if the burden or expense of providing access would be disproportionate to the risks to your privacy in the case in question. In some cases, we may also need you to provide us with additional information, which may include Personal Data, to verify your identity and the nature of your request. If you are an Account holder (iDOGO or Teacher account), you can accomplish most of the following by logging into your account.

Access: You can request a copy of the Personal Data we hold about you.

Rectification: If you believe that any Personal Data we are holding about you is incorrect or incomplete, you can request that we correct or supplement such data.

Erasure: You can request that we erase some or all of your Personal Data from our systems. Note that if you request the deletion of information required to provide the Service to you, your User Account will be deactivated and you will lose access to the Service.

Portability: You can ask for a copy of your Personal Data in a machine-readable format. You can also request that we transmit the data to another controller where technically feasible.

For the following, please email us at privacy@dogonews.com:
...
You also have the right to lodge a complaint about DOGO's practices with respect to your Personal Data with the supervisory authority of your country or EU Member State.

12\. Links to Third Party Sites, Services, and Content
------------------------------------------------------

DOGO websites may contain links to other websites, online services, apps, and content that are operated and maintained by third parties and that are not under the control of or maintained by us. Such links do not constitute an endorsement by us of those other apps, websites, the content displayed therein, or the persons or entities associated therewith. This Privacy Policy does not apply to your interactions with those third parties, even if you find a link to them on the DOGO websites. We encourage you to read the privacy policy of the third-party website provider to see how your personal information will be treated on its site.
