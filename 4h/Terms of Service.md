...
[Home](https://4-h.org/) ![](https://4-h.org/wp-content/themes/4h/assets/images/icons/breadcrumbs-separator.svg) Terms and Conditions
...
In order to access or use some (or potentially all) of the features on the Site, you may need to first register through our online registration process (“**Account**”). The Site’s practices governing any resulting collection, use, disclosure and management of your personal information are disclosed in its [PRIVACY POLICY](https://4-h.org/privacy-policy/).
...
We do not want you to, and you should not, send any confidential or proprietary information to us via the Site. Except as otherwise described in the Site’s posted [PRIVACY POLICY](https://4-h.org/privacy-policy/) or any Additional Terms, you agree that, notwithstanding your retained ownership interests (a) any information that you or individuals acting on your behalf provide to us will not be considered confidential or proprietary by us – regardless of whether you mark them “confidential,” “proprietary,” or the like – and will not be returned, and (b) to the maximum extent not prohibited by applicable law, 4H does not assume any obligation of any kind to you or any third party with respect to your User-Generated Content. By providing any such information, you grant us an unrestricted, irrevocable, worldwide, royalty-free license to use, reproduce, display, publicly perform, transmit and distribute such information. You further recognize that we do not want you to, and you warrant that you shall not, download, upload or otherwise provide any information to us that is defamatory, threatening, obscene, harassing or otherwise unlawful, or that incorporates the proprietary material of another.
...
**By Email:** [HTTPS://4H.ORG/CONTACT/](http://https//4H.ORG/CONTACT/)
...
**HOW TO ENTER:** At the start of or during the Promotion Period, participants must login to his/her Facebook account, visit [WWW.FACEBOOK.COM/4-H/](https://www.facebook.com/4-h/), locate and watch the STEM Challenge livestream, and, within 30 seconds from the time each question is asked and potential answers provided during the livestream, post a comment with the answer to each of the twelve STEM-related questions displayed on screen (each, an “Answer”). The letter and/or words in the Answer must be separated from any subsequent characters by a space and must be an exact match for the letter or word(s) as displayed during the livestream. A comment may include additional wording other than the Answer, at the entrant’s discretion, but only an Answer is required. Entrants are subject to all notices posted online including but not limited to the Sponsor’s Privacy Policy, which can be found at [HTTPS://4-H.ORG/PRIVACY-POLICY/](https://4-h.org/privacy-policy/). **This Sweepstakes is in no way sponsored, endorsed or administered by, or associated with, Facebook, Inc.**
