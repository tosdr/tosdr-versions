...
* A telephone number in the Applications will not receive messages from short codes from a different country.
* Some services, such as social media platforms, may choose not to send messages from their short codes to Voice over IP (VoIP) numbers as provided in the Applications. As such, we cannot guarantee that every short code message will be able to reach the telephone numbers you use in the Applications.
* The Applications cannot send SMS/MMS messages to short codes, including industry standard opt-out messages such as STOP, UNSUBSCRIBE or HELP.
...
**You must configure at least one funding source in your account, as the means to pay for the transactions you perform using your virtual cards. The currently accepted types of funding sources are credit cards and debit cards issued by a US financial institution, and US bank accounts capable of ACH transactions. You agree that you are the owner of all funding sources associated with your account and are authorized to make payments from that funding source. By adding a funding source to your account, you agree that Anonyome Labs is authorized to charge that funding source in accordance with these Terms of Service. If your funding source is a bank account, you will be required to agree to an ACH authorization before your funding source is active.
...
We transmit information to a PCI DSS Level 1 certified third-party processor to process transactions funded by your funding source. Your funding source information such as credit or debit card number or bank account details is never transmitted through or stored in our Services. In order to charge your funding source when you use your virtual card, we store a payment token corresponding to your funding source in our PCI DSS Level 1 certified Services.

**Using Virtual Cards  
**You are financially responsible for each transaction made using your virtual cards.

When a virtual card is used, we charge a non-refundable fee for providing the Service. The fee is charged at the same time as the merchant charge. The merchant charge amount and the fee are charged in a single transaction on your funding source. The exact fee you will be charged is shown in the Applications that offer virtual cards.
...
Disputing a charge with your bank for a virtual card transaction is filing a dispute against Anonyome Labs, Inc. and will not resolve any dispute with the merchant you purchased from when using your virtual card. Anonyome Labs, Inc is the card issuer for purchases completed with a virtual card. If you file a chargeback or ACH dispute against Anonyome Labs, Inc that Anonyome Labs, Inc contests and wins (i.e. you lose the chargeback) you will be charged a $25 chargeback processing fee. There is no chargeback processing fee if you win a contested chargeback.  The chargeback processing fees will be charged to a funding source that you have configured in the Application.

You remain financially responsible for each of your disputed transactions or charge backs until a dispute or chargeback refund has been processed.
...
* Furnishing false or incorrect data on a signup form.
* Falsifying header information or user identification information.
* Sending unsolicited (“opt-out”) bulk email. Users sending bulk email using the Services may only engage in such activity using closed-loop, opt-in lists. Such users who send bulk email through closed-loop, opt-in lists must have a method of confirmation or verification of subscriptions and be able to show evidence of subscription for users who complain about receiving unsolicited email.
...
You agree that you will only use this capability to analyze and manage the digital identity footprint of your own email accounts. Depending on your level of entitlement to use the capability, the analysis provided by this capability may be limited to a subset of third-party services identified from the analysis.
...
* Using the Applications or Services for offering loans, credit repair, debt relief or debt collection.
* Using the Applications or Services for the purpose of engaging in an activity in connection with any adult entertainment industry purpose, regardless of whether such activity is lawfully permitted.
* Continuing to communicate with an individual after they have withdrawn their consent for ongoing communications.
* Using the Applications for call center operations.
...
* Using the Applications or Services to conduct surveys, contests or pyramid schemes.
* Using the Applications to misrepresent your identity.
...
* Calling numbers (whether individually, sequentially, or automatically/”robo-dialing”) to generate income for yourself or others resulting from placing the call.
...
* Unusual telephony or email patterns inconsistent with normal, individual subscription use— for example, sending messages to a high number of recipients, messaging or calling the same destination number repeatedly, calls not consisting of uninterrupted live human voice, initiating a high number of short duration or unanswered calls, provisioning a high number of telephone numbers or creating a high volume of email accounts in a short period of time.
* Creating virtual cards or performing transactions to test card behaviors.
* Creating virtual cards to repeatedly exploit a referral program, free trial, or introductory offer program, or violate the terms and conditions of a merchant.
* Using virtual cards for fraudulent activities with a merchant.
...
**Subject to the terms herein, if you want to terminate the Services provided by Anonyome, you may do so by deleting the Applications from your devices and cancelling any associated subscriptions or memberships.

Anonyome has the right to suspend or terminate any Services provided to you for any reason, including if you have materially breached any provision of the Terms, or if Anonyome is required to do so by law (e.g., where the provision of the Anonyome Properties is, or becomes, unlawful). You agree that all terminations for cause shall be made at Anonyome’s sole discretion. You will not be entitled to a refund of any amounts previously paid to Anonyome for Paid Services.

If your account is suspended, access to all Services associated with the account may be suspended, not only the Service directly associated with the cause for suspension.
