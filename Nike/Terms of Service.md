...
**These Terms create a legally binding agreement between you and NIKE and its affiliates (which we may refer to as “NIKE,” “we,” “us,” or “our”) regarding your use of the Platform**. Please review our [List of Local Entities](https://agreement-global.lams.svs.nike.com/rest/agreement/localentities/en/US/com.nike.commerce.nikedotcom.web/redirect/true) for the name of the NIKE entity responsible for providing the Platform to you and the appropriate contact information. A few important points:
...
* **Terms of Sale.**  By making any purchase with us, you also agree to the [Terms of Sale](https://agreement-global.lams.svs.nike.com/rest/agreement/termsOfSale/en/US/com.nike.commerce.nikedotcom.web/redirect/true) that apply in your country or region. **\[See [Hungarian](#Hungary) terms.\]**
* **Privacy Policy.**  Our [Privacy Policy](https://agreement-global.lams.svs.nike.com/rest/agreement/privacyPolicy/en/US/com.nike.commerce.nikedotcom.web/redirect/true) describes the collection and use of personal information on the Platform and applies to your use of the Platform.
...
### **The following location-based service provider terms apply to your use of and access to the Nike Running Club app and the Nike Training Club app: [location-based service provider terms](https://agreement-global.lams.svs.nike.com/rest/agreement/LBSProvider/en/US/com.nike.commerce.nikedotcom.web/redirect/true). In the event of any conflict between the location-based service provider terms and these Terms, these Terms shall govern.**
