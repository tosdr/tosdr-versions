[![Postimage](//postimgs.org/img/logo.png)](https://postimages.org/)

* [Upload](https://postimages.org/)
* [Upload by URL](https://postimages.org/web)
* [Website plugins](https://postimages.org/plugins)
* [Windows App](https://postimages.org/app)

* [Log in](https://postimages.org/login)
* [Sign up](https://postimages.org/signup)
...
1. Identification of the copyrighted work or works claimed to have been infringed. IMPORTANT: you must have a registered copyright for the work, or at least have filed with the Copyright Office (http://www.copyright.gov/eco/) an application to register a copyright for the work. DMCA notifications based on unregistered works are not valid.
2. Identification of the material on our servers that is claimed to be infringing and that is to be removed, including the URL or other information to enable us to locate the material.
...
* [About](https://postimages.org/about)
* [Terms of Use](https://postimages.org/terms)
* [Privacy Policy](https://postimages.org/privacy)
* [FAQ](https://postimages.org/faq)
* [Languages](https://postimages.org/languages)
* [Contact us](https://postimages.org/contact)

Powered by © Postimages.org, 2004-2024
