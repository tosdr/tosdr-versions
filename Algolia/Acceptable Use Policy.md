* [* Deutsch](https://www.algolia.com/de/policies/policyEntryMenu/acceptable-use/ "Switch to ")[* English](#)[* français](https://www.algolia.com/fr/policies/policyEntryMenu/acceptable-use/ "Switch to ")
...
1. be sent to [abuse@algolia.com](mailto:abuse@algolia.com?subject=Attention%3A%20Abuse) or mailed to the following address: 
...
2. identify the exact content hosted, referenced or linked by Algolia that violates the AUP;
    
3. document your efforts to contact the subscriber directly; and
    
4. provide an email address to permit our subscriber or Algolia to contact you.
...
Algolia is a search as a service provider that hosts content of its subscribers. As an intermediary, Algolia is entitled to rely upon (among other things) the DMCA safe harbor available to hosting service providers and search engines. Although it is Algolia’s policy to respond to clear notices of alleged copyright infringement, Algolia recommends that you submit a notice pursuant to the DMCA directly to the originating site of the content. Algolia’s response to these notices may include forwarding the notice to the applicable subscriber or removing or disabling access to material claimed to be the subject of infringing activity. Algolia maintains policies and procedures to terminate subscribers that would be considered repeat infringers under the DMCA. See 17 U.S.C. 512 available at [http://www.copyright.gov/](http://www.copyright.gov/title17/92chap5.html#512)
