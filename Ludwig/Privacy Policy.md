...
This document contains [a section dedicated to California consumers and their privacy rights](https://ludwig.guru/privacy#california_info).

This document contains [a section dedicated to Virginia consumers and their privacy rights](https://ludwig.guru/privacy#virginia_info).

This document contains [a section dedicated to Colorado consumers and their privacy rights.](https://ludwig.guru/privacy#colorado_info)

This document contains [a section dedicated to Connecticut consumers and their privacy rights.](https://ludwig.guru/privacy#connecticut_info)

This document contains [a section dedicated to Utah consumers and their privacy rights.](https://ludwig.guru/privacy#utah_info)

This document contains [a section dedicated to Brazilian Users and their privacy rights](https://ludwig.guru/privacy#brazil_info).
...
* * ### Advertising
        ...
        * ### Google Ads conversion tracking, Meta ads conversion tracking (Meta pixel), Amazon Advertising, Google AdSense and Prebid
    ...
    * ### Analytics
        ...
        * ### ProfitWell
            ...
            Personal Data: email address; first name; last name; payment info; Usage Data; User ID
    ...
    * ### Displaying content from external platforms
        ...
        * ### Google Fonts and YouTube video widget
    ...
    * ### Handling payments
        ...
        * ### Stripe
            ...
            Personal Data: billing address; email address; first name; last name; payment info; purchase history; various types of Data as specified in the privacy policy of the service
            
        * ### PayPal
            
            Personal Data: email address; first name; last name; payment info; purchase history; various types of Data as specified in the privacy policy of the service
            
        * ### Braintree
            
            Personal Data: email address; first name; last name; purchase history; various types of Data as specified in the privacy policy of the service
    ...
    * ### Heat mapping and session recording
        ...
        * ### Microsoft Clarity
            ...
            Personal Data: clicks; country; custom events; device information; diagnostic events; interaction events; layout details; mouse movements; page events; positional information; scroll-to-page interactions; session duration; time zone; Trackers; Usage Data
    ...
    * ### Registration and authentication provided directly by this Website
        ...
        * ### Direct registration
            ...
            Personal Data: email address; first name; last name; profession
...
* * ### Owner and Data Controller
        ...
        Ludwig s.r.l.s. Via Fiume 6, Palermo 90133, Italia
        
        **Owner contact email:** [\[email protected\]](https://ludwig.guru/cdn-cgi/l/email-protection)
...
Among the types of Personal Data that this Website collects, by itself or through third parties, there are: Usage Data; Tracker; first name; last name; email address; payment info; User ID; billing address; purchase history; various types of Data; city; ZIP/Postal code; state; province; country; county; latitude (of city); longitude (of city); metro area; geography/region; IP address; device information; app information; device logs; operating systems; browser information; language; launches; number of sessions; session duration; scroll-to-page interactions; mouse movements; scroll position; keypress events; motion sensor events; touch events; video views; clicks; browsing history; search history; session statistics; page views; interaction events; page events; custom events; Application opens; number of Users; profession; time zone; diagnostic events; layout details; positional information.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Displaying content from external platforms, Analytics, Tag Management, Advertising, Handling payments, Interaction with external social networks and platforms, Registration and authentication, Managing contacts and sending messages, User database management, Traffic optimization and distribution, Spam and bots protection, Registration and authentication provided directly by this Website and Heat mapping and session recording.
...
* ### Advertising
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    #### Snigel (Snigel Web Services Limited)
    
    Snigel is an advertising service provided by Snigel Web Services Limited.
    
    Personal Data processed: Tracker; Usage Data.
    
    Place of processing: Ireland – [Privacy Policy](https://www.snigel.com/privacy-policy).
    ...
    * targeted advertising according to the VCDPA, CPA, CTDPA and UCPA
    ...
    Amazon Advertising is an advertising service provided by Amazon Europe or by Amazon, depending on how the Owner manages the Data processing.
    
    Personal Data processed: Trackers; Usage Data.
    
    Place of processing: European Union – [Privacy Policy](https://www.amazon.co.uk/gp/help/customer/display.html?nodeId=201909010) – [Opt out](https://www.amazon.co.uk/gp/help/customer/display.html?nodeId=201909150); United States – [Privacy Policy](https://www.amazon.co.uk/gp/help/customer/display.html?nodeId=201909010) – [Opt out](https://www.amazon.com/gp/help/customer/display.html?nodeId=202075050).
    ...
    * targeted advertising according to the VCDPA, CPA, CTDPA and UCPA
    ...
    Place of processing: United States – [Privacy Policy](https://business.safety.google/privacy/) – [Opt Out](https://adssettings.google.com/authenticated); Ireland – [Privacy Policy](https://business.safety.google/privacy/) – [Opt Out](https://adssettings.google.com/authenticated#display_optout).
...
* ### Analytics
    ...
    #### ProfitWell (200 OK LLC)
    
    ProfitWell is an analytics service provided by 200 OK LLC, that allows the Owner to analyze revenue and Users’ (commercial) activity on this Website.
    
    Personal Data processed: email address; first name; last name; payment info; Usage Data; User ID.
    
    Place of processing: United States – [Privacy Policy](https://www.profitwell.com/privacy-policy) – [Opt out](https://www.profitwell.com/privacy-policy).
...
* ### Handling payments
    ...
    Place of processing: Ireland – [Privacy Policy](https://stripe.com/ie/privacy).
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    Personal Data processed: email address; first name; last name; payment info; purchase history; various types of Data as specified in the privacy policy of the service.
    ...
    * a sale according to the CPA, CTDPA and UCPA
    ...
    Personal Data processed: email address; first name; last name; purchase history; various types of Data as specified in the privacy policy of the service.
    
    Place of processing: See the Braintree privacy policy – [Privacy Policy](https://www.braintreepayments.com/legal/braintree-privacy-policy).
...
* ### Registration and authentication
    ...
    Place of processing: Ireland – [Privacy Policy](https://www.facebook.com/policy.php).
...
* ### Registration and authentication provided directly by this Website
    ...
    Personal Data processed: email address; first name; last name; profession.
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://ludwig.guru/cookie-policy).
...
We have collected the following categories of sensitive personal information: payment info, payment info and payment info
...
Ludwig è finanziato dall'Unione Europea con il fondo europeo per lo Sviluppo Regionale (FESR)

[Ludwig - Fondo Europeo Sviluppo Regionale.pdf](https://drive.google.com/open?id=1n15p2rsHkvA2954BzJVcSunM-mSiCtKr)

**Descrizione**: Ludwig è un motore di ricerca linguistico pensato per consentire a chiunque di scrivere in un perfetto inglese. È un sistema di supporto alla scrittura basato sull'imitazione di testi provenienti da fonti affidabili (giornali, pubblicazioni scientifiche, etc,).

**Finalità e obiettivi**: Servizio di supporto alla scrittura in lingua inglese basata sul confronto di frasi inglese/inglese

© 2014-2024 Ludwig S.R.L.S. P.IVA 06333200829 REA PA-314445

[Terms](https://ludwig.guru/terms)

[Privacy](https://ludwig.guru/privacy)

[Cookies](https://ludwig.guru/cookie-policy)
