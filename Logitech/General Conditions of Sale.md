Logitech Order Status and Tracking FAQs
=======================================
...
Order FAQs Order FAQs

* ACCOUNT
    
    * [Profile](https://www.logitech.com/en-us/my-account/account-information.html)
    * [My Orders](https://www.logitech.com/en-us/my-account/my-orders.html)
    * [Payment Options](https://www.logitech.com/en-us/my-account/payment-options.html)
    * [Address Book](https://www.logitech.com/en-us/my-account/address-book.html)
    * [Privacy + Data](https://www.logitech.com/en-us/my-account/privacy-and-data.html)
    * [Login + Security](https://id.logi.com/amp/?locale=en-us&return_to=https://www.logitech.com/en-us/my-account/account-information.html)
* GET STARTED
    
    * [Register a Product](https://support.logi.com/hc/requests/new?ticket_form_id=360000994993)
    * [Downloads](https://support.logi.com/hc/articles/360024361233)
* [SERVICES](https://www.logitech.com/en-us/my-account/services.html)
    
* SUPPORT
    
    * [Get Support](https://www.logitech.com/en-us/my-account/get-support.html)
    * [Spare Parts](https://support.logi.com/hc/articles/360025903194)
    * Order FAQs
...
1. [MY ACCOUNT](https://www.logitech.com/en-us/my-account.html)
2. [Order FAQs](https://www.logitech.com/en-us/my-account/order-faqs.html)
...
[Orders](#orders) [Shipping](#shipping) [Returns and Cancellations](#returns-cancellations) [Technical Support](#technical-support) [Privacy and Security](#privacy-security)

#### Orders

**What is my order status?**

If you logged in or created an account during checkout, you can look up your order [here](https://www.logitech.com/en-us/my-account/my-orders.html "My Orders"). If you used guest checkout, please look up your order [here](https://www.logitech.com/en-us/order-status.html "Find My Orders").
...
If you used “Buy now, pay later” with Klarna, please visit Klarna’s [website](https://www.klarna.com/us/customer-service/) for more information.
...
We will gladly credit sales tax for government institutions. Just email us a copy of your tax-exemption form with an address matching your order's billing or shipping address to cstaxexemptions@digitalriver.com. Please include a copy of your receipt or your order number.

**I need a copy of my invoice.**

To view your invoice, find the order on your account's [My Orders](https://www.logitech.com/en-us/my-account/my-orders.html "My Orders") page and click the "Order Details" button. If you used guest check out, please look up your order [here](https://www.logitech.com/en-us/order-status.html "Find My Orders").
...
For technical assistance for your product, please visit our [Support Site](https://support.logi.com/hc/en-us "Support Contact").

If you have questions pertaining to your order you can contact us at [https://support.logi.com/hc/requests/new?ticket\_form\_id=360000621393](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393).

If you have any billing questions regarding your order, please contact us at [https://support.logi.com/hc/requests/new?ticket\_form\_id=360000621393](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393).
...
If you decide you no longer wish to participate in the Auto-Renew program, you can submit your request to cancel Auto-Renew [here](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393 "Support page") or manage your subscriptions from your account's [Services](https://www.logitech.com/en-us/my-account/services.html "Services page") page. You can also find your order [here](https://www.logitech.com/en-us/order-status.html "Digital River Find My Order") and follow the instructions.
...
Please use the "Forgot my password" link on the [login page](https://www.logitech.com/login.html "login page").
...
If you logged in or created an account during checkout, you can look up your order and view your shipment status [here](https://www.logitech.com/en-us/my-account/my-orders.html "My Orders"). If you used guest check out, please look up your order [here](https://www.logitech.com/en-us/order-status.html "Find My Orders").

For items in stock, orders usually ship within 1-2 business days. Please be aware that some orders may be delayed by order processing or other issues. Once the order is processed, you will receive a shipment confirmation email with shipment tracking information. Shipping time is dependent on the shipping method selected at checkout.

**How do I get my tracking number?**

If you logged in or created an account during checkout, you can look up your order and view your shipment tracking information [here](https://www.logitech.com/en-us/my-account/my-orders.html "My Orders"). If you used guest check out, please look up your order and view your shipment tracking information [here](https://www.logitech.com/en-us/order-status.html "Find My Orders").
...
To obtain a refund on a product purchased online, you will need to contact Customer Service at [https://support.logi.com/hc/requests/new?ticket\_form\_id=360000621393](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393).
...
If you need to return a Logitech product within the 30-day return policy, please visit the following returns portal: [http://returns.narvar.com/logitech/returns](http://returns.narvar.com/logitech/returns).

If you need to return a Logitech G product within the 30-day return policy, please visit the following returns portal: [http://returns.narvar.com/logitechg/returns](http://returns.narvar.com/logitechg/returns).
...
To cancel Auto-Renew, submit your request [here](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393 "Support Contact") or manage your subscriptions from your account's [Services](https://www.logitech.com/en-us/my-account/services.html "Services page") page. You can also find your order [here](https://www.logitech.com/en-us/order-status.html "Digital River Find My Order") and follow the instructions.

You will receive an email confirming that your Auto-Renew cancellation request is processed.

**How do I cancel my pre-order?**

To request cancellation of pre-ordered products, please contact us at [https://support.logi.com/hc/requests/new?ticket\_form\_id=360000621393](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393).
...
For technical assistance for your product, please visit our [Support Site](https://support.logi.com/ "Support Site"). If you have questions pertaining to your order you can contact us at [https://support.logi.com/hc/requests/new?ticket\_form\_id=360000621393](https://support.logi.com/hc/requests/new?ticket_form_id=360000621393).
...
[Click here](https://store.digitalriver.com/store?Action=DisplayDRPrivacyPolicyPage&Locale=en_US&SiteID=defaults "Digital River's Privacy Policy") to view the Digital River privacy policy.
...
1. You pay nothing if any unauthorized charges are made to your card as a result of shopping with us.
...
2. 100% of software downloads available through Logitech have been scanned for viruses.
