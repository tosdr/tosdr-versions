[Invidious](https://invidious.lunar.icu/)

[](https://invidious.lunar.icu/toggle_theme?referer=%2Fprivacy "Toggle Theme")

[](https://invidious.lunar.icu/preferences?referer=%2Fprivacy "Preferences")

[Log in](https://invidious.lunar.icu/login?referer=%2Fprivacy)

### [Status Page](https://status.max.srl/) | [Donate](https://3y.cx/spenden)
...
Users can clear their watch history using the [clear watch history](https://invidious.lunar.icu/clear_watch_history) page.
...
To remove data that has been stored in the website's database, you can use the [delete my account](https://invidious.lunar.icu/delete_account) page.

[Source code](https://github.com/iv-org/invidious) [Documentation](https://github.com/iv-org/documentation)

[Released under the AGPLv3 on GitHub.](https://github.com/iv-org/invidious/blob/master/LICENSE) [View JavaScript license information.](https://invidious.lunar.icu/licenses) [View privacy policy.](https://invidious.lunar.icu/privacy)
