...
By agreeing to these Terms of Service, you represent that you are at least the age of 18 and above the age of majority in your jurisdiction of residence. You may not use our Services for any illegal or unauthorized purpose nor may you, in the use of the Services, violate any laws in your jurisdiction. A breach or violation of any of the Terms will result in an immediate termination of your access to and use of the Services.  
  
**SECTION 1A: THIRD PARTY SERVICES**  
  
The Services function by requesting, modifying or deleting data on third party services. Third Party Services (“Third Party Services”) are defined as any website, program, offering or service not owned by us that you may use our Services to interact with. This includes social networks, messengers, productivity tools, utilities, data brokers, information aggregators, “people finder” sites AND any other service you may access from the Applications, including any affiliates or partners of such Third Party Services.  
It is possible that a Third Party Service’s own terms of service will disallow access to its services by software such as the Services. Because Third Party Services may have dozens of different applicable versions of their terms of service for different countries, devices or classifications of individuals, we cannot review or even access terms of service for all supported Third Party Services.  
By using the Services, you acknowledge that you have read and understand all applicable Third Party Services’ own terms of service and you hereby affirm that your use of the Services is either authorized or that you have a specific waiver or legal protection which allows your lawful usage of the Services.  
If you do not have authorization from a Third Party Service to use the Services, such use could result in a violation of the applicable terms of service which could include significant penalties to you, such as your being banned or suspended from using such Third Party Service, legal action against you by a Third Party Service or other adverse results such as financial penalties or criminal liabilities.  
To the greatest extent possible, we expressly disclaim any liability with respect to any potential violation by you of such terms of service arising from your use of the Services. You agree to review any Third Party Service’s terms of service that may bind or apply to you and to not engage in any activity violating such terms of service when using the Services in any manner whatsoever.  
  
**SECTION 1B - USER ACKNOWLEDGED CONDITIONS**  
  
You also understand, agree to and acknowledge the following (“User Acknowledged Conditions”):  

* The Applications and Services are provided with no guarantees and no service level agreements and therefore should not be used to access any data that you or your business cannot tolerate being permanently or temporarily deleted;
* You must create a backup of any data that may be impacted, utilized or modified by the Services before using the Services; The Applications do not offer a backup feature so this must be completed by requesting your data package directly from the service where the data currently is stored - Instructions for some services can be found on https://redact.dev/blog/download-your-data ;
* The Applications have a built-in archiving system that attempts to make a copy of any data that is previewed or deleted locally to your device. This feature may be disabled or enabled by default depending on several factors. However, the archiving system is a convenience feature and provided as is and with no guarantees or warranties. It should NOT be relied upon. ;
...
* To the fullest extent possible under applicable law, we expressly disclaim any liability, and you hereby accept all liability, arising from any of the User Acknowledged Conditions set forth herein and your use of the Services in any manner not expressly permitted by these Terms of Use.
...
1: You are at least the age of 18 and above the age of majority in your jurisdiction and are legally allowed to enter into agreements;  
2: Your use of the Services are used for legal purposes;  
3: Your use of the Services does not break any law in either your jurisdiction nor Delaware, USA;  
4: Your use of the Services is for personal non-commercial use. Business, government, non- profit or other non-personal uses require prior permission by emailing [\[email protected\]](https://redact.dev/cdn-cgi/l/email-protection);  
...
YOU EXPRESSLY ACKNOWLEDGE AND AGREE THAT ANY LIABILITIES ARISING IN CONNECTION WITH THE USER ACKNOWLEDGED CONDITIONS ARE DISCLAIMED BY US AND SHALL IN NO WAY BE INDEMNIFIABLE BY US. US.  
...
These Terms shall be governed by and construed in accordance with the laws of the State of Delaware without giving effect to any choice or conflict of law provision or rule (whether of the State of Delaware or any other jurisdiction).  
...
**SECTION 17 - BILLING DISPUTES, CHARGEBACKS AND REFUNDS**  
Redact does NOT offer refunds once a product has been downloaded and activated. This is due to the fact that Redact is a privacy-first software suite so we are unable to track individual usage and as such, once the product has been downloaded and activated we have no further insight on any usage.  
  
If you encounter any issues with our software, you should contact our support team directly to resolve the matter. You can reach us via email at [\[email protected\]](https://redact.dev/cdn-cgi/l/email-protection) . We are committed to addressing your concerns and finding a satisfactory solution.  
  
However, if you choose to initiate a dispute with PayPal, Apple, Google or your credit card issuer or bank by requesting a chargeback or payment dispute, please be aware that we will actively contest the claim. In addition, regardless of the outcome of the dispute case, we reserve the right to terminate your access to our software immediately with no refund due to you for any unused portion of time.  
...
**SECTION 19 - NOTICE OF NON-AFFILIATION AND DISCLAIMER**  
Redact Holdings, Inc. is an independent company. We are not affiliated, associated, authorized, endorsed by, or in any way officially connected or supported with any other company or its subsidiaries, organization or government agency. This includes the various Third Party Services we support, such as, but not limited to; Twitter/X, Facebook, Instagram, Discord, Slack, Linkedin and Reddit. All product and company names are trademarks or registered trademarks of their respective holders. Use of them does not imply any affiliation with or endorsement by them.  
...
[Home](https://redact.dev/)[Download](https://redact.dev/download)[Services](https://redact.dev/services)[Features](https://redact.dev/features)[Pricing](https://redact.dev/pricing)[Business](https://redact.dev/business)[Contact](https://redact.dev/contact)[How it works](https://redact.dev/how-it-works)[Affiliates](https://redact.dev/affiliates)[Press Kit](https://redact.dev/press-kit)[Terms & Conditions](https://redact.dev/terms)[Privacy](https://redact.dev/privacy)[Contact](https://redact.dev/contact)

Company

[Blog](https://redact.dev/blog)[Contact Us](https://redact.dev/contact)[AI Opt Out](https://aioptout.co/)

Media

[Affiliates](https://redact.dev/affiliates)[Press Kit](https://redact.dev/press-kit)

Legal

[Privacy Policy](https://redact.dev/privacy)[Terms & Conditions](https://redact.dev/terms)
