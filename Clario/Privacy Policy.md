...
* [Pricing.](https://link-bg.clario.co/link/a4bdb02c-c179-4983-8668-e8fa9b159c07?utm-source=%2Fprivacy-policy&utm-medium=header)
* Which protection is best for you? Let’s quickly check.
    
    [Start now](https://link-bg.clario.co/link/a4bdb02c-c179-4983-8668-e8fa9b159c07?utm-source=/privacy-policy&utm-medium=hamburger-menu)
...
[Get started](https://link-bg.clario.co/link/a4bdb02c-c179-4983-8668-e8fa9b159c07?utm-source=/privacy-policy&utm-medium=header)
...
You’ll also find our [Terms and Conditions](https://clario.co/terms-and-conditions/) here too.
----------------------------------------------------------------------------------------------
...
You can email [legal@weareclario.com](mailto:legal@weareclario.com) or feel free to write us a letter and send it to Unit No: 3005-D6, Swiss Tower, Plot No: JLT-PH2-Y3A, Jumeirah Lakes Towers, Dubai, UAE.
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
If you are an EU resident, you can contact our EU Representative at [hamburg@weitnauer.net](mailto:hamburg@weitnauer.net) or contact them in writing at: Weitnauer Partnerschaft mbB, Rechtsanwälte Steuerberater, Neuer Wall 84, 20354 Hamburg, GERMANY.

UK residents can contact us at [legal@weareclario.com](mailto:legal@weareclario.com).
...
1. Product (Clario software, Clario mobile application, web browser extensions);
2. Website: [https://clario.co](https://clario.co/) as well as any other linked pages and online services offered by the Company (hereinafter jointly known as the “Website”).
...
You can create a Clario account using your Apple ID or Google account. These services will authenticate your identity and provide you with an option to share certain personal data with us such as your:

1. Full name;
2. Email address.

This data will pre-populate our sign up form and allow you to create your account and use Clario Services.
...
3. Cookies information. Please read our [Cookie Policy](https://clario.co/cookie-policy/) carefully for more details about the information we collect when you use our Website as well as how to manage cookies;
...
To provide you with our Product or its specific features (also known as areas), the Company may use third-party software components. Some of these third-party materials may be subject to other terms and conditions. By accepting our Privacy Policy, you indicate your agreement to the terms and conditions of NordVPN’s [Terms of Service](https://my.nordaccount.com/legal/terms-of-service/) and [Privacy Policy](https://my.nordaccount.com/legal/privacy-policy/), and BitDefender [Privacy Policy](https://www.bitdefender.com/site/view/legal-privacy-policy-for-home-users-solutions.html) and [Terms of Services](https://www.bitdefender.com/site/view/subscription-agreement-and-terms-of-services-for-home-user-solutions.html) while activating and using VPN functionality and antivirus protection respectively.
...
1. Mac user - [http://www.hongkiat.com/blog/encrypt-mac-folder/](https://www.hongkiat.com/blog/encrypt-mac-folder/);
2. Windows user - [http://www.computerhope.com/issues/ch000705.htm](https://www.computerhope.com/issues/ch000705.htm);
...
When you request help from our experts, they may access your device remotely via third-party software, such as LogMeIn® and TeamViewer. By accepting our Privacy Policy, you therefore accept the [Terms & Conditions](https://www.logmein.com/legal/terms-and-conditions) and [Privacy Policy](https://www.logmein.com/legal/privacy) of LogMeIn® and [Terms & Conditions](https://www.teamviewer.com/en/eula/) and [Privacy Policy](https://www.teamviewer.com/en/privacy-policy/) of TeamViewer. Please read all Privacy Policies listed above to make sure you agree with all conditions; otherwise, do not purchase or use our service.

### Data breach feature.

Our Data breach check is to enable you to reveal past third-party breaches of your personal data on the dark web and minimise the future risk of abuse of your personal data. Also, an enabled 24/7 Data breach monitor within the Product will notify you whether you have been compromised in new data breaches and if your personal data has been exposed on the dark web based on the email address you submitted.

You may enter your email address(es) you want to check on our Website or within the Product.

The Data breach check or Data breach monitor requires us to transmit the hash of your email(s) to our partner - third-party service provider to check if your email address was involved in a data breach. Our partner never has your email address, only the hash of it. This is an unrecognizable jumble of numbers and letters.

Our data breach service provider will use the hash of your email address only for the purpose of checking if your email address appeared in a data breach. Our partner uses this unique hash to determine which unique code has been violated on a specific website. The partner will check it against its repository of stolen accounts, without knowing who you are, to define if your email address (i.e. the hash email) has been compromised.

Once the check is completed by our partner, we pass its results to you. In order to display your data breaches, we may receive from the partner access to it just to transmit the results of the check to you, i.e., which of your passwords associated with the submitted email(s) have been leaked. Additionally, within the Product only, results of the check may include Social Security number, telephone number, and some digits of your credit card number.

Please note that we do not use or store information about data breaches displayed to you in our files or systems. We only transmit the list of leaks to display them to you via the Website or Product. The data leaks are not stored but only displayed on the Website or within your Product account.
...
Within this feature, we will check your Instagram account privacy settings, with respect to both two-factor authentication and activity status enablement.

Once you have provided us with your Instagram account details, we will get access to your Instagram privacy settings and tell you if you need to enable two-factor authentication and turn off your activity status.

In order to turn on the two-factor authentication, you will be required to enter your phone number. We will transfer your telephone number to your Instagram account in order to receive the activation code. You will be able to change or delete it in the Instagram settings.

### Children’s data.

We don’t process the personal data of anyone below the age of 13 without prior parental consent. If you are under 13 years of age, then please do not use or access our Services. We will delete the personal data of a child aged under 13 which is processed without parental consent. If you are a parent or guardian and discover your child is using our Services, then contact us at [legal@weareclario.com](mailto:legal@weareclario.com) and request to delete the child’s personal data.
...
2. Enforce our [Terms and Conditions](https://clario.co/terms-and-conditions/).
...
If we receive your prior opt-in consent, we may contact you via email to tell you about special offers, promotions, and update you on our products or services. You may opt out of future contact from us at any time by using the method provided in the email (such as clicking on an unsubscribe link), or contacting us via email [legal@weareclario.com.](mailto:legal@weareclario.com)
...
Please check the [AppsFlyer Privacy Policy](https://www.appsflyer.com/privacy-policy/) to get more information on how AppsFlyer processes your data.
...
1. [https://docs.fabric.io/apple/fabric/data-privacy.html;](https://firebase.google.com/)
2. [https://firebase.google.com/products/analytics;](https://firebase.google.com/products/analytics)
...
1. App settings;
2. Email to [legal@weareclario.com](mailto:legal@weareclario.com).

Also, you may opt out of future transmission of data from your device to AppsFlyer's servers by using the [Opt-Out Button](https://www.appsflyer.com/optout).
...
Sometimes we may need to process your personal data for purposes not listed in this Policy. In such cases, we’ll ask for your prior consent before proceeding in order to process your personal data. You may withdraw your consent at any time by emailing us at [legal@weareclario.com.](mailto:legal@weareclario.com)
...
You may address inquiries for the execution of these rights to [legal@weareclario.com.](mailto:legal@weareclario.com) We will process your request immediately upon receipt. However, please note it may take up to thirty (30) days from receipt for your request to be implemented. Once your request is implemented, we will notify you by follow-up email accordingly.
...
California Civil Code Section 1798.83 permits California residents to learn the identities of entities sent their personal data for marketing purposes and the categories of information disclosed. You may request such information by emailing [legal@weareclario.com](mailto:legal@weareclario.com). Please reference California Privacy Rights in your subject line. You may also write to us at Unit No: 3005-D6, Swiss Tower, Plot No: JLT-PH2-Y3A, Jumeirah Lakes Towers, Dubai, UAE.
...
1. email [legal@weareclario.com;](mailto:legal@weareclario.com)
2. [Contact us](https://clario.co/contacts/) form.
...
If you have any questions or suggestions concerning our Privacy Policy, don’t hesitate to contact us at [legal@weareclario.com](mailto:legal@weareclario.com).
