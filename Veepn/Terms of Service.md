[![veepn home](/assets/e82ae3eb/images/logo-main.svg)](https://veepn.com/)
...
![en language](/assets/e82ae3eb/images/flags/en.svg) en
...
*  [Indonesian](https://veepn.com/id/terms-of-service/)
...
*  [Nederlands](https://veepn.com/nl/terms-of-service/)
*  [Norsk](https://veepn.com/no/terms-of-service/)
*  [Polski](https://veepn.com/pl/terms-of-service/)
*  [Português](https://veepn.com/pt/terms-of-service/)
*  [Русский](https://veepn.com/ru/terms-of-service/)
*  [Svenska](https://veepn.com/se/terms-of-service/)
*  [Türkçe](https://veepn.com/tr/terms-of-service/)
*  [简体中文](https://veepn.com/zh/terms-of-service/)
...
1. [Acceptance](#section_1)
2. [Modification](#section_2)
3. [Privacy policy](#section_3)
4. [Payments](#section_4)
5. [Refund policy](#section_5)
6. [Acceptable use policy](#section_6)
7. [License](#section_7)
8. [Intellectual property](#section_8)
9. [Language and translation of service content](#section_9)
10. [Third-party websites](#section_10)
11. [Disclaimers](#section_11)
12. [Limitations of Liability](#section_12)
13. [Indemnification](#section_13)
14. [Termination](#section_14)
15. [Choice of law and dispute resolution](#section_15)
16. [Entire agreement](#section_16)
17. [Severability](#section_17)
18. [Assignability](#section_18)
19. [Contact us](#section_19)

These VeePN Terms of Service (the “Terms)” apply to all subscribers of the VeePN Services.

These Terms govern your use of VeePN, a service available via the link [https://veepn.com/](https://veepn.com/) (the “Site”) and the related application software distributed via application store(s) or otherwise (the “App”), collectively referred to as the “Service”. VeePN is a leading cybersecurity company dedicated to providing top-notch privacy and security comprehensive, multiplatform solution that includes but are not limited to fast and secure Virtual Private Network (VPN) services, Antivirus software, and an Alert system for data leak detection along with other (if any) services, software, extensions, applications, information, and content.
...
Any and all issues regarding the provision of your personal information are governed by our [Privacy Policy](https://veepn.com/privacy-policy/) and you are giving your consent to the collection of such information by using the Service in accordance with its terms. Therefore, we recommend you to review the Privacy Policy in its entirety to get a clear understanding of how we handle your sensitive data.
...
Therefore, in order to avoid being charged should you willing not to, you must affirmatively cancel a subscription or a free trial in your app store account settings at least 48 hours before the end of the free trial or the current subscription period. If you are unsure how to cancel a subscription or a free trial, please visit the [apple support website](https://support.apple.com/en-us/HT202039), [google play help](https://support.google.com/googleplay/answer/7018481?co=GENIE.Platform%3DAndroid&hl=en) (or any other app store's support pages), or contact us via [\[email protected\]](https://veepn.com/cdn-cgi/l/email-protection). PLEASE BE AWARE THAT DELETING THE APP DOES NOT CANCEL YOUR SUBSCRIPTIONS DUE OR SUBSCRIPTIONS THAT FOLLOW FREE TRIALS.
...
3. Any other cause relating to your access or use, or inability to access or use, any portion of the Service or the Content;
4. Your interactions on the Site or Service;
5. Your failure to comply with this Terms;
6. The cost of procurement of substitute services;
7. Unauthorized access to or alteration of your transmissions or data, whether or not the circumstances giving rise to such cause may have been within the control of VeePN or of any vendor providing software, services, or support for the Site or Service.
...
1. The breach of these Terms by you or anyone using your Device or your user account credentials (password or login information);
2. Any other matter for which you are responsible under these Terms or under any applicable law.
