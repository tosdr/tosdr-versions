...
1. Visit Vercel's websites, such as: [vercel.com](https://vercel.com/), [nextjs.org](https://nextjs.org/), [turbo.build](https://turbo.build/) and other Vercel affiliated websites, such as blogs, event registrations, community discussions, forums, and social media platforms (collectively our "Sites");
...
If you have questions or to update or request changes to your personal information, please see [Contact Us](#contact).

Additionally, Vercel has appointed the European Data Protection Office (EDPO) as its GDPR representative in the EU and the EDPO UK Ltd as its UK GDPR representative in the UK. You can contact the EDPO regarding matters pertaining to the GDPR by completing the [request form](https://edpo.com/gdpr-data-request/) or writing to them:
