[![LiteManager](/img/head_img.png)](http://www.litemanager.com/)  

* * *

* [Main](http://www.litemanager.com/)
* [Products](http://www.litemanager.com/produkts/)
    * [LiteManager](http://www.litemanager.com/produkts/LiteManager/)
    * [LiteManager Free](http://www.litemanager.com/produkts/LiteManagerFree/)
    * [QuickSupport](http://www.litemanager.com/produkts/QuickSupport/)
* [Download](http://www.litemanager.com/download/)
* [Buy](http://www.litemanager.com/buy/)
* [Forum](http://www.litemanager.com/forum/en/)
* [Сross-platform](http://www.litemanager.com/cross-platform/)
* [Support](http://www.litemanager.com/support/)
    * [Contact Us](http://www.litemanager.com/support/contacts/)
    * [About Us](http://www.litemanager.com/support/aboutus/)
    * [Solutions](http://www.litemanager.com/support/Solutions/)
    * [OnLine Help](http://www.litemanager.com/support/help_en/)
    * [FAQ](http://www.litemanager.com/support/faq/)
    * [Press room](http://www.litemanager.com/support/press/)
    * [Knowledgebase (How to)](http://www.litemanager.com/support/Knowledgebase_en/)
* [Contact](http://www.litemanager.com/Contact/)
...
[LiteManager update 5](http://www.litemanager.com/news/new_version_testing/ "LiteManager update 5")
...
[A new website design LiteManager.org](http://www.litemanager.com/news/remote_support_software_litemanager/ "A new website design LiteManager.org")

Litemanager — remote support software

31 May 2015

[LiteManager remote access tools](http://www.litemanager.com/news/remote_access_software_litemanager/ "LiteManager remote access tools")
...
LITEMANAGER 4 END USER LICENSE AGREEMENT
========================================
...
Please read this agreement before using your copy of LiteManager Software (the «Product»). This is a legal agreement between you and LiteManagerTeam (the «Company»). If you do not wish to be bound by the terms of this license agreement you must not load, activate or use the software. For purposes hereof, «you» means the individual person installing or using the Product on his or her own behalf; or, if the Product is being downloaded or installed on behalf of an organization, such as an employer, «you» means the organization for which the Product is downloaded or installed and it is represented hereby that such organization has authorized the person accepting this agreement to do so on its behalf. For purposes hereof the term «organization», without limitation, includes any partnership, limited liability company, corporation, association, joint stock company, trust, joint venture, labor organization, unincorporated organization, or governmental authority.  
  
TERM  
Subject to termination under Termination Clause below the License shall be perpetual.  
  
OWNERSHIP  
The LiteManager software is owned and copyrighted by Company. Your license confers no title or ownership in the Product and should not be construed as a sale of any right in the Product.  
  
GRANT OF LICENSE  
This software is designed to run on standalone computers and computer networks. You may load the software from a Network File server but you must purchase a license for each workstation on which you will install or run the software.  
  
COPYRIGHT  
This software is protected by international copyright laws. You may copy it only for backup purposes. The software is licensed to you, but not sold to you. Company grants you the non-exclusive and non-transferable license to store, load, install, execute, and display the specified version of the Product on an unlimited number of computers, workstations, personal digital assistants, 'smart phones,' mobile phones, hand-held devices, or other electronic devices for which the software was designed (each a «Client Device») exclusively for non-commercial beta-testing purposes. The Company reserves all rights not expressly granted herein.  
...
LIMITED WARRANTY  
LIMITED WARRANTY. THIS SOFTWARE IS PROVIDED ON AN «AS IS» BASIS. LITEMANAGERTEAM DISCLAIMS ALL WARRANTIES RELATING TO THIS SOFTWARE, WHETHER EXPRESSED OR IMPLIED, INCLUDING BUT NOT LIMITED TO ANY IMPLIED WARRANTIES OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE. NEITHER LITEMANAGERTEAM NOR ANYONE ELSE WHO HAS BEEN INVOLVED IN THE CREATION, PRODUCTION, OR DELIVERY OF THIS SOFTWARE SHALL BE LIABLE FOR ANY INDIRECT, CONSEQUENTIAL, OR INCIDENTAL DAMAGES ARISING OUT OF THE USE OR INABILITY TO USE SUCH SOFTWARE, EVEN IF LITEMANAGERTEAM HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR CLAIMS. THE PERSON USING THE SOFTWARE BEARS ALL RISK AS TO THE QUALITY AND PERFORMANCE OF THE SOFTWARE.  
  
  
© 2004-2015 LiteManager Inc. and its licensors. All rights reserved. The LiteManager are copyrighted and protected by copyright laws and international copyright treaties, as well as other intellectual property laws and treaties.  
  

[QuickSupport](http://www.litemanager.com/produkts/QuickSupport/ "QuickSupport ")

How to [connect by ID?](http://www.litemanager.com/Connection_by_ID/ "How to connect by ID")

Overview of [solutions](http://www.litemanager.com/support/Solutions/ "solutions").

[LiteManager comparison with analogues](http://www.litemanager.com/comparison/ "LiteManager comparison")

[Difference between Pro and Free versions](http://www.litemanager.com/produkts/LiteManagerFree/ "Difference between Pro and Free versions")

[Guidelines for Technicians](http://www.litemanager.com/support/guidelines_for_technicians/ "Guidelines for Technicians")

[EULA](http://www.litemanager.com/support/help_en/user_license_agreement/ "LITEMANAGER 4 END USER LICENSE AGREEMENT (EULA)")

[Uninstall](http://www.litemanager.com/support/Uninstall/ "Uninstall")

![](/img/win10.png)

[![twitter — LiteManager](/img/twitter.GIF "twitter — LiteManager")](https://twitter.com/Litemanager "twitter — LiteManager")  [![instagram — LiteManager](/img/instagram.png "instagram — LiteManager")](https://www.instagram.com/litemanager_remote_access/ "instagram — LiteManager")

* * *

© 2004—2024 [«LiteManagerTeam»](http://www.litemanager.com/)

+7 909 424 80 31    den.aria@gmail.com, support@litemanager.com

[Site Management System Host CMS](http://www.hostcms.ru/)

![](https://mc.yandex.ru/watch/1125660)