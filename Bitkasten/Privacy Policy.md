...
* [Unternehmen](#) Menü umschalten
    * [Unternehmen Sub](#)
        ...
        [](https://www.bitkasten.de/partner/)
...
Im Folgenden informieren wir über die Erhebung personenbezogener Daten bei Nutzung unserer Webseite. Personenbezogene Daten sind alle Daten, die auf Sie persönlich beziehbar sind, z. B. Name, Adresse, E-Mail-Adressen, Nutzerverhalten. Zweck der Verarbeitung ist das Betreiben einer Internetseite zum Zwecke des Angebots digitaler Postdienstleistungen.
...
E-Mail: [datenschutz@bitkasten.de](mailto:datenschutz@bitkasten.de "mailto:datenschutz@bitkasten.de") 
...
Datenschutz- oder Sicherheitsvorfälle können Sie [hier](https://www.bitkasten.de/datenschutzerklaerung/datenschutz-oder-sicherheitsvorfall-melden/) melden.
...
5\. Webanalysedienste und Tools
-------------------------------

**MATOMO**

Wir nutzen auf unserer Webseite und in unserer App das Open-Source-Software-Tool Matomo (ehemals PIWIK) ), ein Dienst des Anbieters InnoCraft Ltd., 150 Willis St, 6011 Wellington, Neuseeland, zur Analyse des Surfverhaltens unserer Nutzer. Das ist ein Open-Source-Tool zur Web-Analyse. Mit Matomo werden keine Daten an Server übermittelt, die außerhalb unserer Kontrolle liegen. Es werden keine Cookies auf Ihrem Gerät gespeichert.
...
Die Software läuft dabei ausschließlich auf den Servern unserer Webseite. Eine Speicherung der personenbezogenen Daten der Nutzer findet nur dort statt. Eine Weitergabe der Daten an Dritte erfolgt nicht. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der Analyse und Optimierung unseres Internetauftritts.

Nähere Informationen zu den Privatsphäre-Einstellungen der Matomo Software finden Sie unter folgendem Link: [https://matomo.org/docs/privacy/](https://matomo.org/docs/privacy/).

**SENTRY**

Wir nutzen für unsere Website und in unserer App Sentry, ein Fehlermanagement-Tool. Hersteller ist das amerikanische Unternehmen Sentry Inc., 132 Hawthorne St, San Francisco, USA.

Die Software läuft dabei ausschließlich auf den Servern unserer Webseite. Eine Speicherung der personenbezogenen Daten der Nutzer findet nur dort statt. Eine Weitergabe der Daten an Dritte erfolgt nicht. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der Analyse und Optimierung unseres Internetauftritts.

Mehr über die Daten, die durch die Verwendung von Sentry verarbeitet werden, finden Sie in der Datenschutzerklärung unter folgendem Link: [https://sentry.io/privacy/](https://sentry.io/privacy/).

**WONDERPUSH**

Um Neuigkeiten und Updates auf unserer Website und in unserer App zu erhalten, können Push-Benachrichtigungen aktiviert werden, zu dem Sie sich anmelden können. Dieser kostenlose Dienst, wird von dem Push-Anbieter „WonderPush“ (www.wonderpush.com/), WonderPush, 19 avenue d’Italie, 75013 Paris, Frankreich, betrieben. Zur Anmeldung müssen Sie auf eine von Ihrem Browser/App und Ihrem Gerät gesteuerte Autorisierungsanfrage klicken. Die Daten, die wir speichern und verarbeiten, um diesen Dienst zu betreiben und Ihnen relevante Nachrichten zu senden, werden anonymisiert und für maximal 90 Tage auf den Servern von WonderPush aufbewahrt und niemals an Dritte weitergegeben. Wir speichern im Zusammenhang mit dem Push-Benachrichtigungsdienst keine erkennbaren Daten, auch keine IP-Adresse über Sie oder Ihr Gerät.

Sie können den Empfang unserer Push-Benachrichtigungen jederzeit beenden, indem Sie sich abmelden. 

Über folgenden Link verwalten Sie Ihr Web-Push-Abonnement und können Ihre damit verbundenen Daten löschen (in englischer Sprache): [https://docs.wonderpush.com/docs/manage-your-data-and-unsubscribe-from-web-push-notifications](https://docs.wonderpush.com/docs/manage-your-data-and-unsubscribe-from-web-push-notifications). App-Push-Benachrichtigungen können Sie über die Einstellungen Ihres Gerätes jederzeit für unsere App deaktivieren.

Mehr über die Daten, die durch die Verwendung von WonderPush verarbeitet werden, finden Sie in der Datenschutz-FAQ (in englischer Sprache) unter folgendem Link: [https://docs.wonderpush.com/docs/privacy-policy-faq](https://docs.wonderpush.com/docs/privacy-policy-faq).
...
Selbstverständlich können Sie der Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse durch die bitkasten GmbH jederzeit widersprechen. Über Ihren Werbewiderspruch können Sie uns unter folgenden Kontaktdaten informieren:

bitkasten GmbH  
Wallensteinstraße 63  
90431 Nürnberg  
Telefon: 0911 – 6000 28 74  
[info@bitkasten.de](mailto:info@bitkasten.de)

7\. Newsletter
--------------

a) Erhebung, Nutzung und Speicherung personenbezogener Daten

Sie können unseren E-Mail-Newsletter unter Angabe Ihres Namens und Ihrer E-Mail-Adresse beziehen, indem Sie sich dafür mit Ihrem Namen und einer E-Mail-Adresse registrieren und in den Versand ausdrücklich durch Abhaken der Checkbox neben folgendem Text einwilligen:

„Ja, ich möchte den Newsletter der bitkasten GmbH mit Informationen über Produkte und Aktionen abonnieren.“

Nach Ihrer Einwilligung, die durch Zusendung einer Bestätigungs-E-Mail erfragt wird, nutzen wir Ihre E-Mail-Adresse als Empfängeradresse für Newsletter-E-Mails, durch die Sie regelmäßig über aktuelle Angebote und die Produkte der bitkasten GmbH informiert werden. Sie können den Newsletter jederzeit wieder abbestellen, siehe c).
...
8\. Erstellung eines Benutzerkontos
-----------------------------------

Auf unserer Webseite www.bitkasten.de haben Sie die Möglichkeit, ein Benutzerkonto zu erstellen. Hierbei speichern wir folgende Daten:
...
9\. Beauftragung zur Benachrichtigung potenzieller Versender
------------------------------------------------------------

Auf unserer Webseite haben Sie die Möglichkeit, uns mit der Benachrichtigung des von Ihnen angegebenen Unternehmens zu beauftragen, um zukünftig die Briefpost des betreffenden Unternehmens digital in Ihrem bitkasten erhalten. Sofern Sie uns hierzu beauftragt haben, verarbeiten wir folgende personenbezogene Daten zur auftragsgemäßen Versendung der Benachrichtigung:

* Vor- und Nachname
* Adresse

Rechtsgrundlage für die Verarbeitung Ihrer Daten ist Art. 6 Abs. 1 Buchst. b) DSGVO.

10\. Abschließendes
-------------------

Unser geschäftlicher Betrieb setzt voraus, dass Daten erfasst und verarbeitet werden. Wo Datenerfassung und -verarbeitung stattfinden, muss Datenschutz und Datensicherheit gewährleistet sein. Dies ist für uns nicht nur gesetzliche Anforderung, sondern ein ureigenes Anliegen. Sollten Sie noch Fragen oder Anregungen zum Thema Datenschutz rund um unsere Dienstleistungen haben, so sprechen Sie uns unter den oben genannten Kontaktdaten (siehe bitte Punkt 1) sehr gerne an.
