...
[Cookie Policy](https://spoutible.com/cookies_policy)
...
At Spoutible, we believe in transparency and keeping our users informed. This Cookie Policy outlines the types of cookies we use on our platform and the purposes they serve. By using our platform, you consent to the use of cookies in accordance with this policy.

What are Cookies?

Cookies are small text files that are placed on your device when you visit a website. They are used to store information such as user preferences, login information, and browsing history. Cookies help us understand how you interact with our platform and provide a more personalized experience.

**Types of Cookies Used on Our Platform**:

1. Essential Cookies: These cookies are necessary for the basic functioning of our platform and cannot be disabled. They include, for example, cookies that allow you to log in to your account or stay logged in during your session.
2. Performance Cookies: These cookies collect information about how you use our platform, such as the pages you visit and the time you spend on them. We use this information to improve the functionality and performance of our platform.
3. Functionality Cookies: These cookies allow us to remember your preferences and settings, such as your preferred language or the notifications you have enabled.
4. Advertising Cookies: These cookies are used to deliver advertisements that are relevant to your interests. They may also be used to limit the number of times you see an advertisement and to measure the effectiveness of our advertising campaigns.

**Managing Cookies:**

Most web browsers automatically accept cookies, but you can usually change your browser settings to decline cookies if you prefer. Please note that disabling cookies may limit your ability to use certain features of our platform.

Changes to this Cookie Policy:

We may update this Cookie Policy from time to time to reflect changes to our platform and to ensure that it remains accurate and up-to-date. We will notify you of any changes by posting the updated policy on our platform and updating the effective date at the top of this page.

**Contact Us:**

If you have any questions about this Cookie Policy or how we use cookies on our platform, please contact us at [\[email protected\]](https://spoutible.com/cdn-cgi/l/email-protection)
