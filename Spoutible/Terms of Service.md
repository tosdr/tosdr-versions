Enter the 6-digit code from your authenticator app. If you no longer have access to the app, use your saved backup code from when you enabled Two-Factor Authentication.

     

Verify

We are requiring all users to use strong passwords for extra security. We will send you a code to your email address or mobile device to continue. **Please do not close this window.**

##### Send reset password code via:
...
Send ![loading](https://spoutible.com/themes/default/statics/img/button-loader.gif) Please Wait...

##### Enter the code to update your password.

Code  {{ errorMessage }}

{{ errorMessage }}

Submit ![loading](https://spoutible.com/themes/default/statics/img/button-loader.gif) Please Wait...
...
{{invalid\_feedback\_email}}

Password

{{invalid\_feedback\_pass}}

{{unsuccessful\_attempt}} Authentication failed. Please make sure your username and password are correct.

Forgot your password? [Reset Password](https://spoutible.com/start?auth=forgot_pass)

 ![loading](https://spoutible.com/themes/default/statics/img/button-loader.gif) Please Wait... Done! Please Wait... Sign In

Don't have an account? [Sign Up](https://spoutible.com/start?auth=signup)

[](https://spoutible.com/start)[Sign In](https://spoutible.com/start)

[](https://spoutible.com/start?auth=signup)[Create Account](https://spoutible.com/start?auth=signup)

[](https://spoutible.com/start?auth=forgot_pass)[Reset Password](https://spoutible.com/start?auth=forgot_pass)

[Terms of Use](https://spoutible.com/terms_of_use)

[![Logo](https://spoutible.com/themes/default/statics/img/logo.png)](https://spoutible.com/)

[![Logo](/themes/default/statics/img/logo3.png)](https://spoutible.com/)
...
If you have any further questions, comments or requests regarding these Terms and Conditions, please contact us at [\[email protected\]](https://spoutible.com/cdn-cgi/l/email-protection).  
...
[#bidenharris2024](https://spoutible.com/search/posts?q=%23bidenharris2024)

[#restinpower](https://spoutible.com/search/posts?q=%23restinpower)

[#music](https://spoutible.com/search/posts?q=%23music)

[#anythinggoes](https://spoutible.com/search/posts?q=%23anythinggoes)

[#haiku](https://spoutible.com/search/posts?q=%23haiku)
...
* [Cookie Policy](https://help.spoutible.com/support/solutions/articles/150000044461-cookie-policy)
* [Help](https://help.spoutible.com/support/home)
* [Powered by: Bot Sentinel](https://botsentinel.com/)
* [© Spoutible Inc. - 2024.](https://spoutible.com/)

 

##### Auto-Generated Thread Summary

Generating summary, please wait...

![loading...](https://spoutible.com/themes/default/statics/img/edit-document.gif)
...
Spoutible is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you use the Spoutible Platform. We will only use the information that we collect about you in accordance with the applicable national and international privacy laws. We reserve the right to update and modify this Privacy Policy at any time and for any reason. You are encouraged to periodically review this Privacy Policy to stay informed of updates.

IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, YOU ARE ADVISED NOT TO CONTINUE USING THE PLATFORM ANY LONGER.

1. **WHAT INFORMATION WE COLLECT**

While it is perfectly possible to visit and browse the Spoutible Platform without disclosing any personal information, if you choose to actively engage by registering your account, you will be asked to provide certain personally identifiable information including your full name, email address, date of birth, phone number and geographical location. We may also collect some additional information from and about your computer like your IP address, web browser type and version, operating system type and version, location information etc. If you are accessing our services through a mobile handheld device, we may request access or permission to certain system information including your mobile device ID number, model, manufacturer, wireless carrier etc. We may also collect further information about you when you request customer support, sign-up for text alert, emails or newsletters, or otherwise communicate with us. If you wish to change any of the access permissions, you may do so in your device’s settings.

We also collect certain personal information about you when you use the Platform’s direct messaging services. When you send direct messages to other users to have more private, one-to-one communications, these are encrypted and saved by us along with certain information necessary for processing them. In the event that a user reports a message for a violation of Spoutible’s Terms and Conditions, Privacy Policy or any other applicable law, we store the reported message and associated portions of the related conversation. If you delete your copy of a message sent from your account, the message will not be deleted in your recipient’s account. Recipients will retain their own copy, and can duplicate, store, or re-send your messages. We do not use information collected from direct messages for advertising purposes.

Other than this, we may also receive or collect information about you from third parties when we use an outside service provider to display advertisements. Where these ads contain cookies that store your personal information, your personal information may be collected and stored on our servers with other information we may have already received or collected from you. Such personal information is used to serve relevant ads to you and is based on items that may be considered personal information under the law, such as your IP address, browser type, time and date, and subject of advertisements clicked or interacted with, but that may be anonymized or non-personally identifiable information. Usually, we collect non-personally identifiable usage data involving advertisements you respond to (by clicking or muting); pages of our Platform that you visit; the date, time, frequency, and duration of those visits; posts and comments that you engage in during your visits; the particular features of our Platform that you use etc. We also collect information about the content you upload or share on the Platform and maintain backup copies for backup and data redundancy purposes.

No part of our Platform is directed towards children below 13 years of age and we do not knowingly collect personal information from anyone under the age of 13. If we learn we have collected or received personal information from a child under 13 years without verification of parental consent, we will promptly delete that information from our database. If you believe we might have any information from or about a child under 13 years, please contact us at [\[email protected\]](https://spoutible.com/cdn-cgi/l/email-protection).

2. **HOW WE USE YOUR INFORMATION**

Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. We will securely process your personal information and use it for administration and operation of Spoutible, including but not limited to the following purposes –

* To facilitate the creation of and secure your Account.
* To provide and improve the Platform and to develop new products and services.
* To customize and personalize the advertising and other content we deliver on the Platform and on other services offered by our publishing partners.
...
* To alert you to the latest developments and features on the Platform and to notify you of administrative information, such as security or support and maintenance advisories.
...
* To advertise and market to you, which includes sending promotional communications and advertisements.
...
Where you have provided us with consent to use your personal information, you have the right to withdraw this consent at any time by contacting us directly with a request that we cease using your personal information or by following the ‘unsubscribe’ link provided in any electronic communications you receive from us.
...
We may share your information with third parties that perform services for us or on our behalf, including email delivery, hosting services, data analysis and marketing assistance.

* **Third-Party Advertisers**

We may use third-party advertising companies to serve ads when you visit the Spoutible Platform. These companies may use information about your visits to our website and other websites that are contained in web cookies in order to provide advertisements about goods and services that may be of interest to you.
...
We may share information with our subsidiaries, successors, or related companies for the purposes described in our respective privacy policies, and to offer, provide, and improve services and products.

* **By Law or to Protect Rights**

If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation. This includes exchanging information with other entities for fraud protection and credit risk reduction. We may also need to transfer some of your personal information in the event of a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding.
...
We may use cookies, web beacons, tracking pixels, Google analytics and other tracking technologies on our Platform to help customize our services and improve your user experience. Cookies are small files that a website or its service provider transfers to your computer’s hard drive through your web browser. Session cookies are only stored on your computer or mobile device while you use our Platform and are automatically deleted when you close your web browser or mobile application. If you are located in Canada, the United Kingdom, or the European Union, we will request your consent before storing session cookies. Most browsers are set to accept cookies by default. You can remove or reject cookies, but be aware that such action could affect the availability and functionality of the Spoutible Platform. When you access our Platform, your personal information is not collected through the use of tracking technology. You may not decline web beacons. However, they can be rendered ineffective by declining all cookies or by modifying your web browser’s settings to notify you each time a cookie is tendered, permitting you to accept or decline cookies on an individual basis. We use third-party session cookies provided by Cloudflare’s Bot Management technology to protect our Platform from harmful automated attacks. Additionally, we may at times include or offer third party products or services on our Platform. These third-party websites or software may use cookies or similar tracking technology to help manage and optimize your online experience with us. Please note this Privacy Policy will not be applicable in case of any such third-party software and their associated cookies policy. Spoutible bears no responsibility or liability for the content and activities of these third-party links or websites.

5. **INFORMATION STORAGE AND SECURITY**

The personal information collected and processed by Spoutible at our offices and data centres are held securely in accordance with our internal security policy and the appropriate data protection laws as and where applicable. Spoutible has implemented generally accepted standards of technology and operational security in order to protect personal information from loss, misuse, or unauthorized alteration or destruction. Unfortunately, no method of transmission over the Internet, or method of electronic storage, is 100% secure. Whilst we strive to use all reasonable efforts to protect your personal information, we cannot guarantee its absolute security. We will notify you promptly in the event of any breach of your personal information which might expose you to serious risk. We will never collect sensitive information about you without your explicit and informed consent.

6. **INFORMATION** **RETENTION AND TRANSFER**

Spoutible may retain your personal information for as long as it is necessary to fulfil the purpose for which it was collected, or as required or permitted by applicable laws. Typically, we retain your account information for as long as your account is active. We will cease to retain your personal information, or remove the means by which the information can be associated with you, as soon as it is reasonable to assume that such retention no longer serves the purpose for which it was collected, and is no longer necessary for legal or business purposes. All third parties are carefully screened before transfer of any personal information, so we can ensure that there are adequate controls in place and, where relevant, that such third parties are fully compliant with the applicable laws. In case any of any international transfer of personal information, Spoutible takes all reasonable steps to ensure that your personal information continues to receive a standard of protection that is at least comparable to that provided under the applicable data protection laws.

7. **ADDITIONAL RIGHTS**

You have full control through your account settings regarding your personal information that is made available to us and how we use it. In addition to that, according to the applicable data protection laws, you also possess a number of rights in relation to your personal information. These rights include
...
As per the applicable laws, Spoutible has a “Data Protection Officer” (DPO) who is responsible for all matters relating to privacy and data protection and they can be reached at –

Attn: Spoutible Data Protection Officer
...
Email: [\[email protected\]](https://spoutible.com/cdn-cgi/l/email-protection)

If you have any further questions, comments or requests regarding this Privacy Policy, please contact us at [\[email protected\]](https://spoutible.com/cdn-cgi/l/email-protection).

##### EMBED SPOUT

Copy the HTML code below and paste it into the desired section of your website or blog where you want the spout to appear.

![Spoutible](https://static.spoutible.com/spout/logo.png)