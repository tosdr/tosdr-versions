...
![menu](/assets/images/close-drawer.png)

![wargaming-legal](/assets/images/footer/logo.png) 
...
* [LEGAL PORTAL](https://legal.eu.wargaming.net/en)
* [USER DOCUMENTS](https://legal.eu.wargaming.net/en/user-documents)
* [EULA](https://legal.eu.wargaming.net/en/user-documents/eula)
* [END USER LICENSE AGREEMENT](https://legal.eu.wargaming.net/en/user-documents/eula/end-user-license-agreement)
...
6.7. If your UGC is based on our intellectual property, it also qualifies as Player Content and therefore must comply with our [Player Content Policy](https://legal.eu.wargaming.net/en/user-documents/content-policies/player-content-policy/view) in addition to this section 6. For the avoidance of doubt, you always grant Wargaming a license to your UGC in accordance with section 6.4 of this EULA and not in accordance with the Player Content Policy (even if your UGC qualifies as Player Content).
...
a. You are either an individual over the age of majority or, if you are under the age of majority or if you have limited legal capacity, that your parent or legal guardian has agreed to and accepted the respective order on your behalf;
...
a. To order Paid Items, you need to have an Account, initiate and conclude the order process.
...
c. In case we accept your order, we will, directly after that, credit the ordered Paid Items to your Account and we will charge you via your selected payment method. You will also receive a confirmation of your order via e-mail, containing the Contract details and an electronic copy of this EULA.

d. The Contract will be concluded in the language of the country where you live. If permitted by applicable law, the Contract may be concluded in the English language.

e. Paid Items may only be redeemed for other content and services where permitted in the Products.

f. Paid Items cannot be sold or transferred to anyone. However, you may buy Paid Items for another user as a Gift if permitted in the Products. The process for buying and accepting Gifts will be clearly specified in the interface of the respective Product in advance.

g. Paid Items cannot be exchanged for cash or any goods or services.

h. You may only acquire Paid Items from us (or from any person that we authorise for this purpose) or from another user as a Gift if permitted in the Products, and you must not obtain Paid Items from any other person or in any other way or attempt to do so; and
...
[Subscription Rules![](/assets/images/arrow.png)](javascript:;)
...
[If you reside in South Korea, click here to read about your right of withdrawal![](/assets/images/arrow.png)](javascript:;)
...
[Czech Republic![](/assets/images/arrow.png)](javascript:;)
...
11.2.5. V případě sporu s námi na základě zákonů na ochranu spotřebitele máte právo obrátit se na [Českou obchodní inspekci](https://www.coi.cz/informace-o-adr/).

[Australia and New Zealand![](/assets/images/arrow.png)](javascript:;)
...
[South Korea![](/assets/images/arrow.png)](javascript:;)

11.2.7. 골드의 교환, 환불 및 그 조건과 절차. 골드는 워게이밍의 정책과 관련 법률에 따라 교환이나 환불이 가능합니다. 이용자가 골드 구매 후 7일 이내에 환불을 요청할 경우, 워게이밍은 환불 전까지 이용하지 않은 골드의 구매 금액을, 요청일로부터 3영업일 이내에 지급합니다. 이용자가 골드 구매 후 7일 이후에 환불을 요청하거나, 7일 이내라 하더라도 골드를 사용한 경우, 워게이밍은 이용한 골드에 해당하는 금액과 잔여 골드에 해당하는 금액의 10%를 공제한 후, 요청일로부터 3영업일 이내에 지급합니다. 온라인이나 오프라인 이벤트에서 이용자에게 지급되었거나, 결제를 하지 않고 이용자가 취득한, 무료 골드의 경우에는 환불이 불가능합니다.

11.2.8. 소멸 기간. 구매한 골드는 결제 후 5년간 소멸되지 않습니다.

11.2.9. 해지 시 결제 대금 환불. 이용자로부터 계약 해지 통지를 받으면 Wargaming은 3영업일 이내에 남은 골드 금액을 환불합니다. 이용자에게 대금을 환불하는 경우, Wargaming은 이용자가 이용 요금을 결제한 방식과 동일한 방식으로 결제 대금 일체 또는 일부를 환불합니다. 단 동일한 방식으로 환불이 불가능한 경우, Wargaming은 이를 즉시 이용자에게 알리고 이용자가 선택한 방식으로 환불을 제공합니다.

[California![](/assets/images/arrow.png)](javascript:;)
...
o. Undermining the fair play principle or disrupting the normal gameplay, e.g. rigged battles, self-destruction, damaging your teammates, blocking your teammates, passive play, or early exit from battle; or
...
* [World of Tanks](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wot-wotc-wowp/view)
    
* [World of Warplanes](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wot-wotc-wowp/view)
    
* [World of Warships](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wows/view)
    
* [World of Tanks Blitz](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wotb/view)
    
* [World of Tanks: Modern Armor](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wot-wotc-wowp/view)
    

12.3.2. Explanations of how the Code of Conduct applies to clans are set out at the following links:

* [World of Tanks](https://legal.eu.wargaming.net/en/user-documents/game-rules/clan-rules/view)
    
* [World of Warplanes](https://legal.eu.wargaming.net/en/user-documents/game-rules/clan-rules/view)
    
* [World of Warships](https://legal.eu.wargaming.net/en/user-documents/game-rules/game-rules-wows/view)
    
* [World of Tanks Blitz](https://legal.eu.wargaming.net/en/user-documents/game-rules/clan-rules-wotb/view)
    
* [World of Tanks: Modern Armor](https://legal.eu.wargaming.net/en/user-documents/game-rules/clan-rules-console/view)
...
* [Player Content Policy](https://legal.eu.wargaming.net/en/user-documents/content-policies/player-content-policy/view)
...
**TIP:** You will find more information [here](https://legal.eu.wargaming.net/en/user-documents/content-policies/content-moderation-policy/view) about how we moderate content.
...
[13.5.1-13.5.3![](/assets/images/arrow.png)](javascript:;)
...
[13.6.1![](/assets/images/arrow.png)](javascript:;)

**패치, 업데이트 및 변경**

13.6.1. 서비스 장애 및 중단  
  
1) 워게이밍은 유지보수를 수행하기 위하여, 정기적으로 또는 사전통지를 하거나 하지 않고, 웹사이트나 기타 서비스 (총칭하여 “서비스”)를 중단할 권리를 보유합니다.  
  
2) 이용자는 워게이밍의 통제를 벗어나는 사유로 서비스가 중단될 수 있음을 인지합니다. 워게이밍은 이용자가 접속하려는 때는 언제든지 서비스나 계정에 접속할 수 있다는 점을 보증하지 않습니다. 워게이밍은 워게이밍의 합리적인 통제 범위를 벗어나는 사유로 인하여 발생하는 서비스의 중단, 지연 또는 이행불능에 대해 고의나 중과실이 없는 한 책임을 지지 않습니다.  
  
3) 프리미엄 계정과 같은 만료기한이 있는 서비스의 경우, 회사는 서비스의 중지나 장애와 관련하여 다음과 같이 보상합니다. 다만, 천재지변 등 불가항력이나 이용자 과실로 인하여 발생한 서비스의 중지 또는 장애 기간은 보상 대상에 해당하지 않습니다.  
  
i) 사전 통지할 수 없었던 회사의 귀책사유로 1일간 누적 4시간 이상 서비스 중지 또는 장애가 발생한 경우, 서비스 중단 시간의 3배에 해당하는 이용 기간을 연장합니다.  
  
ii) 사전 통지할 수 없었던 회사의 귀책사유로 인한 서비스가 중지 또는 장애가 3일 이상 발생한 경우, 또는 1개월 동안 누적 72시간을 초과한 경우, 계약해지 및 잔여기간에 대한 이용료를 환급합니다.  
  
iii) 24시간 전 사전 통지를 하였으나 서비스 중지 또는 장애가 10시간 이상 누적된 경우, 초과된 시간만큼 이용 기간을 연장합니다.  
  
4) 다음의 경우에 회사는 기술상․운영상 필요에 의해 게임서비스 전부를 중단할 수 있으며, 30일전에 홈페이지에 이를 공지하고 게임서비스의 제공을 중단할 수 있습니다. 사전에 통지할 수 없는 부득이한 사정이 있는 경우는 사후에 통지를 할 수 있습니다.  
  
i) 관련 법령에서 특정 시간 또는 방법으로 게임서비스 제공을 금지하는 경우  
  
ii) 천재지변, 비상사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 게임서비스 제공이 불가능할 경우  
  
iii) 회사의 분할, 합병, 영업양도, 영업의 폐지, 당해 게임서비스의 수익 악화 등 회사의 경영상 중대한 필요에 의한 경우  
  
5) 회사가 상기 4)항에 따라 게임서비스를 종료하는 경우, 이용자는 무료서비스 및 사용 기간이 남아 있지 않은 유료서비스, 계속적 유료 이용계약, 기간제 유료아이템에 대하여 손해배상을 청구할 수 없습니다.
...
[IF YOU RESIDE IN A EUROPEAN UNION MEMBER STATE (17.1-17.5)![](/assets/images/arrow.png)](javascript:;)
...
[IF YOU RESIDE IN AUSTRALIA OR NEW ZEALAND (17.6-17.7)![](/assets/images/arrow.png)](javascript:;)
...
[IF YOU RESIDE IN ANOTHER COUNTRY (17.8-17.10)![](/assets/images/arrow.png)](javascript:;)
...
a. Suspend or permanently close your access to individual features, content or services in the Product(s). You will not be able to use such features and Paid Items in connection with them, but you will still have access to other parts of the Products.

b. Suspend or permanently close your access to individual Products. You will not be able to access such Products and use any Paid Items in them.

c. Suspend or permanently close your access to your Account(s). You will not be able to access your Account(s) and use any Paid Items in it during the suspension period, and we may also prohibit you from accessing or using our Products in the future.
...
[IF YOU RESIDE IN A EUROPEAN UNION MEMBER STATE OR IN THE UNITED KINGDOM (20.1-20.3)![](/assets/images/arrow.png)](javascript:;)
...
[IF YOU RESIDE IN THE UNITED STATES OR BRING A CLAIM AGAINST WARGAMING IN THE US (20.4-20.5)![](/assets/images/arrow.png)](javascript:;)
...
[If YOU RESIDE IN AUSTRALIA OR NEW ZEALAND: (20.6-20.7)![](/assets/images/arrow.png)](javascript:;)
...
[IF YOU RESIDE IN ANOTHER COUNTRY (20.8)![](/assets/images/arrow.png)](javascript:;)
...
IF YOU RESIDE IN A EUROPEAN UNION MEMBER STATE (17.1-17.5)
...
IF YOU RESIDE IN AUSTRALIA OR NEW ZEALAND (17.6-17.7)
...
IF YOU RESIDE IN ANOTHER COUNTRY (17.8-17.10)
...
IF YOU RESIDE IN A EUROPEAN UNION MEMBER STATE OR IN THE UNITED KINGDOM (20.1-20.3)
...
IF YOU RESIDE IN THE UNITED STATES OR BRING A CLAIM AGAINST WARGAMING IN THE US (20.4-20.5)
...
If YOU RESIDE IN AUSTRALIA OR NEW ZEALAND: (20.6-20.7)
...
IF YOU RESIDE IN ANOTHER COUNTRY (20.8)
...
![wargaming-legal](/assets/images/footer/logo.svg)

![wargaming-location](/assets/images/footer/location.svg) ![wargaming-location](/assets/images/footer/location-dark.svg) [Dimostheni Severi 33, Nicosia 1080](https://maps.app.goo.gl/GDopdPcJ5aJSRzhs7)

![wargaming-mail](/assets/images/footer/mail.svg) ![wargaming-mail](/assets/images/footer/mail-dark.svg) [privacy@wargaming.net](mailto:privacy@wargaming.net)

![language](/assets/images/footer/language.svg) ![language](/assets/images/footer/language-dark.svg)
...
* [THE COMPANY](https://wargaming.com/about/)
* [GAMES](https://wargaming.net/)
* [PREMIUM SHOP](https://wargaming.net/shop/)
* [IMPRESSUM](https://legal.eu.wargaming.net/en/user-documents/other/impressum/view)

###### NEED HELP

* [REPORT ILLEGAL CONTENT](https://eu.wargaming.net/support/en/products/wgc/help/36122/)
* [REQUEST DATA](https://eu.wargaming.net/support/en/products/wgc/help/36122/)
* [SUPPORT](https://eu.wargaming.net/support/)

* * *

© 1998–2024 Wargaming.net. All rights reserved.

![scroll-top-wargaming](/assets/images/scroll-top.png)
...
Language
 ...
 ![wargaming-document](/assets/images/language.png) ![wargaming-document](/assets/images/documents/arrow-down.png)
