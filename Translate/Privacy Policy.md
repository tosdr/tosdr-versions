...
* Services
    ...
    * By content
        ...
        * [Text translation by expert](https://www.translate.com/order)
        * [Email translation by expert](https://www.translate.com/services/email-translation)
    * By use cases
    ...
    * By file type
        * [Translate .PDF](https://www.translate.com/services/pdf-translation)
        * [Translate .PPT](https://www.translate.com/services/powerpoint-translation)
        * [Translate .DOC](https://www.translate.com/services/word-translation)
        * [Translate .JSON](https://www.translate.com/services/json-translation)
        * [Translate .INDD, .IDML](https://www.translate.com/indesign-translation)
        * [Translate .AI](https://www.translate.com/adobe-illustrator-translation)
        * [Translate .FIG](https://www.translate.com/figma-translation)
    * By languages
        * [All languages](https://www.translate.com/languages)
        * [Spanish translation services](https://www.translate.com/languages/spanish-translation-services)
        * [Portuguese translation services](https://www.translate.com/languages/portuguese-translation-services)
        * [German translation services](https://www.translate.com/languages/german-translation-services)
        * [Italian translation services](https://www.translate.com/languages/italian-translation-services)
        * [French translation services](https://www.translate.com/languages/french-translation-services)
        * [Japanese translation services](https://www.translate.com/languages/japanese-translation-services)
        * [Chinese translation services](https://www.translate.com/languages/chinese-translation-services)
        * [Korean translation services](https://www.translate.com/languages/korean-translation-services)
        * [Arabic translation services](https://www.translate.com/languages/arabic-translation-services)
...
* Sign in
    * [Sign in](https://www.translate.com/users/login)
...
[Human Pro Translation Edited by an expert, fast delivery time, $0.07 per word](https://www.translate.com/order) [Machine Translation Unedited. Instant. Free.](https://www.translate.com/machine-translation)
...
* Privacy Policy for translators
* Terms & Conditions for translators

**Privacy Policy**
------------------

**Last updated and effective: December 16th, 2024**

**Purpose**

Translate.com LLC ("us", "we", or "our") operates Translate.com website (the "Service").

This page informs you of our policies regarding the collection, use, and disclosure of personal data pertaining to each of our unregistered visitors, registered customers in connection with their access and use of our Service and the choices they have associated with that data.

We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from Translate.com

**Definitions**

* **Service**  
    Service is the document translation from the specified source language into the specified target language and the editing of the specified translations provided via Translate.com website
* **Personal Data**  
    Personal Data means data about a living individual who can be identified from those data (or from those and other information either in our possession or likely to come into our possession).
* **Usage Data**  
    Usage Data is data collected automatically either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit). It may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.
* **Cookies**  
    Cookies are small pieces of data which may include an anonymous unique identifier stored on your device (computer or mobile device).
* **Data Controller**  
    Data Controller means the natural or legal person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal information are, or are to be, processed. For the purpose of this Privacy Policy, we are a Data Controller of your Personal Data.
* **Data Processors (or Service Providers)**  
    Data Processor (or Service Provider) means any natural or legal person who processes the data on behalf of the Data Controller. We may use the services of various Service Providers in order to process your data more effectively.
* **Data Subject (Unregistered Visitor, Registered Customer)**  
...
We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other information that may be of interest to you, including service updates and money-saving deals. You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or the instructions provided in any email we send.

_Personal Data of Registered Customers_

Personally identifiable information of registered customers may include, but is not limited to:

* Email address
* First name and last name
* Phone number
* Address, State, Province, ZIP/Postal code, City (collected until February, 1, 2022)
* Cookies and Usage Data
* Support ticket content (Zendesk, Salesforce and Desk.com customers)

_Personal Data of Unregistered Visitors_

For unregistered visitors we use only cookies to keep track of the domains from which they visit and to measure visitors\` activity on [Translate.com](https://www.translate.com/), as well as usage data collected during such visits.
...
You can adjust the settings within your web browser in accordance with your personal preferences. You can delete cookies that have already been installed at any time and reject new cookies by configuring the settings within your browser. However, if you do not accept cookies, you may not be able to use some portions of our Service.
...
We will not sell or provide your data to any third party where you have not provided your consent to do so. All other data is processed in accordance with the General Data Protection Regulation (GDPR) 2018 and other applicable laws.

**Retention of Data**

Translate.com LLC will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.
...
We notify that the country to which personal data is transferred does not provide for an adequate level of data protection based on the European Commission decision. We endeavor to apply suitable safeguards to protect the privacy and security of your personal data and to use it only consistent with your relationship with Us and the practices described in this Privacy Policy.

**Disclosure of Data**

**Business Transaction**

If Translate.com LLC is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.
...
* To protect and defend the rights or property of Translate.com LLC
...
We implement the most commonly usedtechnical and organizational measures to ensure the protection and security of the data:

* Access control is designed to protect all physical access to the server, client and/or data rooms by using keys, authentication, authorization and other procedures.
* We ensure that all the authorized parties can access only the data specifically related to their specific tasks and/or authorization without being allowed to see anything else.
* If user data is required for analytical and statistical purposes the pseudonymization principle is followed by replacing user-related data by random, anonymous blocks of text.
* We ensure that the data is always transmitted using strong in-transit encryption standards (SSL/TLS certificates). Moreover, other secure connections are used to transfer data from web-based service containing forms, login screens, upload/download capabilities and so on.
* We ensure that all the relevant data is subject to regular backups and also regularly check them to ensure that the data can be successfully retrieved.
...
If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please contact us via email by sending your request to [support@translate.com](mailto:support@translate.com) or through a contact form on the Site.
...
* Hotjar  
    ...
    If you do not want to be recorded by Hotjar, you can disable it by setting the DoNotTrack header in your browser. For more information and more about Hotjar's data processing, please visit: [www.hotjar.com/legal/compliance/opt-out](https://www.hotjar.com/legal/compliance/opt-out).
* Advertising  
...
* By mail: Translate.com LLC, 571 S. Washington, Afton, WY 83110, United States
* By email: [support@translate.com](mailto:support@translate.com) or through a contact form on the Site

Terms of Service for Unregistered Visitors, Registered Customers
----------------------------------------------------------------
...
In addition, when using certain services, you will be subject to any additional terms applicable to such services that may be posted on the Site or provided to you from time to time, including, without limitation, the Privacy Policy located here. All such terms are hereby incorporated by reference into these Terms of Service.
...
In order to access and use certain features of our Services concerning human translations, you may be required to register an account. Unregistered visitors may access only automatic machine translation. If you choose to register for the Service, you agree to provide and maintain true, accurate, current and complete information about yourself as prompted by our registration form. The information that we collect shall be governed by our Privacy Policy.
...
In any case your payment for our Service cannot be less than the minimum one. The minimum payment is the lowest amount of money you are required to pay for an order that would be charged from your bank account. Our minimum payment rates reflect the terms and conditions of payment providers and their commission fees, as well as the amount of effort required to complete your order. Currently minimum payments are as follows:

* $5 for the translation of files with 166 words or less in the following formats: .pdf, .doc, .docx, .ppt, .pptx, .odt, .rtf, .xliff .csv .xls .po .indd .idml .ai .fig;
* $ 4.5 for the translation of texts via the order form on the Website, as well as files in .txt, .json formats, that contain 50 words or less;
* $ 0.5 for orders via the translation API and Zendesk Translation App.

Orders in excess of the above minimal thresholds are calculated using the formula: price per one word x number of words.

You should always check the pricing page of the Site for the current rates before submitting an order as our pricing policy is subject to change.

Depending on the plan you choose, we may bill you monthly based on the number of words translated, or may bill you when your account hits a specified amount as defined on our Pricing Page. A plan may include a limited number of translated words and therefore an additional charge may be applied for overages which may be billed monthly or when the account reaches a specified amount. We reserve the right to change our prices, including minimum payments, and will provide notice of the change on the Site. Your continued use of the Service after the price change becomes effective constitutes your agreement to pay the changed amount. You shall be responsible for all taxes associated with Services other than U.S. taxes based on our net income.
...
Translate.com shall not be liable in any way for any content or materials of any third parties (including users, translators, editors, and reviewers), including, but not limited to, any errors or omissions in any content, or for any loss or damage of any kind incurred as a result of the use of any such content. We reserve the right, although not obligated to, in our sole discretion to refuse or remove any content that is available via the Service. Without limiting the foregoing, we will have the right to remove any content that violates these Terms or is deemed by us, in our sole discretion, to be otherwise objectionable.
...
With respect to content or other materials you upload through the Service or share with other users or recipients (collectively, "User Content"), you represent and warrant that you own (or have sufficient rights to) all right, title and interest in and to such User Content, including, without limitation, all copyright and rights of publicity contained therein. By uploading any User Content you hereby grant and will grant Translate.com and its affiliated companies a nonexclusive, worldwide, royalty free, fully paid up, transferable, sublicensable, perpetual, irrevocable license to copy, display, upload, perform, distribute, store, modify and otherwise use your User Content in connection with the operation of the Service on your behalf, in any form, medium or technology now known or later developed. This license also includes using any User Content and corresponding translation text to enhance, refine, and improve Translate.com’s services.

You acknowledge and agree that any questions, comments, suggestions, ideas, feedback or other information about the Service ("Submissions"), provided by you to Translate.com are non-confidential and we will be entitled to the unrestricted use and dissemination of these Submissions for any purpose, commercial or otherwise, without acknowledgment or compensation to you.

You acknowledge and agree that we may preserve content and may also disclose content if required to do so by law or in the good faith belief that such preservation or disclosure is reasonably necessary to: (a) comply with legal process, applicable laws or government requests; (b) enforce these Terms; (c) respond to claims that any content violates the rights of third parties; or (d) protect the rights, property, or personal safety of Translate.com, its users and the public. You understand that the technical processing and transmission of the Service, including your content, may involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices.
...
Under no circumstances will we be liable for any loss or damage caused by your reliance on information obtained through Translate.com. It is your responsibility to evaluate the accuracy, completeness of Translations available through our Site and Services.
...
The term of this Agreement begins on the date which you accept and agree to this Agreement. You agree to be bound by this Agreement by submitting an electronic order form for Translations or by subscribing to a monthly or annual plan. You agree that we may suspend, terminate or discontinue the Site at any time without prior notice. We reserve the right to terminate this Agreement at our election and for any reason, without prior notice. We reserve the right to immediately terminate or suspend any User accounts or passwords in the event that User violates any of the terms and conditions of this Agreement or engages in any conduct which we, at our sole discretion, consider to be unacceptable. We may, at our sole discretion and without prior notice, immediately suspend the Service and your account if we determine that you are engaging, or have engaged, in any Abuse of Service to exploit available offerings inappropriately. Abuse of Service includes, but is not limited to, the following actions:

* If you primarily use our Zendesk translation application for translation of incoming requests and fail to do the same for outgoing replies, provided that the number of outgoing replies is lower than 30 (thirty) percent. To ensure that our Zendesk translation application is used effectively, we require both inbound and outbound clients’ messages to be translated via our application. For outbound messages, the minimum threshold that you should not fall below is 30 percent.
* If you create multiple accounts to accumulate benefits from the Freemium features (applies to all types of translation and products). Unauthorized customers and registered users can take advantage of our Service by submitting some small texts for translation free of charge within the specified limits, as a trial run. When you have exhausted the limit and wish to continue using the Service, please consider upgrading to our paid options.
* If you dispute the quality of translation and initiate a chargeback more than 30 (thirty) calendar days after receiving it. Once you have your order, we encourage you to review it and should you need to make a revision request or file a complaint, use the available means of contact. If we don't receive a revision request or complaint regarding the delivered translation within 30 (thirty) calendar days, we implicitly acknowledge that you are satisfied with it and no additional action is required, unless further payment is made, or a new order is submitted.

In the event of any termination, you will immediately cease access to the Site and Services. You agree that Translate.com will not be liable to you or any third-party for any termination of your access to the Service.
...
This Agreement, together with the Privacy Policy at [www.translate.com/legal](https://www.translate.com/legal) and the Pricing Plans, and any other legal notices published by us on the Site, shall constitute the entire agreement between you and Us.
...
You may contact us at the following email address: [support@translate.com](mailto:support@translate.com) or through the contact form on the Site.
...
This page informs you of our policies regarding the collection, use, and disclosure of personal data pertaining to each of our Service Providers in connection with their access and use of our Service and the choices they have associated with that data.

**Information Collection and Use**

We collect several different types of information for various purposes to provide and improve our Service to you in the course of performance of Services of translation, review, or editing of customer content in accordance with Terms & Conditions for Service Providers.
...
* Cookies and Usage Data
* Payment System
* Chosen Payment System Email
* Tax identification information

Your personal data shall be treated in strict confidence. We publish on our Site your first name, photo, languages, and fields of specialization. Other information shall be processed only by Translate.com LLC and its authorized suppliers (i.e., accountants, banks, payment processors etc.), exclusively for the performance of the contract.
...
If you are from the European Economic Area (EEA), Translate.com our legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.
...
We implement the most commonly used technical and organizational measures to ensure the protection and security of the data:
...
We work with Payoneer, Wise, Adv cash, Paxum, Revolut.

We work with PayPal which Privacy Policy can be viewed at [https://www.paypal.com/webapps/mpp/ua/privacy-full](https://www.paypal.com/webapps/mpp/ua/privacy-full)
...
This Agreement, including these terms and conditions (Terms), constitutes a legally binding agreement between you ("the Service Provider" or "you") and Translate.com LLC. ("Company") (each herein also referred to individually as a "Party," or collectively as the "Parties"), and governs your performance of Services (as defined below). By performing Services, you are consenting to the terms and conditions of this Agreement. If you do not agree to all of the terms of this Agreement, you must not provide Services.

1. **Services & Payment.** In consideration for compensation received, you agree to perform and deliver an accurate and efficient translation from the specified source language into the specified target language, review, or editing of customer content (“Deliverables”) as requested by us from a Translate.com website ("the Site") from time to time (the “Services”). We have the right to check your professional qualification by requesting you to complete an initial test task assigned by Company. We do not restrict your right to choose orders for the translation or editing of a specific content from the Site upon registering your account. You may work on a single order at a time. You shall submit only carefully translated, edited texts without abridgements, additions or other changes in content within the time frame defined by Company.
    
    Payment will be handled in accordance with the published rates we have quoted and provided our customers. Rates are subject to change and are found at the Pricing Page of our Site. Unless otherwise specifically agreed upon by Company in writing (and notwithstanding any other provision of this Agreement), all activity relating to Services will be performed by and only by Service Provider. Service Provider agrees that it will not (and will not permit others to) violate any agreement with or rights of any third party or, except as expressly authorized by Company in writing hereafter, use or disclose at any time Service Provider 's own or any third party's confidential information or intellectual property in connection with the Services or otherwise for or on behalf of Company.
    
    You agree that any compensation you accrue by working under this Agreement will be paid once per month to you via Payoneer, Wise, Adv cash, Paxum, Revolut, PayPal. No other method of payment will be used by us in order to compensate you. Your account must be at a minimum of $ 20 in order for you to cash out via Payoneer, Wise, Adv cash, Paxum, Revolut, PayPal via your account. If you wish to terminate your account and have not yet reached $ 20, please email us at [support@translate.com](mailto:support@translate.com), and we will manually process the Payoneer, Wise, Adv cash, Paxum, Revolut, and PayPal payment for you.
    
2. **Proprietary Information;** Confidentiality. Service Provider shall not use any Confidential or Proprietary Information for any purpose except to evaluate and complete the performance of services related to this Agreement and specific order. Proprietary and Confidential Information includes all Deliverables, and all other business, technical and financial information (including, without limitation, the identity of, personal data and other information relating to customers or employees) developed, learned or obtained by or on behalf of Service Provider during the period that Service Provider is to be providing the Services that relate to Company or Service. Proprietary information also includes information received in confidence by the Company from its customers or suppliers or other third parties. Service Provider shall take reasonable measures to protect the secrecy of and avoid disclosure of any Confidential or Proprietary Information. The duty of confidentiality shall also apply to customers\` personal data contained in the submitted projects.
    ...
    Proprietary Information shall not, however, include any information that Service Provider can establish (i) was publicly known or made generally available without a duty of confidentiality prior to the time of disclosure to Service Provider by us; (ii) becomes publicly known or made generally available without a duty of confidentiality after disclosure to Service Provider by us through no action or inaction of Service Provider; or (iii) is in the rightful possession of Service Provider without confidentiality obligations at the time of disclosure by us to Service Provider as shown by Service Provider ’s records kept in the ordinary course of business. Upon termination or as otherwise requested by Company, Service Provider will promptly provide to Company all items and copies containing or embodying Proprietary Information (including without limitation all Deliverables) or delete them immediately upon request, except that Service Provider may keep its personal copies of its compensation records and this Agreement.
    
3. **Warranties and Other Obligations.** Service Provider represents, warrants and covenants that: (i) the Services will be performed in a professional and workmanlike manner in accordance with current industry standards and practices and that none of such Services nor any part of this Agreement is or will be inconsistent with any obligation Service Provider may have to others; (ii) Service Provider has necessary skills, qualification, and experience to deliver Services; (iii) all work under this Agreement shall be Service Provider 's original work and none of the Services or Inventions nor any development, use, production, distribution or exploitation thereof will infringe, misappropriate or violate any intellectual property or other right of any person or entity (including, without limitation, Service Provider ); (iv) Service Provider may not assign or otherwise transfer this Agreement, by operation of law or otherwise, without the written consent of Company. Any assignment or transfer of this Agreement in violation of the foregoing shall be null and void.
    
4. **Expectations.** You agree to provide quality and reasonably accurate translations under this Agreement in accordance with the standards of quality customary in the translation business, conveying the meaning of the source text by providing either a literal or free translation depending on the source. If you fail to meet our quality standards in your performance under this Agreement, we reserve the right, in our sole discretion, to terminate this Agreement at any time or delete your account. You shall keep your contact and personal account information updated and contact us immediately in the event of a change. We will notify you if we detect fraudulent behavior on your account, explaining the activity that we have detected. Engaging in fraudulent activities, even once, can lead to termination of this Agreement and deletion of your account.
    
5. **Intellectual Property.** You agree that all right, title, and interest in any copyrightable material, including but not limited to all material we receive from you, and arising out of, or in connection with your performance under this Agreement, is the sole property of Translate.com and you reserve no rights in that material.
    
6. **Avoidance of Conflict of Interest.** Service Provider represents and warrants that Service Provider has no outstanding agreement or obligation that is in conflict with any of the provisions of this Agreement, or that would preclude Service Provider from fully complying with the provisions in this Agreement. Service Provider further represents and warrants that Service Provider has full power and authority to enter into this Agreement and perform Service Provider 's obligations hereunder.
    
7. **Term and Termination.** The term of this Agreement begins on the date which you accept and agree to this Agreement. You agree to be bound by this Agreement for every order that you provide your services for. This agreement may be terminated, for any reason, and at any time by you or us. Sections dealing with the handling of Confidential or Proprietary Information and any remedies for breach of this Agreement shall survive any termination or expiration.
    
8. **Relationship of the Parties;** Independent Contractor. For purposes of this agreement and for the services you provide, you will be classified as an independent contractor. You are not an employee, agent, partner or joint venture partner of Company and shall not bind nor attempt to bind Company to any contract. You are not authorized to hold yourself out as an agent of the Company at any time or on any medium. You shall perform services diligently so that any projected time goals set by the customer or the Company are met and reasonably accurate results are obtained for the customer. You shall be solely responsible for determining the method, mode, manner and hours (within the projected timeframe) in which the Services are performed under this Agreement. You are responsible for any expenses incurred by you during the performance of this Agreement. You acknowledge and agree that you are obligated to report all compensation received from us pursuant to this Agreement as income and the obligation to pay any and all taxes on such income is your responsibility. You agree to indemnify the Company from any and all claims, damages, liability, settlement, attorneys' fees and expenses, as incurred, on account of the foregoing or any breach of this Agreement or any other action or inaction by or for or on your behalf.
    
9. **Assignment.** This Agreement and the services contemplated hereunder are personal to Service Provider and Service Provider shall not have the right or ability to assign, transfer or subcontract any rights or obligations under this Agreement without the written consent of Company. Any attempt to do so shall be void. Company may fully assign and transfer this Agreement in whole or part.
    
10. **Electronic Communications.** For contractual purposes, you consent to receive communications from us in an electronic form, and agree that all terms and conditions, agreements, notices, disclosures, and other communications that Company provides to you electronically satisfy any legal requirement that such communications would satisfy if it were in writing.
    
11. **Indemnification.** You agree to indemnify and hold harmless Translate.com and its affiliates and their directors, officers and employees from and against all taxes, losses, damages, liabilities, costs and expenses, including attorneys’ fees and other legal expenses, arising directly or indirectly from or in connection with (i) your negligent, reckless or intentionally wrongful acts, (ii) a determination by a court or agency that you are not an independent contractor, (iii) your breach of any of the covenants contained in this Agreement and other legal terms on the Site, (iv) your failure to perform your duties in accordance with all applicable laws, rules and regulations, or (v) any violation or claimed violation of a third party’s rights resulting in whole or in part from the use of any of your deliverables under this Agreement.
    
12. **Governing Law/Jurisdiction.** All relations shall be governed, construed, and interpreted by, through and under the laws of the State of Delaware, without giving effect to its principles of conflicts of law. In case any claims or disputes arise, they shall be solved in the state and federal courts located in the State of Delaware.
    
13. **Remedy.** Except as provided by the act and this Agreement, arbitration shall be the sole, exclusive, and final remedy for any dispute between Service Provider and the Company. Accordingly, except as provided for by the act and this agreement, neither Service Provider nor the Company will be permitted to pursue court action regarding claims that are subject to arbitration.
...
* [Machine Translation](https://www.translate.com/machine-translation)
* [Dictionaries](https://www.translate.com/dictionary)
* [Language Pairs](https://www.translate.com/translations)
