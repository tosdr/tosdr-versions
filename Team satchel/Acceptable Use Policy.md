...
This acceptable use policy sets out the terms between you and us under which you may access our Satchel One platform (“Satchel One”). This acceptable use policy applies to all users of, and visitors to, Satchel One.

Your use of Satchel One means that you accept, and agree to abide by, all the policies in this acceptable use policy, which supplement our terms of use.

Satchel One is operated by Teachercentric Limited (“us” or “we”). We are registered in England and Wales under company number 06055034 have our registered office at 7th Floor, Exchange House, 12 Primrose St, London EC2A 2BQ, United Kingdom. Our VAT number is 120898412.

##### Prohibited uses

You may use Satchel One only for lawful purposes. You may not use Satchel One:
...
* not to reproduce, duplicate, copy or re-sell any part of Satchel One in contravention of the provisions of our terms of use;
* not to access without authority, interfere with, damage or disrupt:
    * any part of Satchel One;
    * any equipment or network on which Satchel One is stored;
    * any software used in the provision of Satchel One; or
    * any equipment or network or software owned or used by any third party.

##### Interactive services

We may from time to time provide interactive services on Satchel One (“interactive services”). We are under no obligation to oversee, monitor or moderate any interactive service we provide on Satchel One, and we expressly exclude our liability for any loss or damage arising from the use of any interactive service by a user in contravention of our content standards, whether the service is moderated or not.

##### Content standards

These content standards apply to any and all material which you contribute to Satchel One (“contributions”), and to any interactive services associated with it.
...
We will determine, in our discretion, whether there has been a breach of this acceptable use policy through your use of Satchel One. When a breach of this policy has occurred, we may take such action as we deem appropriate.

Failure to comply with this acceptable use policy constitutes a material breach of the terms of use upon which you are permitted to use Satchel One, and may result in our taking all or any of the following actions:

* immediate, temporary or permanent withdrawal of your right to use Satchel One;
* immediate, temporary or permanent removal of any posting or material uploaded by you to Satchel One;
