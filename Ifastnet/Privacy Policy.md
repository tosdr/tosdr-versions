...
[![logo](/portal/templates/ifastnet-child/assets/images/logo.png)](https://ifastnet.com/index.php)

* [Home](https://ifastnet.com/index.php)
* [Premium Hosting](https://ifastnet.com/portal/sharedhosting.php)
* [Business Hosting](https://ifastnet.com/portal/businesshosting.php)
* [WHM Reseller](https://ifastnet.com/portal/whmreseller.php)
* [VPS Plans](https://ifastnet.com/portal/vpshosting.php)
* [Dedicated Servers](https://ifastnet.com/portal/dedicatedserver.php)
* [Register Domain](https://ifastnet.com/portal/domainchecker.php)
* [Login](https://ifastnet.com/portal/clientarea.php)
...
iFastNet Ltd. Privacy Statement
===============================

iFastNet Ltd. cares about and respects your privacy. For this reason, we collect and use personal data only as it might be needed for us to deliver to you our products, services and websites (collectively, our "Services"). Your personal data includes information such as:
...
If at any time you have questions about our practices or any of your rights described below, you may reach our Data Protection Officer ("DPO") and our dedicated team by contacting us at [support.ifastnet.com](https://support.ifastnet.com/). This inbox is actively monitored and managed so that we can provide you with information you can confidently trust.

We have also have a ticket system to provide answers to your most common questions, additional instructions on how to exercise rights that might be available to you, documentation you may need, and definitions to key terms and concepts in this Privacy Policy.
...
1. create an account or purchase any of our Services (e.g.: billing information, including name, address, and credit card number);
2. request assistance from our Customer Services team (e.g.: telephone number);
3. complete contact forms or request newsletters or other information from us (e.g.: email courses, e-books, or emails); or
...
We only share your personal data as necessary for any third party to provide the services as requested or as needed on our behalf. These third parties (and any subcontractors) are subject to strict data processing terms and conditions and are prohibited from utilising, sharing or retaining your personal data for any purpose other than as they have been specifically contracted for (or without your consent). For further information on our sub-processors please refer to **[our list of Third-Party Data Processors](https://www.ifastnet.com/ThirdPartyDataProcessors.pdf).**
...
You may also update your subscription preferences with respect to receiving communications from us and/or our partners by making a support ticket at https://support.ifastnet.com or by using the support links in your control panel.
...
If you make use of a service that allows you to import contacts (e.g. using email marketing services to send emails on your behalf), we will only use the contacts and any other personal information needed for the requested service. If you believe that anyone has provided us with your personal information and you would like to request that it be removed from our database, please contact us at https://support.ifastnet.com
...
If you have an unresolved privacy or data use concern that we have not addressed satisfactorily, please contact our head office at iFastNet LTD, Bulman House, Regent Centre, Gosforth, Newcastle upon Tyne, NE3 3LS, you may invoke binding arbitration when other dispute resolution procedures have been exhausted.

### How you can access, update or delete your data.

To easily access, view, update, delete, or port your personal data (where available), or to update your subscription preferences, please sign into your Account and visit "Edit Account Details." Please contact us at https://support.ifastnet.com for additional information and guidance for accessing, updating, or deleting data.
...
If you have any questions about the security or retention of your personal data, you can contact us at https://support.ifastnet.com.
...
iFastNet Ltd. is the data controller for www.ifastnet.com and is registered on the Information Commissioner's Office's Register of Data Controllers under number (A8382659).You may direct questions or complaints in respect of how we handle your Personal Data to the Information Commissioner's Office:
...
If you have any questions, concerns or complaints about our Privacy Policy, our practices, or our Services, you may contact our Office of the DPO by contacting us at https://support.ifastnet.com. In the alternative, you may contact us by either of the following means:

* **By Mail:** Attn: Office of the Data Protection Officer, iFastNet Ltd. Bulman House, Regent Centre, Gosforth, Newcastle upon Tyne, NE3 3LS

Other legal information

* [Terms of Service](https://ifastnet.com/terms.php)
* [Cancellation & Refund](https://ifastnet.com/cancellation-refund.php)
* Privacy Policy
...
[Get Started!](https://ifastnet.com/portal/cart.php?a=add&pid=86)

##### Company

* [About Us](https://ifastnet.com/aboutus.php)
* [Contact Us](https://ifastnet.com/contact-us.php)
* [Our Blog](http://blog.ifastnet.com/)
* [Terms of Service](https://ifastnet.com/terms.php)
* [Privacy Policy](https://ifastnet.com/privacy.php)
* [Cancellation & Refund](https://ifastnet.com/cancellation-refund.php)
* [Banners / Link to us](https://ifastnet.com/banners.html)

##### Solutions

* [Shared Hosting](https://ifastnet.com/portal/sharedhosting.php)
* [Business Hosting](https://ifastnet.com/portal/businesshosting.php)
* [WHM Reseller](https://ifastnet.com/portal/whmreseller.php)
* [VPS Hosting](https://ifastnet.com/portal/vpshosting.php)
* [Dedicated Servers](https://ifastnet.com/portal/dedicatedserver.php)
* [Domain Registration](https://ifastnet.com/portal/domainchecker.php)
* [MyOwnFreeHost.net](http://www.myownfreehost.net/)

##### Client Area

* [Login](https://ifastnet.com/portal/clientarea.php)
* [Register](https://ifastnet.com/portal/register.php)
* [Affiliate System](https://ifastnet.com/portal/affiliates.php)
* [knowledge base](http://kb.ifastnet.com/)
* [Submit Ticket](http://support.ifastnet.com/)
...
[http://support.ifastnet.com](http://support.ifastnet.com/)

![Comodo EV SSL Secured](/portal/comodo_secure_seal_113x59_transp.png) ![Visa Debit payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/visa_debit.gif) ![Visa Electron payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/visa_electron.gif) ![Mastercard payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/mastercard.gif) ![Maestro payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/maestro.gif) ![American Express payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/AMEX.gif) ![Diners payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/diners.gif) ![JCB payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/JCB.gif) ![Laser payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/laser.gif) ![ELV payments supported by WorldPay](/portal/templates/ifastnet-child/assets/images/ELV.gif) ![Worldpay payments](/portal/templates/ifastnet-child/assets/images/poweredByWorldPay.gif) ![2CheckOut payments](/portal/templates/ifastnet-child/assets/images/2co11.jpg) ![AliPay](/portal/templates/ifastnet-child/assets/images/alipay-small-whitebg.png) ![NetBanking](/portal/images/netbanking_in.png)

Copyright © 2024 IFastNet LTD, Registered VAT number EU372034688. Registered UK company number 07951746.

Bulman House, Regent Centre, Gosforth, Newcastle upon Tyne, NE3 3LS.

All prices shown are exclusive of VAT, which will be charged at the rate of your place of origin.
