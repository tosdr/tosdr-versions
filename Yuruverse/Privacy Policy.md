...
[](https://yt.funami.tech/toggle_theme?referer=%2Fprivacy "Toggle Theme")

[](https://yt.funami.tech/preferences?referer=%2Fprivacy "Preferences")

[Log in](https://yt.funami.tech/login?referer=%2Fprivacy)
...
Users can clear their watch history using the [clear watch history](https://yt.funami.tech/clear_watch_history) page.
...
To remove data that has been stored in the website's database, you can use the [delete my account](https://yt.funami.tech/delete_account) page.

[Source code](https://github.com/iv-org/invidious) [Documentation](https://github.com/iv-org/documentation)

[Released under the AGPLv3 on GitHub.](https://github.com/iv-org/invidious/blob/master/LICENSE) [View JavaScript license information.](https://yt.funami.tech/licenses) [View privacy policy.](https://yt.funami.tech/privacy)

[Donate](https://invidious.io/donate/) Current version: 2024.02.19-e8a3698 @ master