[![Manjaro Logo](/logo.svg)Manjaro](https://manjaro.org/)Open main menu

* [Products](https://manjaro.org/products)
* [Enterprise](https://manjaro.org/enterprise)
* [Help](https://manjaro.org/help)
* [News](https://manjaro.org/news)
...
[Legal website operator identification](#legal-website-operator-identification)
-------------------------------------------------------------------------------
...
Commercial register: Registering Court Berlin (Charlottenburg); HRA 62804  
Liable associate: Manjaro Verwaltungs-GmbH, Registering Court Berlin (Charlottenburg); HRB 263833  
Managing board: Philip Müller & Roman Gilg  
...
[Responsible for the contents as per § 55 of the RStV (Interstate Broadcasting Agreement)](#responsible-for-the-contents-as-per-55-of-the-rstv-interstate-broadcasting-agreement)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[Information regarding resolution of disputes](#information-regarding-resolution-of-disputes)
---------------------------------------------------------------------------------------------
...
* Manjaro Linux, copyright © 2019-2024 Manjaro GmbH & Co. KG and the Manjaro Developers
...
[![Manjaro Logo](/logo.svg)Manjaro](https://manjaro.org/ "Manjaro")

The Manjaro project is backed up by Manjaro GmbH & Co. KG, an open source driven company.

People

* [Team](https://manjaro.org/team)
* [Donate](https://manjaro.org/donate)
* [Contribute](https://manjaro.org/contribute)

Commercial

* [Partners](https://manjaro.org/partners)
* [DPP](https://manjaro.org/dpp)
* [Contact](https://manjaro.org/enterprise#contact-us)

Status

* [Mirrors](https://repo.manjaro.org/)
* [Packages](https://manjaristas.org/branch_compare)
* [Servers](https://status.manjaro.org/)

Legal

* [Privacy Policy](https://manjaro.org/privacy-policy)
* [Terms Of Use](https://manjaro.org/terms-of-use)
* [Imprint](https://manjaro.org/imprint)

© Copyright 2024 Manjaro GmbH & Co. KG. All rights reserved.

[](https://x.com/ManjaroLinux)[](https://youtube.com/@manjaro-linux)[](https://linkedin.com/company/manjaro-linux)