[![](/home/img/header_logo.png)](https://skillsyncer.com/)

optimize your resume keywords and track your job applications
...
If you register with or log into your Skillsyncer account through another service your user information from that social networking sites, such as Google or Facebook may be collected.. This information may include your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts. The information we receive depends on which services you authorize and any options that are available. To remove this connection or collected information please refer to the "Account Information" section.  
...
●   To "UPDATE" your account and any of its associated data please login to your Skillsyncer account and browse to your Account Settings page.

●   To "DELETE" your account and all of its associated data please email support@skillsyncer.com with subject line "DELETE MY ACCOUNT".

●   To "REMOVE" your social account connection such as Facebook or Google and all of its associated data please email support@skillsyncer.com with subject line "REMOVE SOCIAL CONNECTION".  
