...
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AllSides Technologies, Inc, 8275 E 11th Ave. #200241, Denver, CO 80220-9998.
...
* **Website** refers to AllSides, accessible from allsides.com
...
Unless otherwise indicated, The Service and its original content (excluding Content provided by You or other users), features and functionality are and will remain the exclusive property of the Company and its licensors.

The Service is protected by copyright, trademark, and other laws of both the Country and foreign countries.

Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of the Company.

[AllSides Media Bias Ratings™](https://www.allsides.com/media-bias/media-bias-ratings) are licensed under a [Creative Commons Attribution-NonCommercial 4.0 International License](http://creativecommons.org/licenses/by-nc/4.0/). These ratings may be used for research or noncommercial purposes with attribution. They may not be used for commercial purposes without the prior written consent of the Company. For commercial use, or to request AllSides Media Bias Ratings™ as a CSV or JSON file, [contact us](https://www.allsides.com/contact).

Trademark Usage Guidelines
--------------------------

When using our content, brand and data, please refer to our [Trademark Guidelines](https://www.allsides.com/trademark-guidelines). This page outlines proper trademark usage, copyright attribution, style guidelines and a list of our trademarks.
...
If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at [admin@allsides.com](mailto:admin@allsides.com) and include in Your notice a detailed description of the alleged infringement.
...
You can contact our copyright agent via email at [admin@allsides.com](mailto:admin@allsides.com).
...
Our Service contains links to third-party web sites or services that are not owned or controlled by the Company.
...
The Service or some parts of the Service are available only with a paid Subscription ("Sustaining Membership"). You will be billed in advance on a recurring and periodic basis (such as monthly or annually), depending on the type of Subscription plan you select when purchasing the Subscription.
...
You will not receive a refund for the fees You already paid for Your current Subscription period.

You will lose access to the parts of the Service available only with a paid Subscription as soon as you cancel Your Subscription.
...
If you have any questions about these Terms of Use, You can contact us by email at [admin@allsides.com](mailto:admin@allsides.com).
