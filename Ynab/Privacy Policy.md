![YNAB tree logo](https://cdn.prod.website-files.com/640f69143ec11b21d42015c6/673caa3c748704384b0a3eea_Tree%20Logo%20Blurple%20(2).svg)![Australian flag](https://cdn.prod.website-files.com/640f69143ec11b21d42015c6/673caa3c748704384b0a3eec_flag%20(2).png)
...
Privacy policies aren’t known for being the most entertaining reading material on the world wide web, however, they are important; increasingly so in a world driven by data. Here at YNAB, we love to entertain, but we take your privacy seriously. Being entrusted with your personal information is a privilege, and a responsibility that we don’t take lightly.

Similar to how feeling in control of your money can bring great peace of mind, that same philosophy applies to your personal information. That’s why our intent is to make YNAB’s Privacy Policy as clear and as easy to understand as possible. **You should read this entire Privacy Policy, but here are our key points**:

✓ Our money comes from you, not ads in our service. As a consumer-focused subscription business, we rely on your subscriptions to offer our Services**.**

**✓** Generally, we use the information we collect about you to correspond with you, perform our agreements with you, carry out marketing and advertising activities, and perform our day-to-day business activities and operations.

**✓** We do not sell your Financial Data or any other information you provide through the Product (as both terms are defined below); we do perform typical [targeted advertising](https://www.youneedabudget.com/privacy-policy/opt-out-request) in an effort to introduce more people to the many benefits of YNAB.

**✓** We honor your requests to exercise your privacy rights; just let us know how we can help - whether accessing or deleting your data or otherwise.

**✓** We talk a lot about the importance of trusting your budget, and that goes beyond knowing that the calculations are correct. Your Financial Data is private and we help you keep it that way. The rest of this is a legal document, and it reads like a legal document. (That's what our lawyers want us to do.) We've included a table of contents [here](#table-of-contents), and summaries at the top of most sections in an effort to make it easier to understand, but it’s critical that you read the entire document.

Overview
--------

This Privacy Policy (the “**Policy**”) describes the data protection practices of You Need A Budget LLC and its affiliates ( “YNAB,” “we,” “us,” or “our”). The Policy applies to our websites and applications that link to this Policy, including our budgeting apps and products (“**Product**”) and the YNAB.com website, as well as related online and offline services thereto, and any services, transactions, or engagement you might have with us (collectively, the “**Services**”). 
...
1. [Collection, Use, and Disclosure of Information](#collection-use-and-disclosure-of-information)
2. [Data Retention](#data-retention)
3. [Third-Party Applications and Integrations](#third-party-applications-and-integrations)
4. [Children’s Privacy](#childrens-privacy)
5. [Your Rights and Choices](#your-rights-and-choices)
6. [Information for California Residents](#information-for-california-residents)
...
**Summary**: The information collected as you correspond with us or use the Services is used for the following purposes: to contact you, to fulfill our agreements with you, and to perform routine business activities and operations, including marketing. The following sections offer details about the types of information collected, how and why we collect, protect, use, and disclose that information, and, for users in the UK and European Economic Area, our legal bases for processing it.

### Categories of Information We Collect

We collect information about you, including information that directly or indirectly identifies you, through your use of YNAB. We do so:

* When you provide the information, by filling out forms or otherwise providing information through the Services;
* When you create or add to your budgets and budget categories or we connect to your financial institutions in order to retrieve financial transaction data on your behalf or you provide other financial transaction data within the Product (collectively “Financial Data”);
* When you use location services to record transactions;
* Automatically (through cookies and similar tools) when you browse our websites and apps or interact with our marketing communications; 
* Attend events or participate in programs; and
* When you correspond with us to receive customer support via email or chat.

This includes:

* Information that you provide by filling in forms on the Services, including  information provided at the time of registering to use or subscribing to use paid aspects of the Services  (e.g., email address), requesting further services, entering a contest or promotion we sponsor, completing surveys, or otherwise contacting us. When you use an identity provider – such as Google – to login to our services, we also receive the email associated with the Google (or similar) account. And if you use the Services as part of a Plan (as defined below), we may collect information associated with your use of the Plan (e.g., work email address and the date you joined the plan).   
* Your IP address when you interact with the Services.
* Your address (including postal code) for billing purposes.
* When you choose to directly link financial accounts to YNAB, we receive certain information about those financial accounts, including account balances, transactions and holdings.
* Your location when you record a transaction via the Services, including general and precise location (in accordance with your device settings and location permissions).  Precise location, if enabled, helps the Services remember the location where you are when you record a transaction, so that the Services may suggest that payee when you record another transaction near that same location in the future. "General" location information means information to identify the city and state in which your device is located based on its IP address. YNAB does not use precise or general geolocation information to show you promotions or advertisements based on your location. Please note that precise geolocation information is considered "sensitive personal information" under certain privacy laws, and we process this information in accordance with applicable legal requirements. You can disable precise geolocation tracking on your device. 
* Your communications with us (including email addresses different than that used to establish your account), if you contact us.
* Details of transactions you carry out through the Services, such as records of when you purchase a subscription to YNAB. You may be required to provide billing information before placing an order through the Services.
...
* Technical and usage information when you use the Services or interact with our marketing communications. This information includes IP address, geographic location of the device, browser type, browser language, date and time of your request, time(s) of your visit(s), error logs and other system activity, online browsing behavior data, and other information that allows us to analyze how the Services are used. 

In some cases, we will tell you when we need to collect certain information to provide you with certain services (for example, we may need certain information to access your YNAB budget so our support team can help you troubleshoot an issue). If you choose not to provide such information, we may not be able to provide the services you have requested.
...
* Bank data vendors, such as open banking service providers and bank aggregation service providers, which provide access to certain information about your financial accounts. YNAB will obtain your consent before collecting information from these providers;
* Other users of the Services, for instance in relation to [YNAB Together](https://support.ynab.com/en_us/ynab-together-B1nS78Cki) or a referral program;
...
We may use third-party analytics services (such as Amplitude and Google Analytics) as well as self-hosted data collection services on our Services to collect and analyze usage information through cookies and similar tools (such as the pages most read, time spent, search terms and other engagement data); engage in auditing, research, or reporting; assist with fraud prevention; and provide certain features to you. To prevent Google Analytics from using your information for analytics, you may install the Google Analytics Opt-out Browser Add-on by clicking [here](https://tools.google.com/dlpage/gaoptout). 
...
We also partner with third-party advertisers, ad server companies, and ad networks to promote our service. If you respond to one of our advertisements and visit or register to use our Services, we or our service providers may provide these third-party advertising companies with identifiers from your device or computer, such as an IP address or device ID, to help us analyze our user acquisition efforts.

The use of cookies or other tracking technologies that may be placed on devices you use to access our Services by non-affiliated third parties is governed by those third parties' privacy policies. If you are interested in more information about tailored browser advertising and how you can generally control cookies from being put on your devices to deliver tailored advertising, please read our [Cookies Policy](https://www.youneedabudget.com/cookie-policy).
...
* To perform our obligations pursuant to a contract (or pending contract) with you. For example, we will process your Personal Data to comply with the YNAB [Terms of Service](https://www.youneedabudget.com/terms) as part of entering into a contract with you, and to honor our commitments in any contracts that we have with you.
...
* With your consent. Where we rely on this basis, you may have the right to withdraw your consent at any time as described below.

### Disclosure of Information

We disclose data to fulfill the purposes for which you provide it; to enforce or apply our [Terms of Service](https://www.youneedabudget.com/terms), including billing. We may disclose or transfer information that we collect or you provide with:
...
* **Advertising Partners.** These parties help us market our service. They include ad networks and other marketing providers. 
...
* **Our Payment and Subscription Processors**, which at this time are Stripe and Recurly, to process and manage your payment for the Services.
* **Financial Data Aggregation Services**, but only with your consent. By utilizing these services, you acknowledge that the terms of the respective privacy policies of these providers ([MX](https://www.mx.com/privacy-policy/), [Plaid](https://plaid.com/legal/#end-user-privacy-policy), [TrueLayer](https://truelayer.com/legal/privacy/), etc.) will apply to your use of their services. With respect to aggregating your banking and other financial accounts, you or we (with your consent) will transmit your account credentials to third-party financial data aggregation services, who will use them to link, gather and maintain your account balances, transactions, and holdings used to provide the Services.
...
* **Other users you authorize**. For example, when you use YNAB Together, you authorize us to share budgets that you own and data encompassed within those budgets with your Group Manager and selected Members of your YNAB Together Group.  Members of your YNAB Together Group may view certain information about you, including budgets that you own or have access to, your first name, and email address. For more information about YNAB Together and these defined terms, visit our [**Help Doc**](https://support.youneedabudget.com/en_us/ynab-together-B1nS78Cki). 
* **YNAB Partner**. If you elect to participate in the Product through a business or other organization (“Partner”) as part of a Partner’s plan (“Plan”), for example, when an employer provides YNAB as an employee benefit, then we will share certain of information—such as name, email address, and the date you joined the Services—with that Partner. If a Plan has 10 or more users, we may also provide the Partner with aggregated, anonymized data about the number of Plan users who access YNAB each month and how users are interacting with the Services.

We may also disclose your information:

* To comply with any court order, law or legal process, including to respond to any government or regulatory request.
* To enforce or apply our [Terms of Service](https://www.youneedabudget.com/terms) or terms of sale and other agreements, including for billing and collection purposes.
* If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of YNAB, our customers or others. This includes exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.
...
We may de-identify and aggregate information collected in such a way that the information cannot reasonably be linked to you or your device. We may use such de-identified or aggregated data for any purposes (including testing our IT systems, research, data analysis, improving the Services, and developing new products and features) and may disclose it to our service providers. Also, when we de-identify and aggregate non-Financial Data, we may disclose such data to any third parties, including advertisers, promotional partners, and others.

2\. Data Retention
------------------

Generally speaking, we retain your information as necessary to provide the Services and to fulfill the transactions you have requested, and for other necessary purposes such as complying with our legal obligations, resolving disputes, enforcing our agreements, and for fraud prevention and related security purposes. In determining how long to retain information, we consider the nature and sensitivity of the information, the potential risk of harm from unauthorized use or disclosure of the information, the purposes for which we process the information, how long an account has been inactive, and applicable legal requirements.

More specifically: 

* We retain account data for up to 12 months after your subscription or trial expires, unless you delete your account as described below.
* After deletion, we may retain your email address to be able to confirm deletion of associated data.
...
When you choose to use third-party apps (such as the YNAB Toolkit or other OAuth apps based on our API), plug-ins, or websites that integrate with the Services, they may receive your information and content, including your personal data, photos, and your activity data. Information collected by these third parties is subject to their terms and policies. YNAB is not responsible for the terms or policies of third parties, so we urge you to review their privacy and security policies prior to use.
...
**Summary:** All users have certain rights, for instance in relation to marketing communications and interactions on their mobile devices. Depending on your jurisdiction, you may also have the right to make certain requests regarding your personal information, including the ability to access, correct, or delete certain personal information and to opt-out of certain uses of your personal information. Those rights are outlined below, including information about how to exercise those rights. If there’s any conflict between this section and other areas of this Policy, the portion that protects your personal information the most will be followed. If you are a resident of California, please see our [California Privacy Policy](https://www.youneedabudget.com/privacy-policy/california-privacy-disclosure) for additional disclosures about our practices and more information about your rights.
...
You can also submit a request to opt out of the use of your email address and other personal information related to that email address for targeted advertising purposes and to the disclosure of such information to our marketing and business partners by visiting [this link](https://www.youneedabudget.com/privacy-policy/opt-out-request). Depending on your jurisdiction, you may be permitted to designate an authorized agent to submit such requests on your behalf. Please note that we do not knowingly sell the personal information of minors under 16 years of age without legally-required affirmative authorization.
...
We may offer opportunities to receive certain services or benefits, including money to participate in surveys, sign up for communications, or other similar incentives, which may require the provision of personal information, such as registering for an account and answering surveys or providing additional feedback or information. Such opportunities could be considered a financial incentive under applicable law (each, an “Incentive Program”). Your participation in Incentive Programs is purely voluntary. When you participate in an Incentive Program, you agree to the terms of that Incentive Program, and may revoke your participation depending on the Incentive Program.

6\. Information for California Residents
----------------------------------------

In addition to the rights detailed in the Your Rights and Choices section of this Policy, residents of California may have additional rights regarding personal information. If you are a California resident, please read our [California Privacy Policy](https://www.youneedabudget.com/privacy-policy/california-privacy-disclosure), which supplements this Policy.

7\. Transfers
-------------

**Summary**: We operate from the United States. Information from users based elsewhere will be transferred, processed, and stored in the United States. 

The Services offered by YNAB are operated from the United States. If you are located outside of the United States and choose to use the Services or provide information to us, you acknowledge and understand that your information will be transferred, processed, and stored in the United States, as it is necessary to provide the Services and perform the [Terms of Service](https://www.youneedabudget.com/terms).
