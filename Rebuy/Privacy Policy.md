...
✨ Get it FREE ✨](https://www.rebuyengine.com/tools/merchandising-audit-checklist?website_utm_page=legal-privacy-notice&website_utm_section=global-banner&website_utm_cta=get-it-free&website_utm_test=merchandising-audit)
...
2. [Changes to this Privacy Notice](#changes-to-this-privacy-notice)
3. [Important Note Regarding Information Controlled by our Clients](#client-control)
4. [Information We Collect](#information-we-collect)
5. [Minors](#minors)
6. [Sensitive Data](#sensitive-data)
7. [How Rebuy Uses Personal Information](#personal-info-uses)
8. [Sharing Personal Information](#personal-info-sharing)
9. [Marketing Communications](#marketing-communications)
10. [Your Choices](#your-choices)
11. [Third Party Social Plug-Ins](#social-media)
12. [External Websites](#external-sites)
13. [Data Retention](#data-retention)
14. [Data Security and Protection](#data-security)
15. [California Privacy Rights - Shine the Light](#california-rights)
16. [Nevada Privacy Rights](#nevada-rights)
17. [International Transfers](#international-transfers)
18. [Additional European and International Data Rights](#international-rights)
19. [How to Contact Us](#how-to-contact-us)

1. #### INTRODUCTION
    
    Rebuy, Inc. (hereinafter, “Rebuy”, “we”, “our” or “us”) owns and operates: (a) the website located at [www.rebuyengine.com](https://www.rebuyengine.com/) (the “Site”), and (b) Rebuy’s proprietary hosted software platform that enables users to implement ecommerce personalization and merchandizing solutions (the “Rebuy Platform”). When we refer to the “Services” throughout this Privacy Notice, we mean the Site, Rebuy Platform, and any other products, websites, services, and/or applications provided by us and that include a link and/or reference to this Privacy Notice, and any related services and/or new features and/or functionality provided by us through or in connection with any of the foregoing.
    
    This Privacy Notice describes Rebuy’s data collection, use, protection, and privacy practices with respect to information and data we may collect in connection with the following activities:
    ...
    * Connecting access to and/or authorizing certain data to be shared with us through third-party integrations you have enabled and/or used in connection with the use of the Rebuy Platform (collectively, “**Third Party Integrations**”);
...
3. #### IMPORTANT NOTE REGARDING INFORMATION CONTROLLED BY OUR CLIENTS
    
    Please note that personal information processed by Rebuy about Customers (defined below) is controlled by the business, company, organization and/or or entity (hereinafter, the “Client”) that has entered into the Rebuy Terms of Service Agreement or other agreement with Rebuy for use of the Services (the “Agreement”). When Rebuy collects and/or processes such information, it does so as a “data processor” on behalf of the Client, who is the “data controller”.  
...
4. #### INFORMATION WE COLLECT
    ...
    When you access and use our Services, we collect information directly from you as explained in the Section [Information Provided Directly by Users of the Services](https://www.rebuyengine.com/legal/privacy-notice#information-provided-by-users), and in in certain circumstances, we automatically collect certain information when you access and/or use the Services as explained [Information Collected Indirectly](https://www.rebuyengine.com/legal/privacy-notice#information-collected-indirectly). In addition, the instances where we may receive information from third parties is as described [here](https://www.rebuyengine.com/legal/privacy-notice#information-collected-from-third-parties).
    ...
    * **Information Provided Directly by users of the Services**
    ...
    Rebuy collects the following types of information directly from you:
    ...
    * Payment & Transaction Information: When you sign up to purchase a subscription to the Services, Rebuy may collect certain payment information, such as your credit card, bank account information. Note that we do not directly collect or store any payment information. Payment transaction information is processed and stored exclusively by our third-party, third-party, PCI-compliant, payment processors, on our behalf in order to collect fees payable by you in connection with your use of the Services. The information provided to Rebuy only includes partial payment or credit card information, and limited transaction information via our payment processors' portals.
    ...
    * Cookies and Similar Technologies
        ...
        We or authorized third parties may collect certain information (including, without limitation, Usage Information) by automated means using technologies such as cookies, web beacons, embedded scripts, pixels, browser analysis tools, server logs, and mobile identifiers; however, even though we use these technologies to track the use of the Services, Rebuy does not directly track users across third party websites, provided that, certain targeting & advertising partners (as described below) may track you across websites. For more information on our use of these technologies, see our [Cookie Policy](https://www.rebuyengine.com/legal/cookie-policy).
        
    * Targeting & Advertising
        
        We may use third party advertising partners (e.g., Google, Inc., LinkedIn, Inc. and Facebook, Inc.) who use targeting/advertising cookies and similar technologies to deliver advertisements that are more relevant to you and your interests. They are also used to limit the number of times you see an advertisement as well as help measure the effectiveness of the advertising campaigns. They are usually placed by advertising networks with the website operator's permission. They remember that you have visited a website and this information is shared with other organizations such as advertisers. For more information on our and/or third-party advertising partners' use of these targeting & advertising cookies and similar technologies, please see our [Cookie Policy](https://www.rebuyengine.com/legal/cookie-policy).
...
7. #### HOW REBUY USES PERSONAL INFORMATION
    ...
    * Provide information to regulatory bodies when legally required, and only as outlined below in [Legal Obligations and Security](#legal-obligations-and-security).
...
8. #### SHARING PERSONAL INFORMATION
    ...
    * * Hosting providers,
        ...
        * Professional service providers, such as auditors, lawyers, consultants, accountants and insurers.
        ...
        For a list of all Service Providers we use, please [contact us](mailto:legal@rebuyengine.com). We require all Service Providers to respect the security of your personal information and to treat it in accordance with the law.
    ...
    * **Advertising Partners**
    ...
    We may share your personal information with our third party advertising partners to provide ads that we think may interest you. For more information about our advertising and marketing practices and those of the third party advertising partners, please see please see our [Cookie Policy](https://www.rebuyengine.com/legal/cookie-policy).
    ...
    * Legal Obligations and Security  
        ...
        Your information, including the contents of all of your online communications in our Services and between you and Rebuy may be accessed and monitored as needed to provide our Service and may be disclosed to law enforcement, regulatory agencies, official government bodies, and other third parties, as we, in our sole discretion, believe necessary or appropriate:
        
        * To enforce our rights under our [General Website Terms of Use](https://www.rebuyengine.com/legal/terms-of-use), the Agreement, and/or any other terms and conditions applicable to the use of the Services;
...
9. #### MARKETING COMMUNICATIONS
    ...
    If you are a registered user and have not otherwise opted out (or with your consent where required by applicable law), or if you have opted in to receive direct marketing emails from us, we may use your personal information to send you marketing information about the Services, new product releases, new feature releases of the Services, and/or other Rebuy products and services, that we think may interest you. We carry out direct marketing by email. For the avoidance of doubt, we do not send marketing communications to Customers of our Clients, unless such Customer has signed up directly with us to receive marketing communications from us.
    
    If you no longer wish to receive marketing communications, you have the right at any time to opt out as further explained in  [Your Choices](#your-choices).
    
10. #### YOUR CHOICES
    
    * Accessing, Updating and Correcting Personal information
        
        If you would like to correct or update certain personal information (such as your contact information), please [contact us](mailto:legal@rebuyengine.com) and we will use reasonable efforts to correct and/or update such information.
        
    * Additional European and International Data Rights
        
        If you are a resident of the European Economic Area, you may have additional rights you can exercise as described [here](#international-rights).
        
    * Additional European and International Data Rights
        
        You may manage the receipt of marketing and non-transactional communications sent by email by clicking on the "unsubscribe" link located on the bottom of any of our marketing e-mails. To opt-out of marketing communications sent by physical mail, please [contact us](mailto:legal@rebuyengine.com) with your request.
    ...
    * Cookies & Targeted Advertising
        ...
        You can manage your cookie and tracking preferences as described in our [Cookie Policy](https://www.rebuyengine.com/legal/cookie-policy).
...
15. #### CALIFORNIA PRIVACY RIGHTS - SHINE THE LIGHT
    ...
    Rebuy does not share your personal information with any unaffiliated third party for its direct marketing purposes without your express consent.
...
16. #### NEVADA PRIVACY RIGHTS
    ...
    Rebuy does not currently sell covered information of Nevada consumers as defined under applicable Nevada law; however, you may submit an opt-out request, which we will honor as required by Nevada law should we engage in such a sale in the future.  
      
    You may submit an opt-out request by sending an email message or writing to us at the email and/or mailing address specified in the [How to Contact Us](#how-to-contact-us) Section; along with your full name, any user name, and complete mailing address (including street address, city, state, and zip code), email address (so that we can contact you, if needed, in connection with the request) and confirmation that you are a Nevada resident.  
...
18. #### ADDITIONAL EUROPEAN AND INTERNATIONAL DATA RIGHTS
    ...
    * File a complaint—that’s the right to file a complaint with a supervisory authority about our collection and processing of your personal information.
    ...
    These rights are subject to certain rules around when you can exercise them. If you are located in the European Economic Area and wish to exercise any of the rights set out above, please [contact us](mailto:legal@rebuyengine.com).
    ...
    Finally, you have the right to make a complaint at any time to the supervisory authority for data protection issues in your country of residence. We would, however, appreciate the chance to deal with your concerns before you approach the supervisory authority, so please [contact us](mailto:legal@rebuyengine.com) first.
    
19. #### HOW TO CONTACT US
    
    If you have any questions about this Privacy Notice and/or our [Cookie Policy](https://www.rebuyengine.com/legal/cookie-policy), including any requests to exercise your legal rights, please contact us as follows:
    
    By email at: [legal@rebuyengine.com](mailto:legal@rebuyengine.com); Subject Line: Privacy Request
    
    By mail at: Rebuy, Inc.  
    Attn: Rebuy Privacy Request  
    6004 St Johns Ave  
