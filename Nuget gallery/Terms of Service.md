...
* [Statistics](https://www.nuget.org/stats)
* [Documentation](https://docs.microsoft.com/nuget/)
* [Downloads](https://www.nuget.org/downloads)
* [Blog](https://blog.nuget.org/)

* [Sign in](https://www.nuget.org/users/account/LogOn?returnUrl=%2Fpolicies%2FTerms "Sign in to an existing NuGet.org account")
...
3. Don't send or post spam. Spam is unwanted or unsolicited bulk email, postings, contact requests, SMS (text messages), instant messages, or package content.
4. Don't publicly display or use the Services to share inappropriate content or material (involving, for example, nudity, pornography, graphic violence, or criminal activity).
...
7. Don't damage, disable, overburden, or impair the Services.
8. Don't engage in activity that is harmful to you, the Services, or others (e.g., transmitting viruses, stalking, posting terrorist content, communicating hate speech, or advocating violence against others).
9. Don't infringe upon the rights of others (e.g., unauthorized sharing of copyrighted music or other copyrighted material, or photographs).
10. Don't engage in activity that violates the privacy of others.
...
13. Don’t use the Services if you are under the age of thirteen (13).
14. Don’t use the Services if Microsoft has previously revoked your access to the Services for violation of the TOU.

Enforcement of TOU
==================

Microsoft reserves the right to investigate violations of the TOU. In response to violations of the TOU, Microsoft may stop providing Services to you, close your Microsoft or NuGet account, revoke your access to the NuGet APIs, or delete or unlist your package(s). Microsoft has the sole discretion to decide how to handle customer reports of TOU violations. Microsoft may or may not take any action against the violator, depending on the circumstances and the severity of the violation.
...
Use of NuGet Open Source
========================

The Services allow you to access, download, share, or upload packages from Microsoft and third parties. Each package is governed by the terms that are included with the package. When publishing a package, include the terms in a prominent location, such as a license file or an embedded readme file. When accessing, downloading or acquiring a package you should review the applicable terms. Any terms included with the packages do not modify the TOU. Microsoft does not license any intellectual property to you from third party package providers and is not responsible for information provided by third parties.

Microsoft is not responsible for information, such as personal data, that you include in packages that you upload, share, or store through the Services and cannot guarantee that such information can be permanently deleted or edited. You may unlist your packages, which prevents those packages from appearing on NuGet.org search results and the Visual Studio UI, as further described in the [Services documentation](https://aka.ms/nuget-delete-package-policy).
...
See [Notice and Procedure for Making Claims of Copyright Infringement](https://www.microsoft.com/info/Cloud.aspx).
...
For further information on export and geographic export restrictions, please visit [https://aka.ms/NuGetExportControlPolicy](https://aka.ms/NuGetExportControlPolicy) and [https://www.microsoft.com/en-us/exporting](https://www.microsoft.com/en-us/exporting).
...
[Contact](https://www.nuget.org/policies/Contact)
