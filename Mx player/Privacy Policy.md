...
MX Player also uses YouTube API Services in some of its products. That means if you are using a MX Player's service one of our services which makes use of YouTube APIs, then you are agreeing to the  
