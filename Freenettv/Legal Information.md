...
3. **Sie können Ihre Entscheidung bzgl. der Verarbeitung von Daten bei der Nutzung unserer Webseiten jederzeit [hier](https://www.freenet.tv/#) ändern.**
    ...
    * [Google](https://www.google.com/settings/u/0/ads?hl=de&sig=ACi0TCj-H3kAUIhhb8gCk2wPeXQfyOFhuE-D33d925AUdbT_HeHWo2T9wthPPhuIJl8fz7i_7U-OAN_PN7VgQ_47jwj2T6BqcQ#display_optout)
    * [ad4mat](https://www.ad4mat.com/datenschutz/)
    * [Performance Media](https://www.performance-media.de/opt-out)
    * [Remintrex](https://www.remintrex.com/ceng/pub/unsubscribe.html?lang=de)
    * [The Reach Group](https://www.reachgroup.com/opt-out/)
    * [intelliAd](https://login.intelliad.de/optout.php)
    
    Auf der Webseite [www.youronlinechoices.com](https://www.youronlinechoices.com/) haben Sie unter Präferenzmanagement die weitere Möglichkeit, nutzungsbasierter Online-Werbung durch einzelne oder durch alle Unternehmen zu widersprechen.
    ...
    **Google Analytics**  
    ...
    Alternativ können Sie mit einem Klick auf den folgenden Link ein Opt-Out-Cookie setzen, mit dem das Tracking mit Google Analytics unterbunden wird: Google Analytics Tracking unterbinden: [Google Anayltics Tracking unterbinden](https://www.freenet.tv/#)
    ...
    * [http://www.google.de/policies/privacy/](https://www.google.de/policies/privacy/)
    
    **Informationen zu Facebook Seiten-Insights-Daten**  
    Wenn Sie Facebook-Produkte wie u. a. Seiten nutzen, erhebt und verwendet Facebook die in der [Facebook-Datenrichtlinie](https://www.facebook.com/about/privacy/update) unter „Welche Arten von Informationen erfassen wir?“ beschriebenen Informationen. Erfahren Sie in der Facebook [Cookie-Richtlinie](https://www.facebook.com/policies/cookies/) mehr darüber, wie Facebook Cookies und ähnliche Technologien einsetzt. Für Seiten stellt Facebook Seitenbetreibern [Statistiken und Einblicke](https://www.facebook.com/business/pages/manage#page_insights) bereit, mit deren Hilfe diese Erkenntnisse über die Arten von Handlungen erhalten, die Personen auf ihren Seiten vornehmen („Seiten-Insights“ – Art. 6 Abs. 1f DSGVO).
    ...
    * Informationen zu den Handlungen, den Personen, die die Handlungen vorgenommen haben, und zu den dafür verwendeten Browsern/Apps. Dies sind zum Beispiel:
        ...
        * Facebook Ireland und wir haben eine Vereinbarung getroffen, in der festgelegt ist, wer jeweils welche [Verpflichtung](https://www.facebook.com/legal/terms/page_controller_addendum) aus der DSGVO erfüllt
            
        * Facebook Ireland und wir haben vereinbart, dass Facebook Ireland dafür verantwortlich ist, Ihnen Informationen über die Verarbeitung für Seiten-Insights bereitzustellen und es Ihnen zu ermöglichen, Ihnen Ihre gemäß der DSGVO zustehenden Rechte auszuüben. Gemäß DSGVO haben Sie das Recht auf [Auskunft](https://www.facebook.com/help/contact/180237885820953), Berichtigung, [Übertragbarkeit](https://www.facebook.com/help/contact/180237885820953) und Löschung Ihrer Daten sowie auf [Widerspruch](https://www.facebook.com/help/contact/1638046109617856) gegen die Verarbeitung Ihrer Daten und auf Einschränkung der Verarbeitung. In Ihren Facebook-[Einstellungen](https://www.facebook.com/settings?tab=your_facebook_information) erfahren Sie mehr über diese Rechte. Sie können auch den Datenschutzbeauftragten von Facebook Ireland kontaktieren, dessen Kontaktdaten Sie in der Datenrichtlinie von Facebook Ireland finden.
    ...
    **Verarbeitung im Rahmen von Verträgen und vorvertraglichen Maßnahmen**  
    ...
    Wenn sie eine Bestellung (z.B. Guthabenkarte oder Geräte) in unserem Online-Shop vornehmen wollen, können Sie dies als angemeldeter Kunde (Benutzerkonto) oder im Rahmen einer Gastbestellung unternehmen. Guthabenkarten für freenet TV sind zudem im freien Handel erhältlich, ohne dass Kundendaten angeben müsse. Wenn Sie eine Zugangsberechtigung verwenden wollen, die Sie im Rahmen des Kaufs eines Gerätes ohne zusätzliche Berechnung erworben haben, dann erfordert dies die Anlage eines Kundenkontos.
    ...
    **Vertragsverlängerung, Marktforschung und Werbung**  
    ...
    Media Broadcast GmbH darf mich postalisch, per E-Mail, SMS, Telefon oder Telemedien über Angebote von [Partnern](https://www.freenet.ag/rechtliche-hinweise) zu Apps, Online- und Mediendiensten, Telekommunikations- und TV-Dienste/ -produkte, Software, Hardware und Zubehör, Energiedienstleistungen, Krediten und Versicherungen informieren. Ich bin damit einverstanden, dass zu den vorgenannten Zwecken meine Bestandsdaten (Name, Kontaktdaten, Vertragsbeginn und -ende bis zum Ende des auf die Beendigung des Vertrags folgenden Kalenderjahres) und bei der Werbung für eigene Telekommunikationsdienste auch Verkehrsdaten (Verbindungsart, Umfang und Zeitpunkt für 6 Monate) gespeichert, mit Onlinekennungen und Webtrackingdaten (z.B. Cookies, Werbe-IDs, Geräte-IDs oder IP-Adressen) abgeglichen und verwendet werden. Zur Verknüpfung verschiedener Endgeräte dürfen pseudonymisierte Kennungen (z.B. Telefonnr., E-Mailadressen) verwendet werden.
    
    Ich kann meine Einwilligungen jederzeit ganz oder teilweise widerrufen, etwa [im Online Service in Ihrem Kundenbereich („Mein Konto“)](https://www.freenet.tv/meinkonto), durch ein Schreiben an Media Broadcast GmbH, Erna-Scheffler-Strasse 1, per E-Mail an [datenschutz@freenet.tv](mailto:datenschutz@freenet.tv?subject=Anfrage%20Datenschutz%20freenet%20TV) oder telefonisch unter +49 221 4670 8700 (Mo.-Fr. 08:00 - 22:00 Uhr, Sa. 10:00 - 19:00 Uhr), ohne dass hierfür andere als die Übermittlungskosten nach den Basistarifen entstehen.
    ...
    **Dauer der Datenspeicherung**  
    ...
    Sofern Sie die Möglichkeit nutzen, sich auf unserer Website unter Angabe von personenbezogenen Daten zu registrieren und ein Kundenkonto anlegen, werden die dabei von Ihnen angegebenen personenbezogenen Daten gespeichert und verwendet, bis Sie das Kundenkonto löschen.
