...
[Skip to content](#rules-guidelines-tos)

 [![logo](../../../assets/images/abi-small-white.png)](https://documentation.abinteractive.net/ "ABI Documentation")|
...
* [English](https://documentation.abinteractive.net/official/legal/tos/)

* [Home](https://documentation.abinteractive.net/)
* [Official](https://documentation.abinteractive.net/official/)
* [ChilloutVR](https://documentation.abinteractive.net/chilloutvr/)
* [CCK](https://documentation.abinteractive.net/cck/)

 [![logo](../../../assets/images/abi-small-white.png)](https://documentation.abinteractive.net/ "ABI Documentation")ABI Documentation
...
* [x] 
    ...
    * [x]  Legal
        ...
        * [ ]  Rules, guidelines & ToS [Rules, guidelines & ToS](https://documentation.abinteractive.net/official/legal/tos/)
            
            Table of contents
            
            * [Alpha Blend Interactive Terms of Service](#alpha-blend-interactive-terms-of-service)
                
                * [Introduction](#introduction)
                * [1 - Platform requirements](#1-platform-requirements)
                * [2 - Social Interactions](#2-social-interactions)
                * [3 - Impersonation](#3-impersonation)
                * [4 - Usage of our products and services](#4-usage-of-our-products-and-services)
                * [5 - Uploading and publishing content](#5-uploading-and-publishing-content)
                * [6 - Platform content creation](#6-platform-content-creation)
                * [7 - Modding our games](#7-modding-our-games)
                * [8 - Account management](#8-account-management)
                * [9 - Third party applications or sites](#9-third-party-applications-or-sites)
                ...
                * [10 - Commercial usage](#10-commercial-usage)
    ...
    * [ ]  Platform
        ...
        * [Account limits & Unlock](https://documentation.abinteractive.net/official/platform/account/)
        * [Badges](https://documentation.abinteractive.net/official/platform/badges/)
...
* [ ] 
    ...
    * [Quick Start](https://documentation.abinteractive.net/chilloutvr/quick-start/)
    * [ ] 
        
        [General](https://documentation.abinteractive.net/chilloutvr/general/)
        
        General
        
    * [ ] 
        
        [Controls](https://documentation.abinteractive.net/chilloutvr/controls/)
        
        Controls
        
        * [Game Controller](https://documentation.abinteractive.net/chilloutvr/controls/game/)
        * [Mouse and Keyboard](https://documentation.abinteractive.net/chilloutvr/controls/mouse-and-keyboard/)
        * [Valve Index Controller](https://documentation.abinteractive.net/chilloutvr/controls/valve-index/)
        
    * [ ] 
        
        [FAQ](https://documentation.abinteractive.net/chilloutvr/faq/)
        
        FAQ
        
        * [Mature Content Access DLC](https://documentation.abinteractive.net/chilloutvr/faq/mature-content-access-dlc/)
        * [System Requirements](https://documentation.abinteractive.net/chilloutvr/faq/system-requirements/)
        * [What is ChilloutVR?](https://documentation.abinteractive.net/chilloutvr/faq/what-is-chilloutvr/)
...
* [ ] 
    ...
    * [ ] 
        ...
        [Avatar](https://documentation.abinteractive.net/cck/avatar/)
        
        Avatar
        
        * [Face Tracking Utilities](https://documentation.abinteractive.net/cck/avatar/face-tracking/)
        * [Whitelisted Components for Avatars](https://documentation.abinteractive.net/cck/avatar/whitelisted-components/)
        
    * [ ] 
        
        [World](https://documentation.abinteractive.net/cck/world/)
        
        World
        
        * [Whitelisted Components for Worlds](https://documentation.abinteractive.net/cck/world/whitelisted-components/)
        
    * [ ] 
        
        [Spawnable](https://documentation.abinteractive.net/cck/spawnable/)
    ...
    * [ ]  Components
        ...
        * [CVR Avatar](https://documentation.abinteractive.net/cck/components/CVRAvatar/)
        * [CVR Pointer](https://documentation.abinteractive.net/cck/components/CVRPointer/)
        * [CVR Spawnable](https://documentation.abinteractive.net/cck/components/CVRSpawnable/)
        * [CVR World](https://documentation.abinteractive.net/cck/components/CVRWorld/)
        * [Combat System](https://documentation.abinteractive.net/cck/components/CombatSystem/)
        * [Control Point](https://documentation.abinteractive.net/cck/components/ControlPoint/)
        * [Damage](https://documentation.abinteractive.net/cck/components/Damage/)
        * [Game Instance Controller](https://documentation.abinteractive.net/cck/components/GameInstanceController/)
        * [Gun Controller](https://documentation.abinteractive.net/cck/components/GunController/)
        * [Object Health](https://documentation.abinteractive.net/cck/components/ObjectHealth/)
        * [Score Board Controller](https://documentation.abinteractive.net/cck/components/ScoreBoardController/)
        ...
        * [CVR Blitter](https://documentation.abinteractive.net/cck/components/blitter/)
        * [CVR Custom Render Texture Updater](https://documentation.abinteractive.net/cck/components/custom-render-texture-updater/)
        * [CVR Distance Lod](https://documentation.abinteractive.net/cck/components/distance-lod/)
        * [CVR Face Tracking](https://documentation.abinteractive.net/cck/components/face-tracking/)
        * [CVR GI Material Updater](https://documentation.abinteractive.net/cck/components/gi-material-updater/)
        * [CVR Global Material Property Updater](https://documentation.abinteractive.net/cck/components/global-material-property-updater/)
        * [CVR Global Shader Updater](https://documentation.abinteractive.net/cck/components/global-shader-updater/)
        * [CVR Haptic Chest Area](https://documentation.abinteractive.net/cck/components/haptic-chest-area/)
        * [CVR Haptic Zone](https://documentation.abinteractive.net/cck/components/haptic-zone/)
        * [CVR Interactable](https://documentation.abinteractive.net/cck/components/interactable/)
        * [CVR Material Driver](https://documentation.abinteractive.net/cck/components/material-driver/)
        * [CVR Material Updater](https://documentation.abinteractive.net/cck/components/material-updater/)
        * [CVR Mirror](https://documentation.abinteractive.net/cck/components/mirror/)
        * [CVR Nav Controller](https://documentation.abinteractive.net/cck/components/nav-controller/)
        * [CVR Object Sync](https://documentation.abinteractive.net/cck/components/object-sync/)
        * [CVR Particle Sound](https://documentation.abinteractive.net/cck/components/particle-sound/)
        * [CVR Pickup Object](https://documentation.abinteractive.net/cck/components/pickup-object/)
        * [CVR Portal Marker](https://documentation.abinteractive.net/cck/components/portal-marker/)
        * [CVR Spawnable Trigger](https://documentation.abinteractive.net/cck/components/spawnable-trigger/)
        * [CVR Toggle State Trigger](https://documentation.abinteractive.net/cck/components/state-trigger/)
        * [CVR Texture Property Parser](https://documentation.abinteractive.net/cck/components/texture-property-parser/)
        * [CVR Variable Buffer](https://documentation.abinteractive.net/cck/components/variable-buffer/)
    ...
    * [ ] 
        ...
        * [ ] 
            ...
            * [r176ex4 -> r176ex5](https://documentation.abinteractive.net/cck/lua/changelog/r176ex4-r176ex5/)
...
Rules, guidelines & ToS[¶](#rules-guidelines-tos "Permanent link")
==================================================================

With registering an account in our community hub and / or playing our games you acknowledge and accept the followingly stated rules and guidelines to their fullest. We reserve full rights to include minor changes to the terms of service without requiring any sort of announcement. Bigger changes to the terms of service will be announced and users will be required to accept the changes in order to continue to use our services.

Alpha Blend Interactive Terms of Service[¶](#alpha-blend-interactive-terms-of-service "Permanent link")
-------------------------------------------------------------------------------------------------------
...
For missing or unclear points please contact us at [\[email protected\]](https://documentation.abinteractive.net/cdn-cgi/l/email-protection) - we will answer.

### 1 - Platform requirements[¶](#1-platform-requirements "Permanent link")
...
### 2 - Social Interactions[¶](#2-social-interactions "Permanent link")
...
### 3 - Impersonation[¶](#3-impersonation "Permanent link")
...
### 4 - Usage of our products and services[¶](#4-usage-of-our-products-and-services "Permanent link")
...
### 5 - Uploading and publishing content[¶](#5-uploading-and-publishing-content "Permanent link")
...
### 6 - Platform content creation[¶](#6-platform-content-creation "Permanent link")

> Generally, all content creation is permitted as long as the limits enforced by the ABI team are respected. These limits are mostly on the games side. You can find exceptions below. If there are any questions, you are free to contact us at [\[email protected\]](https://documentation.abinteractive.net/cdn-cgi/l/email-protection).
...
### 7 - Modding our games[¶](#7-modding-our-games "Permanent link")
...
### 8 - Account management[¶](#8-account-management "Permanent link")
...
### 9 - Third party applications or sites[¶](#9-third-party-applications-or-sites "Permanent link")
...
### 10 - Commercial usage[¶](#10-commercial-usage "Permanent link")
...
In order to request permission to use our products and services commercially, mail us at [\[email protected\]](https://documentation.abinteractive.net/cdn-cgi/l/email-protection), and we will get back to you as soon as we can.
