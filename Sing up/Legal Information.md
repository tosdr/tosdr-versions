...
### [The company](https://www.singup.org/privacy-policy)

We are Sing Up and we are the Data Controller, our correspondence address is Sing Up Limited, Gateshead International Business Centre, Mulgrave Terrace, Gateshead, NE8 1AN, United Kingdom. We can be contacted on +44 (0) 204 566 9666 or [\[email protected\]](https://www.singup.org/cdn-cgi/l/email-protection).

### [The purpose for processing your data and our basis for doing so](https://www.singup.org/privacy-policy)

When you register an account and access our platform, we process your personal data so we can provide you access to Sing Up, manage your account (including billing) and to maintain contact for service purposes. We also process personal data for the purposes of marketing, and usage data associated with your account, such as playlists, songs, and favourites.

The lawful basis we use to process this information is Article 6.1.f, legitimate interest. We have a legitimate interest in offering our services to our customers and the data we process is proportionate to the purpose and comprises name and contact / address details.

We record audio downloads and score unlocks to ensure royalties are paid. In addition, we will process your IP address to provide your regional geographical location. The lawful basis we use to process this information is Article 6.1.c, in compliance with a legal obligation under the UK’s Copyright legislation.

We use your data for the supply and shipping of items when you make a purchase from our online shop. We do this on the basis of Article 6.1.f - legitimate interest as we have a commercial interest in delivering our e-commerce.

If you upload your image into your account profile voluntarily, we will process that under the lawful basis of Article 6.1.a, consent. You can withdraw consent at any time by deleting your profile picture or contacting us. We do not require you to upload your image.

If you fail to provide the information that is required, we will be unable to provide our services to you.

### [Recipients of your data](https://www.singup.org/privacy-policy)
...
* Third party suppliers of items purchased via our e-commerce site or the Song Bank.

### [Data processed by third parties on our behalf](https://www.singup.org/privacy-policy)
...
### [Transferring your data outside of the UK](https://www.singup.org/privacy-policy)
...
### [Retention periods](https://www.singup.org/privacy-policy)

We will retain your data only for the time we require it for the purposes stated and / or where we have a legal obligation or other legitimate purpose. We will retain the personal data of our current customer contacts for 6 years for our accounting purposes. If you close your account, or when your account is closed after 2 years of inactivity, your personal data is anonymised on our system and only your purchase history (if available) is retained in an identifiable way until the 6 year deletion process takes place.

### [Your rights](https://www.singup.org/privacy-policy)
...
### [Children’s data and ‘Children’s Code’](https://www.singup.org/privacy-policy)

Please note, when we act as a Data Processor for student data, we process the minimum of children’s data to provide access to the platform. We have reviewed the Student Area of the Sing Up platform ([https://student.singup.org/](https://student.singup.org/)) and our processes against the requirements of the UK Information Commissioner’s Office Age Appropriate Design Code (Children’s Code) as it can be applied to data processors. We are satisfied that we comply with the standards set within this important code.

### [Your rights - Complaints](https://www.singup.org/privacy-policy)
...
##### [The company](https://www.singup.org/privacy-policy/#company "Opens internal link in same window")  
  
[The purpose for processing your data and our basis for doing so](https://www.singup.org/privacy-policy/#processing_purpose "Opens internal link in same window")  
  
[Recipients of your data](https://www.singup.org/privacy-policy/#data_recipients "Opens internal link in same window")  
  
[Data processed by third parties on our behalf](https://www.singup.org/privacy-policy/#data_processors "Opens internal link in same window")  
  
[Transferring your data outside of the UK](https://www.singup.org/privacy-policy/#locations "Opens internal link in same window")  
  
[Retention periods](https://www.singup.org/privacy-policy/#retention "Opens internal link in same window")  
  
[Your rights](https://www.singup.org/privacy-policy/#rights "Opens internal link in same window")  
  
[Children’s data and ‘Children’s Code’](https://www.singup.org/privacy-policy/#childrens_code "Opens internal link in same window")  
  
[Your rights - Complaints](https://www.singup.org/privacy-policy/#complaints "Opens internal link in same window")
