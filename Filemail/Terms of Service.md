...
Filemail has not reviewed all the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Filemail of the site. Use of any such linked web site is at the user's own risk.

7\. Site Terms of Use Modifications
-----------------------------------

Filemail may revise these terms of use for its web site at any time without notice. By using this web site, you are agreeing to be bound by the then current version of these Terms and Conditions of Use.

8\. Governing Law
-----------------

Any claim relating to Filemail's web site shall be governed by the laws of Norway without regard to its conflict of law provisions.
...
You have sole responsibility for all User Files that you store on Filemail servers through use of the Services. You acknowledge and agree that Filemail will not be responsible for any failure of the Services to store a User File, for the deletion of a User File stored on the server, or for the corruption of or loss of any data, information or content contained in a User File.

13\. Reliability
----------------

Filemail cannot guarantee the availability of our service. Even though we have almost no downtime, we cannot be held responsible for unavailability of our service.

14\. Changes in TOS
-------------------

Filemail reserves the right to revise its policies at any time without notice.

15\. Abuse
----------

Filemail reserves the right to charge any account $ an extra 1 year fee, if the account is being abused by sending out SPAM e-mails. E-mail address and IP will be banned from any further use. E-mail addresses and IP may be provided to offended parties - in cases of obvious abuse and/or cases of copyright infringement.
