...
For new contributors\[[edit](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit&section=1 "Edit section: For new contributors")\]
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Always [sign your posts](https://en.wikipedia.org/wiki/Wikipedia:Signatures "wikipedia:Wikipedia:Signatures") on talk pages by typing \~~~~ at the end or using the button in our editor toolbar.
...
Things that may have articles\[[edit](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit&section=5 "Edit section: Things that may have articles")\]
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Authors should not create articles about their own WADs or mods (see [this](https://doomwiki.org/wiki/Doom_Wiki:FAQ#Can_I_write_an_article_about_my_mod.3F "Doom Wiki:FAQ") for further information).
...
Style\[[edit](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit&section=14 "Edit section: Style")\]
--------------------------------------------------------------------------------------------------------------------------------------
...
### Quoting people and works\[[edit](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit&section=19 "Edit section: Quoting people and works")\]
...
* Do not use [contractions](https://doomwiki.org/wiki/Doom_Wiki:List_of_common_contractions "Doom Wiki:List of common contractions"). For example, instead of "once a chaingunner starts, they'll keep firing continuously", write "once a chaingunner starts, _they will_ keep firing continuously".
...
### Creating links\[[edit](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit&section=25 "Edit section: Creating links")\]
...
* Screen shots should be taken in software rendered mode, with settings resembling [vanilla Doom](https://doomwiki.org/wiki/Vanilla_Doom "Vanilla Doom") as closely as possible (unless the screen shot is for showing off a port specifically or belongs to an add-on that requires the use of such a source port).
...
Retrieved from "[https://doomwiki.org/w/index.php?title=Doom\_Wiki:Policies\_and\_guidelines&oldid=472391](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&oldid=472391)"
...
|     |     |
| --- | --- |
| * [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit)<br>    <br>    Improve DoomWiki.org by [editing this page](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=edit)<br>    <br>* [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/wiki/User:Fraggle)<br>    <br>    [Fraggle](https://doomwiki.org/wiki/User:Fraggle "User:Fraggle") made an edit on 27 August 2024<br>    <br>* ![](/w/skins/monaco/style/images/blank.gif)<br>    <br>    Content is available under [CC BY-SA 4.0 International](https://doomwiki.org/wiki/Doom_Wiki:Copyrights "Doom Wiki:Copyrights") unless otherwise noted. ([Terms of Use](https://doomwiki.org/wiki/Doom_Wiki:Terms_of_use)) | * [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=history)<br>    <br>    [History](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&action=history)<br>    <br>* [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/wiki/Special:RecentChangesLinked/Doom_Wiki:Policies_and_guidelines)<br>    <br>    [Related changes](https://doomwiki.org/wiki/Special:RecentChangesLinked/Doom_Wiki:Policies_and_guidelines)<br>    <br><br>* [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&oldid=472391)<br>    <br>    [Permanent link](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&oldid=472391)<br>    <br>* [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/wiki/Special:WhatLinksHere/Doom_Wiki:Policies_and_guidelines)<br>    <br>    [What links here](https://doomwiki.org/wiki/Special:WhatLinksHere/Doom_Wiki:Policies_and_guidelines)<br>    <br><br>* [![](/w/skins/monaco/style/images/blank.gif)](https://doomwiki.org/wiki/Special:Random)<br>    <br>    [View random page](https://doomwiki.org/wiki/Special:Random)<br>    <br>* ![](/w/skins/monaco/style/images/blank.gif)<br>    <br>    [Mobile view](https://doomwiki.org/w/index.php?title=Doom_Wiki:Policies_and_guidelines&mobileaction=toggle_view_mobile) |
