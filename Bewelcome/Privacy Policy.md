*  [![BeWelcome](/images/logo_index_top.png) ![BeWelcome](/images/logo_no_text.png)](https://bewelcome.org/)
* [Safety](#safety_menu)
    * [Safety Information](https://bewelcome.org/safety)
    * [Report problem with a member](https://bewelcome.org/feedback%3FIdCategory=2%26no)
* [About](#about_menu)
    * [About](https://bewelcome.org/about)
    * [FAQ](https://bewelcome.org/about/faq)
    * [Contact us](https://bewelcome.org/feedback)
    * [Statistics](https://bewelcome.org/about/stats)
    * [Terms of use](https://bewelcome.org/terms/en)
    * [Help BeWelcome](https://bewelcome.org/about/getactive)
    * [Donate](https://bewelcome.org/donations)
*  Username or email
    ...
    [Sign up](https://bewelcome.org/signup)
...
* Log in
    *  Username or email
         ...
         Log in Not a member yet? [Sign up](https://bewelcome.org/signup)
        

BeWelcome Privacy Policy
========================

This policy was last updated on 4 April 2020. ([French version](https://bewelcome.org/privacy/fr))
...
Site currently displayed in العربية (Arabic) Български (Bulgarian) Català (Catalan) čeština (Czech) dansk (Danish) Deutsch (German) Ελληνικά (Greek) English (English) Esperanto (Esperanto) Español (Spanish) Euskara (Basque) پارسی (Persian ) suomi (Finnish) Français (French) Galego (Galician ) हिन्दी; हिंदी (Hindi ) hrvatski (Croatian ) Magyar (Hungarian) Indonesian (Indonesian) italiano (Italian) 日本語 (Japanese) lietuvių (Lithuanian) latviešu (Latvian) Norsk bokmål (Norwegian Bokmål) Nederlands (Dutch) Norsk (Norwegian) polski (Polish) Português (Portuguese) Português (bra) (Portuguese (br)) rumantsch (Raeto-Romance ) română (Romanian) Русский (Russian) Slovenčina (Slovak ) Slovenščina (Slovenian) српски језик (Serbian ) Basa Sunda (Sundanese ) Kiswahili (Swahili ) Türkçe (Turkish) 中文(简体) (Chinese (Simplified)) 正體中文 (Chinese (Traditional))
...
© 2007 — 2024 [BeVolunteer](https://www.bevolunteer.org/) and contributors - _Running on open source [BW Rox](https://github.com/bewelcome/rox) rev. [23aae920e (s)](https://github.com/BeWelcome/rox/commit/23aae920e%20(s)) (2024-09-15 07:16:40)_