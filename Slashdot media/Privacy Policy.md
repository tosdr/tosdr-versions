...
We may disclose your Personal Data as described below, subject to the requirements of the Comprehensive Privacy Laws, such as lawful basis for processing under EU/UK/Swiss laws and opt out under U.S. Privacy Laws.
...
Privacy and data protection laws vary around the world and among the individual United States. Our obligations arising under the majority of the world’s privacy laws, including U.S. federal and most state laws, are identified by risk assessments that we conduct to ensure we act reasonably and responsibly when processing your Personal Data. In some jurisdictions, however, privacy laws grant you, the data subject, certain specific rights regarding your Personal Data. We refer to these types of privacy laws as **"Comprehensive Privacy Laws."** Examples of Comprehensive Privacy Laws include the European Union (**"EU GDPR"**), and United Kingdom's variant of the General Data Protection Regulation (**"UK GDPR"**) and Switzerland's data protection law based on GDPR (collectively, the **"GDPR"**), and the consumer privacy statutes of several U.S. states, such as California, Colorado, Utah, Virginia, and effective July 1, 2024, Texas (**"U.S. Privacy Laws"**). In other jurisdictions, such as Nevada, more narrow privacy laws have some features of Comprehensive Privacy Laws such as the right to opt-out of the sale of your Personal Data.

The nature and locations of our business activities make us subject to some, though not necessarily all, Comprehensive Privacy Laws. We are for instance, subject to the California Consumer Privacy Act, or **"CCPA"** and the GDPR, and effective July 1, 2024, the Texas Data Privacy and Security Act (**"TDPSA"**). As such, when we collect Personal Data from data subjects protected by the CCPA, TDPSA (once effective), or GDPR, we become subject to, and those data subjects have rights under, those Comprehensive Privacy Laws. This section of our Statement is used to explain your rights under those laws. For purposes of this section, the words **"you** and **"your** mean only California and Texas consumers (as defined by CCPA and TDPSA) and data subjects whose Personal Data was collected while they were in a GDPR jurisdiction.
...
### YOUR RIGHTS AND OUR OBLIGATIONS UNDER U.S. PRIVACY LAWS
...
As described more below, subject to meeting the requirements for a Verifiable Consumer Request (defined below) and limitations permitted by applicable U.S. Privacy Law, we provide individuals the privacy rights described in this section, as required by applicable U.S. Privacy Law. Although we have concluded that we are subject only to CCPA and TDPSA (when effective), we will accept requests from consumers under any of the U.S. Privacy Laws, and from residents in states without privacy rights, but will apply our discretion with respect to, and if and how, we process such requests. We will also consider applying state law rights prior to the effective date of such laws, but will do so in our discretion. If you exercise these rights, we will not discriminate against you by treating you differently from other individuals who use our Online and Mobile Resources or purchase our services but did not exercise their rights.

Under CCPA, a consumer includes persons in their capacity as our Workforce and Job Applicants, so accordingly this "Your U.S. State Privacy Rights" section also applies to them. It does not, however, apply to our Workforce or Job Applicants that are not current California residents.

* **Know –** California consumers have the right to request that we disclose to you, specifically beyond the general statement immediately above, the categories of Personal Data collected including the source of the data, our use of it and, if the data was disclosed or sold to third parties, the categories so disclosed or sold as well as the categories of third parties who received or purchased it. This is not applicable in Texas and we reserve the right to limit this to California consumers.
...
* **Opt Out –**You have the right to opt out of any sale, sharing, or targeted advertising of Personal Data (as defined in the CCPA and TDPSA) if such sale / sharing / targeted advertising occurs.
* * Under the CCPA, “share” means to disclose for cross-context behavioral advertising only, and not other forms of disclosure. “Sale” is also broadly defined and does not necessarily need to involve a payment.
...
You may use an authorized agent to make a request for you, subject to our verification of the agent, the agent’s authority to submit requests on your behalf, and of you. Once your agent’s authority is confirmed, they may exercise rights on your behalf subject to the agency requirements of applicable U.S. Privacy Laws. Agents can request authorization using our [Authorized Agent Request Form.](https://privacyportal.onetrust.com/webform/611e70e2-1994-43ff-b07b-646df870db4b/draft/018c2f47-e5c6-444a-98b3-7074b41f069a)
...
* [♦ Your Rights and Our Obligations under U.S. Privacy Laws](#CCPA)
...
* [♦ Your U.S. State Privacy Rights](#rightsToKnow)
