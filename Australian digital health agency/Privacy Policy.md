...
* Open/Close Menu [Newsroom](https://www.digitalhealth.gov.au/newsroom)
    * [Media releases](https://www.digitalhealth.gov.au/newsroom/media-releases)
    * [Podcasts](https://www.digitalhealth.gov.au/newsroom/podcasts)
    * [Newsletters](https://www.digitalhealth.gov.au/newsroom/newsletters "Find the latest information, news and insights on digital health in our newsletter series.")
...
* Open/Close Menu [Support](https://www.digitalhealth.gov.au/support "Support")
    ...
    * [Subscribe](https://www.digitalhealth.gov.au/support/subscribe)
...
* Open/Close Menu[Policies, privacy and reporting](https://www.digitalhealth.gov.au/about-us/policies-privacy-and-reporting)
    ...
    * [ANAO Performance Audit Implementation Plan Publication](https://www.digitalhealth.gov.au/about-us/policies-privacy-and-reporting/anao-performance-audit-implementation-plan-publication)
...
On this page: [Agency Privacy Policy](#agency-privacy-policy) | [My Health Record Privacy Policy](#mhr-privacy-policy)
...
More information can be found in our [Agency Privacy Policy](#agency-privacy-policy) (below) and our [My Health Record Privacy Policy](#mhr-privacy-policy) (below).
...
As a Commonwealth entity, we must have a Privacy Policy outlining how we handle personal information in accordance with the Australian Privacy Principles (APPs) in the _Privacy Act 1988_ (Cth).

This policy sets out how we collect, use, and disclose personal information to carry out our functions under the _Public Governance, Performance and Accountability (Establishing the Australian Digital Health Agency) Rule 2016_. This includes our functions as the System Operator for the My Health Record system.
...
* Microsoft Teams to collaborate with our stakeholders. We may collect the name you provide Microsoft if you attend a meeting through Microsoft Teams. This information helps us to know who is attending and how long they attended. You can view [Microsoft’s privacy policy here](https://privacy.microsoft.com/en-US/privacystatement).
* JobAdder to store and manage your personal information to assist with our recruitment activities for potential employees. You can access [JobAdder’s privacy policy here](http://www.jobadder.com/au/privacy).
* Recruiting platforms including Seek and the APS Gazette for job advertisements and applications. You can access [Seek’s privacy policy here](https://www.seek.com.au/privacy/) and the [APS Gazette’s privacy policy here](https://www.apsjobs.gov.au/s/privacy-statement).
* We may use Xref to conduct reference checks with referees whose details you provide to us. Xref will collect personal information about you from your nominated referee(s) and disclose this to us to consider and facilitate your application for employment. You can access [Xref’s privacy policy here](http://www.xref.com/en/privacy-policy/).
* Survey Manager to collect feedback about us or the services that we provide. These surveys may collect personal information if provided in an individual’s response. You can view [Survey Manager’s privacy policy here](https://www.surveymanager.com.au/privacy-policy/).

### Social Networking

We use social networking services such as Twitter, Facebook, LinkedIn, and YouTube to communicate with the public about our work. When you communicate with us using these services we may collect your personal information, but we only use it to help us to communicate with you and the public. The social networking service will also handle your personal information for its own purposes. These services have their own privacy policies. You can access the privacy policies for [Twitter](https://twitter.com/en/privacy), [Facebook](https://www.facebook.com/privacy/policy?section_id=0-WhatIsThePrivacy), [LinkedIn](https://www.linkedin.com/legal/privacy-policy?trk=homepage-basic_footer-privacy-policy) and [YouTube](https://policies.google.com/privacy?hl=en) (a Google company) on their websites.
...
You also have the right under the FOI Act to request access to documents that we hold and ask for information that we hold about you to be changed or annotated if it is incomplete, incorrect, out-of-date, or misleading. For further information see the [Freedom of Information](https://www.digitalhealth.gov.au/about-us/policies-privacy-and-reporting/freedom-of-information-foi) page on our website or see our contact details below.

### How to make a complaint

If you wish to complain to us about how we have handled your personal information you should first complain to us in writing by sending your enquiry or complaint to our postal address (see below) or by email to [\[email protected\]](https://www.digitalhealth.gov.au/cdn-cgi/l/email-protection). Please address your correspondence to ‘The Privacy Officer’. If you need help lodging a complaint, you can contact us - see ‘How to contact us’ below.
...
We will assess and handle complaints about the conduct of Agency staff using the [APS Values](https://www.apsc.gov.au/working-aps/information-aps-employment/aps-values) and [Code of Conduct](https://www.apsc.gov.au/working-aps/integrity/integrity-resources/code-of-conduct) and the guidelines issued by the [Australian Public Service Commission](https://www.apsc.gov.au/).

We will tell you promptly that we have received your complaint and then respond to the complaint within 30 days.

If you are dissatisfied with the outcome of the complaint or the way in which the complaint was handled, you may contact the [Office of the Australian Information Commissioner](https://www.oaic.gov.au/) for advice about your complaint.

### Contact us

You can contact us by:

**Website:** Our [online contact form](https://www.digitalhealth.gov.au/support/contact-us)

**Telephone:** 1300 901 001, 8am - 5pm (AEST/AEDT), Monday - Friday

**Email:** [\[email protected\]](https://www.digitalhealth.gov.au/cdn-cgi/l/email-protection)
...
This policy explains how the Australian Digital Health Agency (the Agency), as System Operator under the _My Health Records Act 2012_ (Cth), collects, uses, and discloses personal information to operate and manage the My Health Record system.

This information is handled subject to the My Health Records Act, _Healthcare Identifiers Act 2010_ (Cth), and _Privacy Act 1988_ (Cth). This policy is published in accordance with Australian Privacy Principles (APPs) in Schedule 1 of the Privacy Act.
...
Technical terms, such as 'System Operator', are explained in our [glossary](https://www.digitalhealth.gov.au/support/glossary). If you have any questions about the terms used in this policy, please contact us using the contact details at the end of this policy.
...
* authorised by the _Auditor-General Act 1997_ (Cth) or the _Ombudsman Act 1976_ (Cth)
...
Part 7 of the My Health Records Act established the role of the Data Governance Board (the Board). The Board oversees the operation of the secondary use governance framework as outlined in the [_Framework to guide the Secondary Use of My Health Record system data_](https://www1.health.gov.au/internet/main/publishing.nsf/Content/eHealth-framework).
...
**Website:** See our [online contact form](https://www.digitalhealth.gov.au/support/contact-us)
...
© 2024 Australian Digital Health Agency
