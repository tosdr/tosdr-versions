...
We employ the use of cookies. By using PreMiD's website you consent to the [use of cookies](https://premid.app/cookies) in accordance with [PreMiD's privacy policy](https://premid.app/privacy).
...
Unless otherwise stated, PreMiD and/or it's licensors own the intellectual property rights for all material on PreMiD. All intellectual property rights are reserved. You may view and/or copy code from [PreMiD](https://github.com/premid) for your own personal use subject to restrictions set in these terms of service.

You must not:

1. Sub-license material

You have to:

1. Make your source code open-source when you distribute something
2. Copyright notice us
3. Add the **same** license as we did

Redistribute content from PreMiD (unless content is specifically made for redistribution).

Our website is licensed under the MPL-2.0 license. [Visit its page](https://opensource.org/licenses/MPL-2.0) for more information.
...
This Terms and conditions page was created with the help at [termsandconditionstemplate.com](https://termsandconditionstemplate.com/) generator. If you have any queries regarding any of our terms, please contact us.
