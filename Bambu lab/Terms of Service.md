[![](/assets/logo.svg)](https://bambulab.com/en)
...
[Terms of Use](https://bambulab.com/en/policies/terms)

[Cookie Policy](https://bambulab.com/en/policies/cookie-policy)
...
If you are located in United States, “Bambu Lab” refers to “Bambulab USA Inc”.

If you are located in China, “Bambu Lab” refers to “上海轮廓科技有限公司”（Shanghai Lunkuo Technology Co., Ltd.）and “深圳拓竹科技有限公司”(Shenzhen Tuozhu Technology Co., Ltd. ).

If you are located in Europe, “Bambu Lab” refers to “Bambulab GmbH”.

If you are located in Japan, “Bambu Lab” refers to “Bambu Japan 株式会社”.
...
1.2 The Software under these Terms shall be bound by it, whether it is stored in a read-only memory or any other media or form or it is from an online download location authorized by Bambu Lab, unless otherwise agreed upon.

**End User Software Licence**

You are granted a limited and non-exclusive licence to access and use this software (as defined in Section 1.1) on only one Bambu Lab device, subject to, and in accordance with the terms and conditions of these Terms. The software cannot be sold, transferred, or used for any other commercial purposes.
...
3.3 You may not sell, rent, lease, lend, sublicence or distribute the entirety or part of the Software to any third party without prior written permission from Bambu Lab. Nonetheless, you may make a one-off permanent transfer of the entire licence to the Software to another party along with the transfer of ownership of your Bambu Lab device, provided that: (1) the transfer must include your Bambu Lab device and all the Bambu Lab Software; and (2) you do not retain all or part of the Software copies; and (3) the party that receives the Bambu Lab device and Software has read and accepted all the terms and conditions of these Terms.
...
Bambu Lab and its licensors own and retain all rights and titles to the visual interfaces, graphics, design, firmware, software, services, and all other elements of the Product and reserve any other rights not expressly granted to you by these Terms.

**Privacy Policy**

Bambu Lab Privacy Policy (the "Privacy Policy") provides information about the data that Bambu Lab collects and the ways in which this data is used by Bambu Lab. For use of the Product , Bambu Lab will collect data from your device in accordance with the provisions of these Terms and the Privacy Policy. You may refer to the details of the Privacy Policy at: [https://bambulab.com/policies/privacy.](https://bambulab.com/en/policies/privacy)

**Consent to Use of Data**

6.1 WHERE YOU CHOOSE TO HELP BAMBU LAB IMPROVE ITS PRODUCTS AND SERVICES, BAMBU LAB AND ITS AFFILIATES/LICENSORS MAY COLLECT DATA FROM YOUR DEVICE FOR ANALYSIS. COLLECTED DATA INCLUDES YOUR DEVICE CONFIGURATION DATA, APP STATISTICAL DATA, AND ERROR LOG DATA. ALL DATA IS ANONYMISED BEFORE BEING COLLECTED AND PROCESSED.

6.2 BAMBU LAB ENSURES THAT A SIMILAR AND ADEQUATE LEVEL OF PROTECTION IS AFFORDED TO YOUR DATA AS REQUIRED BY ALL APPLICABLE LAWS AND REGULATIONS. DATA COLLECTED FROM YOUR PRODUCT DURING USE MAY BE PROCESSED OR TRANSFERRED TO BAMBU LAB AND ITS AFFILIATES/LICENSORS IN COUNTRIES OUTSIDE OF THE COUNTRY YOU RESIDE. THIS MEANS THE DATA MAY BE TRANSFERRED TO OR ACCESSED FROM OTHER JURISDICTIONS WHICH ARE OUTSIDE OF THE COUNTRY WHERE YOU USE BAMBU LAB'S PRODUCTS OR SERVICES. THESE JURISDICTIONS MAY HAVE DIFFERENT DATA PROTECTION LAWS, OR SUCH LAWS MAY NOT EVEN EXIST.

6.3 BAMBU LAB ONLY RETAINS YOUR DATA FOR THE PERIOD NECESSARY TO FULFIL THE PURPOSES OUTLINED IN THESE TERMS AND THE PRIVACY POLICY, UNLESS A LONGER RETENTION PERIOD IS REQUIRED OR PERMITTED BY LAW. WHILE BAMBU LAB TAKES ALL APPROPRIATE TECHNICAL AND ORGANISATIONAL STEPS TO PREVENT UNAUTHORISED ACCESS TO OR DISCLOSURE OF YOUR DATA, PLEASE NOTE THAT NO SECURITY MEASURES ARE COMPLETELY INFALLIBLE.
...
8.1 The Product enables you to access Bambu Lab and third-party apps and services (individually and collectively referred to as "services") that come with the Product. However, some apps and services may not be available in all languages or in all regions. In addition, you acknowledge and agree that some of the features of the Product may not be available on some products depending on the hardware and data access.

8.2 To ensure and enhance your user experience, the Product provides you with a large number of services. The specific services of the Product are provided by Bambu Lab and its affiliated companies/licensors according to the actual situation. Bambu Lab and its affiliated companies/licensors reserve the right to change the contents of the services at any time.

Bambu Lab Product services statement:
...
Model recommendation: Model recommendation is a service that recommends models stored in the Bambu cloud for you. When you connect to the Wi Fi network, the model content will be recommended to you. The model content will vary according to the country / region where your login account is located. You can choose to accept or reject this service. This service may not be available in all countries and languages.

Heath Management System: Health management system is a service for you to automatically diagnose the health status of your device. You may get notified or actively check the current working status of various parts of the device through the health management system, and view the solutions in case of problems. However, you understand that due to technical limitations and other reasons, Bambu Lab cannot guarantee that the above related functions can completely and accurately detect all problems.

Print Failure Detection: Print result detection is a service that automatically detects the problems during printing, including the first layer inspection, spaghetti failure detection and automatic skipping of failed parts. Using these services, the device will prompt warning messages when there is a problem in printing, or accurately skip individual failed parts, or automatically stop printing when there is a serious problem. Some functions of print failure detection (such as spaghetti failure detection) depend on specific hardware configuration, so only bamboo devices equipped with relevant hardware can support it. In addition, you understand that due to technical limitations and other reasons, Bambu Lab cannot guarantee that the above related functions can be completely and accurately detected, and there may be a risk of false detection under special circumstances.
...
You may not use or otherwise export or re-export Bambu Lab Product except as authorized by applicable laws and the laws of the jurisdictions in which the Bambu Lab Software was obtained.
...
The validation, interpretation, modification, fulfilment, and dispute settlement of these Terms are governed by the laws of the People's Republic of China. If any dispute arises concerning the content or performance of these Terms, the dispute shall be settled through friendly negotiation. In the event that the dispute cannot be settled through negotiation, either party could submit the dispute to China International Economic and Trade Arbitration Commission (CIETAC) for arbitration which shall be conducted in accordance with the CIETAC's arbitration rules in effect at the time of applying for arbitration. The arbitral tribunal shall consist of three (3) arbitrators. Bambu Lab and you shall be entitled to appoint one arbitrator, and the third arbitrator shall be jointly appointed by CIETAC. The language of the arbitration is English and is conducted in Shanghai, China. All arbitrators must be proficient in English. The arbitral award is final and binding upon both Bambu Lab and you.
...
By signing up, you agree to Bambu Lab’s [Privacy Policy](https://bambulab.com/en/policies/privacy) and [Terms of use](https://bambulab.com/en/policies/terms).
...
[Authorized Reseller](https://bambulab.com/en/dealer)[Partner With Us](https://bambulab.com/en/partner-with-us)

[Privacy Policy](https://bambulab.com/en/policies/privacy)

[Terms of Use](https://bambulab.com/en/policies/terms)

[Warranty](https://bambulab.com/en/policies/warranty)

[Cookie Policy](https://bambulab.com/en/policies/cookie-policy)

[Cookie Settings](https://bambulab.com/en/policies/terms#)
