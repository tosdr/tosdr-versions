...
This policy is incomplete (it does not yet cover all the infrastructure of the Parrot Project), we hope to finish it shortly.
...
We have never received a warrant since we began this project. Please note our [warrant canary](https://parrotsec.org/warrant/).
...
There is a tiny log buffer that hosts the latest service hits for technical purposes, allowing the system to identify and automatically ban ip addresses abusing the service. The temporary log is just a buffer that keeps a bunch of recent elements, and old entries disappear automatically as new requests come in. It is the standard behavior of the DNS resolver we use (PowerDNS).
...
[Documentation](https://parrotsec.org/docs/)[Community](https://parrotsec.org/community/)[Blog](https://parrotsec.org/blog/)

About Us

[Team](https://parrotsec.org/team/)[Partners](https://parrotsec.org/partners/)[Donate](https://parrotsec.org/donate/)[Careers](https://parrotsec.org/careers/)

Social

[Facebook](https://www.facebook.com/ParrotSec/)[Twitter](https://twitter.com/parrotsec)[Instagram](https://www.instagram.com/parrotproject/)[Discord](https://discord.gg/j7QTaCzAsm)[Telegram](https://t.me/parrotsecgroup)[LinkedIn](https://www.linkedin.com/company/parrotsec/about/)

Carbon Neutral

Dark

© 2024 Parrot Security. All rights reserved.

[Warrant Canary](https://parrotsec.org/warrant/)[Privacy Policy](https://parrotsec.org/privacy/)