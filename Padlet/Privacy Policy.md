...
* [Home](https://padlet.com/)
* [Terms](https://padlet.com/terms)
* [Privacy Policy](https://padlet.com/privacy)
* [Content Policy](https://padlet.com/content)
* [Security](https://padlet.com/security)
* [Accessibility](https://padlet.com/accessibility)
* [Trademark Guidelines](https://padlet.com/trademark)
* [Data Processing Addendum](https://padlet.com/dpa)
* [Sub-processors](https://padlet.com/subprocessors)

[](https://padlet.com/)

* [Home](https://padlet.com/)

* [Terms Overview of the terms that govern your usage of Padlet Service](https://padlet.com/terms)

* [Privacy Policy How we use the data we collect, and the rights that you have with respect to your personal data](https://padlet.com/privacy)

* [Content Policy Explains what can and cannot be posted on Padlet](https://padlet.com/content)

* [Security How we keep your data safe from prying eyes](https://padlet.com/security)

* [Accessibility Explains how accessible Padlet is](https://padlet.com/accessibility)

* [Trademark Guidelines Do’s and dont’s around the usage of Padlet’s branding](https://padlet.com/trademark)

* [Data Processing Addendum The terms that apply when Padlet acts as a processor under the GDPR, including SCCs](https://padlet.com/dpa)

* [Sub-processors List of our sub-processors under GDPR, and notifications if or when we add a new sub-processor](https://padlet.com/subprocessors)

* [Overview](#overview)
* [Information you give us](#information-you-give-us)
* [Information We Track Automatically](#information-we-track-automatically)
* [How Long We Retain Information](#how-long-we-retain-information)
* [Whom Do We Share the Collected Information With?](#whom-do-we-share-the-collected-information-with)
* [How We Secure Information](#how-we-secure-information)
...
_Private_: Only registered Padlet users invited to the padlet can view content.

_Password protected_: People who have the password to the padlet can also view content.

_Secret_: People who have the link to the padlet can view content.

_Members only_ (only available in Personal plans): People who are logged in to Padlet can view content.

_Public_ (only available in Personal plans): Your content is public on the internet.

_Org wide_ (Only available in Schools and Business plans): People in the same school or company can view content.
...
These service providers may be located inside or outside of the European Economic Area (“EEA”). We maintain the list of providers [here](https://padlet.com/subprocessors).
...
### Information Disclosed to Fulfill Legal Obligations
...
The security of your personal information is important to us. We maintain administrative, technical and physical safeguards to protect against loss, theft, unauthorized use, disclosure, or retrieval of personal information. You can check out [our security page](https://padlet.com/security) for more details.
...
You may delete your Account at any time. You can do so from your Account Settings page on the Site or the App or by sending us a request using our [support page](https://padlet.com/contact-us). If you email us, we may require sufficient identifying information to be able to determine that you own the account.
...
You may, under certain conditions, invoke binding arbitration for complaints regarding DPF compliance not resolved by any of the other DPF mechanisms. Please review [Annex I of the DPF](https://www.dataprivacyframework.gov/framework-article/ANNEX-I-introduction) for additional information.
