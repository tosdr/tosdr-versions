[![WishList](https://d2h7q74hv1e614.cloudfront.net/assets/v21/img/WishListLogo2019.png?srcv=202410141047)](https://www.wishlist.com/home)

[![WishList](https://d2h7q74hv1e614.cloudfront.net/assets/v21/img/WishListLogo2019.png?srcv=202410141047)![WishList](https://d2h7q74hv1e614.cloudfront.net/assets/v21/img/WishListIcon-48.png?srcv=202410141047)](https://www.wishlist.com/home)

* Close

Terms of Use for www.wishlist.com
---------------------------------
...
These are the Terms of Use (the “Terms”) for using and accessing our websites, platform, software, content, products, applications (mobile or otherwise), social media accounts, forums, or other services (collectively, the “Site”, or “Services”) provided by Wish-List, Inc. and its affiliated companies (hereinafter “WishList “Company,” “We,” or “Us”).
...
Our Services adhere to export control and economic sanctions laws and regulations enforced by the United States, particularly by the Department of Commerce, the Office of Foreign Assets Control (OFAC) of the Department of the Treasury, the Department of State, among other U.S. authorities (collectively referred to as “U.S. Trade Regulations”). You are not permitted to employ the Services for exporting or reexporting, or to allow the exporting or reexporting, of software or technical data in violation of U.S. Trade Regulations. Moreover, by using the Services, you confirm and warrant that you are not: (a) an individual, organization, or entity based in or constituted under the laws of any country or territory subject to OFAC sanctions (specifically including Cuba, Iran, Syria, North Korea, or the Crimea, Donetsk, and Luhansk regions of Ukraine); (b) designated as a Specially Designated National or Blocked Person by OFAC, or associated with such a person; (c) a party prohibited under U.S. Trade Regulations; or (d) involved in activities concerning nuclear, missile, chemical, or biological weaponry that are restricted for U.S. persons without authorization from the U.S. Government.

Additionally, unless explicitly authorized in writing, we do not support the registration or use of our Services in connection with any Country-Code Top Level Domain Name (“ccTLD”) from countries or territories under OFAC sanctions. These obligations persist beyond the termination or expiration of this agreement or your use of the services.

2.       ACCESS AND USE OF SITE.
...
3.       SUBSCRIPTIONS & AUTOMATIC RENEWALS.

WishList Premium Services come with a yearly subscription that renews automatically every year. This applies to all paid services.

The subscription will automatically renew on the next term, but if you want to, you can disable the automatic renewal at any time after the purchase right from the Account Settings page, so you will not be charged next year.

Please, note the following details regarding WishList Subscriptions:

* Subscription renewals are automatically processed annually on the same date of your first purchase. The subscription renewal will continue and remain valid for each one (1) year unless the subscription is canceled before the renewal date.
* You may cancel your subscription at any time from your Account page on the WishList website. If you choose to cancel your subscription, starting from the moment your subscription expires you will no longer have access to WishLists Premium Service.

We cannot grant refunds on renewal payments. We will send you an email 1 month prior to the renewal date, and you may use this opportunity to cancel your subscription before the renewal payment is automatically processed.

If you choose to cancel your subscription, your subscription will expire exactly on the same day and month of the original purchase, and you will no longer have access to WishLists Premium Service.

You may not provide direct, or indirect access to our content or downloads, resell, share, or publish WishList subscription credentials or access. Do not infringe any intellectual property rights (e.g., copyright, trademark, patent, or other proprietary rights).

We reserve the right to refuse service or cancel your subscription and revoke access to WishList Premium Service for any reason we deem appropriate.

4\. PAYMENTS

All payments are handled using PayPal or Stripe.

5\. PRICE CHANGES

WishList will provide notice to the customer of any changes, detailing the specific rationale for the change, at least one (1) month prior to the change taking effect. The customer then has the right to end the subscription without any penalties or prejudice to other commitments made by the customer.

Should a month pass without any response from the customer, it will be assumed that the customer has accepted the new terms.

6.       OUR PRIVACY POLICY. To provide the Site, we must collect and use your personal data. We detail our practices in the Privacy Policy, which you must agree to in order to use our Site. We also encourage you to review the privacy choices you have in your settings.
...
12.    NOT A BROKER.  We are an administrative website only. We do not sell or facilitate the selling of securities. We are not a broker, financial institution, or a creditor.
...
* [About WishList.com](https://www.wishlist.com/aboutWishList)
* [FAQ](https://www.wishlist.com/ideas/faq)
...
Copyrights © 2024 All Rights Reserved by WishList.com
