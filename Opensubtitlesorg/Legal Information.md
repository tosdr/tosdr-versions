...
Text on this page **is not and will not be translated**
...
The creator of OpenSubtitles.org ("this website") takes no responsibility or liability for anything that happens as a result of reading or downloading anything on this website or anything contained in subsequent pages. These documents may not be freely distributed, but may be used and distributed for non-commercial, scientific and educational purposes. Commercial use of the documents available from this website is protected under the U.S. and Foreign Copyright Laws.
...
* OpenSubtitles.org Service - websites found under a common address www.opensubtitles.org
...
* Service is informative.
* Use of the service is free of charge.
* Service does not provide to any third party emails and other data received from his users.
* Service contacts with registered users via emails. Each sent message is considered delivered.
...
* As part of the above services, the Newsletter may be sent by OpenSubtitles in a cyclical manner.
...
* Newsletter includes the current offer of trade and commercial information about the operations and events on the OpenSubtitles network and its partners.
...
[New subtitles](https://www.opensubtitles.org/en/search/sublanguageid-all "subtitles")[A](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-a "subtitles - a")[B](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-b "subtitles - b")[C](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-c "subtitles - c")[D](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-d "subtitles - d")[E](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-e "subtitles - e")[F](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-f "subtitles - f")[G](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-g "subtitles - g")[H](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-h "subtitles - h")[I](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-i "subtitles - i")[J](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-j "subtitles - j")[K](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-k "subtitles - k")[L](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-l "subtitles - l")[M](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-m "subtitles - m")[N](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-n "subtitles - n")[O](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-o "subtitles - o")[P](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-p "subtitles - p")[Q](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-q "subtitles - q")[R](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-r "subtitles - r")[S](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-s "subtitles - s")[T](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-t "subtitles - t")[U](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-u "subtitles - u")[V](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-v "subtitles - v")[W](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-w "subtitles - w")[X](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-x "subtitles - x")[Y](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-y "subtitles - y")[Z](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-z "subtitles - z")[#](https://www.opensubtitles.org/en/search/sublanguageid-all/moviename-%23 "subtitles - %23")
...
| remember me |     |     |
|     |     |     |
| [Forgotten password](https://www.opensubtitles.org/en/login/redirect-\|en\|disclaimer/a-rp "Forgotten password") \| [Register](https://www.opensubtitles.org/en/newuser) |     |     |

[![](https://toplist.cz/dot.asp?id=216254)](https://www.toplist.cz/)

[](https://www.opensubtitles.org/libs/temp/clickheretobebanned.php)