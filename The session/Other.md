...
Here are some [house rules](#houserules) and [frequently asked questions](#faqs). You can also [read the privacy policy](https://thesession.org/privacy). If you’re a developer, you can check out [the API](https://thesession.org/api).

If you want, you can [install The Session app](https://thesession.org/app).
...
Please don’t post meta-discussions i.e. discussions about discussions, or discussions about the running of this site. [Get in touch](https://thesession.org/contact) with me ([Jeremy](https://thesession.org/members/1)) instead.
...
When you [sign up](https://thesession.org/signup) to become a member, you will be asked to give your name and email address, and choose a password.
...
To have a password reset link sent to you, go to the [log-in page](https://thesession.org/login) and click on the [forgotten your password?](https://thesession.org/forgottenpassword) link. Enter the email address you used to sign up with.
...
Sure. You can [log in](https://thesession.org/login) and go to your member profile. You will see options there for changing any of your details.
...
First of all, make sure that the tune isn’t already listed by doing a [search](https://thesession.org/tunes/search). If the tune is already listed, you can [log in](https://thesession.org/login) and add your setting to the existing listing.

If the tune isn’t yet listed, [log in](https://thesession.org/login) and click on the [Add a tune](https://thesession.org/tunes/add) button in the tunes section. Then follow the on-screen instructions. You’ll need to submit the tune in ABC notation.

### What’s ABC notation?

ABC is a great way of passing on tunes by writing the notes out in plain text.

It's very straightforward and easy to learn. You can find out more on [the ABC notation site](http://abcnotation.com/).

You should test your ABC notation before submitting a tune setting. Here’s [an ABC editor](https://thesession.org/tunes/editor) you can use to see how your notation will look as sheet music (and you can download the ABC file too).

### Can I submit an alternate setting of a tune that’s already listed?

Yes. [Log in](https://thesession.org/login). Go to the tune and click on the “Add a setting” button.
...
To add a tune to your tunebook, [log in](https://thesession.org/login), go to the tune in question and click on the “Add to tunebook” button.

### How can I correct inaccurate sessions, events or recordings?

Every member of The Session can edit the details of sessions, events, recordings and tunes, regardless of who first submitted it. If you see an inaccurate or incomplete listing, go ahead and edit it. You’ll need to [log in](https://thesession.org/login) first.

### A session is no longer active. How do I delete it?

You don’t. Instead, [log in](https://thesession.org/login) and add a comment explaining that the session is no longer active. Also, update the schedule so that no days are selected.
...
Yes, you can [install The Session](https://thesession.org/app) on your mobile phone.
...
You can ask your question in the [Discussions](https://thesession.org/discussions) section of the site. Other members of The Session can then answer your question. This is probably the best place to post questions about the music or ABC problems.
...
[back to top](#top) [Log in](https://thesession.org/login?redirect=%2Fhelp)