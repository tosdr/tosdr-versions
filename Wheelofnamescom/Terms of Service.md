![logo](/images/logo-dark-background-38.png)
...
![blank wheel](/images/gray-wheel.jpeg)

The page is slow to load and there may have been an error. To fix it, please refresh the page.

1. Windows, Linux or Chromebook: press **Ctrl F5**.
2. Mac computer:
    * Safari: press **Option Command E** and then **Command R**.
    * Other browsers: press **Command Shift R**.
3. Phone or tablet: swipe down from the top of the page.

If this doesn't work, try going to [old.wheelofnames.com](https://old.wheelofnames.com/).

* * *

![](/icons/favicon-32x32.png) What is the wheel spinner for?

Every day we hear from people who use our website in new ways:

* Random name picker in the classroom: pick which student will answer the next question. [How to use it in the classroom](https://wheelofnames.com/how-to-use-in-the-classroom)
...
![](/icons/favicon-32x32.png) Does it use renewable energy?
...
[Sustainability](https://wheelofnames.com/faq/sustainability)

![](/icons/favicon-32x32.png) How to use the wheel spinner
...
[Video reviews and tutorials by users](https://wheelofnames.com/user-reviews-and-tutorials)

![](/icons/favicon-32x32.png) Activity in 2024
...
![](/icons/favicon-32x32.png) Is my data private?
...
[How we safeguard your privacy](https://wheelofnames.com/privacy-policy.html)

![](/icons/favicon-32x32.png) Can the wheel be rigged?
...
[Randomness of the wheel](https://wheelofnames.com/faq/randomness)