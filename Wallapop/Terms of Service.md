...
* [ES](https://about.wallapop.com/condiciones-de-uso/ "Español")
* [EN](https://about.wallapop.com/en/legal-terms-and-conditions/ "English")
* [IT](https://about.wallapop.com/it/termini-e-condizioni-duso-di-wallapop/ "Italiano")
* [PT-PT](https://about.wallapop.com/pt-pt/termos-e-condicoes-legais/ "Português")
...
* “**Buyer**“: means any User who purchases or wishes to purchase one or more Products on the Platform.
...
* the [Community Guidelines](https://ayuda.wallapop.com/hc/en-us/articles/360019800078-Community-Guidelines) (including all Policies mentioned and linked to them).
...
3. Not to disseminate, transmit or make available to third parties any type of information, element or content that constitutes unlawful or unfair advertising.
4. Do not transmit unsolicited or unauthorized advertising, promotional materials, “junk mail,” “chain letters,” “pyramid schemes,” or any other form of solicitation, except in those areas (such as commercial spaces) that have been exclusively designed for that purpose.
5. Not to introduce or disseminate any false, misleading, ambiguous or inaccurate information and content in a way that misleads or is likely to mislead the recipients of the information.
6. Not to impersonate other Users of the Service or transmit the account access data or password to a third party without Wallapop’s consent.
7. Not to disseminate, transmit or make available to third parties any type of information, element or content without the authorization of the holders of the intellectual and industrial property rights that may apply to such information, element or content.
...
9. Not to disseminate, transmit or make available to third parties photographs or any representation or image of minors.
10. Do not publish advertisements for products that require a prescription or that must be dispensed under the supervision of a physician (doctor, dentist, optometrist, optician, pharmacist or veterinarian), as well as products that may influence the health of the individual (that present contraindications, interactions, etc.) and perishables of any kind.
11. To have a sanitary operating authorization to publish advertisements related to any health activity (need to present the registration number or registration number of the center).
...
3. It is not allowed to advertise pyramid schemes or similar.
4. Only one property may be advertised per advertisement. In such a case, the property must be advertised in the locality in which it is located.
5. It is not allowed to publish images or descriptions that do not correspond to the Product actually offered.
6. It is not allowed to publish images of minors.
...
1. The evaluations must be objective, truthful and refer to the Product purchased or to the User with whom the transaction has been carried out.
2. It is not permitted to publish ratings that are defamatory, insulting, obscene, offensive, violent or similar.
3. It is not allowed to publish ratings containing personal, sensitive or any other personal or confidential information.
4. It is not permitted to publish ratings for promotional or advertising purposes,
...
**4.6.-** Wallapop also makes available to the User and non-Users an electronic mechanism that allows them to notify the presence of potentially illegal content on the Platform. For more information on how this process works, as well as to access the form, please [click here](https://ayuda.wallapop.com/hc/en-us/articles/23097285718161-Report-illegal-content-at-Wallapop).
...
1. The use made by the Users of the Service nor for the state, origin, possible inaccuracy, or possible falsity of the data provided by the Users nor of the Products offered through the Service.
2. The contents, information, opinions and statements of any User or third parties or entities that are communicated or displayed through the Service (including the sending of images through the chat).
3. The use that Users may make of the materials of the Service, whether prohibited or permitted, in violation of intellectual and/or industrial property rights, confidential information, of the contents of the Service or of third parties.
4. The performance of acts of unfair competition and unlawful advertising.
5. The possible loss of Users’ data due to causes not attributable to the Service.
6. Access by minors to the contents included in the Service.
7. The unavailability, errors, access failures and lack of continuity of the Service.
8. Failures or incidents that may occur in communications, deletion or incomplete transmissions.
9. Non-operability or problems with the email address provided by the User.
...
Users can also apply search filters to narrow their search. More information about search filters [here](https://ayuda.wallapop.com/hc/en-us/articles/360002048677-Use-filters-to-find-what-you-want).
...
**9.2.-** The featured ads are a feature offered by Wallapop so that the ads have more visibility on the wall. There are different types of featured ads that can be consulted [here.](https://ayuda.wallapop.com/hc/en-us/articles/360002041677--Types-of-featured-items)
...
**9.6.-** To request an invoice for the purchase of Visibility Services, the User can find more information at the following link: [Request Invoice](https://ayuda.wallapop.com/hc/en-us/articles/360014607417-Request-an-invoice-from-your-featured-items). In order to process this request, Wallapop will require the applicant’s fiscal data, which is necessary to issue the invoice.
...
**9.13.-** The purchase of Visibility Services does not exempt from compliance with the [publication rules](https://ayuda.wallapop.com/hc/en-us/articles/360004667717-What-content-is-not-allowed-on-Wallapop-) established to operate on Wallapop.
...
**10.1.-** The Wallapop Subscription Service offers Users who subscribe to it a series of specific benefits that will vary depending on the chosen subscription. You can obtain more information about the types of subscriptions [here](https://ayuda.wallapop.com/hc/en-us/sections/360000493638-Type-of-subscriptions).
...
**10.5.-** In the event that a profile is deactivated by Wallapop for a breach of the [publication rules](https://ayuda.wallapop.com/hc/en-us/articles/360004667717-What-content-is-not-allowed-on-Wallapop-) or the Terms and Conditions, the User shall receive a notification at the email address associated with the deactivated profile.
...
**10.9.-** To request an invoice for the purchase of Subscription Services the User can find more information at the following link: [Request invoice](https://ayuda.wallapop.com/hc/es-es/articles/4407344388625-Pagar-suscripci%C3%B3nr-factura-de-destacados). In order to process this request, Wallapop will require the fiscal data of the applicant, which is necessary to issue the invoice.

**10.10.-** The prices relating to the subscription service include the Value Added Tax of 21%. In those cases in which, by application of the rules of localization of the tax established in Law 37/1992, of December 28, 1992, on Value Added Tax, the tax rate is not applicable, Wallapop undertakes to adjust the amount of the tax rate.

**10.11.-** This service is currently only available in Spain. For more information about the subscription service, please [click here](https://ayuda.wallapop.com/hc/en-us/sections/360001165358-What-is-a-PRO-subscription).
...
To contract Wallapop’s Subscription Service you must register as a user with Stripe, reading and accepting the [terms and conditions](https://stripe.com/es-419-es/legal/connect), [privacy policy](https://stripe.com/es-419-es/privacy), and other relevant legal texts accessible via its [website](https://stripe.com/es).
...
**11.- Wallapop Refurbished**

**11.1.- What is Wallapop Refurbished?**

**11.1.1.-** Wallapop has a specific line of business whereby it allows previously selected Professional Sellers who are experts in reconditioning to offer reconditioned electronic products to Users on the Platform. These Products are identified on the Platform under the designation “Refurbished”. Users can find more information on the following [link](https://ayuda.wallapop.com/hc/en-us/articles/22675315382801-Refurbished-items-on-Wallapop).

**11.1.2.-** Wallapop in this line of business also intervenes as an intermediary between the Buyer and the Seller. Therefore, Wallapop is not the Seller of the Refurbished Products, nor is it responsible for the conformity of the Refurbished Products, their characteristics or the information contained in their data sheet. Wallapop offers certain services to Sellers of Refurbished Products, such as a payment service or after-sales support services to the Seller and the Buyer, which are governed by specific terms and conditions between Wallapop and the Seller.

**11.2.- Buying Refurbished Products**

**11.2.1**.- In order to purchase Refurbished Products, it is necessary to create an account as set out in these Terms and Conditions of Use. Purchases of Refurbished Products made on the Platform shall be made from the Sellers, not from Wallapop.
...
**11.3.1.-** Buyers of Reconditioned Products have a period of thirty (30) calendar days from the date of receipt of the Product to exercise their right of withdrawal against the Seller.

The right of withdrawal consists of the Buyer’s right to return the Product without having to justify his decision and without penalty.

Users are informed that the right of withdrawal is exercised before the Seller, being the Seller responsible for managing such right. Wallapop will intermediate in the process with the sole purpose of assisting in the management of the request.
...
**11.3.5**.- In the event that all of the above conditions are met, the total amount of the order (including handling fees) will be refunded to the Buyer through Wallapop.

**11.4.- Legal Warranty for Refurbished Products**

**11.4.1.-** All Reconditioned Products also benefit from the legal guarantee of conformity offered by the Seller for a period of one (1) year from the date of receipt thereof. This means that the Professional Seller is responsible and liable for the non-conformity of the Products for a period of one (1) year from their delivery.

Users are informed that the right of guarantee is exercised before the Seller, being the Seller responsible for managing such right. Wallapop will intermediate in the process with the sole purpose of assisting in the management of the request.

The Seller may offer, unilaterally, a longer legal warranty period. Such extended warranty, and its particular conditions, will be communicated and/or provided by the Seller to the Buyer. In this case, Wallapop will not intervene in the process of managing the exercise of such warranty and it must be managed directly with the Seller.
...
(i) is fit for the use customarily expected for a similar product and corresponds to the description given by the Seller; or
...
(ii) The remedy proposed by or agreed with Seller is not implemented by Seller within 72 business hours of Seller’s proposed remedy.
...
**13.2.- In order to make** use of this service it is essential that the entire transaction has been carried out through Wallapop and that the Product to be purchased complies with our [publication rules](https://ayuda.wallapop.com/hc/en-us/articles/360004667717-What-content-is-not-allowed-on-Wallapop-).
...
* In the event that the Item has been lost during shipment, please follow the instructions indicated [here](https://ayuda.wallapop.com/hc/en-us/articles/360004524538-The-package-hasn-t-arrived)
* In the event that the Item has been damaged during shipment, the instructions listed [here](https://ayuda.wallapop.com/hc/en-us/articles/360006559378-Order-damaged-in-transport) should be followed.
...
The Buyer must pay, on a mandatory basis, the cost of “Wallapop Protection” in case he/she wants to use the shipping service. You can get more information about the associated cost [here](https://ayuda.wallapop.com/hc/en-us/articles/360002310197-Service-costs).

**13.6.3.- Process for claiming reimbursement under Wallapop Protection**

If the Item received does not conform to Seller’s agreement, Buyer may proceed to open a dispute by following the steps outlined [here](https://ayuda.wallapop.com/hc/en-us/articles/360004532197-How-do-I-open-a-dispute-to-the-seller-).
...
* **Nor may you initiate a dispute if you have already stated that the Product was correct.**
* You must **keep the original packaging of the Product received,** including the label printed by the carrier.

When opening a dispute, the Buyer must provide all evidence to justify the reason for the return, and must (i) provide details of what happened and (ii) attach photographs or videos of the Product received that justify that the Product is damaged or does not match the description and/or photographs provided by the Seller.

In the event that the Seller does not accept the return and the dispute is escalated to the Wallapop Support Team, Wallapop will no longer request or collect information, photographs or videos from the Buyer. Consequently, the Buyer will only have the time of the opening of the dispute to provide Wallapop with all the reasons and evidence of the return.

Once the dispute has been initiated, **Seller** may:

**1) Accept the return.** In this case, the Buyer must return the Product (in the same condition in which it was received) to the Seller following the steps detailed [here.](https://ayuda.wallapop.com/hc/en-us/articles/360004532197-How-do-I-open-a-dispute-to-the-seller-)
...
**2) Do not accept the return and escalate the dispute to the Wallapop Support Team.** In the event that the Seller does not accept the return, the dispute will be escalated to the Wallapop Support Team.
...
The Wallapop Support Team will evaluate the case, taking into consideration (i) the information provided by the two parties and (ii) the **Wallapop Returns Policy included within the** **Specific conditions of the Wallapop shipping service available** [**here**](https://ayuda.wallapop.com/hc/en-us/articles/360004524518-Return-Policy), and will make a decision on the case.
...
The Buyer is informed that, depending on the case, it may also be decided that a partial refund of the Product is appropriate (for example, in the event that a part of the Product is operational and functional).
...
The refund (in the case of a full refund) to the Buyer, entails the return of (i) the price paid for the Product, (ii) the shipping costs and (iii) the Wallapop Protection fee.

**_b)_** In the event that, as a result of the dispute, it is decided that the refund of the Product is not applicable, the Seller will receive the money related to the price of the Product in its Wallapop wallet.
...
7. Violate the privacy of other Users or collect personal information about them without their consent.
...
**15.1.-** Articles 11 and 12 of the Digital Services Act (“**DSA**”) require online platforms to designate a single point of contact to enable direct communication with users in the EU, the European Commission, EU Member States’ authorities, and the European Board for Digital Services regarding the application of the DSA. Users can obtain further information about this point of contact [here](https://ayuda.wallapop.com/hc/en-us/articles/23523054029841-Single-Point-of-Contact).
...
These Conditions describe your rights and responsibilities regarding your use of our platform (the “**Services**”). If you are a Business User (as defined above), these Conditions govern your access to and use of our Services in addition to the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/) and our [Privacy Policy](https://about.wallapop.com/en/privacy-policy/), applicable to all users.
...
These Conditions, the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/) and the [Privacy Policy](https://about.wallapop.com/en/privacy-policy/), together form a binding contract between the Business User and Wallapop. If you use a specific service such as a payment or delivery service, its terms and conditions will also form part of the contract. The terms “we”, “our”, and “us” refer to Wallapop, S.L.

Please note that if you identify any contradiction between these Conditions and the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/), these Conditions shall take precedence.
...
1. Is subject to a legal or regulatory obligation that requires it to modify the Conditions in a way that does not allow Wallapop to comply with the notice period.
2. Must exceptionally modify the Conditions in order to address an unforeseen and imminent danger related to the defence of online intermediary services, consumers or Business Users against fraud, malware, spam, data security breaches, other cybersecurity risks or similar risks.
...
1. For security reasons. We may suspend your account for security reasons, or due to reorganisation of IT resources and in order to improve their provision or configuration. In such cases, we will do our best to keep disruptions to a minimum.
2. If you do not comply with our rules of use. If you do not comply with the rules for the use of the Service regulated in clause 3 and/or the rules for the publication of advertisements regulated in clause 8 of the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/). In this case, Wallapop will contact you to inform you of this situation, unless one of the exceptions is applicable which exempts Wallapop from notifying this fact in accordance with the regulations, as will be explained below.
3. If one of your advertisements is reported by users or third parties as fraudulent or illegal. In such case, the advertisement will be disabled from the Wallapop platform and you will be notified. Wallapop will offer you the opportunity to clarify the facts and circumstances that led to the decision of disabling the advertisement, as mentioned above, insofar as the exceptions to the duty to notify the suspension or restriction do not apply.
...
1. Failure to pay for the Services contracted as a Business User.
2. Repeated non-compliance of the rules for the use of the Service regulated in the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/).
3. Unilateral termination by the Business User, at any time and without giving any reason whatsoever, notwithstanding that the parties may agree on other terms.
...
1. Is subject to a legal or regulatory obligation that requires it to terminate or restrict the provision of all Services to a Business User in a way that does not allow it to respect such notice period.
2. Exercises its right of termination for an overriding reason under applicable regulations.
3. Can prove that the Business User concerned has repeatedly breached these Conditions and/or the [Terms and Conditions of use](https://about.wallapop.com/legal-terms-and-conditions/), resulting in the termination or restriction of the Services.
...
During this period of time, you may download the information and content generated on the Wallapop platform. After this period of time, Wallapop will comply with the processing and retention periods regulated in the [Privacy Policy](https://about.wallapop.com/en/privacy-policy/)

If the reason for termination of the Services is because you have breached the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/) as a Business User, you will have ten (10) days to justify your action before terminating the Services. If, after a review, Wallapop considers that you have not acted against the [Terms and Conditions of use](https://about.wallapop.com/en/legal-terms-and-conditions/), these Conditions and/or the [Privacy Policy](https://about.wallapop.com/en/privacy-policy/) of Wallapop, we will reinstate access to your business account and the contents of your account.
...
1. When you consider that we have not complied with any of our obligations in accordance with the P2B Regulation.
2. When technological problems occur that are directly related to the provision of Services and affect you.
3. When it is based on specific measures or conduct of Wallapop that are directly linked to the provision of Services and affect you.
...
To file a complaint, you should contact us through this [form](https://ayuda.wallapop.com/hc/en-us/requests/new?ticket_form_id=13076994262801).
...
* Institución de Mediación B2B de Confianza Online, linked to: [https://www.mediaciononlineb2b.es/](https://www.mediaciononlineb2b.es/)
* [Conflict Management Advisers Mediación B2B](https://eur02.safelinks.protection.outlook.com/?url=https%3A%2F%2Fb2bcma.com%2Fmediacion-b2b%2F&data=05%7C01%7Cjoanaloc.pons%40es.gt.com%7C98e63cb9d38a460a554608db2f649c48%7Ca8803954c6a64d60b4e1d78ecb2ca82a%7C0%7C0%7C638155881412224492%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&sdata=PUhp8i3okDXpJY7MybDc3KY2ZrcKQO2EpoQb01dnxmo%3D&reserved=0)
...
Our [Privacy Policy](https://about.wallapop.com/en/privacy-policy/) gives a detailed explanation of how personal data is processed at Wallapop.
