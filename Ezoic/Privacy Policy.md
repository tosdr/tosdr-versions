...
This privacy policy (“Privacy Policy”) for Ezoic Inc. (“Company”, “we”, “our”, “us”), describes how we collect, use, and disclose information about users of the Company’s website (www.ezoic.com) (“Website”), applications, services, tools and features (collectively, and together with the Website, the “Services”). For the purposes of this Privacy Policy, “you” and “your” means you as the user of the Services. Please read this Privacy Policy carefully so that you understand your rights in relation to your personal information, and how we will collect, use, and process your personal information. This Privacy Policy supplements any other privacy-related notices and policies we may provide to you from time to time, and is not intended to override them. If you do not agree with this Privacy Policy in general or any part of it, you should not access the Website, use our Services or otherwise provide your information to us. Our Website and Services are not intended for children, and we do not knowingly collect data relating to children. Children must not use the Services, except where their parent or guardian has provided consent if this option is available in your location. We change our Privacy Policy from time to time. Updates to our Privacy Policy will apply only to information collected after the date of the change. We will note on our Website when our Privacy Policy has been updated. Please check the Website regularly for notices of changes to our Privacy Policy.
...
* personalize your Services for you; and
...
* asend you announcements in relation to security, privacy or administrative related communications (these communications are not marketing orientated, and we do not rely on consent, so you may not opt out);
* personalize our Services to ensure content is presented in the most effective manner for your and your device;
...
* With our business clients, in our legitimate interests. As necessary, we may share personal information with our business clients who use our Services, including about your activity on their website. Transfers to subsequent third parties are covered by the service agreements with our clients.
...
* In connection with an asset sale or purchase, a share sale, purchase or merger, bankruptcy, or other business transaction or re-organization, in our legitimate interests. We may share your personal information with a prospective buyer, seller, new owner, or other relevant third party as necessary while negotiating or in relation to a change of corporate control such as a restructuring, merger, or sale of our assets.
...
* Withdrawal of consent: Where we rely on consent to process your personal information, you have the right to withdraw this consent at any time by emailing us at [\[email protected\]](https://www.ezoic.com/cdn-cgi/l/email-protection).
...
To exercise any of these rights, you can contact [\[email protected\]](https://www.ezoic.com/cdn-cgi/l/email-protection). We will respond to requests to exercise these rights without undue delay and at least within one month (though this may be extended by a further two months in certain circumstances).  
...
To exercise any of these rights, you can contact [\[email protected\]](https://www.ezoic.com/cdn-cgi/l/email-protection).
...
| CATEGORY | EXAMPLES | CATEGORIES OF RECIPIENTS | BUSINESS OR COMMERCIAL PURPOSE |
| --- | --- | --- | --- |
| Identifiers | Name, email address, IP address | Payment processors, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services;<br>* Providing measurement, analytics, advertising, and other business services<br>* Promoting safety, integrity, and security;<br>* Communicating with you; and<br>* For internal research and development |
| Personal information categories listed in the California Customer Records Statute | Name, address, telephone number, and with your consent diversity information (Race or ethnicity, age, sex (including gender and sexual orientation), physical or mental disability, and veteran status) | Payment processors, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services;<br>* Providing measurement, analytics, advertising, and other business services<br>* Promoting safety, integrity, and security;<br>* Communicating with you; and |
| Commercial information | Records of services purchased | Payment processors, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services |
| Internet or other similar network activity | Information regarding your interaction with the Services | Business clients, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services;<br>* Providing measurement, analytics, advertising, and other business services<br>* Promoting safety, integrity, and security;<br>* Communicating with you; and |
| Geolocation data | IP address | Business clients, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services;<br>* Providing measurement, analytics, advertising, and other business services<br>* Promoting safety, integrity, and security; |
| Inferences drawn from other personal information | Profile reflecting your preference | Business clients, data analytics and advertising vendors, and website hosting vendors | * Providing, personalizing, and improving our Services; and<br>* Providing measurement, analytics, advertising, and other business services |

  

### Sensitive Personal Information

In the preceding 12 months, we collected and disclosed for a business purpose the following categories of sensitive personal information about you:

| CATEGORY | EXAMPLES | CATEGORIES OF RECIPIENTS | BUSINESS OR COMMERCIAL PURPOSE | DATA RETENTION PERIOD |
| --- | --- | --- | --- | --- |
| Government Identifiers | Social Security Number | Tax and other government agencies | For facilitating payments to you and for identification verification | For so long as reasonably necessary for the disclosed purpose, including for so long as your account is open and as long as required thereafter to comply with any legal requirements |
| Diversity Information | Your race or ethnicity, age, sex (including gender and sexual orientation), physical or mental disability, and veteran status | Data analytics and advertising vendors and website hosting vendors | To advertise your diversity and inclusion affiliations, with your consent | For so long as reasonably necessary for the disclosed purpose, including for so long as your account is open and you have not withdrawn your consent |

We retain Personal Information for so long as reasonably necessary for the business or commercial purposes discussed above, as determined by us in accordance with the category of information, the business or commercial purposes, and applicable law.  
...
In the preceding 12 months, we have not sold personal information about California consumers.
...
In the preceding 12 months, we have shared to third parties the following categories of personal information about California consumers:

| Category | Categories of Recipients | Business or Commercial Purpose |
| --- | --- | --- |
| Identifiers | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
| Personal information categories  <br>listed in the California Customer Records statute | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
| Commercial information | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
| Internet or other similar network activity | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
| Geolocation data | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
| Influences drawn from other personal information | Business clients and data analytics and advertising vendors | Providing measurement, analytics, advertising and other business services |
...
* [About](https://www.ezoic.com/about)
* [Careers](https://www.ezoic.com/careers)
* [What Is Ezoic](https://www.ezoic.com/what-is-ezoic)
* [Press](https://www.ezoic.com/press)
* [Cares (CSR)](https://www.ezoic.com/ezoic-cares-csr)

Account

* [Support](https://support.ezoic.com/)
* [Partners](https://www.ezoic.com/certified-seamless-with-ezoic)
* [WordPress](https://wordpress.ezoic.com/)
* [Events](https://www.ezoic.com/events)
* [Contact](https://www.ezoic.com/contact-us)

![Company Logo](/_vercel/image?url=_astro%2FbigE.8yEvsr1B.png&w=640&q=100)

[](https://www.facebook.com/ezoic/)[](https://twitter.com/ezoic)[](https://www.youtube.com/c/ezoic)[](https://www.linkedin.com/company/ezoic-inc-)[](https://www.tiktok.com/@ezoicplatform)

[Privacy Policy](https://www.ezoic.com/privacy-policy) [Terms](https://www.ezoic.com/terms) Copyright 2024