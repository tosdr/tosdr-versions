...
[![Add-on icon](https://addons.mozilla.org/user-media/addon_icons/2632/2632765-64.png?modified=5ae65e2a)](https://addons.mozilla.org/en-US/firefox/addon/archive-page/)

Privacy policy for Archive Page
===============================

[Archive Page](https://addons.mozilla.org/en-US/firefox/addon/archive-page/) by [John Navas](https://addons.mozilla.org/en-US/firefox/user/15797511/)
=====================================================================================================================================================
...
43](https://addons.mozilla.org/en-US/firefox/addon/archive-page/reviews/?score=5 "Read all 43 five-star reviews")[4

3](https://addons.mozilla.org/en-US/firefox/addon/archive-page/reviews/?score=4 "Read all 3 four-star reviews")[3

0](https://addons.mozilla.org/en-US/firefox/addon/archive-page/reviews/?score=3 "There are no three-star reviews")[2

0](https://addons.mozilla.org/en-US/firefox/addon/archive-page/reviews/?score=2 "There are no two-star reviews")[1

2](https://addons.mozilla.org/en-US/firefox/addon/archive-page/reviews/?score=1 "Read all 2 one-star reviews")

Privacy policy for Archive Page

URL is sent to archive.today, but only by express action of the user,  
either by clicking the toolbar button, or by the context menu.  
No other information is collected or sent anywhere.
