...
[](https://twitter.com/ScalaCube)

[](https://discord.gg/rzAVhktTdp)

[](https://www.tiktok.com/@scalacubehosting)

[](https://www.facebook.com/scalacubecom)

[](https://www.linkedin.com/company/scalable-hosting-solutions-ou/?viewAsMember=true)

[Login](https://scalacube.com/cp)

[Sign Up](https://scalacube.com/cp#/auth/register)

[Control Panel](https://scalacube.com/cp)

[Logout](https://scalacube.com/cp#/bill/logout)
...
* [Game Hosting](#)
    * [Minecraft Bedrock (Pocket Edition)](https://scalacube.com/hosting/server/minecraft-pe)
    * [ARK: Survival Evolved](https://scalacube.com/hosting/server/ark)
    * [Palworld](https://scalacube.com/hosting/server/palworld)
    * [Rust](https://scalacube.com/hosting/server/rust)
    * [Project Zomboid](https://scalacube.com/hosting/server/project-zomboid)
    * [Terraria](https://scalacube.com/hosting/server/terraria)
    * [Valheim](https://scalacube.com/hosting/server/valheim)
    * [Hytale](https://scalacube.com/hosting/server/hytale)
    * [Factorio](https://scalacube.com/hosting/server/factorio)
    * [CS: GO 2](https://scalacube.com/hosting/server/cs-go-2)
    * [All Games](https://scalacube.com/hosting)
* [Reviews](https://scalacube.com/reviews)
* [More](#)
    * [Control Panel](https://scalacube.com/cp)
    ...
    * [Affiliate Program](https://scalacube.com/help/hosting/company/affiliate-program)
* [](#)
    * [USD ($)](#)
    * [EUR (€)](#)
    * [GBP (£)](#)
...
* [Hytale](https://scalacube.com/hosting/server/hytale)
* [Factorio](https://scalacube.com/hosting/server/factorio)
* [CS: GO](https://scalacube.com/hosting/server/cs-go)
* [Starbound](https://scalacube.com/hosting/server/starbound)
* [All Games](https://scalacube.com/hosting)
...
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Scalable Hosting Solutions OU, Scalable Hosting Solutions OÜ.
...
* **Facebook Fan Page** is a public profile named ScalaCube specifically created by the Company on the Facebook social network, accessible from [https://www.facebook.com/scalacubecom](https://www.facebook.com/scalacubecom)
...
* **Website** refers to ScalaCube, accessible from [https://scalacube.com](https://scalacube.com/)
...
* **Adyen**
    ...
    Their Privacy Policy can be viewed at [https://www.adyen.com/policies-and-disclaimer/privacy-policy](https://www.adyen.com/policies-and-disclaimer/privacy-policy)
...
The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page [https://www.facebook.com/scalacubecom](https://www.facebook.com/scalacubecom), the Company and the operator of the social network Facebook are Joint Controllers.
...
* By visiting this page on our website: [https://scalacube.com/cp#/bill/tickets/](https://scalacube.com/cp#/bill/tickets/)
...
Registration code: 14652605  
VAT number: EE102133820  
Address: Harju maakond, Tallinn, Kesklinna linnaosa, Vesivärava tn 50-201, 10152  

#### Quick Nav

* [Reviews](https://scalacube.com/reviews)
* [Contacts](https://scalacube.com/contacts)
* [Privacy Policy](https://scalacube.com/privacy-policy)
* [Terms and Conditions](https://scalacube.com/terms)
* [Refund policy](https://scalacube.com/terms#refunds)
* [Control Panel](https://scalacube.com/cp)
* [Support](https://scalacube.com/help)
* [Affiliate Program](https://scalacube.com/help/hosting/company/affiliate-program)
...
* [Minecraft Server Hosting](https://scalacube.com/hosting/server/minecraft) [Bedrock Server Hosting](https://scalacube.com/hosting/server/minecraft-pe) [ARK Server Hosting](https://scalacube.com/hosting/server/ark) [Palworld Server Hosting](https://scalacube.com/hosting/server/palworld) [Project Zomboid Server Hosting](https://scalacube.com/hosting/server/project-zomboid) [Rust Server Hosting](https://scalacube.com/hosting/server/rust) [Valheim Server Hosting](https://scalacube.com/hosting/server/valheim) [Hytale Server Hosting](https://scalacube.com/hosting/server/hytale) [Terraria Server Hosting](https://scalacube.com/hosting/server/terraria) [Factorio Server Hosting](https://scalacube.com/hosting/server/factorio) [CS: GO 2 Server Hosting](https://scalacube.com/hosting/server/cs-go-2) [All Games](https://scalacube.com/hosting)

#### Minecraft Hosting

* [Modded Minecraft Server Hosting](https://scalacube.com/modded/minecraft/server/hosting) [Best Minecraft Server Hosting](https://scalacube.com/best-minecraft-server-hosting) [How To Make A Minecraft Server](https://scalacube.com/help/gameservers/minecraft/how-to-make-a-minecraft-server) [Minecraft Forge Server Hosting](https://scalacube.com/minecraft-forge-server-hosting) [Free Minecraft Server Hosting](https://scalacube.com/free/minecraft/server/hosting) [Minecraft VR](https://scalacube.com/minecraft-vr)

Copyright 2019-2024 © [ScalaCube](https://scalacube.com/) \- All Rights Reserved.
