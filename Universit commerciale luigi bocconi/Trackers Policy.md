...
* \_gat\_UA-3418288-3: 1 hour
* YSC: duration of the session
* DEVICE\_INFO: duration of the session
* VISITOR\_INFO1\_LIVE: duration of the session
* CONSENT: 2 years
* \_\_sak: duration of the session
* YtIdbMeta:databases: duration of the session
* yt-remote-device-id: duration of the session
* yt-remote-session-app: duration of the session
* yt-remote-session-name: duration of the session
* yt-remote-fast-check-period: duration of the session
* yt-remote-connected-devices: duration of the session
* ytidb::LAST\_RESULT\_ENTRY\_KEY: duration of the session
* acsbReset: duration of the session
* LogsDatabaseV2:V8b0040ec||:LogsRequestsStore: duration of the session
...
* ### LinkedIn Ads
    ...
    Place of processing: Ireland – [Privacy Policy](https://www.linkedin.com/legal/privacy-policy) – [Opt out](https://www.linkedin.com/legal/privacy-policy); United States – [Privacy Policy](https://www.linkedin.com/legal/privacy-policy) – [Opt out](https://www.linkedin.com/legal/privacy-policy).
...
* ### Sizmek - Amazon Ad Server (Sizmek Inc.)
    ...
    Place of processing: United States – [Privacy Policy](https://www.sizmek.com/privacy-policy) – [Opt out](https://www.sizmek.com/privacy-policy/).
    ...
    * C6: 3 months
    * CISI\_\*: 15 minutes
    * C\_\*: duration of the session
    * D4: 3 months
    * G4: 3 months
    * ORD: duration of the session
    * OT2: 3 months
    * OT\_\*: duration of the session
    * S2: 3 months
    * SZMKSessionId: indefinite
    * SZMKuid: 3 months
    * S\_\*: 2 days
    * TargetingInfo3: 3 months
    * activityInfo2: 3 months
    * ebImpressionID\_\*: duration of the session
    * ebPanelFrequency: 7 days
    * ebPanelFrequency: indefinite
    * ebPanelFrequencyPerSession: duration of the session
    * ebPanelFrequencyPerSession: indefinite
    * eyeblaster: duration of the session
    * r1: duration of the session
    * searchsession\_\*: duration of the session
    * t1: 3 months
    * u2: 3 months
...
* ### Policy scope
    ...
    This policy is applicable to the following websites:  
    www.unibocconi.it  
    www.unibocconi.eu  
    www.stampa.unibocconi.it  
    www.press.unibocconi.eu  
...
**Owner contact email:** dpo@unibocconi.it
...
[Show the complete Privacy Policy](https://www.unibocconi.eu/wps/wcm/connect/Bocconi/SitoPubblico_EN/Cookie/)