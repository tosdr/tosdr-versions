[Skip to Content](#movetomaincontent)

![us flag icon](https://assets.corsair.com/image/upload/f_auto,q_auto/akamai/content/images/header/flags/us-flag.svg)
...
For more information about Corsair, please see the “About Us” section of our Website at [www.corsair.com/s/about.](https://www.corsair.com/s/about)

### Privacy Policy Overview

Please read this Privacy Policy to understand how we collect, use, disclose, transfer, and store your information. In this Privacy Policy, **“Corsair,” “we,” “us,” and “our”** refer collectively to Corsair Memory Inc., and its family of brands (including [Corsair](https://www.corsair.com/), [Elgato](https://www.elgato.com/), [Origin PC](https://www.originpc.com/), and [SCUF](https://scufgaming.com/),  as well as any of our current or future brands, subsidiaries, or affiliates (“**Affiliates**”)). This Privacy Policy may use terms defined in the Corsair's Terms of Use ("[**Terms of Use**](https://www.corsair.com/s/terms-of-use)").
...
Our Services may include YouTube API Services. By accessing or using our Services that include YouTube API Services, You agree to YouTube's Terms of Service [https://www.youtube.com/t/terms](https://www.youtube.com/t/terms)and Google Privacy Policy at [https://policies.google.com/privacy](https://policies.google.com/privacy). For the YouTube application, you can revoke YouTube application’s access to your data via the Google security settings page at [https://security.google.com/settings/security/permissions](https://security.google.com/settings/security/permissions)
...
In addition to this Privacy Policy, we provide additional information regarding the collection and use of Personal Data through specific products and services in our [**Supplemental Privacy Notices**](#other-supplemental-privacy-notices). Our Supplemental Privacy Notices are incorporated into this Privacy Policy and will control to the extent relevant to your activities and to the extent of any conflict with this Privacy Policy.  
Finally, we provide specific information for users in certain locations. Click the following links to learn more:

* [Your California Privacy Rights](#supplemental-information-for-california-residents)
* [Your Nevada Privacy Rights](#supplemental-information-for-nevada-residents)
* [Your EEA/UK/Swiss Privacy Rights](#supplemental-information-for-users-in-the-EEA-UK-Switzerland)

This Privacy Policy only covers how Corsair processes Personal Data as part of our Service. Corsair’s Privacy Policy does not apply to third parties. We encourage you to read third party privacy policies and understand your privacy rights before interacting with them.
...
5. [Your Privacy Rights and Choices](#your-privacy-rights-and-choices)
...
14. [Supplemental Information for Users in the EEA/UK/Switzerland](#supplemental-information-for-users-in-the-EEA-UK-Switzerland)
...
We may create certain Inference Data from your account data, or associate Inference Data with your account. We may use such Personal Data for our Commercial Purposes, including for personalization, to create consumer profiles, and for marketing purposes, as described below.

### When you make a Purchase or Conduct Another Transaction through our Services
...
When you use our Service, we automatically collect and process Device/Network Data and Usage Data. We process these data as necessary to initiate or fulfill your requests for certain features or functions through our Service, such as keeping you logged in, delivering pages, logging activities for security purposes, etc. In addition, we may also collect and process Contact Data, Identity Data, and Inference Data that we collect, create, and/or receive (including through the use of cookies and similar technologies, subject to any necessary consents required under applicable law). For more information, please visit our Cookies and Similar Technologies page [here](https://assets.corsair.com/image/upload/v1709657873/pages/Legal%20Documents/Corsair_cookie_policy.pdf)  
...
Please see our [Corsair Supplemental Privacy Notices](#other-supplemental-privacy-notices)  for more information regarding the processing of Personal Data via specific Corsair products or Services.
...
We process this Personal Data to establish and manage the Promoter relationship and assess performance, as well as for our Commercial Purposes, including for personalization, to create consumer profiles, and for marketing purposes, as described below.  
...
If you have a warranty claim regarding a Corsair product you purchased, or if you submit a product for return/repair, we may collect additional Device/Network Data, as well as Identity Data, Contact Data, and Transaction Data in connection with the submission and processing of your claim. If you are entitled to a refund, we may collect Payment Data in order to process the refund transaction. We process this Personal Data as necessary to fulfill the transaction, and for our business purposes, described below.
...
If you are an applicant for a position at Corsair in California, the EEA, or the UK, Personal Data will be processed as set forth in the Corsair [Human Resources Privacy Notice for California Residents.](https://res.cloudinary.com/corsair-pwa/image/upload/v1688744621/pages/Legal%20Documents/Human_Resources_Privacy_Policy.pdf)
...
In some email messages and to allow for secure software downloads and installations, Corsair sends to you, we provide a “click-through URL” that links you to content on the Sites. When you click one of these URLs, they pass through a separate server before arriving at the destination page on the Sites. We track this click-through to help us determine interest in particular topics and measure whether we are communicating with you effectively.
...
You are free to withdraw any consent you may have provided, at any time, subject to the [Your Privacy Rights & Choices](#your-privacy-rights-and-choices)  section and the preceding [Legal Bases for Processing Your Information in this Section.](#legal-bases)
...
The Nevada Revised Statutes (NRS 603A.300 et seq.) permit a Nevada consumer to direct an operator of an Internet website or online service to refrain from making any sale of any covered information the operator has collected or will collect about that consumer. You may submit a request pursuant to this directive by emailing us at data.controller@corsair.com. We will provide further information about how we verify the authenticity of the request and your identity.

SUPPLEMENTAL INFORMATION FOR CALIFORNIA RESIDENTS
-------------------------------------------------

California residents have the following rights. You will not need to create an account to exercise your rights. To exercise one of these rights, please provide a verifiable consumer request by emailing us [data.controller@corsair.com](mailto:data.controller@corsair.com).
...
The charts below summarize how we process specific categories of Personal Data. Please see the corresponding definitions/headings above for more information regarding each category of Personal Data, the purposes of processing, and categories of recipients.

| Categories of personal information collected in last 12 months | Purposes for which personal information will be used |
| --- | --- |
| Identity Data | Account Registration; Purchase or other Transaction; Access or use of our Service; Use of our Software or Certain Products; Email and SMS Campaigns; Cookies and Other Technologies; Social Media Promoters; Contest/Promotions; Affiliate Relationships; Contact us/Submissions; Warranty, Returns, and Repairs; In Person Interactions; Feedback and Surveys; Support and Professional Services; Business Purposes; Commercial Purposes |
| Device/Network Data | Account Registration; Purchase or other Transaction; Access or use of our Service; Use of our Software or Certain Products; Email and SMS Campaigns; Cookies and Other Technologies; Social Media Promoters; Contest/Promotions; Affiliate Relationships; Contact us/Submissions; Warranty, Returns, and Repairs; Support and Professional Services; Business Purposes; Commercial Purposes |
| Contact Data | Account Registration; Purchase or other Transaction; Access or use of our Service; Email and SMS Campaigns; Social Media Promoters; Contest/Promotions; Affiliate Relationships; Contact us/Submissions; Warranty, Returns, and Repairs; In Person Interactions; Feedback and Surveys; Support and Professional Services; Business Purposes; Commercial Purposes |
| Payment Data | Account Registration; Purchase or other Transaction; Warranty, Returns, and Repairs; Business Purposes |
| Transaction Data | Account Registration; Purchase or other Transaction; Cookies and Other Technologies; Social Media Promoters; Contest/Promotions; Contact us/Submissions; Warranty, Returns, and Repairs; Support and Professional Services; Business Purposes; Commercial Purposes |
| Audio/Visual Data | Access or use of our Service; Use of our Software or Certain Products; Support and Professional Services; Business Purposes; Commercial Purposes |
| Usage Data | Access or use of our Service; Use of our Software or Certain Products; Cookies and Other Technologies; Contact us/Submissions; Feedback and Surveys; Support and Professional Services; Business Purposes; Commercial Purposes |
| Inference Data | Account Registration; Purchase or other Transaction ; Access or use of our Service; Use of our Software or Certain Products; Email and SMS Campaigns; Cookies and Other Technologies; Contest/Promotions; Feedback and Surveys; Business Purposes; Commercial Purposes |
| Location Data | Account Registration; Access or use of our Service; Business Purposes; Commercial Purposes |
| Government ID Data | Social Media Promoters; Contest/Promotions; Business Purposes |
| User Content | Access or use of our Service; Use of our Software or Certain Products; Contest/Promotions; Contact us/Submissions; Feedback and Surveys; Support and Professional Services; Business Purposes; Commercial Purposes |

| Categories of personal information that we have sold in last 12 months | Categories of third parties to whom the information was sold |
| --- | --- |
| Identity Data | Social Media/Advertisers; Data Aggregators |
| Device/Network Data | Social Media/Advertisers; Data Aggregators |
| Contact Data | Social Media/Advertisers; Data Aggregators |
| Transaction Data | Social Media/Advertisers; Data Aggregators |
| Usage Data | Social Media/Advertisers; Data Aggregators |
| Inference Data | Social Media/Advertisers; Data Aggregators |

| Categories of personal information that we have disclosed for business/commercial purposes in last 12 months | Categories of third parties to whom the information was disclosed |
| --- | --- |
| Identity Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Device/Network Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Contact Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Payment Data | Service Providers; Affiliates; Partners; Successors; Others |
| Transaction Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Audio/Visual Data. | Service Providers; Affiliates; Partners; Successors; Others |
| Usage Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Inference Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Location Data | Service Providers; Affiliates; Partners; Social Media/Advertisers; Data Aggregators; Successors; Others |
| Government ID Data | Service Providers; Affiliates; Successors; Others |
| User Content | Service Providers; Affiliates; Partners; Successors; Others |
...
* [Elgato](https://www.elgato.com/us/en/s/privacy-policy)
...
* [Cookies and Similar Technology](https://assets.corsair.com/image/upload/v1709657873/pages/Legal%20Documents/Corsair_cookie_policy.pdf)