...
Effective from the 8th of August 2018. Last updated on the 10th of July 2023.

At ImprovMX, we respect the privacy rights of our users and recognize the importance of protecting the personal information we collect about you. Our Privacy Policy is designed to help you understand what information we collect and how we use and share that information. This Privacy Policy applies to our Websites and Services.

As used in this Privacy Policy, “**ImprovMX**,” “**us**” and “**we**” refers to ImprovMX, Inc. and its affiliates, including without limitation the “ImproveMX SAS”, company . The “**Websites**” means ImprovMX’s websites (including without limitation [www.improvmx.com](https://www.improvmx.com/), cdn.improvmx.com and any successor URLS, mobile or localized versions and related domains and subdomains), and the “**Services**” means ImprovMX’s applications and services, in each case in whatever format they may be offered now or in the future. The Websites and Services are collectively referred to herein as the “**Service**.”
...
Cookies set by the website and/or mobile app and/or platform owner (in this case, ImprovMX) are called “first party cookies”. Cookies set by parties other than the website and/or mobile app and/or platform owner are called “third party cookies”.
...
| --- | --- |
| **NAME** | **PURPOSE** |
| [AWS](https://crisp.chat/) | We use Amazon Web Services to host our infrastructure and handle email forwarding and custom sending via SMTP. |
| [OVHcloud](https://www.ovhcloud.com/) | We use OVHcloud to handle email forwarding and custom sending via SMTP. |
| [Intercom](https://intercom.com/) | Intercom is used on ImprovMX’s application to handle support on both Chat and Email. |
| [Fernand](https://getfernand.com/) | We use Fernand, the fastest and calmest customer support solution for SaaS, to provide exceptional support and enhance our customers’ experience. |
...
| [Mailgun](https://www.mailgun.com/) | We use Mailgun to facilitate the sending of receipts and transactional emails. |
| Fetchlab | Fetchlab is a tool built by one of our Founder to display the logo of the domains you have on your dashboard and perform email validation when creating accounts. |
...
| [Linear](https://linear.app/) | We use Linear for internal issue tracking, project management and roadmap planning. |
| [Mixpanel](https://mixpanel.com/) | We use Mixpanel to gain valuable insights into user interactions with our product, enhancing user experience and engagement while respecting privacy. |
| [Plausible](https://plausible.io/) | We use Plausible, a privacy-friendly website analytics tool that does not use cookies, to gather insights into our website usage. |
...
| --- | --- | --- |
| ImprovMX | \_t | Session tracking cookie. |
| Stripe | \_\_lc.visitor\_id.XXXXXXX, \_\_stripe\_mid, \_\_stripe\_orig\_props, stripe.csrf, cid, lang, machine\_identifier, merchant, mp\_{token}\_mixpanel, private\_machine\_identifier, lc\_window\_state | We rely on Stripe to handle payments made on ImprovMX. |
...
* If you wish to **access, correct, update, or request deletion** of your personal information, you can do so at any time by emailing [support@improvmx.com](mailto:support@improvmx.com).
* In addition, you can **object to the processing** of your personal information, ask us to **restrict the processing** of your personal information, or **request portability** of your personal information. Again, you can exercise these rights by emailing [support@improvmx.com](mailto:support@improvmx.com).
* You have the right to **opt-out of marketing communications** we send you at any time. You can exercise this right by clicking on the “unsubscribe” or “opt-out” link in the marketing emails we send you. To opt-out of other forms of marketing, please contact us by emailing [support@improvmx.com](mailto:support@improvmx.com).
...
We reserve the right to change our Privacy Policy at any time. If we make changes, we will post them and will indicate on this page the policy’s new effective date. If we make material changes to this policy, we will notify you by email or through notice on the Service.

No Children Under Age 13
------------------------

The Service are not intended for use by anyone under the age of 13, nor does ImprovMX knowingly collect or solicit personal information from anyone under the age of 13. If you are under 13, you may not attempt to register for the Service or send any information about yourself to us, including your name, address, telephone number, or email address. In the event that we confirm that we have collected personal information from someone under the age of 13 without verification of parental consent, we will delete that information promptly. If you are a parent or legal guardian of a child under 13 and believe that we might have any information from or about such child, please contact us at the email or mailing address provided at the end of this Privacy Policy.

Your California Privacy Rights and Disclosures
----------------------------------------------

**California Shine the Light Law.** If you are a California resident and we disclose your personally identifiable information to third parties for such third parties’ direct marketing purposes, California’s Shine the Light Law (CA Civil Code Section 1798.83) allows you to request certain information from us about such disclosures. To make a request under the Shine the Light Law, please contact us at [support@improvmx.com](mailto:support@improvmx.com). Please note that under California law, businesses are not required to respond to such requests more than once during any calendar year.

**California Information-Sharing Disclosure.** California residents may request a list of all third parties with respect to which we have disclosed any information about you for direct marketing purposes and the categories of information disclosed. If you are a California resident and want such a list, please send us a written request by email to [support@improvmx.com](mailto:support@improvmx.com) with “California Privacy Rights” in the subject line.

**California Minors.** At any time, you can delete or remove your posts using the same deletion or removal procedures described in Section [Accessing and Updating Your Personal Information](https://improvmx.com/pages/privacy#privacy-access-and-update) above, or otherwise through the Service. If you have questions about how to remove your posts or if you would like additional assistance with deletion you can contact our support team at [support@improvmx.com](mailto:support@improvmx.com).
...
If you have questions or need to contact us about this Privacy Policy, please email us at [support@improvmx.com](mailto:support@improvmx.com).