...
* [Resources](#)
    ...
    * [Jobvite Academy](https://www.jobvite.com/academy/)
...
Employ websites and services may contain links to other websites, applications, platforms and services maintained by third parties. The information practices of these third parties, including the social media platforms that host Employ branded social media pages, are governed by their Privacy Notices, which you should review to better understand their privacy practices

In some circumstances, Employ also collects, or Employ partners provide Employ with, publicly available information which may contain Personal Data that you have published or that has been made available online. The way in which Employ partners collect this is detailed in their own privacy policies, available on their websites.

**3\. What Personal Data does Employ collect?**

3.1 Personal Data Employ collects directly from you

The Personal Data Employ collects directly from you may include identifiers, professional or employment-related information, financial account information, commercial information, visual information, and internet activity information, among others. Employ may collect such information in the following situations:

|     |     |
| --- | --- |
| Situations | Categories of Personal Data |
| If you express an interest in obtaining additional information about Employ services; request customer support (including accessing the Help & Training Portal); use Employ “Contact Us” or similar features; register to use Employ websites or to receive communications; sign up for an event, webinar or contest; participate in a program, training, certification or survey; use Employ products and services; download certain content; or are employed by a customer of Employ products and services where your information has been shared with us | Contact information, such as your name, job title, company name, address, phone number, email address, username and password, other information you have voluntarily chosen to share |
| If you make purchases via Employ websites or register for an event or webinar | Contact information, financial and billing information, such as billing name and address, credit card number or bank account information |
| If you attend an event | Attendee badge information which may include name, title, company name, address, country, phone number and email address, image and video During the Covid-19 pandemic, this may also include health status, including your temperature, COVID-19-related symptoms, exposure to COVID-19 positive individuals, vaccination status, testing results, and recent travel history |
| If you register with Employ for a variety of purposes, including joining a community that Employ host or participating in a program, training or certification | Username, photo, video or other biographical information, such as your occupation, location, social media profiles or usernames, company name, areas of expertise and interests |
| If you interact with Employ websites or emails | Information about your device and your usage of Employ websites or emails (such as Internet Protocol (IP) addresses or other identifiers), which may qualify as Personal Data (please see Section 4 below) using cookies, web beacons, or similar technologies |
| If you use and interact with Employ products and services | Information about your device and your usage of Employ services through log files and other technologies, some of which may qualify as Personal Data (including Usage Data) (please see Section 4 below) |
| If you communicate with Employ via a phone call | Information you have provided as part of that interaction, which may include Personal Data and special categories of Personal Data, to the extent you voluntarily choose to provide it |
| If you visit Employ offices | Name, email address, phone number, company name, time and date of arrival, image or video During the Covid-19 pandemic, this may also include health status, including your temperature, COVID-19-related symptoms, exposure to COVID-19 positive individuals, vaccination status, testing results, and recent travel history |
...
| If you are a supplier or service provider to Employ (or work for a supplier or service provider) | Contact information, payment and billing information |

If you provide us, Employ service providers or Employ affiliates with any Personal Data relating to other individuals, you represent that you have the authority to do so, and where required, have obtained the necessary consent, and acknowledge that it may be used in accordance with this Privacy Notice. If you believe that your Personal Data has been provided to Employ improperly, or want to exercise your rights relating to your Personal Data, please contact Employ by using the information in Section 14 below.

_Personal Data Employ collects from other sources_

Employ also collects information about you from other sources including partners from whom Employ collects or purchases Personal Data or who provide Employ with publicly available information which may contain Personal Data. Employ may combine this information with Personal Data provided by you.
...
_Cookies, web beacons and other tracking technologies on Employ website and in email communications_

Cookies. Employ uses “cookies” to collect information and improve Employ’s Interactions with you. A cookie is a small data file that Employ transfer to your device. Employ may use “persistent cookies” to save your registration ID and login password for future logins to Employ’s website, such as, to register for webinars. Employ may use “session ID cookies” to enable certain features of the Service, to better understand how your Interactions with Employ and to monitor aggregate usage and web traffic routing on Employ’s website. For more information on how Employ use Cookies and similar technologies, please see Employ’s Cookie Policy.

To manage the use of targeting and advertising cookies on this website, click the Cookie Preferences link in the footer of the page or consult your individual browser settings for cookies. To learn how to manage privacy and storage settings for Flash cookies, click here. Various browsers may also offer their own management tools for removing HTML5 local storage. To learn more about targeted advertising and advertising networks, please visit the opt-out pages of the Network Advertising Initiative, here, and the Digital Advertising Alliance, here.

_Social Media Features_

Our websites may use social media features, such as sharing widgets (“Social Media Features”). Social Media Features may allow you to post information about your activities on Employ website to outside platforms and social networks. Social Media Features may also allow you to like or highlight information Employ have posted on Employ website or Employ branded social media pages. Social Media Features are either hosted by each respective platform or hosted directly on Employ website. To the extent the Social Media Features are hosted by the platforms themselves, and you click through to these from Employ websites, the platform may receive information showing that you have visited Employ websites. If you are logged in to your social media account, it is possible that the respective social media network can link your visit to Employ websites with your social media profile.

Employ also allows you to log in to certain Employ websites using sign-in services. These services authenticate your identity and provide you the option to share certain Personal Data from these services with Employ such as your name and email address to pre-populate Employ sign-up form.

Your interactions with Social Media Features are governed by the privacy policies of the companies providing them.

_Telephony log information_

If you use certain features of Employ services on a mobile device, Employ may also collect telephony log information (like phone numbers, time and date of calls, duration of calls, SMS routing information and types of calls), device event information (such as crashes, system activity, hardware settings, browser language), and location information (through IP address, GPS, and other sensors that may, for example, provide Employ with information on nearby devices, Wi-Fi access points and cell towers).

**5\. Purposes for Processing and Legal Basis**

Employ collect and process your Personal Data (including, where legally permissible, special categories of Personal Data) for the following purposes and relying on the following legal bases:

|     |     |     |
| --- | --- | --- |
| Purpose | Description | Legal basis |
| Websites and social media branded pages |     |     |
| Providing Employ websites (including Employ social media pages) | Employ processes your Personal Data to operate and administer Employ websites and to provide you with the content you access and request | Employ legitimate interest in providing online content to Employ customers and prospective customers regarding Employ service offering and related information |
| Improving Employ websites | Employ processes your Personal Data to analyze overall trends and help Employ improve the user experience on Employ websites | Our legitimate interest in providing a relevant and well-functioning website for the benefit of Employ website visitors |
| Promoting the security of Employ websites | Employ processes your Personal Data by tracking use of Employ websites and verifying and investigating activity | Our legitimate interest in promoting the safety and security of Employ websites and in protecting Employ rights and the rights of others |
| Displaying personalized advertisements and content | Employ processes your Personal Data to conduct market research, advertise to you, provide personalized information about Employ on and off Employ websites and to provide other personalized content based upon your activities and interests | Our legitimate interest in advertising Employ products and services or, where necessary, to the extent you have provided your prior consent Please see Section 10 below, to learn how you can control the processing of your Personal Data by Employ for personalized advertising purposes |
| Office visitors and events |     |     |
| Registering visitors | Employ processes your Personal Data, including registration information and associated non-disclosure information, for security reasons | Our legitimate interest in protecting Employ offices, staff, visitors and Employ confidential information against unauthorized access |
| Managing event registrations and attendance | Employ processes your Personal Data to plan and host events or webinars for which you have registered or that you attend, including sending related communications to you | Performance of a contract or where Employ receives your consent |
| Ensuring the health and safety of Employ visitors and employees | Employ processes your Personal Data (which may include special categories of Personal Data) (where legally permitted) during office visits and at events during the COVID-19 pandemic to ensure the health and safety of Employ visitors and employees | Consent and explicit consent or in Employ legitimate interest to ensure the health of Employ employees and visitors where necessary for reasons of public interest in the area of public health |
| Communications |     |     |
...
**9\. How long does Employ keep your Personal Data?**
...
Employ encourages you to periodically review this Privacy Notice to stay informed about Employ collection, processing and sharing of your Personal Data.
