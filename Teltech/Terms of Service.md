...
If your usual residence is in the European Economic Area, the United Kingdom or Switzerland, these [Terms of Service](https://teltech.co/l) apply to you.
...
**Please read carefully:** These Terms of Service (these “**Terms**”) constitute a legally binding agreement between you and Bending Spoons Operations S.p.A., with offices at Via Nino Bonnet 10, 20154 Milan, Italy, VAT, tax code and registration number with the Milan Monza Brianza Lodi Company Register 13368510965, REA number MI 2718456 (collectively with its successors in interest and permitted assigns, “**Bending Spoons**,” “**we**,” “**us**” or “**our**”). For purposes of these Terms, “you” and “your” refer to any customer or end user of the Apps, any visitor to the Sites, or any person who otherwise accesses or uses our Service. These Terms govern your access to and use of our websites where these Terms are posted (the “**Sites**”), our mobile applications (each, an “App” and, collectively, the “**Apps**”), and our related content, products, and services (collectively, and together with the Sites and the Apps, the “**Service**”).
...
If you have questions or complaints with respect to these Terms or our Service, visit our [support center](https://support.bendingspoons.com/) or the App-specific support pages linked below.
...
Please refer to the applicable privacy policy available in the App or in the relevant App Marketplace (as defined below) for information on how we process your personal data, treat your information and protect your privacy when you use the Service.

3. **Eligibility**
    

**OUR SERVICE IS NOT AVAILABLE TO INDIVIDUALS UNDER THE AGE OF 16.** If you are over the age of 16 but under the legal age of majority in your state or country of residence, your parent or guardian must review and agree to be bound by these Terms on your behalf and must supervise your use of the Service. The parent or legal guardian of a user under the legal age of majority is fully responsible for the acts or omissions of that under-age user in relation to our Service.

You may not download and use the Apps in any jurisdiction expressly prohibited by Bending Spoons. You represent and warrant that: (i) you are not located in a country that is subject to a U.S. Government embargo, or that has been designated by the U.S. Government as a “terrorist supporting” country; and (ii) you are not listed on any U.S. Government list of prohibited or restricted parties.
...
Except as expressly permitted by these Terms and the terms applicable to the mobile application store where we make the applicable App available (each, an “**App Marketplace**”), you agree that you will not: (a) rent, lease, lend, sell, distribute, sublicense, or otherwise transfer or make available the Service; (b) copy, decompile, reverse engineer, disassemble, attempt to derive the source code of, modify, alter, mimic, adapt, translate, or create derivative works of the Service, any updates, content or any part thereof (except as and only to the extent any foregoing restriction is prohibited by applicable law or to the extent as may be permitted by the licensing terms governing use of any open source components included with the Service); (c) violate any applicable law, contract, intellectual property right, or other third-party right or commit a tort; (d) develop or use any applications or software that interact with our Service without our prior written consent; or (e) use our Service for any illegal or unauthorized purpose, or engage in, encourage, or promote any activity that violates these Terms.
...
* Use the Service for any purposes prohibited by applicable laws or regulations, including telecommunications, privacy, and consumer protection laws, or in any manner that violates or infringes upon the rights of others;
    
* Import, submit, upload, publish, post, communicate, or transmit to others in any way whatsoever, any unlawful, fraudulent, deceptive, harmful, defamatory, inaccurate, abusive, offensive, threatening, intimidating, predatory, malicious, stalking, hateful, violent, harassing, discriminatory or racist content, or any content that infringes or violates another person’s rights (including, but not limited to, intellectual property rights, and rights of privacy and publicity);
    
* Send, distribute, or post spam, unsolicited or bulk commercial electronic communications, or pyramid schemes;
...
In order to allow us to operate, provide you with, and improve the Service and our technologies (and to develop new ones), we must obtain from you certain rights in and to the User-Generated Content. You hereby grant us a license to access, use, modify, store, and reproduce User-Generated Content for the purposes of operating, developing, and improving the Service or new technologies or services, all in accordance with the applicable privacy policy (please refer to Section 2 (**Privacy**) for the applicable privacy policy). You will not be entitled to compensation for any use of the User-Generated Content by us under these Terms.

You are solely responsible for the User-Generated Content, and you represent and warrant that such content will not infringe upon or violate the rights of any person, that it complies with these Terms and any applicable law, and that you have all the rights and authorizations necessary to grant the license in the paragraph above and to upload, store, receive, create, modify, share or publish the User-Generated Content on or through the Service and, when applicable, in connection with the Promotion. We expressly disclaim any duty or obligation to undertake any monitoring or review of any User-Generated Content and, should your User-Generated Content violate these Terms, we may terminate or suspend your access to all or part of the Service, take any action with respect to your User-Generated Content that is necessary or appropriate, or cooperate fully with any law enforcement authorities or court order with respect to the User-Generated Content.

We welcome feedback, comments, and suggestions for improvements to the Service (in written, oral, or any other form) (“**Feedback**”). If you provide any Feedback, we may use it without restriction or compensation to you.
...
You acknowledge and agree that your use of any Third-Party Services and Third-Party Materials may be subject to terms and conditions provided by applicable third parties and agree that, if applicable, you will comply with them.
...
We may suspend or terminate your access to your account (if any) and any portion or all of the Service for any reason, including if, in our sole judgment, we determine: (i) there is a threat or attack on any of our services or systems, or any data stored thereon; (ii) your use of the Service disrupts or poses a security risk to us or any of our customers or vendors; (iii) you are using the Service for purposes of engaging in, or your account is being used to engage in, fraudulent or illegal activities; (iv) our provision of the Service to you is prohibited by applicable law or regulation; (v) you fail to comply with one or more provisions of these Terms, or we suspect that you are in violation of, or reasonably likely to be in violation of, one or more provisions of these Terms; or (vi) any of our licensors or vendors restricts, suspends, or terminates our access to one or more Third-Party Services or Third-Party Materials that are required for the provision of or access to the Service. We will use reasonable efforts to provide notice of any suspension of the Service to you and to provide updates regarding resumption of access to the Service following any suspension. We will have no liability for any damage, liabilities, losses (including any loss of data or profits), or any other consequences resulting from a Service suspension.

15. **Termination**
    

These Terms are effective until you perform each of the following, as applicable: (i) stop using our Service, (ii) uninstall and delete all copies of all Apps in your possession, (iii) cancel any account, and (iv) cancel all active subscriptions. You may stop using the Service at any time. Please refer to Section 6 (**Purchases, Subscriptions, Promotional Codes, and Auto Renewals**) and the App-specific terms, below, for information on how you can cancel your subscription or any automatic renewals.

We may terminate these Terms at any time and for any reason by making reasonable efforts to provide you with notice of such termination. Your rights under these Terms will terminate automatically if you fail to comply with any of its provisions.

Upon expiration, termination, or cancellation of these Terms for any reason, (a) you must cease all use of the Service and uninstall and delete all copies of all Apps and our software, documents, and materials included with or relating to the Service in your possession, and (b) all rights and obligations of both parties to these Terms, including all licenses granted under these Terms, will immediately terminate. The provisions of these Terms that are by their nature intended to survive termination or expiration of these Terms will so survive.

16. **Account**
    

If the Service allows you or requires you to provide registration information and create an account, these Terms also govern your account. You agree that you will provide only true, current and accurate information when you create your account or provide us with the required information, and that you meet the eligibility requirements under these Terms. You agree to update your registration information to keep it accurate and current.
...
These Terms, and any dispute, claim (including non-contractual disputes or claims), or matters arising out of or in connection with these Terms will be governed by, and construed in accordance with, the substantive laws of the State of New York, U.S., excluding any conflict-of-laws rule or principle that might refer the governance or the construction of these Terms to the law of any other jurisdiction.

18. **Dispute Resolution; Binding Individual Arbitration**
    

**PLEASE READ THIS SECTION CAREFULLY BECAUSE IT REQUIRES YOU AND BENDING SPOONS TO ARBITRATE CERTAIN DISPUTES AND CLAIMS AND LIMITS THE MANNER IN WHICH WE CAN SEEK RELIEF FROM EACH OTHER. ARBITRATION PRECLUDES YOU AND BENDING SPOONS FROM SUING IN COURT OR HAVING A JURY TRIAL. YOU AND BENDING SPOONS AGREE THAT ARBITRATION WILL BE SOLELY ON AN INDIVIDUAL BASIS AND NOT AS A CLASS ARBITRATION, CLASS ACTION, OR ANY OTHER KIND OF REPRESENTATIVE PROCEEDING. BENDING SPOONS AND YOU ARE EACH WAIVING THE RIGHT TO TRIAL BY A JURY.**
...
> **a) Claims Subject to this Section**. The dispute resolution and binding arbitration terms in this Section 18 apply to all Claims between you and Bending Spoons. A “**Claim**” is any dispute, claim, cause of action, or controversy (excluding those exceptions listed below) between you and Bending Spoons, whether based in contract, tort, statute, fraud, misrepresentation, or any other legal theory for which either party wishes to seek legal recourse and that arises from or relates to these Terms or our Service, including any related to privacy or data-security or to the formation, validity, enforceability, revocability, performance, breach, or scope of the Terms or arbitration agreement or any portion of it or arising out of or relating to interpretation or application of the Terms or arbitration agreement.
> 
> **b) Informal Dispute Resolution Prior to Arbitration**. If you have a Claim against Bending Spoons or if Bending Spoons has a Claim against you, you and Bending Spoons must first attempt to resolve the Claim informally in order to try to resolve the Claim faster and reduce costs for both parties. You and Bending Spoons will make a good-faith effort to negotiate the resolution of any Claim for 45 days, or such longer period as mutually agreed in writing (email suffices) by the parties (“**Informal Resolution Period**”), from the day either party receives a written notice of a dispute from the other party (a “**Claimant Notice**”) in accordance with these Terms.
> 
> You will send any Claimant Notice to Bending Spoons by certified mail addressed to Via Nino Bonnet, 20154 Milan, Italy or by email to bspoperations@legalmail.it. Bending Spoons will send any Claimant Notice to you by certified mail or email using the contact information you have provided to Bending Spoons or via reasonably available means of notice if you have not provided certified mail or email contact information to Bending Spoons. The Claimant Notice sent by either party must (i) include the sender’s name, address, email address, telephone number, and any relevant purchase information; (ii) describe the nature and basis of the Claim; and (iii) set forth the specific relief sought.
> 
> The Informal Resolution Period is intended to allow the party who has received a Claimant Notice to make a fair, fact-based offer of settlement if it chooses to do so. You or Bending Spoons cannot initiate arbitration before the end of the Informal Resolution Period. If you or Bending Spoons file a Claim in court or initiate arbitration without first providing a compliant Claimant Notice and waiting until the conclusion of the Informal Resolution Period, the other party reserves the right to seek relief from a court or arbitrator to enjoin the filing or arbitration and seek damages from the party that has not followed the informal dispute-resolution process to reimburse it for any costs and fees—including arbitration, attorney, and expert fees—incurred as a foreseeable consequence of that breach.
> 
...
> 
> **c) Claims Subject to Binding Arbitration; Exceptions**. Except for individual disputes that qualify for small-claims court (provided that the small-claims court does not permit class or similar representative actions or relief) and any disputes exclusively related to the intellectual property or intellectual-property rights of you or Bending Spoons, including any disputes in which you or Bending Spoons seek injunctive or other equitable relief for the alleged unlawful use or infringement of your or Bending Spoons’ intellectual property (“**IP Claims**”), all Claims, including Claims that are not related to intellectual property but are jointly filed with IP Claims, that are not resolved in accordance with Section 18(b) will be resolved by a neutral arbitrator through final and binding arbitration instead of in a court by a judge or jury.
> 
...
> 
> The arbitrator (not a judge or jury) will resolve all Claims in arbitration. Unless you and Bending Spoons agree otherwise, any decision or award will include a written statement stating the decision of each Claim and the basis for the award, including the arbitrator’s essential factual and legal findings and conclusions.
> 
...
> 
> **f) Arbitration Fees.** Except for circumstances outlined in Sections 18(g) and 18(h), each party will be responsible for arbitration fees in accordance with the applicable Rules and these Terms.
> 
...
> 
> **i) One Year to Assert Claims. TO THE EXTENT PERMITTED BY LAW, ANY CLAIM BY YOU OR BENDING SPOONS AGAINST THE OTHER MUST BE FILED WITHIN ONE YEAR AFTER SUCH CLAIM ARISES; OTHERWISE, THE CLAIM IS PERMANENTLY BARRED, WHICH MEANS THAT YOU OR BENDING SPOONS WILL NO LONGER HAVE THE RIGHT TO ASSERT THAT CLAIM.**
> 
> **j) Confidentiality.** If you or Bending Spoons submits a Claim to arbitration, you and Bending Spoons agree to cooperate to seek from the arbitrator protection for any confidential, proprietary, trade secret, or otherwise sensitive information, documents, testimony, and other materials that might be exchanged or the subject of discovery in the arbitration. You and Bending Spoons agree to seek such protection before any such information, documents, testimony, or materials are exchanged or otherwise become the subject of discovery in the arbitration.
> 
> **k) Coordinated Filings.** If 25 or more Claimant Notices are received by a party that raise similar claims and have the same or coordinated counsel, these will be considered “**Coordinated Claims**” and will be treated as mass filings, mass arbitrations or multiple case filings according to the Rules (including, when applicable, AAA’s Mass Arbitration Supplementary Rules), if and to the extent Coordinated Claims are filed in arbitration as set forth in these Terms. You or Bending Spoons may advise the other of your or its belief that Claims are Coordinated Claims, and disputes over whether a Claim meets the definition of “Coordinated Claims” will be decided by the arbitration provider as an administrative matter. The following procedures are intended to supplement the Rules, and to the extent the procedures conflict with those Rules, to supersede them.
> 
...
> 
> **l) Opting Out of Arbitration**. You have the right to opt out of binding arbitration within 30 days from the date when these Terms first become binding on you by providing us with notice of your decision to opt out via email at bspoperations@legalmail.it or by certified mail addressed to Via Nino Bonnet 10, 20154 Milan, Italy. To be effective, the opt-out notice must include your full name, mailing address, and email address. The notice must also clearly indicate your intent to opt out of binding arbitration. If you opt out of this updated arbitration clause and were previously subject to an arbitration clause in effect prior to this updated arbitration clause, then that prior arbitration clause shall remain as the arbitration clause between us. If you are a new user and did not previously consent to the prior arbitration clause and you choose to opt-out of this updated arbitration clause, then we will also not be bound by this updated arbitration clause.
> 
> **m) Rejection of Future Arbitration Changes.** You may reject any change we make to Section 18 (except address changes) by sending us notice of your rejection within 30 days of the change via email at bspoperations@legalmail.it or by certified mail addressed to Via Nino Bonnet 10, 20154 Milan, Italy. Changes to Section 18 may only be rejected as a whole, and you may not reject only certain changes to Section 18. If you reject changes made to Section 18, the most recent version of Section 18 that you have not rejected will continue to apply.
> 
> **n) Severability**. If any portion of this Section 18 is found to be unenforceable or unlawful for any reason, including but not limited to because it is found to be unconscionable, (i) the unenforceable or unlawful provision will be severed from these Terms; (ii) severance of the unenforceable or unlawful provision will have no impact whatsoever on the remainder of this Section 18 or the parties’ ability to compel arbitration of any remaining claims on an individual basis pursuant to this Section 18; and (iii) to the extent that any claims must therefore proceed on a class, collective, consolidated, or representative basis, such claims must be litigated in a civil court of competent jurisdiction and not in arbitration. The litigation of those claims will be stayed pending the outcome of any individual claims in arbitration. Further, if any part of this Section 18 is found to prohibit an individual claim seeking public injunctive relief (that is, injunctive relief whose primary purpose and effect is to prohibit and enjoin conduct harmful to the general public), that provision will have no effect to the extent such relief is allowed to be sought out of arbitration, and the remainder of this Section 18 will be enforceable. To the extent that you prevail on a Claim and seek public injunctive relief, the entitlement to and extent of such relief must be litigated in a civil court of competent jurisdiction and not in arbitration. The parties agree that litigation of any issues of public injunctive relief shall be stayed pending the outcome of the merits of any individual Claims in arbitration.

19. **General**
    

Unless otherwise stated in these Terms, we may issue any notice that is required or referenced in these Terms to you by (a) email, (b) posting notice through the Service, or (c) any other legally accepted means. It is your responsibility to keep your information current to receive notifications and to check the Service regularly (for example, by opening the App once a month). Notices sent by email will be effective when we send the email to the address you provided to us; and notices we provide by posting will be effective upon posting. To give us notice under these Terms, you must contact us as follows: (1) by email to bspoperations@legalmail.it, or (2) by personal delivery, overnight courier or registered or certified mail to Via Nino Bonnet 10, 20154 Milan, Italy, Attention: Legal. Notices provided by personal delivery will be effective immediately. Notices provided to us by email or overnight courier will be effective one business day after they are sent. Notices provided to us by registered or certified mail will be effective three business days after they are sent.
...
Except as expressly provided in Sections 8 (**Our Intellectual Property Rights**), 10 (**Third-Party Services, Materials and Advertising**), 12 (**Indemnification**), 19 (**General**), and 20 (**Additional Terms for App Marketplaces**) there are no third-party beneficiaries to these Terms other than each of our affiliates.
...
**Call Recording Feature**. Certain states or countries may have laws prohibiting the recording of calls without consent from all parties to the call. You may violate a state’s or country’s criminal law or create civil liability for yourself by listening in on or recording a telephone conversation without first informing all other parties that you are doing so. Bending Spoons may, in its discretion, add beeps, tones, or other auditory notification features to the Apps. Bending Spoons makes no warranties, express or implied, that use of such features, alone, constitute adequate notice under the laws of your state or country. By installing or using the Services, you agree (i) to comply with all applicable laws and regulations (including obtaining consent to record, where applicable); and (ii) that Bending Spoons has no liability for your failure to comply with all applicable laws and regulations.

**Notice to Government End Users**. Any Service provided by Bending Spoons or its affiliates installed for or on behalf of the United States, its agencies and/or instrumentalities ("**United States Government**"), are provided with restricted rights as "commercial products" or “commercial services,” as those terms are defined at 48 CFR § 2.101, consisting of "Commercial Computer Software" and "Commercial Computer Software Documentation," as such terms are used in 48 CFR §12.212 or 48 CFR § 227.7202 et seq., as applicable. Pursuant to 48 CFR §12.212, the United States Government shall have only those rights specified in the license contained herein. The United States Government shall not be entitled to (i) technical information that is not customarily provided to the public or to (ii) use, modify, reproduce, release, perform, display, or disclose commercial computer software or commercial computer software documentation except as specified herein. Use, duplication, or disclosure by the United States Government is subject to restrictions as set forth in 48 CFR § 252.227-7013 or 48 CFR § 52.227-19, as applicable.
...
* These Terms are between you and Bending Spoons, and not Apple Inc. or its subsidiaries (collectively, “**Apple**”), and as between Bending Spoons and Apple, Bending Spoons is solely responsible for the App and the content thereof.
...
* In the event of any third-party claim that the App or your possession and use of the App infringes that third party’s intellectual property rights, as between Apple and Bending Spoons, Bending Spoons will be solely responsible for the investigation, defense, settlement and discharge of any such intellectual property infringement claim.
...
**Access to Contacts**. In order to provide the Service, Robokiller must access the numbers in your Device’s address book.

**Answer Bots**. Robokiller provides you the option to use its Answer Bots to respond to unwanted spam and robocallers. Answer Bots are pre-recorded audio messages. You can choose whichever Answer Bot you like or make your own audio content and recordings (“**Audio(s)**”). If you choose not to use Answer Bots, unwanted spam and robocallers will hear a very polite but concise default recording. When unwanted spam and robocallers engage with one of Robokiller’s Answer Bots, the conversation is recorded as a voicemail and saved within the App (“**Answer Bot Recording**”). By using Robokiller’s Answer Bot feature, you expressly authorize us to record Answer Bot conversations on your behalf.
...
* you will share Audio and/or Answer Bot Recordings strictly from unsolicited, unwanted spam and robocallers and you will not share any Audio and/or Answer Bot Recordings from people with whom you have an established relationship with (e.g., signing up to receive offers);
...
* Bending Spoons will not need to obtain any rights, permissions and/or licenses from any third party or pay royalties to any third party in order to make the Audio and/or Answer Bot Recording publicly available;
...
* the Audio and/or Answer Bot Recording comply with these Terms, all applicable laws as well as the terms of use of any social media platform or application.
    

Users may also share their own unique Answer Bot Audio creations with Robokiller either directly within the App or via email. As between you and Bending Spoons, you own the Audios that you create and submit to Robokiller. By submitting your Audios, you grant Bending Spoons and its affiliates, a limited, worldwide, non-exclusive, royalty-free license and right to access, use, copy, transmit, reproduce, distribute, publicly perform and display (through all media now known or hereinafter created) and make derivative works from your Audios for the purpose of: (i) making the Audios available for review by Bending Spoons; (ii) providing the Audios on social media and other platforms; (iii) allowing other Robokiller Users to play, download and use your Audios within the App; (iv) promoting Robokiller’s Answer Bots, provided you have made your Audios publicly available; and (v) archiving or preserving the Audios for disputes, legal proceedings, or investigations. You further grant all Robokiller Users the ability to view your Audios for personal, non-commercial purposes. This includes the right to copy and make derivative works from the Audios solely to the extent necessary to view the Audios. The aforementioned licenses will continue unless and until you remove your Audios from the App, in which case the licenses will terminate within a commercially reasonable time. Notwithstanding the foregoing, the license for legal archival/preservation purposes will continue indefinitely.
...
**Call Recordings**. Your version of the App may include call recording capabilities. If so, by using the App, you acknowledge and expressly agree that (i) you are the sole party responsible for initiating a call recording, and (ii) you have provided appropriate notice or obtained appropriate consents, as necessary under the laws of your state or country, to record all parties to the call.

**Call Data Retention**. Your personal data will be retained according to the retention periods outlined in the App’s Privacy Policy. We make no guarantees that we will retain certain call data such as calls, call recordings, voicemail, call screens, Answer Bots and transcriptions for greater than six months, after which we may delete any such call data. If you would like to retain this information, you can go to the App’s call details and share the information to your email or cloud storage account. You acknowledge that you bear sole responsibility for the back-up of this information. If you delete your account, your calls, call recordings, voicemail, call screens, Answer Bots and transcriptions will be deleted from our servers and no longer accessible. If you delete a recording, it will be deleted from our servers and no longer accessible. If you want to retain recordings or other call data for longer, you should go to call details and share information with your email or cloud storage account. You acknowledge and agree that you bear sole responsibility for the back-up of this information.
...
**Personal Data Protection.** Robokiller provides you with the option to purchase a personal data protection feature within the App. If purchased, the personal data protection service will regularly use your information to scan online data broker websites (“**Data Sites**”) for personal information about you. Sometimes these Data Sites are called people search sites. If online personal information about you is identified at these Data Sites, Bending Spoons or its designated third party partner will submit opt-out requests on your behalf to remove such personal information (“**Opt-Out**”). You can go to the App at any time to see if online personal information about you was found on these Data Sites and whether the Opt-Out was successful. Bending Spoons may change the Data Sites that are being scanned at any time without notice to you. In order to submit an Opt-Out request to remove your personal information from Data Sites, Bending Spoons, or its designated third party partner, may need to interact with Data Sites on your behalf. Solely in connection with and for the purpose of providing the personal data protection service, you expressly authorize Bending Spoons, its agents, service providers, and its employees, to act as your personal representative in order to submit Opt-Out requests to Data Sites and:
...
* take other actions that Bending Spoons may believe are reasonably necessary to complete an Opt-Out request from a Data Site or to implement the personal data protection feature.
    

Bending Spoons does not guarantee that the personal data protection feature will find a user’s online personal information at any of the Data Sites, or that it will scan all Data Sites. Bending Spoons does not guarantee that the personal data protection feature will be 100% accurate or effective, that an Opt-Out request will be honored or responded to, or that all Opt-Out requests will be equivalent. Bending Spoons does not guarantee that an Opt-Out request will prevent all of any future uses or disclosures of a user’s online personal information by a Data Site, that Robokiller will identify all instances of a user’s online personal information that are eligible for Opt-Out, or that the Data Sites will not retain copies of a user’s online personal information.

Some Data Sites may have multiple databases and may acquire and aggregate personal information about individuals on an ongoing basis. The Opt-Out request we submit on your behalf may not be effective for all sources of personal information maintained by the Data Site, or for online personal information acquired by the Data Site after Robokiller submits the Opt-Out request. In addition, Robokiller may not locate all entries or the correct entries of your online personal information that are eligible for Opt-Out. Not all Data Sites offer the same type of Opt-Out options and you may be required to take further action directly with certain Data Sites to make your Opt-Out request. Further, in some instances, even if Robokiller is able to effectively submit an Opt-Out request on your behalf to a Data Site, we cannot guarantee that the Data Site will delete all of your online personal information in its records or that it will honor our request.

Bending Spoons makes no representations, warranties or guarantees related to such Data Sites. You understand and agree that Bending Spoons is not responsible for the acts or omissions of any of these Data Sites and that you will not hold Bending Spoons liable for such acts or omissions or for Bending Spoons’ failure for any reason to obtain effective Opt-Outs on your behalf. You understand and agree that Bending Spoons is not a credit repair organization as defined under federal or state law, including the Credit Repair Organizations Act.

**Phone Number Lookup Website.** [Lookup.Robokiller.com](https://lookup.robokiller.com/), or any successor site, allows you the ability to look up a phone number to assess whether such a number is a nuisance call. We may use anonymized recordings and transcripts of spam messages collected through the Service to provide this information. Any feedback provided by Robokiller users within the App may appear as comments for a given number.

**Unsubscribing from Robokiller.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available on the Robokiller [Help](https://support.robokiller.com/hc/en-us/articles/20013745596052-How-do-I-cancel-my-subscription) Center.

**Account Deletion**. The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your Robokiller account nor will it cancel your subscription. In order to cancel your Robokiller subscription, you must follow the steps detailed herein.

**No Representations or Warranties**. Bending Spoons endeavors to provide the most accurate data available and to only block calls that are unwanted nuisance calls. Bending Spoons makes no representations or warranties of any kind about the Robokiller Service and makes no guarantee concerning the accuracy of the results that Robokiller provides.

**Support**. For more information on Robokiller, please visit the Robokiller Help Center.

22. **Additional Terms for TapeACall**
    

**General**. TapeACall offers you the ability to record audio and calls (e.g., local toll, domestic long distance and international telephone calls, and conference calls) and provides you with transcripts, transcription summaries and transcription translations of such audio and call recordings.
...
**Call Data Retention**. Your personal data will be retained according to the retention periods outlined in the App’s Privacy Policy. We make no guarantees that we will retain certain call data such as calls, call recordings, audio recordings and transcriptions for greater than six months, after which we may delete such call data. Standard and Premium subscribers will be able to retain this information past six months by going to the App’s call details and sharing information to an email or cloud storage account. You acknowledge that you bear sole responsibility for the back-up of this information. If you delete your account, your calls, call recordings, voicemail, call screens, Answer Bots and transcriptions will be deleted from our servers and no longer accessible. If you delete a recording, it will be deleted from our servers and no longer accessible. If you want to retain recordings or other call data for longer, you should go to call details and share information with your email or cloud storage account. You acknowledge and agree that you bear sole responsibility for the back-up of this information.

**Unsubscribe from TapeACall**. You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available on the TapeACall [Help Center](https://support.tapeacall.com/hc/en-us/articles/360006659052-How-do-I-cancel-my-subscription).

**Account Deletion**. The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your TapeACall account nor will it cancel your subscription. In order to cancel your TapeACall subscription, you must follow the steps detailed herein.

**Support**. For more information on TapeACall, please visit the TapeACall [Help Center](https://support.tapeacall.com/hc/en-us).

23. **Additional Terms for TrapCall**
...
**Call Data Retention**. Your personal data will be retained according to the retention periods outlined in the App’s Privacy Policy. We make no guarantees that we will retain certain call data such as calls, call recordings, voicemail, and transcriptions for greater than six months, after which we may delete such call data. If you want to retain this information longer, you should go to the App’s call details and share the information to your email or cloud storage account. You acknowledge that you bear sole responsibility for the back-up of this information. If you delete your account, your calls, call recordings, voicemail, call screens, Answer Bots and transcriptions will be deleted from our servers and no longer accessible. If you delete a recording, it will be deleted from our servers and no longer accessible. If you want to retain recordings or other call data for longer, you should go to call details and share information with your email or cloud storage account. You acknowledge and agree that you bear sole responsibility for the back-up of this information.

**Unsubscribing from TrapCall.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available on the TrapCall [Help Center](https://support.trapcall.com/hc/en-us/articles/115001874566-How-do-I-cancel-my-subscription).

**Account Deletion.** The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your TrapCall account nor will it cancel your subscription. In order to cancel your TrapCall subscription, you must follow the steps detailed herein.

**Support**. For more information on TrapCall, please visit the TrapCall [Help Center](https://support.trapcall.com/hc/en-us).

24. **Additional Terms for TextKiller**
    

**General**. TextKiller analyzes, filters and protects you against annoying or malicious Short Message Service (SMS) and Multimedia Messaging Service (MMS) messages by filtering those messages from individuals and numbers not in your Device’s contacts. Messages from unknown numbers that are identified as spam will appear in your spam or junk messages folder located in your Device’s native messages application.

**Spam Protection.** When you download TextKiller and begin the setup process, TextKiller will require that you follow the instructions provided in the App in order to allow TextKiller to filter your messages.

**Unsubscribing from TextKiller.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available in the App’s Settings under Help & Support.

**Account Deletion.** The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your TextKiller account nor will it cancel your subscription. In order to cancel your TextKiller subscription, you must follow the steps detailed herein.

**Support**. For more information on TextKiller, please visit [https://support.bendingspoons.com/](https://support.bendingspoons.com/).

25. **Additional Terms for SwitchUp**
...
**Access to Contacts**. In order to provide the Service, SwitchUp must access the numbers in your Device’s address book. If you do not permit SwitchUp to access your contacts, we cannot provide the Service to you.

**Access to Microphone**. When you download SwitchUp and begin the setup process, SwitchUp will ask permission to access your Device’s microphone. Access to your Device’s microphone is required in order for SwitchUp to ensure that you can record a custom voicemail prompt for callers.

**SwitchUp Numbers**. You acknowledge and agree that you have no ownership rights in the phone numbers issued to you through the SwitchUp App (each a "**SwitchUp Number**") and you do not have any rights to transfer or use the SwitchUp Numbers separate and apart from the SwitchUp App. Bending Spoons may, in its discretion, allow you to port your SwitchUp Number to another service. If you wish to port over your SwitchUp Number, contact SwitchUp support (email provided below). You understand and agree that Bending Spoons may reclaim the SwitchUp Numbers and/or discontinue availability for any reason and at any time, without liability to you.

**Emergency Calls**. SwitchUp Numbers cannot be used for inbound or outbound emergency calling or texting (including calls or texts to 911 or your country’s equivalent emergency number) and you understand and agree that you should not rely on SwitchUp for emergency texting or calling capability. You must make alternative arrangements to place emergency calls using your landline or the emergency line associated with your Device.
...
* use SwitchUp for making phone calls in any manner that violate any applicable law or regulations;
    
* use SwitchUp for automated or robocalling, or for unsolicited marketing or consumer research communications; or
    
* USE YOUR SWITCHUP NUMBER AS A SUBSTITUTE FOR A TRADITIONAL TELEPHONE NUMBER AND THAT YOU WILL AT ALL TIMES HAVE AVAILABLE A MOBILE OR TRADITIONAL LANDLINE PHONE THAT CAN BE USED TO MAKE OUTBOUND CALLS, INCLUDING CALLING 911 OR ANY OTHER APPLICABLE EMERGENCY SERVICES.
    

**Additional Limitations of Liability**. You agree that Bending Spoons, its directors, officers, employees, subsidiaries and assigns may not be held liable for any claim, damage, or loss (including, without limitation, any attorneys' fees) by, or on behalf of, you or any third-party user arising from (i) any attempt to text or dial an emergency telephone number using SwitchUp or a SwitchUp Number; and (ii) any communications or any content of any kind that you transmit through your use of SwitchUp.

**Unsubscribing from SwitchUp.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available on the SwitchUp [Help Center](https://support.getswitchup.com/hc/en-us/articles/360050315212-Subscriptions).

**Account Deletion.** Please remember that simply deleting the App will not deactivate your SwitchUp account nor will it cancel your subscription. In order to cancel SwitchUp, you must follow the steps detailed above.

**Support.** For more information on SwitchUp, please visit the SwitchUp [Help Center](https://support.getswitchup.com/hc/en-us).
...
**Please read carefully:** These Terms of Service (these “**Terms**”) constitute a legally binding agreement between you and Bending Spoons Operations S.p.A., with offices at Via Nino Bonnet 10, 20154 Milan, Italy, VAT, tax code and registration number with the Milan Monza Brianza Lodi Company Register 13368510965, REA number MI 2718456 (collectively with its successors in interest and permitted assigns, “**Bending Spoons**” “**we**,” “**us**” or “**our**”). For purposes of these Terms, “you” and “your” refer to any customer or end user of the Apps, any visitor to the Sites, or any person who otherwise accesses or uses our Service. These Terms govern your access and use of our websites where these Terms are posted (the “**Sites**”), our mobile applications (each, an “**App**” and, collectively, the “**Apps**”), and our related content, products, and services (collectively, and together with the Sites and the Apps, the “**Service**”).
...
Please refer to the applicable privacy policy available in the App or in the relevant App Marketplace (as defined below) for information on how we process your personal data.
...
Except as expressly permitted by these Terms and the terms applicable to the mobile application store where we make the applicable App available (each, a “**App Marketplace**”), you agree that you will not: (a) rent, lease, lend, sell, distribute, sublicense, or otherwise transfer or make available the Service; (b) copy, decompile, reverse engineer, disassemble, attempt to derive the source code of, modify, alter, mimic, adapt, translate, or create derivative works of the Service, any updates, content or any part thereof (except as and only to the extent any foregoing restriction is prohibited by applicable law or to the extent as may be permitted by the licensing terms governing use of any open source components included with the Service); (c) violate any applicable law, contract, intellectual property right, or other third-party right or commit a tort; (d) develop or use any applications or software that interact with our Service without our prior written consent; or (e) use our Service for any illegal or unauthorized purpose, or engage in, encourage, or promote any activity that violates these Terms.
...
6. **Purchases, Subscriptions, Promotional Codes, Auto Renewals, Changes to Fees and Withdrawal Right**
...
The validity of these Terms and the validity of any purchase associated with the Service will be considered independently from each other, meaning that the termination of such associated purchase will not affect the validity of these Terms, and the termination of these Terms may not affect the validity of such associated purchase. To complete your purchase, you must have a valid billing address within a country that can be selected as part of the checkout process using the Service (the “**Territory**”). We make no guarantees that any subscription, promotion, or Virtual Items will be appropriate or available for use in locations outside the Territory. You may only make purchases in connection with the Service for personal use by either yourself or your intended recipient. No aspect of the Service or purchase made in connection with the Service is authorized for resale. We may place, at our own discretion, a limit on the quantities that may be purchased per order, per account, per payment card, per person, or per household. We reserve the right, without prior notice, to refuse service to you or reject any order at any time and refund any money you have paid for such order.
...
The Service or one or more Promotions may provide features that allow you to upload, store, receive, create, modify, share or publish textual, visual, audio or other content (collectively, the “**User-Generated Content**”).
...
These Terms are effective until you perform each of the following, as applicable: (i) stop using our Service, (ii) uninstall and delete all copies of all Apps in your possession, (iii) cancel any account, and (iv) cancel all active subscriptions. You may stop using the Service at any time. Please refer to Section 6 (**Purchases, Subscriptions, Promotional Codes, Auto Renewals, Changes to Fees and Withdrawal Right**) and the App-specific terms, below, for information on how you can cancel your subscription or any automatic renewals.

We may withdraw from our agreement with you under these Terms at any time by making reasonable efforts to provide you with at least a 30 days’ advance notice of such withdrawal. If we withdraw from this agreement, your current subscription period will terminate, and you will be eligible to receive a refund for the portion of the fees you have paid corresponding to the subscription period following our withdrawal.

We may terminate our agreement with you under these Terms with immediate effect if you breach one or more of sections 3 (**Eligibility**), 4 (**End User License**), 7 (**Prohibited Uses**), 9 (**User-Generated Content and Feedback**), and 15 (**Account**). If we terminate this agreement for breach, you will not receive a refund for the fees you already paid.

Upon expiration, termination, or cancellation of these Terms for any reason, (a) you must cease all use of the Service and uninstall and delete all copies of all Apps and our software, documents, or materials included with or relating to the Service in your possession, and (b) all rights and obligations of both parties to these Terms, including all licenses granted under these Terms, will immediately terminate. The provisions of these Terms that are by their nature intended to survive termination or expiration of these Terms will so survive.
...
As an alternative to resolution of disputes through courts, consumers resident in the European Union may refer their complaint to the European Online Dispute Resolution Platform. Consumers may obtain more information by visiting the European Commission’s [Online Dispute Resolution Platform site](https://ec.europa.eu/consumers/odr), or any such successor site.
...
* These Terms are concluded between you and Bending Spoons, and not with Apple Inc. or its subsidiaries (collectively, “**Apple**”), and as between Bending Spoons and Apple, Bending Spoons is solely responsible for the App and the content thereof.
...
20. **Additional Terms for TapeACall**
...
21. **Additional Terms for TextKiller**
    

**General**. TextKiller analyzes, filters and protects you against annoying or malicious Short Message Service (SMS) and Multimedia Messaging Service (MMS) messages by filtering those messages from individuals and numbers not in your Device’s contacts. Messages from unknown numbers that are identified as spam will appear in your spam or junk messages folder located in your Device’s native messages application.

**Spam Protection.** When you download TextKiller and begin the setup process, TextKiller will require you to follow the instructions provided in the App in order to allow TextKiller to filter your messages.

**Unsubscribing from TextKiller.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available in the App’s Settings under Help & Support.

**Account Deletion.** The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your TextKiller account nor will it cancel your subscription. In order to cancel TextKiller, you must follow the steps detailed above.

**Support**. For more information on TextKiller, please visit [https://support.bendingspoons.com/](https://support.bendingspoons.com/).

22. **Additional Terms for Confide**
    

**General.** Confide provides a messaging system designed to ensure a high level of confidentiality of conversations between users. Key features include end-to-end encryption, industry-standard cryptography, transport layer security, ephemeral messages, and screenshot-proof technologies, all aimed at maintaining user confidentiality.

**Minimum levels of quality of service.** We try to provide the best Service we can. However, we cannot guarantee any minimum levels of quality of Service and make no guarantees that our Services will always function without disruptions, delay or errors. A number of factors beyond our control may also impact your experience in using our Service and may result in the disruption of your communication with other users including, but not limited to: your local network, firewall, your internet service provider, the public internet, and power supply.

**Security.** We are committed to protecting the safety, security, and integrity of the by addressing abusive behavior and violations of these Terms. We work to prevent misuse of our Service including harmful conduct towards others, and use systems to improve our ability to detect incidents, threats or vulnerabilities that may harm the security of our Service. If we detect such activity, we will take appropriate action, which may include contacting law enforcement.

**Emergency Services.** Our service is not a substitute for your mobile phone, fixed-line telephone, or SMS services, and it does not provide access to emergency services or connect to public safety answering points (e.g., police, fire departments, or hospitals). You are responsible for ensuring access to emergency services through other means, such as a mobile phone or fixed-line telephone.

**Data You Provide.** Our [Privacy Policy](https://support.bendingspoons.com/privacy?app=779883419&version=1.1.0) includes information on the personal data that is collected to provide the Confide service.

**Unsubscribe from Confide.** You must first cancel your subscription in order to properly delete your account. Instructions for unsubscribing are available on the Confide [Help Center](https://support.getconfide.com/hc/en-us/articles/360060590512-How-do-I-manage-or-cancel-my-Confide-Plus-subscription).

**Account Deletion.** The method of account deletion may vary depending on the plan and Device you have. Instructions for deleting your account are available in your account settings on the App.

Please remember that simply deleting the App will not deactivate your Confide account nor will it cancel your subscription. In order to cancel your Confide subscription, you must follow the steps detailed herein.

**Support.** For more information on Confide, please visit the Confide [Help Center](https://support.getconfide.com/hc/en-us).

**Declaration pursuant to Art. 1341 and 1342 of the Italian Civil Code.**

Pursuant to Articles 1341 and 1342 of the Italian Civil Code, you declare you have read and specifically accept sections 1 **(Changes to the Terms and the Service),** **6 (Purchases, Subscriptions, Promotional Codes, Auto Renewals, Changes to Fees and Withdrawal Right),** **9 (User-Generated Content and Feedback),** **11 (Disclaimer of Warranties),** **12 (Indemnification),** **13 (Limitation of Liability),** **14 (Withdrawal and Termination),** **15 (Account),** **16 (Governing Law and Jurisdiction), and** **18 (General).**
