...
| Financial Information | Credit card number, debit card number, and similar information required to process purchase | Yes | No  | Yes |
| Internet or other electronic network activity | Cookies as described above | Yes | No  | No  |
