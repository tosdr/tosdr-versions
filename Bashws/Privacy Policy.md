...
_Modified 2022-09-05_

This Privacy Policy describes Our policies on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
...
* **Company** (referred to as either "the Website", "the Company", "We", "Us" or "Our" in this Agreement) refers to BASH.WS.
...
* **Website** refers to BASH.WS website, accessible from https://bash.ws.
...
The Google Analytics is used by the Website to get the amount of website visitors. The Google AdSense is used by the Website for advertisement purposes and monetization. These are the only third-party scripts used by the website. If you disagree with this, you can disable Google Analytics and AdSense by the setting below. The Google Analytics and all the third-party scripts are deactivated automatically in the case your browser send Do-Not-Track header.
...
If you have any question please [contact us](https://bash.ws/contact).
