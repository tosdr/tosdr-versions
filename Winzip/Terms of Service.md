[![WinZip](/static/wz/images/logo-winzip.png "WinZip")](https://www.winzip.com/)

* [Products](#)
    
    For home
    
    * [WinZip](https://www.winzip.com/en/product/winzip/)
    * [WinZip Suite](https://www.winzip.com/en/product/winzip/suite/)
    * [WinZip for Mac](https://www.winzip.com/en/product/winzip/mac/)
    * [WinZip PDF Pro](https://www.winzip.com/en/product/pdf-pro/)
    * [View all products](https://www.winzip.com/en/all-products/)
    
    For business
    
    * [WinZip Enterprise](https://www.winzip.com/en/enterprise/)
    * [WinZip Courier](https://www.winzip.com/en/product/courier/)
    * [WinZip SafeMedia](https://www.winzip.com/en/enterprise/safemedia/)
    
    [Download WinZip](https://www.winzip.com/en/download/winzip/)
    
    * [Buy WinZip](https://store.winzip.com/852/purl-suite-buy)
    * [Get a quote](https://www.winzip.com/en/enterprise/)
    * [Why WinZip?](https://www.winzip.com/en/features/)
...
* [Resources](#)
    ...
    * [Unzip files](https://www.winzip.com/en/learn/tutorials/unzip-files/)
    * [Zip files](https://www.winzip.com/en/learn/tutorials/create-zip-files/)
    * [Zip repair](https://www.winzip.com/en/learn/features/repair-zip-files/)
    * [Compress images](https://www.winzip.com/en/learn/features/compress-images/)
    * [Compress video](https://www.winzip.com/en/learn/features/compress-video/)
    * [Compress MP3](https://www.winzip.com/en/learn/features/mp3-compression/)
    
    * [Data protection](https://www.winzip.com/en/features/security/password-protection/)
    * [Password protect](https://www.winzip.com/en/features/security/password-protection/)
    * [File manager](https://www.winzip.com/en/learn/features/file-manager/)
    * [File sharing](https://www.winzip.com/en/features/share/send-large-files/)
    * [Folder compression](https://www.winzip.com/en/learn/features/compress-folder/)
    * [Archive files](https://www.winzip.com/en/learn/features/archive-file/)
    
    * [PDF to Word](https://www.winzip.com/en/learn/pdf-pro/file-conversions/pdf-to-word/)
    * [Word to PDF](https://www.winzip.com/en/learn/pdf-pro/file-conversions/word-to-pdf/)
    * [Compress PDF](https://www.winzip.com/en/learn/pdf-pro/features/compress-pdf/)
    * [Convert PDF](https://www.winzip.com/en/learn/features/convert-to-pdf/)
    * [Zip PDF](https://www.winzip.com/en/learn/features/zip-pdf/)
    
    File types
    
    * [RAR files](https://www.winzip.com/en/learn/file-formats/rar/)
    * [Zip files](https://www.winzip.com/en/learn/file-formats/zip/)
    * [7Z files](https://www.winzip.com/en/learn/file-formats/7z/)
    * [GZ/Gzip files](https://www.winzip.com/en/learn/file-formats/gz/)
    * [TAR GZ files](https://www.winzip.com/en/learn/file-formats/tar-gz/)
    * [ISO files](https://www.winzip.com/en/learn/file-formats/iso/)
    
    * [RAR files on Mac](https://www.winzip.com/en/learn/file-formats/rar/mac/)
    * [Zip files on Mac](https://www.winzip.com/en/learn/file-formats/zip/mac/)
    * [TAR files](https://www.winzip.com/en/learn/file-formats/tar/)
    * [TGZ files](https://www.winzip.com/en/learn/file-formats/tgz/)
    
* [Partners](https://www.winzip.com/en/partners/)
* [Support](https://www.winzip.com/en/support/)

* [Sign in](https://suite.winzip.com/login/?utm_source=winzip.com&utm_medium=wzheaderlink)
...
a. By (i) signing-up for a membership, service or a subscription, (ii) using this product with online functionality, this web site ( “Site”) or other online service of Corel Corporation, its affiliates and agents (“Corel”) with links to these Terms of Use (the “General Terms”) (collectively, the “Services”) in any way, including using, transmitting, downloading or uploading any Materials (as defined below) made available or enabled via the Services by Corel , or (iii) merely browsing the Services, you agree that you have read, understand and agree to these General Terms and the Corel Online Privacy Policy at [https://www.corel.com/privacy](https://www.corel.com/privacy), which is incorporated herein by reference. “Materials” means any content made available or enabled by Corel or its licensors, and includes, without limitation, any information, data, documents, images, photographs, graphics, audio, videos, or webcasts, products, and Corel software code and associated documentation (“Software”).
...
d. Corel may change the Terms from time to time at its sole discretion, including by imposing a charge for access to or use of a Service. If such changes are made, Corel will make a new copy of the General Terms available at [https://www.corel.com/tos](https://www.corel.com/tos), with any new Additional Terms made available to you from within or through the affected Service. Corel may require you to provide consent to the updated Terms in a specified manner before further use of the Services is permitted. Otherwise, your continued use of any affected Service constitutes your acceptance of the changes. Your use of the Services is subject to the most current version of the Terms posted on or through the affected Service at the time of such use. It is your responsibility to regularly check [https://www.corel.com/tos](https://www.corel.com/tos) to review the current General Terms and Addition Terms.
...
Use of Materials is governed solely by the license terms of which the latest version is available at [https://www.winzip.com/en/company/legal/](https://www.winzip.com/en/company/legal/) .
...
Please see the Corel End User License Agreement of which the latest version is available at [https://www.corel.com/eula](https://www.corel.com/eula) for your rights and responsibilities in providing feedback to Corel.
...
2. Corel is required to do so by Law (for example, where the provision of the Services or Materials to you is, or becomes, unlawful);
3. The provision of the Services to you by Corel is, in Corel's opinion, no longer commercially viable;
4. Corel has elected to discontinue the Services or Materials (or any part thereof); or
5. You do not pay to Corel, when due, subscription amounts required to maintain your rights to the Services and Materials hereunder.
...
[![WinZip](/static/wz/images/winzip-logo-white.svg "WinZip")](https://www.winzip.com/)

Copyright © Corel Corporation. All rights reserved.

Products

* [WinZip](https://www.winzip.com/en/product/winzip/)
* [WinZip Suite](https://www.winzip.com/en/product/winzip/suite/)
* [WinZip for Mac](https://www.winzip.com/en/mac/)
* [WinZip Enterprise](https://www.winzip.com/en/enterprise/)
* [WinZip PDF Pro](https://www.winzip.com/en/product/pdf-pro/)
* [WinZip System Utilities Suite](https://www.winzipsystemtools.com/system-utilities/)
* [All products](https://www.winzip.com/en/all-products/)

Features

* [Word to PDF](https://www.winzip.com/en/learn/pdf-pro/file-conversions/word-to-pdf/)
* [Compress PDF](https://www.winzip.com/en/learn/pdf-pro/features/compress-pdf/)
* [Convert to PDF](https://www.winzip.com/en/learn/features/convert-to-pdf/)
* [Compress images](https://www.winzip.com/en/learn/features/compress-images/)
* [Compress video](https://www.winzip.com/en/learn/features/compress-video/)
* [File manager](https://www.winzip.com/en/learn/features/file-manager/)
* [File sharing](https://www.winzip.com/en/features/share/send-large-files/)
...
* [Resource center](https://www.winzip.com/en/resources/)
* [Tutorials](https://www.winzip.com/en/learn/#ctg-tutorials)
* [Get WinZip free](https://www.winzip.com/en/download/winzip/)
* [All downloads](https://www.winzip.com/en/download/)
* [About WinZip](https://www.winzip.com/en/company/about/)
* [Partners](https://www.winzip.com/en/partners/)
...
* [Terms of use](https://www.winzip.com/en/company/legal/terms-of-use/)
* [Privacy](https://www.alludo.com/en/legal/privacy/)
* [Cookies](https://www.alludo.com/en/legal/cookies/)
* [EULA](https://www.corel.com/en/eula/)
* [Legal](https://www.winzip.com/en/company/legal/)
* [Do not sell/share my information](https://www.alludo.com/en/legal/privacy/form/)
* Manage my cookies

English

* [Deutsch](https://www.winzip.com/de/)
* [English](https://www.winzip.com/en/)
* [Español](https://www.winzip.com/es/)
* [Français](https://www.winzip.com/fr/)
* [Italiano](https://www.winzip.com/it/)
* [Nederlands](https://www.winzip.com/nl/)
* [Português do Brasil](https://www.winzip.com/br/)
* [日本語](https://www.winzip.com/jp/)
* [简体中文](https://www.winzip.com/cn/)

[Delivered by ![Alludo](/static/common/images/logo/logo-alludo-fw.svg "Alludo")](https://www.alludo.com/) 
...
Follow 3 easy steps to install WinZip

Click downloaded file

![](/static/wz/images/downloadhelper/test/chrome.png) winzip.exe

Click “Yes” to allow installation

![](/static/wz/images/downloadhelper/test/step2.jpg)

Follow setup instructions to finish installation

![](/static/wz/images/downloadhelper/test/step3.jpg)

If your download did not start automatically, please [click here](https://download.winzip.com/gl/nkln/winzip28-pp.exe "Start download")

If your download did not start automatically, please [click here](https://download.winzip.com/gl/gad/winzip28.exe "Start download")