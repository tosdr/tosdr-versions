...
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to App.
...
* **Website** refers to App, accessible from [https://appforce1.net](https://appforce1.net/)
