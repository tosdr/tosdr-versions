[![](/ss/images/icoLogo.svg)SedoDNABest value for advertisers and publishers](https://www.sedodna.com/)

[Advertiser Login](https://www.sedodna.com/advertiser/login)[Advertiser Signup](https://www.sedodna.com/advertiser/signup)[Publisher Login](https://www.sedodna.com/publisher/login)

* [Home](https://www.sedodna.com/)
* [Contact](mailto:support@sedodna.com)
* [Advertisers](https://www.sedodna.com/advertiser/signup)
* [Publishers](https://www.sedodna.com/publisher/signup)

SedoDNA AdServing and Platform Privacy Policy
---------------------------------------------

The purpose of this Privacy Policy (this “Policy”) is to inform you of regarding the use of data within the SedoDNA as well as those affiliated with us, including data processors, sub-processors and third-party partners. This Policy shall also provide you information regarding how to manage certain data collected about you.

### Definitions

**Company** - SedoDNA, a Registered Company
...
The Platform and services are intended for general audiences and are not directed to children under the age of 13. We do not knowingly collect personal information from children under 13. If you become aware that a child has provided us with personal information without parental consent, please contact us here: **support@sedodna.com**
...
Local storage is used for storing "user preferences" to provide better Platform user experience. Depending on browser compatibility it can be used to store page sizes, visible columns, sorting directions, etc.

To clear your local storage, follow below instructions:

1. Open your browser Console by pressing F12 or Ctrl+Shift+I key.
2. Select “Application” in the console’s top menu.
3. Select “Local Storage” in the console’s left menu.
4. Right click your site(s) and click "Clear" or "Delete All" (depending on browser) to delete the local storage.
...
* [Advertisers](https://www.sedodna.com/advertiser/signup)
* [Publishers](https://www.sedodna.com/publisher/signup)
* [Privacy Policy](https://www.sedodna.com/privacy)