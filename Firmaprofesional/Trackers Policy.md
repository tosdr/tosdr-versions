...
Última actualización: 22 de Octubre 2018

**Sumario**

* Cookies usadas : **Terceros**
* ¿Se usan para obtener estadísticas? **Sí**
...
* [Internet Explorer 7 / 8](http://windows.microsoft.com/es-es/windows-vista/block-or-allow-cookies)
* [Internet Explorer 9](http://windows.microsoft.com/es-es/windows7/how-to-manage-cookies-in-internet-explorer-9)
* [Internet Explorer 10](http://windows.microsoft.com/es-es/internet-explorer/delete-manage-cookies#ie=ie-10)
* [Internet Explorer 11](http://windows.microsoft.com/es-es/internet-explorer/delete-manage-cookies#ie=ie-11)
...
Cookies usadas por Google Analytics :

| Name | Purpose | Type | Expiration |
| --- | --- | --- | --- |
| \_\_ga | Analytics | Tercer | 10 minutes |
| \_\_git | Analytics | Tercer | Session |
| \_\_ga | Tercer | 2 Year |

[Analytics:](https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage)Sus cookies (\_ga, \_gat) permiten contabilizar las veces que un usuario visita una web, cómo, cuándo y desde dónde lo hace.
