...
Profile information, images, music, videos, collages, montages, comments, tags, collaborative areas that you create, your “favorite” content, the content you repost, messages, your interactions with VSCO’s content or other people’s content on our Services, and information you may provide to facilitate business between yourself and others.
...
We retain data for as long as we need for the uses mentioned above. You can delete your account by following the instructions [**here**](https://support.vsco.co/hc/en-us/articles/360004196352-How-do-I-delete-my-VSCO-Account-).

When we don’t need your personal information anymore, we’ll either delete it or anonymize it, unless deletion or anonymization isn’t possible or practical (for example, because your data is in backup archives), in which case we’ll make sure your data is securely stored and isolated from further processing.
...
You can opt-out of marketing-related emails by following the opt-out or unsubscribe instructions at the bottom of a marketing email, or by [**contacting us**](https://support.vsco.co/). You will continue to receive other non-marketing emails related to our Services. If you receive marketing text messages from us, you can opt out by replying STOP to our marketing message.

Adjust cookie preferences

You can opt out of the use of certain cookies and similar technologies by clicking “Your Privacy Choices” in the footer of the website and adjusting your preferences. Additionally, most browsers let you limit or reject cookies by configuring your browser settings accordingly.

Disable mobile location data

You can disable our access to your device’s geolocation in your mobile device settings.
...
You can opt out of receiving interest-based advertising on websites through participating members of the Network Advertising Initiative by clicking [**here**](https://optout.networkadvertising.org/?c=1) or the Digital Advertising Alliance by clicking [**here**](https://optout.aboutads.info/). You can also opt out of receiving interest-based advertising in mobile apps through participating members of the Digital Advertising Alliance by using the AppChoices mobile app. Please note that we may work with companies that may not participate in these opt-out mechanisms but may offer their own opt-out.

Limit advertising ID use in your mobile settings

You may be able to configure your mobile device to limit how your mobile advertising ID can be used for interest-based advertising purposes.
...
* **Online:** [**https://support.vsco.co**](https://support.vsco.co/)
...
You have certain rights regarding your personal information under the state consumer privacy laws listed above, subject to certain exceptions under such applicable law. Here, we provide a summary of your rights relating to personal information and how to exercise them. You are entitled to exercise these rights free from discrimination.

**Access.** You have the right to access a copy of your personal information, which you can do by following the instructions available [**here**](https://support.vsco.co/hc/en-us/articles/360052896671-How-do-I-access-a-copy-of-my-personal-data-on-VSCO-), or by submitting a request [**here**](https://vsco.formstack.com/forms/vsco_data_request).

**Correction.** You have the right to request that we correct inaccurate personal information that we have collected about you. You can do so by submitting a support request [**here**](https://support.vsco.co/hc/en-us), or by submitting a request [**here**](https://vsco.formstack.com/forms/vsco_data_request).

**Deletion.** You have the right to request deletion of the personal information that we have collected from you, which you can do by following the instructions available [**here**](https://support.vsco.co/hc/en-us/articles/360004196352-How-do-I-delete-my-VSCO-Account-), or by submitting a request [**here**](https://vsco.formstack.com/forms/vsco_data_request). But if we delete your personal information, we might not be able to provide our Services to you.
...
Categories of recipients to whom we “disclose” PI for a business purpose

**Categories of third parties to whom we sell or share PI for interest-based advertising**
...
Delivering our Services, Research and development, Marketing, and Compliance and protection
...
Device data and metadata about certain content of creators
...
We do not intentionally collect this information, but it may be revealed in identity data, content of creators, or other information we collect
...
Creator content (images, video or audio)
...
We do not intentionally collect this information, but it may be revealed in content of creators
...
**‍_Details regarding each processing purpose listed below are provided in the section of our Privacy Policy titled “How we use your data”._
...
* **Right to lodge a complaint with the supervisory authority**: If you have a concern about any aspect of our privacy practices, including the way we have handled your personal data, you can report it to the relevant supervisory authority. You can find your data protection regulator [**here**](https://edpb.europa.eu/about-edpb/board/members_en).

You may submit these requests through our [**Help Center**](http://support.vsco.co/). We may request specific information from you to help us confirm your identity and process your request. Applicable law may require or permit us to decline your request. If we decline your request, we will tell you why, subject to legal restrictions.
...
You may contact us through our [**Help Center**](http://support.vsco.co/) if you want further information on the specific mechanism used by us when transferring your personal data out of Europe.
...
**You hereby grant your separate consent to the cross-border data collection and other relevant data processing activities set forth in this Privacy Policy. In the event of any material change of the purpose or method of processing or the type of personal data we process, we will re-obtain your consent.**

We will secure your separate consent if we undertake any of the following data processing activities in a manner that materially differs from this Privacy Policy:
...
Please see the above section “How we use your data” for details on how we process your personal data. Unless otherwise stated in the Privacy Notice for China Residents, the relevant sections in the Privacy Policy will apply regarding our processing of your personal data.
...
The Privacy Notice for China Residents is an integral part of the Privacy Policy.  Prior to using our Services, you have carefully read, fully understood and accepted the Privacy Policy, including the Privacy Notice for China Residents.  By accepting and consenting to the Privacy Policy, you have granted your consent to authorize VSCO to process your personal data in accordance with the Privacy Policy.

If you are a resident in China and younger than 14 years old, please do not use our Services or provide any of your personal data to VSCO. Please do not provide any personal data to VSCO if your parent or legal guardian has not accepted this Privacy Policy following discussion with you and granted separate consent to authorize VSCO to process your personal data in accordance with the Privacy Policy.

#### Contact us

You may contact us through our [Help Center](http://support.vsco.co/) with any questions regarding the processing of your personal data.
