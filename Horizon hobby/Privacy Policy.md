...
You always have the right to request information about your stored data, its origin, its recipients, and the purpose of its collection at no charge. You also have the right to request that it be corrected, blocked, or deleted. You can [contact us](https://www.horizonhobby.com/contact) at any time if you have further questions about privacy and data protection.
...
Champaign, IL  
61822  
[Contact](https://www.horizonhobby.com/contact)

Our Data Protection Officer for these US-based sites is Ben Ambrose, who can be reached through the site [contact form](https://www.horizonhobby.com/contact). 
...
Our Data Protection Officer for these EU-based sites is Ben Ambrose, who can be reached through the site [contact form](https://www.horizonhobby.com/contact). 
...
On some Horizon Hobby websites, you may be able to sign up to receive the comment feed after registering or commenting. Your email address may be checked with a confirmation email. You can unsubscribe from this function at any time by clicking the unsubscribe link in the emails. The data provided by subscribing to the comments feed will be deleted. But if you have submitted comments or provided the data to us for another purpose or elsewhere, those comments or data will not be deleted. You may request deletion of this data by sending an informal email request request via the site [contact form](https://www.horizonhobby.com/contact)

Close

### Plugins

Some Horizon Hobby websites have social media or other types of plugins to improve our customer's online experience. Social media plugins allow users to engage with their social media pages. Horizon Hobby pages may include plugins to Facebook, Twitter, Instagram, Tumblr, LinkedIn, Pinterest, Snapchat, YouTube, Vimeo, or Google Maps. When you visit our site, a direct connection between your browser and the social media company's server is established. This allows the social media company to process the users' engagement with their social media plug-in. To establish this connection, the social media company receives information that you have visited our site from your IP address. Horizon Hobby has a legitimate interest in creating an engaging user experience on its webpages. Thus, the basis for data processing under the GDPR is Art. 6(1)(f). Information about each social media plugin can be found in the Learn More section of this provision.
...
The Pinterest plugin allows users to connect to their Pinterest account. It is operated by Pinterest Inc., 635 High Street, Palo Alto, CA, 94301, USA. The Pinterest plugin can be recognized by the Pinterest "Pin it" logo.
...
Some Horizon Hobby websites use third-party analytics and advertising services to a custom and optimized user experience from our websites and their advertising. Horizon Hobby pages may include the analytics and advertising services of Google Analytics, Google Analytics Remarking, Google reCAPTCHA, Facebook Web Beacon, or BazaarVoice Web Beacon. The collection of this data may come in the form of cookies, web beacons, or plugins. General information about how cookies, web beacons, and plugins work can be found above in the sections titled Cookies, Web beacons, and Social Media Plugins, respectively. Horizon Hobby has a legitimate interest in providing an optimized user experience from our websites and their advertising. Thus, the basis for data processing under the GDPR is Art. 6(1)(f). Information about each of the analytics and advertising services used on Horizon Hobby websites can be found under the Learn More section of this provision.
...
If you would like to receive mobile notifications, we require a valid phone number capable of accepting SMS messages as well as information that allows us to verify that you are the owner of the specified phone number and that you agree to receive mobile notifications. No additional data is collected or is only collected on a voluntary basis. We only use this data to send the requested information.

We will, therefore, process any data you enter onto the contact form only with your consent under GDPR Art. 6 (1)(a) and the Telephone Consumer Protection Act. You can revoke consent to the storage of your data and telephone number as well as their use for sending mobile notifications at any time, e.g. by replying with a STOP message. The data processed before we receive your request may still be legally processed.

Sharing excludes text messaging originator opt-in data and consent. No mobile information will be shared with third parties/affiliates for marketing/promotional purposes. All the above categories exclude text messaging originator opt-in data and consent; this information will not be shared with any third parties.
...
You always have the right to request information about your stored data, its origin, its recipients, and the purpose of its collection at no charge.  
You may change any of your personal information in your account online at any time. Also, you may contact us to assist in changing your personal information in your account online or to change, block, delete, or provide to you any other personal information stored by Horizon Hobby. However, some past transactional and encrypted backup data may not be deleted. To make any personal data requests, please contact us and make a request via the site [contact form](https://www.horizonhobby.com/contact).
...
Personal data of California residents is processed in accordance with the California Consumer Protection Act (CCPA). Because we do not sell your personal data, we do not include an opt-out to the sale of personal data. You have the right to request us to disclose personal data that we collect, use, disclose, and sell about your household; and to request that we delete personal data about your household. If you make such request, we may be required to verify your identity under the CCPA, prior to proceeding with or during the processing of the request. These requests may be made by request via the site [contact form](https://www.horizonhobby.com/contact) or our toll-free number (800-338-4639).

We will not discriminate against you based on your decision to exercise your rights under the CCPA, as required by the CCPA.

The following provides a summary of the categories and primary sources of personal data that we collect on California residents, which is further outlined in Sections 4, 5, and 6 of this policy.

|     |     |     |
| --- | --- | --- |
CA Privacy Disclosures Summary
| Category | Source | Purpose |
| --- | --- | --- |
| Name and contact info | User interaction | Provide products and support; marketing |
| Credentials | User interaction | Provide products and support |
| Payment Info | User interaction | Provide products and support |
| Demographic info | User interaction and third-party brokers | Provide and personalize products and support; marketing |
| Name and contact info | User interaction | Provide products and support; marketing |
| IP address | User interaction | Website security and integrity; website use analytics; marketing |

10\. Privacy Shield Framework
-----------------------------

Horizon Hobby complies with the EU-U.S. Privacy Shield Framework and Swiss-U.S. Privacy Shield Framework as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of personal information transferred from the European Union, the United Kingdom, and Switzerland to the United States. Horizon Hobby has certified to the Department of Commerce that it adheres to the Privacy Shield Principles. If there is any conflict between the terms in this privacy policy and the Privacy Shield Principles, the Privacy Shield Principles shall govern. To learn more about the Privacy Shield program, and to view our certification, please visit https://www.privacyshield.gov/. Horizon Hobby has further committed to cooperate with the panel established by the EU data protection authorities (DPAs) and the Swiss Federal Data Protection and Information Commissioner (FDPIC) with regard to unresolved Privacy Shield complaints concerning data transferred from the EU and Switzerland.

You can direct any questions or complaints about the use or disclosure of your personal data by [contacting us](https://www.horizonhobby.com/contact). We will investigate and attempt to resolve any complaints or disputes regarding the use or disclosure of your personal data within 45 days of receiving your complaint.

If you are protected under EU, UK, or Swiss law and unsatisfied with the resolution of your complaint, you may contact the International Centre for Dispute Resolution – American Arbitration Association (ICDR-AAA) at http://go.adr.org/privacyshieldfiling.html for further information and assistance. You may have the option to select binding arbitration for the resolution of your complaint under certain circumstances, provided you have taken the following steps: (1) raised your complaint directly with Horizon Hobby and provided us the opportunity to resolve the issue; (2) made use of the independent dispute resolution mechanism identified above; and (3) raised the issue through the relevant data protection authority and allowed the US Department of Commerce an opportunity to resolve the complaint at no cost to you. For more information on binding arbitration, see the US Department of Commerce's Privacy Shield Framework: Annex I (Binding Arbitration).
