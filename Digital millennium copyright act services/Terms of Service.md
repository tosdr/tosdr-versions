...
Toggle navigation ![DMCA Logo](https://www.dmca.com/img/dmca-website-logo-2022.png)
...
* [Protection](https://www.dmca.com/ProtectionPro.aspx?r=m)
    ...
    * [Search Engine](https://www.dmca.com/SEO-Monitoring.aspx?r=m)
...
[![Logo](https://www.dmca.com/img/dmca-website-logo-2022.png)](https://www.dmca.com/dashboard)
...
* #### [SUPPORT](https://www.dmca.com/Support/default.aspx?r=mmsup)[](#collapseSupport)
    ...
    [DMCA Articles](https://www.dmca.com/articles/?r=mmsup)
...
Digital Millennium Copyright Act Services Ltd. Terms and Conditions
===================================================================

[Knowledge Base](https://www.dmca.com/Solutions/default.aspx "Knowledge Base") » Digital Millennium Copyright Act Services Ltd. Terms and Conditions

[Start Your Takedown](https://www.dmca.com/signup/createtakedown.aspx?ref=sol4382-top)
...
2. Representations and Warranties
    ...
    3. Representations and Warranties of DMCA Services
...
1. DMCA.com Protection Badge
    ...
    2. DMCA Services provides "DMCA.com Protected" badges or logos for internet users as a free service. DMCA.com Services provides the HTML code for any internet users to add a DMCA.com Protection Badge to their website at no charge.
    ...
    5. DMCA.com Protection Badge Acceptable Use Policy (AUP) statements:
    ...
    2. the DMCA.com Protection Badge shall be used as it is designed, displayed, intended and promoted on DMCA.com website. Particularly in conjunction with the badge's direct connection to the Protection Status certificate page. This connection must be direct and without any interference, redirects or advertising not belonging to DMCA.com
    3. the DMCA.com Protection Badge shall be add to the registrants or users website or specific webpage with the specific embed code as supplied by DMCA.com either directly through the DMCA.com website or some other communication from DMCA.com, its staff, management or authorized agents.
    4. use of the DMCA.com Protection Badge without the specific embed code as supplied by DMCA.com either directly through the DMCA.com website or some other communication from DMCA.com, its staff, management or authorized agents is NOT acceptable use of DMCA.com service and property.
    5. the DMCA.com Protection Badge shall not be used in conjunction, directly or indirectly, with any advertising not belonging to DMCA.com. Site users that click (access) the Protection Badge must experience the Status Page click through as designed, displayed, intended and promoted on DMCA.cowebsite. Users must experience the Status Page without any interference, redirects or additional webpages.
    6. the DMCA.com Protection Badge shall not be used and displayed with or without the website content certificate on a website or other platform where content, published without permission is being displayed.
    7. the DMCA.com Protection Badge shall not be used and displayed on a website to promote hatred or harm towards anyone or any party, group or organization.
    8. the DMCA.com Protection Badge shall not be used and displayed on a website to promote the protection of content which has been obtained illegally or without permission.
    9. the DMCA.com Protection Badge shall not be used and displayed on a website to promote the protection of content which is prohibited by the laws of the Canada or country where the website host is physically located or incorporated.
    10. the DMCA.com Protection Badge registrant shall reply to DMCA.com email communications, sent to the registrants listed email address with DMCA.com, within 24 hours for any claims related to the badge use.
    
    7. Should any of the terms of the DMCA.com Protection Badge Acceptable Use Policy listed above not be met, DMCA Services reserves the right to stop delivery of the badge and where required report any illegal activity to the relevant authorities having jurisdiction without notice.
    8. "Protection" in terms of the service paid for when used in conjunction with the DMCA.com "Protection Badge(s)" is applied through services supplied through the ProtectionPro Service suite and limited professional takedown services as defined by the ProtectionPro Service paid for in the month of the last payment reoccurring made. No additional website or website content protection is implied or stated here or anywhere within the DMCA.com website.
    ...
    10. DMCA.com Protection Badge usage indemnity
    ...
    12. Included with the DMCA.com Protection Service badge is the Website Certificate and Status page.Below are list DMCA.com Website Certificate and Status Page Acceptable Use Policy (AUP) statements:
    ...
    3. the DMCA.com Protection certificate and status page shall not be used and displayed with or without the DMCA.com Badge on a website or other platform where content, published without permission is being displayed.
    4. the DMCA.com Protection certificate and status page shall not be used and displayed on a website to promote hatred or harm towards anyone or any party, group or organization.
    5. the DMCA.com Protection certificate and status page shall not be used and displayed on a website to promote the protection of content which has been obtained illegally or without permission.
    6. the DMCA.com Protection certificate and status page shall not be used and displayed on a website to promote the protection of content which is prohibited by the laws of the Canada or country where the website host is physically located or incorporated.
    7. the DMCA.com Protection certificate and status page does not represent ANY obligation, legal or otherwise, on behalf of DMCA Services, it's management, staff or authorized agents toward the website owner or host.
    8. DMCA Services makes no statement of claim with regards as the legal specifics of the language contained within the Website Certificate. Quotes and reference to the United States Copyright Act , DMCA Policy is strictly provided as reference for the reader.
    ...
    10. the DMCA.com Protection Badge registrant shall reply to DMCA.com email communications, sent to the registrants listed email address with DMCA.com, within 24 hours for any claims related to the Website Certificate and Status page use.
    11. A verified status of the Website Certificate and Status Page occurs when the website owner is a paid subscription client of DMCA.com. This verified status of the Website Certificate and Status page does not imply any additional verification over and above the fact the website / protection badge user is a current paying client.
    12. An unverified status of the Website Certificate and Status Page occurs when the website owner is not a client and is a free user of the DMCA Services Protection Badge.
    13. Unauthorized Status of the Website Certificate and Status Page will occur should the DMCA.com Protection Website Certificate and Status page be linked to a website or webpage which is in contravention of the DMCA.com Protection Badge Acceptable Use Policy (see article 4.E.) or DMCA.com Website Certificate and Status Page Acceptable Use Policy (see article 4.I.) DMCA Services reserves the right to stop delivery of the Website Certificate and Status page and where required report any illegal activity to the relevant authorities having jurisdiction.
    
    14. Should any of the terms of the DMCA.com Website Certificate and Status page Acceptable Use Policy listed above not be met, DMCA Services reserves the right to stop delivery of the Website Certificate and Status page, change the Website Certificate and Status page to unverified or unauthorized and where required report any illegal activity to the relevant authorities having jurisdiction without notice.
    15. DMCA Services reserves the right to monitor or view Content on websites which have the DMCA Protection Badge or logo placed upon it at any time for the purpose of ensuring compliance with this Agreement. DMCA Services reserves the right stop delivering the DMCA Protection Badge, without first notifying the client, if content on a domain or website page upon which a DMCA Protection Badge is being delivered is, in DMCA Services’ sole discretion, potentially illegal, a violation of trademark rights and/or copyright, or which may subject DMCA Services to liability, or violate the acceptable use policy stated below in these Terms & Conditions. DMCA Services may notify Customer of the reason for removal. In no instance shall DMCA Services be liable for the removal of the DMCA Protection Badge or the illegal and or unauthorized access, replication or redistribution of their content.
    16. DMCA Services shall not be liable for any such infringement, violation, or misappropriation and Customer shall indemnify DMCA Services against any and all losses and expenses, including for all attorneys' fees and other costs, relating to Customer's breach of this representation and warranty.
    17. DMCA Services shall not be held liable by the Customer for any unauthorized access, replication or redistribution, infringement upon, violation or misappropriation of any patent, copyright, trade secret, trademark, contract, or any other publicity right, privacy right, or proprietary right of any third party held by the customer, of their content while the customer uses any protection product from DMCA Services. The Customer shall indemnify DMCA Services against any and all losses and expenses, including for all attorneys' fees and other costs, relating to Customer's breach of this representation and warranty as a result of any action against DMCA Services as a result of the customer using any DMCA Services’ product or services.
    18. The DMCA Protection Badge service includes with a website certificate or status page this feature is included within the articles above listed 4.A., 4.B.,4.C.
...
3. Manual Takedown Services
    ...
    1. The statement reads: _I swear under penalty of perjury that I have reasonable good faith belief that use of the material in the manner specified above is not authorized by me, the company I represent, its agents, or the law. The information provided herein is accurate to the best of my knowledge. I hereby authorize DMCA.com to act as my/our non-exclusive agent for this copyright infringement notification process._
    ...
    4. Guarantee of success and conditions of that guarantee are as stated on the website, www.dmca.com, and are a part of the paid service.
...
5. Content Monitoring Services
    ...
    1. DMCA.com Services provides "DMCA.com Monitoring" service for users to track, search and scan the publication of their content on the internet. The technology used for the DMCA.com Monitoring Service is both proprietary and or used under license.
    2. DMCA.com Monitoring Service function, features, intent and pricing are listed on the website and will be updated from time to time.
    3. DMCA.com Services, its management or staff does not monitor the content usage of DMCA.com Monitoring.
    4. Specific services and features are provided to the DMCA.com Monitoring Service registrant that registers with DMCA Services by following DMCA.com website instructions. These specific features are listed on the website. From time to time the services and features provided to the registered user are changed without notification to the registrant.
    5. DMCA.com Monitoring Acceptable Use Policy (AUP) statements:
    
    1. the DMCA.com Monitoring Service shall be used as it is designed, displayed, intended and promoted on DMCA.com website and customer portal. Particularly in conjunction with the monitoring service's direct connection to the DIY and Full Service Takedown programs.
    2. the DMCA.com Monitoring Service shall be accessed and used by person or persons approved and/or registered to the DMCA.com account. Underder no cricumstance is the monitoring service login credentials to be shared with anyone not registered with DMCA.com.
    3. Content added to the DMCA.com Monitoring Service shall be owned by or used under permission by the content owner.
    
    7. Should any of the terms of the DMCA.com Monitoring Service Acceptable Use Policy listed above not be met, DMCA Services reserves the right to remove permission to use the DMCA.com Monitoring Service and where required report any illegal activity to the relevant authorities having jurisdiction.
    8. "Monitoring Service" in terms of the service paid for scans the internet or specific website for content as entered into the Monitoring Service by the registrant or with and under permission from the registrant.
        1. No additional services provided by DMCA.com, its agents, management, contractors or affiliates is included or implied.
        2. No additional website or website content protection is implied or stated here or anywhere within the DMCA.com website.
        3. There is no guarantee all content or copies of the content entered into the Monitoring Service by the registrant or with and under permission from the registrant will be found on the internet or specific website.
        4. There is no statement implied or otherwise of any misuse, theft of publication or publication without permission when presenting the scanning results of the content entered into the Monitoring Service by the registrant or with and under permission from the registrant. The scanning or search results are presented as is as found.
        5. There is no statement implied or otherwise of the removal of the content entered into the Monitoring Service by the registrant or with and under permission from the registrant, by takedown or any other website removal method. The scanning or search results are presented as is as found.
        6. no monetary dispensation is implied or offered in anyway with regards to the DMCA.com Monitoring Service program should any stolen content by found or not found through scanning and searching of the internet or specific website.
    9. DMCA.com Monitoring Service usage indemnity
    
    1. DMCA Service, it employees, agents, contractors or management shall not be held responsible, liable or included in any legal action taken against a website owner as a result of the use of DMCA.com's Monitoring Service program.
    2. DMCA Service makes no statement of claim regarding the performance, function, coding etc of a Monitoring Service. DMCA Service, it employees, agents, contractors or management shall not be held responsible or liable for any issues which may result when the DMCA.com Monitoring Service is used.
    
6. Content Research Services
    
    1. DMCA.com Services provides "DMCA.com Research" internet professional search and list service for clients wanting DMCA.com to locate content, specified by the client, on the world wide web. The technology used for the DMCA.com Research Service is both proprietary or other technology used under license or a combination of both. The mix and use of either is a decision and the discretion of DMCA.com staff, management or agents.
    2. The DMCA.com Research Service function, features, intent and pricing may be listed on the website and will be updated from time to time. The specific service or product delivered to the client may be determined at the time of the service payment.
    3. DMCA.com Services, its management or staff does not monitor the content referred to as part of DMCA.com Research results.
    4. The word "Research" when used in terms of the DMCA.com Research Services is a marketing term. It is not intended to convey or imply the specific service provided by DMCA.com will meet the determinant acts, laws or conditions of the jurisdiction of the client that define the specific acts, functions and processes required to provide research services within the client's jurisdiction.
    5. Information provided in the format provided by DMCA.com, it's staff, management or agents as being DMCA.com Research Services or Report may or may not meet the determinant acts, laws or conditions of the jurisdiction of the client that define the specific acts, functions and processes that define research within the client's jurisdiction.
    6. Any work conducted and presented by DMCA.com, it's staff, management or agents as being DMCA.com Research Services or Report may or may not be conducted by persons that meet the determinant acts, laws or conditions of the jurisdiction of the client that define the specific acts, functions and processes that define a professional researcher within the client's jurisdiction.
    7. DMCA.com Research Acceptable Use Policy (AUP) statements:
    
    1. the DMCA.com Research information shall be used in a manner acceptable to the laws of the jurisdiction of client or DMCA.com.
    2. the DMCA.com Research Report or information contained within shall be accessed and used by person or persons approved and/or registered to the DMCA.com account. Under no circumstances is the Research service login credentials to be shared with anyone not registered with DMCA.com.
    3. the DMCA.com Research Report or information contained within is intended for the parties listed within the report and under no circumstances shall the report or the information contained within be published in any form either in whole or in part. It shall not be shared or published with anyone online.
    4. Any content subject to the DMCA.com Research Services shall be owned by or used under permission by the client. Under no circumstances shall DMCA.com Research services be used for competitive advantage purposes and or to look up content not owned or used under permission by the client, its agents, staff or management.
    
    9. Should any of the terms of the DMCA.com Research Service Acceptable Use Policy listed above not be met, DMCA.com reserves the right to remove permission to access the DMCA.com Research information and where required or allowed report any illegal activity to the relevant authorities having jurisdiction.
    10. "Research Service" or "Research Report" in terms of the service paid for under direction from a client, that is a manual process conducted by DMCA.com, it's staff, management or agents and either DMCA.com proprietary technology or technology used under permission or a combination of both that result in information being obtained and presented to the client regarding content prespecified and identified by the client on the world wide web.
        1. No additional free or fee services provided by DMCA.com, its agents, management, contractors or affiliates is included or implied.
        2. No additional website or website content protection is implied or stated here or anywhere within the DMCA.com website.
        3. There is no guarantee all content or copies of the content provided by the client and used by DMCA.com, it's staff, management or agents in providing the Research Service will be found on the internet or specific website.
        4. There is no statement implied or otherwise of any misuse, theft of publication or publication without permission when presenting the Research Service results of the content provided by the client to DMCA.com, it's staff, management or agents conducting the Research Service. The Research Service results are presented as is as found.
        5. There is no statement implied or otherwise of the removal of the content provided by the client to DMCA.com, it's staff, management or agents conducting the Research Service, by takedown or any other website removal method. The Research Service information or search results are presented as is as found.
        6. No monetary dispensation is implied or offered in anyway with regards to the DMCA.com Research Service program should any stolen content by found or not found through scanning and searching of the internet or specific website.
    11. DMCA.com Research Service usage indemnity
    
    1. DMCA Service, it employees, agents, contractors or management shall not be held responsible, liable or included in any legal action due to their involvement in DMCA.com's Research Service.
    2. DMCA Service makes no statement of claim regarding the performance, function, coding etc of a Research Service. DMCA Service, it employees, agents, contractors or management shall not be held responsible or liable for any issues which may result when the DMCA.com Research Service is used.
    3. DMCA Service makes no statement of claim beyond the presentation of information contained within documents submitted as "Research Report". It is the sole responsibility of the client to determine any claim related to the content found and listed within the information presented. DMCA Service, it employees, agents, contractors or management shall not be held responsible or liable for any issues which may result when the DMCA.com Research Service is used.
    
7. DMCA.com Compliance Service Program
    
    1. DMCA.com Services provides "DMCA.com Compliance". This service provides free and paying clients a simple takedown notice statement, compliance badge and user takedown form.
    2. DMCA.com Compliance Service Program function, features, intent and pricing may be listed on the website and will be updated from time to time. The specific service or product delivered to the client may be determined at the time of the service payment.
    3. DMCA.com Services, its management or staff does not monitor websites, domains or companies using the Compliance program.
    
    1. DMCA.com has provided this statement purely for the convenience of the website owner and the site users.
    2. DMCA.com makes no statement of claim regarding the content contained and published on the website on which the compliance statement has been (linked) placed.
    3. DMCA.com makes no statement of claim the site owner will follow the above detailed copyright infringement removal process as detailed.
    
    5. Any compliance statement of copyright infringing takedown process also known as DMCA Takedown chosen by the client has been provided to by Digital Millennium Copyright Services ltd (DMCA.com) as a convenience service. Any policy statement provided with the compliance program does not constitute or replace any Terms of Use, Terms of Service, Terms and Conditions, Acceptable Use Agreement or any other terms referenced or published on this website or others owned by . Nor does this policy act as a replacement of the stipulations, condition and the site owner's obligations under the copyright laws of the country in which the is registered.
    6. Any compliance statement of copyright infringing takedown process also known as DMCA Takedown chosen by the client has been provided to by Digital Millennium Copyright Services ltd (DMCA.com) does not constitute law or legal practice nor does it replace Terms of Use, Terms of Service, Terms and Conditions, Acceptable Use Agreement or any other terms referenced or published on this website or others owned by site owner. Nor does this policy act as a replacement of the stipulations, condition and the site owner's obligations under the copyright laws of the country in which the is registered.
    7. DMCA.com Compliance Takedown Notice Service Program DMCA.com Compliance Service Program provides a specific service whereby 3rd party website users may create and file DMCA Takedown Notices on DMCA.com clients using the DMCA.com Compliance Service Program.
    8. DMCA.com provides no guarantee as to the effectiveness of takedown notices generated by the user through this service.
    9. DMCA.com does not track the takedown notices or their content as generated by users through this program.
    10. DMCA.com will respond to all abuse claims regarding users of the Do It Yourself takedown program. If any abuse of the Do It Yourself services are found, DMCA.com will cancel the service.
    11. DMCA.com makes no statement of claim the site owner will follow the above detailed copyright infringement removal process as detailed.
    12. DMCA.com reserves the right to cancel the Compliance Takedown service for any paid subscriber at any time.
    13. The DMCA.com Compliance Takedown service is not to be used at any time for the creation and sending of frivolous or competitive based takedown notices. If the claim created within the Compliance Takedown service is being abused access to the service will be cancelled.
    14. The DMCA.com Compliance Takedown service specific Acceptable Use Policy (AUP) statements:
    
    1. DMCA.com Compliance Takedown service users shall not use the takedown form for any other purposes other than to recieve specific instructions to remove content hosted on their domain.
    2. All information submitted on the Compliance Takedown service takedown form shall be not be shared or sold or shard with anyone other than the DMCA.com client, their employees, staff, management, agents or owners.
    3. All information submitted on the Compliance Takedown service takedown form shall repect and follow privacy and security laws of the country of registration of the DMCA.com client if they reside in or their company is registered in the USA, UK, EU, Australia or Canada.
    
    16. DMCA.com Compliance Service Program Acceptable Use Policy (AUP) statements:
    
    1. the DMCA.com Compliance Service Program information shall be used in a manner acceptable to the laws of the jurisdiction of client or DMCA.com.
    2. the DMCA.com Compliance Service Program or information contained within shall be accessed and used by person or persons approved and/or registered to the DMCA.com account. Under no circumstances is the DMCA.com Compliance Service Program login credentials to be shared with anyone not registered with DMCA.com the a specific DMCA.com Compliance Service Program account.
    3. the DMCA.com Compliance Service Program or information contained within is intended for the parties listed within the report and under no circumstances shall the report or the information contained within be published in any form either in whole or in part. It shall not be shared or published with anyone online.
    4. Any content subject or domain used in connection with the DMCA.com Compliance Service Program shall be owned by or used under permission by the client. Under no circumstances shall DMCA.com Compliance Service Program be used for competitive advantage purposes and or be subject to content not owned or used under permission by the client, its agents, staff or management.
    5. Any domain used in connection with the DMCA.com Compliance Service Program shall be owned, managed or used under permission by the client. Under no circumstances shall DMCA.com Compliance Service Program be used in conjunction with a domain not owned or used under permission by the client, its agents, staff or management.
    
    18. Should any of the terms of the DMCA.com Compliance Service Program Service Acceptable Use Policy listed above not be met, DMCA.com reserves the right to remove permission to access the DMCA.com Research information and where required or allowed report any illegal activity to the relevant authorities having jurisdiction.
    19. "DMCA.com Compliance Service Program" or "DMCA.com Compliance Takedown Service Program" in terms of the service paid for under direction from a client, it's staff, management or agents and either DMCA.com proprietary technology or technology used under permission or a combination of both that result in information being obtained and presented to the client regarding content prespecified and identified by the client on the world wide web.
        1. No additional free or fee services provided by DMCA.com, its agents, management, contractors or affiliates is included or implied.
        2. No additional website or website content protection is implied or stated here or anywhere within the DMCA.com website.
        3. There is no guarantee by DMCA.com, it's staff, management or agents in providing the DMCA.com Compliance Service Program.
    20. DMCA.com Compliance Service Program usage indemnity
    
    1. DMCA Service, it employees, agents, contractors or management shall not be held responsible, liable or included in any legal action taken against a website owner or the client as a result of the use of DMCA.com Compliance Service Program.
    2. DMCA Service makes no statement of claim regarding the performance, function, coding etc of a DMCA.com Compliance Service Program. DDMCA.com Compliance Service Program, it employees, agents, contractors or management shall not be held responsible or liable for any issues which may result when the DMCA.com Compliance Service Program is used.
    3. DMCA Service makes no statement of claim beyond the presentation of information contained within documents submitted as "Research Report". It is the sole responsibility of the client to determine any claim related to the content found and listed within the information presented. DMCA Service, it employees, agents, contractors or management shall not be held responsible or liable for any issues which may result when the DMCA.com Compliance Service Program is used.
...
7. **REFUND:** all refunds shall be processed in the same method of payment.
    1. **Protection Pro**
    ...
    2. **Professional Takedown Services**DMCA.com offers a money back guarantee should the Professionally managed service not be successful. Exceptions are:
        ...
        3. EXCEPTION - if a client is or has been attempting to remove content prior to or in conjunction with DMCA.com Professionally Managed services. There is no refund if the content has been removed successfully. The Professional work of DMCA.com supersedes any previous takedown work.
...
12. **CUSTOMER INDEMNITIES**. Customer shall defend, indemnify and hold DMCA.com, its officers, directors, employees, agents, successors, assigns, licensors and third party service providers harmless from and against all losses, costs, damages, claims and other liabilities of any kind arising directly or indirectly from or in connection with:
...
13. **DMCA.com INTELLECTUAL PROPERTY**
    ...
    14. Arbitration
        ...
        If you have questions or comments, you can contact us at legal@DMCA.com or FAX (250) 477-5141. We can also be reached at: Digital Millennium Copyright Act Service Ltd., 795 Market Street Victoria, British Columbia V8T 0B4, Canada
        
    
    * * *
    
    Click here to [Start Your Takedown](https://www.dmca.com/signup/createtakedown.aspx?ref=sol4382-bottom)
...
* [Monitoring](https://www.dmca.com/Monitoring.aspx?r=msft)
