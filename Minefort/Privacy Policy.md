...
Privacy Policy of **Minefort.com**
==================================
...
Minefort.com B.V., a Dutch company having its principle place of business at Sloterweg 796, (1066 CN) Amsterdam, the Netherlands, registered with the Dutch Chamber of Commerce under number 89383001.

**Owner contact email:** info@minefort.com

Types of Data collected
-----------------------

Among the types of Personal Data that this Website collects, by itself or through third parties, there are: Tracker; Usage Data; payment info; first name; last name; email address; billing address.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Traffic optimization and distribution, Advertising, Hosting and backend infrastructure, Handling payments, Analytics, Heat mapping and session recording, Managing contacts and sending messages and Tag Management.
...
Personal Data processed: billing address; email address; first name; last name; payment info.
...
Place of processing: Netherlands – [Privacy Policy](https://privacy.microsoft.com/en-us/privacystatement).
...
OVHcloud is a hosting and backend service provided by OVH BV.

Personal Data processed: Usage Data.

Place of processing: Netherlands – [Privacy Policy](https://www.ovh.co.uk/personal-data-protection/).
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://minefort.com/cookie-policy "Cookie Policy").
