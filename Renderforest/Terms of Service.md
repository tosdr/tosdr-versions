...
**Website**  refers to Renderforest’s website, accessible from  [https://www.renderforest.com](https://www.renderforest.com/)
...
You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service. If you’re under the age required to manage your own Renderforest Account, you must have your parent or legal guardian’s permission to use a Renderforest Account. Please have your parent or legal guardian read these terms with you. If you’re a parent or legal guardian, and you allow your child to use the services, then these terms apply to you and you’re responsible for your child’s activity on the services. Renderforest doesn't take the responsibility for the actions, projects and payments made on the platform by children under 18.

Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.

By accessing and using our website ( [www.renderforest.com](https://www.renderforest.com/)), you acknowledge and agree that as an end user, you are strictly prohibited from sublicensing, assigning, transferring, or selling any text, video, images, audio recordings, or other materials protected by intellectual property rights, on any platform or websites other than [www.renderforest.com](https://www.renderforest.com/), without obtaining prior permission from the rightful owner of such materials. Failure to comply with this restriction may result in legal actions taken against you for infringement of proprietary rights. By utilizing our services, you affirm your understanding and commitment to adhere to this clause within our terms and conditions.
...
All Goods purchased are subject to a one-time payment. Payment can be made through various payment methods we have available, such as Dinners Club, Discover, JCB, PayPal ,American Express, Debit cards, YooMoney. Renderforest Android application payments are being processed via Google Play Store. Renderforest iOS application payments are being processed via Apple App Store. Once you complete a payment for a product, you will have the opportunity to download the product. Only the latest version of your Goods will be saved on your Dashboard as we always overwrite old files.
...
Your relationship with Paddle is governed by the following  [Terms and Conditions and Privacy Policy](https://paddle.com/legal-buyers/).
...
5. have engaged in activities that Renderforest deems suspicious or fraudulent.
...
If You participate in any Promotions, please review the applicable rules as well as our Privacy policy. If the rules for a Promotion conﬂict with these Terms, the Promotion rules will apply.
...
Renderforest uses YouTube API to control the player directly from the website. This makes it possible for our users to directly publish videos on YouTube. By using this feature of the Website, you acknowledge to be bound by  [YouTube Terms of Service](https://www.youtube.com/t/terms)  and  [Google’s Privacy Policy](https://policies.google.com/privacy?hl=en). In addition to Renerforest's procedure for deleting the stored data through the Website, users can cancel Renderforest's access to their data via  [Google security settings](https://security.google.com/settings/security/permissions). If you have any complaints regarding Renderforest’s privacy practices incorporated with YouTube API, contact our Support Team via  [support@renderforest.com](mailto:support@renderforest.com).
...
With Renderforest Video Maker, you upload your content to create various videos which you can download and use for personal, commercial, and marketing purposes. You can edit the ready-made templates to create videos but you are solely responsible for all copyright issues relating to the content you upload.

You can:

* create, publish, export, and download an unlimited number of low-quality videos **with** watermarks.
* create, publish, export, and download an unlimited number of high-quality videos **without** watermarks by either paying per project or subscribing to any plan.
* trim, color grade the videos created using Renderforest Video Maker.

You can use exported and downloaded videos:
...
* in any way distribute or sublicense any video without uploading personal content.
* use exported and downloaded videos as stock videos or templates.
* export Renderforest template scenes as greenscreen placeholders, altering animations from the background and using animation fragments in order to create new project(s).
* create products with similar functionality or use Renderforest content to create a similar website or service.
* use chroma key effect over our scenes using any kind of video editing software.
* resell the videos created on Renderforest unless you are subscribed to a Business plan and owns the reselling right.
* create content with harmful, abusive, pornographic, racially, or ethically offensive contexts with Renderforest services.
...
* Fees you pay for a Renderforest Logo are non-refundable. If you have a reason to believe that you were mistakenly charged, please contact our Support Team via  [support@renderforest.com](mailto:support@renderforest.com). We will consider your request for a refund at our sole discretion, provided however that you have not downloaded your Renderforest Logo.
...
12. You should adhere to the stipulation that the Renderforest Lite and Pro Subscription plans are exclusively intended for personal use and refrain from utilizing them for generating videos on behalf of entities other than your own. Additionally, if we detect any activity typical for resellers, you should consider upgrading your plan accordingly to adhere to Renderforest's terms and conditions. Failure to do so may result in a violation of our policies and potential account termination.  
    Should you opt to employ any subscription plan for commercial purposes, it is imperative that you upgrade to either Business plan with the limit of 100 reselling videos or the Enterprise plan to maintain compliance with Renderforest's terms of service. For further information about the Enterprise plan, please contact the Renderforest support team at  [support@renderforest.com](mailto:support@renderforest.com).
13. You shall not take any action that imposes an unreasonable large load on the infrastructure of our services, as well as the systems or networks connected to our services.
14. You shall not create derivative works of the Renderforest website, services, products or any content offered by Renderforest or our third-party providers.
15. You shall not sell, license, or exploit for any commercial purposes any use of/access to the Renderforest services or any part of the services, including but not limited to the licensed content, trademarked products, and third-party products and/or services.
16. You shall not remove or alter any copyright notices, watermarks, and signs indicating proprietary rights of Renderforest or any of our third-party licensors, including copyright mark \[©\], creative commons \[(cc)\] indicators, or trademarks \[® or ™\]
17. You shall not sublicense, assign, transfer, or sell any text, video, images, audio recordings, or other materials protected by intellectual property rights, on any platform or websites other than  [www.renderforest.com](https://www.renderforest.com/), without obtaining prior permission from the rightful owner of such materials.
18. You shall not access our platform on more than two (2) devices simultaneously by logging in with the same account.
19. You shall be responsible for managing and maintaining your authorized devices within the specified limit.
20. You shall not circumvent or manipulate the device limit in any way, as expressly agreed upon.
...
If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at dpo@renderforest.com and include in Your notice a detailed description of the alleged infringement.
...
You can contact our copyright agent via email at dpo@renderforest.com. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.
...
The laws of the Country, excluding its conﬂicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.
...
The certain areas of this website are password restricted. If you visit Renderforest for any purpose other than browsing the website, alternatively, if you want to establish a user account in order to create videos, logos and websites, you will need a user ID (provided by us) and a password to access the restricted areas of the website (video editor for instance).

All information of users login, emails, and passwords are very confidential. All the passwords provided by our users are one way encrypted, and even we cannot see it.

However, you are responsible for the safety and confidentiality of your account and you are obliged to notify Renderforest if your password is lost or stolen or if your account is disclosed to an unauthorized third party user.
...
Renderforest will generate commissions to an Affiliate when the user acquired through a qualified, correctly structured Affiliate link completes the payment for a single purchase or subscription. Affiliates can view their commissions on the  [Activity Dashboard](https://www.renderforest.com/partners/affiliates).
...
Affiliates get their commissions only from the amount paid by the customers, excluding the VAT payments. Based on the currency rate ﬂuctuations, there might be a slight (up to 10 (ten) %) difference in the final amount paid to the Affiliate. All commissions will be paid exceptionally in USD.  
Affiliate withdrawals will be voided if/when the affiliate uses the brand keywords of Renderforest or its compоnents in all kinds of ads. For the list of keywords get in touch with  [support@renderforest.com](mailto:support@renderforest.com).
