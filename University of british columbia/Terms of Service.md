...
[The University of British Columbia](https://www.ubc.ca/ "The University of British Columbia (UBC)")

[The University of British Columbia](https://www.ubc.ca/)

UBC Search

[UBC Search](https://www.ubc.ca/)

* [About UBC](https://www.ubc.ca/about/)
* [Our Campuses](https://www.ubc.ca/our-campuses/)
* [Admissions](https://www.ubc.ca/admissions/)
* [Academics](https://www.ubc.ca/academics/)
* [Strategic Priorities](https://www.ubc.ca/strategic-priorities/)
* [Research](https://www.ubc.ca/research/)
* [Campus Life](https://www.ubc.ca/campus-life/)
* [News](https://news.ubc.ca/)
* [give UBC](https://give.ubc.ca/)

* [Prospective Students](https://www.ubc.ca/prospective-students/)
* [Undergraduate Students](https://www.ubc.ca/undergraduate-students/)
* [Graduate Students](https://www.ubc.ca/graduate-students/)
* [Faculty & Staff](https://www.ubc.ca/faculty-staff/)
* [Alumni](http://www.alumni.ubc.ca/)
* [Community Partners](https://www.ubc.ca/community-partners/)

* [Home](https://www.ubc.ca/)/
* Legal Information & Terms of Use

Legal Information & Terms of Use
================================

The UBC web site consists of the material provided under the ubc.ca domain (e.g., https://www.ubc.ca) and several hundred subdomains (e.g., http://www.research.ubc.ca) (hereinafter referred to collectively as the "Site").
...
Your access to and use of the Site shall be governed by the following Terms of Use. UBC reserves the right amend these Terms of Use at any time without notice.
...
Copyright © 1994-2024 The University of British Columbia. All rights reserved.

* The University of British Columbia owns the intellectual property rights, including copyright, in and to this Site, or has acquired the necessary licenses to display the material on the Site.
...
* The Site may contain links to other sites. These links are provided as references to help you identify and locate other Internet resources that may be of interest. Parties other than the University of British Columbia independently develop and maintain these other sites. Therefore, the University of British Columbia does not assume responsibility for the accuracy or appropriateness of the information contained at such sites. In providing links to other sites, the University of British Columbia is not acting as a publisher or disseminator of the material contained on these other sites and does not seek to control the content of, or maintain any type of editorial control over, such sites.
* A link to another site should not be construed to mean that the University of British Columbia is associated with or is legally authorized to use any trademark, trade name, logo or copyrighted symbol that may be reflected in the link or the description of the link to such other sites. In addition, the mention of another party or its product or services on the Site should not be construed as an endorsement of that party or its product or service.

**(d) Trade Marks**

* Certain words, phrases, names, designs or logos used on the Site may constitute trade marks, service marks or trade names of the University of British Columbia or other entities. The display of any such marks or names on the Site does not imply that the University of British Columbia or other entities have granted a license or authorization of any kind to use such marks or names.

**(e) Submissions**

* All information submitted to the University of British Columbia via the Site shall be deemed and remain the property of the University of British Columbia, and the University of British Columbia shall be free to use, for any purpose, any ideas, concepts, know-how or other techniques contained in information provided to the University of British Columbia through the Site or sent through e-mail, unless otherwise agreed to in writing by the University of British Columbia. Furthermore, the University of British Columbia shall not be subject to any obligations of confidentiality regarding any such information submitted to it unless otherwise agreed to in writing by the University of British Columbia.
* The Internet is not a secure medium and privacy cannot be ensured. Internet e-mail is vulnerable to interception and forgery. The University of British Columbia will not be responsible for any damages you or any third party may suffer as a result of the transmission of confidential information that you make to the University of British Columbia through the Internet, or that you expressly or implicitly authorize the University of British Columbia to make, or for any errors or any changes made to any transmitted information.
...
* This Site uses web analytics tools to help analyze how the Site is used and to improve visitors’ online experience. These tools work by tagging web pages to capture a limited amount of data (including the internet protocol (‘IP”) address of the computer, device or network being used to access the pages). This data is used for aggregate reporting purposes. None of this data can be used by UBC or the service provider to identify you.
    ...
    This Site also uses remarketing tools, which enable UBC or other entities to serve you with relevant advertisements outside of the UBC domain.
...
Use of the Site is governed by UBC's policy [Information Systems Policy (SC14)](https://universitycounsel.ubc.ca/policies/information-systems-policy/).

Copyright at UBC
----------------

[Learn about copyright](http://copyright.ubc.ca/ "Copyright at UBC"), what is covers, and how you can get permission to use someone's copyrighted material.

QuickLinks
----------

* [UBC Policies](http://www.universitycounsel.ubc.ca/policies/ "UBC Policies")
...
[](https://www.facebook.com/universityofbc?fref=ts)[](https://instagram.com/universityofbc)[](https://twitter.com/ubc)[](https://www.linkedin.com/school/universityofbc)[](https://www.youtube.com/user/ubc)[](https://www.tiktok.com/@universityofbc)

[Back to top](#)

[The University of British Columbia](https://www.ubc.ca/)

* [Emergency Procedures](https://cdn.ubc.ca/clf/ref/emergency) |
* [Terms of Use](https://cdn.ubc.ca/clf/ref/terms) |
* [UBC Copyright](https://cdn.ubc.ca/clf/ref/copyright) |
* [Accessibility](https://cdn.ubc.ca/clf/ref/accessibility)