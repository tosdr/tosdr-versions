...
Streetwriters (Private) Ltd., in its sole discretion and at any time, may modify Subscription fees for the Subscriptions. Any Subscription fee change will become effective only for new Subscribers.

7\. Refunds
-----------

We issue refunds for Contracts within seven (7) days (for monthly) or thirty (30) days (for yearly) of the original purchase of the Contract.
...
Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Streetwriters (Private) Ltd. and its licensors. Service is protected by copyright, trademark, and other laws of the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Streetwriters (Private) Ltd.
...
1. Fixed typo in **8\. Prohibited Uses**

### June 5, 2023

1. Added **1\. Communications** to clarify the kinds of emails/announcements we show/send to our users.
2. Added clause under **15\. Amendments To Terms** about when a change to these terms might require sending/posting an announcement.
3. Removed clause regarding **Free Trial** requiring billing information from **5\. Free Trial**.
4. Removed clause regarding Subscription fee change becoming effective for Subscribers at their next Billing Cycle from **6\. Fee Changes**.
5. Added clause under **7\. Fee Changes** clarifying that any change in Subscription fee will only apply to new Subscribers.
6. Added clause under **15\. Amendments To Terms** about the presence of a Change log at the bottom of this site.
