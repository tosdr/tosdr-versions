...
The following privacy policy (“Privacy Policy”) sets forth Mediavine, Inc.’s (“Mediavine” “we” or “us”) policy with respect to information, including personally identifiable data (“Personal Data”) and other information, Mediavine collects from visitors (“you” or “your”)  to the Mediavine website located at [**http://mediavine.com/**](http://mediavine.com/) (the “Website”), including users of the Mediavine Direct platform located at [**https://sales.mediavine.com/**](https://sales.mediavine.com/) (“Mediavine Direct”) and the Mediavine marketplace located at [**https://marketplace.mediavine.com/**](https://marketplace.mediavine.com/trellis) (“Mediavine Marketplace”) (collectively the “Sites”).    
...
This Privacy Policy does not apply to information of any kind that we collect by means (including offline means) or from sources other than those specified herein.   In this policy you can learn about:

* [The Information We Collect and How it is Used](#info-we-collect)
* [Our Cookie Policy](#cookie-policy)
* [How Your Information May Be Used](#how-info-used)
* [How We Share Information with Third-Parties](#third-party-use)
* [Your Rights Related to Your Information](#rights)
    * [Special Notices for California Residents](#california)
    * [Special Notices for Virginia Residents](#virginia)
    * [Special Notices for European Union Residents](#eu)
    * [How to Opt Out of Targeted Advertising](#how-to-opt-out)
* [Our Retention Policies](#how-long-keep)
* [Our Other Policies, such as policies about children, an arbitration clause and links to other terms.](#other-sensitive)
...
Our legal basis for processing this information is your consent, and by voluntarily providing us with Personal Data, you are consenting to our use of it in accordance with this Privacy Policy. If you provide Personal Data to us, you acknowledge and agree that such Personal Data may be transferred and stored from your current location to the offices and servers of Mediavine located in the United States and the authorized third parties referenced below.
...
**Ad Management**.  We may collect or receive information about you from publishers that are members of the Mediavine Ad Management service (“Publishers”) through our use of cookies, pixels or server to server connections.   We (or our third-party partners – detailed in the section entitled “[Third Party Use of Personal Information](#third-party-use)”) may also combine and associate this information with information collected about other ads we have served.  
...
You may choose whether to receive personalized or unpersonalized ads on Publisher sites.   Depending on your choice, will depend on the data collected on the Publisher website.  Please refer to each Publisher’s site privacy policy for further details. We do not control the data privacy or protection policies of third parties, and we are not responsible for the privacy practices of these third parties. 

**Cookies.** We may log information using cookies, which are small data files stored on your browser by the Sites, Ad Management, Create, Grow Social, Grow, Trellis or the Video Player (“Cookies”). We may use both session cookies, which expire when you close your browser, and persistent cookies, which stay on your browser until deleted, to provide you with a more personalized experience on the Sites. Please see the “Cookie Policy” section below for more information about our use of cookies. Our legal basis for processing this information is your consent and our legitimate interests, namely monitoring and improving the Sites and Services.

**COOKIE POLICY**

We use, and allow certain other companies to use, Cookies on our Sites and in our Services to personalize content and ads, to provide social media features, to store saved content as a user of Grow Social or Grow, to analyze our traffic, and to recognize your device.  We also share information about your use of our Sites and our Services with our social media, advertising and analytics partners. This section explains what cookies are, how we use Cookies and similar technologies on our Sites and our Service and what you can do to manage how Cookies are used.
...
From time to time, the Website may engage in remarketing efforts with third-party companies, such as Google, Facebook, or Instagram, in order to market the Sites. These companies use cookies to serve ads based on someone’s past visits to the Website. We use the following third-party service providers for remarketing:
...
**Pseudonymized Data**.  Through certain of the Services, Mediavine may collect personal data that is subsequently pseudonymized.   Mediavine has placed certain internal restrictions and security measures in place to maintain such data as pseudonymized.  
...
* Mail Chimp – this service is used for delivery of email updates and newsletters. We store your name and email address for purposes of delivering such communications.  Mail Chimp’s use of your personal information is subject to [**Mail Chimp’s privacy policy**](https://mailchimp.com/legal/privacy/).  
* Google Forms – this service is used to gather information for applications to the Mediavine Ad Management Service.  Google’s use of your personal information is subject to [**Google’s privacy policy**](https://policies.google.com/privacy#products).  
* Stripe – this service is used to serve our ecommerce platform through Mediavine Direct. At no time is your banking information passed to the Sites. We receive only information used for order fulfillment. Stripe’s use of your personal information is subject to [**Stripe’s privacy policy**](https://stripe.com/us/privacy).
* Workable – this service is used to collect information for candidates seeking employment with Mediavine.  Workable’s use of your personal information is subject to [**Workable’s privacy policy**](https://www.workable.com/privacy).
* Intercom – this service is used for third-party communications.  Intercom’s use of your personal information is subject to [**Intercom’s privacy policy**](https://www.intercom.com/terms-and-policies#privacy).
* HotJar – this service is used in connection with the Grow Publisher Portal that is accessed by Publishers or users of the Grow service.  This service is also used in connection with the Ad Management dashboard.   HotJar does not collect personally identifiable information. Mediavine is using HotJar to manage and monitor interactions with the internal elements of the Grow Publisher Portal and Publisher dashboards.  If you do not want Mediavine to collect this data through HotJar, please contact **publishers@mediavine.com**  or [**review HotJar’s instructions**](https://www.hotjar.com/policies/do-not-track/).    HotJar’s use of your personal information is subject to [**HotJar’s privacy policy**](https://www.hotjar.com/privacy/).
...
Please review [**our Ad Partner Page**](https://www.mediavine.com/ad-partners/) for more information about each Mediavine Partner, including the data shared links to each Mediavine Partner’s privacy policy and other information about each Mediavine Partner’s practice, as available.
...
Please contact us at **privacy@mediavine.com** to submit a request or obtain information regarding any of the above. 
...
* Email us at [privacy@mediavine.com](mailto:privacy@mediavine.com); 
...
To see the categories of data collected and/or processed by Mediavine and the purposes for processing, please refer to the section of this privacy policy entitled The Information We Collect and How it is Used.

To see the categories of data that we may share with third parties, please refer to the section of this privacy policy entitled How We Share Information with Third-Parties.

Through our Ad Managment service, Mediavine sells and processes data for targeted advertising.  You may see more information and opt-out of targeted advertising from any Mediavine Publisher website through the Opt-Out of Targeted Advertising link that appears in the footer of each website or through the links provided in the section of this privacy policy entitled How To Opt Of Targeted Advertising.  
...
To appeal a decision regarding a consumer rights request. Please email us at [privacy@mediavine.com](mailto:privacy@mediavine.com)
...
If you would like more information about personalized advertising and to know your choices to opt-in or opt-out of this data collection, please visit [**https://thenai.org/opt-out**](https://thenai.org/opt-out/)/. You may also visit [**http://optout.aboutads.info/#**](http://optout.aboutads.info/#/)/ and [**http://optout.networkadvertising.org/#**](http://optout.networkadvertising.org/) to learn more information about interest-based advertising. You may download the AppChoices app at [**https://youradchoices.com/appchoices**](https://youradchoices.com/appchoices) to opt out in connection with mobile apps, or use the platform controls on your mobile device to opt out.   For more information about cookies and how to disable them, you can consult the information at  [**https://www.allaboutcookies.org/manage-cookies/**](https://www.allaboutcookies.org/manage-cookies/).
...
If you have questions or concerns about an ad on a Publisher website or have a question about that website’s data collection, please refer to that website’s privacy policy or contact us at **webmaster@mediavine.com**.  
...
**Contacting Mediavine**

Please also feel free to contact us if you have any questions about Mediavine’s Privacy Policy or the information practices noted herein.
