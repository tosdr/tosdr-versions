...
* [Products](javascript:void(0);)
    ...
    * [Iris Intelligence Platform](https://domaintools.com/products/platform/)
        * The first place to go when you need to know.
        * [Iris Investigate](https://www.domaintools.com/products/platform/iris-investigate/)
            * Map connected infrastructure to get ahead of threats.
        * [Iris Detect](https://www.domaintools.com/products/platform/iris-detect/)
            * Discover and monitor lookalike domains with unmatched speed and coverage.
        * [Iris Enrich](https://www.domaintools.com/products/platform/iris-enrich/)
    ...
    * [Farsight DNSDB](https://www.domaintools.com/products/farsight-dnsdb/)
        ...
        * [DNSDB API](https://www.domaintools.com/products/farsight-dnsdb/)
            * Unlock the power of 13+ years of historical passive DNS data, updated in real time.
        * [DNSDB Export](https://www.domaintools.com/products/farsight-dnsdb/)
        ...
        * [DNSDB Flexible Search](https://www.domaintools.com/products/farsight-dnsdb/)
            * Regular expression search across every label of a fully qualified domain name and select RData.
    * [Threat Intelligence Feeds](https://www.domaintools.com/products/threat-intelligence-feeds/)
        * If it’s happening online, you’ll know.
        * [Domain Visibility](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/)
            * Daily risk-scored domain list and targeted feeds.
        * [Predictive Risk Score](https://www.domaintools.com/products/threat-intelligence-feeds/predictive-risk-scoring/)
            * Predictive risk scoring and infrastructure profiling.
    
* [Integrations](https://www.domaintools.com/integrations/)
    
    * [Integrations](https://www.domaintools.com/integrations/)
    
    * * [SIEM](https://www.domaintools.com/integrations/?_integration=siem)
            * Enhance threat hunting and domain alerts in your preferred SIEM.
        * [SOAR](https://www.domaintools.com/integrations/?_integration=soar)
            * Create event playbooks and take targeted action with our leading domain intelligence.
    * * [Threat Intelligence](https://www.domaintools.com/integrations/?_integration=threat-intelligence)
            * Uncover actor infrastructure and profile threats in your preferred platform.
        * [Getting Started](https://www.domaintools.com/integrations/get-started/)
...
* [Partners](javascript:void(0);)
    ...
    * * [Reseller Partner](https://www.domaintools.com/partners/resell-partner-program/)
            * VAR’s, Distributors, MSSP’s and System Integrators can grow revenue and improve margins.
    * * [OEM Partners](https://www.domaintools.com/partners/oem-partners/)
            * Cyber Product and Service companies can quickly advance and differentiate your solution.
    * * [Technology Partners](https://www.domaintools.com/partners/become-a-technology-partner/)
            * Cyber Technology Companies enhance and expand your capabilities.
    
* [Solutions](https://www.domaintools.com/solutions/)
    
    * [Solutions](https://www.domaintools.com/solutions/)
    
    * By Use Case
        * [Threat Intelligence](https://www.domaintools.com/solutions/use-cases/threat-intelligence/)
            * See the Internet. Identify risk.
        * [Phishing and Fraud Prevention](https://www.domaintools.com/solutions/use-cases/phishing-fraud-prevention/)
            * Gain the early upper hand on emerging campaigns.
        * [Threat Hunting](https://www.domaintools.com/solutions/use-cases/threat-hunting/)
            * Make unknown threats known before they do damage.
        * [Brand Protection](https://www.domaintools.com/solutions/use-cases/brand-protection/)
            * Defend your brand and reputation.
        * [Forensics & Incident Response](https://www.domaintools.com/solutions/use-cases/forensics-incident-response/)
            * Discover “who is” behind attacks and threats.
        * [Application Enrichment](https://www.domaintools.com/solutions/use-cases/application-enrichment/)
            * Build homegrown or third-party security applications with the world’s best Internet intelligence.
    * By Industry
        * [Federal Government](https://www.domaintools.com/solutions/industry/government/)
            * Strengthening cybersecurity resilience across government systems.
        * [Financial Services](https://www.domaintools.com/solutions/industry/financial-services/)
            * Increasing the financial sector’s resilience against attacks.
        * [Healthcare](https://www.domaintools.com/solutions/industry/healthcare/)
            * Bolstering protection and defenses for PII and PHI.
        * [Technology](https://www.domaintools.com/solutions/industry/technology/)
            * Helping defenders of the high-tech attack surface.
        * [Retail](https://www.domaintools.com/solutions/industry/retail/)
            * Safeguarding against data breaches, consumer-based attacks, phishing, BEC, and other threats.
    
* [Company](https://www.domaintools.com/company/)
    
    * [Company](https://www.domaintools.com/company/)
    
    * * [Leadership](https://www.domaintools.com/company/leadership/)
            * Meet our exceptional executive team of experts and industry leaders.
        * [Careers](https://www.domaintools.com/company/careers/)
            * Join our team to collaborate with exceptional people who are dedicated to protecting the Internet.
    * * [Pressroom](https://www.domaintools.com/company/press/)
            * Access the latest DomainTools news and press coverage.
        * [Contact](https://www.domaintools.com/contact/)
...
* [Resource Center](https://www.domaintools.com/resources/)
    ...
    * * [Knowledge Center](javascript:void(0);)
            * [Blog](https://www.domaintools.com/resources/blog/)
                * Explore our library of thought leadership articles and insights.
            * [Webinars](https://www.domaintools.com/resources/webinars/)
                * Watch live and on-demand cybersecurity training from the DomainTools team.
            * [Podcasts](https://www.domaintools.com/resources/podcasts/)
                * Stream informative and exclusive episodes of DomainTools “Breaking Badness” podcast.
            * [White Papers](https://www.domaintools.com/resources/white-papers/)
                * Discover the real-world impact of DomainTools DNS intelligence.
    * Client Resources
        * [User Guides](https://www.domaintools.com/resources/user-guides/)
        ...
        * [Customer FAQs](https://www.domaintools.com/support/)
...
As you use our Services, we may collect Personal Data through the use of cookies and other technologies. We, and our third-party partners, automatically collect certain types of usage information when you visit our Services, read our emails, or otherwise engage with us. This information may include (i) your IP address (which may identify your general location), (ii) the type of browser, computer or device you use, (iii) technical information about the means of connection to the Services (for instance, the operating system, the Internet service provider utilized and other similar information), (iv) the page that led you to the Services, and (v) the search terms you typed into a search engine that led you to the Services. We typically collect this information through a variety of tracking technologies, including cookies, web beacons, embedded scripts, location-identifying technologies, file information, and similar technology (collectively, “tracking technologies”). You may use browser controls or tools made available by third parties to control tracking technologies and make certain choices about cookies placed on our Services through our “cookie banner.”
...
We do not knowingly collect information from minors and the Site is intended for adults over the age of 18. If you are a parent or guardian and believe that your child under the age of 13 has provided Personal Information to us without your consent, please notify us at [\[email protected\]](https://www.domaintools.com/cdn-cgi/l/email-protection). If we become aware that information is or has been submitted by or collected from a minor under the age of 13, we will work to promptly delete this information.
...
Additionally, EU residents have the right to lodge a complaint with their local data protection authority. Further information about how to contact your local data protection authority is available at [http://ec.europa.eu/justice/data-protection/bodies/authorities/index\_en.htm](http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm).

8) For California Residents
---------------------------

If you are a California resident, California law may provide you with additional rights regarding our use of your personal information. To learn more about your California privacy rights, visit our [California Privacy Notice](https://www.domaintools.com/company/california-privacy-notice).
...
If you have any questions or concerns about our Privacy Notice or if you want to exercise your rights, please send an email to [\[email protected\]](https://www.domaintools.com/cdn-cgi/l/email-protection) or write to us at: DomainTools, 2101 4th Ave, Suite 1720, Seattle, WA 98121. If you are in the European Union or the United Kingdom, you may address privacy-related inquiries to our representative pursuant to Article 27 GDPR as follows:
...
[\[email protected\]](https://www.domaintools.com/cdn-cgi/l/email-protection)
...
[![DomainTools Logo](https://www.domaintools.com/wp-content/uploads/dev-DomainTools-Logo-RC.png "DomainTools Logo")](https://www.domaintools.com/)

[Pricing](https://www.domaintools.com/pricing/) [Contact](https://www.domaintools.com/contact/) [Login](https://account.domaintools.com/log-in/?r=http%3A/whois.domaintools.com) [Support](https://www.domaintools.com/support/) [Request a Demo](https://www.domaintools.com/demo/)
...
* [Products](javascript:void(0);)
    * [Iris Platform](https://www.domaintools.com/products/platform/)
        * [Iris Detect](https://www.domaintools.com/products/platform/iris-detect/) 
        * [Iris Enrich](https://www.domaintools.com/products/platform/iris-enrich/)
        * [Iris Investigate](https://www.domaintools.com/products/platform/iris-investigate/)
    * [Farsight DNSDB](https://www.domaintools.com/products/farsight-dnsdb/)
    * [Threat Intelligence Feeds](https://www.domaintools.com/products/threat-intelligence-feeds/)
        * [Predictive Risk Scoring](https://www.domaintools.com/products/threat-intelligence-feeds/predictive-risk-scoring/)
        * [Hosting IP Risk Feed & Hotlist](https://www.domaintools.com/products/threat-intelligence-feeds/predictive-risk-scoring/hosting-ip-risk-feed-hotlist/)
        * [Domain Risk Feed & Hotlist](https://www.domaintools.com/products/threat-intelligence-feeds/predictive-risk-scoring/domain-risk-feed-hotlist/)
        * [Domain Visibility Feed](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/)
        * [Domain Discovery Feed](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/domain-discovery-feed/)
        * [Farsight Newly Active Domains](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/farsight-nad/)
        * [Farsight Newly Observed Hostnames](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/farsight-noh/)
        * [Farsight Newly Observed Domains](https://www.domaintools.com/products/threat-intelligence-feeds/domain-visibility/farsight-nod/)
    * [DomainTools Monitors](https://www.domaintools.com/products/monitors/)

* [Integrations](https://www.domaintools.com/integrations/)
    * [SIEM](https://domaintools.com/integrations/?_integration=siem)
    * [SOAR](https://domaintools.com/integrations/?_integration=soar)
    * [Threat Intelligence](https://domaintools.com/integrations/?_integration=threat-intelligence)
    * [Anomali](https://www.domaintools.com/integrations/anomali/)
    * [Cortex XSOAR](https://www.domaintools.com/integrations/cortex-xsoar/)
    * [CrowdStrike](https://www.domaintools.com/integrations/crowdstrike/)
    * [Elastic](https://www.domaintools.com/integrations/elastic/)
    * [IBM QRadar](https://www.domaintools.com/integrations/ibm-qradar/)
    * [IBM Resilient](https://www.domaintools.com/integrations/ibm-resilient/)
    * [Maltego](https://www.domaintools.com/integrations/maltego/)
    * [MISP](https://www.domaintools.com/integrations/misp/)
    * [Splunk](https://www.domaintools.com/integrations/splunk/)
    * [Splunk SOAR](https://www.domaintools.com/integrations/splunk-soar/)
    * [TheHive and Cortex](https://www.domaintools.com/integrations/thehive-and-cortex/)

* [Partners](javascript:void(0);)
    * [Reseller Partner](https://www.domaintools.com/partners/resell-partner-program/)
    * [Technology Partners](https://www.domaintools.com/partners/become-a-technology-partner/)
    * [MSSP Partners](https://www.domaintools.com/partners/mssp-partners/)
    * [OEM Partners](https://www.domaintools.com/partners/oem-partners/)
    * [Partner Portal](http://domaintools.allbound.com/)
* [Company](https://www.domaintools.com/company/)
    * [Leadership](https://www.domaintools.com/company/leadership/)
    * [Careers](https://www.domaintools.com/company/careers/)
    * [Pressroom](https://www.domaintools.com/company/press/)
...
* [Facebook](https://www.facebook.com/domaintoolsllc/ "Facebook")
* [Twitter](https://twitter.com/domaintools/ "Twitter")
* [Linkedin](https://www.linkedin.com/company/domaintools/ "Linkedin")

© 2024 DomainTools

DomainTools® and DomainTools™ are owned by DomainTools, all rights reserved.

[Privacy Policy](https://www.domaintools.com/company/privacy-policy/)    |    [California Privacy](https://www.domaintools.com/company/california-privacy-notice/) [Notice](#)  
[Do Not Sell My Personal Information](https://www.domaintools.com/company/california-privacy-notice/do-not-sell/)    |    [Terms of Service](https://www.domaintools.com/company/terms-of-service/)    |    [Sitemap](https://www.domaintools.com/sitemap/)