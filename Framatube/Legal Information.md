 [![](https://framasoft.org/img/logo-white.svg) **Frama****soft**
===============================================================](https://framasoft.org/fr)

* [Nos actions](#)
    * [Éducation populaire](https://framasoft.org/fr/educ-pop)
    * [Émancipation numérique](https://framasoft.org/fr/empowerment)
    * [Archipélisation](https://framasoft.org/fr/archipelago)
    * [Feuille de route 2023-2025](https://framasoft.org/roadmap)
* [Services libres](https://degooglisons-internet.org/)
* [Framablog](https://framablog.org/)
* [Nous trouver](#)
    * [Nous contacter](https://contact.framasoft.org/)
    * * * *
        
    * [Mastodon (micro-blog)](https://framapiaf.org/@Framasoft)
    * [PeerTube (vidéos)](https://framatube.org/a/framasoft/video-channels)
    * [Mobilizon (événements)](https://mobilizon.fr/@framasoft/events?showPassedEvents=false)
    * [Flux RSS](https://rss.framasoft.org/)
    * [Lettre d’information](https://contact.framasoft.org/newsletter)
    * * * *
        
    * [X](https://twitter.com/framasoft)
    * [Facebook](https://www.facebook.com/framasoft)
* Langue
    
    * [العربية](https://framasoft.org/ar/legals)
    * [Català](https://framasoft.org/ca/legals)
    * [Čeština](https://framasoft.org/cs/legals)
    * [Deutsch](https://framasoft.org/de/legals)
    * [English](https://framasoft.org/en/legals)
    * [Esperanto](https://framasoft.org/eo/legals)
    * [Español](https://framasoft.org/es/legals)
    * [Français](https://framasoft.org/fr/legals)
    * [Magyar](https://framasoft.org/hu/legals)
    * [Hrvatski](https://framasoft.org/hr/legals)
    * [Italiano](https://framasoft.org/it/legals)
    * [日本語](https://framasoft.org/ja/legals)
    * [Polski](https://framasoft.org/pl/legals)
    * [Português (Brasil)](https://framasoft.org/pt_BR/legals)
    * [Português (Portugal)](https://framasoft.org/pt_PT/legals)
    * [Русский](https://framasoft.org/ru/legals)
    * [Српска ћирилица](https://framasoft.org/sr_Cyrl/legals)
    * [Svenska](https://framasoft.org/sv/legals)
    * [Tiếng Việt](https://framasoft.org/vi/legals)
    * * * *
        
    * [Traduire](https://weblate.framasoft.org/projects/framasoft/)
    

Si nous pouvons faire tout ça, c’est grâce à vous, grâce à vos dons !

[Faire un don](https://framasoft.org/fr/#support)
...
Pour nous contacter : [https://contact.framasoft.org](https://contact.framasoft.org/)
...
Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des utilisateurs sur le site Framasoft. Framasoft se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions relatives à la protection des données. Le cas échéant, Framasoft se réserve également la possibilité de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment en cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le support utilisé (texte, photographie…).

### Limitations contractuelles sur les données techniques

Framasoft ne pourra être tenue responsable de dommages matériels liés à l’utilisation du site. De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant pas de virus et avec un navigateur de dernière génération mis-à-jour.
...
Mentions légales de l’association Framasoft,  
le 6 octobre 2014.