...
* [3\. Purposes, legal bases and storage period](#_purposes_legal_bases_and_storage_period)
    * [3.1. General use of the platform](#_general_use_of_the_platform)
    * [3.2. Registering for a user account](#_registering_for_a_user_account)
* [4\. Services of the website](#_services_of_the_website)
    * [4.1. Forums (bbs.archlinux.org)](#_forums_bbs_archlinux_org)
    * [4.2. Wiki (wiki.archlinux.org)](#_wiki_wiki_archlinux_org)
    * [4.3. Bug tracker (bugs.archlinux.org)](#_bug_tracker_bugs_archlinux_org)
    * [4.4. Arch User Repository (aur.archlinux.org)](#_arch_user_repository_aur_archlinux_org)
    * [4.5. GitLab (gitlab.archlinux.org)](#_gitlab_gitlab_archlinux_org)
    * [4.6. Collaboration pads (md.archlinux.org)](#_collaboration_pads_md_archlinux_org)
    * [4.7. Mailing lists (lists.archlinux.org)](#_mailing_lists_lists_archlinux_org)
    * [4.8. Arch IRC channels](#_arch_irc_channels)
* [5\. Contact](#_contact)
* [6\. Donations](#_donations)
* [7\. Storage period](#_storage_period)
* [8\. Categories of recipients](#_categories_of_recipients)
* [9\. General rights of data subjects](#_general_rights_of_data_subjects)
    * [9.1. Art. 15 GDPR - Right of access](#_art_15_gdpr_right_of_access)
    * [9.2. Art. 16 GDPR - Right of rectification](#_art_16_gdpr_right_of_rectification)
    * [9.3. Art. 17 GDPR - Right to deletion](#_art_17_gdpr_right_to_deletion)
    * [9.4. Art. 18 GDPR - Right to restriction of processing](#_art_18_gdpr_right_to_restriction_of_processing)
    * [9.5. Art. 20 GDPR - Right to data portability](#_art_20_gdpr_right_to_data_portability)
    * [9.6. Art. 77 GDPR in conjunction with Section 19 BDSG - Right to lodge a complaint with a supervisory authority](#_art_77_gdpr_in_conjunction_with_section_19_bdsg_right_to_lodge_a_complaint_with_a_supervisory_authority)
* [10\. In particular right to object and right to withdraw consent](#_in_particular_right_to_object_and_right_to_withdraw_consent)
    * [10.1. Art. 21 GDPR - Right to object](#_art_21_gdpr_right_to_object)
    * [10.2. Withdrawal of consent](#_withdrawal_of_consent)
* [11\. Obligation to provide data](#_obligation_to_provide_data)
* [12\. The existence of automated decision-making (including profiling)](#_the_existence_of_automated_decision_making_including_profiling)
* [13\. Internet-specific data processing and cookies](#_internet_specific_data_processing_and_cookies)
...
The Arch Linux Team (hereinafter referred to as "Arch" or "we") operates the website and its services available on the Internet at [https://archlinux.org/](https://archlinux.org/) including the respective sub-directories (hereinafter referred to as the "website").
...
Email: [privacy@archlinux.org](mailto:privacy@archlinux.org)
...
* your password for [the accounts service](https://accounts.archlinux.org/), [AUR](https://aur.archlinux.org/), [the forums](https://bbs.archlinux.org/), [wiki](https://wiki.archlinux.org/), [security tracker](https://security.archlinux.org/), [archweb](https://archlinux.org/), [GitLab](https://gitlab.archlinux.org/), or [the bugtracker](https://bugs.archlinux.org/),
...
### 4.1. Forums ([bbs.archlinux.org](https://bbs.archlinux.org/))
...
### 4.2. Wiki ([wiki.archlinux.org](https://wiki.archlinux.org/))
...
### 4.3. Bug tracker ([bugs.archlinux.org](https://bugs.archlinux.org/))
...
### 4.4. Arch User Repository ([aur.archlinux.org](https://aur.archlinux.org/))
...
### 4.5. GitLab ([gitlab.archlinux.org](https://gitlab.archlinux.org/))
...
### 4.6. Collaboration pads ([md.archlinux.org](https://md.archlinux.org/))
...
### 4.7. Mailing lists ([lists.archlinux.org](https://lists.archlinux.org/))
...
You can use our Arch IRC channels. To avoid spam you need to be registered in order to join. We process your personal data to provide you with the IRC channel’s functions. For information on the registration process, please see our corresponding wiki page at: [https://wiki.archlinux.org/title/Arch\_IRC\_channels](https://wiki.archlinux.org/title/Arch_IRC_channels). The IRC channels are provided by Libera Chat. We have no influence on the processing of your data by Libera Chat. For information on the processing of your personal data, please see [https://libera.chat/privacy](https://libera.chat/privacy).
