[![fastmail](https://www.fastmail.com/wp-content/themes/fastmail/webroot/images/header/logo.svg)](https://www.fastmail.com/)
...
[Home](https://www.fastmail.com/) / Terms of Service

Terms of Service
================

Fastmail is a committed member of the larger email, contacts, and calendars ecosystem. We are values-driven and privacy-aware.

These Terms of Service came into effect on **December 12 2022**. The only changes from our previous terms are the inclusion of our domain names Terms of Service and clarity around your rights under the Australian Consumer Law. You can also find our [previous Terms of Service](https://fastmail.com/tos-historical/) online:

* [May 23, 2022](https://fastmail.com/tos-historical/2022-2/)
* [May 25, 2020](https://fastmail.com/tos-historical/2020-2/)
* [May 24, 2018](https://fastmail.com/tos-historical/2018-2/)
* [October 1, 2017](https://fastmail.com/tos-historical/2017-2/)

The following are the terms and conditions for use of the various services provided by Fastmail Pty Ltd, ACN 142 646 580, PO Box 234, Collins St West 8007, Australia (referred to as “Fastmail”), including the Fastmail email service; the Topicbox mailing list service; the Pobox email forwarding, filtering and domains services;and the Fastmail domain names registration service (collectively referred to as the “Service”). Note that use of the Fastmail domain name registration service is additionally subject to the [Fastmail domain Terms of Service](https://fastmail.com/about/tos-domain/).
...
* (m) Threaten, abuse, or defame our staff in any way. We will not respond to or engage with any people or customers who choose to act in this manner. We reserve the right to suspend the account or refuse service to anyone who threatens, abuses or defames our staff.
* (n) Run any process or perform any activity that interferes with the proper working of the Services (including by placing an unreasonable load on the Services’ infrastructure).
...
* (b) any threatening, defamatory, obscene, offensive or illegal content or conduct of any other party or any infringement of another’s rights by another party, including intellectual property rights; or
...
* (a) The resupply of the Services or the cost of resupplying the Services if we determine that there has been a minor fault; or 
* (b) Cancelling the agreement and granting a refund if there is a major fault with the Services.
