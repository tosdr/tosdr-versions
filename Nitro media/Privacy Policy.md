...
* Via e-mail sent by a user to Nitro
* Through the use by Nitro of third-party databases from which user Information is extracted and combined with Information obtained by Nitro through other means.
...
* In connection with the operation of the Site and Nitro’s internal business
* In connection with other Sites or offline businesses owned or operated by Nitro
* For Users to obtain information and offers for products and services offered by Nitro as well as selected third parties.
...
* By writing us at: Nitro Media, 132 Mill Road, Moncton, NB, Canada E1C 9V8
* Visiting https://docs.corepassage.com/ccparequest.aspx to fill out a CCPA request form.
...
_Policy Last Revised: May 17, 2023_

© 2024 - GoFeedProvider.COM | [Contact Us](https://www.technosystem02.com/ContactUs)