Privacy Policy of **iubenda Privacy Controls and Cookie Solution**
==================================================================

Iubenda Privacy Controls and Cookie Solution collects some Personal Data from its Users.
...
SC: 12,795.78 Eur (fully paid up)  
...
Among the types of Personal Data that iubenda Privacy Controls and Cookie Solution collects, by itself or through third parties, there are: Usage Data; Trackers.

Complete details on each type of Personal Data collected are provided in the dedicated sections of this privacy policy or by specific explanation texts displayed prior to the Data collection.  
Personal Data may be freely provided by the User, or, in case of Usage Data, collected automatically when using iubenda Privacy Controls and Cookie Solution.  
Unless specified otherwise, all Data requested by iubenda Privacy Controls and Cookie Solution is mandatory and failure to provide this Data may make it impossible for iubenda Privacy Controls and Cookie Solution to provide its services. In cases where iubenda Privacy Controls and Cookie Solution specifically states that some Data is not mandatory, Users are free not to communicate this Data without consequences to the availability or the functioning of the Service.  
Users who are uncertain about which Personal Data is mandatory are welcome to contact the Owner.  
Any use of Cookies – or of other tracking tools — by iubenda Privacy Controls and Cookie Solution or by the owners of third-party services used by iubenda Privacy Controls and Cookie Solution serves the purpose of providing the Service required by the User, in addition to any other purposes described in the present document.

Users are responsible for any third-party Personal Data obtained, published or shared through iubenda Privacy Controls and Cookie Solution.
...
* ### Hosting and backend infrastructure
    ...
    This type of service has the purpose of hosting Data and files that enable iubenda Privacy Controls and Cookie Solution to run and be distributed as well as to provide a ready-made infrastructure to run specific features or parts of iubenda Privacy Controls and Cookie Solution.
    ...
    Place of processing: Netherlands – [Privacy Policy](https://www.digitalocean.com/legal/privacy-policy/).
    
    Category of personal information collected according to the CCPA: identifiers.
    
* ### Traffic optimization and distribution
    
    This type of service allows iubenda Privacy Controls and Cookie Solution to distribute their content using servers located across different countries and to optimize their performance.  
    Which Personal Data are processed depends on the characteristics and the way these services are implemented. Their function is to filter communications between iubenda Privacy Controls and Cookie Solution and the User's browser.  
    ...
    Akamai Content Delivery Network is a traffic optimization and distribution service provided by Akamai Technologies, Inc.
    
    Personal Data processed: Trackers; Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://www.akamai.com/us/en/privacy-policies/).
...
* ### iubenda as Data Controller
    
    iubenda processes, as Data Controller, the following access data which is strictly necessary for the technical provision of the service:  
      
    \* IP address;  
    \* Web browser info (User Agent/type of device);  
    \* Referrer (page viewed by the User) and all the information possibly available on the http header.  
      
    The information outlined above is sent to Bunny CDN which, in turn, forwards it to Akamai CDN. This forwarding is done, in the case of users in the European Union, without transmitting their IP address.  
      
    Further information about Akamai CDN and Bunny CDN can be found in the section "Detailed information on the processing of Personal Data" in the present document.
    
* ### US privacy laws
    
    The iubenda Privacy Controls and Cookie Solution is also designed to apply some privacy laws across the United States, if the "US State laws" option is activated.  
    When accessing a website or app, the solution displays the “Your privacy choices/Notice at collection” widget through which users can manage their privacy rights (Sale of my personal information, Share of my personal information, Processing of my personal information for targeted advertising, and Processing of sensitive personal information categories) and read the Notice at collection.  
      
    The preferences expressed by final users are stored in the Cookie and Consent Preference Log (CPL) and can be retrieved at any time.  
      
    Pursuant to the California Consumer Privacy Act of 2018, as amended by the California Privacy Rights Act of 2020 (CCPA), the category of personal information collected by iubenda through the Privacy Controls and Cookie Solution is: internet information.  
      
    The personal information collected by businesses is processed by iubenda as “service provider” (CCPA) and “processor” (under the Virginia Consumer Data Protection Act of 2023 or VCDPA) for the purpose of ensuring a correct execution of the Privacy Controls and Cookie Solution and its functionalities (“business purpose”).
    
* ### Personal Data retention time
    
    The information collected through the Privacy Controls and Cookie Solution is not normally retained by iubenda.  
    However, if necessary to monitor the service, and the proper functioning thereof, the following access data will be stored for a maximum period of time of 15 days: IP address, Web browser information, Referrer.
    
* ### Appointment of iubenda as Data Processor
    
    The clients acknowledge and accept that by using the Privacy Controls and Cookie Solution they are engaging iubenda to process Personal Data as “processor” pursuant to the European personal data protection legislation. The conditions of engagement are determined by the [Data Processing Agreement](https://www.iubenda.com/terms-and-conditions/39701710).  
      
    Such an agreement, the conclusion of which is required by law, therefore forms an integral and binding part of the contractual relationship between iubenda and its clients.
    
* ### Appointment of iubenda as Service Provider
    
    The clients acknowledge and accept that by using the Privacy Controls and Cookie Solution they are engaging iubenda to process Personal Data as “service provider” pursuant to the California Consumer Privacy Act. The conditions of engagement are determined by the [Service Provider Addendum](https://www.iubenda.com/terms-and-conditions/14591862).  
      
    Such an agreement, the conclusion of which is required by law, therefore forms an integral and binding part of the contractual relationship between iubenda and its clients.  
    
* ### Description of the service
    
    The Privacy Controls and Cookie Solution provided by iubenda allows websites and apps to request and manage consent for the use of cookies and similar technologies and to handle the preferences of US users related to their privacy rights.  
      
    Final users can accept or refuse the installation of cookies and similar technologies or personalize the related consent’s preferences through the banner displayed by the solution upon their first visit to a website or app. If the Cookie and Consent Preference Log (CPL) is enabled, the consent preferences for the installation of cookies and similar technologies expressed by final users are stored in the CPL and can be retrieved at any time.  
      
    When final users navigates on a website/application where the iubenda Privacy Controls and Cookie Solution is installed, a technical cookie is injected which contains the following information, for which iubenda acts as data processor:  
      
    \* Cookie Policy id number;  
    \* consent date and time;  
    \* consent content (accept/reject);  
    \* how the consent has been given (banner dismissal, button click etc.).  
      
    Depending on the configuration chosen, such technical cookie can be stored either on the iubenda.com domain (if the option enableRemoteConsent is active), or on the client’s domain (default setting).  
      
    From the above information, iubenda retrieves aggregate counters per day which indicate the number of consents given vs. the totality of the consents requested, including the indication of how the consent is given.
...
This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the entity running iubenda Privacy Controls and Cookie Solution and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).  
...
This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the business running iubenda Privacy Controls and Cookie Solution and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).
...
We may use your personal information to allow the operational functioning of iubenda Privacy Controls and Cookie Solution and features thereof (“business purposes”). In such cases, your personal information will be processed in a fashion necessary and proportionate to the business purpose for which it was collected, and strictly within the limits of compatible operational purposes.
...
We collect the above-mentioned categories of personal information, either directly or indirectly, from you when you use iubenda Privacy Controls and Cookie Solution.

For example, you directly provide your personal information when you submit requests via any forms on iubenda Privacy Controls and Cookie Solution. You also provide personal information indirectly when you navigate iubenda Privacy Controls and Cookie Solution, as personal information about you is automatically observed and collected.
...
You have the right to request that we delete any of your personal information, subject to exceptions set forth by the law (such as, including but not limited to, where the information is used to identify and repair errors on iubenda Privacy Controls and Cookie Solution, to detect security incidents and protect against fraudulent or illegal activities, to exercise certain rights etc.).
...
This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the controller running iubenda Privacy Controls and Cookie Solution and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).
...
The User's Personal Data may be used for legal purposes by the Owner in Court or in the stages leading to possible legal action arising from improper use of iubenda Privacy Controls and Cookie Solution or the related Services.  
The User declares to be aware that the Owner may be required to reveal personal data upon request of public authorities.

### Additional information about User's Personal Data

In addition to the information contained in this privacy policy, iubenda Privacy Controls and Cookie Solution may provide the User with additional and contextual information concerning particular Services or the collection and processing of Personal Data upon request.

### System logs and maintenance

For operation and maintenance purposes, iubenda Privacy Controls and Cookie Solution and any third-party services may collect files that record interaction with iubenda Privacy Controls and Cookie Solution (System logs) or use other Personal Data (such as the IP Address) for this purpose.
...
The Owner reserves the right to make changes to this privacy policy at any time by notifying its Users on this page and possibly within iubenda Privacy Controls and Cookie Solution and/or - as far as technically and legally feasible - sending a notice to Users via any contact information available to the Owner. It is strongly recommended to check this page often, referring to the date of the last modification listed at the bottom.  
...
Information collected automatically through iubenda Privacy Controls and Cookie Solution (or third-party services employed in iubenda Privacy Controls and Cookie Solution), which can include: the IP addresses or domain names of the computers utilized by the Users who use iubenda Privacy Controls and Cookie Solution, the URI addresses (Uniform Resource Identifier), the time of the request, the method utilized to submit the request to the server, the size of the file received in response, the numerical code indicating the status of the server's answer (successful outcome, error, etc.), the country of origin, the features of the browser and the operating system utilized by the User, the various time details per visit (e.g., the time spent on each page within the Application) and the details about the path followed within the Application with special reference to the sequence of pages visited, and other parameters about the device operating system and/or the User's IT environment.

#### User

The individual using iubenda Privacy Controls and Cookie Solution who, unless otherwise specified, coincides with the Data Subject.
...
The natural or legal person, public authority, agency or other body which, alone or jointly with others, determines the purposes and means of the processing of Personal Data, including the security measures concerning the operation and use of iubenda Privacy Controls and Cookie Solution. The Data Controller, unless otherwise specified, is the Owner of iubenda Privacy Controls and Cookie Solution.

#### iubenda Privacy Controls and Cookie Solution (or this Application)

The means by which the Personal Data of the User is collected and processed.

#### Service

The service provided by iubenda Privacy Controls and Cookie Solution as described in the relative terms (if available) and on this site/application.
...
This privacy policy relates solely to iubenda Privacy Controls and Cookie Solution, if not stated otherwise within this document.
...
[Show the simplified Privacy Policy](https://www.iubenda.com/privacy-policy/36700132 "Show the simplified Privacy Policy")