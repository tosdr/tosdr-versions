...
* [Buy](#how-to-buy) goods and services.
...
* Sign up for [PayPal products](https://www.paypal.com/us/webapps/mpp/merchant?locale.x=en_US) that meet your business needs.

Business accounts may be subject to fees that differ from the fees applicable to personal accounts. Business accounts are not eligible to receive “[personal transactions](https://www.paypal.com/us/webapps/mpp/paypal-fees?locale.x=en_US#SendAndReceiveMoney)”, although they may send personal transactions to friends and family with an eligible PayPal account.
...
By linking a payment method to your PayPal account, as described in the section [**Link or Unlink a Payment Method**](#linking-funding), you authorize PayPal to charge such linked payment method (a) whenever you choose such linked payment method to send money or purchase something using PayPal, (b) in connection with any errors, claims, or disputes, and (c) for amounts you owe to PayPal.
...
All deposits to and withdrawals from PayPal Savings are made via transfer to your PayPal balance. When you link PayPal Savings to your PayPal account, you authorize PayPal and Synchrony Bank to transfer funds between your eligible Balance Account and PayPal Savings in accordance with your instructions. More information about sending and receiving funds from PayPal Savings can be found in the [PayPal Balance Terms and Conditions](https://www.paypal.com/legalhub/pp-balance-tnc#friends-family-savings).

### Business accounts

Money sent to a business account can be held directly as balance in the business account. The balance functionality in your business account will differ depending on whether we have been able to verify the [required identifying information](#business-accounts) that you provide to us.
...
For some uses of your PayPal accounts, PayPal may determine currency conversion is necessary. The applicable currency conversion spread can be found on our Fees page under the heading [Currency conversion](https://www.paypal.com/webapps/mpp/merchant-fees#statement-13).
...
The fees applicable to sending personal transactions to an eligible PayPal account can be found on our [**Consumer Fees page**](https://www.paypal.com/webapps/mpp/paypal-fees#SendAndReceiveMoney) and will be disclosed to you in advance each time you initiate sending a personal transaction to a friend or family member. If you convert money in your Balance Account balance or in your business account balance from one currency to another before sending money, PayPal’s transaction exchange rate (including our [currency conversion spread](https://www.paypal.com/webapps/mpp/paypal-fees#statement-currency)) will be used. If you use your credit card as the payment method when sending money, you may also be charged a cash-advance fee by your card issuer.
...
If you have a personal account, you may cancel a recurring automatic payment 3 [**Business Days**](#business-days) or more before the date of the next scheduled payment from your account settings or by contacting us through the [**PayPal Help Center**](https://www.paypal.com/smarthelp/home), or by calling PayPal at (888) 221-1161. If you order us to stop one of these payments 3 [**Business Days**](#business-days) or more before the transfer is scheduled, and we do not do so, we will be liable for your losses or damages.
...
If you have authorized an automatic payment and PayPal performs currency conversion for an automatic payment transaction, PayPal will use the transaction exchange rate (including PayPal’s [**currency conversion spread**](https://www.paypal.com/webapps/mpp/paypal-fees#statement-currency)) in effect at the time the automatic payment transaction is processed.
...
* Within 1 day of the date of the original payment, PayPal’s transaction exchange rate (including a [currency conversion spread](https://www.paypal.com/webapps/mpp/paypal-fees#statement-currency)) used at the time of the original payment will apply.
* Beyond 1 day of the date of the original payment, PayPal’s transaction exchange rate (including a [currency conversion spread](https://www.paypal.com/webapps/mpp/paypal-fees#statement-currency)) on the date of the refund will apply.
...
When you send money using the Send Money feature in your PayPal account to eligible PayPal accounts within the U.S. using balance in your Balance Account linked to your personal account, the balance in your business account, or your bank account, we waive all fees charged to you (as per our [Fee pages](https://www.paypal.com/webapps/mpp/paypal-fees)), so we always show you these payment options first, even if you have a set preferred payment method for your online purchases. You always have the choice to select any payment method in your PayPal account during the Send Money experience. If you select a payment method with a fee, we will always show you the fee before you send money.
...
The PayPal Rewards Program allows eligible PayPal users to earn rewards points for completing qualifying transactions or activities. See the [PayPal Rewards Program Agreement](https://www.paypal.com/legalhub/pp-rewards-program-tnc) for more information. Such agreement governs participation in the PayPal Rewards Program and is incorporated herein by reference.
...
If you use PayPal Payouts (formerly Mass Pay), the [PayPal Payouts Terms and Conditions](https://www.paypal.com/us/webapps/mpp/ua/paypal-payouts-agreement?locale.x=en_US) will apply.
...
If you promote the use of PayPal’s Credit Products on your sites, other approved channels, and/or consumer communications through the PayPal Advertising Program, there are additional requirements that [apply](https://www.paypal.com/legalhub/pay-later-messaging-tnc).

If you receive consumer inquiries relating to a Credit Product including but not limited to PayPal Credit, PayPal Cashback Mastercard, or the PayPal World Cashback Mastercard, then you must direct the consumer to the Customer Support channel associated with the Credit Product. If you receive consumer inquiries relating to PayPal or another Credit Product other than those listed above, then you must direct the consumer to [**PayPal Customer Support**](https://www.paypal.com/cshelp/personal).
...
* Breach this user agreement, the PayPal [Acceptable Use Policy](https://www.paypal.com/legalhub/acceptableuse-full), the [Commercial Entity Agreements](https://www.paypal.com/legalhub/ceagreement-full) (if they apply to you), the [PayPal Balance Terms and Conditions](https://www.paypal.com/legalhub/pp-balance-tnc) (if it applies to you), or any [other agreement](https://www.paypal.com/legalhub/home) between you and PayPal;
...
* Access the PayPal services from a country that is not included on PayPal’s [permitted countries list](https://www.paypal.com/webapps/mpp/country-worldwide);
...
If a payment sent to you as a seller is challenged as a payment that should be invalidated and reversed, we may place a temporary hold on the funds in your PayPal account to cover the amount that could be reversed. Any of the situations described under [Refunds, Reversals and Chargebacks](#s3-refunds-reversals-chargebacks) are situations that could result in us placing a hold on a payment. If we determine the transaction should not be reversed, we’ll lift the temporary hold. If we determine the transaction should be reversed, we’ll remove the funds from your PayPal account.
...
* Invalidation and reversal of a payment as a result of the actions described under [Refunds, Reversals and Chargebacks](#s3-refunds-reversals-chargebacks).
...
Anti-money laundering and counter-terrorism financing laws may require that PayPal verify the​ [required identifying information](#business-accounts) if you use certain PayPal services. PayPal reserves the right to close, suspend, or limit access to your PayPal account and/or the PayPal services in the event that, after reasonable inquiries, we are unable to obtain information about you required to verify your identity.
