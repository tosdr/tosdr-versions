[SOFTPEDIA®](https://www.softpedia.com/ "Softpedia")

*   [Windows Apps](https://win.softpedia.com/ "Windows Software")
*   [Mac Apps](https://mac.softpedia.com/ "Mac Apps")
*   [Linux Apps](https://linux.softpedia.com/ "Linux Software")
*   [Drivers](https://drivers.softpedia.com/ "Windows Device Drivers")
*   [Android APK](https://mobile.softpedia.com/apk/ "Android Apps (APK)")
*   [Reviews](https://news.softpedia.com/ "Technology News")

[](http://www.softpedia.com/dyn-search.php)

3,496,208,326 served downloads

178 new items today

1,622,545 items total
...
Before you create an account on this site, you will need to accept our [Terms and Conditions](https://www.softpedia.com/user/terms.shtml).

If you have any questions about this privacy policy, including any requests to exercise your legal rights, please contact [\[email protected\]](http://www.softpedia.com/cdn-cgi/l/email-protection). This is your email contact in respect of all queries relating to your data protection rights and we aim to respond promptly to all such emails.
...
You can set your browser to refuse all or some of the browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please see our [Cookies Policy](https://www.softpedia.com/user/cookies.shtml).
...
### Specific legal rights for users located in the [EEA region](https://en.wikipedia.org/wiki/European_Economic_Area) (GDPR)

You may contact our data protection officer at [\[email protected\]](http://www.softpedia.com/cdn-cgi/l/email-protection) for more information or to exercise any of these rights:
...
Use our [DSR (data subject request) form](https://www.softpedia.com/dsr/) or send an email to [\[email protected\]](http://www.softpedia.com/cdn-cgi/l/email-protection)

You also have the right to make a complaint at any time to the [ANSPDCP](https://www.dataprotection.ro/), the Romanian supervisory authority for data protection issues. We would, however, appreciate the chance to deal with your concerns about data protection before you approach the authority so please contact us in the first instance.
...
1\. California residents may exercise the following rights by contacting our Privacy Policy Coordinator by email at [\[email protected\]](http://www.softpedia.com/cdn-cgi/l/email-protection):
...
7\. California's "Shine the Light" law permits customers who are California residents to request certain details about how a business shares their personal information as defined by "Shine the Light" with third parties (and in some cases affiliates) for those third parties' or affiliates' own direct marketing purposes. California customers may request information about our compliance with this law by contacting us by e-mail at [\[email protected\]](http://www.softpedia.com/cdn-cgi/l/email-protection) or by mail at the address set forth in Section 11 above. Any such mail inquiry must include "California Privacy Rights Request" in the first line of the description and include your name, street address, city, state, and ZIP code. Please note that we are only required to respond to one request per customer each year, and we are not required to respond to requests made by means other than through this email or mail address.
...
[Contact](https://www.softpedia.com/user/contact.php "Contact")  • [Privacy Policy](https://www.softpedia.com/user/privacy.shtml "Privacy Policy")  • [Cookie Policy](https://www.softpedia.com/user/cookies.shtml "Cookie Policy")  • EU residents: [Cookie Settings](javascript:; "Cookie Settings")
