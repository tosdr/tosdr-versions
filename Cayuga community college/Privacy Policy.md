Privacy Policy of **www.cayuga-cc.edu**
=======================================
...
**Owner contact email:** webmaster@cayuga-cc.edu

Types of Data collected
-----------------------

Among the types of Personal Data that this Website collects, by itself or through third parties, there are: Cookies; Usage Data; address; first name; last name; gender; date of birth; phone number; state; email address; ZIP/Postal code; city; company name; Social Security number (SSN); number of Users; session statistics; browser information; geography/region; clicks; browsing history.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Interaction with external social networks and platforms, Contacting the User, Advertising, Displaying content from external platforms, Remarketing and behavioral targeting, RSS feed management, Tag Management, Infrastructure monitoring, Managing contacts and sending messages, Registration and authentication provided directly by this Website, SPAM protection and Analytics.
...
* ### Analytics
    ...
    * targeted advertising according to the VCDPA
    ...
    Matomo Cloud is an analytics service provided by InnoCraft.
    
    Personal Data processed: browser information; browsing history; clicks; geography/region.
    
    Place of processing: New Zealand – [Privacy Policy](https://matomo.org/matomo-cloud-privacy-policy/).
...
* ### Contacting the User
    ...
    Personal Data processed: address; city; date of birth; email address; first name; gender; last name; phone number; state; ZIP/Postal code.
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    Personal Data processed: address; city; company name; email address; first name; last name; phone number; state; ZIP/Postal code.
...
* ### Displaying content from external platforms
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    Google Programmable Search Engine is a search engine embedding service provided by Google LLC or by Google Ireland Limited, depending on how the Owner manages the Data processing, that allows this Website to incorporate content of this kind on its pages.
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    Adobe Edge Web Fonts is a typeface visualization service provided by Adobe Systems Incorporated that allows this Website to incorporate content of this kind on its pages.
...
* ### Infrastructure monitoring
    ...
    **Purpose for Processing the Personal Data**  
    Monsido is a software-as-a-service (SaaS) company that provides access to Services that scan and analyze our website. The Services consist of a collection of tools for controlling and optimizing website content, accessibility review, improving search engine optimization (SEO), monitoring website performance, and utilizing website analytics data. As such, their services collect and process our website data by crawling the Cayuga website, storing cache copies of the content, analyzing the content, and detailing the results in reports generated on their SaaS platform.  
      
    **The Personal Data that We Collect**  
    Monsido may collect information that personally identifies our website visitors and individuals whose information appears on our website (“Personal Data”). Personal Data on our website will typically consist of names, postal addresses, e-mail addresses, telephone numbers, or any other information on our website which can be directly or indirectly attributed to an individual. Cayuga does not typically post these items on our website, other than a student’s name (e.g. Dean's Listing).  
      
    Monsido’s Services are not intended for the collection or processing of any sensitive data (e.g., health or sex life information; racial or ethnic origin; political opinions or religious/ philosophical beliefs; trade union membership).  
      
    **Methods Used to Collect Personal Data**  
      
    There are two potential ways in which data is collected:  
      
    **Crawler.**  
    Monsido’s services utilize web crawlers to scan our website. Web crawlers are computer programs that scan the website, read everything they find, and store that data in Monsido’s databases. This information is represented in reports that are subsequently generated through their SaaS platform.  
    **Analytics.**  
    Analytics requires that you install a JavaScript snippet on the master template of our website so that certain data will be captured. When a page with the JavaScript snippet loads, the script will provide information on the website visitor.  
      
    Monsido also uses cookies. A cookie is a small file placed on the hard drive of your computer. A website visitor may refuse to accept browser cookies by activating the appropriate setting on her or his browser. For more information on cookies and how a website visitor can remove them according to the type of browser used, refer to www.allaboutcookies.org.  
      
    Monsido’s cookies are used to help visitors’ use of the website. It is used to collect statistics about site usage, such as when the visitor last visited the site. This information is then used to improve the user experience on the website. This Monsido Analytics cookie contains a randomly generated ID used to recognize the browser when a visitor reads a page. The cookie contains no personal information and is used only for web analytics.  
      
    Monsido’s cookies are used purely to track the sequence of pages a visitor looks at during a visit to the site. This information can be used to create user journeys and enable visitors to find relevant information quickly.  
      
    To ask questions or comment about this Monsido’s policies and their privacy practices, contact them at privacy@monsido.com.
    ...
    * targeted advertising according to the VCDPA, CPA, CTDPA and UCPA
    ...
    LogRocket is a monitoring service provided by LogRocket, Inc .
    
    Personal Data processed: Tracker; Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://logrocket.com/privacy/).
    ...
    * targeted advertising according to the CPA, CTDPA and UCPA
    ...
    Place of processing: United States – [Privacy Policy](https://www.datadoghq.com/legal/privacy/).
...
* ### Registration and authentication provided directly by this Website
    ...
    Personal Data processed: address; date of birth; email address; first name; last name; phone number; Social Security number (SSN).
...
* ### RSS feed management
    ...
    This type of service allows this Website to manage RSS feeds and the distribution of their content. Depending on the characteristics of the service used, these services may be used to insert ads within the content and to gather statistics data from them.
    ...
    Place of processing: US – [Privacy Policy](http://www.google.com/intl/en/policies/privacy/).
...
* ### Links to External Websites
    ...
    Links from this web site to web sites outside Cayuga Community College are for the convenience of the user. Such links do not constitute an official endorsement or approval of any private sector web site, product, or service.
    
    This processing constitutes a sale based on the definition under the CCPA. In addition to the information in this clause, the User can find information regarding how to opt out of the sale in the section detailing the rights of Californian consumers.
    
* ### Disclaimer of Liability
    
    Every effort is made to provide accurate and complete information. However, we cannot guarantee that there will be no errors. Concerning documents and information on this website neither Cayuga Community College, nor their employees and contractors make any warranty, expressed or implied, including the warranties of merchantability and fitness for a particular purpose concerning documents available from this web site. Additionally, the State University of New York assumes no legal liability for the accuracy, completeness, or usefulness of any information or process disclosed herein and do not represent that use of such information or process would not infringe on privately owned rights.
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://www.iubenda.com/privacy-policy/8183428/cookie-policy "Cookie Policy").
...
We have collected the following categories of personal information about you: identifiers, commercial information, biometric information, internet or other electronic network activity information and geolocation data.

We have collected the following categories of sensitive personal information: Social Security number (SSN)
...
We have collected the following categories of personal data: identifiers, commercial information, internet information and geolocation data

With your consent, we collect the following categories of sensitive data: Social Security number (SSN)  
...
[Download PDF](https://www.iubenda.com/privacy-policy/8183428.pdf)
...
[Show the simplified Privacy Policy](https://www.iubenda.com/privacy-policy/8183428 "Show the simplified Privacy Policy")