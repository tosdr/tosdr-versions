...
* [English](https://www.tawk.to/terms-of-service/ "English")
...
10\. You guarantee every end user the right to object to your processing of personal data relating to the end user and processed for the purposes of direct marketing. tawk.to is firmly committed to protecting the privacy of your personal information and the personal information of your customers. By using tawk.to, you acknowledge and agree that tawk.to’s collection, usage and disclosure of this personal information is governed by our [Privacy Policy](https://www.tawk.to/privacy-policy/).
...
(c) you are otherwise subject to the requirements of the EU General Data Protection Regulation, tawk.to’s collection and use of personal information of any European residents is also subject to our [Data Processing Addendum](https://www.tawk.to/data-protection/dpa-data-processing-addendum/).
...
15\. You acknowledge and agree that tawk.to is the sole owner of the Service including without limitation, all applicable copyrights, patents, trademarks, and trade secrets, database rights, treaties, and all other intellectual property rights appurtenant thereto. Personally identifiable data collected by tawk.to in the course of fulfilling its obligations under this Agreement shall be used by tawk.to in accordance with the then-current tawk.to privacy policy. You acknowledge that no title to the intellectual property in the Service transfers to you as a result of your use of the Service. You further acknowledge that title and full ownership rights to the Service will remain the exclusive property of tawk.to and you will not acquire any rights to the Service except as expressly set forth herein. You are not permitted to disseminate any information that is made available to you, as a licensee, by tawk.to, including without limitation, Login Credentials. Any rights not expressly granted herein are reserved.
...
* Sell or resell the services we provide,
...
* Access the Service by any means other than through the interfaces that are provided by tawk.to for use in accessing the Service,
* Impersonate any other person or entity, including without limitation any tawk.to official, or misrepresent your affiliation with any other person or entity, or
...
* Modify or alter the tawk.to widget out of the scope of the customization options available in the tawk.to dashboard.
* Remove or alter tawk.to logo and branding from the widgets or tawk.to pages in any way.

tawk.to Partner Programme terms and conditions
==============================================
...
This Partner Agreement (the **“Agreement”**) is an agreement by and between **tawk.to inc**., with an address of 187 East Warm Springs Rd, SB298 Las Vegas, Nevada, USA 89119 ( **“tawk.to”**) and you or the entity that you represent (‘you’, ‘You’ or ‘tawk.to partner’), and takes effect upon your submission to become a tawk.to partner (the **“Effective Date”**) Purpose.

tawk.to is a provider of live chat software that can be used either through a website browser or a downloadable app, that allows businesses to communicate with their customers. Partner is in a position to promote, market, and advertise tawk.to, to potential customers (“referrals”) who may become customers of tawk.to

1. **Referral Arrangement.** Upon the Effective Date of this Agreement, Partner may from time to time, refer potential clients/customers to tawk.to. tawk.to will pay Partner a fee for these referrals.
2. **Compensation.** tawk.to shall pay Partner a commission based on their partner tier membership, for each successful referral, where a successful referral is defined as a referral that becomes a paying client/customer of tawk.to. tawk.to shall pay Partner via Paypal, within 15 days of the end of each calendar month after a successful referral.
3. **Termination.** The term of this Agreement commences once you register on the tawk.to website as a PARTNER and lasts until terminated by either Party. Upon termination, tawk.to shall pay Partner all compensation due and owing for referrals made prior to the date of termination, but not yet paid.
4. **Partner Termination.** tawk.to reserves the right to immediately terminate the Partner from the program in the event that Partner acts in an unlawful manner, or conducts business in a manner that is negative to tawk.to or to the Partner Program.
...
10. **Modification of Agreement.** tawk.to may modify this Agreement from time to time at its reasonable discretion by posting a change on the site at [https://www.tawk.to/partner-program/](https://www.tawk.to/partner-program/) or notifying Partner via email. If Partner objects to any such change, Partner may terminate this Agreement for cause. Partner’s continued participation in the Program following receipt of notice about changes to this Agreement shall constitute binding acceptance of this Agreement as amended.
