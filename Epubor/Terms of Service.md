...
[Home](https://epubor.com/) > [About](https://epubor.com/about.html) >[Terms of Use](https://www.epubor.com/refund-policy.html)
...
* [Single User License](#single-license)
* [Multiple Users License](#multi-license)
* [Extended Download Service](#eds)
* [Client Rights and Interests](#client-rights)
* [License Change/Update](#license-change)
* [Secure Shopping Guarantee](#secure-shopping)
...
Step 2, Request refund from our [platform 2checkout](https://secure.2co.com/myaccount/order_lookup/);  
...
Pricing for multi-user license depends on the number of end user. **The more users, the cheaper price.**If you are intend to purchase hundreds of licenses or more, we can give you a lower price, please [open a ticket](mailto:support@epubor.com) and our customer service will contact you within 24 hours in working days. 
...
However, if your order is still within 30 days from the payment date(7 days for 1 Month License), you can repurchase the correct platform software first and then contact [Epubor Support Team](mailto:support@epubor.com) to get the refund for the wrong platform software.
...
[Join in Epubor Editor Team to Get Lifetime License for Free](https://www.epubor.com/get-free-license.html#article)
...
3.8  [(12 reviews)](https://epubor.com/refund-policy-sms.htm)
