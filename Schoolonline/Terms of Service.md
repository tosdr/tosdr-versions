...
New Derwent House, 69-73 Theobalds Road, London, England, WC1X 8TA (“School Reviewer”). ‘schoolonline.co.uk’ is a registered trade name of School Reviewer.
...
Using our Services and accessing your Content requires registration with SchoolOnline. Your SchoolOnline user ID is valuable, and you are responsible for maintaining its confidentiality and security. SchoolOnline is not responsible for any losses arising from the unauthorised use of your SchoolOnline ID. Please contact School Reviewer if you suspect that your SchoolOnline ID has been compromised.

You must be age 10 (or equivalent minimum age in your Home Country, as set forth in the registration process) to create a SchoolOnline ID and use our Services. SchoolOnline IDs for persons under this age can be created by a parent or legal guardian using Family Sharing or by an approved educational institution.

#### PRIVACY

Your use of our Services is subject to School Reviewer’s Privacy Policy, which is available on our website.
...
* You can use Content from up to five different SchoolOnline IDs on each device.
...
3. Termination. This Agreement is effective until terminated by you or Licensor. Your rights under this Agreement will terminate automatically if you fail to comply with any of its terms.
...
6. You may not use or otherwise export or re-export the Licensed Application except as authorised by the laws of the United Kingdom or such other jurisdiction as may be applicable and the laws of the jurisdiction in which the Licensed Application was obtained.
7. The Licensed Application and related documentation are protected by copyright laws worldwide
...
“School Reviewer” means: School Reviewer Limited of New Derwent House, 69-73 Theobalds Road, London, England, WC1X 8TA, United Kingdom;
...
If you believe that any Content available through the Services infringe a copyright claimed by you, please contact School Reviewer via our email: info@schoolonline.co.uk.

#### TERMINATION AND SUSPENSION OF SERVICES

If you fail, or School Reviewer suspects that you have failed, to comply with any of the provisions of this Agreement, School Reviewer may, without notice to you: (i) terminate this Agreement and/or your SchoolOnline ID, and you will remain liable for all amounts due under your SchoolOnline ID up to and including the date of termination; and/or (ii) terminate your license to the software; and/or (iii) preclude your access to the Services.
