...
* [Use Cases](https://www.keepersecurity.com/resources/solutions/use-cases/)
    ...
    * [**Password Management**](https://www.keepersecurity.com/solutions/enterprise-password-management.html "Protect and manage your organization's passwords, metadata and files")
    * [**Single Sign-On Security**](https://www.keepersecurity.com/solutions/single-sign-on.html "Seamlessly and quickly strengthen SAML-compliant IdPs, AD and LDAP")
    * [**Password Sharing**](https://www.keepersecurity.com/features/password-sharing.html "Securely share passwords and sensitive information with users and teams")
    * [**Passwordless Authentication**](https://www.keepersecurity.com/solutions/passwordless-authentication.html "Enable passwordless authentication for fast, secure access to applications")
    * [**Secrets Management for DevOps**](https://www.keepersecurity.com/secrets-manager.html "Protect critical infrastructure, CI/CD pipelines and eliminate secret sprawl")
    * [**Credential Governance & Controls**](https://www.keepersecurity.com/solutions/role-based-access-control.html "Achieve visibility, control and security across the entire organization")
    * [**Privileged Session Management**](https://www.keepersecurity.com/solutions/privileged-session-management.html "Securely manage applications and services for users, teams and nodes")
    * [**SSH Key Management**](https://www.keepersecurity.com/solutions/ssh-key-management.html "Manage and protect SSH keys and digital certificates across your tech stack")
    * [**Remote Infrastructure Access**](https://www.keepersecurity.com/solutions/remote-infrastructure-access.html "Initiate secure remote access with RDP, SSH and other common protocols")
    * [**Secure Remote Database Access**](https://www.keepersecurity.com/solutions/remote-database-access.html "Restrict secure access to authorized users with RBAC and policies")
    * [**Zero-Trust Security**](https://www.keepersecurity.com/solutions/zero-trust-security.html "Strengthen your organization with zero-trust security and policies")
    * [**Industry Compliance & Reporting**](https://www.keepersecurity.com/solutions/industry-compliance-reporting.html "Achieve industry compliance and audit reporting including SOX and FedRAMP")
    * [**Password Rotation**](https://www.keepersecurity.com/solutions/password-rotation/ "Automate credential rotation to drastically reduce the risk of credential-based attacks")
    * [**Remote Privileged Access Management**](https://www.keepersecurity.com/solutions/remote-privileged-access-management/ "Provide employees, vendors and trusted third parties with privileged remote access to critical systems without requiring a VPN.")
...
* Resources
    ...
    * [Keeper ROI Calculator](https://www.keepersecurity.com/roi-calculator-password-manager/ "Keeper ROI Calculator")
...
Please read these Terms of Use carefully. The following are the terms of use for your subscription to Keeper and use of the Software. By using Keeper software you accept these terms of use. These terms of use are not assignable by you to anyone else. If you have purchased your Keeper services through a third party reseller that has incorporated these terms of use by reference as a part of its agreement with you, any references to ‘Keeper Security’ hereunder shall be understood to mean ‘your third party reseller acting for or on behalf of Keeper Security’.
...
Please read these Terms of Use carefully. These terms of use cover your subscription to KeeperChat and use of the Software. By using KeeperChat you accept these terms of use. These terms of use are not assignable by you to anyone else. If you have purchased your Keeper services through a third party reseller that has incorporated these terms of use by reference as a part of its agreement with you, any references to ‘Keeper Security’ hereunder shall be understood to mean ‘your third party reseller acting for or on behalf of Keeper Security’.
...
Open Source Software (“OSS”) means software components, including Apache Guacamole, which have been embedded, combined, packaged, or otherwise distributed in or with the Software, with or without modifications, under separate license terms, which can be obtained from the author(s) of the software components.
...
* Use Cases
    ...
    * [Remote Privileged Access Management](https://www.keepersecurity.com/solutions/remote-privileged-access-management/)
* Resources
    * [Blog](https://www.keepersecurity.com/blog/)
    * Free Cybersecurity Tools
        * [Personal Dark Web Scan](https://www.keepersecurity.com/free-data-breach-scan.html)
