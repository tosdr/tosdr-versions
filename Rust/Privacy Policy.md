...
3. [Cookies #](#cookies)
4. [Data Transfers #](#data-transfers)
5. [Information Security #](#information-security)
6. [Your Rights #](#your-rights)
7. [Data Retention #](#data-retention)
8. [Children’s Privacy #](#children%E2%80%99s-privacy)
9. [Specific services #](#specific-services)
    1. [Rust Foundation administration #](#rust-foundation-administration)
    2. [Rust Foundation Community Grants Program #](#rust-foundation-community-grants-program)
    3. [rust-lang.org #](#rust-lang.org)
        1. [static.rust-lang.org #](#static.rust-lang.org)
    4. [crates.io #](#crates.io)
    5. [docs.rs #](#docs.rs)
    6. [Forums #](#forums)
...
**Children’s Privacy** [#](#children%E2%80%99s-privacy)
-------------------------------------------------------
...
### **Rust Foundation administration** [#](#rust-foundation-administration)
...
### **Rust Foundation Community Grants Program** [#](#rust-foundation-community-grants-program)
...
### **[rust-lang.org](http://rust-lang.org/)** [#](#rust-lang.org)
...
When you visit [rust-lang.org](http://rust-lang.org/), we receive your IP address as part of our standard server logs. We store these logs for 1 year.

#### **[static.rust-lang.org](http://static.rust-lang.org/)** [#](#static.rust-lang.org)

When you (or tooling, such as Rustup) visits [static.rust-lang.org](http://static.rust-lang.org/) or [dev-static.rust-lang.org](http://dev-static.rust-lang.org/), we receive your IP address, user-agent header, referer header, and request path as part of our standard server logs. We store these logs for 1 year.

### **[crates.io](http://crates.io/)** [#](#crates.io)
...
[Crates.io](http://crates.io/) requires users to have a [GitHub account](https://github.com/) in order to log in and use the service. When you log in to [Crates.io](http://crates.io/) using a GitHub account, we receive your GitHub username and avatar. If you share a display name or public email address in your GitHub public profile, we also receive that information.

You must have a verified email address to publish a crate. We receive any public email address associated with your GitHub account. You can also choose to submit a different address to associate with your [Crates.io](http://crates.io/) activity. We will only use your email address to contact you about your account.

When you visit [Crates.io](http://crates.io/), we receive your IP address, user-agent header, and request path as part of our standard server logs. We store these logs for 1 year.

When you (or tooling, such as Cargo) visits [static.crates.io](http://static.crates.io/), we receive your IP address, user-agent header, referer header, and request path as part of our standard server logs. We store these logs for 1 year.

All crates on [Crates.io](http://crates.io/) are public, including the list of crate owners’ user names and the crate upload date. Anyone may view or download a crate’s contents. Because of the public nature of [Crates.io](http://crates.io/), any personal data you might include in a Cargo.toml file uploaded to a crate will be publicly available. For example, if an email address is in the `authors` field in the Cargo.toml file, that email address will also be public.
...
When you visit [docs.rs](http://docs.rs/), we receive your IP address and user-agent header as part of our standard server logs. We store these logs for 1 year.
...
The Users Forum and Internals Forum on [rust-lang.org](http://rust-lang.org/) are hosted by [Discourse](https://www.discourse.org/) and use its open source discussion platform. Discourse’s privacy policy is available [here](https://www.discourse.org/privacy).

We use Mailgun to send email. Mailgun’s privacy policy is available [here](https://www.mailgun.com/privacy-policy).

We use ZenDesk to manage, track, and respond to support requests, including for the [Crates.io](http://crates.io/) mailing list. ZenDesk’s privacy policy is available [here](https://www.zendesk.com/company/agreements-and-terms/privacy-policy/).

GitHub login is used for authentication in [Crates.io](http://crates.io/) and (optionally) in the forums. GitHub’s Privacy Statement can be found [here](https://help.github.com/en/articles/github-privacy-statement).
...
For data subject access requests, or any questions about this privacy notice, please [contact us](https://foundation.rust-lang.org/info/contact/).

![rust foundation logo](/img/rf-logo-transparent.png)

[![X Formely Twitter icon](/img/social/X.png)](https://x.com/rust_foundation) [![LinkedIn icon](/img/social/linkedin.png)](https://www.linkedin.com/company/rust-foundation/)

[Anti-Bribery and Anti-Corruption Policy](https://foundation.rust-lang.org/policies/anti-bribery-and-anti-corruption-policy) | [Anti-Trust Policy](https://foundation.rust-lang.org/policies/anti-trust-policy) | [Bylaws](https://foundation.rust-lang.org/policies/bylaws) | [Cloud Compute Program](https://foundation.rust-lang.org/policies/cloud-compute-program) | [Code of Conduct](https://foundation.rust-lang.org/policies/code-of-conduct) | [Conflict of Interest Policy](https://foundation.rust-lang.org/policies/conflict-of-interest-policy) | [Copyright Policy](https://foundation.rust-lang.org/policies/copyright-policy) | [Intellectual Property Policy](https://foundation.rust-lang.org/policies/intellectual-property-policy) | [Logo Policy and Media Guide](https://foundation.rust-lang.org/policies/logo-policy-and-media-guide) | [Privacy Policy](https://foundation.rust-lang.org/policies/privacy-policy) | [Statement on Global Regulations](https://foundation.rust-lang.org/policies/statement-on-global-regulations) | [Whistleblower Policy](https://foundation.rust-lang.org/policies/whistleblower-policy)