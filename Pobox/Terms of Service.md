...
[Return to overview](https://www.pobox.com/policies/)
...
* Press, marketing and partners
    ...
    * [Brand Guidelines](https://www.pobox.com/policies/brand-guidelines/)
    
* Responsible disclosure
    
    * [Security Issue Reporting](https://www.pobox.com/bug-bounty/)
...
These Terms of Service came into effect on **December 12 2022**. The only changes from our previous terms are the inclusion of our domain names Terms of Service and clarity around your rights under the Australian Consumer Law. You can also find our previous Terms of Service online:

* [May 23, 2022](https://www.pobox.com/policies/terms-of-service/archive/2022-05/)
* [May 25, 2020](https://www.pobox.com/policies/terms-of-service/archive/2020-05/)
* [May 24, 2018](https://www.pobox.com/policies/terms-of-service/archive/2018-05/)
* [October 1, 2017](https://www.pobox.com/policies/terms-of-service/archive/2017-10/)

The following are the terms and conditions for use of the various services provided by Fastmail Pty Ltd, ACN 142 646 580, PO Box 234, Collins St West 8007, Australia (referred to as “Fastmail”), including the Fastmail email service; the Topicbox mailing list service; the Pobox email forwarding, filtering and domains services;and the Fastmail domain names registration service (collectively referred to as the “Service”). Note that use of the Fastmail domain name registration service is additionally subject to the [Fastmail domain Terms of Service](https://www.pobox.com/policies/domains-terms-of-service/).
...
If you have a free account for the Service, you agree to use the Service only to send, receive, upload and publish personal messages and content. Any unauthorised commercial use of the Service, or the resale of the Service, is expressly prohibited.
...
5. Create an identity where we reasonably believe that your use of this identity causes harm or liability to a user, third party, or Fastmail — for example, by hacking, phishing, harassing, spamming, misleading others, or scraping content that doesn’t belong to you.
...
13. Threaten, abuse, or defame our staff in any way. We will not respond to or engage with any people or customers who choose to act in this manner. We reserve the right to suspend the account or refuse service to anyone who threatens, abuses or defames our staff.
14. Run any process or perform any activity that interferes with the proper working of the Services (including by placing an unreasonable load on the Services’ infrastructure).
...
2. any threatening, defamatory, obscene, offensive or illegal content or conduct of any other party or any infringement of another’s rights by another party, including intellectual property rights; or
3. any content sent using and/or included in the Service by any third party.

Unless these Terms of Service are deemed to be a “Small Business Contract” or you are deemed to be a “Consumer” under the Australian Consumer Law, which is Schedule 2 of the Competition and Consumer Act 2010 (Cth), (“ACL”), in no event shall Fastmail be liable for any direct, indirect, punitive, incidental, special, consequential damages or any damages whatsoever including, without limitation, damages for loss of use, data or profits, arising out of or in any way connected with the use or performance of the Service or related web sites, with the delay or inability to use the Service or related web sites, the provision of or failure to provide services, or for any information, software, products, services and related graphics obtained through the Service, or otherwise arising out of the use of the Service, whether based on contract, tort, negligence, strict liability or otherwise, even if Fastmail has been advised of the possibility of damages. Because some states/jurisdictions do not allow the exclusion or limitation of liability for consequential or incidental damages, the above limitation may not apply to you. If you are dissatisfied with any portion of the Service, or with any of these terms of use, your sole and exclusive remedy is to discontinue using the Service and its related web sites.

Fastmail makes no representations about the suitability, reliability, availability, timeliness, and accuracy of the Service for any purpose. The Service is provided “as is” without warranty of any kind. To the maximum extent permitted by the law and in particular to your rights under the ACL (if any), Fastmail hereby disclaims all warranties and conditions with regard to the Service, including all implied warranties and conditions of merchantability, fitness for a particular purpose, title and non-infringement.

If the ACL applies, and in particular if you are deemed to be a “Consumer” under the ACL, our liability for a breach of a condition or warranty is limited to:

1. The resupply of the Services or the cost of resupplying the Services if we determine that there has been a minor fault; or
2. Cancelling the agreement and granting a refund if there is a major fault with the Services.
...
Fastmail shall have no obligation to maintain any content in your account or to forward any unread or unsent messages to you or any third party.
...
Please note that fees in relation to Fastmail’s domain name registration services are generally non-refundable. Please refer to the Fastmail Domain Terms of Service.
...
Fastmail reserves the right to change these Terms or its policies regarding the use of the Service at any time and to notify you by posting an updated version of these Terms on this web site.

If you are deemed to be a “Consumer” or these Terms are deemed to be a “Small Business Contract” under the ACL, and you do not deem the variation acceptable, you may elect not to proceed with the purchase of the Service requested before the date of the variation but which are intended to be subject to the variation.

Subject to your rights under the ACL (if any), as outlined above, you agree that the variation applies from the date of receiving notice of the varied Terms. You will be deemed to have received notice of the varied Terms when we post an updated version of these Terms on this website. You are responsible for regularly reviewing these Terms to check for updates. You will be taken to have accepted the varied Terms if continue to use the Service or you make a further request for us to provide Service to you after the effective date.
...
Unless otherwise specified herein and subject to any additional terms applicable to specific services (e.g. the Fastmail Domain Terms of Service), these Terms constitute the entire agreement between you and Fastmail with respect to the Service (excluding the use of any software which may be subject to an end-user license agreement) and it supersedes all prior or contemporaneous communications and proposals, whether electronic, oral or written, between you and Fastmail with respect to the Service.
...
Fastmail shall be released from its obligations (and shall not be in default of this Contract or otherwise liable or responsible for any delay, breach of this Contract or failure in its performance under this Contract) in the event of an act of God, strike, lockout or other industrial disturbance or labour difficulty, national emergency, war, act of public enemy, blockade, revolution, riot, insurrection, civil commotion, pandemic, lightning, storm, flood, fire, earthquake, explosion, embargo, unavailability of any essential equipment or materials, failure of the Internet, computer hacking, unavoidable accident, lack of transportation, prohibitive governmental regulation or if any other cause beyond the reasonable control of the parties renders provision of the Services impractical, where all money due to Fastmail shall be paid immediately and, unless prohibited by law, Fastmail may elect to terminate this agreement.
...
2. at Fastmail’s request, you must assist Fastmail in enforcing these Terms against your customers;
3. in the event of a dispute between you and a customer of yours, Fastmail may in its discretion at a customer’s request, detach the customer from your resale service.
...
2. Fastmail is not responsible and accepts no liability for the actions or omissions of the reseller; and
3. the reseller has the ability to create/modify/delete and access your accounts on your behalf.

**COPYRIGHT AND TRADEMARK NOTICES**
-----------------------------------

All source code, executable code, page designs and other copyrightable material are Copyright © 1999-2022 Fastmail Pty Ltd or used under license from the copyright owner.
