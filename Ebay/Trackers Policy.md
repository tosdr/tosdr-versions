...
|     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- |
| [![eBay Home](https://ir.ebaystatic.com/rs/v/fxxj3ttftm5ltcqnto1o4baovyl.png)](https://www.ebay.com/) |     |     |     |     | {"delay":300} |     |
...
If you are having difficulties with rendering of images on the above verification page, eBay suggests using the latest version of your browser, or an alternate browser listed on the [customer service page](http://pages.ebay.com/help/policies/technical-issues/technical-issues?id=4220&st=3&pos=1&query=Technical%20issues&intent=supported%20browsers&lucenceai=lucenceai).
