[Skip to Content Area](#main-content)
...
* [All About Birds](http://allaboutbirds.org/)
    * [Bird Guide](https://allaboutbirds.org/guide)
    * [Birds of the World](https://birdsoftheworld.org/?utm_source=clo-website-menu&utm_medium=web-menu&utm_campaign=CLO-REFERRAL&utm_id=cloreferral)
...
THESE TERMS AND CONDITIONS OF SERVICE (the “Terms”) ARE A LEGAL AND BINDING AGREEMENT BETWEEN YOU AND CORNELL LAB OF ORNITHOLOGY governing your use of this site \*.birds.cornell.edu and any of its affiliate sites and mobile apps such as: www.allaboutbirds.org, ebird.org, Merlin Bird ID app (the “Services”). Examples of Services from the Cornell Lab of Ornithology: birds.cornell.edu, allaboutbirds.org, eBird.org, Bird Academy, Merlin mobile and web apps, NestWatch.org, FeederWatch.org, and all Cornell Lab of Ornithology websites, apps, digital services, and social media pages (Facebook, Instagram, Twitter, etc).

Please review the Terms fully before you continue to use the Services. By using the Services, you agree to be bound by the Terms. You shall also be subject to any additional terms posted with respect to individual sections of the Services. Please review our [Privacy Policy](https://privacy.cornell.edu/), which also governs your use of the Services, to understand our practices. If you do not agree, please discontinue using the Services. If you’re under the age of 13, do not use or access our Services. Where necessary under applicable law, we may seek your consent by other means such as by asking you to click on a button or to change a setting. Where we do so, we will also offer you a way to revoke your consent.

Cornell Lab of Ornithology reserves the right to change the Terms at any time without prior notice. Your continued access or use of the Services after such changes indicates your acceptance of the Terms as modified. It is your responsibility to review the Terms regularly.
...
The terms of use for **eBird APIs** can be found here:

[https://www.birds.cornell.edu/home/ebird-api-terms-of-use/](https://www.birds.cornell.edu/home/ebird-api-terms-of-use/)

The terms of use for **raw eBird data** can be found here:
...
The terms of use for use for accessing eBird Status and Trends Products (eBird Status Visualizations, eBird Status Data Products, and Modified eBird Status Data Products) can be found here:

[https://ebird.org/science/status-and-trends/products-access-terms-of-use](https://ebird.org/science/status-and-trends/products-access-terms-of-use)
...
Our citizen-science projects are designed to benefit the entire scientific research community, which in turn benefits the larger public. Therefore, if you participate in any Cornell Lab citizen-science projects, you grant the Cornell Lab and its collaborators permission to use your contributions in any way to further this goal. We ask you to grant us these broad permissions because they allow us to change the legal details by which we keep the data available; this is important because the legal environment can change and we need to be able to respond without obtaining permission from every single contributor.  
...
When you submit records to eBird, you authorize us to have our team of regional editors contact you about questions they may have about your observations. This helps us maintain a high level of data quality so we can use these data for scientific and conservation purposes. This is limited to official volunteers who help with data quality. [Find out more about this process](https://support.ebird.org/en/support/solutions/articles/48000795278-the-ebird-review-process).
...
All participants are expected to always treat each other with mutual respect. Conduct by any user that, at the discretion of Cornell Lab of Ornithology, restricts or inhibits any other user from using or enjoying the Services will not be permitted. The Cornell Lab of Ornithology reserves the right to delete comments or terminate accounts associated with inappropriate or offensive behaviors.

Examples of prohibited conduct include:

1. Adding offensive, threatening, abusive, or profane comments, images, sound recordings or videos to any of our sites or data you contribute to any project.
2. Abusive or threatening language or behaviors in the course of correspondence or interactions with a reviewer or other member of the community.
3. Falsified documentation to support a record or fabricated sightings.

Cornell Lab of Ornithology reserves the right to refuse access to the Services to any user for any reason, including, without limitation, a reasonable belief that the user in question has violated these Terms or any of the copyright or trademark laws of the United States.
...
* [Quick Links](https://www.birds.cornell.edu/home/get-involved/)
    ...
    * [Frequently Asked Questions](https://www.allaboutbirds.org/news/browse/topic/faqs#)
    ...
    * [Find Your Project](https://www.birds.cornell.edu/home/get-involved/)
    * [See Your Impact](https://www.birds.cornell.edu/home/impact/)
    * [Visit Us](https://www.birds.cornell.edu/home/visit/)
...
* [News Room](https://www.birds.cornell.edu/home/news/)
* [Land Acknowledgment](https://www.birds.cornell.edu/home/our-commitment-to-diversity-equity-inclusion-and-justice/)
...
[Donate](https://give.birds.cornell.edu/page/87895/donate/1?ea.tracking.id=WEB&utm_source=BCE&utm_medium=Website&utm_campaign=Evergreen-Appeal)

Follow Us
---------

* [](https://twitter.com/cornellbirds "Follow us on Twitter")
* [](https://www.facebook.com/cornellbirds "Like us on Facebook")
...
[Members](https://www.birds.cornell.edu/home/members/)  
[Students](https://birds.cornell.edu/home/students/)