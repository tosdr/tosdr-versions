...
1.1.1. our website [https://patientaccess.com](https://patientaccess.com/) (the “**Website**”), whether as a guest or a registered user; and/or
...
1.6.1. our Privacy Policy ([https://support.patientaccess.com/privacy-policy](https://support.patientaccess.com/privacy-policy)), as may be updated from time to time, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Service, you consent to such processing and you must ensure that all data provided by you is accurate; an

1.6.2. our Cookie Policy ([https://support.patientaccess.com/cookie-policy](https://support.patientaccess.com/cookie-policy)), as may be updated from time to time, which sets out information about the cookies we use on our Website.

1.6.3. our Additional terms of use [https://support.patientaccess.com/booking-terms-of-use](https://support.patientaccess.com/booking-terms-of-use) at the time of booking the service and Cancellation policy [https://support.patientaccess.com/cancellation-policy](https://support.patientaccess.com/cancellation-policy) for any Booking Services that are available independently of your GP practice.
...
* A ‘Medication Assistant service that allows you to receive information and notifications to help you better manage your medication and set your own reminders to help you to take your medication in accordance with your prescription (‘**Medication Reminders**’).
...
* A ‘Clinical Research Studies’ service that allows you to receive information and notifications about clinical trials that you may be eligible to participate in and, if you’re interested in participating, share your details with the relevant party conducting the trial. You must have remote access your medical records (as mentioned above) in order to use this part of the Service.  
    ...
    Furthermore, where you have signed up for the Medication Assistant service we will be able to provide information and notifications related to existing medications that we know of from your electronic medical record and/or that you input into the Medication Reminders service when setting up your reminder(s) (if any).

3.3. In addition to the services detailed in section 2, for accounts linked to your GP practice you also have the option to activate the Smart Pharmacy service. The Smart Pharmacy service allows you to nominate one of any of ‘Smart Pharmacies’ (being pharmacies that are set up to deliver this additional functionality) in your vicinity via Patient Access. If no pharmacies have registered as ‘Smart Pharmacies’ in your area then this feature will not be available unless or until this happens. Once you have nominated a Smart Pharmacy we will copy your NHS number into your account (to act as a unique identifier) and share it with your nominated pharmacy. We will then be able to provide you with notifications regarding your prescriptions (as may be provided to us by the relevant pharmacy), including details as to when it is ready for collection (or is out for delivery as appropriate).  
  
For the avoidance of doubt, the messages we send contain information provided by your nominated Smart Pharmacy (or your GP practice as appropriate). We are not able to validate whether or not this information correct (for example, if in fact your prescription is ready for collection) and it is provided on an ‘as is’ basis. You should address any issues with regard to the accuracy of such messages to your nominated pharmacy.  
...
5.5. We have the right to disable any user identification code or password, whether chosen by you or allocated by us, at any time, if in our reasonable opinion you have failed to comply with any of the provisions of these Terms of Use.

5.6. If you know or suspect that anyone other than you knows your user identification code or password, you must promptly reset your password to something which only you know. Please visit [https://patientaccess.com/forgot/password](https://patientaccess.com/forgot/password) to reset it.
...
5.9. If you are under 16 years of age and your Patient Access account is not being linked to your GP practice with your GP’s authorisation, your parent or legal guardian must supervise the registration and use of your Patient Access account at all times for any features made available to you as part of this service. We will ask you to enter your date of birth and agree to these Terms of Use that include notice of this age restriction.

5.10. You may only access the Booking Services that are made available independently of your GP practice if you are at least 18 years of age. If you are under 18 years of age and would like to access these Booking Services, please ask your parent or legal guardian to complete the relevant Booking for you and confirm that they agree to the Patient Access Additional terms of use [https://support.patientaccess.com/booking-terms-of-use](https://support.patientaccess.com/booking-terms-of-use) at the time of booking the service.
...
6.1. When activated by you, the Clinical Research Studies Service will search your medical record (in accordance with our Privacy Policy: [https://support.patientaccess.com/privacy-policy](https://support.patientaccess.com/privacy-policy)) to identify if you meet the inclusion/exclusion criteria for certain clinical trials and to check the feasibility of clinical trials more generally that may be made available in the Clinical Research Studies Service in the future.
...
6.4. The Medication Assistant Service is available to users who: (i) have linked their account to their GP practice; and (ii) have access to their medical record. The Service provides you with information that may assist you in the management of your health condition(s) and/or use of relevant medication based on the information recorded in your medical record.

6.5. The resources provided are for information purposes only and should not be used for the diagnosis or treatment of medical conditions or in place of the advice of a qualified healthcare professional e.g., your GP. EMIS will use reasonable care in seeking to ensure that the information provided is relevant to you based upon the information you provide to EMIS through the Service but makes no warranty as to its accuracy or relevance to you. You must consult a doctor or other health care professional for diagnosis and treatment (including medication) in respect of any medical conditions.

6.6. You agree and acknowledge that there may be a delay in the information updating in your medical record and that this may result in you receiving information regarding a medication that you were taking but have since ceased to take / be prescribed. If you have any doubts then please contact your GP.

6.7. Where you have chosen to activate and use the Medication Reminders Service, you agree and acknowledge that:

6.7.1. the purpose of the Service is to assist you with taking your medication in line with the relevant instructions from the healthcare professional(s) involved in the prescribing and dispensation of your medication, it is not a replacement for those instructions;

6.7.2. it is your responsibility to set up each reminder ensuring that a) the medication(s) listed in Medication Reminders, taken from your medical record, are accurate and still relevant; and b) the reminders you set up are in the correct quantities and timings as per the instructions on your prescription or as otherwise advised by a qualified healthcare professional entrusted with your care;

6.7.3. you are responsible for keeping your medication reminders up to date including making appropriate changes if there are any changes to your medication or how you are advised to take your medication; and

6.7.4. EMIS has no control over the information (including medication you are taking and the times / frequency that you set to take such medication) contained within your medical record, including whether it is accurate or up to date and shall have no liability to you or any other party whatsoever in relation to any errors in this information. You should always take your medication in accordance with the instructions provided to you by the relevant healthcare professionals (including those on your prescription, unless advised otherwise by a qualified healthcare professional entrusted with your care).

6.8. Once set up within the Medication Reminders module, push notifications will be sent to your device(s) at the time(s) and date(s) that you have set. The notifications will be sent to the most recent device used to sign into your account (i.e. if you sign in on a tablet, the notifications will go to your tablet rather than your mobile device. If you want notifications to be sent to a particular device you should ensure that you only use Medication Reminders on that device). Please take this into account if you have any shared devices.

6.9. You must ensure that you are signed into your own Patient Access account and not any linked (proxy) accounts i.e. of your dependants etc. If you try to use Medication Reminders within a proxy account, the notifications may not register or work in your account and/or the proxy account.
...
9.2. Our rights in the Service (including, the Website and App) are licensed (not sold) to you and you have no rights to the same other than to use the Service under and in accordance with these Terms of Use.
...
10.2. Subject to section 1, we will not be liable or responsible for:
...
12.1. You are free to stop using the Service at any time. If you breach any of these Terms of Use we can stop providing all or part of the Service to you. If we terminate (or suspend) your access to the Service then we will notify you by email or at the next time you attempt to access your account. Where you have linked your account to your GP practice, our ability to provide those GP practice enabled Services to you is dependent upon your GP Practice continuing to keep active the relevant functionality within their clinical system. However, your GP Practice may choose (for whatever reason) to deactivate functionality at any time. In all such cases, the contract between us under these Terms of Use shall terminate and:

12.1.1. all rights granted to you shall cease;

12.1.2. you must immediately cease all activities authorised by these Terms of Use, including your use of the Service;
...
12.1.4. any provision of these Terms of Use that expressly or by implication is intended to come into or continue in force on or after termination of your right to use the Service shall remain in full force and effect, including: sections 7 (Prohibited Uses), 9 (Intellectual Property Rights),10 (Limitations of Liability), 15 (Choice of Law and Jurisdiction) and 16 (General).
...
14.3. You are responsible for choosing to share your medical record and you must do so with all due care. Please note that while you can revoke access via the share your record service at any time, while the link is live there is nothing to prevent any third party with whom you have shared the link from itself making that link available to other persons, and if they have the passcode from copying the data contained in the record or taking screenshots of the information. Given the nature of the information in your medical record it is your responsibility to only provide the link to trusted recipients that may need access to certain details so as to be better able to provide you with care (for example, if you were abroad then you may wish to give access to a local pharmacist to enable them to check whether you have certain allergies recorded in your medical record). By sharing your medical record, you acknowledge that this is done at your own risk.
...
To contact us, please use the contact/feedback form accessible via this link [https://support.patientaccess.com](https://support.patientaccess.com/).
...
Cancel [Contact technical support](https://support.patientaccess.com/contact-support-form?returnUrl=https%3A%2F%2Fsupport.patientaccess.com%2Fterms-of-use)