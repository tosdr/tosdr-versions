...
This privacy policy provides you with information on the type, scope and purpose of the collection and use of your personal data.
...
Responsible according to Art 4 para 7 GDPR and other national data protection laws of the member states of the European Union and other data protection regulations is
...
**E-Mail: [info@geizhals.at](mailto:info@geizhals.at)  
**

**Competent supervisory authority of the data controller:**
...
3\. Data collected during use of our website
--------------------------------------------
...
You can find more information on privacy at Inxmail at: [https://www.inxmail.de/datenschutz](https://www.inxmail.de/datenschutz)
...
6\. Registration for forum/product reviews/merchant reviews
-----------------------------------------------------------
...
For more information on Facebook Connect and privacy settings, please refer to the [privacy policy](https://www.facebook.com/about/privacy/update) and [terms of service](https://www.facebook.com/legal/terms/update) of Facebook Inc.

#### Google login

We also give you the option to sign up for our service using Google Login. To sign up, you will be forwarded to the Google website, where you can log in with your user data. This will link your Google account and our service. When this link is created, we automatically receive your name and your email address from Google Ireland Limited. This information is essential for the use of our services, in order to enable identification.

For more information on Google Login and privacy settings, please refer to the [privacy policy and terms of service](https://policies.google.com/) of Google Ireland Limited. 

7\. Use of cookies
------------------

Our web pages use cookies at various locations. The cookies are used to make our offer more user-friendly and to improve efficiency. Cookies are small text files that are stored on your computer and saved by your browser. The cookies do not contain any personal data. This data is not merged with other data sources. We use „session cookies“, which are deleted when you end your browser session. In addition, there are some persistent cookies, which we use to recognise you as a visitor. Cookies do not harm your computer and do not contain viruses.

If you do not allow us to use cookies in general, certain features and pages will not work as expected.
...
| Name | Purpose | Expiry |
| --- | --- | --- |
| GHS | Session cookie for documenting marketing campaigns | Session |

### Long-term cookies

| Name | Purpose | Expiry |
| --- | --- | --- |
| ForumLogin | Login cookie to detect new or regular customers | 10 years |
| GeizhalsConfcookie | Configuration cookie to store settings related to the operation of the web application (e.g. pre-selection of the countries of origin for merchant offers or pre-selection of sort criteria for merchant offers) | 10 years |
| blaettern | Configuration cookie to store the displayed number of merchant offers on product pages | 10 years |
| GeizhalsDevice | Configuration cookie to store the overriding of the user agent switch between mobile and web | 7 days |
| csrf | Protects against cross-site request forgery (CSRF) attacks | 15 minutes |
| ghhsba | Configuration cookie to store the deactivation of sticky bottom ads | 1 hour |
| ghds | Configuration cookie to store the deactivation of site branding | 2 hours |
...
**[Google Chrome](https://support.google.com/chrome/answer/95647?hl%3Dde%26hlrm%3Den)**
...
**[Firefox (Blocking third-party cookies)](https://support.mozilla.org/de/kb/Cookies-von-Drittanbietern-blockieren)**

8\. Do Not Track
----------------

If your browser includes the „Do Not Track“ header, only strictly necessary cookies are set.  
External services, advertising, etc. are not integrated in this case.
...
You can also disable the setting of cookies via your browser settings or download a corresponding [browser plug-in](http://tools.google.com/dlpage/gaoptout).

You can find more information on the use of user data by Google Analytics in [Google’s privacy policy](https://support.google.com/analytics/answer/6004245?hl=en)

The following cookies are set:

| Name | Purpose | Expiry |
| --- | --- | --- |
| \_ga | Contains a randomly generated User ID. This ID enables Google Analytics to recognise returning users on this website and to merge data from previous visits. | 2 years |
| \_gat | Certain data are only sent to Google Analytics at a maximum of once per minute. The cookie has a lifetime of one minute. As long as it is set, certain data transfers are blocked. | 1 minute |
| \_gid | Contains a randomly generated User ID. This ID enables Google Analytics to recognise returning users on this website and to merge data from previous visits. | 1 day |
...
This method of measuring reach was developed taking privacy into account. The aim of the reach measurement process is to statistically calculate usage intensity and the number of users of a website. Individual users are never identified. Your identity always remains protected. You will not receive advertising via the system. For websites that are members of the Informationsgemeinschaft zur Feststellung der Verbreitung von Werbeträgern e.V. (IVW – [http://www.ivw.eu](http://www.ivw.eu/)) or take part in the „internet facts“ study of the Arbeitsgemeinschaft Online-Forschung e.V. (AGOF – [http://www.agof.de](http://www.agof.de/)), usage statistics are published monthly by the AGOF and the Arbeitsgemeinschaft Media-Analyse e.V. (ag.ma – [http://www.agma-mmc.de](http://www.agma-mmc.de/)), as well as the IVW, and can be viewed at [http://www.agof.de](http://www.agof.de/) , [http://www.agma-mmc.de](http://www.agma-mmc.de/) and [http://www.ivw.eu](http://www.ivw.eu/).
...
Further information on the SCMS can be found on the website of INFOnline GmbH ( [https://www.infonline.de](https://www.infonline.de/) ), which operates the SCMS, the data protection website of AGOF ( [http://www.agof.de/datenschutz](http://www.agof.de/datenschutz) ) and the data protection website of IVW ( [http://www.ivw.eu](http://www.ivw.eu/) ).

You can object to data processing by SCMS at the following links:

[http://optout.ioam.de](http://optout.ioam.de/)

### 9.3 Use of Google DFP
...
To do this, you will need to follow these instructions to deactivate cookies from Google: [http://www.google.com/settings/ads/plugin?hl=en-GB](http://www.google.com/settings/ads/plugin?hl=en-GB) or [https://adssettings.google.com/](https://adssettings.google.com/)
...
Click on the following links to deactivate personalised advertising on the respective website:

[Auf**geizhals.at**deaktivieren](https://geizhals.at/?disable_personalized_ads=1) [Auf**geizhals.de**deaktivieren](https://geizhals.de/?disable_personalized_ads=1)

The following cookies are set:

| Name | Purpose | Expiry |
| --- | --- | --- |
| \_\_gads | Cookie for measuring interactions with ads and preventing the same ads from being shown to you too many times. | 2 years |
| GoogleAdServingTest | Cookie for measuring interactions with ads and preventing the same ads from being shown to you too many times. | Session |
| IDE | Cookie to measure the efficiency of an ad and deliver targeted ads to the user | Session |
| test\_cookie | Cookie to check whether the browser allows cookies to be set. Contains no identification data. | Session |

#### 9.4 GetBack (adfocus) – push notifications

For Web Push notifications we use the service Getback from adfocus GmbH, Theilerstrasse 7, 6300 Zug in Switzerland. This service helps to improve targeted communication with our customers. This technology enables us to send our visitors „Web Push Notifications“, for example, notifications about new products, competitions, discounts/vouchers, news or shopping tips.

The following cookies are set:

| Name | Purpose | Expiry |
| --- | --- | --- |
| gb\_push\_permission | Status on the browser-side acceptance of Web Push notifications on Geizhals | 1 month |
| gb\_is\_push\_subscriber | Status of the notification subscription | 1 year |
| gb\_intseg | Saving the selected interests | 15 years |
| gb\_has\_push\_support | Support of Web Push notifications of the current browser | 1 year |
| \_gb\_l | current language | Session |
| \_gb\_lang | current language | Session |
| \_gb\_lh | last host used in the session. To detect a subdomain change. | Session |
| \_gb\_reparse | variable for re-reading the website in case of a change | Session |
| \_gb\_ver | Version number of the customer configuration | 1 month |
| \_gb\_views | Pageview counter of the session | Session |
| \_gbc | Users‘ Client-Key | 2 years |
| \_gbs | Users‘ Session-Key | Session |

You can object to the data processing by GetBack (adfocus) by clicking on the following link

**Opt-out:** [https://geizhals.at/?pushnotifications\_landing=1](https://geizhals.at/?pushnotifications_landing=1)

Further information can be found in the privacy policy of [GetBack](https://www.getback.app/about/privacy/)

As a sub-processor, Amazon Web Services, Inc., P.O. Box 81226, Seattle, WA 98108, USA provides the following IT services:
...
### 10.1 Usage-based online advertising
...
[http://www.youronlinechoices.com/uk/about-behavioural-advertising](http://www.youronlinechoices.com/uk/about-behavioural-advertising)
...
As our partner, MediaMarktSaturn uses the „Salesforce DMP“ technology of Salesforce.com Germany GmbH, Erika-Mann-Str. 31, 80636 Munich, Germany on this website. Data is collected by setting cookies (krxd.net), i.e. text files that are stored on your computer. These data reflect the user’s interaction with the website in order to be able to assess which advertisements may be of most interest to you.

You can prevent this recording by Salesforce by clicking on the following link:

Opt-out: [https://www.salesforce.com/products/marketing-cloud/sfmc/salesforce-dmp-consumer-choice/?mc=DMP](https://www.salesforce.com/products/marketing-cloud/sfmc/salesforce-dmp-consumer-choice/?mc=DMP)

Please note that this setting must be made for each browser you use. If all cookies in your browser are deleted, this also affects the opt-out cookie.

### 10.2 Tag-in-tag advertising
...
Privacy: [http://www.mindshareworld.com/about/privacy-policy](http://www.mindshareworld.com/about/privacy-policy)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### Wavemaker GmbH:

Privacy: [https://www.wavemakerglobal.com/privacy/](https://www.wavemakerglobal.com/privacy/)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### Mediacom:

Privacy: [https://www.mediacom.com/uk/privacy-policy](https://www.mediacom.com/uk/privacy-policy)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### GroupM:

Privacy: [https://www.groupm.com/eu-privacy-policy](https://www.groupm.com/eu-privacy-policy)

Opt-out: [https://www.groupm.com/eu-privacy-policy](https://www.groupm.com/eu-privacy-policy)

#### IPG Mediabrands:

Privacy: [https://www.ipgmediabrands.com/privacy-policy/](https://www.ipgmediabrands.com/privacy-policy/)

Cookies notice: [https://dach.ipgmediabrands.com/hinweis-zu-cookies/](https://dach.ipgmediabrands.com/hinweis-zu-cookies/)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### Performics:

Privacy: [https://www.performics.com/performics-privacy-policy/](https://www.performics.com/performics-privacy-policy/)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### SDO/Styria Digital One:

Privacy: [https://sdo.at/datenschutzregelungen/](https://sdo.at/datenschutzregelungen/)

Cookie policy: [https://sdo.at/en/cookie-policy](https://sdo.at/en/cookie-policy)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### OMD:

Privacy: [http://www.omd.com/privacy-policy](http://www.omd.com/privacy-policy)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### MEDIAPLUS:

Privacy: [https://www.mediaplus.at/de/footer/privacy-policy-online-advertising.html](https://www.mediaplus.at/de/footer/privacy-policy-online-advertising.html)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

#### HAVAS:

Privacy: [https://de.havas.com/home/datenschutz/](https://de.havas.com/home/datenschutz/)

Opt-out: Refer to [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser)

### 10.3 [Programmatic advertising](https://en.wikipedia.org/wiki/Programmatic_advertising)
...
Yieldlab uses cookies to adapt and optimise the display of advertising placed by Yieldlab’s customers for the user. For example, this affects the maximum frequency with which advertising is displayed to a user. In some cases, Yieldlab also uses stored cookie information for statistical analyses.
...
Further information can be found at [http://www.yieldlab.com/meta-navigation/data-privacy-statement/](http://www.yieldlab.com/meta-navigation/data-privacy-statement/)

Opt-out: [http://www.yieldlab.com/elements/privacy/](http://www.yieldlab.com/elements/privacy/)
...
You can prevent the storage of cookies on your hard drive and the display of web beacons. To do this, you need to select „do not accept cookies“ in your [browser settings](https://unternehmen.geizhals.at/about/en/info/privacy-policy/#browser).

You can find further information at: [https://www.google.com/policies/technologies/ads/c](https://www.google.com/policies/technologies/ads/c)

11\. Legal bases of data processing
-----------------------------------
...
### Derogations for specific situations Article 49 (1) (a) GDPR:

This clause allows data transfers to third countries without an adequate level of protection (e.g. USA) with the explicit consent of the data subjects, whereby this consent must meet the general requirements of Art 7 GDPR  (voluntary, informed and revocable at any time).
