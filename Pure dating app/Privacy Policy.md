...
* 8[Safety and Transparency when sharing User’s Personal Data with Third Parties](#safety-and-transparency-when-sharing-data)
...
If you are a resident of California, please see and review our [Privacy Policy for California Residents](https://pure.app/content/en/legal/privacy-policy-for-california), which supplements this Privacy Policy accordingly. Additionally, our [Notice at Collection](https://pure.app/content/en/legal/notice-at-collection) for California residents supplements the information contained in this Privacy Policy and applies solely to all visitors, users, and others who reside in California. 
...
* Technical Data: IP address, operating system, date and time of access, country from which PURE is accessed (based on IP address), browser type, referrer URL, log-in data, and device type;
...
* Email address (see Article 8 of this Privacy Policy);
* Identity data, details about your ad (personal description, age, height, spoken languages);
* Sexual and other preferences (turn-ons).

##### **c. When using PURE** 

When you use PURE, you voluntarily provide us with certain information. When you add information to your user profile, interact with us or other users, you make the choice to share your certain personal information with us. In this way, we can process the following categories of your Personal Data, some of which are optional, while others are mandatory to enable you to use PURE to its fullest potential and enhance your overall experience:
...
* User’s content and material which has been submitted by Users as “Personal ads and Profile”, including pictures, as well as content and material which has been submitted in the chat conversations, including videos, audio, pictures, and text messages sent when communicating with others (collectively, “**User Submissions**”) are processed in order to secure and operate services and keep our user community safe. To ensure user safety and prevention and detection of scams, fraudulent activities, and violations of laws and regulations, principles, guidelines and other PURE policies, we use a combination of manual moderation and automated systems to monitor and review pictures and texts from chat conversations and Personal ads. This approach is in strict compliance with data protection regulations and is undertaken to meet the legal requirements imposed by specific countries concerning the transmission of explicit content. For this purpose, pictures and texts from chat conversations will be anonymized and stripped of personal information to protect your privacy, thereby ensuring data protection against unauthorized access or disclosure. We will not attempt to re-identify this anonymized data. For more details about this, please see our Terms and Conditions ([here](https://pure.app/content/en/terms));
...
* Access to your device's camera and usage of Augmented Reality (“**AR**”) features within PURE that are provided by Snap Inc. and allow an interactive experience that combines the real world and computer-generated 3D content. This access allows the integration of innovative experiences that enhance users' overall engagement, encounter with AR and the option to unlock their full potential for creations.  
...
* If you submit report on illegal content under Digital Services Act (DSA) via email, we collect the information that you give us in the form,
...
* Biometric data, if you wish to confirm that the submitted pictures reflect your real appearance captured through the camera by using our facial recognition technology. The submitted pictures will be analyzed and compared to your face using facial recognition technology to confirm the match. The Photo Verified badge, if awarded, is for informational purposes only and may be automatically removed if you change or remove the submitted picture, or if the face does not match during a subsequent check. The biometric data obtained in the Photo Verification process, even if the process was not successful, will be retained in our systems in accordance with Section 11 below for as long as necessary to fulfill the purposes described in this subsection. You can remove your Photo Verified badge by deleting your account. Upon account deletion, any biometric data collected during the verification process will also be permanently deleted. If you choose to cancel the Photo Verification process at any point before its completion, no biometric data related to this process will be retained. For more details about the Photo Verified feature, please see our Terms and Conditions ([here](https://pure.app/content/en/terms)).

We receive most of your Personal Data directly from you. To the extent permitted by applicable law, we can also obtain your Personal Data from publicly available sources or from public authorities and other third parties (e.g., service partners, internet analysis services). Personal data we share with third parties is regulated by Article 8 of this Privacy Policy.
...
* Fraud prevention: Mandatory and optional data collected in the process of creating your PURE account (see Article 2), transactional data, texts and pictures in chat conversations that are anonymized and stripped of personal information (see Article 2), pictures or videos that you upload, publish or provide in any other way (see Article 2), information about the images (e.g. metadata), such as the location of a photo and device information (see Article 2), and others, are used to detect, analyze and prevent fraudulent activities and scams on PURE. We rely on a combination of automated systems and manual reviews to achieve this (see Terms and Conditions ([here](https://pure.app/content/en/terms)) and Article 2).
* Market and opinion research, analytics: We use usage data, activity data, insights, responses, testimonials, interactions, and others to monitor and analyze your use of PURE. We may also use this data, along with other personal data you provide, such as age, height, gender, and others, for internal research and analytics, further developing the offers on PURE, administering focus groups, determining user demographics, conducting market studies and surveys, and analyzing user behavior to enhance the overall experience on PURE.
...
* Compliance with laws and regulatory recommendations and directives: Know your customer (KYC) clarifications, fulfillment of disclosure, information and reporting obligations, fulfillment of archiving obligations, responding to law enforcement requests, and the prevention, detection, and clarification of criminal acts;
...
* Legitimate interests: It is necessary to process your Personal Data to pursue our legitimate business interests, provided that your rights and freedoms do not override these legitimate interests, which include but are not limited to ensuring platform security and integrity, operational efficiency, functionality, business development, user safety and overall compliance.
...
* Your consent: If you choose to provide us with Personal Data that may be considered sensitive in certain jurisdictions, you are giving us consent to process that Personal Data in accordance with this Privacy Policy. We will explicitly ask for your consent to collect specific Personal Data such as your precise geolocation, to transfer your Personal Data to countries without an adequate level of data protection (for more information please see Article 7 of this Privacy Policy), or to use your Personal Data for certain specific reasons (e.g. direct marketing). You may withdraw your consent at any given time by contacting us as stated in this Privacy Policy (see Article 14). You can exercise this right at any time and doing so won't affect the legality of processing your data that occurred before the withdrawal, as long as you were informed before giving your consent.

#### 5\. Online tracking and analysis

##### **a. Cookies**

We use and may allow others to use cookies and similar technologies on PURE to recognize you and/or your device(s). You may read our Cookies Policy (see [here](https://pure.app/content/en/legal/cookies)) for more information on why we use them and how you can have better control over their use.
...
#### 8\. Safety and Transparency when sharing User’s Personal Data with Third Parties
...
* Government agencies and legal representatives: We may disclose your Personal Data to governmental agencies, courts, and other authorities, both domestic and foreign, legal representatives, if we are legally obligated or entitled to do so or if we deem it necessary to do so in order to protect our interests. This includes situations where disclosure would protect  PURE’s, Users', business partners', or other relevant parties' legal rights, mitigate our liability in an actual or threatened lawsuit, enable us to enforce our agreements with you and accurately address, prevent, or respond to illegal activity, suspected fraud, or other misconduct.

This disclosure aligns with our commitment to transparency, in accordance with relevant data protection laws and regulations. Please refer to the Article 8 of this Privacy Policy for detailed information on data sharing and protection practices.
...
A limited number of PURE’s personnel may manually access, review, and utilize Users' inputs to refine and enhance the Goddess, as deemed necessary for its development process, or to comply with legal obligations. The extent of this depends on the development and implementation phase of the Goddess, therefore it may not occur consistently. It's important to note that our competent personnel’s access is limited to information essential for improving the Goddess’ performance. This strict control ensures Users' privacy and confidentiality as no identifiable personal data, which Users may have provided in the process of registration or usage of PURE, is or will be employed in training the Goddess.

The Goddess does not have access to Users' personal data which was provided according to Article 2 of this Privacy Policy and it won’t request it. Users should refrain from disclosing any sensitive personal data, confidential or proprietary information. Note that the Goddess is designed to not request Users' above-mentioned or other sensitive personal information and Users are strongly advised against sharing any of such information with the Goddess, even if requested by the Goddess to do so.

##### b. Third party providers

We collaborate and share certain content with third-party service providers specialized in AI model development and infrastructure that enable us to deliver a seamless experience of the Goddess to Users. These service providers are subject to data privacy, security and confidentiality obligations, and their own data policies. It is important to understand that we share only essential and minimal data necessary for the performance of the Goddess. This ensures that no identifiable or any kind of personal information from Users is disclosed or shared in this process. Rest assured, we require that these third parties take reasonable measures for anonymization of received data and refrain from attempting or re-identifying it, thereby ensuring compliance with applicable laws and regulations.
...
* Lodge a complaint with a supervisory authority: You have the right to lodge a complaint with a competent supervisory authority regarding the processing of your Personal Data.   
    You can file a complaint in the EU member state of your habitual residence, your place of work, or where you consider that the processing of your Personal Data is not in compliance with the GDPR. If you need additional information about the appropriate supervisory authority for filing complaints, please contact us.
* Withdrawal: You have the right to withdraw your consent to the processing of your Personal Data at any time, free of charge, and without giving any reason by contacting us at the address provided in this Privacy Policy. Processing activities conducted with your consent in the past, prior to you withdrawing consent, do not become unlawful as a result of your withdrawal. 
...
[15 October 2024](https://pure.app/content/ru/privacy?effective_date=2024-10-15)[30 June 2024](https://pure.app/content/ru/privacy?effective_date=2024-06-30)[19 March 2024](https://pure.app/content/ru/privacy?effective_date=2024-03-19)[01 March 2024](https://pure.app/content/ru/privacy?effective_date=2024-03-01)[13 November 2023](https://pure.app/content/ru/privacy?effective_date=2023-11-13)[15 April 2023](https://pure.app/content/ru/privacy?effective_date=2023-04-15)
