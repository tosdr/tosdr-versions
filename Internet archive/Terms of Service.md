...
We understand that not everyone can donate right now, but if you can afford to contribute this Saturday, we promise it will be put to good use. Our resources are crucial for knowledge lovers everywhere—so if you find all these bits and bytes useful, **please pitch in.**
...
![](//athena.archive.org/0.gif?kind=track_js&track_js_case=control&cache_bust=1234860733)

![](//athena.archive.org/0.gif?kind=track_js&track_js_case=disabled&cache_bust=1509929875)