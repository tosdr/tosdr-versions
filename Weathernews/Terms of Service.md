...
株式会社ウェザーニューズ（以下「ウェザーニューズ」という）がウェブサイト上で提供する気象コンテンツは、気象学的解析に基づくものです。この気象学的解析に基づく気象予測情報には、解析的手法に内在する限界（不的中のリスク）が存在いたします。かかる解析の基礎とならない急激な気象要因の変化等の不可知の要因を原因として、予報と実際の気象状況との間に差異が生じることがあります。また地形等の局地的な要因による小規模で特異な気象状況につきましては、予報との差異が現れることがあります。自然における地象・気象・水象の急激な変化は、予測し得ない不可知の要素と、人の想像を越える要因によって不測の事態を生じせしめる可能性を常に秘めております。弊社ウェブサイトをご利用になる際は、利用者自身の行動を決定する際のあくまで参考としてご利用いただき、出発前に現地に最新の情報をご確認頂くなど、利用者自身であらゆるリスクに備えた準備をされ、また行動をして頂きますようお願い申し上げます。ウェザーニューズ並びにその役員及び従業員は、弊社ウェブサイトのコンテンツ情報に依拠し、またはコンテンツの情報を信頼して行った活動により発生した、いかなる生命、身体、財産上の損失又は損害について責任を負いかねますので、あらかじめご了解の程お願い申し上げます。

### 著作権について

弊社ウェブサイト上のコンテンツの著作権は原則としてウェザーニューズに帰属します。個々のコンテンツの著作権のほかに、ホームページという形で編集したことによる編集著作権もウェザーニューズに帰属します。ただし株式会社ウェザーニューズの社員以外の者による寄稿や外部写真家による写真などの著作権は原則として原著作者に帰属します。

### 著作権の取り扱い

弊社ウェブサイトのコンテンツを著作権法上許可された「私的使用」や「引用」等の範囲を超えて使用する場合、ウェザーニューズの使用許諾が必要となります。外部寄稿のものは原著作者の許諾も必要となります。弊社ウェブサイトの画面を許可なく複製、翻訳、翻案、放送、出版、販売、貸与するなどの行為を行うことは禁止いたします。また営利団体、非営利団体、個人の別を問わず弊社ウェブサイト以外のホームページ、パソコン通信、イントラネット、電子メールなどへ、コンテンツ全部もしくはその一部を株式会社ウェザーニューズの承諾なく転用することは著作権侵害にあたり禁止いたします。

### 許される「引用」の範囲

著作権法による「引用」とは、報道、批評、研究その他の目的で、出典と引用部分を明示して、目的上正当な範囲内で記事の一部を使用する場合を意味します。また、引用する側が「主」で、引用される側が「従」の関係であることが必要です。これらの条件が満たされない場合、著作権法で認められる引用とはならず、ウェザーニューズによる使用許諾が必要となります。

### コンテンツの転用

ウェザーニューズに許可なく弊社ウェブサイトの独自コンテンツを、改変、要約し、コンテンツを転用することは禁止いたします。

### コンテンツのダウンロード

個人が弊社ウェブサイトのコンテンツを自分のパソコンにダウンロードするのは著作権法で認められた「私的使用のための複製」と解釈いたします。ただし、ダウンロードしたコンテンツを使用できるのは、本人かその家族に限られます。個人がダウンロードした場合であっても、これを会社などで本人以外に利用させることは、営利非営利の目的を問わず「私的使用」の範囲を超えるため、ウェザーニューズの許可が必要です。

弊社は以上の内容に訂正を行うことがあります。その際、すべての情報はこのページにてお知らせいたします。
