Digital analytics just got easier, for everyone. Join our webinar on November 19!
...
* Why Heap
    ...
    * [Why Product Analytics And what can it do for you?](https://heap.io/why-heap/why-product-analytics)
    * [How Heap Works A video guide](https://heap.io/why-heap/how-heap-works)
    * [How Heap Compares Heap vs. competitors](https://heap.io/compare)
    * [Product Analytics + Digital Experience Analytics A deeper dive](https://www.heap.io/dxa-plus-pa-detailed)
    * [The Future of Insights A comic book guide](https://heap.io/resources/ebooks-whitepapers/comic-book-digital-insights-are-a-superpower)
    
    [Watch a Demo](https://heap.io/demo-hub)
...
* Platform
    ...
    * [Segments User cohorts for actionable insights](https://heap.io/platform/segments)
    * [Dashboards Share insights on critical metrics](https://heap.io/platform/dashboards)
    * [Charts Analyze everything about your users](https://heap.io/platform/charts)
    * [Playbooks Plug-and-play templates and analyses](https://heap.io/platform/playbooks)
    
    Data Foundation
    
    * [Capture Automatic event tracking and apis](https://heap.io/platform/capture)
    * [Mobile Track and analyze your users across devices](https://heap.io/platform/mobile)
    * [Enrichment Add context to your data](https://heap.io/platform/enrichment)
    * [Integrations Connect bi-directionally to other tools](https://heap.io/platform/integrations)
    
    Data Management
    
    * [Governance Keep data clean and trusted](https://heap.io/platform/governance)
    * [Security & Privacy Security and compliance made simple](https://heap.io/platform/security)
    * [Infrastructure How we build for scale](https://heap.io/platform/infrastructure)
    * [Heap Connect Send Heap data directly to your warehouse](https://heap.io/platform/connect)
    
* Use Cases
    
    Solutions
    
    * [Funnel Optimization Improve conversion in user flows](https://heap.io/use-case/funnel-optimization)
    * [Product Adoption Maximize adoption across your site](https://heap.io/use-case/product-adoption)
    * [User Behavior Understand what your users do](https://heap.io/use-case/user-behavior)
    * [Product Led Growth Manage PLG with data](https://heap.io/use-case/product-led-growth)
    
    Industries
    
    * [SaaS Easily improve acquisition, retention, and expansion](https://heap.io/use-case/saas)
    * [Retail and eComm Increase purchases and order value](https://heap.io/use-case/ecommerce)
    * [Healthcare Build better digital patient experiences](https://heap.io/heap-for-healthcare)
    * [Financial Services Raise share of wallet and LTV](https://heap.io/use-case/financial-services)
    
    Heap For Teams
    
    * [Product Teams Optimize product activation, conversion and retention](https://heap.io/solutions-product-teams)
    * [Marketing Teams Optimize acquisition performance and costs](https://heap.io/solutions-marketing-teams)
    * [Data Teams Optimize behavioral data without code](https://heap.io/solutions-data-teams)
...
* Resources
    ...
    * [Heap University Video Tutorials](https://learn.heap.io/)
    * [Help Center How to use Heap](https://help.heap.io/)
    * [Heap Plays Tactical how-to guides](https://help.heap.io/category/dashboard-templates/)
    * [Professional Services](https://heap.io/professional-services/service-offerings)
    
    Resources
    
    * [Down the Funnel Our complete blog and content library](https://heap.io/resources)
    * [Webinars & Events Events and webinar recordings](https://heap.io/resources/webinars-events)
    * [Press News from and about Heap](https://heap.io/press)
    * [Careers Join us](https://heap.io/careers)
    
    Ecosystem
    
    * [Customer Community Join the conversation](https://community.heap.io/)
    * [Partners Technology and Solutions Partners](https://heap.io/partners)
    * [Developers](https://heap.io/platform/developer)
    * [Customers Stories from over 9,000 successful companies](https://heap.io/customer-stories)
    
* [Free Trial](https://heapanalytics.com/signup?utm_placement=main_nav)[Request Demo](https://heap.io/request-product-analytics-demo?utm_placement=main_nav)
* [Log In](https://heapanalytics.com/app)

* [Free Trial](https://heapanalytics.com/signup?utm_placement=main_nav)
* [Request Demo](https://heap.io/request-product-analytics-demo?utm_placement=main_nav)
* [Log In](https://heapanalytics.com/app)

Heap Inc. Website Terms of Use
==============================
...
Welcome to the Website of Heap Inc., a Delaware corporation (“Heap,” “we,” “our,” or “us”). This Website Terms of Use (the “Website Terms” or “Terms of Use”) is a legally binding agreement between you (“Users,” “Customers,” and/or “Website Visitors”) and Heap.

This Website Terms governs your use of our website i.e., located at [https://heap.io/](https://heap.io/) (the “Website” or “Site”). By using or accessing the Website, you agree to be bound by, and use our Site in compliance with, these Website Terms.

IF YOU DO NOT AGREE TO THESE WEBSITE TERMS, PLEASE DO NOT USE OUR SITE AND FEEL FREE TO CONTACT US AT [LEGAL@HEAP.IO](mailto:LEGAL@HEAP.IO).
...
These Website Terms govern your use and access of our Site. To register for a Heap account and to be eligible to use our Services (as defined under the [Terms of Service](https://heap.io/legal/heap-master-services-agreement)), you must thoroughly review and accept Heaps’ [TERMS OF SERVICE](https://heap.io/legal/heap-master-services-agreement). IF YOU DO NOT AGREE WITH THE TERMS OF SERVICE, PLEASE DO NOT CLICK THE “I ACCEPT” BUTTON AND PLEASE DO NOT USE OUR SERVICES.

Capitalized terms not described herein shall have the same meaning as ascribed to them under the [Terms of Service](https://heap.io/legal/heap-master-services-agreement) and/or the [Privacy Policy](https://heap.io/privacy).

### 2\. Heap Agreements

This Website Terms only governs your use and access rights to our Website. Please note that if you purchase and use our Services,  you will be subject to our [Terms of Service](https://heap.io/legal/heap-master-services-agreement) in addition to being subject to these Website Terms.

Your use and access of our Website and Services are also subject to our [Privacy Policy](https://heap.io/privacy). Please read our Privacy Policy carefully to understand your rights and obligations with respect to collection and storage of data.

The Website Terms, the Terms of Service and the Privacy Policy is hereinafter collectively referred to as “Heap Agreements.” In the event of any conflict between the above-mentioned agreements, the Privacy Policy will take precedence over the Terms of Service and the Website Terms.

IF YOU WANT TO KNOW MORE ABOUT HEAP AGREEMENTS, PLEASE SEND US YOUR QUERY AT [LEGAL@HEAP.IO](mailto:LEGAL@HEAP.IO).
...
Our Privacy Policy (“Privacy Policy”) describes how we handle information provided to us by our customers and users when using and accessing our Website and Services. You understand that when you access and/or use of our Website and Services, you consent to our PRIVACY POLICY. Additionally, you also agree to the transfer of information to the United States of America (the “US”).

Our Site is designed to allow you to learn how your customers and individuals (“Your Users”) use your product by giving you the ability to collect information based on their interaction with your mobile application, mobile web site or web properties where you have integrated our Site and send communications to them. Heap does this in part using a first party cookie placed on Your User’s device from your server. Some information is automatically collected from or about Your Users when you use our Site. If you integrate an official Heap iOS or JavaScript library in your product it may by default collect Your User data including but not limited to: the time of an event, the elements Your User has interacted with, metadata and other details about these elements, how Your User came to your site, what search engine and search keywords Your Users may have used to get to your site, information about the device Your User is on such as their operating system, and browser, as well as the city/region/country location of Users. In addition, you can choose what other user data you want to collect from Your Users such as age, IP addresses, user names, real names, email addresses and other custom properties.
...
* Credit Card Information including credit card numbers, CVV numbers (three digit codes for Visa and MasterCard, four digit code for American Express) and magnetic stripe information
...
* Personally identifiable information knowingly collected from children under the age of 13 or from online Site directed toward children
...
1. **With third parties who work on our behalf to provide you with the Services;**
    
2. **To comply with laws or to respond to lawful requests and legal process (provided that Heap will endeavor to notify you if Heap has received a lawful request for your information);**
    
3. **To protect the rights and property of Heap, our agents, customers, and others including to enforce our agreements, policies, and terms of use;**
    
4. **In an emergency, including to protect the personal safety of any person; and**
    
5. **For the purposes of a business deal (or negotiation of a business deal) involving sale or transfer of all or a part of our business or assets (business deals may include, for example, any merger, financing, acquisition, divestiture, or bankruptcy transaction or proceeding).**
...
You agree to provide appropriate notices to Your Users about, and if required by applicable laws obtain appropriate consent from Users for, your information collection and use practices relating to your use of our Site and your use of cookies for tracking purposes. Appropriate notices may include notice in the form of a privacy policy posted on your website and/or your mobile application.

We may also collect registration and other information about you as our customer through our Site. Our collection and use of information collected about you on our website is governed by our Privacy Policy. Our Privacy Policy does not cover information we collect about Your Users on your behalf from your mobile and web properties. It is your obligation to provide your own privacy policy or notice to your users. It is your responsibility to ensure compliance with applicable privacy laws at your end.
...
If you would like to unsubscribe from receiving promotional emails from us, please follow instructions to unsubscribe available at the bottom of the email sent by us. If you have any questions, please feel free to email [legal@heap.io](mailto:legal@heap.io).
...
5. **Your address, telephone number**
    
6. **And e-mail address;**
...
If you have any questions or concerns about our Site, Services or these Website Terms, you may contact us by email at [legal@heap.io](mailto:legal@heap.io).

Better insights. Faster.
------------------------

[Request Demo](https://heap.io/request-product-analytics-demo)

* Platform
* [Capture](https://heap.io/platform/capture)
* [Enrichment](https://heap.io/platform/enrichment)
* [Integrations](https://heap.io/platform/integrations)
* [Governance](https://heap.io/platform/governance)
* [Security & Privacy](https://heap.io/platform/security)
* [Infrastructure](https://heap.io/platform/infrastructure)
* [Heap Illuminate](https://heap.io/platform/illuminate)
* [Segments](https://heap.io/platform/segments)
* [Charts](https://heap.io/platform/charts)
* [Dashboards](https://heap.io/platform/dashboards)
* [Playbooks](https://heap.io/platform/playbooks)

* Use Cases
* [Funnel Optimization](https://heap.io/use-case/funnel-optimization)
* [Product Adoption](https://heap.io/use-case/product-adoption)
* [User Behavior](https://heap.io/use-case/user-behavior)
* [Product Led Growth](https://heap.io/use-case/product-led-growth)
* [Customer 360](https://heap.io/use-case/customer-360)
* [SaaS](https://heap.io/use-case/saas)
* [Retail and eComm](https://heap.io/use-case/ecommerce)
* [Financial Services](https://heap.io/use-case/financial-services)

* Why Heap
* [Why Product Analytics](https://heap.io/why-heap/why-product-analytics)
* [How Heap Works](https://heap.io/why-heap/how-heap-works)
* [How Heap Compares](https://heap.io/compare)
* [ROI Calculator](https://heap.io/roi-calculator)
* [The Future of Insights](https://heap.io/resources/ebooks-whitepapers/comic-book-digital-insights-are-a-superpower)

* Resources
* [Blog](https://heap.io/blog)
* [Content Library](https://heap.io/resources)
* [Events](https://heap.io/resources/webinars-events)
* [Topics](https://heap.io/topics)
* [Heap University](https://learn.heap.io/)
* [Community](https://community.heap.io/)
* [Professional Services](https://heap.io/professional-services/service-offerings)

* Company
* [About](https://heap.io/about)
* [Partners](https://heap.io/partners)
* [Press](https://heap.io/press)
* [Careers](https://heap.io/careers)
* [Customers](https://heap.io/customer-stories)
* [DEI](https://heap.io/dei-at-heap)

* Support
* [Request Demo](https://heap.io/request-product-analytics-demo)
* [Help Center](https://help.heap.io/)
* [Contact Us](https://heap.io/contact-sales)
* [Pricing](https://heap.io/pricing)

* Social

* [Twitter](https://www.twitter.com/heap)
* [Facebook](https://www.facebook.com/HeapAnalytics)
* [LinkedIn](https://www.linkedin.com/company/heap-inc-)
* [YouTube](https://www.youtube.com/channel/UCgoAkAVwOt_ZvfSZz7Dn1jQ)

© 2024 Heap Inc. All Rights Reserved.

* [Legal](https://heap.io/legal)
* [Privacy Policy](https://heap.io/privacy)
* [Status](https://status.heap.io/)
* [Trust](https://heap.io/trust-center)