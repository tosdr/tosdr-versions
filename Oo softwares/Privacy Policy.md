...
* Products
    ...
    * * Backup & transfer data
        * [O&O DiskImage Professional data backup for your PCs](https://www.oo-software.com/en/diskimage-backup-your-data "O&O DiskImage: Maximum security for your Data with our backup software for Windows")
        * [O&O AutoBackup Backup and sync your files and folders automatically](https://www.oo-software.com/en/autobackup-sync-files "O&O AutoBackup: Backup and sync your files and folders automatically")
        * [O&O FileBackup Instant backup and restoration of data](https://www.oo-software.com/en/oofilebackup "O&O FileBackup: Instant. Reliable. Fast")
        * Rescue data & systems
        * [O&O DiskRecovery Professional data recovery made easy](https://www.oo-software.com/en/products/oodiskrecovery "O&O DiskRecovery: Professional data recovery made easy")
        * [O&O BlueCon Disaster recovery when a pc or server no longer starts](https://www.oo-software.com/en/oo-bluecon-disaster-recovery-for-companies "O&O BlueCon: Disaster recovery when a pc or server no longer starts")
        
        * Optimize systems
        * [O&O Defrag Speed up your Windows PC](https://www.oo-software.com/en/products/oodefrag "O&O Defrag: Speed up your Windows PC")
        * [O&O DiskStat Optimize storage space and work better with Windows](https://www.oo-software.com/en/oodiskstat "O&O DiskStat: Optimize storage space and work better with Windows")
        * Protect data & systems
        * [O&O SafeErase Stop identity theft with secure data deletion](https://www.oo-software.com/en/safeerase-hard-drive-data-secure-deletion "O&O SafeErase: Stop identity theft with secure data deletion")
        * Cloud solutions
        * [O&O Syspectr Free IT management solution from the cloud](https://www.oo-software.com/en/oo-syspectr "O&O Syspectr: Free IT management from the cloud")
        
        * Freeware
        * [O&O ShutUp10++ Free antispy tool  
            for Windows 10 and 11](https://www.oo-software.com/en/shutup10 "O&O ShutUp10: Free antispy tool for Windows 10 and 11")
        * [O&O RegEditor Editing the Windows Registry](https://www.oo-software.com/en/ooregeditor "O&O RegEditor: Edit Windows registry enties Freeware")
        * [O&O AppBuster Bust Apps you do not want](https://www.oo-software.com/en/ooappbuster "O&O AppBuster: Bust Apps you do not want")
        * [O&O Lanytix Quick and easy Network Analysis in the LAN](https://www.oo-software.com/en/oolanytix "O&O Lanytix: Quick and easy Network Analysis in the LAN")
        * [O&O DeskInfo All important system information directly on the desktop](https://www.oo-software.com/en/oodeskinfo "O&O DeskInfo: All important system information directly on the desktop")
        
        * [Downloads Get installation and portable applications](https://www.oo-software.com/en/download/archive)
        * [O&O Blog Stay up-to-date with our blog](https://blog.oo-software.com/en)
        * [Corporate Solutions Benefits for your company](https://www.oo-software.com/en/corporate-solutions)
        * [O&O PowerPack Our 4 Top Products in a Pack for a Special Price!](https://www.oo-software.com/en/products/oopowerpack)
        
    * [View all products >>>](https://www.oo-software.com/en/products/)
    
* Support
    
    * * Ressources
        * [Documentation Documents related to O&O products](https://www.oo-software.com/en/support/docs)
        * [User's guides online Read manuals online](https://docs.oo-software.com/en/)
        * [Downloads Download archive](https://www.oo-software.com/en/download/archive)
        * [Whitepapers Studies and whitepapers](https://www.oo-software.com/en/support/docs)
        * [FAQ Frequently asked questions](https://www.oo-software.com/en/support/faq)
        * [First aid First aid in the event of data loss](https://www.oo-software.com/en/support/firstaid)
        
        * Get support
        * [Overview Our service offers](https://www.oo-software.com/en/support)
        * [Registration Register your O&O product](https://www.oo-software.com/en/support/register)
        * [Trial users Support for trial users](https://www.oo-software.com/en/support/tsupport)
        * [Registered customers Support for registered customers](https://www.oo-software.com/en/support/csupport)
        * [License recovery Resend your O&O license](https://www.oo-software.com/en/support/license-recovery)
        
        * Partner
        * [O&O Partner Program Your advantages as an O&O Partner](https://www.oo-software.com/en/partner)
        * [O&O Partners Authorized O&O Partners in your region](https://www.oo-software.com/en/order/reseller)
        
        * Company
        * [About us Leading manufacturer of system tools](https://www.oo-software.com/en/company)
        * [Product releases List release dates and versions](https://www.oo-software.com/en/support/productreleases)
        * [The O&O Group Made in Berlin. Made in Germany.](https://www.oo-software.com/en/company/oogroup)
        * [Team Our management team](https://www.oo-software.com/en/company/team)
        * [Contact us How to contact O&O](https://www.oo-software.com/en/contact)
        
    
* [Get your US$10 voucher](https://www.oo-software.com/en/newsletter?r=tn1.2.4)

O&O Software’s Privacy Policy
=============================

![Microsoft Gold certified Partner](/oocontent/themes/oo2017/images/logos/msp.png)
...
**Newsletter**  
Sendinblue GmbH is the software used for our NewsLetters. Your data will be transmitted to Sendinblue GmbH. Sendinblue GmbH is prohibited from selling your data and using it for purposes other than sending newsletters. Sendinblue GmbH is a German, certified provider, which was selected according to the requirements of the General Data Protection Regulation and the German Federal Data Protection Act.

Further information can be found here: [https://www.sendinblue.com/information-for-email-recipients/?rtype=n2go](https://www.sendinblue.com/information-for-email-recipients/?rtype=n2go)
...
The data protection measures are always subject to technical updates, which is why we ask you to inform yourself about our data protection measures at regular intervals by consulting our data protection declaration [https://www.oo-software.com/en/company/privacy](https://www.oo-software.com/en/company/privacy).
...
* [The O&O Group](https://www.oo-software.com/en/company/oogroup)
* [Management Team](https://www.oo-software.com/en/company/team)
* [Awards](https://www.oo-software.com/en/company/success)
...
[About us](https://www.oo-software.com/en/company) [Blog](https://blog.oo-software.com/en/) [For Partners](https://partners.oo-software.com/en/) [Contact](https://www.oo-software.com/en/contact)

[Our Products](https://www.oo-software.com/en/products) [Order](https://www.oo-software.com/en/order) [Downloads](https://www.oo-software.com/en/download/archive) [Data Security](https://www.oo-software.com/en/company/privacy)

[Support](https://www.oo-software.com/en/support) [FAQ](https://www.oo-software.com/en/support/faq) [Platform Status](https://www.syspectr.com/en/status) [News & Releases](https://blog.oo-software.com/de/)

[Social Commitment](https://www.oo-software.com/en/company/social-commitment) [Press Releases](https://www.oo-software.com/en/press/releases) [O&O Labs](https://www.oo-software.com/en/labs) [The O&O Group](https://www.oo-software.com/en/company/oogroup)

© 1997-2024 O&O Software GmbH, Berlin

[Privacy Policy](https://www.oo-software.com/en/company/privacy) [Terms & Conditions](https://www.oo-software.com/en/contact/termsandconditions) [EULA](https://docs.oo-software.com/en/eula-3) [Cancel subscriptions](https://app.syspectr.com/en/premium/cancel) [Imprint](https://www.oo-software.com/en/contact)