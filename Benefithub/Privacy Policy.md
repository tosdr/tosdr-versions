...
At BenefitHub, Inc. (including our parent, Motivano, Inc., and our subsidiaries, “BenefitHub” or “we”), we know that you care how information about you is used and shared. When you use BenefitHub, we know that you are trusting us with your personal information and want us to tell you what information we are gathering and how we are sharing it. We appreciate your trust and are committed to collecting and processing your personal information carefully and sensibly. This privacy policy (“Privacy Policy” or “Policy”) is meant to help you understand how we do that.

#### Acknowledgement of Policy Terms

By visiting your sponsor’s BenefitHub website located at “\[SponsorName\].BenefitHub.com” (the “Website”), using our SavingsScout™ extension for web browsers (the “SavingsScout Extension”), the BenefitHub mobile application (the “Mobile App”), providing information to or making a transaction through the Website, Mobile App, Extension, or any other online services or software applications we provide (collectively, the “BenefitHub Platform” or the “Platform”), you acknowledge you have read and agree to the terms of the most recent version of this Privacy Policy. We reserve the right, at our sole discretion, to change, modify, add or remove portions of this Privacy Policy at any time. If this Policy changes in the future, we will let you know by posting the updated Policy on the BenefitHub Platform with the most recent effective date. Please remember that your use of the BenefitHub Platform is also subject the most recent version of our Terms and Conditions, which are also available on the BenefitHub Platform, and to check periodically for changes.
...
If you do not want your information handled as described in this Privacy Policy, please do not provide us with your information or interact with the BenefitHub Platform or any website we link to.
...
* search for products and services on the Platform
* click through the Platform to purchase a product or service
* provide information in your Account (and you might have more than one if you have used more than one e-mail address when shopping with us) or your Profile
* provide Feedback when you favorite, love, post a review of, or tell us if you redeemed a deal for a product or service
* participate in a sweepstakes, contest or questionnaire
* communicate with BenefitHub through email or another way
...
**BenefitHub Mobile App Information:** When you use the BenefitHub Mobile App to make a purchase from a merchant partner, you share with us certain information needed to complete and track those purchases. You also directly share with the merchant partner whatever information the merchant may require in order to collect payment for, process, fulfill, track, and deliver your purchase. BenefitHub does not see, collect, or store any of your payment or credit card data. We may also request access or permission to and track location-based information (e.g. latitude/longitude to find local offers) from your mobile device, either continuously or while you are using the Mobile App, to provide location- based services. If you wish to change our access or permissions, you may do so in your mobile device’s settings.

**SavingsScout Extension:** In order to download and use the SavingsScout Extension, you must register for and maintain an active BenefitHub Platform account. If you already have an active account but are unable to locate it, you are required to provide your email address in order to locate it. We also collect information you directly provide when you use the SavingsScout Extension to search for products and services on the Platform and click through to purchase a product or service.

**Technical Information:** Whenever you interact with us through the BenefitHub Platform, we automatically receive and store certain types of information to help ensure that the Platform works correctly on different devices, operating systems, and browsers.

**Examples of the automatic information we collect and analyze include:**

* the Internet protocol (IP) address used to connect your computer to the Internet
* computer and connection information such as device and browser type, version, time zone setting, browser plug-in types and versions, operating system, and platform
* Platform search, viewing, and purchase history, which we sometimes aggregate with similar information from other customers to create features like Most Purchased
* an event stamp, including the full Uniform Resource Locator (URL) clickstream to, through, and from the BenefitHub Platform, including date and time

**During some visits we may also use software tools such as JavaScript to measure and collect Platform session analytics information, including:**
...
* _**Operations**__:_ These are cookies that are needed to make the Platform work. They include remembering your sign in credentials, browser navigation, and standard technical checks such as Javascript checks and load
* _**Analytics**__:_ These cookies help BenefitHub monitor traffic and activity on the BenefitHub Platform and to coordinate its own marketing and promotional activities. They do not identify you specifically, but they may be indirectly linked to your unique user ID. We anonymize and aggregate this information to help us to detect fraud or misuse of your account, understand broad demographic data and trends, and generally operate the
* _**Attribution**__:_ BenefitHub uses third party pixels on our landing pages to let our advertising partners know that you found one of their ads or discounts on the BenefitHub Platform. Third party affiliates may also use cookies on our behalf in order to pay BenefitHub a commission or revenue share from a merchant when you make a purchase on the Platform (part of which we pass on to you as Cash Back). In these cases, BenefitHub does not reveal any information to the merchant or third party affiliate that can be used to identify you.

The Help feature on most browsers will tell you how to prevent your browser from accepting new cookies, how to have the browser notify you when you receive a new cookie, or how to disable cookies altogether. Additionally, you can disable or delete similar data used by browser add-ons, such as Flash cookies, by changing the add-ons settings or visiting the Web site of its manufacturer. Because cookies allow you to take advantage of some of the BenefitHub Platform’s essential features, we recommend that you leave them turned on. If you delete or choose not to accept cookies from us, you may be missing out on certain features of the BenefitHub Platform. For more information on cookies, including how to disable them, please see [http://www.allaboutcookies.org/](http://www.allaboutcookies.org/)[.](http://www.allaboutcookies.org/)

#### How BenefitHub Shares The Information It Receives

We never sell information about our customers to anyone. We also do not share information about your individual shopping activities or preferences with your sponsor organization. Other than registrations, logins, and clicks, we only share aggregated information about all participants of your sponsor organization , and only subject to this Privacy Policy. However, if you are purchasing or participating in your sponsor organization’s specific benefits program through BenefitHub (e.g. voluntary benefits), then it is likely we are sharing your benefit elections and information with your employer or membership organization, as well as with any insurance carriers or other benefit providers that you have selected, in order to properly receive and remit premiums and other fees on your behalf.
...
Protection of BenefitHub: We release account and other personal information when we believe release is appropriate to comply with the law or lawful demands from government entities or other regulatory bodies; to enforce or apply this Policy, our Terms and Conditions, and other agreements; or to protect the rights, property, or safety of BenefitHub, our users, or others. This may include exchanging information with other companies and organizations for fraud protection and credit risk reduction.

Please note, however, this does not include selling, renting, sharing, or otherwise disclosing personally identifiable information from customers for commercial purposes in violation of the commitments set forth in this Privacy Policy.
...
#### How We Secure Your Information and How Long We Retain It
...
The BenefitHub Platform includes third-party advertising and links to other websites that are not owned or operated by BenefitHub. This Privacy Policy only addresses the use and disclosure of information by BenefitHub through your interaction with the BenefitHub Platform. Other websites that may be accessible through links from the BenefitHub Platform and our co-branded websites may have their own privacy statements and personal information collection, use, and disclosure practices.
...
#### Choices For Managing Your Personal Information
...
If you do not want to receive e-mail or other mail from us, please adjust your Customer Communication Preferences. Even if you do not want to receive Terms and Conditions and other legal notices from us, such as this Privacy Policy, those policies and terms will still govern your use of the BenefitHub Platform, and it is your responsibility to review them for changes.

As noted above, the Help feature on most browsers will tell you how to prevent your browser from accepting new cookies, how to have the browser notify you when you receive a new cookie, or how to disable cookies altogether. Additionally, you can disable or delete similar data used by browser add-ons, such as Flash cookies, by changing the add-on settings or visiting the Web site of its manufacturer.

Because cookies allow you to take advantage of some of BenefitHub’s essential features, we recommend that you leave them turned on.

If you want to stop using the BenefitHub Platform, we provide instructions on how to delete your Account and uninstall the Extension on our Website. You can uninstall the Mobile App in the same way in which you would delete other mobile applications from your device. If you have any issues, you may contact our support team for help at [customercare@benefithub.com](mailto:customercare@benefithub.com).
...
#### Children Should Not Use BenefitHub
...
If you choose to visit BenefitHub or use the BenefitHub Platform, your visit and use, and any dispute over privacy, is subject to this Privacy Policy and our Terms and Conditions, including limitations on damages, resolution of disputes, and application of the law of the state of Delaware. If you have any concern about privacy at BenefitHub, please contact us at [DPO@benefithub.com](https://motivano-my.sharepoint.com/personal/stuart_soberman_motivano_com/Documents/IT/DPO%40benefithub.com) with a thorough description, and we will try to resolve it. Our business changes constantly, and our Privacy Policy and the Terms and Conditions will change also, with the effective date noted.

We may e-mail periodic reminders of our notices and conditions, but you should check the BenefitHub Platform frequently to see recent changes. Unless stated otherwise, our current Privacy Policy applies to all information that we have about you and your account, and your use of the BenefitHub Platform indicates your consent to that version of the Privacy Policy.

#### Additional Terms For IncentFit Wellness Incentives

If you or your sponsor organization utilizes the IncentFit Wellness Incentives program, your use of that program is additionally governed by [this privacy policy.](https://incentfit.com/privacy-policy)
...
#### Additional Terms For Nevada Residents

If you are a Nevada resident, you have the right to request that BenefitHub not sell your personal information to third parties. To submit this request, please send us an email at [DPO@benefithub.com.](mailto:DPO@benefithub.com) However, as stated elsewhere in this Privacy Policy, please note that BenefitHub does not sell, rent or trade your personal information to third parties.

#### How To Contact Us

If you have any questions about this Privacy Policy or our related practices, please contact us by email at [DPO@benefithub.com,](mailto:DPO@benefithub.com) or by snail mail at:
...
#### Additional Terms For Canada Residents

In Canada, we provide the BenefitHub Platform through BenefitHub Technology Canada Limited, a private company established in Vancouver, British Columbia, Canada. Our address is 885 West Georgia Street, Suite 1500, Vancouver, BC V6C 3E8. Our contact email address is [DPO@benefithub.com](mailto:DPO@benefithub.com).

**Legal Bases:** The personal information that you share and we collect, as well as its purposes, are described in this Privacy Policy. BenefitHub will only collect or process your personal information if we have a legal basis to do so. These are:

* When you consent to our use of your data for a specific
* When we need that data to enact a transaction or to provide you with services and products that you request. This includes personalizing features and protecting the security of BenefitHub and its
* When BenefitHub has a legitimate interest in using that data in the normal ways you’d expect, like ensuring BenefitHub’s products run properly, improving and creating new products, historical analytics research, promoting BenefitHub, and protecting our legal
* When we need to process your data to comply with a legal or regulatory

**Your rights:** You have the following rights with regard to your personal data. To exercise any of these rights, please contact us at [DPO@benefithub.com.](mailto:DPO@benefithub.com) Please note that these rights are limited, like for example, where fulfilling your request would adversely affect other individuals or our legal obligations.

* Right to Access: You have the right to request information about your personal data that we hold, how we use it, and who we share it
* Right to Portability: Where you have provided your personal data to us on the basis of your consent, you have the right to ask us for a copy of this data in a structured, machine-readable format and to ask us to send this data to another data
* Right to Rectification: You have the right to ask us to correct your personal data where it is inaccurate or
* Right to Erasure: In certain circumstances, you have the right to ask us to delete the personal data we hold about
* Right to Withdraw Consent: In situations where we are processing your personal data based on your consent, you may withdraw this consent at any
* Right to Object to Processing: In situations where we are processing your personal data based on our legitimate interest, you can object that the interest is no longer legitimate. BenefitHub will stop processing that data, unless we can demonstrate an overriding legitimate ground. You can also request to opt out of direct
* Right to Restrict Processing: You have the right to ask us to stop any active processing of your personal data while we seek to verify data you claim is inaccurate, while we verify our legitimate interests, or while we cannot erase that data due to legal

BenefitHub will try to respond to these requests within 30 days, but some might take longer. You will typically not be charged any fee for effecting these rights, but BenefitHub reserves the right to charge a reasonable fee (or refuse to comply) if the request is unfounded, repetitive, or excessive.

**Complaints**: In the event that you wish to make a complaint about how we process your personal data, please contact us at [DPO@benefithub.com](mailto:DPO@benefithub.com) and we will do our best to resolve it. If you are not satisfied with our response to your concern, you can choose to file a complaint with the Office of the Privacy Commissioner of Canada/Commissariat à la protection de la vie privée du Canada at [https://www.priv.gc.ca/en/report-a-concern/file-a-formal-privacy-complaint/file-a-complaint-about-a-](https://www.priv.gc.ca/en/report-a-concern/file-a-formal-privacy-complaint/file-a-complaint-about-a-business/) [business/.](https://www.priv.gc.ca/en/report-a-concern/file-a-formal-privacy-complaint/file-a-complaint-about-a-business/) 
