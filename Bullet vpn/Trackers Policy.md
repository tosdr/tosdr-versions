...
At times, there are changes and amendments to BulletVPN’s Cookie Policy. BulletVPN has all the rights to modify and alter the Cookie Policy, whenever it is necessary and required by BulletVPN. This is the whole agreement. It is the responsibility of the users to periodically check for new the Cookie Policy. If after the changes in Cookie Policy, the user still is using BulletVPN, it will be considered as an agreement between the user and BulletVPN on the revised Cookie Policy.

**Email:** [\[email protected\]](https://www.bulletvpn.com/cdn-cgi/l/email-protection)
