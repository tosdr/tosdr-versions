[diaspora\*](https://pod.interlin.nl/)

[![](/assets/branding/logos/asterisk_white_mobile-6e8e6a9049758f5f3b615e3ff56b1bfefcddc454e3ddd07a78754219639b089c.png)](https://pod.interlin.nl/)

* [Create account](https://pod.interlin.nl/users/sign_up)
* [Sign in](https://pod.interlin.nl/users/sign_in)
...
diaspora\* - Terms of Service Last Updated: 17th August, 2014
=============================================================

Here are the important things you need to know about accessing and using the **diaspora\*** (https://pod.interlin.nl/) website and service (collectively, "Service"). These are our terms of service ("Terms"). Please read them carefully.
...
This Service runs on a diaspora\* social network server. This source code is licensed under an [AGPLv3](https://www.gnu.org/licenses/agpl-3.0.html) license which means you are allowed to and even encouraged to take the source code, modify it and use it.
...
The validity of these Terms and the rights, obligations, and relations of the parties under these Terms will be construed and determined under and in accordance with the laws of Nederland.

Jurisdiction & Waiver of Representative Actions
-----------------------------------------------

You expressly agree that exclusive jurisdiction for any dispute with **diaspora\***, or in any way relating to your use of the **diaspora\*** website or Service, resides in the courts of Nederland and you further agree and expressly consent to the exercise of personal jurisdiction in the courts of Nederland in connection with any such dispute including any claim involving **diaspora\***. You further agree that you and **diaspora\*** will not commence against the other a class action, class arbitration or other representative action or proceeding.
...
* To enforce applicable user agreements or policies, including our [terms of service](https://pod.interlin.nl/terms#terms); and to protect **diaspora\***, our users or the public from harm or illegal activities;
...
* [What’s new?](https://github.com/diaspora/diaspora/blob/1d0982822b0278525b4d5be881114ff0977ea9df/Changelog.md)
* [Code 0.7.15.0](https://pod.interlin.nl/source.tar.gz "Download the source code package")
* [Pod statistics](https://pod.interlin.nl/statistics)
* [Switch to touch-optimized mode](https://pod.interlin.nl/mobile/toggle)
* [Terms](https://pod.interlin.nl/terms)
