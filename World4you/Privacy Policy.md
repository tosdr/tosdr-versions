...
* [www.world4you.com](https://www.world4you.com/)
* [my.world4you.com](https://my.world4you.com/)
* [webmail.world4you.com](https://webmail.world4you.com/)
* [mysqlsvradmin.world4you.com](https://mysqlsvradmin.world4you.com/)
* additional web pages of World4You Internet Services GmbH, provided that their data privacy statement link leads to this page
...
In cases of doubt, the German version of this privacy statement shall apply.
...
The data controller as set out in the General Data Protection Regulation and other national data protection laws of the Member States as well as any other data protection regulations is:
...
**e:** [dataprotection@world4you.com](mailto:dataprotection@world4you.com)  
**t:** +43 50 5859 
...
For the processing of personal data necessary for the fulfillment of a contract to which the data subject is party, Art. 6 Para. 1 Item b GDPR serves as the legal basis. This also applies to processing necessary for the performance of pre-contractual measures.

Insofar as the processing of personal data is necessary for the fulfilment of a legal obligation to which our company is subject, Art. 6 Para. 1 Item c GDPR serves as the legal basis.
...
If the processing is necessary for the safeguarding of a legitimate interest of our company or a third party and if the interests, fundamental rights and fundamental freedoms of the data subject do not outweigh the aforementioned interest, Art. 6 Para. 1 Item f GDPR serves as the legal basis for the processing.
...
If you do not change any settings or delete anything in your internet browser, the necessary technical cookies will remain valid for one month, with the exception of the cookie “copol\_www\_world4you\_com\_optin”. This is technically necessary in order to save your consent to the placement of optional cookies and is only deleted after 10 years, if still present.
...
The distribution of the newsletter will be carried out by CleverReach GmbH & Co KG. They ensure the security of your data through appropriate technical and organizational measures that are state ofthe art. As a processor, CleverReach GmbH & Co KG is not permitted to use the personal data provided for purposes other than sending the newsletter. For this purpose, the following data is transmitted to CleverReach GmbH & Co KG: first name, last name, email address, last mail client, date of birth, language, existing products, annual revenue, business customer or private customer, order date, contract duration, termination date, registration date, last login, and registration medium (website, control panel, or external platforms). Your personal data will be transmitted to CleverReach server locations within the EU.
...
You can revoke the consent you have given us to receive newsletters at any time without giving reasons. To do so, you can send us an e-mail to dataprotection@world4you.com or unsubscribe using the link [https://www.world4you.com/en/newsletter/information](https://www.world4you.com/en/newsletter/information) or via the unsubscribe option provided in the newsletter. However, we would like to point out that all processing/transfers carried out until the revocation remain lawful.
...
For the purpose of communication between you and us the following data will be passed on to our customer support platform Dixa ApS, Vimmelskaftet 41 A, 1. Stock, 1161 Copenhagen K, Denmark:
...
For the purpose of setting up and maintaining customer services and internal service landscapes  
the above mentioned obligatory and optional data will be passed on to our affiliated company Arsys  
Internet S.L.U., C. Madre de Dios, 21, 26004 Logroño, La Rioja, Spain.

For the purpose of developing, improving and managing the product portfolio the following data will  
be passed on to our affiliated company united-domains GmbH, Gautinger Straße 10, 82319  
Starnberg, Germany:
...
If invoices are sent by post or communication is made by post, your name and your address may be passed on to our service provider WienIT GmbH, Thomas-Klestil-Platz 3, 1030 Vienna for printing and enveloping.
...
If the data is necessary for the fulfillment of a contract or for the performance of pre-contractual measures, earlier erasure of the data is not possible.
...
No data is disclosed to third parties in this context. The data is used exclusively for the processing of the conversation. As part of the optional disclosure of the e-mail-address in the contact field of the FAQs the e-mail-address will be sent to our service provider Dixa ApS, Vimmelskaftet 41 A, 1. Stock, 1161 Copenhagen K, Denmark.
...
On our website we use chatbot features by Dixa ApS, Vimmelskaftet 41 A, 1. Stock, 1161 Copenhagen K, Denmark. The use of the chatbot function is optional. For the purpose of customer service, the following personal data provided when entering the chat will be used in any case:

* First name, last name
* Customer number
* Domain

Other use of personal data may be necessary for the processing of customer service.

#### **8.2. Legal basis for the data processing**

The legal basis for the processing is Art. 6 Para. 1 Item. b GDPR (contract fulfillment) and Art. 6 Para. 1 Item f (legitimate interest).  
In the course of fulfilling the contract, the data is processed in accordance with Art. 6 Para.1 Item. b DSGVO for a period of up to 180 days after the end of the conversation.

#### **8.3. Purpose of the data processing**

The purpose of the data processing is the exercise of customer service in connection with the performance of the contract and our legitimate interest.  
When using the chatbot functions, data is transmitted directly to the servers of our service provider Dixa AG, which are located in Denmark. You can find more information about data protection at Dixa under [https://www.dixa.com/legal/privacy/.](https://www.dixa.com/legal/privacy/)  

#### **8.4. Duration of the storage**

The personal data of the customers are kept for up to 180 days after the end of the conversation. After that, the data processed in the chat will be anonymized.
...
(2) wf\_loginalerted\_ (Hash): This cookie is used to notify the Wordfence administrator when an administrator logs in from a new device or location. This cookie is set for administrators only and is used to help site operators know if an admin has logged in from a new device or location.
...
### **13\. Analysis of user behavior using Mouseflow**

#### **13.1. Scope of the processing of personal data**

On our website we use the tool from Mouseflow ApS, Flaesketorvet 68, 1711 Copenhage, Denmark. The following data is transmitted to the service provider Mouseflow ApS for the purpose of improving user experience: 
...
The legal basis for the processing is Art. 6 para. 1 item a (consent). We obtain this via the cookie banner. 

#### **13.3. Purpose of data processing**

The processing of the personal data of the users enables us to analyse our users’ browsing habits. By evaluating the data obtained, we are able to compile information on the use of the individual components of our website. This helps us to constantly improve our website and its user-friendliness.

#### **13.4. Duration of the storage**

The data is deleted as soon as it is no longer required for our record-keeping purposes. The evaluations are performed using aggregated, and thus no longer personal, data.

#### **13.5. Option to object or request elimination**

Cookies are stored on the user’s computer and transmitted to us from there. Hence you as the user have complete control over the use of cookies. By changing the settings in your internet browser, you can deactivate or limit the transmission of cookies. Cookies that have already been stored can be deleted at any time. This can also be carried out automatically. If cookies are deactivated for our website, it is possible that you may no longer be able to use all the functions of the website to their full extent.

### **14\. Remarketing (Marketing Cookies)**
...
You as the user have the option to deactivate the use of cookies by Google; you can do so by calling up the page to deactivate Google at [https://www.google.com/ads/preferences](https://www.google.com/ads/preferences) . You can view more detailed information on Google remarketing as well as Google’s data privacy statement at: [https://www.google.com/privacy/ads/](https://www.google.com/privacy/ads/) .
...
You can find more information on this in Facebook's data protection declaration at [https://www.facebook.com/about/privacy/](https://www.facebook.com/about/privacy/) . If you do not wish to collect data via Custom Audience, you can deactivate it here [https://www.facebook.com/ads/preferences/?entry\_product=ad\_settings\_screen](https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen) . You must first log into Facebook. If you do not have a Facebook account, you can suppress usage-based advertising from Facebook on the website of the European Interactive Digital Advertising Alliance: [https://www.youronlinechoices.com/de/praferenzmanagement/](https://www.youronlinechoices.com/de/praferenzmanagement/) .
...
You can also prevent the collection of the data generated by the cookie and related to your use of the website and the processing of this data by Microsoft by clicking on the following link [https://choice.microsoft.com/de-DE/opt-out](https://choice.microsoft.com/de-DE/opt-out) explain out your contradiction. Further information on data protection and the cookies used by Microsoft and Bing Ads can be found on the Microsoft website [https://privacy.microsoft.com/de-de/privacystatement](https://privacy.microsoft.com/de-de/privacystatement) .
...
### **16\. LinkedIn Insight Conversion Tool**
...
You can disable the LinkedIn Insight Conversion Tool and interest-based advertising by opting out at the following link: [https://www.linkedin.com/mypreferences/d/categories/ads](https://www.linkedin.com/mypreferences/d/categories/ads) .
...
* telephone number 
* e-mail address
* address (street, number, ZIP-code, city, state)
* data of products/packages (product IDs, purchase date for the product/service, product definition ID, product description, product category)
* 2FA-authentication active/inactive

The legal basis for the processing of user's personal data is Article 6 (1) (f) GDPR. The respective data will be deleted at the end of the session.

On the website, we use the Personalization Engine tool for web tracking of website users. For this purpose, the following data is transmitted to our service provider Ionos SE:
...
### **18\. Reddit Pixel (Conversion Tracking)**

Purpose: Marketing  
Recipient country: USA

On our website we use the Reddit Conversion Pixel, an analysis service of Reddit Inc., 520 Third Street, Suite 305, San Francisco, CA 94107, USA ("Reddit").

Within the scope of this service, data is transmitted to the USA or such transmission cannot be ruled out. We would like to point out that, in the opinion of the European Court of Justice, there is currently no adequate level of data protection in the case of data transfer to the USA and that there are therefore various risks (such as possible access by US secret services).

For this tool, a so-called tracking pixel is integrated on our website. When you visit our pages, a direct connection is established between your browser and the Reddit server via this tracking pixel. Reddit thereby receives, among other things, the information from your browser that our page was called up from your end device. We would like to point out that we have no influence on the scope of the transmitted data and its further use by Reddit and therefore inform you according to our state of knowledge: Through the integration of Reddit conversion pixels, Reddit receives the information that you have called up the corresponding web page of our website or clicked on an advertisement from us. If you are registered with a Reddit service, Reddit can assign the visit to your account. Even if you are not registered with Reddit or have not logged in, it is possible that the provider will find out and store your IP address and other identifying features.
...
The processing of the data by TikTok takes place within the framework of the data use policy at [https://www.tiktok.com/legal/privacy-policy?lang=en of TikTok](https://www.tiktok.com/legal/privacy-policy?lang=en%20of%20TikTok) .

Specific information and details about the TikTok Pixel and how it works can be found in the TikTok help section at [https://support.tiktok.com/en](https://support.tiktok.com/en)
...
### **Enabling and disabling cookies in the browser**

You can enable or disable the general use of cookies in your browser. Depending on the browser you use, you can find these settings in the options menu of your browser. When you open the [privacy settings](#) , you can choose whether to agree to the use of cookies on our pages without restriction or to allow only certain cookies.
...
| Surname | Purpose | Creator | Storage time | Domain |
| --- | --- | --- | --- | --- |
| **\_ga** | Contains information to help distinguish users from the page. Gathers data about user visits, such as which pages are relevant. | Google | 1 year | world4you.com |
| **\_ga\_(GA4-ID)** | Contains information to help distinguish users from the page. Gathers data about user visits, such as which pages are relevant. | Google | Session | www.world4you.com |
| **\_gac\_(GA-ID)** | Contains information to help distinguish users from the page. Gathers data about user visits, such as which pages are relevant. | Google | Session | www.world4you.com |
...
| **\_uetvid** | registers a unique ID that identifies and recognizes the user. Used for targeted advertising. | Microsoft Bing | Session | my.world4you.com |
