...
The gender-specific spelling has been omitted for the sole purpose of better readability. All personal names on the website (and all integrated documents) are therefore to be understood as gender-neutral. The shortened form of language has purely editorial reasons and does not contain any evaluation.

### 1.1 SCOPE OF THE GTCS

These General Terms and Conditions (“**GTCs**”) apply to all deliveries and services provided by World4You Internet Services GmbH, Wolfgang-Pauli-Straße 2, BT3, 4020 Linz (“**ISP”**) as part of a concluded contract (“**Assignment”**) for its contract partners (“**Customers”**, jointly with the ISP called the “**Parties”** or individually a **“Party”**). The reciprocal rights and duties of the Parties are determined predominantly by the contents of the Assignment accepted by the ISP. The contractual services owed by the ISP are called the “**Services**”.
...
If the ISP works for the customer as a processor in the meaning of Art. 28 Para. 3 GDPR, special regulations for the processing agreement apply in addition to these GTCs, which can be accessed under [AVV](https://www.world4you.com/en/company/terms-and-conditions).
...
The ISP is committed to advocating compliance with legal regulations and complying with official orders (e.g. to remove terrorist content) in a legal compliant manner.
...
1. violates the Pornography Act,
2. glorifies war, terror and other acts of violence,
3. is likely to pose a serious moral hazard to children or adolescents,
4. Portraying people in a way that violates human dignity and/or reproduces an actual event without an overriding legitimate interest in this form of reporting,
5. incite hatred against parts of the population or against a national, racial, religious or ethnic group, or call for violence or arbitrary measures against them, or attack the human dignity of others by insulting, maliciously showing contempt for or slandering parts of the population or one of the aforementioned groups;
6. describe cruel or otherwise inhuman acts of violence against humans or animals in a way that glorifies or trivialises such acts of violence or that represents the cruel or inhuman nature of the process in a manner that violates dignity,
7. are likely to deny, insult, threaten, or cause resentment of others.
8. The aforementioned obligations apply mutatis mutandis to references ("hyperlinks") set up or embedded on the website by the Customer to such third-party content.

3.2.4 The Customer undertakes not to use the contractual services for the dissemination of terroristic content within the meaning of Austrian and European legislation and assumes comprehensive liability in the event of culpable violation of this obligation.

In order to prevent the dissemination of terroristic content via the contractual service as quickly as possible, the ISP works effectively with the authorities in Austria and the other EU member states. Therefore terroristic content will be removed after receiving a removal order within the meaning of Articles 3 and 4 TCO Regulation as soon as possible.

In addition, the provider reserves the right to temporarily remove or restrict access to terroristic content due to a violation of the terms of use / general conditions without the existence of a removal order and to temporarily block the user who distributed the content. This also applies if the ISP becomes aware in another way e.g. through a user message that terroristic content is being distributed via the contractual service. The customer will be informed immediately about a corresponding measure provides that this does not impair criminal investigations.

3.2.5 The Customer undertakes to equip its homepage with a provider identification (“Imprint" or “Disclosure") corresponding to the legal requirements.

3.2.6 The Customer promises not to use the contractual Services in any way that would result in illegal impairment of third parties or could put the safety and business of the ISP or others at risk. Spamming (aggressive direct mailing by email) or any use of the service to send threats, obscenities, harassment or to harm other internet users is prohibited.

3.2.7 The Customer must not look for data about other Customers of the ISP or about the ISP itself which are not intended for it, and must not transfer, sell or otherwise use them or information about how to access them. If the Customer comes across data not intended for it or if it receives information about how to access these, the Customer must notify the ISP immediately and in any case safeguard confidentiality.

3.2.8 The Customer further agrees to notify the ISP, if claims are asserted against it from the use of the contractual Services either in a court of law or extrajudicially. Furthermore, the Customer undertakes to immediately remedy the legal or contractual non-conformity in the event of a use of the contractual services found by the ISP to be illegal or in contravention of the contract.
...
The Customer is obligated to notify the ISP of any suspicions that its access details or other secret information relating to the ISP’s Services, may have become known to unauthorised third parties.
...
With regard to the annual fee for domains, the constancy of value according to the Consumer Price Index, as referred to in the above paragraph, is also agreed.
...
The Customer’s invoice must contain the following information: Customer name, Customer address, invoice date, Customer number, statement period, invoice number, individual fees, total price excl. VAT, VAT, total price incl. VAT and any discounts granted.

The ISP will make the invoice available in the Customer’s customer area at [my.world4you.com](http://my.world4you.com/) and will notify the Customer of this by email.
...
10\. CONTRACT TERM AND TERMINATION; BLOCK
-----------------------------------------

### 10.1 CONTRACT TERM AND TERMINATION

Any contracts for Services or other long-term debt relationships concluded between the Parties are agreed for an indefinite term or for the agreed defined period.

A separate contract is concluded for each product or service. This means that each position must be terminated or resigned in the event of termination or resignation.

If no agreement has been reached for the duration of the contract, contracts are concluded for an indefinite period. Either Party may cancel the contract in writing (scanned termination letter by email or via the customer portal) with a notice period of one month for the end of a performance period agreed upon contract conclusion. The performance period is the period for which the fee is charged (e.g. one month or one year).

### 10.2 MINIMUM CONTRACT TERM

If a cancellation waiver (“Minimum Contract Term”) has been agreed for a specific period (for Consumers, initially up to 24 months), an ordinary termination by the Customer only takes effect after this period has passed since the start of the contract.
...
1. default on payment within the meaning of section 6 or initiation of insolvency proceedings in case of payment default for claims which fall due after insolvency proceedings are initiated;
2. insolvency proceedings being rejected due to a lack of assets to cover costs;
3. at least two pending execution proceedings of the Customer’s creditors;
4. liquidation proceedings being initiated for the Customer;
5. if a request for a security or advance payment is not met in the event of a default on payment (section 6);
6. a significant violation of statutory provisions, official requirements or contractual provisions;
7. abuse of the ISP’s Services or spamming (for Consumers, only in case of fault);
8. use of the Services or triggering of a data transfer is such a way that the security or stability of the network is put at risk (for Consumers, only in case of fault);
9. use of insecure technical facilities within the meaning of section 3;
10. death of the Customer.

Section c) does not apply in relation to Consumers. 

The reasons mentioned above under a) to j) include a demonstrative list. The statutory right of both Parties to cancel for an important reason remains unaffected.

Instead of dissolving the contract, the ISP may, if it has retention rights, also withhold its Services (block). Moreover, the ISP may in such cases also halt or block some of its Services. In the cases of sections h) and i), the ISP will trigger the block only to the extent and so long as this is actually required to protect third parties and the ISP’s infrastructure and prevent legal violations.

In case of self-determined or third-party-alleged violations caused by individual contents or information published on hosted websites, the ISP may remove these or block access to them.

In all cases, the ISP will notify the Customer of the measures taken and the reasons for them immediately. The right to a subsequent dissolution of the contract by the ISP for good cause shall remain unaffected.
...
11\. SPECIAL PROVISIONS OF DOMAIN REGISTRATION
----------------------------------------------

### 11.1 BROKERING AND ADMINISTRATION OF THE DOMAIN; CONTRACTUAL RELATIONSHIPS

If agreed upon contract conclusion, domains are subject not just to the ISP’s GTCs but also to the terms and conditions and the guidelines of the registrar. The terms and conditions applicable to the domains of [nic.at](http://nic.at/) are available at [https://www.nic.at/de/agb](https://www.nic.at/de/agb).

If agreed upon contract conclusion, domains which are subject to the coordination of the Internet Corporation for Assigned Names and Numbers ("ICANN", 12025 Waterfront Drive, Suite 300 Los Angeles, CA 90094-2536, [https://www.icann.org/](https://www.icann.org/)) (e.g. the domains ".com", ".net", ".org", ".info" and ".biz"), are also subject to the 'Uniform Domain-Name Dispute-Resolution Policy' of ICANN ("UDRP"), available at

[https://www.icann.org/en/dndr/udrp/policy.htm](https://www.icann.org/en/dndr/udrp/policy.htm).

Rights and obligation of registrants can be found at the following link: [https://www.icann.org/resources/pages/benefits-2013-09-16-en](https://www.icann.org/resources/pages/benefits-2013-09-16-en)

### 11.1.1. No longer available domains

If the domain is no longer available, the ISP will arrange for a return of costs already paid.

### 11.1.2. Special conditions for domains not administered by [**nic.at**](http://nic.at/)

The domains "**.at**", "**.co.at**" and "**.or.at**" are administered by the registrar [nic.at](http://nic.at/). The ISP reserves the requested domain with [nic.at](http://nic.at/) on behalf and on account of the Customer. The ISP is only authorized to give instructions on behalf of the Customer.

### 11.1.3. Special conditions for domains coordinated by ICANN

World4You is a registrar officially accredited by ICANN for the top level domain names ".com" and ".net". If the Customer registers a ".com” or ".net” domain, it agrees to hold harmless the ".com” or ".net” registrar, VeriSign, Inc., 12061 Bluemont Way, Reston, VA 20190, [www.verisign.com](http://www.verisign.com/), and its directors, managers, employees, representatives and subsidiaries, from all claims, damage, liability, costs and expenses, including appropriate solicitors’ fees and expenditure incurred from or in the context of the entered domain owner. This provision does not apply in relation to Consumers.

### 11.2 LEGAL PERMISSIBILITY OF THE DOMAIN

The ISP is not obligated to review the permissibility of the domain, e.g. under trademark or naming law. The Customer warrants that it will observe the applicable legal provisions and, in particular, will not violate anybody’s hallmark rights. In all other cases, section 9. applies.

### 11.3 TERMINATION AND TRANSFER OF A DOMAIN

If the Customer terminates its web hosting contract with the ISP, the ISP will cancel the domain for the Customer. Regardless of whether the web hosting contract with the ISP is terminated, the Customer may transfer its domain to a different provider.

Domains for which [nic.at](http://nic.at/) is the registrar (see section 11.1.1) require a separate Assignment from the Customer to delete the domain. Alternatively, the Customer is given the option to keep its domain and transfer it to another provider. If the Customer does not place an Assignment to either delete or transfer the domain, the ISP is authorised to give instructions regarding the domain which will remain active. As a result, the Customer continues to be liable to make payments.

The Customer can instruct the ISP to transfer existing domains to the ISP. If the transfer fails for reasons which the ISP cannot influence or which are not the ISP’s fault (if these reasons make the transfer technically impossible), the Customer is nevertheless liable to pay the fee for the transfer Assignment. If the Customer places another Order, the Customer must pay the fee again.

12\. SPECIAL PROVISIONS FOR RENTAL SERVERS
------------------------------------------

The Customer does not have access to the server room.

The ISP will provide the Customer with preconfigured hardware. The ISP will maintain the hardware in the same owed, usable conditions as its initial configuration. No maintenance beyond this is owed.
...
The ISP’s contact details are available on the ISP’s website at [https://www.world4you.com/de/impressum](https://www.world4you.com/de/impressum).

* * *

* Services
    * [Webmail](https://webmail.world4you.com/)
    * [Customer Area](https://my.world4you.com/en)
    * [phpMyAdmin](https://mysqlsvradmin.world4you.com/)
    * [Newsletter](https://www.world4you.com/en/newsletter)
    * [Promotions](https://www.world4you.com/en/promotions)
* Products
    * [Your Domain Solutions](https://www.world4you.com/en/domain)
    * [Your Hosting Solutions](https://www.world4you.com/en/hosting)
    * [Your Website-Tool Solutions](https://www.world4you.com/en/website)
    * [Your Mail Solutions](https://www.world4you.com/en/mail)
    * [Your Server Solutions](https://www.world4you.com/en/server)
* Company
    * [About us](https://www.world4you.com/en/company)
    * [Jobs](https://www.world4you.com/en/company/jobs)
    * [Data Center](https://www.world4you.com/en/company/datacenter)
    * [IT security](https://www.world4you.com/en/company/it-security)
...
![Mastercard](https://www.world4you.com/build/images/icons/payment-mastercard.4482d8df.svg "Mastercard") ![Visa](https://www.world4you.com/build/images/icons/payment-visa.209a9307.svg "Visa") ![SEPA](https://www.world4you.com/build/images/icons/payment-sepa.3df5504d.svg "SEPA")

[![Facebook](https://www.world4you.com/build/images/icons/social-facebook.61fc2e9a.svg)](https://www.facebook.com/world4you "To our Facebook page") [![Instagram](https://www.world4you.com/build/images/icons/social-instagram.9dcfc674.svg)](https://www.instagram.com/world4you_at/ "To our Instagram page") [![LinkedIn](https://www.world4you.com/build/images/icons/social-linkedin.aa48daa4.svg)](https://www.linkedin.com/company/world4you/ "To our LinkedIn page") [![TikTok](https://www.world4you.com/build/images/icons/social-tiktok.55b3a5d2.svg)](https://www.tiktok.com/@world4you_at "To our TikTok page")

© 2024 World4You Internet Services GmbH, all prices include 20% VAT.

* [Privacy](https://www.world4you.com/en/company/data-privacy-statement)
* [Terms & Conditions](https://www.world4you.com/en/company/terms-and-conditions)
* [Imprint](https://www.world4you.com/en/company/imprint)
* [Cookie settings](#)
