Privacy Policy of **www.macofalltrades.com**
============================================
...
**Owner contact email:** owner@macofalltrades.com

Types of Data collected
-----------------------

Among the types of Personal Data that this Website collects, by itself or through third parties, there are: first name; last name; phone number; physical address; email address; password; country; state; ZIP/Postal code; city; Trackers; Usage Data; Universally unique identifier (UUID); unique device identifiers for advertising (Google Advertiser ID or IDFA, for example); number of Users; session statistics; province; county; latitude (of city); longitude (of city); metro area; geography/region; IP address; device information; app information; device logs; operating systems; browser information; language; launches; number of sessions; session duration; scroll-to-page interactions; mouse movements; scroll position; keypress events; motion sensor events; touch events; video views; clicks; browsing history; search history; page views; interaction events; page events; custom events; Application opens.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Registration and authentication provided directly by this Website, Advertising, Managing support and contact requests, Commercial affiliation, Remarketing and behavioral targeting, Displaying content from external platforms, Tag Management, Platform services and hosting, User database management, Content performance and features testing (A/B testing), Heat mapping and session recording, Analytics, Managing contacts and sending messages, Hosting and backend infrastructure, Traffic optimization and distribution and Spam and bots protection.
...
* ### Advertising
    ...
    * a Sharing in California
    ...
    #### Rakuten Advertising (Rakuten Marketing LLC)
    
    Rakuten Advertising is an advertising service provided by Rakuten Marketing LLC.
    
    Personal Data processed: Cookies; Universally unique identifier (UUID); Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://rakutenadvertising.com/en-uk/legal-notices/services-privacy-policy/) – [Opt out](https://rakutenadvertising.com/legal-notices/ad-choice-preferences/).
    ...
    * a Sharing in California
    ...
    Similar audiences is an advertising and behavioral targeting service provided by Google LLC that uses Data from Google Ads Remarketing in order to display ads to Users with similar behavior to Users who are already on the remarketing list due to their past use of this Website.  
    On the basis of this Data, personalized ads will be shown to Users suggested by Google Ads Similar audiences.
    
    Users who don't want to be included in Similar audiences can opt out and disable the use of advertising Trackers by going to: Google [Ad Settings](https://adssettings.google.com/authenticated).
    ...
    * a Sharing in California
    ...
    Microsoft Advertising Universal Event Tracking is an analytics service provided by Microsoft Corporation that connects data from the Microsoft Advertising network with actions performed on this Website.
    
    Personal Data processed: Trackers; unique device identifiers for advertising (Google Advertiser ID or IDFA, for example); Universally unique identifier (UUID); Usage Data.
    ...
    * a Sharing in California
    ...
    Clerk.io is an advertising and behavioral targeting service provided by Clerk.io ApS, which provides analytics and allows this Website to display personalized search results, recommendations and content.
    
    Personal Data processed: Trackers.
    
    Place of processing: Denmark – [Privacy Policy](https://clerk.io/privacy).
    ...
    * a Sharing in California
    ...
    LeadsRx is an advertising service provided by LeadsRx, Inc.
    
    Personal Data processed: Trackers; Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://leadsrx.com/privacy).
    ...
    * a Sharing in California
    ...
    Place of processing: United States – [Privacy Policy](https://www.thetradedesk.com/general/privacy-policy) – [Opt out](https://www.adsrvr.org/).
...
* ### Analytics
    ...
    Place of processing: Ireland – [Privacy Policy](https://www.facebook.com/about/privacy/) – [Opt out](https://www.facebook.com/adpreferences/ad_settings).
...
* ### Commercial affiliation
    ...
    #### Rakuten Advertising Affiliate (Rakuten Marketing LLC)
    
    Rakuten Advertising Affiliate is a banner commercial affiliation service provided by Rakuten Marketing LLC.
...
* ### Content performance and features testing (A/B testing)
    ...
    Place of processing: United States – [Privacy Policy](https://www.optimizely.com/privacy/).
...
* ### Hosting and backend infrastructure
    ...
    #### accessiBe accessWidget (accessiBe Ltd.)
    
    accessiBe accessWidget is a service that helps websites to comply with accessibility standards and is provided by accessiBe Ltd.
    
    Personal Data processed: Usage Data.
    
    Place of processing: Israel – [Privacy Policy](https://accessibe.com/privacy-policy).
...
* ### Managing contacts and sending messages
    ...
    Attentive is a message-sending service provided by Attentive Mobile, Inc. Attentive uses the Attentive tag as a Tracker to recognize and track User behavior as well as to manage any User-entered data such as email or telephone numbers.
    
    Personal Data processed: Trackers.
    
    Place of processing: United States – [Privacy Policy](https://www.attentive.com/legal/privacy).
...
* ### Managing support and contact requests
    ...
    #### Reamaze (Lantirn Incorporated)
    
    Reamaze is a support and contact request management service provided by Lantirn Incorporated.  
      
    Personal Data processed: various types of Data as specified in the privacy policy of the service.  
      
    Place of processing: United States – [Privacy Policy](https://www.reamaze.com/privacy). Privacy Shield participant.  
...
* ### Platform services and hosting
    ...
    BigCommerce is a platform provided by BigCommerce, Inc. that allows the Owner to build, run and host an e-commerce website.  
      
    Personal Data processed: various types of Data as specified in the privacy policy of the service.  
      
    Place of processing: United States – [Privacy Policy](https://www.bigcommerce.com/privacy/). Privacy Shield participant.  
...
* ### Registration and authentication provided directly by this Website
    ...
    Personal Data processed: city; country; email address; first name; last name; password; phone number; physical address; state; ZIP/Postal code.
...
* ### Remarketing and behavioral targeting
    ...
    **Users may also opt-out of certain advertising features through applicable device settings, such as the device advertising settings for mobile phones or ads settings in general**.
    ...
    #### Rakuten Advertising Remarketing (Rakuten Marketing LLC)
    
    Rakuten Advertising Remarketing is a remarketing and behavioral targeting service provided by Rakuten Marketing LLC that connects the activity of this Website with the Rakuten advertising network.
    ...
    * a Sharing in California
    ...
    TikTok Remarketing is a remarketing and behavioral targeting service provided by TikTok Inc. that connects the activity of this Website with the TikTok advertising network.
    
    Personal Data processed: Trackers.
    
    Place of processing: United States – [Privacy Policy](https://www.tiktok.com/legal/privacy-policy?lang=en#privacy-us).
...
* ### Tag Management
    ...
    * a Sharing in California
    ...
    Place of processing: United States – [Privacy Policy](https://www.twilio.com/legal/privacy).
...
* ### User database management
    ...
    Smile is a remarketing and behavioral targeting service provided by Smile Inc.  
      
    Personal Data processed: various types of Data as specified in the privacy policy of the service.  
      
    Place of processing: Canada – [Privacy Policy](https://smile.io/privacy-policy).  
...
This Website uses Trackers. To learn more, Users may consult the [Cookie Policy](https://www.iubenda.com/privacy-policy/43926847/cookie-policy "Cookie Policy").
...
* ### Identifiers
    ...
    **Third-parties:** Rakuten Marketing LLC, Microsoft Corporation, Facebook, Inc.
    
    **Service providers or contractors:** this Website, Cloudflare, Inc.
...
* ### Internet or other electronic network activity information
    ...
    **Third-parties:** Meta Platforms, Inc., Rakuten Marketing LLC, Google LLC, Microsoft Corporation, Criteo SA, Facebook, Inc., Twilio, Inc., Optimizely, Inc., Adobe Systems Incorporated, Meta Platforms Ireland Limited, TikTok Inc., The Trade Desk
    
    **Service providers or contractors:** Fonticons, Inc. , Clerk.io ApS, LeadsRx, Inc., this Website, Attentive Mobile, Inc., accessiBe Ltd., Cloudflare, Inc.
...
* ### Geolocation data
    ...
    **Service providers or contractors:** Cloudflare, Inc.
...
[Show the simplified Privacy Policy](https://www.iubenda.com/privacy-policy/43926847 "Show the simplified Privacy Policy")