**Apartment List Terms of Use**
-------------------------------

Last Updated: October 12, 2020 

Welcome to [www.apartmentlist.com](https://www.apartmentlist.com/), as operated by Apartment List, Inc. (“**Company**” or “**we**”). Our website and mobile applications allow companies to list apartments, houses or other real estate for rent or sale and individuals to locate such properties for rent or sale (collectively the "**Service**"). Company makes this Service available to users of the Service subject to these terms of use (the "**Terms**"). These Terms represent a legal contract between you, a user of the Service seeking properties for rent or sale (“**you**”), and Company, regarding your access to and use of the Service. 

1. **Acceptance of the Terms**

**Please read these Terms carefully before you start to use the Service. By using the Service, you accept and agree to be bound and abide by these Terms, our Privacy Policy** **and any additional posted guidelines, rules and terms applicable to specific services, features, and downloadable applications, which may be posted from time to time (collectively, the "Guidelines"). Our Privacy Policy and such Guidelines are incorporated by reference into these Terms.**

**If you do not agree to these Terms, the Privacy Policy or the Guidelines, you must not access or use the Service.** 
...
Please read the [Privacy Policy](https://www.apartmentlist.com/about/privacy) carefully for details relating to what information and data Company collects from you, and how we use that information and disclose it to third parties. 
