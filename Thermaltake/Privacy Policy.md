...
* [Products](#)
    ...
    * [Backpack](https://www.thermaltake.com/products/lifestyle.html)
    * [Racing Simulator Cockpit](https://www.thermaltake.com/products/racing-simulator-cockpit.html)
...
* [Products](#)
    ...
    * [AIO Liquid Cooling](https://www.thermaltake.com/products/aio-liquid-cooling.html)
        ...
        * [Dual Fan Radiator](https://www.thermaltake.com/products/aio-liquid-cooling/dual-radiator-240mm.html)
...
Scope of this Policy Applies
----------------------------

* This Policy applies to the relationship between you and the Website operating organization to regulate the following items related to the collecting, dealing with and use of your personal data: (1) when you have business contacts with us, or participate in every activity that we hold (including but not limited to registry as a Website member, online shopping or participate in every kind of promotion activities like, lucky draw or gifting); or (2) you use our consulting services through telephone, fax or our Web platform for inquiries or recommendations; or (3) any other Website, services or products that show our declarations, has been linked to the declaration.
    
* Any activities regarding personal data protection that by using our Website to link to any Website that a third party managed or operated shall follow the privacy policy of the third party’s or the Website. We will not be responsible for any activities of the third party’s Website.
    

Safety for Personal Data
------------------------

Protection of your person privacy is an important core value of Thermaltake. We will not provide your personal data to any third party who is not related to the services of this Website, unless your consent is obtained or the laws grant us to do that. You shall keep your web password and information about your member account in a proper way and shall not release personal data (especially web password) to any person. Please remember to log off your account after completely using every service provided by our Website and remember to close the browser window if you are sharing a computer with others or using a public computer.

* It will be considered that we have clearly informed the following when members provide personal data to us.
    
* Name of Collector: Thermaltake (address: 5F, 185, Ti-Ding Avenue Sec. 2, Nei-Hu District, Taipei City, Taiwan. Tel: 886-87975788, email:[info@thermaltake.com](mailto:info@thermaltake.com)
    
* Legal basis that we use your personal data
    
    * Consent: You agree that we may use your personal data for one or several particular purposes.
    * Performance of Agreement: We collect and deal with your personal data for the purpose of entering agreement with you or providing services listed in the agreement.
    * Legal Duty: We may use your personal data to do our legal duties.
    
* The type, purpose, territory, target, method and custody period of the personal data we collected are elaborated as follows: 
    
    |     |     |     |     |     |
    | --- | --- | --- | --- | --- |
    | Category of Personal Data | Purpose of Collection | Territory Used | Target and Method used | Period for Custody |
    | Name | ■ performance of agreement or provision of services   <br>■ individual identification   <br>■ related promotion for distribution or advertisement   <br>■ For products or services development purposes | ■ Taiwan, or the country where our subsidiary’s business office is located or any territory that is required to use it for service provision purposes | ■ The targets are Thermaltake and its relevant subsidiaries   <br>■ Any activities that are required to provide your electronic business or perform agreement (such as deliver goods, make payment, inquiry of progress, order cancellation, customer services after sale, management for website or members, etc.)   <br>■ To provide promotion and advisement materials or inform you for joining promotion activities.   <br>■ To check and confirm your identity when you contact us.   <br>■ To conduct related investigation, statistical or research/analysis for our products or services. | ■ During a period, we will keep relevant information subject to the purpose we collected them for, time for dealing with data, starting from your provision of personal data, to the time point below.   <br>(1) termination of the collection purpose or service listed on the left column; or   <br>(2) You expressly asked us to delete. |
    | Address | ■ To perform agreement or provide service   <br>■ For promotion purposes like distribution or advertisement   <br>■ For products or services development purpose | ■ Taiwan, or the country where our subsidiary’s business office is located, or any territory that is required to use it for service provision purposes | ■ The targets are Thermaltake and its relevant subsidiaries   <br>■ Any activities that are required to provide your electronic business or perform agreement (such as deliver goods, make payment, inquiry of progress, order cancellation, customer after sale services, management for websites or members, etc.)   <br>■ To provide promotion and advisement materials or inform you for joining promotion activities.   <br>■ To conduct related investigation, statistical or research/analysis for our products or services | ■ During a certain period, we will keep relevant information subject to the purpose we collected them for, time for dealing with the data, starting from your provision of personal data, to the time point below.   <br>(1) termination of the collection purpose or service listed on the left column; or   <br>(2) You expressly asked us to delete. |
    | Date of Birth | ■ To perform agreement or provide service   <br>■ individual identification   <br>■ For promotion purpose like distribution or advertisement   <br>■ For products or services development purposes | ■ Taiwan, or the country where our subsidiary’s business office is located, or any territory that is required to use it for service provision purposes | ■ The targets are Thermaltake and its relevant subsidiaries   <br>■ Any activities that are required to provide your electronic business or perform agreement (such as deliver goods, make payment, inquiry of progress, order cancellation, customer services after sale, management for website or members, etc.)   <br>■ To check and confirm your identity when you contact us.   <br>■ To conduct related investigation, statistical or research/analysis for our products or services | ■ During a period, we will keep relevant information subject to the purpose we collected them for, time for dealing with data, starting from your provision of personal data, to the time point below.   <br>(1) termination of the collection purposes or service listed on the left column; or   <br>(2) You expressly asked us to delete. |
...
You can also prevent the collection of your data by Google Analytics by clicking on the following link. An opt-out cookie will be set to prevent your data from being collected on future visits to this site: [https://tools.google.com/dlpage/gaoptout?hl=en](https://tools.google.com/dlpage/gaoptout?hl=en)
