...
**10\. Use of cookies and similar technologies.** We use cookies and similar technologies to help personalize your experience by helping save your settings and customizations across visits, and providing you personalized content and advertisements.
...
**15\. Comments and questions.** If you have any comments or questions about this privacy notice, or if you wish to exercise your legal rights with respect to your Personal Data, please contact us at support@overwolf.com.
...
* Website analytics - we use analytics tools ("Tools"), including "Google Analytics" to collect information about the use of the Services over our websites, such as the pages viewed on our websites, referral/exit pages, clicks, scrolling etc. The Tools may collect certain Personal Data, and may link such Personal Data to our databases. We use the information we get from the Tools to improve our Services. Google's ability to use and share information collected by Google Analytics about your visits to this site is restricted by the Google Analytics Terms of Use located at [www.google.com/analytics/terms/us.html](https://www.google.com/analytics/terms/us.html)and the Google Privacy Policy located at [policies.google.com/privacy](https://policies.google.com/privacy). To learn more about opting out of Google Analytics, click [here](https://tools.google.com/dlpage/gaoptout).
...
Third-party service providers only receive data needed to provide their services to us. We require service providers to use data only in order to perform the services we have hired them to do (unless otherwise required by law). We prohibit our service providers from selling data they receive from us or receive on our behalf. For example, we may use a company to provide us a ticketing system for the purpose of customer support. The information they may receive as part of providing that support system cannot be used by them for anything else. For more information about our service providers, please see our [Third-party sub-processors page](https://www.overwolf.com/legal/privacy/third-party-sub-processors).

We use the YouTube API Services to support some of the Services, such as the ability to upload a video from the Overwolf platform and or Third Party Apps. If you choose to use these Services, you will need to grant us permission to access your YouTube account. We will make use of this access strictly to support the related Services. You can manage and revoke this access at any time via the [Google Security Settings](https://myaccount.google.com/permissions?pli=1) page. Please see the [Google Privacy Policy](https://policies.google.com/privacy) for more information about how YouTube and Google process your personal data.
...
To facilitate the delivery of ads within the Services and Third Party Apps, Overwolf uses trusted and well known third-party advertising service providers. For more information about the advertising service providers we work with, please see our [Advertising service providers page](https://www.overwolf.com/legal/privacy/advertising-service-providers).
...
2. Where we use certain service providers, we may use specific contracts approved by the European Commission which give Personal Data the same protection it has in the EEA.
3. Where we use providers based in the US, we may transfer data to them if they have been certified by the EU-US Privacy Shield which requires them to provide similar protection to Personal Data shared between Europe and the US or any other arrangement which has been approved by the European Commission.

Please contact us with the contact information listed below if you would like further information on the specific mechanism used by us when transferring your Personal Data out of the EEA.
...
Detailed information on LiveRamp’s data processing activities is available in LiveRamp’s privacy policy https://liveramp.com/privacy/. You have the right to withdraw your consent or opt-out to the processing of your personal data at any time https://liveramp.com/opt\_out/.
...
If you have any comments or questions about our Privacy Notice please contact us at [support@overwolf.com](mailto:support@overwolf.com).
