...
* [English](https://www.overwolf.com/docs/overwolf/website/terms-of-use)
* [Deutsch](https://www.overwolf.com/de/docs/overwolf/website/terms-of-use)
...
1. AN END USER THAT USES THE OVERWOLF PLATFORMS (AS SUCH TERMS DEFINED WITHIN THE [OVERWOLF PLATFORM TERMS OF USE](https://www.overwolf.com/docs/overwolf/platform/platform-terms-of-use)), OR USING ANY OTHER APPLICATIONS THAT WERE DEVELOPED AND OWNED BY OVERWOLF AND DISTRIBUTED THROUGH OUR PLATFORMS,  YOU WILL BE SUBJECT TO THE APPLICABLE POLICIES AND APPLICABLE TERMS OF USE;
    
2. A DEVELOPER THAT USES THE OVERWOLF DEVELOPER PLATFORMS (AS SUCH TERM IS DEFINED IN THE [OVERWOLF DEVELOPERS TERMS AND CONDITIONS](https://www.overwolf.com/docs/overwolf/developers/developer-terms)), AND THE OVERWOLF SOFTWARE WHICH ENABLES INTEGRATION OF APPS, YOU WILL BE SUBJECT TO THE APPLICABLE POLICIES OF EACH OVERWOLF PLATFORM AND/OR OVERWOLF ELECTRON, AND TO THEIR APPLICABLE TERMS OF USE;
...
1\. AMENDMENTS TO THE TERMS[​](#1-amendments-to-the-terms "Direct link to 1. AMENDMENTS TO THE TERMS")
------------------------------------------------------------------------------------------------------
...
YouTube API We use the YouTube API Services. By using our Services you agree to the [YouTube Terms](https://www.youtube.com/t/terms).

3\. RESTRICTIONS OF USE[​](#3-restrictions-of-use "Direct link to 3. RESTRICTIONS OF USE")
------------------------------------------------------------------------------------------
...
4\. INTELLECTUAL PROPERTY[​](#4-intellectual-property "Direct link to 4. INTELLECTUAL PROPERTY")
------------------------------------------------------------------------------------------------
...
You grant Overwolf a non-exclusive, worldwide, transferable, perpetual, irrevocable right to publish, distribute, publicly display and use the User Content in connection with the Services. “_**User Content**_” shall include any images, data, text, photo, video, and other material that you may submit to the Services. You shall remain the owner of the User Content, and Overwolf does not claim any ownership of the copyright or other proprietary rights in such User Content. Notwithstanding the foregoing, you agree that Overwolf may retain copies of the User Content and use it as reasonably necessary for or incidental to its operation of the Services.

5\. REPRESENTATIONS AND WARRANTIES[​](#5-representations-and-warranties "Direct link to 5. REPRESENTATIONS AND WARRANTIES")
---------------------------------------------------------------------------------------------------------------------------
...
7\. DISCLAIMER AND LIMITATION OF LIABILITIES[​](#7-disclaimer-and-limitation-of-liabilities "Direct link to 7. DISCLAIMER AND LIMITATION OF LIABILITIES")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
8\. INDEMNIFICATION[​](#8-indemnification "Direct link to 8. INDEMNIFICATION")
------------------------------------------------------------------------------
...
9\. TERMINATION[​](#9-termination "Direct link to 9. TERMINATION")
------------------------------------------------------------------
...
10\. JURISDICTION[​](#10-jurisdiction "Direct link to 10. JURISDICTION")
------------------------------------------------------------------------
...
11\. MISCELLANEOUS[​](#11-miscellaneous "Direct link to 11. MISCELLANEOUS")
---------------------------------------------------------------------------
...
12\. CONTACT US[​](#12-contact-us "Direct link to 12. CONTACT US")
------------------------------------------------------------------
...
* [1\. AMENDMENTS TO THE TERMS](#1-amendments-to-the-terms)
* [2\. AMENDMENTS TO THE TERMS](#2-amendments-to-the-terms)
* [3\. RESTRICTIONS OF USE](#3-restrictions-of-use)
* [4\. INTELLECTUAL PROPERTY](#4-intellectual-property)
* [5\. REPRESENTATIONS AND WARRANTIES](#5-representations-and-warranties)
* [7\. DISCLAIMER AND LIMITATION OF LIABILITIES](#7-disclaimer-and-limitation-of-liabilities)
* [8\. INDEMNIFICATION](#8-indemnification)
* [9\. TERMINATION](#9-termination)
* [10\. JURISDICTION](#10-jurisdiction)
