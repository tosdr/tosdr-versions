...
_See the following links for 🇰🇷_[Korean](https://faq.daylio.net/article/89-terms-of-use-ko) _and 🇯🇵_[Japanese](https://faq.daylio.net/article/88-terms-of-use-jp) _translations._
...
This End-User License Agreement ("EULA") constitutes an agreement between you and Daylio (herein referred to as the "Owner") with regard to the Daylio application for Mobile Phones (herein referred to as "Software Product" or "Software"). By installing the Software, you agree to be bound by the terms of this license agreement.
...
6\. PRIVACY AND ADVERTISING. You can find our [Privacy Policy](http://daylio.helpscoutdocs.com/article/15-privacy-policy) on our website or in our application. It is advised that you read them entirely.
...
10\. SUBSCRIPTIONS. Daylio users may access the Software in the following ways:
...
Daylio offers monthly and annual subscription options. For the purposes of our monthly and annual subscriptions, a month constitutes 30 calendar days, and a year constitutes 365 calendar days. 
