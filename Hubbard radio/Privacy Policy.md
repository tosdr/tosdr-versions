[![Hubbard Radio](https://corporate.hubbardradio.com/wp-content/uploads/2013/09/HUBBARDradio_logo-300x96.png)](https://corporate.hubbardradio.com/)
...
**_Additional Information for Residents of California & Virginia_**

Consumers in these states have certain rights with respect to their personal information and data, as described below. We have provided detailed descriptions above in the “How We Collect Personal Information,” “The Types of Personal Information We May Collect From You,” “How We Use Your Personal Information,” and “How We Disclose Personal Information” sections of this Privacy Policy. For purposes of this Section, “Personal Information” is synonymous with “personal data” and generally means information that identifies, relates to, or describes a particular in-scope state resident.
...
| CATEGORY | CATEGORIES OF PARTIES TO WHOM INFORMATION IS DISCLOSED | CATEGORIES OF THIRD PARTIES TO WHOM INFORMATION IS SOLD AND/OR SHARED | PROCESSED FOR TARGETED ADVERTISING |
| --- | --- | --- | --- |
| Identifiers, such as name, IP address, email address, and online and device identifiers. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | Ad partners and advertising technology companies. | Yes |
| Demographic information, including your gender, age, date of birth. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | Ad partners and advertising technology companies. | Yes |
| Audio, electronic, visual information, and other similar information. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), promotional and sweepstakes partners, and business partners.<br><br>Affiliates for purposes of business operations and support. | N/A | N/A |
| Commercial information, such as purchase history, transaction history, and entry information or activity for sweepstakes, contests, or promotions. | Vendors, such as service providers, transaction processors, and law enforcement (if necessary). Promotional partners for our sweepstakes and contests.<br><br>Affiliates for purposes of business operations and support. | **For entry information only:** Ad partners, advertising technology companies, and promotional/sweepstake partners. | **For entry information only:** Yes. |
...
| Commercial information, including financial information. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | N/A | N/A |
| Geolocation, such as non-precise geolocation information, or approximate location as inferred from IP address. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | Ad partners and advertising technology companies. | Yes |
| Other information you may share if you use social features when accessing our Platforms, including the organizations, links, and other information included on your social profile page. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | Ad partners and advertising technology companies. | Yes |
| Inferences, such as those drawn from any of the Personal Information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics. | Vendors, such as cloud service providers (including cloud-based customer service and survey tools we use), payment processors, and business partners.<br><br>Affiliates for purposes of business operations and support. | Ad partners and advertising technology companies. | Yes |
...
_Sources From Which Personal Information Is Collected_

We collect this personal information directly from California and Virginia residents themselves, as well as from social media platforms (e.g., if the individual has connected a social media account to our website); referrals; joint marketing, co-branding, co-promotional, or advertising partners; and sources of demographic and other information, including through devices you used to interact with us through our Platforms. All sources of personal information collected are noted in the “How We Collect Personal Information” and “The Types of Personal Information We May Collect From You” sections above.

_Business or Commercial Purposes for Which Personal Information Is Collected_

Your Personal Information is used for the following purposes:

* To operate, manage, and maintain our Platforms;
* To provide our Platforms;
* To accomplish our business purposes and objectives, including to:
    ...
    * Develop, improve, repair, and maintain our Platforms;
    ...
    * Advertise and market our Platforms;
    * Run and administer our promotions and contests;
...
**_Your Privacy Rights Under Applicable State Law_**

If you are a resident of California or Virginia, you may have the following rights with respect to any information about you that constitutes “personal information” under California law and “personal data” under other state laws, as described below.
...
* **Opt Out of “Sale” and Certain Sharing Practices:** Depending on the state you reside in, you will have the right to opt out of the sale of your data, the disclosure of your data for cross-context behavioral advertising/targeted advertising (known as a “share” in California), and profiling in furtherance of solely automatized decisions that produce legal or similarly significant effects. In order for you or your authorized agent to exercise this right, please visit our “[Do Not Sell or Share My Personal Information](https://corporate.hubbardradio.com/data-request/)” page.
...
* **Right to Appeal:** If you are a Virginia resident and receive a denial of a personal data rights request, you have the right to request an appeal.

_To Exercise Rights:_

In order to exercise your right to opt out of the sale or sharing of your personal information, please visit our “[Do Not Sell or Share My Personal Information](https://corporate.hubbardradio.com/data-request/)” page.
...
California residents may use an authorized agent on their behalf to exercise a privacy right discussed above. If you are an authorized agent acting on behalf of a California resident to communicate with us or to exercise a privacy right discussed above, you must be able to demonstrate that you have the requisite authorization to act on behalf of the resident and have sufficient access to their laptop, desktop, or mobile device to exercise these rights digitally. If you are an authorized agent trying to exercise rights on behalf of a Hubbard user, please contact us at the contact information below with supporting verification information, which includes proof that you have access to the consumer’s interface and proof of your own identify.
