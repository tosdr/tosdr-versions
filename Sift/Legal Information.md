...
* Why Sift
    ...
    * [EXPLORE WHY](https://sift.com/legal-and-compliance/service-privacy-notice#)
    ...
    * [EVEN MORE](https://sift.com/legal-and-compliance/service-privacy-notice#)
...
* Resources
    ...
    * [BY TOPIC](https://sift.com/legal-and-compliance/service-privacy-notice#)
...
Previous Service Privacy Notice available [here.](https://sift.com/legal-and-compliance/service-privacy-notice-june-2023)
...
Please note that this Notice does not describe our collection and use of personal information when visitors access our website. For information about how we collect and use information via our website ([www.sift.com](https://sift.com/) and its subdomains), please see our [Website Privacy Notice.](https://sift.com/legal-and-compliance/website-privacy-notice)

Additionally, if you are an Authorized User and a resident of California, Colorado, Connecticut, Delaware, Florida, Iowa, Montana, New Hampshire, New Jersey, Oregon, Tennessee, Texas, Utah or Virginia, please also review our [Supplemental U.S. State Law Privacy Notice.](https://sift.com/legal-and-compliance/supplemental-us-state-law-privacy)
...
* [PART I. GENERAL INFORMATION AND KEY TERMS](https://sift.com/legal-and-compliance/service-privacy-notice#general-information)
    
    * [Who we are](https://sift.com/legal-and-compliance/service-privacy-notice#who-we-are)
        
    * [How the Sift Services work](https://sift.com/legal-and-compliance/service-privacy-notice#how-the-sift-services-work)
        
* [PART II. WHAT WE COLLECT AND HOW WE USE IT](https://sift.com/legal-and-compliance/service-privacy-notice#what-we-collect)
    
    * [(A) END USERS](https://sift.com/legal-and-compliance/service-privacy-notice#end-users)
        
        * [Information We Collect About End Users](https://sift.com/legal-and-compliance/service-privacy-notice#info-we-collect)
            
        * [How We Use End User Information and the Legal Bases](https://sift.com/legal-and-compliance/service-privacy-notice#legal-bases)
            
        * [How We Use Tracking Technologies to Collect Information about End Users](https://sift.com/legal-and-compliance/service-privacy-notice#tracking-tech)
            
        * [Automated Decision-Making and Profiling](https://sift.com/legal-and-compliance/service-privacy-notice#automated)
            
    
    * [(B) AUTHORIZED USERS](https://sift.com/legal-and-compliance/service-privacy-notice#authorized-users)
        
        * [Information We Collect About Authorized Users](https://sift.com/legal-and-compliance/service-privacy-notice#info-authorized-users)
            
        * [How We Use Authorized Users Information and the Legal Bases](https://sift.com/legal-and-compliance/service-privacy-notice#how-we-use-info)
            
    
    * [(C) SHARING INFORMATION WITH THIRD PARTIES](https://sift.com/legal-and-compliance/service-privacy-notice#sharing-information)
        
* [PART III. INTERNATIONAL TRANSFERS, AND DATA RETENTION](https://sift.com/legal-and-compliance/service-privacy-notice#international-transfers)
    
    * [Processing of personal information in the US and other territories](https://sift.com/legal-and-compliance/service-privacy-notice#processing-personal)
        
    * [European data transfers](https://sift.com/legal-and-compliance/service-privacy-notice#european-data-transfers)
        
* [PART IV. YOUR PRIVACY RIGHTS](https://sift.com/legal-and-compliance/service-privacy-notice#your-privacy-rights)
    
    * [European Privacy Rights: EEA, UK and Switzerland](#european-privacy-rights)
        
    * [Access, correct or delete your information (European privacy rights: for EEA, UK and Switzerland)](#European-privacy-rights) 
        
    * [U.S. State Law Rights](https://sift.com/legal-and-compliance/service-privacy-notice#us-state-law-rights-ca-va)
        
    * [Unsubscribe from our mailing list](https://sift.com/legal-and-compliance/service-privacy-notice#unsubscribe-from-mailing-list)
        
* [PART V. OTHER IMPORTANT INFORMATION](https://sift.com/legal-and-compliance/service-privacy-notice#other-important-information)
    
    * [Security safeguards](https://sift.com/legal-and-compliance/service-privacy-notice#security-safeguards)
        
    * [Data retention](https://sift.com/legal-and-compliance/service-privacy-notice#data-retention)
        
    * [Changes to this Notice](https://sift.com/legal-and-compliance/service-privacy-notice#changes-to-this-notice)
        
* [PART VI. HOW TO CONTACT US](https://sift.com/legal-and-compliance/service-privacy-notice#contact)
    
    * [Contact details](https://sift.com/legal-and-compliance/service-privacy-notice#contact-details)
        
    * [Controller Information, Data Protection Officer, and EU Representative](https://sift.com/legal-and-compliance/service-privacy-notice#controller-status)
        
    * [Further Privacy Resources](https://sift.com/legal-and-compliance/service-privacy-notice#further)
...
If you have questions about or need further information concerning the legal basis on which we collect and use your personal information, including any legitimate interests relied upon, please contact us as provided under the [How to contact us](https://sift.com/legal-and-compliance/service-privacy-notice#contact) section at the end of this Notice.

### How We Use Tracking Technologies to Collect Information about End Users

We use standard tracking technologies to automatically collect certain information (as described in the [Information We Collect About End Users](https://sift.com/legal-and-compliance/service-privacy-notice#info-we-collect) section) from your device and/or browser when you visit or interact with Customer Sites.
...
Sift employs profiling techniques to detect and prevent fraud, security threats and other illegal or malicious behavior on Customer Sites. This includes collecting and analyzing information about End User interactions and behavior to return fraud scores to our Customers for particular events or activities and win rates for particular chargeback disputes. This also includes using Customer Data to train Sift’s global models that understand fraud patterns across the network of customers, and custom models that are tailored to specific customer businesses. As a result, profiling not only assists with immediate fraud prevention but plays a crucial role in the development and improvement of Sift’s fraud detection systems, including to ensure the ongoing accuracy and integrity of our models and algorithms.

Automated decision-making refers to decisions that are made automatically on the basis of computer determinations (using software algorithms), without human review or intervention, and that result in legal or significant effects. While the services we provide to our Customers do not generally involve automated decision-making, there are limited circumstances where a Customer’s use of the Sift Services may result in such decisions being made by our Customers about an action you have taken on a Customer Site. For example, the Customer may use the analysis we provide them to automatically pause the completion of an activity or transaction based on rules the Customer has set or to automatically challenge a particular chargeback. In such instances, you may be required to take further steps (e.g., two factor authentication), you may potentially be unable to complete a transaction, or your chargeback may be disputed by the Customer. Similarly, the Customer may use the analysis we provide them to challenge a particular chargeback. In such instances, you may be required to take further steps (e.g., two factor authentication), you may potentially be unable to complete a transaction, or your chargeback may be disputed by the Customer.

Our Customers decide how to use the scores that we provide them. They set and control the thresholds for any automated actions, which may depend on factors like the Customer’s industry, business objectives and risk tolerance. By providing insights to Customers, our aim is to empower them to make informed decisions. If you want to learn more about how a business you interact with uses Sift, or want to contest a decision that’s been made by a business that uses Sift, we encourage you to reach out to that online business to assist you.
...
Depending on your location, you may have the right to access, request correction or deletion of any personal information that we process about you, as provided under applicable data protection laws. You can send an email to [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection) or use our [web form](https://sift.com/data-request) to exercise these rights.
...
Please note that, in certain circumstances, your ability to access or control your personal information may be limited, as required or permitted by applicable laws. For example, Sift may be required by law to retain and continue processing your personal information after a deletion request, for example where such processing is necessary to maintain the accuracy and integrity of our models and algorithms so that we can more effectively detect fraudulent behaviors or assist with chargeback disputes within the permissible timeframe.

### European Privacy Rights: EEA, UK and Switzerland

**Access, correction and deletion**: You have the right to obtain information about the processing of your personal information, including automated decision-making and profiling, and to receive a copy of your personal information. You may also request correction or deletion of any personal information that we process about you. You can send an email to [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection) or use our web form to exercise these rights. As explained above, in certain circumstances, exceptions may apply to these rights as required or permitted under applicable laws. For example, Sift may retain your personal information after a deletion request to ensure the accuracy and integrity of our models and algorithms or to assist with chargeback disputes within the permissible timeframe.

**Objection to processing, rectification and portability**: You have the right to object to the processing of your personal information, ask us to restrict the processing of your personal information, request manual review of automated decisions , or request portability of your personal information. To exercise these rights, please email [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection) or submit a request via our [web form](https://sift.com/data-request). Again, exceptions may apply to these rights as required or permitted under applicable laws. For example, Sift may continue to process your personal information after an objection request to ensure the accuracy and integrity of our models and algorithms.

**Withdrawal of consent**: If we have collected and process your personal information with your consent, then you can withdraw your consent at any time. Withdrawing your consent will not affect the lawfulness of any processing we conducted prior to your withdrawal, nor will it affect processing of your personal information conducted in reliance on lawful processing grounds other than consent. To withdraw your consent to any processing, please  email [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection) or submit a request via our [web form](https://sift.com/data-request).

**Right to complain to a data protection authority:** You have the right to complain to a data protection authority about our collection and use of your personal information. For more information, please contact your local data protection authority. Contact details for data protection authorities in the EEA and UK are available [here](https://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm) and Switzerland are [here](https://www.edoeb.admin.ch/edoeb/en/home/the-fdpic/links/data-protection---switzerland.html).
...
Email: [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection)
...
You may contact our Data Protection Officer by emailing [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection) or using the mailing address listed in the Contact Details section above. Our EU representative (for EEA, UK or Swiss data subjects) is:

Sift Science Ireland Limited  
by email: [\[email protected\]](https://sift.com/cdn-cgi/l/email-protection)  
...
_[Website Privacy Notice](https://sift.com/legal-and-compliance/website-privacy-notice)_  
_[Supplemental U.S. State Law Privacy Notice](https://sift.com/legal-and-compliance/supplemental-us-state-law-privacy)_  
_[Website Cookie Notice](https://sift.com/legal-and-compliance/website-cookie-notice)_  
_[Data Rights Request](https://sift.com/data-request)_  
_[Do Not Sell My Personal Information](https://pages.sift.com/cpra-opt-out.html?_gl=1*q171n7*_ga*MzY4ODc5MDYuMTcwMzAyNDk5OA..*_ga_R8SV2EK5NZ*MTcxMTQ5MTA0Ni4yNC4wLjE3MTE0OTEwOTUuMC4wLjA.)_
