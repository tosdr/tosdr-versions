...
At China Global Television Network (together, “CGTN” or “we”, “us”, or “our”)，it is important to us that your personal data is protected at all times. Therefore, we have established CGTN's Privacy Policy in accordance with the provisions of the General Data Protection Regulation (GDPR) of the European Union, the California Consumer Privacy Act (CCPA), the Personal Information Protection Law (PIPL) of the People's Republic of China, and other laws and regulations, and using security measures to protect your personal data.

This Privacy Policy applies to CGTN English channels [https://www.cgtn.com/](https://www.cgtn.com/) , the data collection and processing implemented, and the use of our related products and services.

Our Privacy Policy covers how we process and access your data when you log in and use our services worldwide.
...
This Privacy Policy may be modified in order to accommodate current laws and regulations in effect. Modifications will be notified by means of an online posting for the latest version currently in effect.

We are aware of the importance of personal data to you and will treat your personal data with care. We strive to create and maintain a trusting relationship with you and to protect your personal data by adhering to the following principles: lawfulness, fairness, transparency, purpose limitation, minimum necessary, accuracy, integrity and confidentiality, consistency of rights and responsibilities, and security. At the same time, we are committed to taking appropriate security measures to fully protect your personal data in accordance with proven industry security standards.

**Before using CGTN products and services and submitting your personal data, please read this Privacy Policy carefully and make sure that you fully understand and agree to it before using it, and that you are fully aware of and understand the meaning of its contents and the corresponding legal consequences. By signing, or clicking "read", "agree" or other similar options, and submitting your personal data to us, you are deemed to have accepted this Privacy Policy.**
...
In particular, we identify in bold type or other reasonable manner the terms that are (potentially) materially related to your rights and interests, and you should focus on reading them. If you have any questions, comments or suggestions regarding this Privacy Policy, please feel free to contact us through Section IX of this Privacy Policy.

This policy will help you understand the following.

I. How we collect and use your personal data  
II. How we provide, disclose and store your personal data  
III. How we protect your personal data  
IV. Your rights  
V. How we process children's personal data  
VI. How your personal data is transferred worldwide  
VII. The use of cookies and similar technologies  
VIII. How to update this policy  
IX. How to contact us

I. How we collect and use your personal data

Personal Data: means any data that refers to an identified or identifiable natural person ("Data Subject"). This identifiable natural person can be identified directly or indirectly, in particular by reference to such identifiers as name, **ID number, location data,** online identification, or by reference to one or more elements of the natural person's physical, physiological, genetic, psychological, economic, cultural or social identity.

Special types of personal data: are personal data that **reveal racial or ethnic origin, political opinions, religious or philosophical beliefs, trade union membership**, as well as **genetic data, biometric data for the purpose of uniquely identifying a natural person, health, sexual life or sexual orientation of a natural person**. In this Privacy Policy, the provisions concerning special types of personal data are marked in bold font to draw your special attention to them. In the case of actual collection of special personal data, we will obtain your separate consent.

We collect and use your personal data in compliance with the GDPR, the CCPA and PIPL. We will collect and use your personal data for the purposes described below in this Privacy Policy. We do not perform automated decision-making based on the personal data we collect from you.

Unless otherwise stated in this Privacy Policy or required by law or regulation, when we need to use personal data for purposes other than those set out in this Privacy Policy, we will inform you in advance and ask for your consent through pop-ups, etc. Refusing to agree to this Privacy Policy will not prevent you from using our website, however, doing so may prevent us from recommending news and videos to you. If you use CGTN's services without registering or logging in, we will provide you with browsing-only services in visitor mode. We will only be able to provide you with some of the features in visitor mode, and we will collect your cookies, IP, and device information in order to ensure that the features are available.

**i. When you are using CGTN products and services, we will collect your personal data in the following cases.**

| Function/Scene | Type | Purpose |
| --- | --- | --- | --- |
...
2\. In addition, when you contact us via e-mail, we collect the following types of personal data.
...
(4) Other data that you may disclose in your emails

We do not collect special kinds of personal data about you, such as data about your race, political opinions, religion, unless you voluntarily provide it to us.

3\. The purposes and types of personal data we may collect from you when you visit the CGTN website or when you are not registered to log in to the CGTN website and agree to our privacy policy.
...
(3) We may collect data about you, including but not limited to

* Web logs
    * ① Site search content input content and search results
    * ② IP address
    * ③ Language used
    * ④ Date and time of access to the service
    * ⑤ Cookie (see detailed data in the Cookie Policy)
* Device or application data: such as that provided by the mobile device you are using, your browser, or other programs used to access CGTN.
    * ① Configuration data
    * ② Device version number
* Location data: When you turn on the device location function and use the services provided based on location, we use various data for location after obtaining your consent.
    * ① IP address
    * ② and other sensor data that can provide location data
* In order to provide you with better services and improve your user experience, CGTN may also record.
    * ① Operating system version number

4\. When you use the product through mobile devices (non-APP), we may call your acceleration sensor, orientation sensor, gravity sensor permissions, detect the screen direction change, video playback horizontal firm screen switch heart. Through your sensor information (individual sensor information is not personal information) to provide you with the corresponding business functions. Please be aware that individual device sensor information does not involve any person's location information and cannot be combined with other information to identify an individual.

**ii. We will not obtain your authorized consent for the collection and use of your data in the following cases.**

1\. With the performance of obligations or duties under the laws and regulations
...
5\. For the purpose of safeguarding the life, property and other significant legitimate rights and interests of the data subject or other individuals but for which it is difficult to obtain their authorized consent

6\. Where the personal data involved are disclosed to the public by the data subject himself/herself

7\. Necessary for the conclusion and performance of a contract at the request of the data subject

8\. Where the personal data is collected from lawful public disclosures, such as lawful news reports, government data disclosure and other sources

9\. Necessary to maintain the safe and stable operation of the products or services provided, such as the detection and disposal of product or service failures

10\. Necessary to carry out statistical or academic research in the public interest and to take specific measures to protect the rights and interests of data subjects.

11\. Other circumstances specified by laws and administrative regulations.

II. How we provide, disclose and store your personal data

**i. Provision**

We will not provide your personal data to any company, organization or individual, except for the following.

1\. Provided under the condition of obtaining separate consent. After obtaining your separate consent, we will provide your personal data to other parties.
...
2\. Disclosure based on law: We may disclose your personal data when compelled to do so by law, legal proceedings, litigation or government authorities.

**iii.Storage**

1\. We store all personal data we collect on our servers in accordance with legal and regulatory requirements. At the same time, we store the personal data we collect securely in accordance with laws and regulations and the most advanced network security practices.

2.We will only store personal data for as long as is necessary to achieve the purposes of processing or to fulfil our contractual or legal obligations. No longer than is necessary for the processing of personal data will be stored, unless a longer period is required by law, regulation or procedural purposes. However, it will be stored for a longer period of time when the technical and organizational measures required by law are met and when it is processed only for purposes of public interest, scientific or historical research and for statistical purposes.

3\. After the expiration of the retention period, your personal data will be deleted from the system or anonymized.

4\. For countries with localized storage requirements, we will actively communicate with your country or region to achieve localized storage together.
...
**i. Access, review and copy your personal data**
...
You can send us an email to cgtn@cgtn.com to inquire about your personal data. We will respond to your request no later than one month after verification.
...
If you are unable to cancel your CGTN account by the above means, you may send an email to cgtn@cgtn.com. We will respond to your request no later than one month after verification.
...
If you are unable to correct such personal data by the above means, you may send an email to cgtn@cgtn.com. We will respond to your request no later than one month after verification.

**iv. You may restrict our processing of your personal data in the following circumstances.**
...
You have the right to object to the processing of your personal data if it is necessary for us to pursue our legitimate interests; if it is carried out in the public interest or to perform a task based on official authority, or if there are reasons related to your particular situation. You can exercise your rights by sending an e-mail.

**vi. Responding to your request above and complaints**
...
**vii. California residents have the following specific legal rights.**

Under California law, including the California Consumer Privacy Act (California Civil Code 1798.100), if you are a California resident, you may contact us regarding the following rights with respect to personal data about you.

Right of Access: You have the right to request access twice a year to the personal information we have collected about you in the past 12 months.

Right to erasure: You have the right to request that we delete your personal information. For specific legal reasons, there may be exceptions to the right to erasure, and if applicable, we will list them for you upon your request.

Right to opt-in/opt-out of the sale of personal data: For individuals aged 16 or over, you have the right to opt-out of the sale of your personal data that we may hold to third parties. For individuals between the ages of 13 and 16, you have the right to opt-in to the sale of personal data we may hold about you. However, CGTN will not "sell" any of your personal data.

Exercising your rights: If you wish to exercise any of your privacy rights or have any questions about how we use your personal data, please contact us at cgtn@cgtn.com.

**viii. We will not be able to respond to your request in the following circumstances.**
...
**ix. California residents have the following specific legal rights:**

Under California law, including the California Consumer Privacy Act (California Civil Code 1798.100), if you are a California resident, you may contact us regarding the following rights regarding your personal data:

Right of Access: You have the right to request, twice a year, access to the personal information we have collected about you within the last 12 months.

Right to erasure: You have the right to request that we delete your personal information. There may be exceptions to the right to erasure for specific legal reasons, and if applicable, we will list them for you at your request.

Right to opt-in/opt-out of the sale of personal data: For individuals aged 16 or over, you have the right to opt-out of the sale of your personal data that we may hold to third parties. For individuals between the ages of 13 and 16, you have the right to opt out of the sale of your personal data that we may hold. However, CGTN will not "sell" any of your personal data.

Exercising your rights: If you wish to exercise any of your privacy rights or if you have any questions about how we use your personal data, please contact us at cgtn@cgtn.com.

**x. Change the scope of your authorized consent.**
...
V. How we process personal data of children
...
**i. When you visit our website, your cookies are collected and processed by us and by Google Analytics on our behalf.**
...
**iii.** When you visit our website, we will send a cookie to your device and send it to Google and our servers. We will not use cookies for purposes other than those described in this Privacy Policy.

**iv.** You can change your web browser settings to opt out of our cookies and the browser you can use to perform this action. You can delete all existing cookies on your device by clearing your browser's browsing history, which will delete all cookies from all websites you have visited. please note that you may also lose some saved data. Since most web browsers include the ability to manage cookies, you can change your web browser settings to opt out of our cookies at any time. you can do this for depending on your browser type as follows.
...
**v. We collect your cookie data and its purpose.**

| Cookie | Type | Purpose |
| --- | --- | --- |
| Universal Analytics (Google) | AMP\_TOKEN  <br>IDE  <br>\_\_auc  <br>\_ga  <br>\_gat\_newsTracker  <br>\_gat\_webTracker  <br>\_gid | Those cookies are used to collect information about your use of our website. We use them to estimate the number of visitors on our website as well as the pages they visit. We then use such information to improve our website and its content. To know more about how Google through Google Analytics process your data, you can visit their presentation on how Privacy works with their services. |
...
**i. China Global Television Network**

E-mail: cgtn@cgtn.com

Address: No. A1, Guanghua Road, Chaoyang District, Beijing, People's Republic of China

Postal code: 100026

**ii. China Global Television Network EU Representative**
