[STSpaceTraders API](https://spacetraders.io/)

[Changelog](https://spacetraders.io/docs/changelog)[Github](https://github.com/SpaceTradersAPI)[Discord](https://discord.com/invite/jh6zurdWk5)[API Docs](https://api.spacetraders.io/)
...
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Artocom, LLC, 414 Morrison St, San Diego CA 92102.
...
* **Facebook Fan Page** is a public profile named SpaceTraders API specifically created by the Company on the Facebook social network, accessible from [https://www.facebook.com/SpaceTradersAPI/](https://www.facebook.com/SpaceTradersAPI/)
...
* **Website** refers to SpaceTraders API, accessible from [https://spacetraders.io](https://spacetraders.io/)
...
The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page [https://www.facebook.com/SpaceTradersAPI/](https://www.facebook.com/SpaceTradersAPI/), the Company and the operator of the social network Facebook are Joint Controllers.
...
* By email: [admin@spacetraders.io](mailto:admin@spacetraders.io)
...
[Privacy](https://spacetraders.io/privacy-policy)

[Terms and Conditions](https://spacetraders.io/terms-and-conditions)

[Cookies Policy](https://spacetraders.io/cookies-policy)

[EULA](https://spacetraders.io/eula)

© 2023 SpaceTraders. All rights reserved.