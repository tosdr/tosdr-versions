...
Welcome to GOLO. Through our golo.com website (“**Website**”) we provide products, services, and information (collectively, the “**Services**”). The Website is owned and operated by GOLO, LLC (“**GOLO**”, “**we**”, “**us**” or “**our**”).

Your use of our Website, and the purchase of our products (“**Products**”), including but not limited to the GOLO® Metabolic Plan, Release® dietary supplement, Superfood Essentials Kit, and the AeroTrainer® exercise platform, and our Services (whether through our Website, GOLO mobile app (“**Mobile App**”) phone, or other method) are governed by these Terms of Sale and Use, and by our privacy policy (as modified from time to time and which may be found [on our website's privacy policy page here](https://www.golo.com/pages/privacy-policy), and which is incorporated by reference herein) (“**Privacy Policy**”) (collectively, these “**Terms**”). Your use of our Mobile App is additionally governed by our End User License Agreement (“**EULA**”), which is incorporated by reference herein, and which must be agreed to prior to installation on a mobile device. References to “**User**”, “**Customer**”, “**you**” or “**your**” mean you as a casual visitor, someone who has created a user account for receiving information from us, or as a customer. The Terms apply to you as applicable to the type of user you are.
...
At GOLO, our goal is 100% customer satisfaction. We take pride in providing exceptional customer service and support. In the event you have a problem with your order, it is our objective to make sure you are satisfied. If you have any issues with your order, please contact out knowledgeable Customer Support team to resolve your issue. GOLO's Customer Support team is available Mon – Fri 9am-5:30pm Eastern Time, to assist you with any questions. You can reach our Customer Support team by calling 1-800-730-GOLO (4656) and selecting Option 2, or via email at support@golo.com. Please note: Our Customer Support representatives are not trained medical professionals and therefore cannot provide medical advice.

**Shipping Policy**

**Supplements & Fitness products:**

GOLO ships orders of supplements & fitness products to addresses in the United States (its territories) and Canada only. We ship all orders within 1-4 business days.
...
GOLO ships orders of non-perishable food products to addresses in the United States and its territories only. We cannot ship food products to Canada. We ship all orders within 1-4 business days.
...
GOLO ships perishable GOLO Foods orders to addresses in the 48 contiguous US states only. We cannot ship these items to Alaska, Hawaii, US territories or Canada.

Orders are shipped within 1-5 days of order date and will arrive within 1-2 days of ship date. Orders are shipped via DHL, USPS, UPS, FEDEX or other comparable shippers. All shipments can be tracked online. Tracking instructions will be provided in your shipping confirmation email.
...
We offer to our customers GOLO support services related to the GOLO for Life Plan and their experience with it. You can reach Customer Support at 1-800-730-4656 or sending an email to support@golo.com. We have the right at our sole discretion to refuse to accept a customer for support services, or to discontinue services for any reason. We encourage feedback regarding our support services you may submit your comments by emailing us at support@golo.com.  GOLO -support services are subject to GOLO’s Health Disclaimer, which is set forth below.  Please see that section for further details.

**Telephone Calls and Call Recording:**

When you place an order with GOLO, you will be asked to provide us with a telephone number where we can reach you. Your telephone number is required so that GOLO can reach you with informational calls related to your orders. All calls to and from GOLO may be monitored or recorded.
...
GOLO may offers its customers the use of third-party payment solution providers, such as Buy Now Pay Later via PayPal, and such third-party payment providers are not otherwise associated with GOLO.  You agree to and do hereby release GOLO from any liability for actions or conduct of these third-party payment vendors.  You further agree to hold GOLO harmless for any liability to GOLO as result of your use of such third-party payment vendor.
...
Use of Buy Now Pay Later via PayPal is subject to Buy Now Pay Later via PayPal’s terms and conditions and privacy policy.  To learn more about Buy Now Pay Later via PayPal, [click here](https://www.paypal.com/us/digital-wallet/ways-to-pay/buy-now-pay-later "See details on Pay later with PayPal via the PayPal website").

Buy Now Pay Later via PayPal is a third-party payment solution provider and is not associated with GOLO.  If you need assistance with the payment plan option after your purchase, contact Buy Now Pay Later via PayPal directly using the information provided at the time of purchase.
...
**AeroTrainer One Year Limited Warranty:**

We warrant that the AeroTrainer® exercise platform product will be free from material defects in workmanship (the “AeroTrainer Limited Warranty”) for a period of one (1) year from the date of shipment to you (the “AeroTrainer Limited Warranty Period”). We shall have no obligation with respect to a warranty claim unless notified of such claim within the AeroTrainer Limited Warranty Period. The AeroTrainer Limited Warranty does not extend, and shall not apply, to any defects in the product resulting in whole or in part from accident, neglect, abuse or misuse, willful damage, misconduct, recklessness, negligence, or any alteration, modification or repair to the product by anyone other than us or use of the product for purposes other than those intended by GOLO as described in the product documentation. Damage to or failure of the product caused in whole or in part by use of non-GOLO supplied or non-GOLO approved repair or replacement parts will not be covered by this warranty.
...
GOLO guarantees the quality of our products and that you will receive your order in good condition. Since the GOLO Foods products are perishable, GOLO cannot accept returned food products or offer refunds. If your order arrives damaged, or is incorrect, GOLO will be happy to send a replacement order.  If your order is damaged or incorrect, please call GOLO at 800-730-4656 or email us at support@golo.com within five (5) days of the date you received your order.  GOLO may require you to provide photographic evidence or documentation for damaged or incorrect orders before any replacement is issued.

**Non-perishable Food Products** 

GOLO offers two (2) options in order to obtain a refund for one of our non-perishable food products :

1. GOLO Store Credit - If you choose this option, we will email you a credit equal to the value of the purchased item (see price list below). The credit can be used toward the purchase of any GOLO item online or ordered via telephone with Customer Service and is valid for 3 years from the issue date.
2. Donate - If you choose this option, simply donate the item(s) to your local food bank (or any other entity that accepts food donations) and obtain a receipt. Email the receipt to support@golo.com along with your order number. Once received, we will issue a full refund to your original form of payment. Find your local food bank [offsite on the Feeding America website here](https://www.feedingamerica.org/find-your-local-foodbank)
...
In order to receive a full refund when returning a product to GOLO, all items must be complete.  For example, if you are returning a GOLO® For Life Plan, all booklets must be included in your return along with any remaining supplements or if you are returning. If your return package is missing items, you still may receive a partial refund. However, if nothing is returned, a refund will not be issued. Your return must be postmarked within the time allotted on the return authorization instructions that are issued to you. Once a return is requested, your account will be deactivated, and you will no longer be able to access your GOLO account.
...
Click [on our website's SMS terms page here](https://www.golo.com/pages/sms-terms "Link to SMS Terms of Service on our website") for our SMS Terms of Service, which are incorporated by reference herein, and which we amend from time to time.

**Becoming a Registered User:**

When you create an account on our websites, you agree to provide accurate and complete information about yourself. GOLO, LLC has the right to suspend or terminate your account if you are suspected of providing false or misleading information. The responsibility for maintaining the confidentially of your account is yours. GOLO is not liable or responsible for any loss or damage that may arise from any unauthorized use, access, or any other breach of security of your Account.

**myGOLO.com Membership:**

In order to register to become a member of GOLO, you must do so in accordance with instructions throughout this Website. If you elect to become a registered user of GOLO's Website, you agree to provide us with true and accurate information about yourself. Without limiting any other provision of these Terms & Conditions you further agree not to register for more than one account or create a false or misleading identity on this Website. When you become a member, GOLO will send emails regarding news, product information, and offers. You may opt out of these by selecting opt out under your account setup, selecting opt out on any electronic communication, calling customer service at 1­-800­-730­-GOLO (4656), or emailing us at support@golo.com. The GOLO membership is subject to change as the business determines necessary.
...
In order to become a member and have full access to our Website, you will need to purchase a GOLO Metabolic Plan and provide an email address and create a secure password.
...
Contact Us. Our contact information is GOLO, LLC, 4051 Ogletown Stanton Road, Third Floor, Newark, DE 19713, Attn: Customer Support; Email: [support@golo.com](mailto:support@golo.com); or Phone: 1-800-730-GOLO (4656). You may also visit our “Contact Us” website page at [https://www.golo.com/pages/contacts](https://www.golo.com/pages/contacts).

[Return to the homepage](https://www.golo.com/ "Home")
