...
![](https://m-img.org/spai/q_lossless+ret_img+to_webp/matomo.org/wp-content/uploads/2020/03/matomo-logo-winner-mobile3.png)](https://matomo.org/)
...
* [![](data:image/svg+xml;base64,)
    ...
    ![](https://m-img.org/spai/q_lossless+ret_img+to_webp/matomo.org/wp-content/uploads/2018/10/matomo-logo-final-1-170x25.png)](https://matomo.org/)
* Why Matomo?
...
* [Log in](https://matomo.org/login)[Help](https://matomo.org/help/?header)[TRY IT FOR FREE](https://matomo.org/start-free-analytics-trial/)
*  
...
[API Terms](#api)  
[Payment, Refunds, Upgrading and Downgrading Terms](#payment)  
[Cancellation and Termination](#cancellation)  
[Modifications to the Service and Prices](#modification)  
[Copyright and Content Ownership](#copyright)  
[Privacy and security of your data](#privacy)  
...
3. In the event the usage of Hits exceeds the Service plan you selected during a term, the Company will charge additional overage fees and the Customer shall be obligated to pay any overage fees in the next term. The overage fees are displayed in your Account page in Matomo and on the pricing page at [matomo.org/pricing](https://matomo.org/pricing/).
...
10. Our online order process is conducted by our reseller [Paddle.com](https://paddle.com/). Paddle.com is the Merchant of Record for most of our orders. Paddle provides customer service inquiries and handles returns.
...
2. Prices of all Services are subject to change upon 30 days notice from us. Such notice may be provided at any time by posting the changes to the Matomo Cloud by InnoCraft at [matomo.org/pricing](https://matomo.org/pricing/) or the Service itself.
...
5. InnoCraft’s processing of your users’ data is governed by the [Matomo Cloud Data Processing Agreement](https://matomo.org/matomo-cloud-dpa/) (DPA), which forms an integral part of these Terms of Service.
...
7. 1. Passwords, authentication/authorization credentials
    ...
    3. 1. Credit card information including credit card numbers, CIV numbers (three digit codes for Visa and MasterCard, four digit code for American Express) and magnetic stripe information
...
6. You agree that the Company may monitor the activity of any account on the Service. Any such data shall be only used for the purpose of providing and improving the Service.
7. The Company may also collect registration and other information about you through the Company websites. The Company collection and use of information collected on the Company websites is governed by the InnoCraft Privacy Policy available at [https://www.innocraft.com/privacy](https://www.innocraft.com/privacy).
8. The InnoCraft Privacy Policy does not cover information InnoCraft collects on Customer’s behalf from Customer’s mobile and web properties. It is Customer’s obligation to provide Customer’s own privacy policy or notice to Customer’s users.
...
17. Questions about the Terms of Service should be sent to [support@innocraft.cloud](mailto:support@innocraft.cloud)
...
Email: [privacy@innocraft.com](mailto:privacy@innocraft.com)  
Contact form: [matomo.org/contact](https://matomo.org/contact/)
...
* [Conversion Rate Optimisation Checklist](https://matomo.org/blog/2023/10/conversion-rate-optimisation-checklist/)
...
* [](https://www.youtube.com/c/MatomoAnalytics/videos)
* [](https://mastodon.social/@Matomo)
