...
1. [Home](https://www.crohnscolitisfoundation.org/)
...
The purpose of the [Crohn's & Colitis Foundation](https://www.crohnscolitisfoundation.org/about/) website is to provide information about the Foundation and inflammatory bowel disease (IBD) to people living with [Crohn's disease](https://www.crohnscolitisfoundation.org/what-are-crohns-and-colitis/what-is-crohns-disease/) and [ulcerative colitis](https://www.crohnscolitisfoundation.org/what-are-crohns-and-colitis/what-is-ulcerative-colitis/), as well as to their families and friends, healthcare professionals, and the general public.
...
For disclosure of demographic information (e.g., rental or exchange of donor lists with other organizations), the Foundation as a minimum will use the "opt-out" approach. An "opt-out" is obtained when the Foundation gives individuals an opportunity to decline or "opt-out" of disclosures to third parties. If an individual does not opt out, permission is deemed granted.

What security do we provide to protect your personal information?
-----------------------------------------------------------------

The Foundation uses multiple electronic and administrative safeguards to protect your information from unauthorized access, such as firewall technologies and Secure Socket Layer (SSL) security, which is described below. Access to your account information is protected via system passwords which are changed periodically. Despite use of these safeguards, we cannot guarantee and do not represent that your information will always be secure from unauthorized access.
...
You may view or edit your personal profile by [logging in](http://online.crohnscolitisfoundation.org/site/UserLogin?NEXTURL=ConsProfileUser) to our website at [www.crohnscolitisfoundation.org,](https://www.crohnscolitisfoundation.org/) where you can also view a history of your online transactions or subscribe to our e-newsletter. In addition, you may also email us at [\[email protected\]](https://www.crohnscolitisfoundation.org/cdn-cgi/l/email-protection) or call us at 1-800-932-2423 to review your personal information.

Disclaimer on Information Provided on the Crohn's & Colitis Foundation Website
------------------------------------------------------------------------------

All articles and messages that appear in our website, including notes from physicians and other Foundation-designated participants, are provided for general information purposes only. They do not represent individual medical advice, counsel concerning individual treatments or medical care, referrals to healthcare professionals, or any other recommendations. You should not rely on any information on these pages to replace consultations with your doctor and other qualified healthcare professionals regarding your individual health needs. Statements or opinions expressed by physicians and other independent authors reflect the views of each such individual and do not necessarily reflect the views or any official policy of the Crohn's & Colitis Foundation. 
...
Except where otherwise noted, all information on the Foundation website, including its design and organization, is copyrighted by the Crohn's & Colitis Foundation Inc. This material is for personal use only. Permission to otherwise reprint or electronically reproduce any document in whole or in part is expressly prohibited, unless prior written consent is obtained from the Foundation.  

The Crohn's & Colitis Foundation's website also contains information copyrighted and owned by entities and individuals other than the Foundation. This information is for personal use only. Permission to otherwise reprint or electronically reproduce any document in whole or in part is expressly prohibited, unless prior written consent is obtained from the owner.  

The Foundation's website also contains third party information. Whenever possible, such information is marked with the name of the source and does not necessarily represent the opinion of the Foundation. We do not take any responsibility whatsoever for such third party information. 

The Foundation's website also contains links to other Internet sites. The Foundation does not necessarily endorse the views expressed in the Internet sites to which it provides links, nor is the organization responsible for the information they contain. The content of these linked sites are the sole responsibility of such sites and their contributing authors. The Foundation does not intend links to other sites to be referrals or endorsements of the linked entities, but rather provides such links for convenience only.
...
* [Donate Stock](https://www.crohnscolitisfoundation.org/donate/donate-stock)
* [Estate Planning/Planned Gift](http://plannedgiving.crohnscolitisfoundation.org/?_ga=2.85149913.1749512814.1560173213-1652049484.1550848626)
* [FreeWill](https://www.crohnscolitisfoundation.org/donate/planned-giving/free-will)
* [Trusts](http://plannedgiving.crohnscolitisfoundation.org/wills-and-living-trusts)
* [Donate by Wire Transfer](https://www.crohnscolitisfoundation.org/donate/wire-transfers)
* [Give Through Your IRA](https://www.crohnscolitisfoundation.org/donate/give-through-your-ira)
* [Donate a Car](https://www.crohnscolitisfoundation.org/donate/donate-car)
* [Create a Tribute Page](https://p2p.onecause.com/diy-tributes-memorials)
* [Donation Frequently Asked Questions](https://www.crohnscolitisfoundation.org/donate/faq)
* [Donate Cryptocurrency](https://www.crohnscolitisfoundation.org/donate/donate-cryptocurrency)
* [Donor Privacy Policy](https://www.crohnscolitisfoundation.org/donate/donor-privacy-policy)
