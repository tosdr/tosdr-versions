...
If you are using one of our custom DNS filters (paid service), you have the option and control on what to log. You have the option of DNS visibility and to see all logs from your network or a total privacy mode, where nothing is ever logged. You can customize your settings inside your [account](https://my.cleanbrowsing.org/dashboard?page=settings&subpage=data_retention).
...
#### CleanBrowsing Detailed Privacy Policy
...
4. **Public Resolver Users:** Those who use CleanBrowsing Public, Free, Recursive Domain Name System (“DNS”) Resolver services, such as the 185.228.168.168 Resolver. Learn more about CleanBrowsing [Free filters](https://cleanbrowsing.org/filters).
