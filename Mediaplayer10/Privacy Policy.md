[![MediaPlayer 10 - The Official Home of MP10](/assets/logo1.png)](https://www.mediaplayer10.com/) Play All Your Media Files With Ease! Play all your media files with MediaPlayer10 Chrome New Tab
...
[* Scope](#scope)[* What data do we use?](#data)[* Why do we use this data?](#why)[* Do we use web browser cookies, or pixels?](#cookies)[* Will we ever contact you (and how to opt-out)?](#ever-contact)[* Will we share this data?](#share-data)[* U.S. Children’s Online Privacy Protection Act (“COPPA”)](#children)[* California Consumer Privacy Act (“CCPA”)](#cali-consumer)[8.1 Consumers With Disabilities; Non-Discrimination](#8.1)  
[8.2 Designated Methods For Submitting CCPA Requests](#8.2)  
[8.3 Personal Information](#8.3)  
[8.4 Necessity To Maintain Your Personal Information](#8.4)  
[8.5 Opt-out / Opt-in For Sale Of Personal Information](#8.5)[* E.U. General Data Protection Regulation (“GDPR”)](#eu-data)[9.1 GDPR Owner](#9.1)  
[9.2 Personal Data](#9.2)  
[9.3 Disclosure](#9.3)  
[9.4 Data Retention](#9.4)  
[9.5 Contact GDPR Owner](#9.5)[* Privacy Practices Disclosure For Chrome Web Store](#cws)[* Policy Updates](#policy-updates)[* Contact Us](#contact-us)
...
* You can [disable or remove our app or extension at any time](https://www.mediaplayer10.com/uninstall/).
...
* You’ve disabled this site’s Notifications. If you are still seeing notifications, please try our manual [unsubscribe instructions.](https://www.mediaplayer10.com/unsubscribe/)

* This web browser profile is not subscribed to this site’s Notifications.
* If you are still seeing notifications from the web address of this site, please try our manual [unsubscribe instructions.](https://www.mediaplayer10.com/unsubscribe/)

* If you opted-in via your web browser to this site’s Notifications, you can unsubscribe by using this link.
You can also disable this site’s Notifications via your [web browser settings](https://www.mediaplayer10.com/unsubscribe/) (a.k.a. options or preferences).
...
* Amazon Web Services [(Data Privacy FAQ)](https://aws.amazon.com/compliance/data-privacy-faq/)
* Cloudflare [(Privacy Policy)](https://www.cloudflare.com/privacypolicy/)
* Google [(Privacy Policy)](https://policies.google.com/privacy); Google Analytics [Opt-out Browser](https://tools.google.com/dlpage/gaoptout) Add-on
* IBM Cloud [(Privacy Statement)](https://www.ibm.com/privacy/)
* Verizon Media [(Privacy Centers)](https://www.verizonmedia.com/policies/index.html)

### 7\. U.S. Children’s Online Privacy Protection Act (“COPPA”)

We do not knowingly collect or sell information from children under the age of 13 pursuant to the Children’s Online Privacy Protection Act of 1998, 15 U.S.C. 6501-6505. We encourage parents and legal guardians to be familiar with the Internet activity of their children. For more information, visit the United States Federal Trade Commission [website](https://www.consumer.ftc.gov/topics/protecting-kids-online) about protecting kids online.
...
You can contact us to submit a CCPA request via [this webform,](javascript:void(0)) or by calling our automated, toll-free (within the United States) phone number: 1-833-874-2272. Please be aware that your public Caller ID information may be collected for business purposes if you choose the phone call method.

For inquiries about our Privacy Policy that are not related to CCPA, please use the [contact](#contact) information at the end of this Privacy Policy.
...
* _Display Name_ – If you enter personal information into the service’s “Display Name” text input field, it will be used for business purposes, including using it to temporarily identify you by your chosen display name in a service session.
* _IP Address_ – Your public “Internet Protocol” address sent to us by your web browser.
* _GUID_ – A unique “Generic User Identification” created when you visit our site, use our service, install our app, add our extension, or subscribe to Notifications which may be stored in a cookie.
* _Anonymous Diagnostic Data_ – Anonymous service diagnostic data, including but not limited to network connection conditions.
* _UA_ – The “User Agent” and version of your web browser; e.g. Chrome 84, Firefox 79, Safari 13, etc.
* _OS_ – The “Operating System” and version used by your hardware; e.g. Windows 10, macOS 10.15, etc.
...
You can contact our GDPR owner via this [\[email protected\]](https://www.mediaplayer10.com/cdn-cgi/l/email-protection) or post:
...
_For inquiries about our Privacy Policy that are not related to GDPR, please use the contact information at the end of this Privacy Policy._
...
* _Display Name_ – If you enter personal data into the service’s “Display Name” text input field, it will temporarily identify you by your chosen display name in a service session.
* _IP Address_ – Your public “Internet Protocol” address sent to us by your web browser.
* _GUID_ – A unique “Generic User Identification” created when you visit our site, use our service, install our app, add our extension, or subscribe to Notifications.
* _Anonymous Diagnostic Data_ – Anonymous service diagnostic data, including but not limited to network connection conditions.
...
We may pass your personal data without first obtaining your consent to third parties listed in [Section 6](#section_six).
...
Our extensions request the minimum browser permissions and site permissions required to function. You as the user can review the “Site access” and “Permissions” of extensions by opening chrome://extensions in Chrome.
...
If you have questions or concerns about this Privacy Policy, its implementation, or feel that we have not followed it, please let us know by [email](https://www.mediaplayer10.com/contact-us/) or post:
...
* [Home](https://www.mediaplayer10.com/)
* [Contact Us](https://www.mediaplayer10.com/contact-us/)
* [Support](https://www.mediaplayer10.com/support/)
* [Privacy Policy](https://www.mediaplayer10.com/privacy-policy/)
* [Terms Of Service](https://www.mediaplayer10.com/terms-service/)
* [Uninstall](https://www.mediaplayer10.com/uninstall/)
* [Developers](https://www.mediaplayer10.com/developers/)
* [Unsubscribe](https://www.mediaplayer10.com/unsubscribe/)
* [Do Not Sell My Personal Information](https://www.mediaplayer10.com/privacy-policy/#cali-consumer)