...
This Service (via the Matrix homeserver hosted at [https://matrix.org](https://matrix.org/)) is run and managed by [New Vector Ltd](https://vector.im/), the company formed in July 2017 to hire the Matrix core development team.
...
You must be at least 16 years old to use this Service ([https://matrix.org](https://matrix.org/))