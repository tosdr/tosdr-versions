...
[Donate](https://matrix.org/support) [Try Matrix](https://matrix.org/try-matrix/)
...
We decided to use plain English as much as possible, to make our terms as clear as possible. We are always looking to improve, so please send us feedback on this document to [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection).
...
Email: [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection)

Postal address:

Matrix.org Foundation 10 Queen Street Place London United Kingdom EC4R 1AG

Should you have other questions or concerns about this document, please send us an email at [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection).
...
If you read something that rubs you the wrong way, or if you think of something that should be added, please get in touch! We're all ears! Email [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection) and we'll chat.
...
If you think we removed your access by mistake, send an email to [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection) and we'll give you our reasoning, when possible.
...
Queries sent to [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection) will be addressed on a best-effort basis by the paid team. Phone support is not provided.
...
Any content containing or promoting indecent images/depictions of children is illegal and utterly prohibited on the Service. When we become aware of such content, we refer the details to the relevant authorities. If you've found an account, room or group being used for the distribution or promotion of child sexual exploitation, please share the details in an email to [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection).

Any other forms of illegal content are strictly prohibited in the Service and its distribution will result in immediate account termination. If you come across such content please share the details in an email to [\[email protected\]](https://matrix.org/cdn-cgi/l/email-protection).
...
[Copyright Notice](https://matrix.org/legal/copyright-notice)