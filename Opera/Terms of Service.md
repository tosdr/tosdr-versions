...
1. **Opera Account gives you access to additional/extended features of Aria.** You do not need Opera Account to access and use Aria. However, you will need to create or log into Opera Account to gain access to additional or extended features of Aria.
...
3. **Restricted Content and use** You may not (i) use Aria for any illegal purpose, to violate or facilitate the violation of any person’s rights or any law or regulation, or in any manner inconsistent with the Terms; (ii) generate obscene, vulgar, sexually-oriented, hateful, or threatening Output, generating malware (iii) use Aria feature for unauthorized services requiring professional knowledge and/or qualifications (like: providing legal, tax, financial, medical advices) (iv) reverse engineer, de-encrypt, or otherwise derive the design, internal logic, structure or inner workings (including algorithms and source code of Aria) (v) use output from the Aria to develop models that compete with Aria and/or OpenAI; (vi) provide Aria with information regarding minors under 13 or applicable age for digital consent. You agree to use Aria solely for your own personal, noncommercial use and benefit. You may read more in our [FAQ](https://help.opera.com/en/browser-ai-faq/) section.
...
6. **Ceasing to provide the Aria Feature.** If we decide to cease to provide the Aria feature, then you will be notified as soon as reasonably possible.
    
7. **Customer Service.** If you have a question about Aria, you may contact customer support [here](https://opera.atlassian.net/servicedesk/customer/portal/9). If you believe that any content accessible via Aria infringes your rights, you may submit a notification to customer support.
    
8. **FAQ.** To learn more about artificial intelligence and to get practical guidelines on how to use Aria, please check our [FAQ](https://help.opera.com/en/browser-ai-faq/) section.
