...
Rest assured, we offer extra security measures for the ways you like to do business.

[![](/bin-public/060_www_fidelity_com/images/security/2factor.png)](https://www.fidelity.com/security/how-two-factor-authentication-works)

  

### [Multi–factor authentication](https://www.fidelity.com/security/extra-security-login)

**Protect your identity:**  
For extra protection during logins and sensitive transactions, get a push notification or security code to verify it's you.

[![](/bin-public/060_www_fidelity_com/images/security/money-transfer-lockdown-icon.png)](https://dpcs.fidelity.com/ftgw/dpcs/security/dashboard/view)

  

### [Money transfer lockdownLog In Required](https://dpcs.fidelity.com/ftgw/dpcs/security/dashboard/view)
...
[![](/bin-public/060_www_fidelity_com/images/security/security-text-alert-icon.png)](https://dpcs.fidelity.com/ftgw/dpcs/security/dashboard/view)

  

### [Security text alertsLog In Required](https://dpcs.fidelity.com/ftgw/dpcs/security/dashboard/view)

**Stay informed on account activity:**  
Get instant security alerts on your mobile number when certain transactions or profile updates are made to your account.

[![](/bin-public/060_www_fidelity_com/images/security/myvoice.png)](https://www.fidelity.com/security/fidelity-simplispeak/overview)

  

### [Fidelity voice biometrics](https://www.fidelity.com/security/fidelity-myvoice/overview)

**Access accounts with your voice:**  
Fidelity uses voice biometric technology in two ways: we can verify clients by voiceprint over the phone or through any microphone-enabled digital device.

[_See more of our security measures_](https://www.fidelity.com/security/our-security-measures)
...
Por favor lea nuestra [Garantía de protección al cliente de Fidelity](https://www.fidelity.com/security/espanol/customer-protection-guarantee "Garantía de protección al cliente de Fidelity").

![Security-Spot](/bin-public/060_www_fidelity_com/images/fidelity/Security-Spot.png)

### How strong are your passwords?

If you use the same username or password at Fidelity and other online sites, your accounts could be at risk. Use strong, different passwords for each of your online accounts.

[Change your password now](https://www.fidelity.com/customer-service/how-to-update-password)

Take additional steps for your protection
-----------------------------------------

* [Boost your login protection](http://www.fidelity.com/security/boost-your-login-protection)
* [Take precautions at home](http://www.fidelity.com/security/take-precautions-at-home)
* [Monitor your accounts](http://www.fidelity.com/security/monitor-your-accounts)
* [Look out for suspicious emails](http://www.fidelity.com/security/look-out-for-suspicious-emails)
* [Browse with vigilance](http://www.fidelity.com/security/browse-with-vigilance)
* [Protect your loved ones from financial exploitation](http://www.fidelity.com/security/elder-financial-exploitation)

Special offers for additional security
--------------------------------------

* [Protect your personal identity](https://www.idnotify.com/idprotectplans?RTN=90000244&EID_SID=Web&EID_LOB=PI)
* [Safeguard your loved ones from elder fraud](http://www.eversafe.com/fidelity/LOB=PI)

Experian, Eversafe, and Fidelity are independent entities are not legally affiliated.
