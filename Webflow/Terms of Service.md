...
_We are updating our Terms of Service. These new Terms of Service will come into effect on November 15, 2023. By continuing to use Webflow after November 15, 2023, you agree to comply with and be bound by these terms_

Terms of Service
----------------

_Effective date: November 15, 2023_

_Last modified date: November 2, 2023_

### Table of Contents

1. [Welcome to Webflow!](#welcome-to-webflow)
2. [Your Account](#your-account)
3. [Your Website Content](#your-website-content)
4. [Your Responsibilities](#your-responsibilities)
5. [Third-Party Platforms, Product Specific Terms, and Website Content](#third-party-terms)
6. [What We Own](#what-we-own)
7. [Our Rights](#our-rights)
8. [Billing, Payments, and Renewals](#billing-payment-and-renewals)
9. [Privacy and Security](#privacy-and-security)
10. [Intellectual Property Policy](#intellectual-property-policy)
11. [Confidentiality](#confidentiality)
12. [Disclaimer of Warranties and Limitation of Liability](#disclaimer-of-warranties-and-limitation-of-liability)
13. [Indemnification](#indemnification)
14. [Changes to the Platform and Termination](#changes-to-the-platform-and-termination)
15. [Amendments, Notification Procedures, and Updates to the Agreement](#amendments-notification-procedures-and-updates-to-the-agreement)
16. [Dispute resolution](#dispute-resolution)
17. [US Economic Sanctions](#us-economic-sanctions)
...
Welcome to Webflow’s Terms of Service! In these white boxes, you'll find our plain-English Terms of Service. This part isn’t legally binding, so please use this column only as an aid when reviewing the legal language.

#### 1.2 Applicable Terms

Your use of the Platform is subject to these Terms, as well as our [Acceptable Use Policy](https://webflow.com/legal/aup), [Intellectual Property Policy](https://webflow.com/legal/copyright), [Trademark Usage Policy](https://webflow.com/legal/trademark-policy) and, if applicable, the [Product Specific Terms](https://webflow.com/legal/product-terms), [Template License Policy](https://webflow.com/templates/template-licenses), Marketplace Creator Agreement, [Developer Terms of Service](https://webflow.com/legal/developer-terms-of-service), [Data Processing Addendum](https://webflow.com/legal/dpa), [Beta Program Terms and Conditions](https://webflow.com/legal/beta-terms) and any applicable agreements or policies referenced therein (these documents are hereby incorporated into these Terms by reference and together with these Terms are collectively referred to as the “**Agreement**”). Undefined capitalized terms used in these Terms have the meanings ascribed to them in the relevant agreement, policy, or addendum incorporated by reference into the Agreement.  As mentioned above, the sidebar notes are provided for convenience, are not part of these Terms or the Agreement, and have no legal effect. 
...
By accepting these Terms and using the Service, please understand you are also agreeing to the terms of our Acceptable Use Policy, Intellectual Property Policy, Trademark Usage Policy and, if applicable, the Product Specific Terms, Marketplace Creator Agreement, Developer Terms of Platform, Data Processing Addendum, and Beta Program Terms and Conditions.
...
You must be at least 13 years old (and have your parent's permission if you are under 18) to use Webflow.

If you use Webflow on behalf of your business, you are representing that you are authorized to agree to these Term on its behalf.

#### 2.2 Signing Up

To access and use the Platform, you must register for an account with Webflow (“**Account**”). To complete your Account registration, you agree to provide us with complete and accurate information and to keep that information current so that we can communicate with you about your Account. We may need to send you notices about important updates (like changes to these Terms or our Privacy Policy), or to inform you of legal inquiries we receive about your use of the Platform so you can make informed choices in response. We encourage you to provide your own (or your company’s) contact and billing details, including your valid, current email address, as we may use it to identify and determine the actual and true owner of the Account and/or Website Content (as defined below). Webflow reserves the right to reclaim usernames on behalf of businesses or individuals that hold legal claim or trademark to those usernames.

Basically...

You need to sign up for an Account to use Webflow. Choose a plan that works for you or for your company (if you're authorized to act on their behalf). If you set up an account through another service like Google, it’s OK for us to use your information as provided by that service.

We may send you occasional emails about Webflow updates or your account.
...
If you are a [Webflow Expert](https://experts.webflow.com/browse), web design agency, solo web designer, or any other similarly situated third party that builds and designs websites on behalf of your clients (“**Website Designer**”), you represent and warrant that you are authorized to act as your clients’ agent and are accepting the Agreement on their behalf. You further agree that you will surface the Agreement to your clients. You agree to immediately notify us of any unauthorized use of your Account or password. If we believe your Account has been compromised, we may suspend or disable it until such time that the matter has been resolved.
...
If you have a Webflow Account, the Platform may enable you to, among other things, publish or upload content to the Internet, including but not limited to blogs or forum posts, images, photos, and videos. Any content you submit, post, display, or otherwise make available on or via the Platform, including all Intellectual Property Rights (defined below) therein, is referred to as your “**Website Content**.” For the avoidance of doubt, Website Content includes any [Templates](https://webflow.com/templates), [Libraries](https://webflow.com/libraries?utm_source=marketplace), or [Apps](https://webflow.com/apps?utm_source=marketplace) that you submit to the [Marketplace](https://webflow.com/marketplace). Unless otherwise specified in the Agreement and to the maximum extent permitted by law, you agree to be fully responsible for the Website Content that you create or submit to the Platform and you further agree not to use the Platform to create or submit any Website Content that does not comply with the Agreement including but not limited to Webflow’s [Acceptable Use Policy](https://webflow.com/legal/aup).

Please note that any [Templates](https://webflow.com/templates), [Libraries](https://webflow.com/libraries), and/or similar offerings that you submit to the [Webflow Marketplace](https://webflow.com/marketplace) will be governed by the Marketplace Creator Agreement and any accompanying policies including but not limited to the [Template Submission Guidelines](http://webflow.com/templates/submission-guidelines). Additionally, please note that any [Apps](https://webflow.com/apps) you submit to the Webflow Marketplace will be governed by the [App Developer Terms](https://webflow.com/legal/developer-terms-of-service) and any accompanying policies referenced therein.
...
You are solely responsible for the content you publish using Webflow, and by publishing any content you are confirming that the content does not violate these Terms, including our Acceptable Use Policy. Please follow our rules and don’t do anything illegal with our platform, and keep in mind that what you publish may be publicly available online.

#### 3.2 Rights you Grant and License to Webflow

You retain ownership of your Website Content unless otherwise specified in the Agreement including but not limited to [Product Specific Terms](https://webflow.com/legal/product-terms) (e.g. content generated using generative artificial intelligence products). However, in order to provide the Platform to you we need certain rights from you, as more fully described below. 
...
When you upload content to Webflow, you will still own it, but we require your authorization to use it in certain ways to provide, improve, protect, and promote the Service. For example, when you upload a photo, you also are authorizing us to save it and display it on your site. We also have the limited right to feature your sites and content solely to promote Webflow, which you may opt out of.
...
If you upload website content that violates Webflow's terms or policies, we may remove your content. We will do our best to notify you, unless doing so would cause more harm than good. Additionally, Webflow proactively scans for CSAM and if we discover it, you will be reported to law enforcement authorities.
...
You agree that you have the authority to accept these terms, that you will follow applicable laws and polices, and that you will do right by your End Users.
...
Webflow has no relationship to the end users or website visitors of the sites you build with Webflow, so we are not responsible for how you handle their information.

So you should make sure to:

* Protect the info you gather on your sites
* Let people know if their data may have been accessed in the event of a security breach
* Let your website visitors know what info you gather and how it will be used
...
Webflow’s [Product Specific Terms](https://webflow.com/legal/product-terms) apply to your access to and use of certain specific products, features, or services available via the Platform. Our [Product Specific Terms](https://webflow.com/legal/product-terms) are incorporated by reference into the Agreement.

Basically...

If you integrate any of the Webflow services with a third-party service (e.g. Stripe), you should review their terms of service because you might need to agree to additional or different terms. You should also review [Webflow's Product Specific Terms](https://webflow.com/legal/product-terms).
...
Customers can add a range of content to the Service. Webflow is not responsible for any user or any content that you or any other user or third party posts or sends through the Service.
...
Webflow links to a lot of third-party sites that have their own terms of service, which are distinct from ours.

We provide a list of designers for hire. We have not vetted these designers, so please do that yourself before hiring anyone.

We provide templates that are created by other users and we can’t guarantee the quality of these templates. Reach out to the creator if you need help. Every template page has an area where you can comment and ask for help!
...
Unless otherwise noted, information published on this site constitutes copyrighted works of Webflow or our licensors.

Third-party information, such as data accessed through a service on Webflow, is subject to the copyrights of those third-party systems.
...
For monthly payment plans, the Platform is billed in advance on a monthly basis. Any requests for refunds will be handled in accordance with [Webflow’s Billing and Refund Policy](https://university.webflow.com/lesson/webflow-billing#:~:text=Does%20Webflow%20provide%20refunds%3F,we%20understand%20mistakes%20sometimes%20happen) as updated by Webflow from time to time. 
...
Like other products, some of our services are paid. You are responsible for payment for the services and associated taxes. Certain additional rules apply to Enterprise Customers.

### 9\. Privacy and Security

By using the Platform, you confirm that you have read and understood our [Privacy Policy](https://webflow.com/legal/privacy) and that you consent to the collection, use, processing, and disclosure of your Personal Information and aggregated data as set forth therein. You understand that your Personal Information will be collected, used, transferred to, and processed in the United States as part of your use of the Platform. Our [Privacy Policy](https://webflow.com/legal/privacy) is not a contract and does not form part of this Agreement. We may update our [Privacy Policy](https://webflow.com/legal/privacy) from time to time as set forth in that policy. 
...
It has these handy plain-English sections too.

### 10\. Intellectual Property Policy  

Webflow respects the intellectual property of others, and expects customers to do the same. If you believe, in good faith, that any materials provided on or in connection with the Platform infringe upon your copyright, trademark, or other intellectual property right, please review our [Intellectual Property Policy](https://webflow.com/legal/intellectual-property-policy) and [Trademark Policy](https://webflow.com/legal/trademark-policy) and fill out the applicable [Copyright (DMCA) Takedown Form](https://support.webflow.com/resources/copyright-takedown) or [Trademark Takedown Form](https://support.webflow.com/resources/trademark-takedown) or send the information detailed in the [Intellectual Property Policy](https://webflow.com/legal/intellectual-property-policy) to Webflow's Copyright Agent at: Webflow, Inc., 398 11th St., Floor 2, San Francisco, CA 94103.
...
Both you and Webflow agree to use the Confidential Information of the other only to perform the obligations and/or exercise the rights in these Terms. Confidential Information must be protected and respected.
...
Webflow reserves the right to update, change, or terminate the Service and/or your access to it for any reason in our sole discretion.
...
We may materially change or update the Terms from time to time in our usual course of business. If we do, we'll make sure to give you notice of any Updated Terms (e.g., we will post a note on our website or email you). Your continued access and use of Webflow after the Effective Date found at the top of the page shall constitute your acceptance of the updated terms.
...
We don’t want to fight. If something goes wrong, contact us and we'll try to amicably solve the problem. If that doesn’t work, we will figure it out in arbitration in San Francisco.
...
Webflow’s ability to provide the Service to you is subject to compliance with US sanctions that restrict or prohibit who or from where the Service can be accessed.
...
[Archived Terms of Service](https://webflow.com/legal/archived-terms/terms-of-service-oct-14-2022)
