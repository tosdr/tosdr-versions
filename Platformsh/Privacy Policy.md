...
[Trust Center](https://platform.sh/trust-center/)[privacy](https://platform.sh/trust-center/privacy/)Privacy Policy

Privacy Policy
==============

Looking for our GDPR DPA? Find it [here](https://platform.sh/trust-center/privacy/dpa/).
...
Platform.sh offers different services, products, software, and offerings (the "Services"), including but not limited to, all information, tools and services (including any beta services) available from us to you (the 'User'), that are run under the brand "Platform.sh'' and on related Platform.sh websites, including but not limited to: [https://platform.sh](https://platform.sh/), [https://docs.platform.sh](https://docs.platform.sh/), [https://status.platform.sh](https://status.platform.sh/), [https://accounts.platform.sh](https://accounts.platform.sh/?), [https://console.platform.sh/,](https://console.platform.sh/,) [https://blackfire.io](https://blackfire.io/), and [Upsun.com](https://upsun.com/) (the 'Sites'), conditioned upon your acceptance of all terms, conditions, policies and notices stated in the Terms of Services and this Privacy Policy.
...
If you are looking for our Events Privacy Policy, please click [here](https://platform.sh/trust-center/privacy/events-privacy-policy/).

#### **(2) Information we collect**[](#2-information-we-collect "Link to this heading")
...
* IP Addresses; 
* log files; 
* CV and and other information when applying to work with us through our [Careers page](https://platform.sh/company/careers/); and
...
#### **(3) Our use of cookies and urchin tracking modules (UTMs)**[](#3-our-use-of-cookies-and-urchin-tracking-modules-utms "Link to this heading")
...
#### **(5) Why we process your personal information** [](#5-why-we-process-your-personal-information "Link to this heading")
...
#### **(6) Disclosing your personal information**         [](#6-disclosing-your-personal-information "Link to this heading")
...
#### **(7) Your data protection rights under GDPR, Canada’s PIPEDA, and California's consumer privacy act**[](#7-your-data-protection-rights-under-gdpr-canadas-pipeda-and-californias-consumer-privacy-act "Link to this heading")
...
#### **(8) Accessing and updating your personal information**[](#8-accessing-and-updating-your-personal-information "Link to this heading")
...
#### **(9) Storing, securing, and transfer of your personal data and information**[](#9-storing-securing-and-transfer-of-your-personal-data-and-information "Link to this heading")
...
We take all reasonable measures to protect your personal data and information from unauthorized access to, or unauthorized alteration, disclosure or destruction of, information we maintain. To maintain your trust, we’ve achieved several independently audited industry certifications, ensuring your data is handled with appropriate care and according to industry standards. You can find more information [here](https://platform.sh/trust-center/). We also  use physical, organizational, and technological methods and policies to protect and safeguard your personal information. For more on our security, please visit [https://platform.sh/trust-center/](https://platform.sh/trust-center/).
...
#### **(10) Data breaches**[](#10-data-breaches "Link to this heading")
...
#### **(11) Third-party links**[](#11-third-party-links "Link to this heading")
...
#### **(12) Children’s privacy**[](#12-childrens-privacy "Link to this heading")
...
#### **(13) About us**[](#13-about-us "Link to this heading")
...
#### **(14) Contact us**[](#14-contact-us "Link to this heading")

If you have any questions, requests, feedback,  or concerns regarding this Privacy Policy or you want to exercise any of your rights, please [contact us](https://platform.sh/contact/). You can also send an email to dpo@platform.sh. Our procedures are in place to receive and respond to any complaints and inquiries you may have. For Blackfire.io-specific questions, please visit the [support center](https://support.blackfire.io/en/). For existing Platform.sh customers, [please create a support ticket through your account](https://auth.api.platform.sh/?) to allow for identity verification.
...
In compliance with the EU-U.S. DPF and the UK Extension to the EU-U.S. DPF, and the Swiss-U.S. DPF, Platform.sh commits to resolve DPF Principles-related complaints about our collection and use of your personal data.  EU, UK and Swiss individuals with inquiries or complaints regarding our handling of personal data received in reliance on the EU-U.S. DPF {and the UK Extension to the EU-U.S. DPF and the Swiss-U.S. DPF} should first [contact](https://platform.sh/contact/) Platform.sh. You can also send an email to [dpo@platform.sh](mailto:dpo@platform.sh). In compliance with the EU-U.S. DPF {and the UK Extension to the EU-U.S. DPF and the Swiss-U.S. DPF}, Platform.sh commits to cooperate and comply {respectively} with the advice of {the panel established by the EU data protection authorities (DPAs) and the UK Information Commissioner’s Office (ICO) and the Gibraltar Regulatory Authority (GRA) and the Swiss Federal Data Protection and Information Commissioner (FDPIC) with regard to unresolved complaints concerning our handling of personal data received in reliance on the EU-U.S. DPF and the UK Extension to the EU-U.S. DPF {and the Swiss-U.S. DPF}.  If you have a complaint and Platfotm.sh is not able to resolve it, you may invoke binding arbitration under the EU-U.S. Data Privacy Framework policies. Platform.sh is willing to enter into binding arbitration with written notice provided that all pre-arbitration requirements are met (See [Data Privacy Framework website](https://www.dataprivacyframework.gov/s/article/How-to-Submit-a-Complaint-Relating-to-a-Participating-Organization-s-Compliance-with-the-DPF-Principles-dpf)).

#### **(16) Changelog**[](#16-changelog "Link to this heading")
...
| --- | --- | --- |
| **1.0** | 2016-08-16 | * Original version |
| **1.1** | 2017-10-25 | * Added information about GDPR compliance |
| **1.2** | 2018-01-20 | * Added GDPR Supervisory Authority |
| **2.0** | 2018-06-16 | * Updated from Legal Review<br>* Added additional privacy-related compliance with GDPR, PIPEDA, and California |
| **2.1** | 2018-11-05 | * Grammar and punctuation fixes<br>* Added clause “and other privacy regulations as described in this Privacy Policy” to indicate that we take measures to ensure compliance with privacy regulations beyond just GDPR<br>* Added toll-free contact number pursuant to the California Consumer Privacy Act of 2018 |
...
| **3.0** | 2019-12-04 | * Expanded CCPA section with updated rights information<br>* Removed toll-free number added in v2.1 as it is no longer required with recent CCPA revisions<br>* Grammar and punctuation fixes<br>* Converted changelog into table for readability<br>* Revised "About Us" wording to include only our main office. Our full office list is available on our "Contact Us" page<br>* Added information about how to file a complaint regarding a breach in compliance with the Australian Privacy Act |
| **3.1** | 2019-12-05 | * Fix capitalization in section 11 title<br>* added [https://console.platform.sh/](https://console.platform.sh/?) to the list of sites this policy applies to<br>* Formatting fixes |
| **3.2** | 2019-12-20 | * Additional Australian Privacy Act details<br>* Fix spelling mistakes<br>* Expand ways for filing complaints<br>* Expand list of named privacy acts in Section 7<br>* Clarify wording in Section 7 concerning where data is transferred to, including the explicit recognition of the UK |
| **3.3** | 2020-01-09 | * Add DPO email address to Section 10 at the request of the Australian OAIC<br>* Fix incorrect link to the OAIC in Section 13 |
| **3.4** | 2020-01-09 | * Fix grammar error<br>* Add additional out-of-scope DNS entries to Section 1 |
| **3.4.1** | 2020-01-09 | * Add additional out-of-scope DNS entry to Section 1 |
| **3.5** | 2020-01-09 | * Wording and punctuation changes to improve clarity<br>* Remove Privacy Shield |
| **3.6** | 2021-03-29 | * Added development sites to list in Introduction section<br>* Added data minimization language |
| **3.7** | 2021-04-26 | * Add fr-4 region<br>* Delete ovh-fr-1 |
| **3.7.1** | 2021-04-28 | * Add fr-3 region back to list after accidental deletion |
| **3.8** | 2021-06-17 | * Expanded CCPA section to encompass CPRA rights |
| **3.9** | 2021-09-03 | * Add au-2 region |
| **4.0** | 2021-09-09 | * Remove regions list<br>* Clarify in Section 1 what is excluded in this Privacy Policy |
| **5.0** | 2021-09-24 | * Add EU DPA page link and applicability |
| **6.0** | 2022-02-16 | * Update Section 3 to include UTMs and edit Section 8 to include new language regarding disclosing information to authorities |
| **7.0** | 2022-03-03 | * Update Introduction to include Blackfire.io and changed pronouns in various sections to incorporate Blackfire.io<br>* Update cookie descriptions in Section 3 |
| **7.1** | 2022-03-11 | * Clarified personal information categories in Section 2 and updated California data privacy information in Section 6 |
| **7.2** | 2022-06-28 | * Add fraud prevention to Section 4, How Do We Use Your Information |
| **7.3** | 2022-08-19 | * Add sensitive data collection to Section 2, Information We Collect |
| **7.4** | 2023-03-03 | * Grammar, punctuation  and spelling mistakes fixes<br>* Wording and paragraph structuring  changes to improve clarity<br>* Remove duplications<br>* Add with whom will share your information in Section 6-Legal<br>* Update our address<br>* Include information about the personal data we collect when you apply to work with us in Section 2 |
| **7.5** | 2023-05-03 | * Removed “Co-sponsored activities” and “Integration Partners” clauses from Section 6<br>* Added link to our Events Privacy Policy |
| **7.6** | 2023-07-06 | * Wording change in Section 3 to improve clarity |
| **7.7** | 2023-07-31 | * Addition of Upsun to Section 1, Addition of Job Roles to Section 2, Information We Collect |
| **7.8** | 2023-11-07 | * New section about compliance with the Data Privacy Framework |
| **7.9** | 2024-03-19 | * Added chatbot in Section 6 |
| **7.10** | 2024-03-20 | * Added user interactions in Section 6 |
