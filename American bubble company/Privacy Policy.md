![](https://www.facebook.com/tr?id=679542016055742&ev=PageView&noscript=1)                                Privacy – BubbleTree USA                                                                     
...
American Bubble Company LLC Privacy Policy

This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from [www.bubbletreeusa.com](http://www.bubbletreeusa.com/) (the “Site”).  Please read this policy carefully to understand our policies and practices regarding your information and how we will treat it. If you do not agree with our policies and practices, your choice is not to use the Site. By accessing or using this Site, you agree to this Privacy Policy. This policy may change from time to time. Your continued use of this Site after we make changes is deemed to be acceptance of those changes, so please check the policy periodically for updates. 
...
* Automatically as you visit, interact and navigate through the Site.

INFORMATION YOU PROVIDE TO US. 

You are not required to provide personal information. We will only collect such information when it is voluntarily provided to us on the Site, by email or through some other format. The information we collect on or through our Site may include:

* Information that you provide by signing up to receive our emails.
* Information that you provide when placing an order.
...
* Information about your computer and internet connection, including your IP address, operating system, Internet Service Provider, platform type, referral source, and browser type.
...
* To fulfill any orders for which you provide it.
...
IP addresses are unique numeric identifiers that are assigned to each browser accessing the Internet. An IP address, by itself, cannot identify you personally. However, when combined with other information provided by your Internet Service Provider (ISP), your IP address can be used to identify the computer accessing the Site. Under certain circumstances, recipients, their legal representatives, and/ or law enforcement authorities may be able to combine this with information disclosed by ISPs to determine the source of a particular communication. By using this Site, you knowingly and voluntarily assume any risks associated with such disclosure. 

CREDIT CARD INFORMATION

If you make a purchase through our Site, we may collect contact information (such as name physical address, email address phone number), in connection with your purchase.  We do not process any underlying payment facilitated by the Site; payment is processed by our payment partners, currently we use Shopify and PayPal ("Payment Partners"). Credit Card information that you input to consummate a transaction is encrypted using SSL technology. Only the Payment Partners may be given access to the full credit card number that you provide. We do not have access to your full credit card number, although we may access or store the last four digits of the Credit Card number for record keeping purposes. Data handled by a Payment Partner is subject to that Payment Partner's terms and privacy policy.
...
If you are an individual in the European Union, we collect and process information about you only where we have legal bases for doing so under applicable EU laws, including the General Data Protection Regulation (“GDPR”).  The legal basis may depend on the type of information and how you use the Site.  If you have consented to our use of information about you for a specific purpose (for example if you make an order through the Site), you have the right to change your mind at any time, but this will not affect any processing that has already taken place.  Where we are using your information because we have a legitimate interest to do so, you have the right to object to that use though, in some cases, this may mean no longer receiving communications or utilizing certain features on the Site.  We are not required to have a data protection officer, so any questions about our use of your personal data or related requests should be addressed to: [info@americanbubble.com](mailto:info@americanbubble.com)

YOUR CALIFORNIA PRIVACY RIGHTS

If you are a California resident, California laws, including under the California Consumer Privacy Act of 2018 may provide you with additional rights regarding our use of your personal information. To learn more about your California privacy rights, see below:
...
The Site is not intended for individuals under the age of 13. We, therefore, shall not intentionally collect information about any user under the age of 13.  If you are under 13, do not use or provide any information on this Site.  If we learn we have collected or received personal information from a child under 13 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 13, please contact us at [info@americanbubble.com](mailto:info@americanbubble.com)

CHANGES

We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons. If we make material changes to how we treat our users' personal information, we will notify you. The date the privacy policy was last revised is identified at the bottom of the page. You are responsible for ensuring we have an up-to-date active and deliverable email address for you, and for periodically visiting our Website and this privacy policy to check for any changes.

CONTACT US

For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at info@americanbubble.com or by mail using the details provided below:

For California Residents

American Bubble Company LLC (“we,” “our,” and “us”) is furnishing this additional information to natural persons residing in the State of California, as required by the California Consumer Privacy Act of 2018 (the “CCPA”). This information should be read together with our Privacy Policy. https://american-bubble-company.myshopify.com/ABCPrivacy

This CCPA supplement to our Privacy Policy is dated and effective February 1, 2021.

The CCPA requires certain disclosures that already are covered in our Privacy Policy. https://american-bubble-company.myshopify.com/ABCPrivacy This section provides additional specific information required by CCPA, including information about how to exercise your rights under the CCPA.
...
Disclosures About the Sources and Uses of Personal Information

As described in our Privacy Policy, in order to provide the Services, we may have collected Personal Information from several categories of sources in the past twelve months.

This includes several categories of Personal Information as defined by the CCPA:

* Identifiers, such as name, postal or electronic address and telephone numbers;
* Personal information as defined under the California Customer Records statute (California Civil Code § 1798.80(e)) such as contact information;
* • Commercial information, such as transaction information and billing and payment history;
* Internet or network activity information, such as browsing history, interactions with our website, and Internet Protocol (IP) location;
* Geolocation data, such as device location and Internet Protocol (IP) location when you interact with our website;

We use your Personal Information for a variety of business purposes, as explained in the Privacy Policy. https://american-bubble-company.myshopify.com/ABCPrivacy

In order to provide the Services, we may share Personal Information with others. We never sell your Personal Information. During the past twelve months, we may have disclosed, for a business purpose, information within the categories listed above. See our Privacy Policy [https://american-bubble-company.myshopify.com/ABCPrivacy](https://american-bubble-company.myshopify.com/ABCPrivacy) to learn more about the categories of Personal Information we disclose, and the categories of third parties to whom your Personal Information is disclosed.
...
To request information about your own Personal Information, including information about the categories and specific pieces of information collected, or to request that we delete your Personal Information, please contact us at the contact information shown below. Please provide your name, email address, and any other information which you believe will help us to locate your records.

We will not furnish Personal Information to anyone unless their identity has been verified to a reasonable degree of certainty or, in the case of sensitive or valuable Personal Information, to a reasonably high degree of certainty. We will not provide consumers with specific Personal Information if the disclosure would create a substantial, articulable and unreasonable risk to the security of the Personal Information, the consumer’s account with us, or the security of our business systems.

American Bubble Company, LLC

325 Larchmont Blvd. Suite 230

Los Angeles, CA, 90004

Attn:– CCPA Requests

[info@americanbubble.com](mailto:info@americanbubble.com)
