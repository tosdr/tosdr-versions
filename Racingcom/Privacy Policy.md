...
**_  
For what purpose may RDC Media use and/or disclose my personal information?_**
...
Personal information collected by RDC Media shall be disclosed to Racing Victoria**.** Please refer to Racing Victoria’s Privacy Policy available at [https://www.racingvictoria.com.au/privacy-policy](https://www.racingvictoria.com.au/privacy-policy) for details regarding how Racing Victoria manages your personal information.
...
The use of cookies, advertising identifiers for mobile devices and Google Analytics enables RDC Media to:
...
If a person does not wish to receive cookies, you may set your browser to either prompt or refuse cookies.
...
**Email**: [privacyofficer@racingvictoria.net.au](mailto:privacyofficer@racingvictoria.net.au)
...
Before you can lodge a complaint with the OAIC, you will generally need to complain directly to RDC Media. Details on how to lodge a complaint with OAIC are set out on the OAIC’s website [here](https://www.oaic.gov.au/privacy/privacy-complaints).

The OAIC can also be contacted on 1300 363 992.

**12\. REVIEW AND APPROVAL**

This Policy is reviewed annually and as required. This may occur due to a change of operation, new legislative obligation, government recommendations or recommendations as a result of audits.

Where revisions are required, changes will be tracked in red for review by the relevant Senior Management Team member, and for recommendation to the RDC Media Chief Executive Officer and/or RDC Media Board for approval.

If approved, a tracked, clean (both in Word) and PDF copy of the Policy will be saved, and then sent to Legal, Risk and Compliance and uploaded onto the Website.

Any changes to the Policy are noted in the “version” table at section 13 below.

**13\. VERSION**

|     |     |     |     |
| --- | --- | --- | --- |
| **Version** | **Nature of Change** | **Reviewing Party** | **Approval date** |
| 1   | Adoption. | Warren Horton, Project Manager | 7 December 2021 |
| 1.1 | Update to entity name, opt-out contact for direct marketing and approver of this policy. | Pete Campbell, CEO | 7 March 2023 |
| 1.2 | Insertion of ‘Microsoft Clarity’ data monitoring and analytics information at clause 9. | Peter Campbell RDC Media CEO | 21 November 2023 |

**14\. CLOSE YOUR RACING+ ACCOUNT**

You may delete your Racing+ account and associated information at any time by submitting a request through the following webpage: [www.racing.com/racingplus/close-account](https://www.racing.com/racingplus/close-account)

This action will be subject to an email verification process. Upon successful verification, your Racing+ account, your profile, and any associated data is removed from the platform.

Requests to close a Racing+ account will be actioned within 24-48 hours once the verification is completed. 
