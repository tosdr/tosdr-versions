...
Kissmetrics Terms of Use

### EFFECTIVE DATE: December 28, 2023

The following terms and conditions (these “Terms of Use”) govern all use of the kissmetrics.io and app.kissmetrics.io websites, including the Kissmetrics Blog (kissmetrics.io/blog) ) (the “Website”) and all content, services, features, activities and products available at or through the Website, including but not limited to the website analysis service, the conversion service and the campaign automation service (the “Analysis Service,” the “Engage Service,” and the “Customer Engagement Automation Service”, respectively, together with all other content, services, features, activities and products available through the Website are herein referred to as the “Services”). The term “you” or “your” includes any of your subsidiaries, affiliates, employees. The Services are owned and operated by Sandstorm Analytics, Inc., dba Kissmetrics (also referred to as “we”, “our” or “us”). Please read these Terms of Use carefully before using the Services.

BY USING OR ACCESSING THE SERVICES, YOU AGREE TO BE BOUND BY THESE TERMS OF USE AND ALL TERMS, POLICIES AND GUIDELINES INCORPORATED IN THE TERMS OF USE BY REFERENCE, INCLUDING, BUT NOT LIMITED TO KISSMETRICS [PRIVACY POLICY](https://www.kissmetrics.io/privacy) (COLLECTIVELY, THIS “AGREEMENT”). BY USING OR ACCESSING THE SERVICES, YOU REPRESENT THAT YOU ARE AT LEAST 13 YEARS OF AGE. THIS AGREEMENT IS LEGALLY BINDING AND CONDITIONS YOUR USE OF THE SERVICES. If you do not agree to all the terms and conditions of this Agreement, you must discontinue use of the Services.

### 1\. Account Registration and Access

To register for the Services and create an account, you (including any agent designated by you operating on your behalf) must complete the registration process by providing Kissmetrics with the requested information including your name, email address, telephone, company name, company website, and password. You agree to provide us with complete and accurate information when you register for the Services, and to keep such information up to date.

You shall protect your username and password and are solely responsible for activities that occur under or through your account, including activities initiated by third parties, whether or not such activities are authorized by you. If you allow a third party to access the Services on your behalf, you shall ensure that such third party is bound by, and abides by, the terms of this Agreement. You agree to notify Kissmetrics immediately of any unauthorized use of your account or any other breach of security relating to your account or your use of the Services.
...
At the end of your current subscription period, your Plan will automatically renew for a subscription period equal to your prior subscription period unless you provide Kissmetrics with email notice (sent to [billing@kissmetrics.io](mailto:billing@kissmetrics.io)) of your intent not to renew your Plan at least thirty (30) days prior to the end of the current subscription period.

To view the specific details of your Plan, including pricing information and the end date of your subscription period, login to your account on Kissmetrics and click the [“Account”](https://app.kissmetrics.io/account) page or contact us at [billing@kissmetrics.io](mailto:billing@kissmetrics.io).
...
* If you desire to downgrade your Plan level prior to the end of your subscription period, please provide written notice to [billing@kissmetrics.io](mailto:billing@kissmetrics.io). The Plan downgrade will take effect the first billing cycle that occurs more than thirty (30) days following your notice to Kissmetrics, and you will not receive any refunds for payments made on your current billing cycle. Downgrading your Plan may cause the loss of account content, features, or capacity. Kissmetrics disclaims liability for any such loss.
...
* Any questions involving upgrades or downgrades to your Plan can be directed to [billing@kissmetrics.io](mailto:billing@kissmetrics.io).

#### 2.3 FREE TRIAL

Subscriptions to the Services may begin with a free trial period during which you can try out the Services for 14 days from the date you register (“Free Trial Period”). There is no limit to the number of Events recorded on a registered website during the Free Trial Period. Messages and/or Emails may be restricted or limited during the Free Trial Period.
...
If you cancel your Plan, you will lose all access, upon the expiration of your final paid period, to the Services and any data or information stored in your account (see Section 11 (“Term and Termination”) for additional details).

### 3\. Licenses

#### 3.1 LICENSE TO KISSMETRICS SOFTWARE

Subject to the terms and conditions of this Agreement, Kissmetrics hereby grants you a limited, revocable, non-exclusive, non-transferable and non-assignable license to (a) include the Kissmetrics-provided code (together with any fixes, updates and upgrades provided to you, the “Kissmetrics Script”) in the HTML code for web page(s) that are properly registered for the Services and owned or operated by you, solely for the purposes of accessing and providing information to the Services and accessing information available from the Services with respect to such web page(s); and (b) remotely access the Services to view and download your reports stored on the Kissmetrics Website, located at kissmetrics.io.
...
Kissmetrics’ Privacy Policy is incorporated into this Agreement by this reference and is available at [https://www.kissmetrics.io/privacy/](https://www.kissmetrics.io/privacy)  
...
#### 4.1 YOUR OBLIGATIONS WITH RESPECT TO COOKIES USED BY THE KISSMETRICS SCRIPT ON VISITORS TO YOUR WEBSITE
...
By using the Kissmetrics Script implementing the use of such cookies, you represent and warrant that: (a) you will comply with all applicable laws relating to the placement of such cookies on Visitors’ computers, including Directive 2009/136/EC of the European Parliament (“the Cookie Directive”) where it applies; (b) you have posted (or you will post) a privacy policy on each website on which you use the Services, which clearly and conspicuously discloses the use of such cookies and (c) you have obtained all required consents and authorizations from your website Visitors relating to the use of such cookies.
...
* you will comply with all applicable laws, including, but not limited to, those followed regarding the transfer of Personally Identifiable Information from the European Economic Area and/or Switzerland to the United States under the U.S. – EU Privacy Shield framework and U.S. – Swiss Safe Harbor, respectively, relating to the collection, use and disclosure of Visitor data, including Personally Identifiable Information, to Kissmetrics;
* you will provide all required notifications and obtain all required consents and authorizations from your website Visitors to permit Kissmetrics to collect, obtain and/or use Visitor data, including Personally Identifiable Information, relating to Visitor use of your website, for the purposes of providing the Services;
...
* you have posted (or you will post) a privacy policy on each website on which you use the Services, which contains a link to [Kissmetrics’ Privacy Policy](https://www.kissmetrics.io/privacy) and clearly and conspicuously states that:
    ...
    * Visitors may opt-out of this analytics and user interactions service by using Kissmetrics Opt-Out feature.
...
#### 4.4 KISSMETRICS LIMITS ACCESS TO YOUR INFORMATION
...
Kissmetrics reserves the right to aggregate certain categories of Client Data (such as internet browser usage and screen resolution) across some or all of the websites using the Services for the purposes set forth in Section 3.2 (“License to Client Data”).
...
#### 5.2 KISSMETRICS’ EXCLUSIVE RIGHT TO MANAGE MATERIAL
...
Except for the limited licenses expressly granted herein, Kissmetrics expressly reserves all right, title and interest in and to the Kissmetrics Script, content on the Kissmetrics Website, aggregate data and general trend reports described in sections 3.2(c)(iii) and 4.5, and all processing, analytics, and other software and technology used by Kissmetrics in the analysis of your website and/or the provision of the Services (“Kissmetrics Technology and Service”), including, without limitation, any derivatives, improvements, enhancements or extensions of the Kissmetrics Technology and Service conceived, reduced to practice or otherwise developed on or on behalf of Kissmetrics, all of which are valuable assets of Kissmetrics, and any copyright, patent or trademark or other intellectual property right, or federal or state right, pertaining thereto.

#### 5.4 Restrictions on Use and Compliance

##### You shall not

* Use, or allow the use of, the Kissmetrics Technology and Service, except pursuant to the limited rights expressly granted in this Agreement;
* Use the Kissmetrics Technology and Service in any manner that is inconsistent with user documentation, if any, supplied to you by Kissmetrics or inconsistent with Kissmetrics’ standard security procedures, if any, accessible through your user interface;
* Attempt to reverse engineer, hack into, or compromise any aspect of the Kissmetrics Technology and Service, or attempt to access data or account information of any other customer of Kissmetrics;
* Remove, obscure or alter any legal notices, including notices of intellectual property rights appearing in or on any materials delivered to you by Kissmetrics;
* Use, post, transmit or introduce any device, software or routine that interferes or attempts to interfere with the operation of the Kissmetrics Technology and Service;
* Use the Kissmetrics Technology and Services for academic research or research unrelated to your Visitors or the web page(s) registered for use with the Services, or for contemplated litigation, scholarship, or any other unintended purpose;
* Post or transmit any libelous, defamatory, indecent, obscene, abusive or pornographic message, data, image or program;
* Post or transmit any message, data, image or program that would violate any property rights of others using the Services or on the Kissmetrics Blog;
...
* You will provide a clear and conspicuous explanation to each recipient of a Message and/or Email regarding how recipients can opt out of or unsubscribe to receiving your message and you will provide a link to opt-out of or unsubscribe to all Message and/or Email you send. Such link must remain operational for a period of thirty (30) days after the date on which you send the Message and/or Email and must be in form and substance satisfactory to Kissmetrics.
...
You further understand and agree that, if you use the Services to send Messages and/or Emails to recipients outside of the United States, (A) you will review and comply with the anti-spam laws of the countries each recipient lives in, and (B) you will be solely responsible for all monetary penalties and other liabilities, and Kissmetrics will have no liability, for Messages and/or Emails sent through the Services that do not comply with and are in violation of such countries anti-spam laws.
...
EMAIL DELIVERABILITY. It is understood that Kissmetrics makes no guarantee that HTML messages will be rendered properly on all recipients’ email programs, due to the wide variety of HTML generation tools available. Kissmetrics makes every reasonable attempt to make sure that all Emails sent through our servers follow email standards and you understand and agree that we cannot guarantee that messages will look consistent across all email platforms due to the number of different HTML composition tools available.
...
Upon any termination of the Services (a) Kissmetrics will cease providing the Services; (b) you will delete all copies of the Kissmetrics Script from your web page(s); (c) any outstanding balance payable by you to Kissmetrics will become immediately due and payable and any collection expenses incurred will be included in the amount owed; (d) you will not be entitled to any refunds of any usage fees or any other fees; and (e) all of your historical report data will no longer be available to you through Kissmetrics.
...
[support@kissmetrics.io](mailto:support@kissmetrics.com)  
...
[Gets Started for Saas](#)

[Get Started for eCommerce](#)
