...
[Deutsch](https://yousician.com/de/privacy-notice) [English](https://yousician.com/privacy-notice) [Español](https://yousician.com/es/privacy-notice) [Français](https://yousician.com/fr/privacy-notice) [Italiano](https://yousician.com/it/privacy-notice) [日本語](https://yousician.com/ja/privacy-notice) [Português](https://yousician.com/pt_BR/privacy-notice) [Русский](https://yousician.com/ru/privacy-notice) [简体中文](https://yousician.com/zh_Hans_CN/privacy-notice) [繁體中文](https://yousician.com/zh_Hant_TW/privacy-notice)
...
_Last edited 10 January 2023_

Thank you for using Yousician services! This Privacy Notice explains what personal data Yousician Ltd. and its subsidiaries (“we” in this notice) collect about you and how we use your personal data, as well as the choices you have about your personal data. 

This Privacy Notice applies to all of Yousician’s services (such as our online music learning apps Yousician and Campfire, and our instrument tuning apps), websites like [yousician.com](https://www.yousician.com/) and related services and properties we control and which we collectively here call the “Services”. We may update this Privacy Notice from time to time by posting a new version of the Privacy Notice on [yousician.com](https://www.yousician.com/). If the changes we make are material, we will notify you by posting a notice in the Services or by other appropriate means. Please note that your use of the Services after the effective date is subject to the new Privacy Notice. 

The terms and conditions applicable to our Services have been set out in our [Terms of Service.](https://yousician.com/terms-of-service) 

#### 1. CONTACT US 

If you have any questions about this Privacy Notice or the ways we use your data, please contact us at [privacy@yousician.com](mailto:privacy@yousician.com). 
...
* If you make purchases in our Services, we receive data relating to the _transactions_ from the third-party payment service providers involved in those transactions to validate those purchases.
...
Providing data to us is not mandatory, but we are unable to provide the Services, or some parts or features of the Services, without processing your data. If you use our Services, we will collect data relating to you for some or all of the purposes described in this notice, depending on the Services you decide to use and your choices when using them. You have a number of options to control the extent to which we process your data, such as whether or not to connect your third party accounts to our Services, resetting or limiting the use of your advertising IDs in your device settings, or disable the use of cookies in our cookie banner and/or your browser settings, or opt-out of the sharing of your personal data for the purposes of personalized advertising in the privacy settings of our Services. 
...
We may show ads in our Services to enable you to access content in our Services free of charge. In order to show you ads in our Services, we may integrate SDKs into our Services provided by third-party ad partners. These third-party ad partners may show contextual or personalized ads based on your privacy preferences and whether you have opted-out of receiving personalized ads in the Service’s privacy settings. Please see a list of our third-party partners by clicking [here for more information.](https://yousician.com/privacy-notice-third-party)
...
Our Yousician app provides the possibility to control some of the social features of the app and what data you share with others. You can modify your preferences in the settings under the privacy tab of the app.

You also have the right to correct or update your information. You may do this by editing your personal details on your profile if your information changes or happens to be incorrect. Or you can contact us at [support@yousician.com](mailto:support@yousician.com).

You also have the right to object to our processing of your information to the extent our processing is based on legitimate interests. You can at any time ask us to stop using your information to send you marketing communications. In the Yousician application, you are able to modify your preferences concerning marketing communications (push and email) under the privacy tab in the Yousician application’s settings or by following the instructions in such communications. 

Any consent that you might have provided can be withdrawn at any moment.

For limiting interest based advertising, please check out your ad tracking settings of your mobile device or web browser. For your Android or iOS device, select “limit ad tracking” (Apple iOS) or “opt-out of interest-based ads” (Android) in the settings. For opting out of targeted advertising on the web, you can adjust your browser settings to limit certain tracking by cookies or by visit [www.youradchoices.com](https://www.youradchoices.com/) and/or [www.networkadvertising.org](https://www.networkadvertising.org/) .

Where applicable, you may also opt-out from receiving personalized ads through the options provided in the Service’s privacy settings. When you decide to opt-out of receiving personalized ads, you may still be served ads in the Service by our ad partners, however, these ads will be based on contextual data and may be less relevant to you. For more information on what ad partners we use and how they use your information, please click [here for more information](https://yousician.com/privacy-notice-third-party).

If you have any complaints about our handling of personal data or want to know about something specific in this regard, please email us a [privacy@yousician.com](mailto:privacy@yousician.com). We take these matters seriously and will look into all requests and complaints.

Finally, you always have the right to lodge a complaint with the local data protection authority (for example, the Office of the Data Protection Ombudsman in Finland).
...
When we collect personal data, we do not know your age, and we do not knowingly collect or solicit personal data from anyone under the age of 13 (or any other minimum legal age) or knowingly allow such persons to use our Service. If You are under 13 (or any other minimum legal age), please do not attempt to access our Services, take them into use, or send us any information about yourself. If you believe that we might have received any information from or about a child under the age of 13 (or any other minimum legal age), please contact us at [privacy@yousician.com](mailto:privacy@yousician.com).

#### 10. COOKIES AND SIMILAR TECHNOLOGIES

Cookies are small files stored on a user’s computer (or other internet enabled devices, such as smartphones) when an online service has been used. We and our partners use cookies and similar technologies to provide the Services and personalize it for you, to run analytics and target advertisements. Some of the cookies used in the Service are “first party” cookies, i.e. from the website itself, and others are third party (partner) cookies that belong to the advertising, analytics entities or social networks.
