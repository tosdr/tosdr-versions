...
This Privacy Policy describes the privacy practices of KeyMe, LLC ("KeyMe", "we", "our" or "us") in connection with consumer’s use of our mobile application (the "Application"), key duplication kiosks (the "Kiosks"), on www.key.me (the "Site") and the services, features, content or applications we offer (collectively with the Application, the Kiosks, and the Site, the "Services").
...
We may maintain pages for Key.me on social media platforms, such as Facebook, LinkedIn, Twitter, Google, YouTube, Instagram, and other third party platforms. When you visit or interact with our pages on those platforms, the platform provider’s privacy policy will apply to your interactions and their collection, use and processing of your personal information. You or the platforms may provide us with information through the platform, and we will treat such information in accordance with this Privacy Policy.
...
KeyMe will retain your fingerscan minutiae only until the earlier of the time that you delete your account, or within 3 years of your last interaction with KeyMe. You may also email [support@key.me](mailto:support@key.me) to request that we remove your fingerscan minutiae from our databases.

### What Choices Do You Have Regarding Your Information?

* **Access, update, and delete your information.** If you are a registered user, you can access and update certain information associated with your account by logging into the Services. You can delete your account by emailing [support@key.me](mailto:support@key.me).
* **Opt out of marketing communications.** You may opt out of marketing-related emails by following the opt-out or unsubscribe instructions at the bottom of the email, or by contacting us at support@key.me. You may continue to receive service-related and other non-marketing emails.
...
If you have any questions or concerns regarding privacy using the Services, please send us a detailed message to support@key.me. We will make every effort to resolve your concerns.
...
We do not sell personal information. As we explain in this privacy policy, we use cookies and other tracking tools to analyze website traffic and facilitate advertising. If you would like to opt out of our (and our third party advertising partners’) use of cookies and other tracking technologies, please review the instructions provided in the [Online Tracking Opt-out Guide](https://www.key.me/online-tracking-opt-out-guide).
...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| **Personal information we collect** | **CCPA categories (Definitions are available [here](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.5.&part=4.&chapter=&article=))** | **Sources of personal information** | **Purposes for which we may collect and use personal information** | **Categories of third parties to which we disclose personal information** |
| * Contact information,  <br>    <br>* Payment information | * Identifiers  <br>    <br>* Commercial information  <br>    <br>* Financial Information | * You | * Service delivery  <br>    <br>* Marketing  <br>    <br>* Compliance & Operations | * Service providers  <br>    <br>* With partners, at your direction |
| * Fingerscan minutiae | * Biometric Information | * You | * Service delivery<br>* Compliance & Operations |     |
| * Usage information  <br>    <br>* Information about your device’s hardware and software  <br>    <br>* Unique identifiers associated with your device  <br>    <br>* IP address  <br>    <br>* Demographic information  <br>    <br>* General location information, such as city, state, or geographic area  <br>    <br>* Inferences drawn from device data and online activity data | * Unique Identifiers<br>* Commercial Information<br>* Internet or Network Information<br>* Geolocation Data<br>* Inferences | * You<br>* Automatic collection | * Service delivery<br>* Marketing<br>* Compliance & Operations | * Advertising partners<br>* Service providers |
...
* call 1-855-343-5776
* email [support@key.me](mailto:support@key.me)
