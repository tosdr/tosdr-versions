...
Strictly necessary cookies cannot be deactivated. All other cookies can. If you choose not to use those cookies during your visit, you should be aware that certain functions and pages will not work as expected. As an example, you will not be able to use the shopping list feature.
...
You can also find out more about cookies and how to delete and control them on [www.aboutcookies.org](https://www.aboutcookies.org/) or click “Help” in your browser menu.
