...
| Source | purpose | Retention Period |
| --- | --- | --- |
| [DoubleClick](https://policies.google.com/privacy) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 2 years |
| [LinkedIn](https://www.linkedin.com/legal/privacy-policy) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 180 days |
| [ownerIQ](http://www.owneriq.com/privacy-notice) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 15 days |
| [SiteScout](http://www.sitescout.com/privacy) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 1 month/1 year |
| [Tapad](https://www.tapad.com/privacy-policy) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 2 months |
| [Facebook](https://www.facebook.com/privacy/explanation) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 90 days |
| [Salesforce DMP](https://www.salesforce.com/products/marketing-cloud/sfmc/salesforce-dmp-privacy/) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 180 days |
| [Centro](https://www.centro.net/privacy-policy/) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 1 month/1 year |
| [JD Power](http://www.jdpower.com/privacy) | These types of cookies are used for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 1 month/1 year |
| [Hubspot](https://legal.hubspot.com/privacy-policy) | These types of cookies are for identifying your preferences so we can personalize our marketing emails. Information collected includes your visits to our Site, geolocation, device type, and IP address. | Session/10 years |
| [NextRoll](https://www.nextroll.com/privacy) | These types of cookies are for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 12 months |
| [Demandbase](https://www.demandbase.com/privacy-policy/) | These types of cookies are for retargeting, so we can show you relevant ads based on your activity on our Site after you leave it. Information collected includes an identifier, and sometimes your geolocation, device type, and IP address. | 13 months |
...
| Google Analytics | We use [Google Analytics](https://support.google.com/analytics/answer/6004245?hl=en) in certain markets to generate statistical data on how our visitors use our Site. We use IP masking to ensure that **no personally identifiable information is collected.** | Session/2 years |
