...
d. Stored Data. We allow You to upload certain types of data about Yourself, including but not limited to Your contact information, educational history, professional qualifications and other information as prompted by the Services (collectively, “Stored Data”) during registration and regular use of the Services. You agree to (i) provide true, accurate, current, and complete Stored Data; and (ii) maintain and promptly update the Stored Data to keep it true, accurate, current, and complete. If You provide any information that is untrue, inaccurate, not current or incomplete, or Evident has reasonable grounds to suspect that such information is untrue, inaccurate, not current or incomplete, Evident has the right to suspend or terminate Your Account and refuse any and all current or future use of the Evident Properties (or any portion thereof). You agree not to create an Account using a false identity or information, or on behalf of someone other than Yourself. Stored Data is stored using encryption. Still, Evident cannot and does not guarantee the security, completeness, or integrity of any Stored Data or that the Stored Data will not be corrupted or lost. You acknowledge that the Services limit the practical ability to modify certain Stored Data after it has been provided or verified. For example, if Your legal name has been verified by a state identification authority, You must change Your name first with the state before the change can be made using the Services. Additional information about Your rights to manage Your personal data in Your Stored Data is provided in our Privacy Policy available at https://www.evidentid.com/privacy-policy.
...
a. Pre-Arbitration Claim Resolution. For all Disputes, whether pursued in court or arbitration, You must first give us an opportunity to resolve the Dispute which is first done by emailing to us at support@evidentid.com with the following information: (1) Your name, (2) Your address, (3) A written description of Your Claim, and (4) A description of the specific relief You seek. If we do not resolve the Dispute within 45 days after receiving Your notification, then You may pursue Your Dispute in arbitration. You may pursue Your dispute in a court only under the circumstances described below.

b. Exclusions from Arbitration/Right to Opt Out. Notwithstanding the above, Your or we may choose to pursue a Dispute in court and not by arbitration if: (a) The dispute qualifies for initiation in small claims court; or (b) YOU OPT-OUT OF THESE ARBITRATION PROCEDURES WITHIN 30 DAYS FROM THE DATE THAT YOU FIRST CONSENT TO THIS AGREEMENT (the “Opt-Out Deadline”). You may opt-out of this Arbitration Provision by emailing us at [support@evidentid.com](mailto:support@evidentid.com) the following information: (1) Your name; (2) Your address; (3) A clear statement that You do not wish to resolve disputes with us through arbitration. Your decision to opt-out of this Arbitration Provision will have no adverse effect on Your relationship with us. We do enforce the Opt-Out Deadline so **any opt-out request received after the Opt-Out Deadline will not be valid and You must pursue Your dispute in arbitration or small claims court.**
