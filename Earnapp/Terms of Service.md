...
Information regarding your use, credits and applicable rates can be found on the EarnApp dashboard (https://earnapp.com/dashboard) or FAQ page (https://earnapp.com/faq/).
...
Information regarding your use, credits and applicable rates can be found on the EarnApp dashboard (https://earnapp.com/dashboard) or [FAQ page](https://help.earnapp.com/hc/en-us/articles/12456135504657-How-much-will-I-get-paid-for-EarnApp-and-what-are-the-requirements-) .
...
Earnings from referral programs will be added to EarnApp balance and will show in your dashboard.  
...
In consideration for continued access to the EarnApp, you agree to adhere to the terms governing member conduct as written herein. You understand that your account and any Credits you have earned can be terminated or suspended at the sole discretion of Bright Data if Bright Data reasonably believes you have violated the terms of member conduct in any way. You understand that EarnApp and software embedded within EarnApp may include security components that monitor the use and conduct of users. You may not attempt to override or circumvent any of the security measures, monitoring measures, or usage rules embedded into EarnApp. Any unauthorized modification of any kind of the software provided by Bright Data, in whole or in part, is strictly prohibited.

When using EarnApp, you agree not to:

1. cheat, defraud, game, mislead, misinform, trick, or deceive Bright Data in any way in order to accrue Credits or for any other reason;
...
4. forge headers or otherwise manipulate identifiers in order to disguise the origin of any Content transmitted through the Bright Data Service;
