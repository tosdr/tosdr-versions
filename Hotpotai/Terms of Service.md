...
All content created and obtained via this website is subject to the following Terms of Use.
...
Please read these Terms of Use carefully because they affect your legal rights and include an agreement to resolve disputes that may arise between us. We believe these rules simplify and enhance the service for all users.
...
These Terms of Use (Terms) govern the access, browsing and use by the users (User or Users, as applicable) of this website as well as the services rendered through this website (Service or Services, as applicable) which include the downloading, uploading, and usage of graphics, photos, text, links, and other content (Content). Rights not expressly granted to the User by the Terms are reserved exclusively for Panabee LLC (Company). In particular, the Company strongly advises Users to review and understand the Intellectual Property section.
...
Legal Compliance And Output Uniqueness
--------------------------------------
...
The Services are built on software that require redistribution of licenses. [See here](https://hotpot.ai/terms/licenses) for the list.
