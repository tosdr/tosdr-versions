...
1. [Introduction](#1th)
2. [Certain Terms](#2th)
3. [Personal Data Collection](#3th)
4. [Cookies, Web Beacons and Other Analysis Tools](#4th)
5. [How We Use Your Information](#5th)
6. [How We Disclose Your Information Outside GL.iNet](#6th)
7. [International](#7th)
8. [What Data Protection Settings Are Available](#8th)
9. [Retention of Personal Information](#9th)
10. [Your Rights](#10th)
11. [Accessing, Reviewing and Changing Your Personal Information](#11th)
12. [Third-Party Services](#12th)
13. [Individuals Located in the EEA or Switzerland](#13th)
14. [Privacy of Children Online](#14th)
15. [Limitation of Liability](#15th)
16. [Changes to This Privacy Policy](#16th)
17. [Contact Us](#17th)

1\. Introduction
----------------

GL Technologies (Hong Kong) Limited, and its affiliates and subsidiaries (collectively, “GL.iNet” “we” “us,” or “our”) takes your privacy seriously. If you are a visitor to GL.iNet Website, a recipient of GL.iNet communications or a customer of GL.iNet then except as expressly set forth below, this Privacy Policy applies to your use of such Website or Service. This Privacy Policy describes how we collect, use, disclose, transfer, and otherwise process your Personal Information. It also tells you about your rights with respect to your Personal Information, and how you can reach us to update it or get answers to questions you may have about our privacy practices.

2\. Certain Terms
-----------------

This Privacy Policy covers the processing of Personal Information related to GL.iNet products and services (“Services”), including:

* GL.iNet hardware products (“Products”),
* website(s) that may be accessed at https://www.gl-inet.com/ (“Site”),
...
* Registration is required in order to use the Services, we may ask you to provide certain Personal Information when you create an account on GL.iNet or install and register to GL.iNet-marked software(s), register a product, complete a survey, or sign up to be on our mailing list. We may ask you to submit the following types of Personal Information: first and last name, country, email address, product serial number, date of purchase, telephone number, shipping address, and proof of purchase. We may also collect additional personal information such as your interests or hobbies, your gender or age.
* Information you voluntarily share or post. We may collect Personal Information that you provide in GL.iNet and GL.iNet-marked software(s), or post in a public space on our website, such as message boards.
...
* For the performance of GL.iNet services. This element covers all technical and commercial processes required to carry-out user requests.
...
* Processing is based on GL.iNet's legitimate interest to conduct its business, improve its product and service offerings, and facilitate communication.
* Promotional communications.
* Processing is based on your consent.
* For linking various user accounts (i.e. the GL.iNet account with other social media or email accounts) and extracting information for specialized requested services.
* To provide customer service and ensure the security of our operations.
* Processing is based on the legal obligation to ensure the confidentiality of processing and GL.iNet's legitimate interest to secure its operations.
...
6 How We Disclose Your Information Outside GL.iNet
--------------------------------------------------

**GL.iNet DOES NOT SELL OR RENT YOUR PERSONAL DATA TO ANY THIRD PARTIES WHATSOEVER.**
...
In addition, the third parties may also integrate GL.iNet's Products and Services into their products and services. We are NOT responsible for this integration.
...
4. We (or a third party) have a legitimate interest in using your Personal Information. In particular, we have a legitimate interest in using your Personal Information for things like:
    ...
    * Customizing our Services to provide you with a better GL.iNet user experience
    * Marketing to inform existing customers about our Services
    * Detecting, preventing, or otherwise addressing fraud, abuse, security, or technical issues with our Services
    * Protecting against harm to the rights, property or safety of GL.iNet, our users, or the public as required or permitted by law
