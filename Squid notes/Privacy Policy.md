...
* [Home](https://www.squidnotes.com/)
* [Features](https://www.squidnotes.com/)
* [Education](https://www.squidnotes.com/edu)
* [Blog](https://www.squidnotes.com/blog)
* [About](https://www.squidnotes.com/about)
* More
    

Use tab to navigate through the menu items.

* [](https://www.facebook.com/SteadfastInnovation)
* [](https://twitter.com/squidnotes)
* [](https://www.youtube.com/user/SteadfastInnovation)

##### End User License Agreement

###### By downloading this application from Steadfast Innovation, LLC (here after referred to as "The Company"), installing or using this application or any portion thereof ("Application"), you agree to the following terms and conditions (the "Terms and Conditions").
...
3. THE COMPANY TERMS OF SERVICE AND PRIVACY POLICY  
    ...
    1. We recognize that privacy is important and appreciate your trust to provide The Company with information to improve our applications and services.
        
    2. We reserve the right to collect anonymous app usage data and crash reports to fix bugs and improve the Application. We do NOT collect any information to identify the user or the device.
        
    3. The Application works completely offline. All user data is stored directly on the device. The user may create a backup of their data to a third-party cloud storage account. We do NOT collect any user data.
        
    4. User data can be exported in a portable format (see [here](https://takeout.squidnotes.com/) for details).
        
    5. The Application conforms to COPPA, FERPA, and GDPR requirements.
        
    6. Any privacy questions can be directed to [help@squidnotes.com](mailto:help@squidnotes.com).  
         
...
© 2024 Steadfast Innovation, LLC

[Translate](http://translate.squidnotes.com/)

[Feedback](http://idea.squidnotes.com/)

[FAQ​](http://faq.squidnotes.com/)

[Contact](mailto:support@squidnotes.com)

[Terms](https://www.squidnotes.com/terms)
