...
• [CCPA/California Consumer Privacy Act](https://www.ironmountain.com/utility/legal/california-consumer-privacy-act)

• [China](https://ironmountain.com.cn/zh/utility/legal/china-privacy-policy)
...
What type of personal data we collect and use
...
•**Technology enabled Collection of Personal Data (website visitors):** Iron Mountain websites use various cookies and similar technologies. A cookie is a small text file placed onto your device, by a website that you visit. These files allow Iron Mountain’s websites to improve user experience by delivering content tailored to users’ interests and enabling other features. You have a variety of tools to control the data collected by cookies and similar technologies. Where required, Iron Mountain uses cookies only upon your consent. For instance, cookies that provide you with customized content. Iron Mountain websites allow you to control some cookies through their cookie banners or browser settings.
...
We process Personal Data of our customers as a data processor without reviewing the content or origin of such Personal Data. We may collect, store and process such Personal Data solely on our customers’ behalf and at their direction. Our customers who use our services in this way are data controllers and are responsible for obtaining any consents, permissions and for providing privacy notice required for the collection and use of such information. How we share your personal data
...
• Iron Mountain complies with the EU-U.S. Data Privacy Framework (EU-U.S. DPF), the UK Extension to the EU-U.S. DPF, and the Swiss-U.S. Data Privacy Framework (Swiss-U.S. DPF). You may find more information [here](https://edge.sitecorecloud.io/ironmountain-c8dd68e9/media/project/iron-mountain/iron-mountain/files/utility/legal/data-privacy-framework-statement.pdf?sc_lang=en).
...
Data subject/consumer rights: How to access and control your personal data
...
1. **access and obtain a copy of your Personal Data** – note that We may need to check your identity first to avoid disclosure to any unauthorised person and also respect the right to privacy of other individuals when providing you access or copy of your Personal Data;
2. **rectify or erase your Personal Data** – if data is inaccurate or incomplete;
3. **restrict the processing of your Personal Data** – e.g., when you question the accuracy of processing, and We restrict processing only until your request is verified;
4. **delete or anonymise your Personal Data** (under GDPR “right to be forgotten”) unless there are exceptions, e.g., when law allows us such processing;
5. **ensure so-called “data portability”** - upon your request, Iron Mountain might “transfer” your Personal Data to another organisation/company if processing is based on your consent or the performance of a contract;
6. **object to the processing of your Personal Data** - e.g., when We process your Personal Data based on our legitimate interest or for direct marketing purposes and the processing is carried out by automated means;
7. **obtain a copy of Personal Data safeguards applied for transfers outside your jurisdiction** \- e.g., the copy of SCCs;
8. **lodge a complaint with your local supervisory authority:** Data Protection Authority, e.g., ICO in the UK;
9. **withdraw your consent for the processing of your Personal Data** (however this does not affect the lawfulness of processing based on consent before its withdrawal).
...
* Industry solutions
    ...
    * [Entertainment](https://www.ironmountain.com/industries/entertainment)
