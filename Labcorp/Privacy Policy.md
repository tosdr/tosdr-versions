...
Labcorp Web Privacy Statement
-----------------------------

Laboratory Corporation of America Holdings and its subsidiaries, including Laboratory Corporation of America (collectively "Labcorp", “We”, “Us” or “Our”), is a leading global life sciences company that is committed to protecting your (“Your” or “You”) information that We may collect from or which You may submit to or through [www.Labcorp.com](https://www.labcorp.com/) or other Labcorp websites or mobile applications that directly link to this privacy statement (collectively, the “Website”).

This privacy statement (the “Privacy Statement”), together with Our Terms of Use, describes how We may use Your information and how that information may be used or disclosed by Us.
...
Generally, You can visit the Website without revealing who You are and without disclosing any of Your information. However, there may be times when We require information about You or Your device, or when You wish to disclose such information to Us. Such information is obtained when You use our Website or it is submitted by You, and is subject to the provisions set out in this Privacy Statement.

We collect and process the following information:

* Unique identifiers, such as Your name, postal address, online identifier, email address, account name, or other similar personal identifiers.
* Protected classification characteristics under applicable laws, such as Your age (40 years or older), race, ancestry, national origin, medical condition, physical or mental disability, sex (including gender, pregnancy and related medical conditions), genetic information (including familial genetic information).
* Commercial information, such as records of products or services purchased or obtained, or correspondence from You.
* Usage information and other similar network activity, such as browsing history, device ID, search history, Internet Protocol address, information on Your interaction with a website, device geolocation, application type and version, or advertisements placed and ad interactions.
* Professional or employment-related information, such as current or past job history or performance evaluations.

We obtain the information listed above:

* Directly from You, such as from documents or forms You provide to Us, or preferences You express or provide when accessing our services;
* Indirectly from You, such as by observing Your activity when receiving, using, or accessing our services;
* Automatically from You, such as through the use of tracking technologies and other cookies as You use our digital services, including Our websites and mobile applications; or
* From third-parties, such as to monitor and analyze the use of our websites, mobile applications, for payment processing, or other third-party vendors that We use to provide services to You, including websites and mobile applications through the course of providing services to You or jointly with Us.

Where required by law, We may ask for Your additional explicit consent to collect information considered to be sensitive personal information (such as information about Your ethnicity or health information). You may withdraw such consent at any time by contacting Us at the details below.

We do not ask You to provide personal health care information to Us through our general website.\* We obtain personally identifying information about You only if You voluntarily choose to provide such information via correspondence with Us. Feedback forms used in Labcorp correspondence specifically request that You not include personal information such as user names, passwords, social security numbers, and private health information. Correspondence conducted via Labcorp feedback forms is stored on a third-party server and then downloaded by Labcorp personnel.

\* If You are a user of Labcorp Link or other specific Labcorp Connectivity Solutions or programs, You may be asked to provide personal information through those applications. In addition to the general applicability of this Privacy Statement to those products, use of those applications and any information collected through there, are governed by specific end user agreements, as well as Labcorp’s [Notice of Privacy Practices](https://www.labcorp.com/hipaa-privacy) relating to use and disclosure of individually identifiable health information.

If You are a user of the Labcorp Patient mobile application, You may be asked to grant access to Your device’s file storage to store and retrieve data in order to view PDF files in the application.

Various Labcorp webpages and programs give users the option to make electronic payment for services. Information from these bill payment links is not tracked or recorded but may be transmitted to independent third parties for payment processing.
...
* To fulfill or meet the reason for which the information is provided, including to process payments and other financial transactions.
* To provide You with information, products, or services that You request from Us.
* To provide You with electronic messages consisting of alerts, reminders, event registrations and other notices concerning Our products or services, appointments, events, or news that may be of interest to You.
...
* As described to You when collecting Your information directly or as otherwise set forth under applicable law.

When we use Your contact information to communicate to You about new services and products that may be of interest to You, You will be given the option of receiving periodic informational/promotional mail or email from Us. You choose whether or not to receive correspondence when You provide this information or by changing Your preferences within Your registration profile or by following the instructions provided in the email at any time.
...
Your personal information may be transferred to, stored, and processed in a country other than the one in which it was provided, including the U.S. (i.e., a ‘Recipient’ country). Labcorp will use mechanisms for any such transfer as required under applicable law. If You have questions concerning the transfer of Your information, please contact Us using the contact details set out below.

### Third Parties Disclosures

We may share Your Personal Information with agents, contractors, or partners of Labcorp in connection with services that these individuals or entities perform for, or with, Labcorp. We may, for example, provide Your information to agents, contractors, or partners for hosting Our databases, for data processing services, or so that they can mail You information that You requested.

Labcorp will disclose Your information in response to duly authorized information requests of any law enforcement agency, court, regulator, government authority, or other third party, where We believe such disclosure is necessary to comply with a legal or regulatory obligation, or otherwise to protect Our rights or the rights of any third party, including to identity or locate anyone for the prevention or detection of crime or the apprehension or prosecution of offenders. You waive and hold Us harmless from any claims resulting from such disclosures and from any actions taken as a consequence of investigations by either Us or law enforcement authorities.

We will also transfer your information to a third party in connection with the sale, assignment, or other transfer of Our business to which the information relates.
...
We reserve the right to take any appropriate legal action, including referral to law enforcement, for any illegal or unauthorized use of this Website. We also reserve the right take any action to prevent the unauthorized use of Our intellectual property.

### The Retention of Your Information

We will retain and use Your information to the extent and for a period permitted under applicable law, including as necessary to comply with our legal obligations, resolve disputes, enforce our legal agreements and policies, and protect Our property.
...
We will not be liable where Your password or user name is used by someone else. You agree to notify Us immediately at the contact information provided below of any unauthorized use of Your password or user name of which You become aware. We have the right to disable any user identification code or password, whether chosen by You or allocated by Us, at any time to safeguard your account and data.

Please be aware that while We take appropriate steps to safeguard the security of Your Personal Information, the transmission of information over the Internet is not completely secure and therefore You do this at Your own risk.

Financial information and payment data, including credit card numbers, that You provide to Us via the Labcorp internet bill payment link is encrypted. This information will be accessed only by Labcorp agents and employees and third-party vendors who support Labcorp’s billing operations.

We implement technical and organizational measures to maintain a level of security appropriate to the risk to the Personal Information We process.

To request that Your Personal Information be deleted from Our databases, please see below for more information.

### Cookies and Our Use of Tracking Technologies
...
Labcorp also uses the services of Google Analytics and other similar software to analyze traffic to the various Labcorp webpages. Data collected regarding site usage is compiled in aggregate to improve the performance of the site, create a profile of uses, and improve our marketing and advertisements. By accessing our Website, You expressly consent to the use of these tracking technologies, and this data collection and use.

If You do not wish Your information to be included in aggregated data through Google Analytics, You can download and install Google’s “Google Analytics Opt-out Browser Add-on” available [here](https://tools.google.com/dlpage/gaoptout). If You wish to prevent the use of cookies or for Your information to be included in aggregated data through Google Analytics, You must modify the properties on Your web browser for both as described above.

We are giving You notice of the tracking technologies and Your available choices regarding them so that your consent is meaningfully informed. You are responsible for managing any preference changes on your device or browser. Generally, certain tracking technologies may be rejected, disabled or removed by tools that are available as part of most commercial browsers, and in some but not all instances can be blocked in the future by selecting certain settings. Each browser You use will need to be set separately and different browsers offer different functionality and options in this regard.

Please be aware that if You disable or remove these tracking technologies some parts of our Website may not work and when You revisit Our Website your ability to limit browser-based tracking technologies is subject to Your browser settings and limitations.
...
The Labcorp Website may contain links to a number of sites that may provide useful information. Links contained on the Labcorp Website that transfer You to a non-Labcorp site are not maintained by Labcorp and may contain different information and/or different privacy policies from those of our Company. You may review the privacy policies of these websites and/or receive specific information regarding that site's privacy policies and procedures after leaving the Labcorp site. Labcorp is not responsible for the content or privacy practices of a non-Labcorp Website. Labcorp does not control, or have any input into, whether our business partners or internet-linked sites, use or accept cookies on their sites.
...
You should be aware that this Site is not intended for, or designed to attract, individuals under the age of 18. If You are a parent or guardian and You are aware that Your child has provided Us with personal information, please contact Us.

### Your Rights over Your Personal Information

You may have certain rights regarding Your personal information, subject to local law. These may include the right to:
...
We encourage You to contact Us to update or correct Your personal information if it changes or if the information We hold about You is inaccurate. Please note that We will likely require additional information from You in order to honor Your requests.

You may request that Your personal information be deleted, You may continue to receive materials for a short period while We are updating Our lists. Your records will then be permanently deleted from Our systems.
