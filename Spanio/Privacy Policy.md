...
Span.IO, Inc. (“Span”, "us", "we", or "our") operates the [www.span.io](https://www.span.io/) website, the Span Home and Span Installer mobile applications, and Span products (hereinafter referred to as the "Service").
...
**Span respects your right to privacy and the use of your personal information.** This Privacy Policy is designed to provide transparency in informing you of our policies regarding the collection, use and disclosure of personal information when you use our Service and the choices you have associated with that personal information. Span values transparency about the types of personal information collected and its use.**‍**‍
...
* **From digital platforms** such as via our websites, mobile and software applications, social media pages including when you make a purchase, opt in for newsletters, or register your Span product with us.
* **From your Span Account.** When you purchase and register your Span product, a mobile app account will be associated with your product.
* **From payment applications** and other forms such as credit related information, date of birth, bank routing information when you make a purchase directly from Span.
* **From other sources** such as from our certified installers, sales, and marketing partners.
* **From your device or browser** such as Usage Data sent automatically whenever you visit our Service or when you access the Service by or through a mobile device. This Usage Data may include information such as your computer's Internet Protocol address (IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data. When you access the Service with a mobile device, this Usage Data may include information such as the type of mobile device you use, the IP address of your mobile device, your mobile operating system, the type of mobile Internet browser you use, unique identifiers and other diagnostic data.

When visiting the Span website or using our Services, we use cookies and similar tracking technologies to track the activity on our Service and we hold certain information:

* **Cookies** are files with a small amount of data which may include a unique identifier. Cookies are sent to your browser from a website and stored on your device. Other tracking technologies are also used such as beacons, tags and scripts to collect and track information and to improve and analyze our Service.
* **Examples of Cookies** we use are: (1) Necessary Cookies used to operate our Service, (2) Preference Cookies used to remember your preferences and various settings, and (3) Targeting Cookies used for advertising purposes.
* **Disabling Cookies.** You can instruct your browser to refuse cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service. More information on disabling cookies may be found from your browser’s support pages.
* **Analytics tools.** Span may use analytics services such as Google Analytics that use cookies and similar tools to collect information about use of websites or applications to report trends without displaying the identity of individual users. To learn about the opt-out process you can download the Google Analytics Opt-out Browser Add-on [here](https://tools.google.com/dlpage/gaoptout) (https://tools.google.com/dlpage/gaoptout).
...
### Information from or about you or your SPAN products

We may collect information from or about your SPAN products or your home from you, from your electric utility, via a Span certified installer partner, or from the product itself (directly or via paired equipment, such as a solar inverter). This includes but is not limited to:

* **Product performance data** to provide and continually improve our products and services, such as installation location and setup information, data related to product performance and use (e.g. battery efficiency, solar production, and other energy data), information related to your home energy consumption, technical information from the mobile app, and other data relevant to diagnostics and troubleshooting.
* **Product installation information** such as the configuration of your electric system, information about your solar and battery system, installation date, and serial number(s).

If you do not wish for Span to collect performance or other personal information about you from Span products, please contact us using the information in the “Contact Us” section below. Please note that opting out of the performance data collection from your Span product prevents Span from identifying and notifying you of issues applicable to your product functionality and performance in real time. This may result in reduced performance, damage or inoperable, and may impact certain features such as periodic software updates.

Use of Information
------------------

Span uses the data described above for various purposes, including:

### To communicate with you

Such as:

* To respond to your inquiries regarding our products and Service.
* To complete or fulfill your purchase, including processing payments and delivering your product.
* To notify you about changes to our Service.
* To advise you of important functional or safety information about your Span product.
...
* To gather analysis, usage or other information so that we can improve our products and Service.
* To monitor performance and use of your products and Service.
* To share insights related to additional products and/or services intended to improve your experience and improve your energy consumption.
* To analyze, detect, prevent and address technical issues, security, abuse, fraud or other issues with our products and Service.
* To provide customer support.
* Other uses which we notify you about or which you consent to.

Span may use or share non-personally identifiable information for any purpose, such as for business or research purposes, for analysis that benefits the public or industry, to modify and improve our products and Service, to adjust products and Services to fit your needs, and when permitted legally.

**Sharing Personal Information**
--------------------------------

Span may share your personal information in the following cases:

### With your permission

We may share personal information with your permission, such as to add an authorized user to your Span account or if you sign up for programs offered by third party partners (e.g. utilities or energy aggregators). Please note, the terms and privacy policies of any third party partners will govern your use of those products and services.
...
If Span.IO is involved in a merger, acquisition or asset sale, your personal information may be transferred.

### For legal reasons

Under certain circumstances, Span may disclose your personal information if permitted to do so by law or in response to valid requests by public authorities (e.g., a court or a government agency).

Please note that if you choose a third party for the purchase or installation of your Span products and share your personal information, we cannot control collection, storage or use of your personal information by that third party. Always review the privacy statements for any company that intends to collect your personal information.
...
* Configuring your browser to decline cookies where you choose.
* Opting out of analytics tools.
* Opting out of marketing communications.
* Disabling the collection of certain personal information from our products and Service.
* Editing device permissions and changing in-app settings.

Opt-Out of Email. If you wish to opt out of marketing and promotional communications from Span, please contact us using the information in the “Contact Us” section below or click the “unsubscribe” button at the bottom of your email. Please note that we may continue to contact you with important safety or administrative messages even if you choose to opt out from marketing communications.
...
[Privacy Policy - March 01, 2020](https://cdn.prod.website-files.com/628f26de26f0252b4094378b/629f1ef9bee3b06d90786cfb_Privacy-Policy-3-1-20.pdf)
