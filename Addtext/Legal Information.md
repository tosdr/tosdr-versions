...
This privacy notice discloses the privacy practices for AddText.com which is run by FlamingText.com Pty Ltd. This privacy notice applies solely to information collected by this web site.
...
We will not share your personally identifiable information with any third party outside of our organization other than as necessary to fulfill your request, to comply with the law or to satisfy any requirements in the event of a company reorganization that may involve the merger, acquisition or sale of our assets.

If you Share your creation, and allow "Public background", then this will allow others to use your image. You are agreeing to make it public. (If you don't agree, then de-select "Public background"). If you use our "Share" link, it will create a public facing page that anyone can view (if they know the URL). We don't currently link to the creations (Jan 2014), but in the future we may add a feature for people to view popular and recently created images.

### Security

If we add user accounts or payment options, we will update this section to let you know what security precautions we take to protect your information.
...
We use "cookies" on this site. A cookie is a piece of data stored on a site visitor's hard drive to help us improve your access to our site and identify repeat visitors to our site. For instance, when we use a cookie to identify you, you would not have to log in a password more than once, thereby saving time while on our site. Some services on this web site require that you are a registered user. To determine if you are registered and currently logged in, we use a cookie to keep track of this information.
