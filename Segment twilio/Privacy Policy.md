* English
    ...
    * [日本語](https://segment.com/ja-jp/legal/privacy)
    * [English ![Selected language icon](/content/dam/twilio-com/core-assets/design-ops/component-svgs/check-black.svg)](https://segment.com/en-us/legal/privacy) 
...
* Support
    ...
    * [Support Plans](https://segment.com/en-us/support-plans)
    * [Partner Solutions](https://segment.com/en-us/partner-solutions)
...
* Products
    ...
    * [**Voice**
        ...
        Make, receive, and monitor calls around the world](https://segment.com/en-us/voice)
    ...
    * [Twilio Lookup logo
        ...
        **Lookup**
        ...
        Know your customer and assess identity risk with real-time phone intelligence](https://segment.com/en-us/user-authentication-identity/lookup)
    ...
    * [Twilio SendGrid Email API logo
        ...
        **Email**
        ...
        Deliver email messages reliably at scale with SendGrid](https://segment.com/en-us/sendgrid/email-api)
    * [Twilio Task Router logo
        
        **Serverless**
        
        Build, deploy, and run apps with Twilio’s serverless environment and visual builder](https://segment.com/en-us/serverless)
    * [Twilio Phone Numbers logo
        
        **Phone Numbers**
        
        Access local, national, and toll-free phone numbers](https://segment.com/en-us/phone-numbers)
    ...
    * [Twilio Flex logo
        ...
        **Twilio Flex**
        ...
        Digital engagement center for customer service and sales](https://segment.com/en-us/flex)
        
        [Contact center](https://segment.com/en-us/flex/use-cases/contact-center)
        
    * [Twilio Engage logo
        
        **Twilio Engage**
        
        Create multi-channel campaigns with a unified data-first platform](https://segment.com/en-us/engage)
    * [Twilio Marketing Campaigns logo
        
        **Marketing Campaigns**
        
        Create and manage email marketing campaigns with SendGrid](https://segment.com/en-us/sendgrid/marketing-campaigns)
    ...
    * [**Journeys ↗**
    ...
    [See all products](https://segment.com/en-us/products)
...
* Solutions
    ...
    * [**Marketing & promotions**
        ...
        Create multichannel marketing campaigns.](https://segment.com/en-us/use-cases/marketing-and-promotions)
        
        [SMS marketing](https://segment.com/en-us/solutions/text-marketing) [Customer surveys](https://segment.com/en-us/use-cases/automated-customer-surveys)
        
    * [**Contact Center**
        
        Provide personalized, data-driven service.](https://segment.com/en-us/flex/use-cases/contact-center)
    * [**IVR & self-service**
        
        Set up a modern IVR with AI-enabled support.](https://segment.com/en-us/use-cases/ivr)
        
        [Call tracking](https://segment.com/en-us/use-cases/call-tracking)
    ...
    * [**Marketing**
        ...
        Keep customers engaged on any channel](https://segment.com/en-us/solutions/marketing)
    * [**Product & Engineering**
        
        Connect with target users reliably and securely](https://segment.com/en-us/solutions/product-and-engineering)
    * [**Customer Experience**
        
        Deliver personalized sales and support experiences at scale](https://segment.com/en-us/solutions/customer-experience)
    * [**Developers**
        
        Tutorials and docs to start building on Twilio](https://segment.com/en-us/ahoy)
    
    ##### Industries
    
    * * *
    
    * [**Financial Services**](https://segment.com/en-us/solutions/financial-services)
    * [**Healthcare**](https://segment.com/en-us/solutions/healthcare)
    * [**Hospitality**](https://segment.com/en-us/solutions/hospitality)
    ...
    * [**Find a partner**
        ...
        Work with a Twilio partner to buy or build the right solution](https://segment.com/en-us/partner-solutions/partner-showcase)
    * [**Partner with us**
        
        Join our Partner Program to build or sell Twilio solutions to your customers.](https://segment.com/en-us/partner-solutions)
...
* Developers
    ...
    * [**Ahoy!**
        ...
        Get inspired by the latest from our developer community](https://segment.com/en-us/ahoy)
    * [**Developer Blog**
        
        Read tutorials, community projects, and product updates](https://segment.com/en-us/blog/developers)
    * [**Stack Overflow**
        
        Ask the Twilio community for help](https://stackoverflow.com/collectives/twilio)
    * [**Champions**
        
        Become a Twilio community Champion](https://segment.com/en-us/champions)
    ...
    * [**Changelog**
        ...
        See updates and additions to Twilio products](https://segment.com/en-us/changelog)
    * [**API Status**
...
* Why Twilio
    ...
    * [**Why Twilio**
        ...
        The trusted platform for data-driven customer engagement across any channel.](https://segment.com/en-us/why-twilio)
    * [**About Us**
        
        Twilio company page](https://segment.com/en-us/company)
    * [**Twilio Magic**
        
        Twilio core values](https://segment.com/en-us/company/values)
    * [**Diversity**
        
        Diversity, equity, and inclusion](https://segment.com/en-us/company/diversity)
    * [**Investor Relations**
        
        Information for Twilio investors](https://investors.twilio.com/)
    * [**Press & Media**
        
        Latest announcements and launches](https://segment.com/en-us/press)
    ...
    * [**Customer Engagement Platform**
        ...
        Build durable customer relationships with personalized, data-driven engagement](https://segment.com/en-us/customer-engagement-platform)
    ...
    * [**Super Network**
        ...
        Simplify, strengthen and unite carrier communication networks using software.](https://segment.com/en-us/super-network)
    ...
    * [**Resource Center**
        ...
        Browse our content library for more resources on how you can create lasting customer relationships](https://segment.com/en-us/resource-center)
    * [**Customer Stories**
        
        See what customers are building with Twilio](https://customers.twilio.com/en-us)
    * [**Blog**
        
        Explore the latest product updates, technical tutorials, and best practices](https://segment.com/en-us/blog)
    * [**State of Customer Engagement**
        
        See the top trends shaping customer engagement in our annual report](https://segment.com/en-us/state-of-customer-engagement)
    * [**Twilio Events**
        
        Join upcoming group events](https://segment.com/en-us/events)
...
* Pricing
    ...
    * [Twilio Messaging logo
        ...
        **Messaging**](https://segment.com/en-us/pricing/messaging)
        
        [SMS](https://segment.com/en-us/sms/pricing/us) [Whatsapp](https://segment.com/en-us/whatsapp/pricing) [Conversations](https://segment.com/en-us/messaging/pricing/conversations-api)
    ...
    * [Twilio Programmable Voice logo
        ...
        **Voice**](https://segment.com/en-us/voice/pricing/us)
        
        [Conferencing](https://segment.com/en-us/voice/conference/pricing) [SIP trunking](https://segment.com/en-us/sip-trunking/pricing/us)
    ...
    * [Twilio Verify logo
        ...
        **Verify**](https://segment.com/en-us/verify/pricing)
    * [Twilio Lookup logo
    ...
    * [Twilio Flex logo
        ...
        **Twilio Flex**](https://segment.com/en-us/flex/pricing)
    * [Twilio Engage logo
    ...
    * [Twilio Marketing Campaigns logo
    ...
    [See all pricing](https://segment.com/en-us/pricing)
    

Data is collected based on search terms. [Privacy Policy](https://segment.com/en-us/legal/privacy)

* [Contact sales](https://segment.com/en-us/help/sales)
...
[Terms of Service](https://segment.com/en-us/legal/tos)

[Acceptable Use Policy](https://segment.com/en-us/legal/aup)

[Service and Country Specific Requirements](https://segment.com/en-us/legal/service-country-specific-terms)

[Data Protection Addendum (DPA)](https://segment.com/en-us/legal/data-protection-addendum)

[Security Overview](https://segment.com/en-us/legal/security-overview)

[Service Level Agreements](https://www.twilio.com/en-us/legal/service-level-agreement)

[Advisory Services Terms](https://segment.com/en-us/legal/advisory-services-terms)

[Professional Services Terms](https://segment.com/en-us/legal/professional-services-terms)

[Twilio Marketplace Terms](https://segment.com/en-us/legal/twilio-marketplace-terms)

[Twilio Segment Customer Data Platform Destination Integration and Listing Terms](https://segment.com/en-us/legal/segment-destination-terms)

[AI/ML Terms](https://www.twilio.com/en-us/legal/ai-terms)

[European Electronic Communications Code Rights Waiver](https://segment.com/en-us/legal/service-country-specific-terms/eu-eecc-waiver)

[Customer Name Changes and Assignments](https://segment.com/en-us/legal/name-change-assignments)

[Updates to Legal Terms and Conditions](https://segment.com/en-us/legal/online-terms-updates)

### Privacy

[Data Privacy at Twilio](https://segment.com/en-us/privacy)

[Privacy Notice](https://segment.com/en-us/legal/privacy)

[Binding Corporate Rules](https://segment.com/en-us/legal/bcr)

[Customer Proprietary Network Information (CPNI)](https://segment.com/en-us/legal/CPNI)

[Sub-processors](https://segment.com/en-us/legal/sub-processors)

[GDPR](https://segment.com/en-us/gdpr)

[Customer Data Protection Addendum](https://segment.com/en-us/legal/data-protection-addendum)  

[Supplier Data Protection Addendum](https://segment.com/en-us/legal/supplier-data-protection-addendum)

[Global Applicant Privacy Notice](https://segment.com/en-us/legal/privacy/Global-Applicant-Privacy-Notice)

### Mobile Application Terms

[Twilio Frontline End User App Terms](https://segment.com/en-us/legal/frontline-terms)

[Twilio Authy App Terms](https://segment.com/en-us/legal/authy-app-terms)

### Supplier Agreements

[Supplier Purchase Order Terms and Conditions](https://segment.com/en-us/legal/po-terms)

[](https://www.twilio.com/legal/country-specific-terms)[Country-Specific Terms](https://segment.com/en-us/legal/country-specific-terms)

[Supplier Data Protection Addendum](https://segment.com/en-us/legal/supplier-data-protection-addendum)

[Supplier Code of Conduct](https://segment.com/en-us/legal/supplier-code-of-conduct)

### Intellectual Property

[DMCA Policy](https://segment.com/en-us/legal/dmca-policy)

[Trademark](https://segment.com/en-us/legal/trademark)

### Resources for Law Enforcement

[Government Requests](https://segment.com/en-us/legal/government-requests)

[Transparency Report](https://segment.com/en-us/legal/transparency)

### Civil Requests

[Submit a request or subpoena](https://segment.com/en-us/legal/civil-requests)
...
[Sweepstakes Rules](https://segment.com/en-us/legal/rules)

### Customer Research and User Experience

[Acknowledgement and Waiver](https://segment.com/en-us/legal/research)

### Legal Notices for Twilio's Web Site

[Impressum (Germany)](https://segment.com/en-us/legal/impressum-germany)

### Italy ALIAS Database Code of Conduct

[Code of Conduct (Italy)](https://segment.com/en-us/guidelines/it/sms)

Twilio Privacy Notice
=====================

**Effective December 19, 2024**   Last Updated**:** November 12, 2024 _(View the prior version of our privacy notice [here](https://www.twilio.com/en-us/legal/privacy/archive/privacy-notice-september-2024))_

[Introduction](#contents-of-this-notice)
----------------------------------------

The Privacy program of Twilio Inc. and its [group companies](https://www.twilio.com/en-us/legal/bcr/controller#appendix-1) (‘Twilio’, ‘we’ or ‘our’) is built on our [Binding Corporate Rules](https://www.twilio.com/en-us/legal/bcr) ('BCRs'), which serve as our code of conduct that governs our global processing of personal data. 
...
[How We Secure Personal Data](#how-we-secure-personal-data)

[How Long We Retain Personal Data](#how-long-we-retain-personal-data)

[Your Rights and Choices About Your Data](#your-rights-and-choices-about-your-data)

[How To Exercise Your Rights and Choices](#how-to-exercise-your-rights-and-choices)

[How We Use Cookies and Other Tracking Technologies](#how-we-use-cookies-and-other-tracking-technologies)
...
[Personal Data We Process](#contents-of-this-notice)
----------------------------------------------------
...
[How We Process Personal Data](#how-twilio-processes-your-personal-information)
-------------------------------------------------------------------------------
...
[How We Disclose Personal Data](#how-twilio-processes-your-personal-information)
--------------------------------------------------------------------------------
...
We may disclose your personal data among Twilio Group Members. Twilio Group Members will only use the information as described in this Privacy Notice. Twilio Group Members are listed in Appendix 1 in our [Binding Corporate Rules](https://www.twilio.com/en-us/legal/bcr/processor#appendix-1).
...
For more details, please see the procedure laid out in our [Binding Corporate Rules](https://www.twilio.com/en-us/legal/bcr).
...
[International Data Transfers](#how-twilio-processes-your-personal-information)
-------------------------------------------------------------------------------
...
You may have additional rights under our [Binding Corporate Rules](https://www.twilio.com/en-us/legal/bcr) in the EU. For example, where you believe your personal data has been transferred by an EU-based Twilio company to our US headquarters and processed by the US company in breach of the Binding Corporate Rules, you may have a right to:
...
[How to Contact Us](#how-twilio-processes-your-personal-information)
--------------------------------------------------------------------

If you have any questions, concerns or complaints about this Privacy Notice or our data protection practices, please do not hesitate to contact our Data Protection Officer by emailing us at [privacy@twilio.com](mailto:privacy@twilio.com) or by writing to us at any of the following addresses:
...
We will endeavor to resolve questions, concerns or complaints you raise with us in accordance with our [Complaints Handling Procedure](https://www.twilio.com/en-us/legal/bcr/controller#appendix-7). In the unlikely event that we are unable to resolve your concern, you can find information about your options to seek assistance through independent dispute resolution mechanisms or complaints to your local data protection authority [here](https://www.twilio.com/en-us/legal/privacy/disputes).
...
You have the possibility, under certain conditions, to invoke binding arbitration for complaints regarding DPF compliance that are not resolved by any of the other DPF mechanisms. You can find more information in the DPF [ANNEX-I-introduction](https://urldefense.com/v3/__https://www.dataprivacyframework.gov/framework-article/ANNEX-I-introduction__;!!NCc8flgU!dDkOuYLS4xvQQZ_9JHqO9dP7eQXWgMdV2Pdi0Hzwz5ERdYA0F0H7Cd-NuxilDjOEfE5b9lm3GBLKfu9mClbi9-0N$).
...
Twilio processes personal data (Communications Usage Data and Customer Content) for most of our Services as a data processor acting on the instruction of our customer and in accordance with the terms of our agreement with a customer, our [Data Protection Addendum](https://www.twilio.com/legal/data-protection-addendum), and service specific terms. Our services provide customers with ways to control, access and secure their data.

We also offer customers the ability to store, delete, access, or exercise other choices about their personal data. The ability to make these choices depends on the Twilio product or service being used and how it is being used by a customer. Customers are referred to our [API docs](https://www.twilio.com/docs/api) for each of our products and services, along with SendGrid’s [documentation](https://docs.sendgrid.com/) and Segment’s [documentation](https://segment.com/docs/) to find more detailed information about managing personal data collected and stored in connection with their use of our products and services. We also provide an overview of our retention and deletion practices, including how to delete data you control in our [support documentation](https://support.twilio.com/hc/en-us/articles/4410585868443-Data-Retention-and-Deletion-in-Twilio-Products). We provide information about the security measures we use to protect our customer’s data  in our [Security Overview](https://www.twilio.com/legal/security-overview), and if you are located in a country that requires you to obtain information about our supplemental measures, you may read more about those measures [here](https://support.twilio.com/hc/en-us/articles/360051805394-Measures-Twilio-Takes-to-Safeguard-the-Privacy-of-Customer-Personal-Data).
...
For more detail on our Services, please find information below or by visiting our [products page](https://www.twilio.com/en-us/products).
...
The SendGrid services also collect additional data in the form of web beacons placed in the body of emails delivered using the SendGrid platform. This allows us to keep track of whether or not an email has been delivered, opened, clicked on, whether it bounced or was treated as spam. You can learn more about web beacons in the section titled “[How We Use Cookies and Other Tracking Technologies](#how-we-use-cookies-and-other-tracking-technologies)” above.

#### [Voice Intelligence](https://www.twilio.com/en-us/legal/ai-terms/voice-intelligence-data-use)
...
* [Twilio Engage](https://segment.com/en-us/engage)
* [Flex](https://segment.com/en-us/flex)
* [User Authentication & Identity](https://segment.com/en-us/user-authentication-identity)
...
* [Customer Data Platform](https://segment.com/en-us/customer-data-platform)
* [SMS Marketing](https://segment.com/en-us/solutions/text-marketing)
* [Commerce Communications](https://www.twilio.com/docs/proxy)
* [Contact Center](https://segment.com/en-us/flex)
* [All solutions](https://segment.com/content/twilio-com/global/en-us/products?tab=2.html#all-solutions)
...
* [About Twilio](https://segment.com/en-us/company)
* [Why Twilio](https://segment.com/en-us/why-twilio)
* [Customer Engagement Platform](https://segment.com/en-us/customer-engagement-platform)
* [Trusted Communications](https://segment.com/en-us/trust)
...
* [Public Policy](https://segment.com/en-us/public-policy/blog)
