...
🇫🇷 [Click here to obtain the Terms of Service in French](https://ga-public-downloads.s3.amazonaws.com/General-Assembly-Terms-and-Conditions-French.pdf)

I. Introduction and Eligibility
-------------------------------

These Terms of Service (“Terms”) constitute a legally binding agreement between you (“you”, or “your” or “user”) and General Assembly Space, Inc. and its affiliates (“General Assembly,” “we,” “us”). Please read these Terms carefully before using the General Assembly Service (defined below). “You” and “users” shall mean all visitors to the General Assembly Service. These Terms include General Assembly’s [Privacy and Cookies Policy](https://generalassemb.ly/privacy_policy) (“Privacy Policy”), which is incorporated by reference into these Terms. We have included several annotations in boxes to help explain the legal jargon and emphasize key sections. These annotations are for convenience only and have no legal or contractual effect. YOUR USE OF THE GENERAL ASSEMBLY SERVICE SIGNIFIES YOUR AGREEMENT TO BE BOUND BY THESE TERMS EACH TIME YOU ACCESS THE GENERAL ASSEMBLY SERVICE. IF YOU DO NOT AGREE TO ANY OF THESE TERMS, DO NOT USE THE GENERAL ASSEMBLY SERVICE. You may not use, access, or download the General Assembly Service unless, and by accessing the General Assembly Service, you represent and warrant that, you if an individual, are at least 18 years of age, and, accept and agree to be bound by these Terms (or, as applicable, have received the written consent of a parent or guardian to be bound by these Terms).

Children. No part of the General Assembly Service is directed to persons under the age of 17 (_For users in France:_ _No part of the General Assembly Service is directed to persons under the age of 18_.)
...
International Users. The General Assembly Service is operated from the United States, but may be accessed in other parts of the world. If you access or use the General Assembly Service, General Assembly will process your personal information in accordance with applicable laws and our [Privacy Policy.](https://generalassemb.ly/privacy_policy) If you are located in Europe, for the purposes of (i) the Data Protection Act 1998, General Assembly Space, Limited is the data controller with respect to any information collected by it in the United Kingdom; and (ii) the General Data Protection Regulation (EU) 2016/679, General Assembly France SAS is the data controller with respect to any information collected by it in France. 
...
Disputed Charges. You agree to submit any disputes regarding any charge to your account in writing to General Assembly within thirty (30) days of such charge, or your dispute is waived and such charge will be final and not subject to challenge. You may dispute a charge by sending an email to us at classes@generalassemb.ly.

Refunds. Our policy for providing refunds for any purchases you make, is set forth in the Refund Policy located in the course catalog for your region. All course catalogs can be found [here](https://generalassemb.ly/regulatory-information). General Assembly may modify its refund policies at any time with or without specific notice to you; provided, however, that the refund policy in effect at the time of any transaction shall apply to such purchase despite any subsequent change in such policy. Please contact admissions@generalassemb.ly to request a refund.
...
Terms Of Service | General Assembly
-----------------------------------
...
General Assembly’s Use of Your User Content. By creating, posting, or sharing Your User Content, on or through the General Assembly Service, and subject to General Assembly’s Privacy Policy, and except as otherwise expressly stated, you grant General Assembly and its affiliates, successors and assigns, and their respective licensees, advertising agencies, third-party partners and the employees, officers, directors and agents of each and all of them, the right and permission with respect to Your User Content, to use, copy, reproduce, modify, remove, publish, upload, distribute, transmit, publicly display and create derivative works from, such materials on a perpetual, sublicensable, royalty-free, worldwide basis, and in any medium or format whatsoever now existing or hereafter created, including in and on the internet, and for any internal (e.g., non-promotional) purposes, including advertising, program and teacher improvement, and educational support and advancement, promotional or educational materials, public relations, publicity, packaging and promotion of General Assembly and its businesses, products and services, without further consent from, or payment or other compensation to, you. Notwithstanding the foregoing, with respect to our use of your Student Work, we agree not to modify Student Work without your express permission. You waive any rights you may have regarding Your User Content, except for Student Work, being altered or manipulated in any way that may be objectionable to you. We reserve the right to refuse to accept, post, display, or transmit any of Your User Content in our sole discretion. Upon your request, General Assembly will discontinue this licensed use within a commercially reasonable period after Your User Content is removed from the General Assembly Service. If you are an Instructor, the license grant above is also applicable to any content you create for the purpose of your Course (such as syllabi, slides or homework) that you post on General Assembly’s platform.
...
2. Identification of the copyrighted work alleged to have been infringed (or if multiple copyrighted works located on the General Assembly Service are covered by a single notification, a representative list of such works);
3. Identification of the specific material alleged to be infringing or the subject of infringing activity, and information reasonably sufficient to allow General Assembly to locate the material on the General Assembly Service;
...
Notices and counter-notices must meet the then-current statutory requirements imposed by the DMCA; see http://www.loc.gov/copyright/ for details. Notices and counter-notices with respect to the General Assembly Service should be sent to legal@ga.co. Consult your legal advisor and see 17 U.S.C. § 512 before filing a notice or counter-notice as there are penalties for false claims under the DMCA.
...
XI. User Content Disclaimers, Limitations, and Prohibitions We do not represent or guarantee the truthfulness, accuracy, or reliability of content posted by users of the General Assembly Service. You accept that any reliance on material posted by other users or third-party service providers will be at your own risk.
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
1. Attempt to interfere with, harm, reverse engineer, steal from, or gain unauthorized access to the General Assembly Service, user accounts, or the technology and equipment supporting the General Assembly Service;
2. Frame or link to the General Assembly Service without permission;
3. Use data mining, robots, or other data gathering devices on or through the General Assembly Service;
...
6. Sell, transfer, or assign any of your rights to use the General Assembly Service to a third party without our express written consent;
7. Post advertising or marketing links or content, except as specifically allowed by these Terms;
8. Use the General Assembly Service after your account has been terminated, without our consent;
9. Use the General Assembly Service in an illegal way or to commit an illegal act in relation to the General Assembly Service or that otherwise results in fines, penalties, and other liability to General Assembly or others; or
10. Access the General Assembly Service from a jurisdiction where it is illegal or unauthorized.
...
By providing your email, you confirm you have read and acknowledge General Assembly’s [Privacy Policy](https://generalassemb.ly/privacy-policy) and [Terms of Service](https://generalassemb.ly/terms-of-service). This site is protected by reCAPTCHA and the [Google Privacy Policy](https://policies.google.com/privacy) and [Google Terms of Service](https://policies.google.com/terms) apply.

[](https://generalassemb.ly/)

### Legal Pages

* [Regulatory Information](https://generalassemb.ly/regulatory-information)
...
* [Our Story](https://generalassemb.ly/about)
* [Locations](https://generalassemb.ly/locations)
* [Articles](https://generalassemb.ly/blog/)
* [Join Our Team](https://generalassemb.ly/careers)
...
* [Alumni](https://generalassemb.ly/alumni)
* [Become An Instructor](https://generalassemb.ly/our-instructors)
* [Veteran Resources/GI Bill](https://generalassemb.ly/gi-bill)
* [Fund a Scholarship/Social Impact](https://generalassemb.ly/opportunity-fund/partners)
* [Community Code of Conduct](https://generalassemb.ly/community_code_of_conduct)

[](https://www.facebook.com/gnrlassembly)[](https://instagram.com/generalassembly)[](https://twitter.com/ga)[](https://www.youtube.com/@gnrlassembly)[](https://www.linkedin.com/school/generalassembly/)

[Get in touch](https://generalassemb.ly/students/get-in-touch)

© 2024 General Assembly. All rights reserved.

[Regulatory Information](https://generalassemb.ly/regulatory-information)

[Terms](https://generalassemb.ly/terms-of-service)

[Privacy](https://generalassemb.ly/privacy-policy)