...
Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endgerät und dem X-Server hergestellt. X (ehemals Twitter) erhält dadurch Informationen über den Besuch dieser Website durch Sie. Durch das Benutzen von X (ehemals Twitter) und der Funktion „Re-Tweet“ bzw. „Repost“ werden die von Ihnen besuchten Websites mit Ihrem X (ehemals Twitter)-Account verknüpft und anderen Nutzern bekannt gegeben. Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch X (ehemals Twitter) erhalten. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von X (ehemals Twitter) unter: [https://twitter.com/de/privacy](https://twitter.com/de/privacy).
...
Ihre Datenschutzeinstellungen bei X (ehemals Twitter) können Sie in den Konto-Einstellungen unter [https://twitter.com/account/settings](https://twitter.com/account/settings) ändern.
...
Diese Webseite nutzt Funktionen des Webanalysedienstes [Plausible](https://plausible.io/privacy).

Der Dienst verwendet keinerlei Cookies und erfasst keine persönlichen Daten.
...
Ausführliche Informationen zum zu den Funktionen von Brevo entnehmen Sie folgendem Link: [https://www.brevo.com/de/newsletter-software/](https://www.brevo.com/de/newsletter-software/).
...
Näheres entnehmen Sie den Datenschutzbestimmungen von Brevo unter: [https://www.brevo.com/de/datenschutz-uebersicht/](https://www.brevo.com/de/datenschutz-uebersicht/) sowie [https://www.brevo.com/de/legal/privacypolicy/](https://www.brevo.com/de/legal/privacypolicy/).
...
Auf dieser Website sind Funktionen des Podcast-Dienstes Podlove eingebunden. Anbieter ist Eric Teubert, Hafenstraße 5C, 04179 Leipzig.

Sowohl die Podlove Abo-Schaltfläche als auch der Podlove Web Player können über keycdn.com bereitgestellt werden (keycdn GDPR-Erklärung).

Podlove Publisher verfolgt Download-Statistiken. IP-Adressen werden verwendet, um einen geschätzten geografischen Standort zu bestimmen (Stadt- oder Bundeslandebene).

IP-Adressen werden vorübergehend (bis zu 48 Stunden) als Teil einer Anfrage-ID gespeichert. Dies ist notwendig, weil der Podcast-Besitzer wissen muss, wie oft Episoden heruntergeladen werden, um die Rentabilität seiner Bemühungen zu beweisen.

Um eine realistische Download-Zahl zu ermitteln, muss das System in der Lage sein, wiederholte Zugriffe auf dieselbe Datei durch denselben Nutzer zu erkennen. Der einzige zuverlässige Weg, dies zu erreichen, ist die Betrachtung der IP-Adresse in Kombination mit dem User Agent. Die Verwendung einer anonymisierten IP-Adresse ist nicht möglich, da dies zu falschen Ergebnissen führen würde. Ein Zugriff auf dieselbe Datei durch denselben Nutzer an verschiedenen Tagen kann als separater Download betrachtet werden, daher ist es notwendig, IPs nur bis zu 48 Stunden zu speichern.

Nach 48 Stunden werden die Request-IDs so gesalzen, dass es unmöglich ist, die ursprüngliche IP-Adresse wiederherzustellen.

Der User Agent wird ebenfalls gespeichert.

Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Podlove: [https://podlove.org/privacy/](https://podlove.org/privacy/)
...
Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Die Datenschutzerklärung von Google finden Sie hier: [https://policies.google.com/privacy](https://policies.google.com/privacy).
...
Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: [https://stripe.com/de/privacy](https://stripe.com/de/privacy) und [https://stripe.com/de/guides/general-data-protection-regulation](https://stripe.com/de/guides/general-data-protection-regulation).
...
Details hierzu können Sie in der Datenschutzerklärung von Klarna unter folgendem Link nachlesen: [https://www.klarna.com/de/datenschutz/](https://www.klarna.com/de/datenschutz/).
...
Details entnehmen Sie der Datenschutzerklärung von Shopify Payment: [https://www.shopify.de/legal/datenschutz](https://www.shopify.de/legal/datenschutz).
...
American Express kann Daten an seine Muttergesellschaft in die USA übermitteln. Die Datenübertragung in die USA wird auf die Binding Corporate Rules gestützt. Details finden Sie hier: [https://www.americanexpress.com/en-cz/company/legal/privacy-centre/binding-corporate-rules/](https://www.americanexpress.com/en-cz/company/legal/privacy-centre/binding-corporate-rules/).

Weitere Informationen entnehmen Sie der Datenschutzerklärung von American Express: [https://www.americanexpress.com/de-de/firma/legal/datenschutz-center/online-datenschutzerklarung/](https://www.americanexpress.com/de-de/firma/legal/datenschutz-center/online-datenschutzerklarung/).
...
[](https://twitter.com/intent/tweet?url=SHAREURL&hashtags=blocktrainer)[](https://www.linkedin.com/shareArticle?mini=true&url=SHAREURL/)[](https://www.facebook.com/sharer.php?u=SHAREURL)[](https://t.me/share/url?url=SHAREURL)[](https://api.whatsapp.com/send?text=SHAREURL)[](mailto:?amp;body=SHAREURL)
...
[![Shopinbit](/fileadmin/_processed_/2/b/csm_shopinbit_banner_vert_8579927c88.jpg)](https://ref.blocktrainer.de/shopinbit/ws/blocktrainer-empfehlungslinks/logo-banner)
