...
* [Terms and Conditions](https://www.idrive.com/terms-and-conditions)
* [Privacy Policy](https://www.idrive.com/privacy)
* [GNU General Public License (GPL)](https://www.idrive.com/termslinks)
* [Service Level Agreement (SLA)](https://www.idrive.com/terms_sla)
* [DMCA Policy](https://www.idrive.com/dmca_policy)
* [Acceptable Use Policy](https://www.idrive.com/acceptable_use_policy)
* [GDPR](https://www.idrive.com/gdpr)
* [Compliance Statement](https://www.idrive.com/compliance-statement)
...
By registering for an IDrive® account you or the entity you represent ("you" and "your") agree to be bound by these Terms of Service (the "Terms"), which govern your access to and use of the IDrive® Service (the "Service") offered by IDrive Inc. ("we", "us" or "our"). Some applications of the Service may implement open source code released under the [GNU General Public License](https://www.idrive.com/termslinks) ("GPL"). Please carefully read the [GPL](https://www.idrive.com/termslinks) as well as our [Service Level Agreement](https://www.idrive.com/terms_sla) and [Privacy Policy](https://www.idrive.com/privacy), which are incorporated into these Terms.
...
It is important to note that the functionality of the Service is time-dependent and these Terms represent the functionality as of now. It is possible that earlier versions of the Service do not support all the functionalities as described below. Please reference the [Windows Notes](https://www.idrive.com/old-version_windows) and [Mac Notes](https://www.idrive.com/old-version) for previous account versions.
...
(b) will not violate, or encourage or facilitate the violation of, any aspect of our [Acceptable Use Policy](https://www.idrive.com/acceptable_use_policy);
...
If there is suspicion that an account is being used for storage and distribution of any illegal material such as copyrighted content, we reserve the right to examine the content of the online storage and backup account. We may also access the account and data for support related activities. We normally do not review, inspect, edit or monitor any content, data or files stored by you or any other user of the Service. We reserve the right to refuse, remove or disable access to any data or files stored on our servers with immediate effect that we determine may be illegal, may violate these Terms, may violate the rights of any third party or otherwise may be reasonably objectionable. For absolute privacy, we recommend use of the private encryption key which allows use of a key known only to the user in addition to the basic account credentials.

### 3\. Registration Information / Privacy

You agree to promptly notify us of any change in the information you provided during your registration for the Services (including, without limitation, any change in your mailing address, telephone numbers or email address). The registration information (including your selected username and password) provided by you during your registration for the Service, together with any and all updates provided by you from time to time under this paragraph, is referred to in these Terms as the "Registration Information." Our policy regarding the privacy and use of the Registration Information is set forth in our [Privacy Policy](https://www.idrive.com/privacy), which may be modified and amended by us from time to time. By accepting these Terms, you are also acknowledging that you agree to the terms of the [Privacy Policy](https://www.idrive.com/privacy).

We may send SMS/emails/push notifications to update you on any product reminders, updates, events, and promotions we may be running. We may use the email addresses and mobile numbers provided by you to send periodic information about our Services and related products.
...
For yearly accounts created after November 23, 2011, you have the option of disabling auto-renewal and your account will terminate at the end of your annual term. Please note that all of your data will be deleted when your account is terminated. To facilitate future account reactivation, minimal metadata may be retained. No pro-rated refunds will be issued for the time remaining in your annual subscription if you choose to disable auto-renewal. If you’d like to close your account prior to the end of your annual subscription term, please [contact our support team](https://www.idrive.com/support).

Overuse - Paid Plans  
Certain paid accounts are allowed to use storage space beyond the chosen plan's quota limit. This is designed to allow uninterrupted backups in case the usage exceeds the quota limit. However, for usage beyond the quota limit, there maybe an overuse charge at the rate of $0.25/GB/month for Mini and Personal plans and $0.50/GB/month for Team and Business plans. While it is not necessary, we encourage users to upgrade to one of the higher storage plans if their usage exceeds the quota limit for their chosen plan to avoid the overuse charges. Upgrades may involve additional charges. Alternatively, an Archive Cleanup operation can be performed to potentially bring the Account under the quota limit. IDrive® also provides a simple manual delete option for any file(s)/folder(s) in the account via the Desktop App to remove the data that you no longer need. This, in combination with backup set modification can be used effectively to bring the account under quota.

The quota limit for sub-accounts may work differently than the regular accounts. Depending on the configuration, on exceeding the quota, a soft limit may apply on the quota (backups may stop once the ongoing backup is complete).

Free Accounts  
We reserve the right to terminate Free Accounts at any time, with or without notice. Without limiting the foregoing, if a Free Account is inactive for ninety (90) days, then we reserve the right to terminate the Free Account without providing additional notice. An inactive account is an account where no sign in has occurred either automatically or manually for a specified period of time.

Mini, Personal, Team, and Business Accounts  
Mini and Personal accounts are for personal and home use only. Businesses must choose Team or Business Plans. As with many services like broadband providers, there may be substantial pricing, storage and functionality differences between mini, personal, team, and business accounts.
...
Based on the protection level of primary production devices, we may or may not keep redundant backups of the primary production data. This decision may be made based on RAID level, distributed nature of the file system where user account resides and other criteria. If there is no redundant backup of primary production data, we may not be able to recover data in the event of failure and we may need to initiate a fresh backup of user data.

The general guideline to users is that we strongly recommend a local backup of user data on premise. IDrive® now has local backup capability with encryption and private key support and we strongly encourage our users to make full use of this. This feature is offered for no additional fee. Online or Cloud Backup should always be a complementary solution to local backup and not be the ONLY solution.

Due to relatively large sizes of storage devices, some of the recovery and repair efforts in the event of a failure may take many days or weeks, and is not guaranteed. We may request a fresh backup from users via the IDrive® Express service to expedite in cases where there is a suspected loss or corruption of data due to hardware or software failures, or just via the online backup process. Users will need an active IDrive® subscription to avail the IDrive® Express service.

It is critical that users do not remove the data on their local computer that they backed up to IDrive® and keep only one copy of data on IDrive®. In the event of hardware or software errors at the IDrive® end and subsequent re-backups either via online or via express, this may still leave users without some of their data if the data is removed from their desktop that they may eventually need for restore. Again, we strongly recommend not to use IDrive® as the only source of your data backup, a local copy is strongly recommended.

We allow you to retain and restore thirty (30) previous versions of all files backed up to your account (for accounts created prior to 11-07-2018, 10 previous versions are stored). Versions do not count against your quota limit, however if the amount of space required to maintain previous versions exceeds two times the actual storage being used, we reserve the right to limit the number of versions retained for your account. We advise you to audit your logs for the desktop application completely including individual entries for files and total count periodically to ensure that the backups are taking place successfully and in case of errors, take corrective action.

IDrive® is not a monitored service; we recommend periodically auditing logs to confirm the backup is occurring as desired. IDrive® requires periodic review, at least on a weekly basis to verify the execution of backups because backups may fail for any number of reasons including but not limited to, internet connectivity issues, authentication issues, firewall, blocks by anti-virus programs, system configuration changes to the computer, etc. You should also periodically update the backup client to the most recent version. Release Dates are posted on the product download pages. **We highly recommend that a maximum count of five computers per sub-account (while there is no enforced limit) must be maintained for best performance and reliability. We also recommend using private encryption key for additional security.**

### 8\. Multiple Computers, Additional/Sub-accounts and Bulk Resellers

IDrive® offers an Additional/Sub-accounts feature for clear separation of authentication and encryption key (if used). This allows for easy central administration of multiple accounts that can be based on administrator set quota levels or different plans according to user needs. The main account holder/Bulk Reseller may be responsible for actions arising from Additional account holders and/or Sub-account holders, and is responsible for ensuring all such accounts adhere to these terms.

Upon setup, the main account holder/Bulk Reseller will set up a username and password for the Additional/Sub-account. An email will be sent to the Additional/Sub-account user with this sign in information. It is the Additional/Sub-account user's responsibility to change the password on the account. If the main account holder and/or Bulk Reseller retains the usernames and passwords of the Additional/Sub-accounts, he/she will have read/write access to the Additional/Sub-accounts including access to profile information, backup sets, backup schedules, and even data if there is no private encryption key set.

Primary Support responsibility related to Additional/Sub-accounts resides with the main account holder/Bulk reseller. IDrive® serves main account holder/Bulk reseller as a Secondary support provider. IDrive® reserves the right to be the primary support for sub-accounts under certain cases.

A main account holder/Bulk Reseller has the authority to cancel the Additional/Sub-accounts as well as the main account, for any reason. If the main account is canceled, all Additional Accounts and/or Sub-accounts will, by default, be canceled as well. In case of cancellation of main account holder/Bulk Reseller due to non-payment, IDrive® reserves the rights to keep the Additional/Sub-accounts active for some time and contact them to sign up directly with IDrive® services.

IDrive® also supports the ability to backup multiple number of computers, tablets, and/or mobile devices to a single account. In order to backup multiple computers, your authentication information must be replicated on each computer you wish to backup, including the private encryption key (if used). There may be additional charges per computer added to backup.

MINI, PERSONAL, TEAM, AND BUSINESS IDRIVE ACCOUNTS ARE NOT AUTHORIZED OR LICENSED FOR BULK RESALE. If IDRIVE determines that a mini, personal, team, or business account is being used for resale, IDRIVE reserves the right to immediately suspend that account and will require the account to be reclassified as a reseller account under reseller pricing and terms for the entire period of time personal account space was being resold, otherwise the offending account will be forced to forfeit the account without refund.

### 9\. Third Party Applications

IDrive® implements the Services using our EVS technology. EVS facilitates developers to produce third party applications that utilize IDrive® for backup purposes. We require all developers to agree to our Developer Terms and to adhere to our Privacy Policy to protect the safety of our users. However, IDrive® disclaims all responsibility and liability arising out of the use of third party applications, and we do not provide any warranties, express or implied, regarding the functionality, use, or performance of any third party applications. You agree that by using third party applications to access your Account, you are doing so at your own risk. We strongly advise that you only use trusted third party applications and review the terms provided with third party applications beforehand.

### 10\. IDrive® for WordPress, IDrive® Lite, IDrive® Contacts

The IDrive® for WordPress plug-in, IDrive® Lite, and IDrive® Contacts accounts are based on different technologies and are not inter-operable with standard IDrive® accounts. The user defined private encryption key option and certain items discussed in [https://www.idrive.com/online-backup-compliance](https://www.idrive.com/online-backup-compliance) are also not applicable to these products and are only applicable to Windows and Mac IDrive® accounts.

IDrive® for WordPress is a WordPress plug-in that uses Snapshots technology to retrieve earlier copies of data, which is limited to last ten (10) days snapshots (may change without notice).

### 11\. IDrive® BMR appliance Terms of Service

IDrive® BMR appliance operates in conjunction with IDrive's online backup service.

IDrive® BMR offers a number of data recovery options, such as file-level restore, complete system recovery, and specific disk volume recovery. We assure file-level restore provided backups have been reliable. System recovery and individual volume recovery are not assured because they could fail due to a variety of reasons, including the use of dissimilar hardware or other system-related problems.

IDrive® BMR solution is provided via subscription service, which includes the IDrive® BMR appliance as well as the cloud backup solution. You agree to pay the subscription fees on time at the start of each subscription period for the whole solution. IDrive® BMR appliance is provided to you as long as the subscription is active. You agree to return the appliance on cancellation of subscription. Failure to return the appliance will result in your account being charged for the cost of the appliance. You are liable for returning damaged BMR appliance, including damages caused during shipping due to poor packaging.

Upon cancellation of your Account, you must return the BMR appliance to IDrive®. You must cancel your Account before it renews each year in order to avoid a charge for the next year's fees to your credit card. Please note on cancellation, refunds are issued if account is canceled within thirty (30) days of its creation date. After 30 days, pro-rated refunds are issued on a case-by-case basis subject to eligibility.

Please note that all of your data will be deleted from your IDrive® Cloud account on cancellation. If you’d like to close your account prior to the end of your annual subscription term, please [contact our support team](https://www.idrive.com/support).

Warranty for the IDrive® BMR appliance will be provided as long as the subscription is active. WARRANTY IS LIMITED TO PROVIDING REPLACEMENT PARTS OR REPLACEMENT OF THE ENTIRE APPLIANCE WITH A NEW ONE. RECOVERY OF ANY LOST DATA IS NOT GUARANTEED. YOU UNDERSTAND THAT YOU WILL NOT HOLD IDRIVE INC. ACCOUNTABLE FOR ANY DATA LOSS DUE TO THE USE OF IDRIVE BMR SOLUTION. It is always recommended that you make use of the two tier backup solution, with one tier of backup with the BMR appliance, and second tier with the IDrive® Cloud for best data protection. It is also important that you monitor your local and cloud backups periodically to make sure that the backups are taking place successfully. Ensure weekly inspection of your BMR Appliances by logging into the admin console, to check the backup and hard drive status of the device.

Overuse:  
Certain paid accounts are allowed to use storage space beyond the chosen plan's quota limit. This is designed to allow uninterrupted backups in case the usage exceeds the quota limit. However, for usage beyond the quota limit, there may be an overuse charge at the rate of $120/TB/month for all BMR plans. While it is not necessary, we encourage users to upgrade to one of the higher storage plans if the usage exceeds the quota limit for their chosen plan, to avoid overuse charges. Upgrades may involve additional charges. We also provide options to configure cloud retention policy and delete data from the cloud.

Partner Management Disclaimer:  
Under our 'Partner Management' feature, we provide our Resellers direct access to the BMR server of their customers through the centralized web console with automatic login. This feature is designed to allow the partners to monitor the BMR device, as well as the backup status and remotely manage the BMR device for their customers. Please contact BMR customer support service to disable direct access to the BMR server.

### 12\. IDrive® Photos Terms of Service

IDrive® Photos allows the Account holder to upload, store, send, receive, or share your content. There is no obligation for the Account holder to provide any content to IDrive® Photos services and the account holder can choose the content they want to provide. If the Account holder chooses to upload or share content, they must ensure they have the necessary rights to do so and that the content is lawful.

You, as the Account holder, are solely responsible for access to, content in, or sharing and use of your Account. We are not liable for any loss or damage arising from any access to, content in, or sharing and use of your Account.
...
You must maintain authorization and access to the Domain account and Backed up Sites (Microsoft Office 365 or Google Workspace) so that we are regularly able to access it for purposes of providing our IDrive® Backup Services. You agree and acknowledge that Content may not be available or restorable a) if our access authority to a Domain or Backed up Site is changed or otherwise restricted; b) due to unavailability of the Domain or Backed up Site, or any portion thereof; c) if the Domain or Backed up Site provider amends its API guidelines in such a way that affects our ability to access the Domain to provide the Product; and/or d) with respect to modifications to the Content that are not captured in the backup frequency or retention schedule for the Service Plan chosen.
...
Any notice under these Terms provided by you will be deemed to be properly given if received by Customer Service at [support@idrive.com](mailto:support@idrive.com), except those that are related to cancellation or termination of your Account. 'Cancel at the end of your annual term' is available online by disabling auto-renewal option. For special cases where you’d like to close your account prior to the end of your annual subscription term, please [contact our support team](https://www.idrive.com/support). Sending an email to [support@idrive.com](mailto:support@idrive.com) for cancellation is not considered as a cancellation notice for security reasons. On successful cancellation of an account by you or by us, due to various reasons including non-payment for the Services, your data will be removed from our storage servers. We may delay the cancellation related to non-payment for the services and provide a grace period of up to thirty (30) days from the due date to allow for the customer to arrange for payments.
...
[1-818-485-4333](https://www.idrive.com/support)

* #### [My IDrive](https://www.idrive.com/)
    
* [Sign Up](https://www.idrive.com/idrive/signup)
* [Features](https://www.idrive.com/online-backup-features)
* [Download](https://www.idrive.com/online-backup-download)
* [Pricing Plans](https://www.idrive.com/pricing)
* [Security](https://www.idrive.com/online-backup-security)
* [Educational Offer](https://www.idrive.com/online-backup-education)
* [Blog](https://blog.idrive.com/)
* [IDrive vs Competition](https://www.idrive.com/idrive-vs-competition)
* * #### [NAS Backup](https://www.idrive.com/nas-backup)
        
    * [Synology Backup](https://www.idrive.com/synology-backup)
    * [QNAP Backup](https://www.idrive.com/qnap-backup)
    * [Netgear Backup](https://www.idrive.com/netgear-backup)
    * [Asustor Backup](https://www.idrive.com/asustor-backup)

* #### Products
    
* [iPhone, iPad, Android Backup](https://www.idrive.com/iphone-ipad-android-backup/)
* [Linux Backup](https://www.idrive.com/online-backup-linux)
* [IDrive BMR](https://www.idrive.com/bare-metal-recovery/)
* [Disk Clone](https://www.idrive.com/image-backup)
* * #### [Server Cloud Backup](https://www.idrive.com/server-cloud-backup)
        
    * [SQL Server](https://www.idrive.com/online-backup-sql-server/)
    * [On-premise MS Exchange Server](https://www.idrive.com/online-backup-exchange-server/)
    * [On-premise MS SharePoint Server](https://www.idrive.com/online-backup-sharepoint/)
    * [Oracle Server](https://www.idrive.com/online-backup-oracle-server/)
    * [System State](https://www.idrive.com/online-backup-system-state/)
    * [Hyper-V](https://www.idrive.com/online-backup-hyper-v/)
    * [VMware](https://www.idrive.com/online-backup-vmware/)

* #### Features
    
* [Multiple Device Online Backup](https://www.idrive.com/multiple-device-online-backup)
* [Small Businesses](https://www.idrive.com/small-business)
* [Manage Computers via Web](https://www.idrive.com/dashboard)
* [Snapshots](https://www.idrive.com/snapshots)
* [True Archiving](https://www.idrive.com/true-archiving)
* * #### Services
        
    * [Resellers](https://www.idrive.com/reseller/)
    * [IDrive Express](https://www.idrive.com/idrive-express)
    * [Business Compliance](https://www.idrive.com/online-backup-compliance)

* #### Resources
    
* [Support](https://www.idrive.com/support)
* [FAQs](https://www.idrive.com/online-backup-classic-faq)
* [Video Tutorials](https://www.idrive.com/videos)
* [Corporate](https://www.idrive.com/online-backup-company)
* [IDrive Ventures](https://www.idrive.com/ventures)
* [Press Releases](https://www.idrive.com/online-backup-news)
* [Reviews](https://www.idrive.com/online-backup-reviews)
* [Legal](https://www.idrive.com/terms-and-conditions)

© IDrive Inc.

[![Facebook](https://static.idriveonlinebackup.com/source/images/spacer.gif)](https://www.facebook.com/IDriveBackup) [![Twitter](https://static.idriveonlinebackup.com/source/images/spacer.gif)](https://twitter.com/IDriveBackup)[![LinkedIn](https://static.idriveonlinebackup.com/source/images/spacer.gif)](http://www.linkedin.com/company/1498880)