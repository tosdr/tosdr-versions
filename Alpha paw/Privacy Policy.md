...
Alphapaw.com is committed to protecting your privacy online. To further this commitment, we have adopted an Online Privacy Policy that guides how we collect, store, and use the information collected about you online.
...
* Personal or business contact information (such as name, address and email address, pet name, pet breed and type, social media, name of your company or department, and your business function or title);
* Demographic information (such as age, gender, physical characteristics and their pet’s health concerns);
...
If you are receiving e-mails or regular mail and at a later date you choose to opt out and have your name removed from the e-mailing list, you can do so by sending us an email on [support@](mailto:support@alphapaw.com)[alphapaw.com](mailto:support@alphapaw.com)

Accessibility

Please head [here](https://www.alphapaw.com/website-accessibility-notice/) to read our latest notice.
...
To personalize the Site, and to simplify the registration process, we give you the option to link your account with Facebook/Instagram. When you link your account, Facebook/Instagram may share data about you with us, and we may share information about you with Facebook. In addition, Alpha Paw players who are your friends on Facebook/Instagram may be shown your Alpha Paw username if you have both linked your Facebook accounts.

Log Files

Other non-personal information collected by Alphapaw.com is in the form of logs – files that record website activity, including how many “hits” a particular web page is getting (a.k.a., “click-through data”). For example, log file entries are generated every time a visitor clicks the “Home” icon on our site. These entries enable Alphapaw.com to assess overall site activity, track interest in advertised sales, track interest in purchase behaviour, and troubleshoot technical concerns. Through the use of log files, we may also collect certain demographic information such as the type of browser you are using (e.g., Chrome, FireFox, Internet Explorer), the type of operating system you are using (e.g., Windows or Mac OS), and the domain name of your Internet service provider (e.g., Comcast, AT&T).

Who is collecting my personal information?

Any personal information that you disclose while visiting any of our websites is collected by Alphapaw.com, and is used in the manner specified above.
