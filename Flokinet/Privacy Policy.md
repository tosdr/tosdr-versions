...
[](https://invidious.flokinet.to/toggle_theme?referer=%2Fprivacy "Toggle Theme")

[](https://invidious.flokinet.to/preferences?referer=%2Fprivacy "Preferences")

[Log in](https://invidious.flokinet.to/login?referer=%2Fprivacy)
...
Users can clear their watch history using the [clear watch history](https://invidious.flokinet.to/clear_watch_history) page.
...
To remove data that has been stored in the website's database, you can use the [delete my account](https://invidious.flokinet.to/delete_account) page.

[Source code](https://github.com/iv-org/invidious) [Documentation](https://github.com/iv-org/documentation)

[Released under the AGPLv3 on GitHub.](https://github.com/iv-org/invidious/blob/master/LICENSE) [View JavaScript license information.](https://invidious.flokinet.to/licenses) [View privacy policy.](https://invidious.flokinet.to/privacy)

[Donate](https://invidious.io/donate/) Current version: 2024.05.27-1ae14cc2 @ master