...
This Agreement (the "**Agreement**") is between you and Sejda BV, a Dutch company registered with Chamber of Commerce Amsterdam under number 68286945 ("**Sejda**"). If you are agreeing to this Agreement not as an individual but on behalf of your company, then "**Customer**" or "**you**" means your company, and you are binding your company to this Agreement.

Sejda may modify this Agreement from time to time, subject to the terms in Section 16 (Changes to this Agreement) below.
...
This Agreement governs your initial purchase as well as any future purchases made by you that reference this Agreement. This Agreement includes our [Privacy Policy](https://www.sejda.com/privacy), [Service Level Agreement](https://www.sejda.com/sla), [Reporting Copyright Violations](https://www.sejda.com/takedown) guideline, any Orders and any other referenced policies and attachments.

2\. Types of Sejda Products
---------------------------
...
"**HTML to PDF API**" refers to Sejda's cloud-based HTML to PDF conversion API available under api.sejda.com and any related pages.
...
Our Software, such as Sejda Desktop, is subject to the additional terms set out in the [End User License Agreement](https://www.sejda.com/eula)
...
### 6.4 Responsibility for Your Data

#### 6.4.1 General

You and your use of Hosted Products (including use by your End Users) must comply at all times with these Terms and all Laws. You represent and warrant that: (i) you have obtained all necessary rights, releases and permissions to submit all Your Data to the Hosted Products and to grant the rights granted to us in these Terms and (ii) Your Data and its submission and use as you authorize in these Terms will not violate (1) any Laws, (2) any third-party intellectual property, privacy, publicity or other rights, or (3) any of your or third-party policies or terms governing Your Data. Other than our express obligations under the Terms, we assume no responsibility or liability for Your Data, and you are solely responsible for Your Data and the consequences of submitting and using it with the Hosted Products.
...
#### 6.4.3 Remarks About Password Removal
...
#### 6.4.4 Removals and Suspension

We have no obligation to monitor any content uploaded to the Hosted Products. Nonetheless, if we deem such action necessary based on your violation of these Terms, including Our Policies, or in response to takedown requests that we receive following our guidelines for [Reporting Copyright Violations](https://www.sejda.com/takedown), we may (1) remove Your Data from the Hosted Products or (2) suspend your access to the Hosted Products. We will use reasonable efforts to provide you with advance notice of removals and suspensions when practicable, but if we determine that your actions endanger the operation of the Hosted Products or other users, we may suspend your access or remove Your Data immediately without notice. We have no liability to you for removing or deleting Your Data from or suspending your access to any Hosted Products as described in this Section 6.4.4.

#### 6.4.5 No Prohibited Sensitive Personal Information

You will not submit to the Hosted Products (or use the Hosted Products to collect) any Sensitive Personal Information. Notwithstanding any other provision to the contrary, we have no liability under these Terms for Sensitive Personal Information submitted in violation of the foregoing.
...
Sejda has a zero tolerance policy for chargebacks. Any customer who disputes a credit card payment that is found to be valid will be permanently banned from using the Service.
...
You are permitted to use the Sejda HTML to PDF API from a product or service you provide to a third party, which must have substantially different functionality than the HTML to PDF API and must not allow any third party to use the HTML to PDF API for software development or application development purposes.
...
Sejda does not guarantee that the electronic signature provided through its sign tool is legally binding in your country or under the laws of the country governing the legal transaction that is the purpose of the signing process. Sejda further disclaims any liability for contracts that are not closed, lost or signed out of time due to the usage of the sign tool. We also do not guarantee that we have saved or delivered a copy of your contract.
...
Any notice under this Agreement must be given in writing. We may provide notice to you via email or through your account. Our notices to you will be deemed given upon the first business day after we send it. You may provide notice to us by post to Sejda BV, Unit G7171, Keurenplein 41, 1069 CD Amsterdam, Netherlands. Your notices to us will be deemed given upon our receipt.
