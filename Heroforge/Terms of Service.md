...
Sky Castle Studios LLC (“Sky Castle Studios”, “we”, and “us”)

You must be 16 years of age or older to use this site because of US online privacy laws concerning minors (COPPA).
...
* input, use or process the materials or any Content with any AI training software or algorithm, including, without limitation, in connection with or for purposes of deep learning;
* attempt to decompile, copy, access or misappropriate or reverse engineer any software or source code contained on the Hero Forge web site or pursuant to which it runs or is displayed;
...
* (f) improperly display any TCP/IP packet header or part of the header information in any email or other postings or use any iframes;
* (g) upload, or otherwise make available, files that contain images, photographs, software or other material protected by intellectual property laws, including, by way of example, and not as limitation, copyright or trademark laws (or by rights of privacy or publicity) unless you own or control the rights thereto or have received all necessary consents to do the same;
* (h) defame, abuse, harass, stalk, threaten, spam other users or continually send them unwanted emails or communications, solicit other users for business or commercial purposes, or otherwise violate any legal rights (including the rights of privacy and publicity) of others;
* (i) upload, post, email, transmit, or otherwise make available any unlawful, inappropriate, defamatory, obscene, pornographic, vulgar, offensive, fraudulent, false, misleading or deceptive content or message;
* (j) promote or engage in discrimination, bigotry, racism, hatred or harassment against any individual or group;
* (k) use an offensive screen name (e.g., explicit language) or avatar (e.g., containing nudity);
* (l) act in a deceptive manner or impersonate any person or organization;
* (m) harm or exploit minors;
* (n) upload or share any purchased 3D Models to a third-party site, application or service, e.g., Steam, for redistribution; or
* (o) collect information about users of the services or the site in violation of these Terms and Conditions or interfere with any third party’s ability to use or enjoy, or our ability to provide, the services or site.

Finally, you also agree to abide by our Community Guidelines \[[https://www.heroforge.com/community-guidelines](https://www.heroforge.com/community-guidelines/)\]

This license shall automatically terminate if you violate any of these restrictions. This license may be terminated by Sky Castle Studios at any time. Upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.
...
You agree to notify Sky Castle Studios immediately of any unauthorized use of your account or any other breach of security. We will not be liable for any loss, damages, liability, expenses or attorneys’ fees that you may incur as a result of someone else using your password or account, either with or without your knowledge, to the fullest extent permitted by applicable law. You will be liable for losses, damages, liability, expenses and attorneys’ fees incurred by Sky Castle Studios or a third party due to someone else using your account.
...
### 3.4 User Profiles, Account Settings, Sharing, Following and Searches

Users with an account on Hero Forge may create a profile of themselves with certain information that they choose to share, subject to these Terms and Conditions, including, without limitation, Section 7 below (“User Profiles”). We strongly encourage you to protect your personal information at all times, including when creating a username and your publicly accessible User Profile information and not to disclose it to anyone.

In a user’s account settings, the user may choose to share Character Designs they have created on or through the site with other users and make characteristics thereof, such as names, titles, and descriptive elements thereof publicly searchable. Users will be able to follow other users whose Character Designs they like.

We provide a feature for users to comment on publicly shared Character Designs on their character design pages. You are not allowed to share personal information of others, including through any comment or message posted on Character Design walls. Personal information includes:
...
### 4.3 Hero Forge Pro Subscription

A Hero Forge Pro Subscription consists of a suite of image creation tools with unlimited output, and other "power user" features, including adding folder functionality to a User's save files and other digital usability improvements. We may add or remove features from the Hero Forge Pro Subscription. If you sign up for a Hero Forge Pro Subscription, you will be immediately billed a one-time amount that is set forth when you sign up for the Hero Forge Subscription (as a non-refundable minimum purchase). Thereafter, your credit card will automatically be charged the recurring amount set forth when you sign up for your Hero Forge Subscription every 30/90/180/365 days depending on the subscription period you have chosen and your Hero Forge Pro Subscription will renew at those intervals. Unless you timely cancel prior to the renewal date, you will be charged as described above.

### 4.4 Hero Forge Pro + Downloads Subscription

A Hero Forge Pro + Downloads Subscription confers all of the benefits of a Hero Forge Pro Subscription, plus a number of “download credits” in amounts set forth when you purchase the subscription. Throughout the course of the subscription term, users may redeem these credits for a range of Hero Forge digital products, including but not limited to our “STL Download” product or our “3D Tabletop Download” product. Subscription terms begin at $14.99 USD a month, and users may purchase 1 month, 6 months, or 1-year terms and the number of credits available depends on the term that has been purchased. In addition to redeeming these credits for unique a la carte custom designs, users will be able to redeem the credits for pre-made packs of digital content. Further details and options are set forth when you click to sign up for a Subscription. Unused credits will “roll over” and accumulate for up to 13 months’ worth of credits. We may add or remove features from the Hero Forge Pro + Downloads Subscription. When you sign up, you will immediately be billed a one-time amount that is set forth when you sign up for the Hero Forge Pro + Downloads Subscription (as a non-refundable minimum purchase). Thereafter, your credit card will automatically be charged the recurring amount set forth when you sign up for your Subscription every month, six months, or year, depending on the subscription period you have chosen and your Hero Forge Pro + Downloads Subscription will renew at those intervals. Unless you timely cancel prior to the renewal date, you will be charged as described above.

### 4.5 Subscription Cancellation Policy

Customers may cancel at any time, subject to the time frames below. We do not place “holds” on Subscriptions. you must navigate to your Subscription account page \[www.heroforge.com/account/subscription\] and follow the instructions provided. There are no cancellation fees. Cancellations must be effected prior to the billing date of the Subscription renewal. Cancellations will have no effect on any charges incurred prior and up to the end of the current subscription billing period, but will be effective as of the conclusion of the current subscription period.

### 4.6 Promo Codes

Sky Castle Studios may, from time to time in its sole discretion, offer certain promotional codes for discounts. Promotional codes are non-transferable and are not redeemable for cash, credit, or toward previous purchases. The promotion code must be redeemed at the time of checkout, unless otherwise advertised, and cannot retroactively be applied to a purchase. There is no cash alternative. Furthermore, unless stated otherwise in the promotion, promotional codes cannot be used in conjunction with any other offer or promotional discount, and must be redeemed by the date published, if provided. Lost promotional codes cannot be replaced. Unless stated otherwise in the promotion, there is a limit of one promotional code per customer. Promotional codes are void where prohibited. Any promotional program may be terminated or modified by Sky Castle Studios at any time in its sole discretion.
...
We have the right to refuse or limit any orders, limit quantities, and Subscriptions. We will not be liable if a Product is unavailable or if shipment or delivery is delayed. Order may only be cancelled within 24 hours of purchase. After that, the orders are non cancelable. We may grant or deny cancellation requests for individual orders in our sole and absolute discretion. This sentence does not apply to Subscriptions, cancellation of which is subject to Section 4. We reserve the right to provide substantially similar products to fulfill your order.
...
If you receive a damaged or incomplete shipment of Products, or if you are otherwise unhappy with any Product, please email us at [\[email protected\]](https://www.heroforge.com/cdn-cgi/l/email-protection). We must receive notice of a damaged or incomplete shipment within ten (10) days of receipt (as shown on by our common carrier’s shipping information). Any refunds or replacements are made solely at our discretion.
...
The website may contain information and content provided by third parties. We have no obligation to monitor, we do not endorse, and we are not liable for any third-party content. In addition, the website may contain links to third-party websites. Sky Castle Studios is not responsible for the content on any linked site or any link contained in a linked site. We do not endorse or accept any responsibility for the content on such third-party sites. Third parties may offer their services directly to you through the website. In such case, you may be required to agree to the third party’s terms of service and/or privacy policy to use the service. Sky Castle Studios will not be liable in any way for the acts or omissions of such third party, the terms of service or privacy policy of the third party or its failure to adhere to its terms of service or privacy policy, or any loss, damages, liability or expenses (including attorneys’ fees) that you may incur arising from or related to such third party’s services or products.

7\. Contributions to Sky Castle Studios
---------------------------------------

Any text, photographs, artwork, ideas, questions, reviews, comments, suggestions or other content that you submit or post to the website or otherwise provide to us, including, without limitation, any content you include in a User Profile you may create on our website, but not any Character Designs, which are owned exclusively by Sky Castle Studios as set forth in Section 2 above, are referred to as “User Content.” The following Terms apply to User Content:

### 7.1 License to Sky Castle Studios

By sharing, submitting or uploading any User Content, you grant Sky Castle Studios a worldwide, perpetual, irrevocable, non-exclusive, royalty-free, sublicensable and transferable license to use, copy, distribute, display, publish, perform, sell, transmit, adapt, translate, modify, reverse-engineer, disassemble, market for our own purposes, and create derivative works from your User Content in any manner existing now or created in the future. Subject to the license above, you retain ownership of User Content.
...
You also grant us the right to use and display the name, photograph and any other information that you submit with any User Content for use in a User Profile you may create on our website.

### 7.4 Your Responsibility for User Content

Sky Castle Studios has no ability to control the User Content you may upload, post or otherwise transmit using the service and does not have any obligation to monitor such User Content for any purpose. You acknowledge and agree that you are solely responsible for all the User Content that you make available through the website. Accordingly, you represent and warrant that: (1) you have all rights, licenses, consents, and releases necessary to grant Sky Castle Studios the required rights to disseminate any User Content and (2) neither your User Content nor your posting, uploading, publication, submission or transmittal of this User Content or Sky Castle Studio’s use of your uploaded User Content (or any portion thereof) on, through or by the means of the website, will infringe, misappropriate or violate a third party’s patent, copyright, trademark, trade secret, moral rights or other intellectual property rights or rights of publicity or privacy or result in the violation of any applicable law or regulation. Moreover, you may not use and Sky Castle Studios will not use or permit you to use any User Content, including any designs or content you wish to use with our services, that, without limitation, violate any of the restrictions in 2 above or:

* Encourages violence or hatred against individuals or groups;
* Includes hate speech or symbols;
* Promotes, feature, or encourage the use of hard drugs;
* Features explicit sexual content or nudity;
* Includes sexually suggestive images or text involving children;
* Promotes, features, or encourages underage drinking, smoking, or marijuana use
* Includes crass vulgarity, lewd language, or swear words.
...
### 7.6 Explicit User Content

We allow users to create Character Designs or post User Content that may have educational, scientific, or artistic nudity, provided they are not obscene and do not otherwise violate these Terms and Conditions, including, without limitation, Section 7.4 above.

Explicit content that violates our Community Guidelines \[[https://www.heroforge.com/community-guidelines](https://www.heroforge.com/community-guidelines/)\] is not allowed (“Explicit User Content”). There is a way for users to report Explicit User Content so that we can review and, if appropriate, remove it from the Site. While Sky Castle Studios does its best to prevent Explicit User Content from being posted and has procedures for expeditiously removing it, Sky Castle Studios cannot guarantee that users will never be exposed to such Explicit User Content and will not be responsible in the event a user accidentally views or is exposed to Explicit User Content. You hereby assume the entire risk that you may be exposed to Explicit User Content that has somehow made its way onto the Site, and you hereby expressly release and waive any and all claims you may have against Sky Castle Studios in connection therewith.
...
Sky Castle Studios respects the rights of others and we expect users of our website and services to do the same. These Terms and Conditions prohibit the infringement of the copyrights of others, and it is also our policy that we may remove, suspend, terminate access of, or take other appropriate action against repeat offenders. We may also remove content that in our sole discretion appears to infringe the intellectual property rights of others or otherwise violates these Terms and Conditions.

### 8.2 How to File an Infringement Notification

If you have evidence, know, or have a good faith belief that content residing on or accessible through our website infringes a copyright which you own or for which you are a designated agent, please send a notice of infringement by fax, electronic mail or regular mail to Sky Castle Studios’ designated Copyright Agent to receive notifications of claimed infringement by one of the following means:

  

Sky Castle Studios Copyright Agent  
2701 Ocean Park Blvd. Suite 251, Santa Monica, CA 90406  
[\[email protected\]](https://www.heroforge.com/cdn-cgi/l/email-protection)  
(510) 633-3371
...
* Include information reasonably sufficient to permit Sky Castle Studios to locate the material. Please provide a URL and screenshots for each item. Include the specific asset(s) or page(s) that you claim to be infringing. Say “entire work” ONLY if all assets/pages in a collection/document are infringing.
...
THE WEBSITE, SERVICES AND PRODUCTS ARE PROVIDED “AS AVAILABLE” AND “AS IS” TO THE FULLEST EXTENT PERMITTED BY LAW, WITH NO REPRESENTATIONS OR WARRANTIES OF ANY KIND. SKY CASTLE STUDIOS DISCLAIMS TO THE FULLEST EXTENT PERMITTED BY LAW ALL WARRANTIES, EXPRESS, IMPLIED AND STATUTORY, INCLUDING ALL WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT. SKY CASTLE STUDIOS DOES NOT WARRANT THAT ANY PRODUCTS WILL BE IN STOCK, SAFE, DEFECT-FREE, CONFORM WITH WRITTEN OR ORAL SPECIFICATIONS, GUARANTEES, REPRESENTATIONS, WARRANTIES OR PROMISES, OR THAT PRODUCTS WILL NOT BE LOST OR DAMAGED IN SHIPMENT. THIS PROVISION IS NOT INTENDED TO DISCLAIM LIABILITY THAT WE MAY NOT DISCLAIM UNDER APPLICABLE LAW.

### 9.2 USE OF SITE IS AT YOUR OWN RISK

SKY CASTLE STUDIOS DOES NOT REPRESENT OR WARRANT THAT THE SITE, SERVICES OR EMAILS SENT TO YOU WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, FREE OF VIRUSES OR OTHER HARMFUL CODE, OR THAT ALL INFORMATION WILL BE ACCURATE OR COMPLETE. YOU AGREE THAT YOUR USE OF THE SITE SHALL BE AT YOUR SOLE RISK AND THAT YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR HARDWARE OR LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF MATERIAL OR DATA. SKY CASTLE STUDIOS MAKES NO REPRESENTATION, WARRANTY, GUARANTEE OR PROMISE THAT THE PRODUCTS, WEBSITE OR SERVICES WILL MEET YOUR REQUIREMENTS OR ACHIEVE ANY PARTICULAR RESULTS. SKY CASTLE STUDIOS WILL NOT BE RESPONSIBLE FOR ANY THIRD- PARTY CONTENT OR SERVICES ON THE SITE, ANY LINKS TO THIRD-PARTY WEBSITES OR ANY THIRD-PARTY WEBSITES. PACKAGING, LABELS AND INSTRUCTIONS MAY CONTAIN MANUFACTURER DISCLAIMERS AND LIMITATIONS OF LIABILITY THAT APPLY TO THE PRODUCTS YOU PURCHASE. SKY CASTLE STUDIOS MAKES ALL DISCLAIMERS IN THIS PARAGRAPH ON BEHALF OF ITSELF AND ITS LICENSORS AND SUPPLIERS.

### 9.3 NO CONSEQUENTIAL DAMAGES

IN NO EVENT, TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, WILL SKY CASTLE STUDIOS, ITS AFFILIATES OR THEIR RESPECTIVE OFFICERS, DIRECTORS, ATTORNEYS, EMPLOYEES OR REPRESENTATIVES (COLLECTIVELY “SKY CASTLE STUDIOS” FOR PURPOSES OF THIS SECTION) BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES RESULTING FROM THE PERFORMANCE, USE OF OR THE INABILITY TO USE THE WEBSITE, SERVICES OR PRODUCTS, EVEN IF SKY CASTLE STUDIOS HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, WHETHER IN AN ACTION IN CONTRACT, TORT (INCLUDING NEGLIGENCE), STRICT LIABILITY, VIOLATION OF STATUTE OR OTHERWISE. SKY CASTLE STUDIOS WILL NOT BE LIABLE FOR THE COST OF REPLACEMENT PRODUCTS, LOSS OF REVENUE, OR LOSS OF GOOD WILL.

### 9.4 OUR LIABILITY IS LIMITED

IN ANY EVENT, TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, OUR AGGREGATE LIABILITY WILL NOT EXCEED THE AMOUNT PAID FOR THE PRODUCT(S) TO WHICH THE CLAIM RELATES OR, IF THE CLAIM DOES NOT RELATE TO A PRODUCT, $99.99. THIS PROVISION IS NOT INTENDED TO EXCLUDE LIABILITY THAT SKY CASTLE STUDIOS MAY NOT EXCLUDE UNDER APPLICABLE LAW.
...
© September 2020 Sky Castle Studios, LLC. All rights reserved
