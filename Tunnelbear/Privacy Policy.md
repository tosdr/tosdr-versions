...
By using our Services and/or registering for an account, you are accepting the terms of this Privacy Policy and our [Terms of Service](https://www.tunnelbear.com/terms-of-service), which are integrated here by reference.
...
------------------------------------](https://www.tunnelbear.com/privacy-policy#1.0)
...
[### 1.1 What is Personal Data?](https://www.tunnelbear.com/privacy-policy#1.1)
...
![](/static/img/privacy_minimum@2x.e2ae3e8.png)

We strive to collect the minimum amount of information required to operate our service.

[### 1.2 Account User Data](https://www.tunnelbear.com/privacy-policy#1.2)
...
Marketing, communications, purchase receipts and occasional product news
...
Provide paid service until this date
...
If you pay for our services with a credit card, we do still collect your last name along with your payment information, see [1.4 Personal and Financial Data Collected at Payment](#1.4) for more details.

[### 1.3 Operational Data](https://www.tunnelbear.com/privacy-policy#1.3)
...
Operational events  
e.g. Created an account, complete Twitter bonus, made a payment, upgraded to paid subscription, online ad referrals

Troubleshooting account and payment related issues and tracking where sales come from; these events are not related to the time and activity of VPN usage
...
![](/static/img/privacy_satisfaction@2x.7fe37ad.png)

Some data is used to ensure customer satisfaction.

[### 1.4 Personal and Financial Data Collected at Payment](https://www.tunnelbear.com/privacy-policy#1.4)
...
![](/static/img/privacy_nofraud@2x.fa48188.png)
...
Cookie name: TB\_SESSION

Service: TunnelBear website customization
...
Cookie name: PLAY\_SESSION

Service: TunnelBear authentication

Cookie expiry: 7 days

PLAY\_SESSION is the authentication token for TunnelBear.com. It allows you to use your account without having to continuously login.

Cookie name: tb\_user

Service: TunnelBear authentication

Cookie expiry: 30 days

tb\_user allows us to understand whether you are a new or returning visitor to our website. By setting this cookie, we're able to customize the content on our own without using any third party tools.

Cookie name: XSRF-TOKEN

Service: TunnelBear XSRF protection

Cookie expiry: 1 year

One common attack used against website visitors is a [cross-site request forgery attack](https://en.wikipedia.org/wiki/Cross-site_request_forgery). TunnelBear uses this cookie to protect you from XSRF attacks.

Cookie name: downloaded

Service: TunnelBear download

Cookie expiry: 6 hours

downloaded allows us to track if you come visit the page multiple times in a short period.

Cookie name: \_\_cf\_bm

Service: Cloudflare bot

Cookie expiry: 30 min

It identify and mitigate automated traffic to protect site from bad bots.

Cookie name: \_\_cfruid

Service: Cloudflare

Cookie expiry: Session

It is necessary to support Cloudflare Rate Limiting products.

Cookie name: cf\_clearance

Service: Cloudflare challange

Cookie expiry: 5 hours

It is used to no longer issue a challenge if present.

Cookie name: \_ga

Service: Google Analytics – [IP anonymization enabled](https://support.google.com/analytics/answer/2763052?hl=en)

Cookie expiry: 2 years

To make our website better, we use Google Analytics (GA) to see how many people are visiting it. We have set GA to use the minimum available retention period and [not store IP addresses](https://www.tunnelbear.com/blog/how-we-avoid-collecting-your-ip-address-on-our-website/).
...
Google Analytics uses this cookie to [limit the number of requests](https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage) that we can make to their service in a given time period.
...
Google Analytics use this cookie to store and count pageviews
...
TunnelBear uses Cloudflare to protect our service from DDoS attacks. [Cloudflare uses \_cfuid](https://support.cloudflare.com/hc/en-us/articles/200170156-What-does-the-Cloudflare-cfduid-cookie-do-) in your browser so that once they have checked to see if you're a bot, they won't have to check again while you use our website.

Cookie name: \_stripe\_mid
...
Cookie name: tb\_test

Service: TunnelBear Teams

Cookie expiry: Session

This cookie records a bit of information that helps us track how people are finding TunnelBear Teams.

Cookie name: L1c

Service: Browser ID cookie
...
Service: LinkedIn Ad Analytics

Cookie expiry: 6 months

LinkedIn insights and ads tags

Cookie name: BizoData
...
Cookie name: BizoUser MatchHistory
...
Cookie name: BizoNetwork PartnerIndex
...
Cookie name: \_hjShownFeedbackMessage
...
Visit [Zendesk Cookie Policy](https://support.zendesk.com/hc/en-us/articles/4408824378650-Zendesk-In-Product-Cookie-Policy)

[### 1.6 Other Data TunnelBear Just does NOT Collect](https://www.tunnelbear.com/privacy-policy#1.6)
...
![](/static/img/privacy_nologging@2x.fc32f54.png)

No logging!

[2\. Personal Data
-----------------](https://www.tunnelbear.com/privacy-policy#2.0)

Any Personal Data you provide to TunnelBear will be administered according to the following principles:

[### 2.1 Accountability](https://www.tunnelbear.com/privacy-policy#2.1)
...
[### 2.2 Disclosure of Personal Data to Third Parties](https://www.tunnelbear.com/privacy-policy#2.2)
...
[### 2.4 Limiting Collection](https://www.tunnelbear.com/privacy-policy#2.4)
...
[### 2.5 Limiting Use, Disclosure, and Retention](https://www.tunnelbear.com/privacy-policy#2.5)
...
[### 2.7 Safeguards](https://www.tunnelbear.com/privacy-policy#2.7)
...
[### 2.8 Openness and Transparency](https://www.tunnelbear.com/privacy-policy#2.8)
...
[### 2.9 Individual Access](https://www.tunnelbear.com/privacy-policy#2.9)
...
[### 2.10 Individual Access](https://www.tunnelbear.com/privacy-policy#2.10)
...
[### 2.11 Rights of Access, Rectification, Erasure, and Restriction](https://www.tunnelbear.com/privacy-policy#2.11)
...
Visit [TunnelBear's privacy center](https://www.tunnelbear.com/account/privacy) to request access to, receive (port), seek rectification, or request erasure of Personal Data held about you by TunnelBear.
...
Phone: (819) 994-5444  
TTY: (819) 994-6591  
[www.priv.gc.ca](https://www.priv.gc.ca/ "Office of the Privacy Commissioner of Canada website")
...
_Your California Privacy Rights - Shine the Light Law_
...
[### 2.12 Changes to Our Privacy Policy](https://www.tunnelbear.com/privacy-policy#2.12)
...
![](/static/img/privacy_feedback@2x.25c0df6.png)
