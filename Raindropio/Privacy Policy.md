...
1\. How Raindrop.io Collects Information[​](#1-how-raindropio-collects-information "Direct link to 1. How Raindrop.io Collects Information")
--------------------------------------------------------------------------------------------------------------------------------------------
...
### i. Personal Information Provided by You[​](#i-personal-information-provided-by-you "Direct link to i. Personal Information Provided by You")

#### Registration and Other Information You Provide[​](#registration-and-other-information-you-provide "Direct link to Registration and Other Information You Provide")
...
#### Communications[​](#communications "Direct link to Communications")
...
#### Payment Information[​](#payment-information "Direct link to Payment Information")
...
### ii. Information We Collect When You Use the Services[​](#ii-information-we-collect-when-you-use-the-services "Direct link to ii. Information We Collect When You Use the Services")

#### Device Information[​](#device-information "Direct link to Device Information")
...
#### Cookies and Similar Technologies[​](#cookies-and-similar-technologies "Direct link to Cookies and Similar Technologies")
...
We may use both session cookies and persistent cookies. If you disable cookies on your browser, some parts of the Services may not work fully.
...
#### Additional data gathered from our browser extension[​](#additional-data-gathered-from-our-browser-extension "Direct link to Additional data gathered from our browser extension")
...
2\. How Raindrop.io Uses Information[​](#2-how-raindropio-uses-information "Direct link to 2. How Raindrop.io Uses Information")
--------------------------------------------------------------------------------------------------------------------------------

Raindrop.io will use information, including Personal Information, for the following purposes:

#### Providing the Service[​](#providing-the-service "Direct link to Providing the Service")
...
#### Communications[​](#communications-1 "Direct link to Communications")
...
3\. How Raindrop.io Discloses Information[​](#3-how-raindropio-discloses-information "Direct link to 3. How Raindrop.io Discloses Information")
-----------------------------------------------------------------------------------------------------------------------------------------------

### As Required by Law and Similar Disclosures[​](#as-required-by-law-and-similar-disclosures "Direct link to As Required by Law and Similar Disclosures")
...
4\. Transfer to Other Countries[​](#4-transfer-to-other-countries "Direct link to 4. Transfer to Other Countries")
------------------------------------------------------------------------------------------------------------------
...
5\. Data Retention[​](#5-data-retention "Direct link to 5. Data Retention")
---------------------------------------------------------------------------
...
6\. Our Commitment to Security[​](#6-our-commitment-to-security "Direct link to 6. Our Commitment to Security")
---------------------------------------------------------------------------------------------------------------
...
7\. Children’s Privacy[​](#7-childrens-privacy "Direct link to 7. Children’s Privacy")
--------------------------------------------------------------------------------------
...
8\. Do Not Track[​](#8-do-not-track "Direct link to 8. Do Not Track")
---------------------------------------------------------------------
...
9\. Your Rights and Choices[​](#9-your-rights-and-choices "Direct link to 9. Your Rights and Choices")
------------------------------------------------------------------------------------------------------

### Global Rights[​](#global-rights "Direct link to Global Rights")
...
### European Rights[​](#european-rights "Direct link to European Rights")
...
10\. How to Contact Us[​](#10-how-to-contact-us "Direct link to 10. How to Contact Us")
---------------------------------------------------------------------------------------
...
11\. Updates to this Privacy Policy[​](#11-updates-to-this-privacy-policy "Direct link to 11. Updates to this Privacy Policy")
------------------------------------------------------------------------------------------------------------------------------
...
* [1\. How Raindrop.io Collects Information](#1-how-raindropio-collects-information)
    * [i. Personal Information Provided by You](#i-personal-information-provided-by-you)
    * [ii. Information We Collect When You Use the Services](#ii-information-we-collect-when-you-use-the-services)
* [2\. How Raindrop.io Uses Information](#2-how-raindropio-uses-information)
* [3\. How Raindrop.io Discloses Information](#3-how-raindropio-discloses-information)
    * [As Required by Law and Similar Disclosures](#as-required-by-law-and-similar-disclosures)
* [4\. Transfer to Other Countries](#4-transfer-to-other-countries)
* [5\. Data Retention](#5-data-retention)
* [6\. Our Commitment to Security](#6-our-commitment-to-security)
...
* [9\. Your Rights and Choices](#9-your-rights-and-choices)
    ...
    * [European Rights](#european-rights)
* [10\. How to Contact Us](#10-how-to-contact-us)
* [11\. Updates to this Privacy Policy](#11-updates-to-this-privacy-policy)