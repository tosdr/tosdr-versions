...
This Add-on is owned and operated by Browsing Safety By Safely team. Browsing Safety by Safely is an add-on designed for Mozilla Firefox. After adding this add-on to the Firefox browser, the add-on will provide necessary safety warnings of potentially unwanted and malicious web content. We respect the privacy of users of our Add-on products and have developed this privacy policy (the "Privacy Policy") to demonstrate our commitment to protecting your privacy.

Browsing Safety By Safely is a Firefox browser add-on that intelligently detects the privacy-related search terms that the users type in their browser’s address bar. Once a privacy-related search term is detected, the add-on will send a notification to the user and offer the user to search for the same search term with a private search engine that the user selects.

### 2\. Scope

This Privacy Policy applies to information collected through Browsing Safety By Safely (“we”, “us” or “our”), whether accessed via computer, mobile device or other technology (collectively, the “Service”).
...
Please read this Privacy Policy carefully, prior to using the Service. By using the Service, you are acknowledging that you understand and agree to the terms hereof as well as the [terms & conditions](https://terms.thesafersearch.com/terms) set forth on the Site.
...
You can contact us to submit any GDPR related inquiry or request by submitting an inquiry to [\[email protected\]](https://terms.thesafersearch.com/cdn-cgi/l/email-protection)
...
* Submitting an inquiry to [elazarstarkman@gmail.com](mailto:elazarstarkman@gmail.com?subject=feedback%20from%20ff)
...
We regularly review our compliance with this Privacy Policy. Questions, comments and requests regarding this Privacy Policy are welcomed and should be addressed to [elazarstarkman@gmail.com](mailto:elazarstarkman@gmail.com?subject=feedback%20from%20ff).
...
* [Privacy](https://terms.thesafersearch.com/privacy.php)
* [Terms](https://terms.thesafersearch.com/terms.php)
* [Contact us](https://terms.thesafersearch.com/contact.php)
