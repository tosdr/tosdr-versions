[Home](https://www.fabiano.law/en/) » [Pages](https://www.fabiano.law/en/page/)
...
20 January 2022 · 7 min · Nicola Fabiano | Translations:

* [🇮🇹 IT](https://www.fabiano.law/it/page/privacy-policy/)

Table of Contents

* [Matomo opt-in or opt-out](#matomo-_opt-in_-or-_opt-out_)
* [Privacy Policy](#privacy-policy)
    * [Data controller](#data-controller)
    * [Legal basis for the processing](#legal-basis-for-the-processing)
    * [Processing of data](#processing-of-data)
        * [Browsing data](#_browsing-data_)
        * [Data communicated by users](#_data-communicated-by-users_)
    * [Cookies](#cookies)
        * [Matomo](#matomo)
    * [Data recipients](#data-recipients)
    * [Period for storing personal data](#period-for-storing-personal-data)
    * [Transferring personal data to a third country or international organisation](#transferring-personal-data-to-a-third-country-or-international-organisation)
...
![Privacy Policy](/images/compliant.png)

[icon created by Freepik - Flaticon](https://www.flaticon.com/free-icons/policy "policy icons")

**Privacy Policy**

* * *

Matomo _opt-in_ or _opt-out_[#](#matomo-_opt-in_-or-_opt-out_)
==============================================================

  

1. \[EN\]: **Allow** tracking (or choose 2) - \[IT\]: **Consento** al tracking (o scegli 2)

2. \[EN\]: **Disallow** tracking - \[IT\]: **Non consento** al tracking

**Opt-in:** **\[EN\]** You **allowed** tracking - **\[IT\]** **Hai consentito** al tracking.

**Opt-out:** **\[EN\]** You are **not** tracked - **\[IT\]** I dati di sessione **non** sono raccolti.

  

If you have chosen “Allow tracking” we remind you that we will collect your data only in an anonymous and aggregated manner as [reported in this policy](https://www.fabiano.law/en/page/privacy-policy/#matomo).  
You can still change your choices at any time.
...
We provide this information according to the [EU Regulation 2016/679 (GDPR)](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679&from=EN) for those who consult the website [https://www.fabiano.law](https://www.fabiano.law/). Note that this information applies only to those “Studio Legale Fabiano” website and not to other websites that the user may consult through links.

Data controller[#](#data-controller)
------------------------------------

The data controller is Nicola Fabiano (info \[at\] fabiano.law).

Legal basis for the processing[#](#legal-basis-for-the-processing)
------------------------------------------------------------------

The purpose is to consult this website, and the processing of personal data is based on consent - according to article 6, par. 1, lett. a) of EU Regulation 2016/679 - expressed by the user by browsing this website and its consultation, thus accepting this information. Consent is optional, and the user can withdraw at any time by request sent by email to privacy \[at\] fabiano.law, specifying that, in this case, whether the user does not consent, they cannot consult this website, and the navigation might be compromised.
...
* [Facebook](https://www.facebook.com/policies/cookies/) (cookie policy)
* [Twitter](https://twitter.com/privacy?lang=en) (cookie policy)
* [LinkedIn](https://www.linkedin.com/legal/privacy-policy) (cookie policy)

### Matomo[#](#matomo)

This site uses **only session cookies** [**Matomo**](https://matomo.org/) for Web Analytics to acquire _statistics in an anonymous and aggregate form_ related to your navigation on the pages of this site.

We have set the -do not track support- leaving the choice to the user to disable the opt-out.

The user can activate opt-in or deactivate opt-out anytime from the home page or at the top of this page.

**Thus, this site does not use cookies other than session cookies solely for the functional purposes described above, and their installation does not require the user’s consent**.
...
Users (data subject) of this website may exercise the rights according to Articles 15 to 22 of EU Regulation 2016/679. You can lodge all requests to exercise these rights by writing to privacy \[at\] fabiano.law
...
[« Prev  
Privacy - GDPR](https://www.fabiano.law/en/page/privacy_gdpr/) [Next »  
Team](https://www.fabiano.law/en/page/team/)

[](https://twitter.com/intent/tweet/?text=Privacy%20Policy&url=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f&hashtags=)[](https://www.linkedin.com/shareArticle?mini=true&url=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f&title=Privacy%20Policy&summary=Privacy%20Policy&source=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f)[](https://reddit.com/submit?url=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f&title=Privacy%20Policy)[](https://facebook.com/sharer/sharer.php?u=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f)[](https://telegram.me/share/url?text=Privacy%20Policy&url=https%3a%2f%2fwww.fabiano.law%2fen%2fpage%2fprivacy-policy%2f)