...
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and TTS Monster(" **Company** ", “**we**”, “**us**”, or “**our**”), concerning your access to and use of the tts.monster website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use, including the User Agreement posted on the Site, which are incorporated into these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
TTS Monster does not intend to profit or generate an income from it's AI TTS services. TTS Monster AI TTS can be created and used for free by any user through "Discord" bots, by visiting the TTS Monster discord server.
...
If you are unsatisfied with our services, please email us at legal@tts.monster.
...
* Reverse engineer and/or circumvent API restrictions
