...
This Privacy Policy applies to the SearchItWithUs Site and Services and is independent of any other site, services, or application(s) you may be installing or using concurrently. The SearchItWithUs Site and Services are provided and maintained by SearchItWithUs, which may be referred to herein as "SearchItWithUs," "We," "Us," or "Our" whether in uppercase, lowercase, or a combination.
...
* Media access control ("MAC") and operating system data
* Search term(s)
...
* The total number of Site visits and Service uses
* Browser type (to study browser trends, for example)
* MAC and operating system data
...
* Search term that was entered into the search box
* Originating IP address and the user's country or OS language setting
* Sponsored listings or other advertisements that you click on
* That the search request came from the relevant Site and its associated revenue tag
* MAC and operating system data

We suggest that you consider visiting the sites of these search engines to learn their privacy policies and more information about what they collect, as well as to determine how you may attempt to prevent the collection of such information, or clear such information. Some of these search engines are members of the Network Advertising Initiative (NAI). To opt out of other ad networks or to learn more about network advertising, please visit the NAI site and Digital Advertising Alliance website. In addition, some browsers have "do no track" functionalities or setting, which you might consider learning about.
...
IF YOU ARE THE PARENT OR LEGAL GUARDIAN OF A CHILD YOUNGER THAN 13 YEARS OF AGE WHO HAS BECOME AN SITE USER SUBSCRIBER, THEN PLEASE CONTACT US AT [\[email protected\]](http://searchter.com/cdn-cgi/l/email-protection) TO HAVE THAT CHILD'S ACCOUNT TERMINATED AND INFORMATION DELETED.
...
* [OnGuard Online](https://onguardonline.gov/socialnetworking.html), maintained by the Federal Trade Commission.
* [WiredSafety](https://www.wiredsafety.org/)
* [Netsmartz.org](https://netsmartz.org/)
* [The Child Safety Network](https://www.csn.org/)
* [Control Kids](https://www.controlkids.com/)
* [Cyber Sitter](https://www.solidoak.com/)
