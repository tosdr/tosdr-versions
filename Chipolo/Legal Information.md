...
By accessing or using the applications and services owned or operated by Chipolo, d.o.o., whether through our software app(s) or website (our “Services”), you are accepting and agreeing to be bound by the terms and conditions set forth below (these “Terms”).
...
Please refer to our [Privacy Policy](https://chipolo.net/pages/privacy-policy) for information on how we collect, use and disclose information from our users.
...
* Intercept or “sniff” the communication packets between the Chipolo hardware and mobile devices or attempt to reverse engineer the Chipolo Bluetooth Low Energy profile or Chipolo protocol; Access, tamper with, or use non-public areas of the Services, Chipolo’s computer systems, or the technical delivery systems of Chipolo’s providers;
* Interfere with, or attempt to interfere with, the access of any user, host or network, including, without limitation, sending a virus, overloading, flooding, spamming, or mail-bombing the Services;
* Attempt to access or search the Services or Content or download Content from the Services through the use of any tool, device or mechanism (including spiders, robots, crawlers, data mining tools or the like) other than the software and/or search agents provided by Chipolo or other generally available third party web browsers;
...
* a statement by you, made under penalty of perjury, that the above information in your notice is accurate and that you are the copyright owner or authorized to act on the copyright owner’s behalf. Notice of claims of copyright infringement should be sent to our Copyright Agent either via email at [\[email protected\]](https://chipolo.net/cdn-cgi/l/email-protection) or by mail addressed to Copyright Agent, Chipolo, d.o.o., Gabrsko 12, 1420 Trbovlje, Slovenia
...
Chipolo warrants that your Chipolo hardware product (“the Product”) will be free from defects in materials and workmanship for a period of two (2) years from the date of delivery to the original retail purchaser (“the Warranty Period”). If a defect in the Product arises within the Warranty Period, Chipolo will, at its sole option and subject to applicable laws: (a) repair or replace it with a new or refurbished product or component; or (b) refund the original purchase price upon return of the defective Product. This Warranty does not apply where the instructions for use and activation of the Product are not complied with or where the Product is damaged as a result of abuse, accident, modification or other causes beyond our reasonable control.
...
Warranty is only valid under normal use of your device and purchase of Chipolo at Chipolo-approved distributors/sellers as stated at www.chipolo.net. Any purchase from sellers not authorized by Chipolo is not subject of any warranty and/or repair service.

List of authorized distributors and sellers:

* Amazon - Offical Chipolo Store
* Best Buy US
...
* Paradigm Direct Sales
* Superior Communications
* Hirsch Gift
* Forward Industries (IN), Inc.
* Newgen Distribution AB
* ComputerWorks AG
* GL Entertainment Distributions LTD
* Cesium Telecom, Inc.
* i4, industrijsko oblikovanje, d.o.o
* DAS Companies, Inc.
* Nital S.p.A.
* SOFTproject, d.o.o.
* MacGear Limited
...
* KUBBICK
* BlueGreenGroup, Inc.
* L7 Prestige Brand, S.L.
* MacGear Australia
* ZENIT LOGISTICS LLC
* EasyCo s.r.o.
* WIT Entertainment (Att Cox)
* Modus Brands (Vincent van Oorscho)
* Ingram Micro
* DK store
* UNION Trading GmbH
* Microline d.o.o.
* Big Bang, d.o.o.
* Mente advertising & marketing prod.
* SERVISOFT
* JANUS TRADE, d.o.o.
* JBTS
...
Should you be dissatisfied with our product, the original retail purchaser of the Product may return all Chipolos purchased in the original transaction, in their original condition, with the original receipt and packaging, within 30 days of the date of delivery to the original retail purchaser and Chipolo d.o.o. will exchange it or provide a full refund of the original purchase price. Please note that this policy applies only to Products you purchase directly from Chipolo d.o.o.. This is in addition to your legal rights and your rights under the Chipolo hardware two (2) year Worldwide Warranty referred to above.
...
Once you have submitted your request you will be contacted within 24 hours with instructions on how to return your order. Upon receipt, we will verify that all of the Chipolos in your original order are included with the return and that the Chipolos are in good physical condition. Once the refund has been processed a confirmation message will be sent out with information on when the refund should be expected.
