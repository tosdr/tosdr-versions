[![logo](https://cdn.fraudlabspro.com/assets/img/logo.svg)](https://www.fraudlabspro.com/)
...
* First, it addresses Personal Data we process in our FraudLabs Pro application (the “App”) or in our FraudLabs Pro plug-ins (the “Plug-in”) or in our FraudLabs Pro JavaScript (the “JavaScript”) or in our FraudLabs Pro API (the “API”) or in our fraud detection solution located at [https://www.fraudlabspro.com](https://www.fraudlabspro.com/) (collectively, with the App, the Plug-in, the JavaScript and the API, the “Service”).
* Second, it explains our privacy practices in connection with Personal Data we may collect about you when you contact us or access our FraudLabs Pro website located at [https://www.fraudlabspro.com](https://www.fraudlabspro.com/) (the “Website”).
...
We collect order related information which we store in the Service to determine possibility of e-commerce fraud. Many of our customers use this analysis result to provide the right services to the right people. For example, an e-commerce website using the Service to filter International orders and avoid chargebacks.

We work very hard to protect the Personal Data we do collect and to ensure that the Personal Data we collect is appropriate for the services we provide. You can view the information we typically collect about your device, order and location for use in the Service by visiting [this demo page of our Website](https://www.fraudlabspro.com/demo). You can request that we delete or not sell the Personal Data we have about you at any time via the process described below.
...
**Data Used In The Service:** The Personal Data we collect for use in our Service is described in detail in the Table below. With respect to the Personal Data used in the Service we only collect important order information required to determine the risk of e-Commerce transaction. Most of the order information we collect is provided by our customers. The order information is based on the data received in shopping cart during e-Commerce checkout process. Our customers may also add JavaScript in their web sites to collect the web activities of visitors.
...
* Identifiers: first and last name, user name, email address, credit card information, company name, phone number, IP address and device fingering.
* Special Categories of Personal Data (as defined in the CCPA): Credit card numbers, or other financial account information.
...
* Geolocation data: billing address, shipping address, country, region, city, ZIP code, time zone, weather station, and other geolocation data.
* Other Personal Data: Feedback you may provide through our email, or our website, or to exercise your Data Subject Rights Requests, to the extent it contains Personal Data not already described above.
...
* our legitimate interests and the legitimate interests of our customers for the purpose of facilitating the fulfillment of their business needs, which may include the detection and prevention of credit card fraud, compliance with export control and sanctions, etc.; and
...
| --- | --- | --- | --- |
| _Identifiers_  <br>First and last name, user name, email address, company name, phone number, IP address and device fingerprint. | _Identifiers_  <br>We obtain this information through order form in our web site or obtain this information us through the Service from our customers. | _Identifiers_  <br>To provide fraud analysis to our customers for the purpose of providing the Service; our legitimate interests and those of our customers (as detailed above). | _Identifiers_  <br>Our customers; certain third party vendors that provide infrastructure support services, and software management services (service desk, bug tracking, etc.). |
| _Special Categories of Personal Data_  <br>credit card information | _Special Categories of Personal Data_  <br>Same as above. | _Special Categories of Personal Data_  <br>Same as above. | _Special Categories of Personal Data_  <br>Same as above. |
| _Commercial Information_  <br>Order amount, order currency and order quantity. | _Commercial Information_  <br>Same as above. | _Commercial Information_  <br>Same as above. | _Commercial Information_  <br>Same as above. |
| _Internet or other similar network activity_  <br>Information about your interaction with our website and our advertising for the Service; whether you are using a proxy server; information about which Internet Service Provider you are using and their location; Internet connection speed, ISP domain name; mobile carrier and usage type information | _Internet or other similar network activity_  <br>Same as above. | _Internet or other similar network activity_  <br>Same as above. | _Internet or other similar network activity_  <br>Same as above. |
| _Geolocation Data_  <br>Billing address and shipping address. | _Geolocation Data_  <br>Same as above. | _Geolocation Data_  <br>Same as above. | _Geolocation Data_  <br>Same as above. |
...
If you would prefer not to accept cookies, you can alter the configuration of your browser to reject all cookies or some cookies. Note, if you reject certain cookies, you may not be able to access all of our Website’s features. For more information, please visit [https://www.aboutcookies.org/](https://www.aboutcookies.org/).

You may also set your browser to send a Do Not Track (DNT) signal. For more information, please visit [https://allaboutdnt.com/](https://allaboutdnt.com/).
...
None of our services and specifically the Service are not directed at, or intended for use by, children under the age of 18. We have no actual knowledge that we sell the personal information of minors under 16 years of age.
...
**Data Used In The Service:** With respect to the Personal Data processed as part of the Service, you can access and view the information we collect at any time [at this demo feature](https://www.fraudlabspro.com/demo). Please see the Section “How Can You Exercise Your Privacy Rights,” below, for more information.
...
If your account settings do not allow you change it directly, please follow the steps described below and we will do our best to change the Personal Data for you.
...
You have the right to ask us to not sell your Personal Data at any time. This is called the “right to opt out”. We do not sell the information we collect from our Website or from our Customers.

To exercise the right to opt-out, you may submit a request to us by completing the below webform:

[DO NOT SELL REQUEST FORM](https://www.fraudlabspro.com/do-not-sell)
...
In addition, we do not sell the Personal Data of individuals of individuals that we know that are less than 18 years old. Individuals who opt-in to Personal Data sales may opt-out of future sales at any time.
...
[MANAGE YOUR DATA WITH US](https://www.fraudlabspro.com/do-not-sell)

You may always contact us by email at [support@fraudlabspro.com](mailto:support@fraudlabspro.com); or by writing to us at:  
...
**For requests related to Personal Data stored in the Service PLEASE NOTE** since we require your email address to verify your identity, the simplest way to make your request is via our webform. We will request you to verify the email address using a special code.

Authorized Agents
-----------------

**Data Collected Via Website or Customers:** You may appoint an authorized agent to exercise your rights on your behalf. You should appoint such agent via written permission or a power of attorney pursuant to [Probate Code sections 4000 to 4465](https://law.justia.com/codes/california/2011/prob/division-4-5/) (if you reside in the State of California) or the applicable rules for authorizing somebody else to exercise your rights in your country of residence.
...
**Data Used in the Service:** In addition to the above information, your authorized agent will need to provide us with a certification or attestation.
...
If you have any questions about this Notice or our processing of your Personal Data, please write to us by email at [support@fraudlabspro.com](mailto:support@fraudlabspro.com) or by postal mail at:  
