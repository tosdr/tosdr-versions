...
BanQu — Website & Blockchain Application Privacy Policy  
Effective May 1, 2019

BanQu, Inc. (“BanQu”) respects your privacy. This Privacy Policy tells you how we will use the information entrusted to us when you visit [https://banqu.co](https://banqu.co/) or any other online site or application we operate that links to this Privacy Policy (collectively the “Services”) from any device.

Scope of this Policy

This Privacy Policy describes how BanQu uses your personal information for its own purposes. It does not apply to the processing of personal information to provide services to the businesses and organizations that use our Services to provide you with economic identity services, as well as to conduct business with you (“Clients”).  
Our Clients access our Services for their own purposes. If you are affiliated with any of our Clients, they may process your information pursuant to their own privacy policies. This Privacy Policy does not apply to our Clients’ collection and processing of your personal information.In connection with providing the Services to our Clients, we process certain personal information on behalf of and at the direction of our Clients. Our Clients remain the owners and controllers of that personal information. Any personal information we process on behalf of our Clients is governed by our Clients’ privacy policies. Except as expressly described in the “Client Employees” section below, this Privacy Policy does not apply to use of the Services by our Clients’ employees.
...
We also may collect other types of information from you with your consent. We may combine all of the information we collect or receive about you and use or disclose it in the manner described in this Privacy Policy.
...
* Other Parties With Your Consent. In addition to the sharing described in this Privacy Policy, you may grant access to your information to other third parties, including:
...
Some of the functionality on the Services may be provided by third parties that are not affiliated with BanQu. These entities may collect or receive certain information about your use of the Services, including through the use of cookies, Web beacons, and similar technologies. BanQu is not responsible for the privacy practices of these entities.
...
All the information you provide may be transferred or accessed by entities around the world as described in this Privacy Policy. If you access the Services from outside the United States, please be aware that information you provide to us or that we obtain as a result of your use of the Services may be processed and transferred to the United States and be subject to U.S. law. The privacy and data protection laws in the United States may not be equivalent to such laws in your country of residence. You understand and acknowledge that by using our website, accessed by any device, or by providing us with your information, we collect, transfer, store, and process your information to and in the United States.
...
* Cookies. Cookies are small text files that websites and other online services use to store information about users on the users’ own computers. For example, cookies can be used to store your login credentials so that you do not have to enter them each time you return to a website. Cookies also may be used to store a unique identification number tied to your computer so that a website can recognize you as the same user across different visits to the website. You can configure your Internet browser to warn you each time a cookie is being sent or to refuse cookies completely.

BanQu and the third parties that provide functionality on the Services may use cookies to relate the information automatically collected when you use the Services to information we obtain from you directly or from commercially available sources.
...
From time to time, we may revise this Privacy Policy to reflect changes to the scope of the Services or for other reasons. Therefore, it is important to check the effective date of the Privacy Policy posted here each time you use the Services. If we make any material revisions to this Privacy Policy, we email you at the email address you have provided or will place a notice on our website. By continuing to use the Services after we make changes, you indicate your consent to those changes, except as limited by applicable law.

Questions and Contact Information

We want to assure you that we are dedicated to protecting your privacy. If you have questions or comments about this Privacy Policy, please contact [info@banqu.co](mailto:info@banqu.co).  
...
BanQu – Blockchain Application Terms of Use  
BanQu, Inc. (BanQu)

Effective May 1, 2019  
  
These Terms of Use govern your access to and use of BanQu’s website at [https://banqu.co](https://banqu.co/) and any other website or online application that links to these Terms (the “Services”). These Terms are a legal contract between you and BanQu, and you agree to this contract by using the Services. These Terms also contain limitations on BanQu’s liability and an arbitration provision, so it is very important that you review them carefully before using the Services.
...
4. harvest or otherwise collect information about others, including e-mail addresses, without their consent;
5. take any action that imposes an unreasonable or disproportionately large load on the Services’ infrastructure;
6. use any device, software, or routine to interfere or attempt to interfere with the proper working of the Services or any activity conducted on the Services;
7. use or attempt to use any engine, software, tool, agent, or other device or mechanism (including, without limitation, browsers, spiders, robots, avatars, or intelligent agents) to navigate or search the Services other than the search engine and search agents available on the Services and other generally available third-party web browsers;
8. attempt to decipher, decompile, disassemble, or reverse-engineer any of the software comprising or in any way making up a part of the Services;
9. engage in any other conduct that restricts or inhibits any other person from using or enjoying the Services.
...
2. attempting to probe, scan, or test the vulnerability of a system or network, or breach security or authentication measures without proper authorization;
...
4. sending unsolicited e-mail, including promotions or advertising of products or services;
...
[Scope of this Policy](#Scope-of-this-Policy)[Collection of Information](#Collection-of-Information)[Sharing of Information](#Sharing-of-Information)[Client Employees](#Client-Employees)[Third-Party Functionality](#Third-Party-Functionality)[Storage and Protection of Information](#Storage-and-Protection-of-Information)[Children’s Information](#Children-s-Information)[Non-U.S. Users](#Non-US-Users)[Changing or Deleting Your Information](#Changing-or-Deleting-Your-Information)
