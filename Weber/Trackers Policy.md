...
* **A. Data Privacy Rights and Inquiries**
    ...
    United States consumers have the ability to request information or to make inquiries from Weber regarding use of your data by visiting our [data access ticket system](https://app-de.onetrust.com/app/#/webform/616bbec2-6fcf-47bd-805a-e1c33281ba92 "Data Access Ticket System").  The data access ticket system is operated by a reputable third party. Only Weber representatives will respond to and address your inquiry, but the third party operating the system will collect information including IP address, information collected by cookies, log information, referring website, and information you provide in submitting your request to Weber, such as your first and last name, email, country and details of your request. You may also email [privacy.americas@weberstephen.com](mailto:privacy.americas@weberstephen.com "Email Us")  for data access inquiries and requests.
    
    Where required by applicable law, you have a right to request access to your personal information, to request a correction to it if you believe it is inaccurate, or exercise other rights to your personal information. If you have submitted personal information to Weber and would like to exercise such rights, please contact us using the contact information provided below. We may require you to verify your identity before we provide you with access to your information. We will use reasonable efforts to comply with your requests; however, in some cases we may not be able to allow you to access certain personal information (for example if it contains personal information of other persons or for legal reasons). In such cases, we will provide you with a reasonable explanation of why it is not possible to grant access to your personal information.
    
* **B. Data security**
    
    Weber implements reasonable technical and organizational security measures, including physical, organizational and technological protection, (such as the use of SSL encryption for certain components of the Applications) to help protect accruing or collected personal information against accidental or intentional manipulation, loss, destruction or attacks by unauthorized persons. Our security measures are continuously being improved as new technologies become available and following our regular review of our current data security, access and protection practices. Personal information may be accessed by persons within our organization, or our third party service providers, who require such access to carry out the purposes indicated above, or such other purposes as may be permitted or required by the applicable law.
    
    Although we have taken measures to help protect our Applications, computer systems and any personal information that we have collected from unauthorized use, access, disclosure, misuse, alteration or destruction, no security measures can provide absolute protection. We cannot ensure or warrant the security of any information you provide to us. 
...
* **A. Information Generally Collected and Used for the Applications**
    
* i. Usage data
    
    To ensure trouble-free use of the Applications, we need to collect and process the following personal information:
    

* General
    * City, State and/or Country
    * Language
    * Consent, where applicable (eg: marketing opt-in).
    * Mobile operating system
    * Unique device ID
    * IP address
* Mobile App or web browser version
* Session data (time, temperature, type of meat)
* Optional: Marketing data (opt-in, if selected by user)
    * E-mail address
    * Name

The aforementioned data may be used for identifying the respective user while he is using the Applications and for analytics purposes as described below.

ii. Location data

In addition to collection of location data for analytics purposes and for support services as described below, for certain Mobile Applications a Bluetooth connection is required to connect to the applicable Weber device. Please note that under certain versions of e.g. Android OS, location data is also processed necessarily when Bluetooth is activated. For this the publisher of your operating system is controller. If desired, you can deactivate the transfer of your location via the settings of your operating system.

iii. Analytics

The Applications use analytics tools, which collect and transmit anonymous data of the user's behavior, such as location, smart device, mobile operation system, app usage information and device type (if applicable) for the purpose of analysis and improvement of the Applications. For certain mobile applications, you can deactivate collection of data for analytics purposes by turning off the Analytics switch. You may also review your options regarding choice in analytics in the Cookies section below.

We may also combine certain usage information from a particular Application, browser, computer or mobile device with another Application, browser, computer or device that may be linked to you (cross-device tracking) in order to optimize our services and provide tailored communications and advertisements to you. Regarding your consent to receive marketing communications, if you do not want to receive these tailored communications, please unsubscribe from Weber communications as detailed below.

You may adjust your options regarding certain analytics in the mobile Applications in the Settings of the mobile Application. You may adjust your options with regard to certain analytics on our website as described in the Cookies section below.
...
* **C. Information specific to Mobile Applications**
    ...
    To use a Weber mobile application or to connect your phone or other device to your iGrill, Weber Connect - capable device or grill or other Weber connected devices via Bluetooth, it is not required to create a Weber-ID account. However, many features of these applications are only available to registered users. Please find below some information on the data processes for both registered (Weber-ID) and non-registered users.
    
    With regard to your use of Weber's mobile applications, if you do not log in or create a Weber-ID, the mobile application creates a random anonymous identification ("Random ID") which is transferred to the cloud, where the following data may be stored for the user under the Random ID:
    
    * Target Temperature
    * Cavity Index and Cavity Temp
    * Probe Index and Probe Temp
    * Preset Category
    * Preset Sub Category
    * Doneness
    * Cook Mode
    * Start Date
    * End Date
    * Session Name/Consumer Login Name
    * Program ID, Plan ID and Prompt ID
    * Boot Count and Time Since Boot
    * Timestamp
    * Graph Data (temperate point for each second of the session collected from Device)
    * Product Model
    * Device or Hardware ID
    * Cook Session ID
    * Firmware Version
    * Probe Placement
    * Timer Information and Duration
    ...
    * Notes
    * Notifications
    * Model and/or serial number of any paired grill device
...
* **D. Information Specific to the Website.**
    ...
    The specific scope and mode of collection and use of your data depends on whether you are just visiting our website (e.g. for viewing the products we offer) or whether you are actually using specific services (e.g. if you order products).
    
    i. For Browsing the Website
    
    If you use the Weber website for browsing only, generally you are not required to provide any personal information (though certain aspects of the site may utilize such information if available). In this case (and apart from these other aspects of the site as described in this Policy), we collect and use those of your data which your Internet browser transmits to us automatically, such as:
    ...
    * Your IP address.
    ...
    If you visit a Weber website for browsing only (and have not created a Weber-ID or otherwise provided Weber with more specific information), we collect and use this data in non-personal form. This is done to generally enable the use of the websites you visit as well as for statistical purposes and for improving our web presence and the services we provide there.
...
Weber wants to make sure you are up to date and involved on our newest **_Innovations_** , including products, technologies and other offerings. With this in mind, in this Section of the Policy, we discuss our use of your data for advertising and consumer insights and research purposes.
...
When you use the Applications, please note that we may share your hashed email addresses, as well as other pseudonymous identifiers and data about your use of the Applications and your device if applicable, with Facebook and other social media networks, as well as other online platforms and related reputable service providers, in order to utilize services which may include but are not limited to Facebook's Custom Audience and pixel services.
...
Once engaged with the relevant social media website, your use and browsing will be governed by the data protection statements/privacy policies of the relevant providers.
...
* **A. Session Cookies**
    ...
    We may use "session cookies" (also called temporary cookies), i.e. cookies which are stored for the time while you are using for certain aspects of using the Applications. The purpose of these cookies is to display online content within our mobile apps, or identify your device while you are using a Weber website, even while changing from one of our websites to another, and to determine the end of your visit to one of our Websites.
    
    The cookies are deleted as soon as you have closed your browser or mobile app session.
    
* **B. Tracking and Targeting Cookies**
    
    On the Applications we also use tracking and targeting cookies that monitor the user's behavior. For that purpose we use so-called First-Party cookies, which are not made available by your browser to other domains than the Website.
    ...
    * Mouse movement and Heatmaps - this analyzes the mouse movement of the user and tracks where a particular high occurrence took place
    ...
    In addition to indicating your preferences in the cookie preference center, to exercise choices with regard to certain cookies (e.g., disable, delete), you can review your Internet browser settings, typically under the "Help" or "Internet Options" sections. Please note that our Applications rely on some cookies to function properly. If you disable or delete certain cookies in your Internet browser settings, you might not be able to access or use important features or functions of the Applications, and you may be required to re-enter your login details.
    
    To learn more about the use of cookies for Google analytics and to exercise choice regarding such cookies, please visit: [https://tools.google.com/dlpage/gaoptout](https://tools.google.com/dlpage/gaoptout "Google Analytics Opt-out").
    ...
    * Digital Advertising Alliance ([http://optout.aboutads.info/](http://optout.aboutads.info/?c=2&lang=EN#!/ "Digital Advertising Alliance"))
    * Network Advertising Initiative ([http://optout.networkadvertising.org/](http://optout.networkadvertising.org/ "Network Advertising Initiative"))
    * EU Interactive Digital Advertising Alliance ([http://www.youronlinechoices.eu](http://www.youronlinechoices.eu/ "EU Interactive Digital Advertising Alliance"))
    * Digital Advertising Alliance-Canada ([http://youradchoices.ca/choices/](http://youradchoices.ca/choices/ "Digital Advertising Alliance-Canada"))
    
      
    
    You can also read further about how the Website uses third party cookies and how you can control their use when you visit the Website in the next section.
