[Javascript license information](https://posteo.de/js-licenses.html)

Posteo funktioniert nur mit aktiviertem Javascript!

[![Posteo](/images/posteo-logo.svg?v=28055cd298d04774c6ea5b70eaba38c8f0f93f63484c3f89e7783edf22d59b26)](https://posteo.de/de "zurück zur Startseite")

Menü

zurück zum Anfang der Seite

[Registrieren](https://posteo.de/registrierung)

![](/images/svg-icons/fa-globe.svg?v=12bd4b595c266000f1d258287234db84805a301c22631dbc9278357b0af8f33e) [Français](https://posteo.de/fr/site/declaration_protection_donnees)

![](/images/svg-icons/fa-globe.svg?v=12bd4b595c266000f1d258287234db84805a301c22631dbc9278357b0af8f33e) [English](https://posteo.de/en/site/privacy_policy)

![](/images/svg-icons/fa-globe.svg?v=12bd4b595c266000f1d258287234db84805a301c22631dbc9278357b0af8f33e) [Français](https://posteo.de/fr/site/declaration_protection_donnees)

![](/images/svg-icons/fa-globe.svg?v=12bd4b595c266000f1d258287234db84805a301c22631dbc9278357b0af8f33e) [English](https://posteo.de/en/site/privacy_policy)

* [Das Postfach Alle Leistungen](https://posteo.de/site/leistungen)
* [Über uns Mehr zu Posteo](https://posteo.de/site/ueber_posteo)
    
    * [Wir über uns](https://posteo.de/site/ueber_posteo)
    * [Presse über uns](https://posteo.de/site/andere_ueber_uns/)
    * [Posteo-Transparenzbericht](https://posteo.de/site/transparenzbericht)
    * [Wen wir unterstützen](https://posteo.de/site/wirunterstuetzen)
    * [Posteo Lab in Berlin](https://posteo.de/lab/)
    
* [Aktuelles Blog & Presse](https://posteo.de/blog)
* [Hintergrund-Info zu Datenschutz & Co](https://posteo.de/site/faq)
    
    * [Häufige Fragen](https://posteo.de/site/faq)
    * [Maximaler Datenschutz](https://posteo.de/site/datenschutz)
    * [Posteo-Verschlüsselung](https://posteo.de/site/verschluesselung)
    * [Konsequente Nachhaltigkeit](https://posteo.de/site/nachhaltigkeit)
    * [Anonymisierte Zahlung](https://posteo.de/site/bezahlung)
    
* [Hilfe bei allen Fragen](https://posteo.de/site/hilfe)
* [Kontakt Wir sind für Sie da](https://posteo.de/site/kontakt)
...
Die Erbringung unserer E-Mail-Dienstleistungen erfordert die Verarbeitung von Daten und erfolgt entsprechend den gesetzlichen Vorschriften. Für den Datenschutz sind insbesondere die Datenschutzgrundverordnung (DSGVO), das geltende Bundesdatenschutzgesetz (BDSG), das Telemediengesetz (TMG) sowie das Fernmeldegeheimnis maßgeblich. Die Dienste von Posteo werden ausschliesslich auf unseren Servern in Deutschland gehostet.
...
Im November 2016 hat die Bundesdatenschutzbeauftragte(BfDI) einen anlasslosen Kontrollbesuch zum Datenschutz bei Posteo durchgeführt. Es gab keine Beanstandungen und die BfDI lobte ausdrücklich unser Datenschutzkonzept. Den vollständigen Prüfbericht finden Sie [hier](https://posteo.de/blog/datenschutz-wirklich-beeindruckend-umgesetzt-bundesdatenschutzbeauftragte-%C3%BCber-posteo).

Keine Bestandsdaten
-------------------

Wir erheben und speichern grundsätzlich keine Bestandsdaten (wie Namen, Adressen, etc.) von Ihnen. Sie geben bei der Registrierung weder Bestandsdaten an, noch werden sonstige personenbezogene Daten erhoben.

Wir beugen mit dieser konzeptionellen Datensparsamkeit effektiv Datendiebstählen vor: Nur Datensätze, die bei einem Unternehmen nicht vorliegen, können mit 100-prozentiger Sicherheit nicht entwendet werden. Darüber hinaus werden [Bezahldaten](https://posteo.de/site/bezahlung) bei Posteo nicht mit Ihrem Postfach verknüpft. Deshalb liegen bei uns insgesamt tatsächlich keine Bestandsdaten zu Ihrem Posteo-Postfach vor. In anderen Worten: Posteo führt keinen Datensatz mit Kundendaten bzw. personenbezogenen Daten zu Ihrem Postfach.

Dies wurde 2017 nach einer Vor-Ort-Prüfung in einem [Prüfbericht der Bundesdatenschutzbeauftragten](https://posteo.de/blog/datenschutz-wirklich-beeindruckend-umgesetzt-bundesdatenschutzbeauftragte-%C3%BCber-posteo) unabhängig bestätigt.
...
Wir erheben und speichern rechtskonform grundsätzlich keine auf Kunden beziehbaren IP-Adressen. Dies wird im Prüfbericht der Bundesdatenschutzbeauftragten zu Posteo unabhängig bestätigt. Wir erheben Ihre IP-Adresse auch nicht, wenn Sie unsere Website besuchen, unser Kontaktformular oder den Webmailer nutzen. Wir erheben oder speichern Ihre IP-Adresse auch nicht, wenn Sie E-Mails über IMAP oder POP3 abrufen oder mit einem externen Client über SMTP bei uns zum Versand einliefern. Bei der Kommunikation zwischen E-Mailservern über SMTP werden uns IP-Adressen anderer E-Mail-Server bekannt, also z.B. IP-Adressen von GMX- oder Gmail-Servern. Die IP-Adressen der Anbieter-Server werden nur in Fehlerfällen in den Logfile-Protokollen aufgeführt und nach 7 Tagen gelöscht.

Wir protokollieren lediglich Fehler beim Senden und Empfangen von E-Mails, um technische Störungen und Fehler rasch nachvollziehen und beseitigen zu können. Diese nicht personenbeziehbaren Daten löschen wir automatisiert nach 7 Tagen. Außerdem erstellen wir allgemeine, anonyme System-Nutzungs- bzw. Auslastungsstatistiken. Auch diese Statistiken enthalten keine personenbeziehbaren Daten oder IP-Adressen.
...
Alternativ können Sie in vielen Fällen für den Import auch unseren [Umzugsservice](https://posteo.de/hilfe/posteo-umzugsservice-benutzen) benutzen.
...
Geben Sie Text in unser Kontaktformular ein, bleibt er bis zum Absenden lokal auf Ihrem Gerät. Posteo steht für echtes "Privacy by Design": Ggf. angezeigte Lösungsvorschläge werden lokal in Ihrem Browser vorgehalten und beim Eintippen von Schlagworten angezeigt. Während Sie tippen, werden keine Daten durch das Internet an Posteo übertragen, um sie dort mit einer Schlagwort-Datenbank abzugleichen.
...
In bestimmten gesetzlich geregelten Fällen, insbesondere bei Vorlage eines richterlichen Beschlusses im Falle einer Straftat, sind wir ggf. zur Herausgabe eines Postfachs verpflichtet. Wie oft staatliche Stellen bei Posteo versucht haben, solche Daten zu erlangen und wie oft wir solche tatsächlich nach anwaltlicher Prüfung herausgeben mussten , ist in unseren [Transparenzberichten](https://posteo.de/site/transparenzbericht) dokumentiert. Bestandsdaten oder personenbeziehbare IP-Adressen liegen zu Posteo-Postfächern nicht vor und können nicht herausgegeben werden.

Sie benötigen keine Auftragsverarbeitungsvereinbarung mit uns
-------------------------------------------------------------

Wir haben zu diesem Thema eine anwaltliche Prüfung für unsere Kundinnen und Kunden vornehmen lassen. Das Ergebnis: Als öffentlich zugänglicher E-Mailanbieter, der sich an Einzelpersonen richtet, sind wir kein Auftragsverarbeiter im Sinne der Datenschutzgrundverordnung (DSGVO) - und entsprechende Vereinbarungen mit Kunden müssen nicht abgeschlossen werden. **Dies trifft auch für eine ggf. berufliche Nutzung von Posteo zu: Es liegt keine Auftragsverarbeitung im Sinne des Art. 28 der DSGVO vor.**

Zur Begründung:  
Telekommunikations(TK)-Dienste wie Posteo müssen nicht nur den allgemeinen Datenschutzgesetzen entsprechen. Sie unterliegen zusätzlichen gesetzlichen Verpflichtungen und damit einhergehenden strengen Sicherheitsvorschriften, die unter anderem im Telekommunikationsgesetz (TKG) und dem Telekommunikation-Telemedien-Datenschutz-Gesetz (TTDSG) geregelt sind.

Wir müssen z.B. entsprechend dieser zusätzlichen gesetzlichen Regelungen über ein Sicherheitskonzept verfügen, das von der Bundesnetzagentur kontrolliert wird. Mindestens alle zwei Jahre findet eine Prüfung durch die Aufsichtsbehörde statt. Unseren Kunden gegenüber sind wir, anders als Auftragsverarbeiter, hingegen nicht weisungsgebunden: Wir treffen Entscheidungen bezüglich der Dienstesicherheit selbst - und diese müssen den gesetzlichen Anforderungen entsprechen.

Aus diesem Grund galt schon vor dem Inkrafttreten der DSGVO, dass bei Posteo keine Auftragsverarbeitung im Sinne des Art. 28 DSGVO vorliegt.

In der DSGVO ist in Art. 95 eine entsprechende Ausnahmeregelung für öffentlich zugängliche elektronische Kommunikationsdienste wie Posteo definiert: "Diese Verordnung erlegt natürlichen oder juristischen Personen in Bezug auf die Verarbeitung in Verbindung mit der Bereitstellung öffentlich zugänglicher elektronischer Kommunikationsdienste in öffentlichen Kommunikationsnetzen in der Union keine zusätzlichen Pflichten auf, soweit sie besonderen in der Richtlinie 2002/58/EG festgelegten Pflichten unterliegen, die dasselbe Ziel verfolgen." Posteo unterliegt den in der E-Privacy-Richtlinie (2002/58/EG) festgelegten Pflichten (diese entsprechen auch den Vorgaben der §§ 3-18 TTDSG). Deshalb benötigen Sie keine Auftragsverarbeitungsvereinbarung mit uns, um den Vorgaben der DSGVO zu entsprechen - und wir bieten solche auch nicht an.

Lesetipp: Der Branchenverband Bitkom fasst dies in seiner Broschüre zur Auftragsverarbeitung gemäß DSGVO noch weiter: "Eine Auftragsverarbeitung liegt ebenfalls nicht vor, wenn die Dienstleistung in speziellen Gesetzen geregelt ist, z.B. Telekommunikationsdienstleistungen oder Postdienstleistungen." ([Quelle](https://www.bitkom.org/sites/default/files/file/import/170515-LF-Auftragsverarbeitung-online.pdf), Seite 23)
...
Sie haben gemäß **Art. 21 DSGVO** das Recht, dem Verarbeiten von personenbezogenen Daten bei einem Unternehmen zu widersprechen. Wir erheben weder Bestandsdaten noch personenbeziehbare IP-Adressen von Ihnen bzw. zu Ihrem Posteo-Postfach. Bezahldaten bewahren wir lediglich aus steuerrechtlichen Gründen auf, dem kann nicht widersprochen werden.

Sie haben gemäß **Art. 7 Abs 3 DSGVO** Unternehmen gegenüber auch das Recht, eine erteilte Einwilligung zum Verarbeiten von personenbezogenen Daten zu widerrufen. Wir erheben weder Bestandsdaten noch personenbeziehbare IP-Adressen von Ihnen bzw. zu Ihrem Posteo-Postfach. Bezahldaten bewahren wir lediglich aus steuerrechtlichen Gründen auf, dem kann nicht widersprochen werden.
...
Speichert ein Unternehmen personenbezogene Daten von Ihnen, muss es Sie gemäß **Art. 34 DSGVO** unverzüglich darüber informieren, wenn der Schutz dieser Daten verletzt wurde. Wir speichern grundsätzlich keine Bestandsdaten, Bezahldaten oder personenbeziehbaren IP-Adressen zu Ihrem E-Mail-Postfach. Durch unsere Datensparsamkeit und das Absichern sensibler Daten verhindern wir den Diebstahl und anderen Missbrauch von Kundendaten zu Ihrem Postfach konzeptionell mit maximalem "Privacy by Design". Über sicherheitsrelevante Vorfälle, bei denen die Sicherheit Ihrer bei Posteo gespeicherten Daten verletzt werden könnte, werden wir Sie per E-Mail und in unserem Unternehmensblog informieren, den Kontakt unseres Datenschutzbeauftragten nennen und Tipps für geeignete Maßnahmen mitteilen.

Gemäß **Art. 77 DSGVO** haben Sie das Recht, sich bei einer Aufsichtsbehörde zu beschweren. Die zuständige Aufsichtsbehörde ist:
...
* [Leistungen](https://posteo.de/site/leistungen "Link zur Seite Leistungen")
* [Presseberichte](https://posteo.de/site/andere_ueber_uns "Link zu den Presseberichten über Posteo")

* [Transparenzbericht](https://posteo.de/site/transparenzbericht "Link zum Transparenzbericht von Posteo")
* [AGB](https://posteo.de/site/agb "Link zu den allgemeinen Geschäftsbedingungen") / [Datenschutzerklärung](https://posteo.de/site/datenschutzerklaerung "Link zur Datenschutzerklärung")
* [Javascript Lizenz-Informationen](https://posteo.de/js-licenses.html "Link to Javascript license information")
* [Anti-Abuse-Team](https://posteo.de/site/kontakt "Link zu den Informationen über das Posteo Anti-Abuse-Team") / [Security Transparency](https://posteo.de/site/security_transparency "Link zur Posteo Security Transparency")