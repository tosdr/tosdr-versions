...
Pursuant to our Terms of Use, this document describes how we treat personal information related to your use of mixdrop (the “Website”), including information you provide when using it.
...
Registration of an account is required for the use of many features on the Website. We require the following personal information at the time of registration: your username, your e-mail address and password. Your IP address is recorded automatically. Except as specifically set forth below, none of this information becomes publically available on the website.

Usage Information
-----------------

We may record information about your usage of the Website such as the contents you upload and access, the frequency and size of data transfers and other statistics. If you have registered and are logged in, we may associate that information with your account.

Uploaded Content
----------------

Any content you upload to the service may be accessed by anyone with access to your account. You may also use the Website to share uploaded content with others, in which case such others may access the content and may then share the content with others as well. You may also use the Website to make uploaded content publicly available, in which case anyone may access the content and share it with others. Any content you share or make publicly available may be associated with
...
When you use the Website, we may send cookies to your computer to uniquely identify your browser session and provide other functionality. We may use both session cookies and persistent cookies.
