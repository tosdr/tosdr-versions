...
You can also [download entire folders into a ZIP file](https://help.dropbox.com/sync/download-entire-folders) from dropbox.com (note that there are limits on how large the folder can be).
