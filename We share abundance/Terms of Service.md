...
4. [Terms & Conditions](https://weshareabundance.com/terms-conditions/)
...
**Payment to each user shall be processed subject to the [Withdrawal Rules](https://weshareabundance.com/withdrawals/) which for an integral part of these terms. A user is obliged to have a valid account opened with the payment system operator Waves Exchange. Payments will be directed to the account stated by the user. The user may not cancel a payment request sent to a server.**
...
11. **STATEMENT OF INCORRECT USERS’ DATA**
...
12. **WEBSITES OF THIRD-PARTY SERVICE PROVIDERS**
...
15. **ACCOUNT SUSPENSION AND LIMITIATION OF USE**
...
17. **LAWFUL ACT AND STATEMENT OF CONSENT**
...
* Address:Pertisau, Gooseham, Morwenstowe, BUDE, Cornwall, EX23 9PF
...
[](https://weshareabundance.com/#hsoverlay-close)Search this website  Type then hit enter to search