...
* [1 DMCA Notice & Takedown Policy and Procedures](#DMCA_Notice_&_Takedown_Policy_and_Procedures)
    ...
    * [1.4 Modifications to Policy](#Modifications_to_Policy)
    * [1.5 Customer Service Requests](#Customer_Service_Requests)
...
**Attention MFC Models:** Please do not send requests for removal of your content from other sites to our Designated DMCA Agent (who is only in charge of removing content from MFC). For assistance with taking down your recorded content other sites, please contact [Contact Model Support](https://wiki.myfreecams.com/wiki/Contact_Model_Support "Contact Model Support").
...
Further information regarding notification and takedown requirements can be found in the DMCA, here: [http://www.law.cornell.edu/uscode/text/17/512](http://www.law.cornell.edu/uscode/text/17/512).
...
(e) a statement that the Recipient consents to the jurisdiction of the Federal District Court in and for the judicial district where the Recipient is located, or if the Recipient is outside of the United States, for any judicial district in which the service provider may be found, and that the Recipient will accept service of process from the person who provided the Notice, or that person’s agent. Written notification containing the above information must be signed and sent to:

Lawrence G. Walters Walters Law Group 195 W. Pine Ave. Longwood, FL 32750 Notice \[at\] DMCANotice \[dot\] com
