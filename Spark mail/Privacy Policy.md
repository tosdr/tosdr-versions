...
April 10, 2024 : Spark 3 version for Desktop (Windows, macOS) now includes Templates, Integrations, Shared Drafts, Assignments and Shared Inboxes, but lacks Calendar and the Send Large Attachments functionality. We may also add new features from time to time, and we will keep you updated on them.
...
Read more about samples, their review, and deletion in the ‘Email samples’ subsection of ‘[Data Processed](https://sparkmailapp.com/legal/privacy-app#dataprocessed).’
