...
* [Organisation](https://yle.fi/aihe/about-yle/organisation)
* [Strategy](https://yle.fi/aihe/strategy)
* [Finances](https://yle.fi/aihe/about-yle/finances)
* [Yle's annual reports](https://yle.fi/aihe/about-yle/annual-reports)

Careers

* [Careers](https://yle.fi/aihe/about-yle/careers)
...
* [Contact us](https://yle.fi/aihe/about-yle/contact-us)
* [For media](https://yle.fi/aihe/about-yle/for-media)
* [Feedback](https://asiakaspalvelu.yle.fi/)
...
* [Yle yhtiönä suomeksi](https://yle.fi/aihe/yleisradio)
* [Bolaget på svenska](https://svenska.yle.fi/bolaget)

Privacy statement for Yle services
==================================

_**We have updated our privacy policy on May 24th 2024.**_

* [Your privacy is important to us](#at-izj0)
    
* [What information do we process?](#at-6bcj)
    
* [What is the purpose of us processing personal data?](#at-8jdl)
    
* [What is the legal basis for processing personal data?](#at-fghq)
    
* [Will the data be shared with any third parties?](#at-c4ok)
    
* [Who processes your personal data?](#at-gt9z)
    
* [Is data processed outside the EU or the EEA?](#at-7era)
    
* [What do we do to protect your personal data?](#at-h8qz)
    
* [How do we use cookies?](#at-igz6)
    
* [How long do we store your data?](#at-ry3p)
    
* [How do you exercise the rights granted to you by data protection legislation?](#at-wxm4)
    
* [Changes to this privacy statement](#at-y5zw)
    
* [Who is the data controller and how can I contact them?](#at-o466)
...
This privacy statement does not cover the processing of personal data for journalistic purposes. [Read more on what is meant by the processing of personal data for journalistic purposes](https://drive.google.com/open?id=1tOustEqDT79Y5cz0dhwGl_iLPfKz_MTB) (in Finnish).
...
* **Basic personal information and information related to authentication**, such as name, pseudonym, username or other individual identifier, email address, gender and age.
    
* **Information describing and related to the user**, such as date of birth, gender, whether they have an official municipality of residence in Finland, interests, favourites, preferred topics, language and other selections, details of user devices and other information related to content production and programmes.
    
* **Information on newsletters subscribed to by the user.**
    
* **User-created content**, such as customer feedback and contacts, permissions and consent, information related to competitions and drawings as well as comments made in the online service.
    
* **Information about the participant** when registering or participating in Yle events, competitions or drawings.
    
* **Research and survey information.** We may carry out customer surveys and research regarding service quality and use. The information requested in surveys may be combined with viewing history data in additional surveys to be conducted later. Any additional surveys conducted are always done so that the data of an individual user is processed as statistical entities and the individual respondent cannot be identified.
...
* **Access to Yle services**, such as content use, programmes you have watched or listened to, articles you have read, or searches you have done in our services.
    
* **Technical and device information**, device identifiers and terminal device information, such as a terminal model and unique device and/or cookie identifier, terminal operating system, user browser, application, browser version, IP address, session identifier, session time and duration.
    
* **Analytics and statistics**, such as statistics collected by online service analytics systems.
    
* **Yle service use history** information that is connected to the user and derived from observed use and/or information provided by the user, including demographic, interests and other user grouping.
    
* **Information collected from customer communication**, such as newsletter link clicks to gain insight on the reach of our communications.
    
* **Location information**, if you have provided your express consent for it. Yle services based on location information use satellite, IP address or other network-based positioning information. The use of assisted positioning methods may include the exchange of your location information as well as device- and operator-specific identifiers with a positioning server. When you use our services that are based on location information, such as local content or location-based emergency bulletins, your location information is sent with your consent to Yle for the purpose of providing the appropriate content.
    
* **Information derived from use of the services**, such as information related to age group, gender or life stage (e.g. couple or family). The information derived from analytics is mainly based on cookies and cookie-based enriched data.
    
* **Other information collected with your consent**.
    

[Read more about Yle’s cookie policies](https://yle.fi/aihe/s/yleisradio/cookiepolicy-en)
...
_We process your personal data in order to provide better services._
...
_We process personal data to provide more personal, interactive and user-friendly services._

Processing personal data allows us to make services available on different devices, suggest interesting content as well as display content targeted for different users in our services. [Read more about Yle’s recommendations.](https://yle.fi/aihe/s/yleisradio/ylen-palvelujen-personointi-ja-uutisautomaatio) (in Finnish).

2\. Service and content development and reporting
-------------------------------------------------

_We process information related to the use of services in order to make Yle better for you and for everyone._
...
_We contact our users to inform them of Yle services and content._
...
_Personal data can be used to provide customer service._
...
* the personalisation and recommendation of services. You can learn more about recommendations used in Yle services [in this article](https://yle.fi/aihe/s/yleisradio/ylen-palvelujen-personointi-ja-uutisautomaatio).
...
Yle's archived content and related author information are processed for archiving purposes in the public interest. [Read more about Yle’s operating principles](https://yle.fi/aihe/artikkeli/2015/02/19/arkistosta-aarteita-loyda-ohjelma-tai-hanki-aineistoa) (in Finnish).
...
* _With your consent, we may disclose personal data to Yle partners in conjunction with service use._ Personal data may be disclosed with your express consent to, for instance, a service provided by a non-Yle party. One such service is the Varaamo reservation service provided by the City of Helsinki that you may use with your Yle ID.
    
* _Disclosures to our social media partners._ Personal data may be disclosed to social media operators such as Meta or X (formerly Twitter). The use of social media plugins at Yle is described in more detail in [Yle's cookie policy](https://yle.fi/aihe/s/yleisradio/cookiepolicy-en).
    
* _Disclosure of personal data for research._ Any disclosures of data for research use are always assessed on a case-by-case basis. In principle, the information is only disclosed in a translated form, from which individual persons can no longer be identified. Cookie information related to audience measurement can be disclosed for statistical and research purposes. We describe the processing of audience measurement data in greater detail in our [cookie policy](https://yle.fi/aihe/s/yleisradio/cookiepolicy-en).
    
* _We disclose personal data to the authorities only to the extent required by mandatory legislation._ Personal data may be disclosed to competent authorities upon demand in accordance with statutory requirements.
    
* _Disclosure of personal data related to content author information._ Yle stores author information in its contents in Wikidata in order to give its content a keyword to the extent that it is considered relevant from the perspective of communication. The content metadata, including author information, has been selectively published on the [Elävä arkisto website](https://elavaarkisto.kokeile.yle.fi/data/) and on the [opendata website](https://yle.fi/aihe/artikkeli/2016/06/29/open-data-resources-available-yle) in accordance with the principles of open data.
...
_Yle applications on third-party application platforms_
...
Our [cookie policies](https://yle.fi/aihe/s/yleisradio/cookiepolicy-en) describe our use of cookies in more detail and explain how you can restrict their use.
...
_This privacy statement was updated on on May 24th 2024._

You can view earlier versions of the Yle Privacy Statement:

* [Privacy statement for Yle's services 12.12.2023–23.5.2024](https://yle.fi/aihe/s/about-yle/privacy-statement-for-yles-services-1212023-23052024)
    
* [Privacy statement for Yle's services 2.9.2020–11.12.202](https://yle.fi/aihe/s/about-yle/privacy-statement-for-yles-services-02092020-11122023)3
    
* [Privacy statement for Yles services 14.2.2019-2.9.2020](https://yle.fi/aihe/s/about-yle/privacy-statement-for-yles-services-1422019-292020)
    
* [Privacy statement for Yles services 25.5.2018-14.2.2019](https://yle.fi/aihe/s/about-yle/privacy-statement-for-yles-services-2552018-1422019)
...
In matters concerning data protection, you can send email to [tietosuoja@yle.fi](mailto:tietosuoja@yle.fi).

### In other languages

* [Suomeksi](https://yle.fi/aihe/s/yleisradio/tietosuojalauseke)
* [På svenska](https://svenska.yle.fi/s/dataskyddsbeskrivning)
* [Sámegillii](https://yle.fi/aihe/s/yleisradio/tietosuojalauseke-saameksi)
* [по-русски](https://yle.fi/aihe/s/yleisradio/privacy-policy-russian)
* [Yкраїнською](https://yle.fi/aihe/s/yleisradio/privacy-policy-ukrainian)
