...
Are you GDPR / CCPA / VCDPA compliant ?

Yes. We respect your privacy and make it a priority to protect your data. The privacy policy below explains the data that we collect, its purpose and place of processing along with a list of our sub-processors. If your local laws require a copy of the Data Processing Agreement (e.g. a DPA including the new Standard Contractual Clauses for EU) please [contact us](https://ipapi.co/contact/).

Is my data i.e. an IP address query, safe ?

Yes. We do not share or sell your IP address queries. They get stored in log files for a limited time, like any standard webserver logs. We've gone a step ahead to let you bypass that as well. Please [contact us](https://ipapi.co/contact/) for details.
...
Capitalized terms that are not defined but used herein shall have the same meaning as defined in our [Terms of Service](https://ipapi.co/terms/). By using the Application, you agree to this privacy policy and the Terms.
...
**Owner contact email:** [\[email protected\]](https://ipapi.co/cdn-cgi/l/email-protection)

Types of Data collected
-----------------------

Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Usage Data; Tracker; answers to questions; clicks; keypress events; motion sensor events; mouse movements; scroll position; touch events; email address; first name; last name; username; payment info; billing address; phone number; contact info; physical address; purchase history; User ID; contents of the email or message; IP address; company name.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: SPAM protection, Advertising, Traffic optimization and distribution, Managing support and contact requests, Registration and authentication, Platform services and hosting, Remarketing and behavioral targeting, Hosting and backend infrastructure, Analytics, Backup saving and management, Managing contacts and sending messages, Handling payments, Infrastructure monitoring, Displaying content from external platforms, Collection of privacy-related preferences, Contacting the User and Registration and authentication provided directly by this Application.
...
* ### Handling payments
    ...
    Personal Data processed: billing address; email address; first name; last name; payment info; Tracker; various types of Data as specified in the privacy policy of the service.
    ...
    * a Sharing in California
    ...
    Paddle is a payment management service provided by Paddle.com Inc, Paddle.com Market Limited or by Paddle Payments Limited, depending on how the Owner manages the Data processing, which allows Users to make online payments. Paddle also allows this Application to measure the performance of their checkout and subscriptions model, and to re-engage and message Users who have shown signs of abandonment.
    
    Personal Data processed: billing address; contact info; contents of the email or message; email address; payment info; phone number; physical address; purchase history; Trackers; Usage Data; User ID.
    
    Place of processing: United States – [Privacy Policy](https://paddle.com/privacy-buyers/); United Kingdom – [Privacy Policy](https://paddle.com/privacy-buyers/); Ireland – [Privacy Policy](https://paddle.com/privacy-buyers/).
...
* ### Hosting and backend infrastructure
    ...
    Place of processing: United States – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); Canada – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); United Kingdom – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); France – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); Germany – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); India – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); Australia – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/); Singapore – [Privacy Policy](https://aws.amazon.com/compliance/data-privacy-faq/).
...
* ### Managing contacts and sending messages
    ...
    Place of processing: United States – [Privacy Policy](https://wildbit.com/privacy-policy).
...
* ### Registration and authentication provided directly by this Application
    ...
    Personal Data processed: billing address; company name; email address; first name; last name; physical address.
...
* ### Remarketing and behavioral targeting
    ...
    **Users may also opt-out of certain advertising features through applicable device settings, such as the device advertising settings for mobile phones or ads settings in general**.
    ...
    Users can opt out of Google's use of Trackers for ads personalization by visiting Google's [Ads Settings](https://adssettings.google.com/authenticated).
...
This Application uses Trackers. To learn more, Users may consult the [Cookie Policy](https://ipapi.co/cookie/ "Cookie Policy").
...
* ### Internet or other electronic network activity information
    ...
    **Third-parties:** Google LLC, Cloudflare, Inc., Amazon Web Services, Inc., Zendesk, Inc., Dropbox, Inc., Stripe, Inc., Buzpark Bilisim Tarim Urunleri Sanayi Tic. Ltd. Sti., Paddle.com Inc, iubenda srl
...
* ### Identifiers
    ...
    **Third-parties:** Wildbit LLC, Stripe, Inc., Paddle.com Inc, this Application
...
* ### Commercial information
    ...
    **Third-parties:** Stripe, Inc., Paddle.com Inc
