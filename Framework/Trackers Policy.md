...
* ### Tag Management
    ...
    * \_\_storejs\_\_: indefinite
    * \_\_tld\_\_: duration of the session
    * ajs%3Acookies: duration of the session
    * ajs%3Atest: duration of the session
    * ajs\_anonymous\_id: 1 year
    * ajs\_group\_id: 1 year
    * ajs\_group\_properties: indefinite
    * ajs\_user\_id: 1 year
    * ajs\_user\_traits: indefinite
    * seg\_first\_url: 1 year
    * seg\_first\_utm: 1 year
...
* ### Advertising
    ...
    * fr: 3 months
    ...
    Users may opt out of behavioral targeting features through their device settings, [their LinkedIn account settings](https://www.linkedin.com/psettings/advertising/actions-that-showed-interest) or by visiting the [AdChoices opt-out page](https://optout.aboutads.info/).
...
* ### Remarketing and behavioral targeting
    ...
    **Users may also opt-out of certain advertising features through applicable device settings, such as the device advertising settings for mobile phones or ads settings in general**.
    ...
    Personal Data processed: device information, email address, shopping history, Tracker and Usage Data.
    
    Place of processing: United States – [Privacy Policy](https://www.klaviyo.com/privacy/policy) – [Opt out](https://www.klaviyo.com/privacy/policy).
