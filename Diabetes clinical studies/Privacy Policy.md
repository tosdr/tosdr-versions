[![Diabetes Clinical Studies](https://diabetesclinicalstudies.org/wp-content/uploads/sites/11/2018/10/diabetes-clinical-studies-logo.png)](https://diabetesclinicalstudies.org/ "Diabetes Clinical Studies")

[![Diabetes Clinical Studies](https://diabetesclinicalstudies.org/wp-content/uploads/sites/11/2018/11/Mobile-DCS.png)](https://diabetesclinicalstudies.org/ "Diabetes Clinical Studies")

* [Participating in Clinical Trials](https://diabetesclinicalstudies.org/participating-in-clinical-trials/)
* [Why Register?](https://diabetesclinicalstudies.org/why-register/)

[![](https://diabetesclinicalstudies.org/wp-content/uploads/sites/11/2018/12/facebook.png)](https://www.facebook.com/Diabetes-Clinical-Studies-748616122157186/)

[DO YOU QUALIFY?](https://diabetesclinicalstudies.org/sign-up)
...
Subject Well, Inc. and its group entities ("SubjectWell", "we", or "us") offer clinical trial participant recruitment services (the "Services"). This Privacy Policy sets out how we use and protect your Personal Information and your rights and choices with regard to that information. This Privacy Policy applies to Personal Information collected by or on behalf of SubjectWell, including information collected through our websites: [https://alzheimers-study.org](https://alzheimers-study.org/); [https://breastcancerclinicaltrial.org](https://breastcancerclinicaltrial.org/); [https://copdclinicaltrials.org](https://copdclinicaltrials.org/); [https://crohnsandcolitistrials.org](https://crohnsandcolitistrials.org/); [https://diabetesclinicalstudies.org](https://diabetesclinicalstudies.org/); [https://highcholesteroltrials.org](https://highcholesteroltrials.org/); [https://hypertensiontrials.org](https://hypertensiontrials.org/); [https://migraineclinicaltrials.org](https://migraineclinicaltrials.org/); [https://osteoarthritistrials.org](https://osteoarthritistrials.org/) and mobile versions of our websites (collectively "the Site") or anywhere else we display this Privacy Policy. It also applies to information collected by or through our Services, which may include by phone, text message, email, the Site or other communication mechanisms.
...
* In connection with the Services, information you provide to sign up for clinical trial matching, including your name, age, e-mail address, health conditions relevant to the clinical trial opportunities, or any other information you decide to provide to us in connection with the Services; and
...
A subset of personal information we may collect is “sensitive personal information,” as defined by applicable law, and includes health conditions and other medical record information relevant to the clinical trial opportunities. The business or commercial purpose for which it is collected is for our operational purposes and performing services you request. When applicable, we will obtain your consent or authorization before accessing such information, in accordance with applicable law.

In addition, when you decide to participate in a clinical trial, then any information you provide as a participant in that trial is subject to the informed consent form that you complete.
...
* Cookies. We use cookies to make interactions with the Site easy and meaningful. When you visit the Site, our servers may send a cookie to your computer. We may use cookies that are session-based and persistent. Session cookies exist only during one session. They disappear from your computer when you close your browser software or turn off your computer. Persistent cookies remain on your computer after you close your browser or turn off your computer. Please note that if you disable your web browser's ability to accept cookies, you will be able to navigate the Site, but you may not be able to use all the features of the Site. The following sets out how we may use different categories of cookies and your options for managing cookie settings:
...
To learn how to opt out of performance cookies using your browser settings, [click here](https://www.trialsearch.com/cookie-policy). To learn how to manage privacy and storage settings for Flash cookies, [click here](https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html).
...
To learn how to opt out of functionality cookies using your browser settings, [click here](https://www.trialsearch.com/cookie-policy). To learn how to manage privacy and storage settings for Flash cookies, [click here](https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html).
...
Some browsers have a "Do-Not-Track" feature that lets you tell websites that you do not want to have your online activities tracked. When you choose to turn on the Do-Not-Track setting in your browser, your browser sends a signal to websites, analytics companies, ad networks, plug-in providers, and other web services that you may encounter while browsing the Internet, instructing them to stop tracking your activity via cookies or other online tracking technologies. While we continue to evaluate this evolving technology to implement such capabilities, the Site does not currently respond to browser-based Do-Not-Track signals. For information regarding Do-Not-Track and how to enable this setting if available on your devices, please see [https://allaboutdnt.com](https://allaboutdnt.com/).
...
The information in this section applies to residents of California. Please contact us at [privacy@subjectwell.com](mailto:privacy@subjectwell.com) if you have any questions about this Privacy Policy, including this section specific to California residents, or if you would like a printed copy of this Privacy Policy. You may also print a copy of this Privacy Policy by selecting the "Print" button in your web browser.
...
In some cases, we may share your information with our service providers or contractors that help us operate our business such as data storage or IT providers. We may also share your information with third parties, such as when required by law, to provide information or services you request, and pursuant to your consent or authorization.
...
In the last 12 months, we have collected and disclosed a business purpose each of the categories of Personal Information noted in the table below, to the categories of recipients listed. We do not share your personal information for cross-context behavioral advertising or sell your personal information for monetary or other considerations and have not done so in the last 12 months.
...
Please refer to the above section of this Privacy Policy titled PURPOSES FOR OUR COLLECTION AND USE OF PERSONAL INFORMATION for descriptions of the business or commercial purposes for which we collected the information.
...
* Right to Know: You have the right to confirm whether or not we process your Personal Information and to access such Personal Information. To exercise this right, please complete our online form available here and select “Info Request” or email your request to [privacy@subjectwell.com](mailto:privacy@subjectwell.com) and include "Disclosure Request" in the subject line of your message.
* Right to Portability: You have the right to obtain a copy of your Personal Information that you previously provided to us in a portable, and to the extent technically feasible, readily usable format that allows you to transmit the Personal Information to another business without hindrance, where the processing is carried out by automated means. To exercise this right, please complete our online form here and select “Data Portability” or email your request to privacy@subjectwell.com and include "Access Request" in the subject line of your message.
* Right to Correct: You have the right to request that we correct any inaccurate Personal Information that we maintain about you. To exercise this right, please complete our online form available here and select “Update Data” or email us at privacy@subjectwell.com and include “Correction Request” in the subject line of your message
* Right to Delete: You have the right to request us to delete the Personal Information we have collected or maintain about you. Please note that certain exceptions may apply to your right to delete information, such as when we must retain Personal Information as required or permitted by law and we will maintain a copy of your deletion request. We will notify you if any such exceptions apply to your request. To exercise this right, please complete our online form available here and select “Data Deletion” or email us at [privacy@subjectwell.com](mailto:privacy@subjectwell.com) and include "Deletion Request" in the subject line of your message
* Right to Appeal: If we refuse to take action on a request, you have the right to appeal our decision within a reasonable time. To exercise this right, please complete our online form here or email your request to privacy@subjectwell.com and include “Appeal Request” in the subject line of your message. Within 60 days of our receipt of your appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation for the decisions.

You can exercise these rights yourself or you can designate an authorized agent to make a request on your behalf. If you would like an authorized agent to submit a request on your behalf, please send us an email at privacy@subjectwell.com for instructions and details on proof and information required for the use of an authorized agent.
...
Where applicable, these rights can be exercised by completing the request form available [here](https://privacyportal-eu-cdn.onetrust.com/dsarwebform/734bda27-eb9c-4323-8df9-6d070c98c248/754222c0-d3db-4292-8d22-7187a8ffba28.html) or by sending us an email through the contact details further below. Depending on where you live, you may have a right to lodge a complaint with a supervisory authority or other regulatory agency if you believe that we have violated any of the rights concerning your Personal Information. We encourage you to first reach out to us at [privacy@subjectwell.com](mailto:privacy@subjectwell.com) so we have an opportunity to address your concerns directly before you do so. We are committed to compliance with the General Data Protection Regulation ("GDPR") where applicable, so please contact us through the details listed below if you have any questions about these rights.
...
E-mail: [privacy@subjectwell.com](mailto:privacy@subjectwell.com)  
...
EDPO online request form: [https://edpo.com/gdpr-data-request/](https://edpo.com/gdpr-data-request/)  
In writing to EDPO at Avenue Huart Hamoir 71, 1030 Brussels, Belgium.

UK General Data Protection Regulation (GDPR) - UK Representative:

EDPO online request form: [https://edpo.com/uk-gdpr-data-request/](https://edpo.com/uk-gdpr-data-request/)  
In writing to EDPO UK at 8 Northumberland Avenue, London WC2N 5BY, United Kingdom.

* [Home](https://diabetesclinicalstudies.org/)
* [Participating in Clinical Trials](https://diabetesclinicalstudies.org/participating-in-clinical-trials/)
* [Why Register?](https://diabetesclinicalstudies.org/why-register/)
* [Find Out If You Qualify](https://diabetesclinicalstudies.org/sign-up/)

[![Logo and link to home](/wp-content/uploads/sites/11/2018/10/diabetes-clinical-studies-footer-1.png)](https://diabetesclinicalstudies.org/) [![TRUSTe](//privacy-policy.truste.com/privacy-seal/seal?rid=5462723d-0537-4848-a02d-044ee78283a5)](https://privacy.truste.com/privacy-seal/validation?rid=5462723d-0537-4848-a02d-044ee78283a5)

Copyright ©2018 DiabetesClinicalStudies.org • All rights reserved.  
Intended for US audiences only.

[Sponsor, CRO or Investigator Site? Click Here](https://www.mdconnectinc.com/diabetes-patient-recruitment)  
This web site does not replace the informed consent process. This web site does not replace the advice of your doctor.  
[Privacy Policy](https://diabetesclinicalstudies.org/privacy-policy/)