![none](https://www.facebook.com/tr?id=549279042777849&ev=PageView&noscript=1)        

[Skip to content](#content)

You are here » [Home](https://www.seymourlerhn.com/) » Terms & Conditions

[](#mobile-menu)

[![Seymour & Lerhn](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20250%2062'%3E%3C/svg%3E "SL-Logo-LR")

![Seymour & Lerhn](https://www.seymourlerhn.com/wp-content/uploads/2019/09/SL-Logo-LR.png "SL-Logo-LR")](https://www.seymourlerhn.com/ "Seymour & Lerhn")

[](https://www.seymourlerhn.com/feed/)

* [01246 622622](tel:01246622622)
* [Enjoy 30-Days Free Access](https://www.seymourlerhn.com/platform)
...
_Seymour & Lerhn is a service provider of immersive learning tools including 360, VR, AR and interactive digital experiences for schools, museums, heritage, and outreach._

 _These Terms & Conditions govern your use of our service. As used in these Terms of Use, “Seymour & Lerhn platform”, “our service” or “the service” means the service provided by Seymour & Lerhn, including the platform, all features and functionalities, the website, and user interfaces, as well as all content and software associated with the service._

[_Terms & Conditions relating to bespoke services and services for museums, heritage, or outreach._](https://www.seymourlerhn.com/terms-and-conditions-heritage/)
...
1. Membership to Seymour & Lerhn provides access to the online platform and content in line with the UK National Curriculum on a recurring yearly subscription.  
      
    
2. There are a number of membership options, please ensure you have the correct membership for your needs. Find our handy checklist here.  
      
    
3. Teacher Subscriptions may only be used by the registered user and account details may not be shared.  
      
    
4. School Subscriptions include seats for teachers and pupils. Accounts may only be used by the subscribing school and seats, accounts or log in details must not be shared or distributed without prior written consent from Seymour & Lerhn.  
      
    
5. Your Seymour & Lerhn membership will renew yearly or monthly (depending on your subscription) until terminated. To use the service you must have internet access and an internet enabled device and provide a valid payment method.  
      
    
6. Unless you cancel your membership before your next billing date, you authorise us to charge your next subscription fee to your Payment Method.  
      
    
7. **You must read and agree the Terms & Conditions in full prior to subscribing or use of the Platform.**
...
**2.1** Any use of this website, platform, or its contents, may be used only in accordance with the Terms & Conditions. By using the platform, you agree to abide by the terms of use.  
...
**8.2** To correct confirmed orders, please contact hello@seymourlerhn.com.  
...
**9.4** All transactions are completed through Stripe and no payment details are stored by Seymour & Lerhn or partners. Stripe Checkout Terms & Conditions can be found here: [https://stripe.com/en-gb/checkout/legal](https://stripe.com/en-gb/checkout/legal)  
...
**12.8 Privacy:** You acknowledge and agree to be bound by the terms of our [privacy policy](https://www.seymourlerhn.com/privacy-policy).  
...
[01246 622622](tel:01246622622)  
[Unit 4, Chatsworth Technology Park, Dunston Rd, Chesterfield, S41 4XA](https://www.google.co.uk/maps/place/Oasis+Studio/@53.259985,-1.43074,20.5z/data=!4m13!1m7!3m6!1s0x487984d09b240821:0xa2ca9517433968db!2sChatsworth+Technology+Park,+Dunston+Rd,+Whittington+Moor,+Chesterfield+S41+8XA!3b1!8m2!3d53.2599134!4d-1.4308118!3m4!1s0x48799c656d0100cb:0x54cf3b17fe7e47d1!8m2!3d53.2600028!4d-1.4306822)  
[hello@seymourlerhn.com](mailto:hello@seymourlerhn.com)
...
Our site uses cookies, by clicking okay you agree to our [privacy policy](https://www.seymourlerhn.com/privacy-policy/).  
...
| --- | --- | --- |
| \_\_stripe\_mid | 1 year | This cookie is set by Stripe payment gateway. This cookie is used to enable payment on the website without storing any payment information on a server. |
| \_\_stripe\_sid | 30 minutes | This cookie is set by Stripe payment gateway. This cookie is used to enable payment on the website without storing any payment information on a server. |
...
| \_ga\_V4VS8XZGZV | 2 years | This cookie is installed by Google Analytics. |
| \_gat\_gtag\_UA\_117859430\_1 | 1 minute | Google uses this cookie to distinguish users. |
| \_gid | 1 day | This cookie is installed by Google Analytics. The cookie is used to store information of how visitors use a website and helps in creating an analytics report of how the website is doing. The data collected including the number visitors, the source where they have come from, and the pages visted in an anonymous form. |
| \_hjAbsoluteSessionInProgress | 30 minutes | Hotjar helps us to improve the website based on user interaction. This cookie is used to detect the first pageview session of a user. This is a True/False flag set by the cookie. |
| \_hjFirstSeen | 30 minutes | Hotjar helps us to improve the website based on user interaction. This is set by Hotjar to identify a new user’s first session. It stores a true/false value, indicating whether this was the first time Hotjar saw this user. It is used by Recording filters to identify new user sessions. |
...
| \_hjIncludedInPageviewSample | 2 minutes | Hotjar helps us to improve the website based on user interaction. This cookie is set to let Hotjar know whether that user is included in the data sampling defined by the site's pageview limit. |
...
| Cookie | Duration | Description |
| --- | --- | --- |
| CONSENT | 16 years 7 months 25 days 15 hours 9 minutes | No description |
| lfuuid | 9 years 8 months 25 days 15 hours 9 minutes | User tracking for enhanced performance |
| m   | 2 years | No description |
| S   | 1 hour | No description |
| wp\_woocommerce\_session\_61e484ba3b3baff16dfbc76f84de5edb | 2 days | No description |
...
Powered by [![CookieYes Logo](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20300%2060'%3E%3C/svg%3E)

![CookieYes Logo](https://www.seymourlerhn.com/wp-content/plugins/cookie-law-info/legacy/public/images/logo-cookieyes.svg)](https://www.cookieyes.com/)