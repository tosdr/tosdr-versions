...
1. How to Do it Right
    ...
    Starting to use the service is quick and practical. The registration is free, and the terms of service are very simple:
    
    * You will not share your unique ID nor sell it to anyone, under any circumstances.
    * You represent and warrant that your use of 2Captcha will comply with all applicable laws and regulations.
    * You agree that this is a paid system, and will not try to circumvent payments by no means.
    * You agree that you won't modify, copy or recreate parts of any of our API clients without the explicit consent of 2Captcha.
    * You agree to use 2Captcha Service exclusively for authorized and legal purposes, consistent with all applicable laws and regulations.
    
    Please note that your account may be suspended or terminated in case of violation of those simple rules.
    
2. Definitions
    -----------
    
    2Captcha ("2Captcha” or the "Service”) is a manual CAPTCHA solving service provided through the URL 2captcha.com (the "Website”) which allows you to recognize CAPTCHAs images. 2Captcha is owned and operated by ALTWEB L.L.C-FZ, a Dubai Emirate Co. ("2Captcha”, "we”, "us”). 2Captcha has employees, independent contractors, and representatives ("our Team"). As a customer of the Service or a representative of an entity that’s a customer of the Service, you're a "Member” according to this agreement (it’s "you”). These Terms of Use ("Terms,” along with our our API Guidelines) define the terms and conditions under which you’re allowed to use 2Captcha and how we’ll treat your account while you’re a Member. If you have any questions about our terms, feel free to contact us at support@2captcha.com.
    
3. Eligibility
    -----------
    
    In order to use 2Captcha, you must:
    ...
    * and provide true, complete, and up to date contact information.
    ...
    By using 2Captcha, you represent and warrant that you meet all the requirements listed above, and that you won’t use 2Captcha in a way that violates any laws or regulations. 2Captcha may refuse service, close accounts of any users, and change eligibility requirements at any time.
    
    It is prohibited to use the service for any illegal actions including but not limited to:
    
    * sending of spam
    * illegal access to any services
    * brute-force of any websites and resources
    * buying any products or services with stolen credit card
    * buying any illegal items
    
    Violation of these terms will result in immediate denial of service and account termination.
    
4. Term
    ----
    
    The Term begins when you sign up for 2Captcha and continues as long as you use the Service. Clicking the button and entering your username means that you’ve officially "signed” the Terms. If you sign up for 2Captcha on behalf of a company or other entity, you represent and warrant that you have the authority to accept these Terms on their behalf.
...
6. Changes
    ...
    We may change any of the Terms by posting revised Terms of Use on our Website and/or by sending an email to the last email address you gave us. Unless you terminate your account within ten (10) days, the new Terms will be effective immediately and apply to any continued or new use of 2Captcha. We may change the Website, the Service, or any features of the Service at any time.
...
8. General Rules.
    ...
    * You represent and warrant that your use of 2Captcha will comply with all applicable laws and regulations.
    * You agree that this is a paid system, and will not try to circumvent payments. This includes excessively reporting correctly decoded CAPTCHAs as incorrect.
    * You agree that you won't modify, copy or recreate parts of any of our API clients without the explicit consent of 2Captcha.
    * You agree to use 2Captcha Service exclusively for authorized and legal purposes, consistent with all applicable laws and regulations.
...
9. Reporting Abuse
    ...
    If you think anyone is violating any of these Terms, please notify us immediately. If you received spam you think came from a 2Captcha user, we want to hear about it. Please report it to our abuse team.
    
10. Compliance with Laws
    --------------------
    
    You represent and warrant that your use of 2Captcha will comply with all applicable laws and regulations. You’re responsible for determining whether our Services are suitable for you to use in light of any regulations. You agree to indemnify and hold us harmless from any losses, including attorney fees, that result from your breach of any part of these warranties.
...
21. Responsible persons contact information
    ---------------------------------------
    
    In case you have any exclusive information regarding 2Captcha please contact Mark Miller, our Chief Marketing Officer by email mark.miller@2captcha.com.
    

Thanks for taking the time to learn about 2Captcha's policies.
