...
Welcome to the TGTG Platform owned by:
...
With this Cookie Policy, Too Good To Go ApS ("TGTG", "we") informs you about our use of cookies and other data collection tools to collect data that helps us personalize your use of our website and mobile applications ("Platform"). We are concerned with adequately protecting your data. Therefore, we will observe the applicable legal provisions for the protection, lawful handling and non-disclosure of data, as well as for data security.  
  
We also work with a variety of business intelligence and analytics companies (“Partners") that use various technologies including cookies to collect data about your use of the Services (such as pages visited, ads viewed or clicked on) so that we can better deliver experiences to you based on your interests and online activities:
...
Some cookies are technically necessary for our Services. Such technically necessary cookies do not require your prior consent.

All other cookies require your prior consent, which we will obtain via the cookie banner on the Platform. You can at any time change or withdraw your consent via the cookie banner on our Platform.

### 3\. WHAT TYPES OF COOKIES DO WE USE

We use several different types of cookies:

**Necessary cookies:** Necessary cookies help make a website usable by enabling basic functions like page navigation and access to secure areas of the website. The website cannot function properly without these cookies. We also use audience measurement cookies (strictly necessary statistics), which enable us to measure the audience on our sites (number of visits, number of pages viewed, the activity of visitors on the site and how often they return). Our cookies are exempt from the need to obtain consent, insofar as they are strictly necessary for the operation of the site. You can opt-out of the processing of your personal browsing data for audience measurement purposes by visiting our privacy settings page here (https://www.toogoodtogo.com/en/privacy-settings).

**Statistics cookies:** Statistics cookies help website owners to understand how visitors interact with websites by collecting and reporting information about the website visitors’ use of the site. In addition to our necessary audience measurement cookies, we carry out more extensive audience measurement if you as a visitor on our website have consented to statistics cookies in our cookie banner. You can withdraw your consent for these cookies at any time by managing your cookie preferences here (javascript:CookieConsent.renew();). Please note that we will still collect the above-mentioned necessary audience measurement data, unless you opt-out as indicated above.”

For more information, please see the full list of cookies used by our website, including purpose of each cookie in the cookie overview in section 6 below.

### 4\. THIRD-PARTY COOKIES

We use and allow third parties on our Platform. We do not control the cookies of third parties. Please see the list of third-party cookies in the cookie overview in section 6 below.

### 5\. RETENTION PERIOD

Most cookies on our website are so-called session cookies. They are automatically deleted when you leave our website.

Persistent cookies, on the other hand, remain on your computer until the cookies either reach an expiration date set by us or are manually deleted by you in your browser.

Please see the specific retention periods in the cookie overview in section 6 below.

  

### 6\. COOKIE OVERVIEW

change cookie consent settings [here](https://toogoodtogo.com/privacy-settings)
...
contact us [privacy@toogoodtogo.com](mailto:privacy@toogoodtogo.com)

For more information on our processing of personal data, please read our [privacy policy](https://toogoodtogo.com/privacy).
