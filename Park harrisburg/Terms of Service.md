[Online Parking Reservations for Park Harrisburg | Harrisburg, PA](https://parkharrisburg.com/ "Online Parking Reservations for Park Harrisburg | Harrisburg, PA")
...
By agreeing to these SMS Terms, you also consent to the use of an electronic record to document your agreement. You may withdraw your consent to the use of the electronic record by emailing SP+ at [customercare@spplus.com](mailto:customercare@spplus.com).

You may provide us with consent to send you text messages through our website or mobile application (e.g. by providing us with your phone number and signing up for text messages) or through communications or transactions with us (e.g. by initiating or agreeing to receive text message communications with customer service). By providing your consent, you agree to these SMS Terms, our Terms, and the [SP+'s Privacy Policy](http://www.spplus.com/privacy-policy/).

Data obtained from you in connection with this text messaging service may include your mobile phone number, your wireless provider’s name, the date, time, and content of your messages and other information you provide to SP+ as part of this service. SP+ may use this information to contact you for the purposes of providing services you request from SP+. If you have questions regarding our privacy practices, please read the [SP+'s Privacy Policy](http://www.spplus.com/privacy-policy/).

By consenting to receive SP+ text messages, you agree that SP+ or its service providers may use any automated or non-automated technology to send you transactional and/or marketing text messages.

SP+ may terminate any text messaging services or your participation in our text message program at any time with or without notice, including, for example, before you have received any or all messages that you otherwise would have received, but these SMS Terms will still apply.

SP+ does not charge you for our text message program. But message and data rates may apply, so depending on your plan with your wireless or other applicable provider, you may be charged by your carrier or other applicable provider.
...
SP+ text messages are supported on all U.S. and Canadian carriers. Please note, however, that the supporting mobile carriers may change without notice, and the particular text message program you join may be limited to specific carriers. Delivery of information and content to a mobile device may fail due to a variety of circumstances or conditions. You understand and acknowledge that network services, including but not limited to mobile network services, are outside of SP+’s control, and SP+ is not responsible or liable for issues arising from them. SP+ and the mobile carriers (for example, Verizon, AT&T and T-Mobile) are not liable for delayed or undelivered messages.

By consenting to receive SP+ text messages, you represent that you are 16 years of age or older and understand the obligations and agree to the terms set forth in these SMS Terms. You further represent that you are the subscriber of the cellular service at the mobile number provided or that you are authorized by the subscriber to sign-up for texts. You are responsible for notifying SP+ immediately if you change your mobile telephone number. You may notify SP+ of a number change by contacting Customer Care at \[phone number\] or by emailing SP+ at customercare@spplus.com or via the support request site at https://parking.com/support

You agree to indemnify SP+ in full for all claims, expenses, and damages related to or caused in whole or in part by your failure to notify SP+ if you change your telephone number including, but not limited to, all claims, expenses, and damages related to or arising under the Telephone Consumer Protection Act.SP+ may suspend or terminate your receipt of SP+ text messages if SP+ believes you are in breach of these SMS Terms. Your receipt of SP+ text messages is also subject to termination in the event that your mobile telephone service terminates or lapses. SP+ reserves the right to modify or discontinue, temporarily or permanently, all or any part of SP+ text messages, with or without notice.
...
For help visit [https://parking.com/support](https://parking.com/support) or text "HELP" to 201-379-2616. After you send the SMS message "HELP" to us, we will respond with a link to a self-service support page and the ability to submit a help request through Customer Care.

We reserve the right to modify these SMS Terms, or any part thereof, or add or remove terms at any time, and such modifications, additions or deletions will be effective immediately upon posting. Your continued enrollment in SP+'s text messaging program shall be deemed to constitute acceptance by you of such modifications, additions, or deletions.

### International Use

SP+ makes no representation that materials on the Sites are appropriate or available for use in locations outside the United States and Canada, and accessing them from territories where their contents are illegal is prohibited. Those who choose to access the Sites from other locations do so on their own initiative and are responsible for compliance with local laws.
...
© 2023 SP Plus Corporation. All rights reserved.
...
* [](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fparkharrisburg.com%2Fterms-of-use%2F&t=Terms%20of%20Use "Share on Facebook")
* [](https://x.com/intent/tweet?text=Terms%20of%20Use&url=https%3A%2F%2Fparkharrisburg.com%2Fterms-of-use%2F "Share on X")

* [](mailto:?subject=Terms%20of%20Use&body=https%3A%2F%2Fparkharrisburg.com%2Fterms-of-use%2F "Send over email")
* [](# "Print this webpage")