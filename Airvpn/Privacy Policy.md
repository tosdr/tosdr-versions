...
*  [![Servers online.](/img/icons/server_status.png) Online: **25191** users - **294172** Mbit/s total BW](https://airvpn.org/status/ "See Server Status")
...
When users connect to AirVPN Virtual Private Network, no cookies are stored on their system. When users access AirVPN web site (for example to enter the forum) cookies are stored on their systems in order to enable access to the web site. Cookies are stored only for technical reasons and can be deleted anytime by the user. Cookies are specifically meant for technical functioning. Under no circumstance does Air use cookies to track and/or profile users. Air web servers do not use third party add-ons or any other procedure that may lead to users profiling by any third party or by Air itself.  
