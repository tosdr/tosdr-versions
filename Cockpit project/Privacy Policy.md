[![Cockpit Project](/images/site/cockpit-logo.svg)](https://cockpit-project.org/)
=================================================================================

* [Home](https://cockpit-project.org/)
* [Install](https://cockpit-project.org/running.html)
* [Documentation](https://cockpit-project.org/documentation.html)
* [Contribute](https://cockpit-project.org/external/wiki/Contributing.html)
* [Blog](https://cockpit-project.org/blog/)
* [Search](https://cockpit-project.org/search.html)
...
This site contains links to other sites. the Cockpit Project does not control the information collection of sites that can be reached through links from [cockpit-project.org](https://cockpit-project.org/). If you have questions about the data collection procedures of linked sites, please contact these sites directly.
...
© 2013 - 2024 — Cockpit is a [Red Hat](https://redhat.com/) sponsored free software project released under the [LGPL v2.1+](https://opensource.org/licenses/lgpl-2.1.php)

[Privacy Policy](https://cockpit-project.org/privacy.html) — [Code of Conduct](https://cockpit-project.org/code-of-conduct.html)

[Edit page on GitHub](https://github.com/cockpit-project/cockpit-project.github.io/edit/main/privacy.md)