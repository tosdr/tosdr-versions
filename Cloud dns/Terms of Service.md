...
DNS Hosting and Domain Name Rules
---------------------------------
...
* The personal data we collect from you is processed for the purposes of managing your domain name registration, fulfilling legal obligations, and ensuring compliance with ICANN policies. This data may also be used for providing customer support and resolving any issues related to your domain services.
...
* Certain personal data fields are mandatory for completing your domain registration, such as your name, address, and contact information. You will be clearly informed which data is obligatory and which is optional during the registration process.
* You have the right to access and correct the personal data we hold about you. If you wish to update your data or rectify any inaccuracies, please contact us at \[Insert Contact Information\] or use the account management portal to make necessary changes.
* By registering a domain name with us, you consent to the collection and processing of your personal data for the purposes outlined in this policy. This consent is necessary for us to provide you with domain registration services.
* If you provide personal data of any third-party individuals (such as administrative or technical contacts) during the domain registration process, you represent that you have notified those individuals of the data processing and obtained their consent, as required under this policy.
* We will not process the personal data you provide in a manner incompatible with the purposes outlined in this policy. Your data will only be processed in accordance with the purposes stated above, ensuring it is used solely for lawful and legitimate reasons.
* We take reasonable precautions to protect your personal data from loss, misuse, unauthorized access, disclosure, alteration, or destruction. Our data security protocols are designed to maintain the confidentiality and integrity of the personal data you entrust to us.
