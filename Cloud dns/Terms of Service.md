...
* [Français](https://www.cloudns.net/tos/lang/fr/)
* [Română](https://www.cloudns.net/tos/lang/ro/)
* [Български](https://www.cloudns.net/tos/lang/bg/)
* [Español](https://www.cloudns.net/tos/lang/es/)
* [Português](https://www.cloudns.net/tos/lang/pt/)
* [Italiano](https://www.cloudns.net/tos/lang/it/)
* [Polski](https://www.cloudns.net/tos/lang/pl/)
* [Slovenský](https://www.cloudns.net/tos/lang/sk/)
* [Українська](https://www.cloudns.net/tos/lang/ua/)
* [Türkçe](https://www.cloudns.net/tos/lang/tr/)
* [日本語](https://www.cloudns.net/tos/lang/jp/)
* [हिंदी](https://www.cloudns.net/tos/lang/hi/)
* [Bahasa Indonesia](https://www.cloudns.net/tos/lang/id/)
* [עברית](https://www.cloudns.net/tos/lang/he/)
* [简体中文](https://www.cloudns.net/tos/lang/chs/)
...
* [DNS Hosting](javascript: void(0);)
    ...
    * [GeoDNS](https://www.cloudns.net/geodns/)
    * [Enterprise DNS](https://www.cloudns.net/enterprise-dns/)
...
* [Monitoring](https://www.cloudns.net/monitoring/)
    ...
    * [UDP](https://www.cloudns.net/udp-monitoring/)
...
* [Company](javascript: void(0);)
    ...
    * [Contacts](https://www.cloudns.net/contact/)
    * [Data centers](https://www.cloudns.net/data-centers/)
    * [Media and Reviews](https://www.cloudns.net/media-and-reviews/)
    * [Feedback](https://www.cloudns.net/feedback/)
    * [Careers](https://www.cloudns.net/careers/)
* [Partnership](javascript: void(0);)
    * [Affiliate Program](https://www.cloudns.net/affiliate/)
    * [Resellers](https://www.cloudns.net/resellers-api/)
...
* [Light theme](javascript: void(0);)
* [Dark theme](javascript: void(0);)
...
* [Services](javascript: void(0);)
    * [DNS Services](https://www.cloudns.net/dns-services/)
    * [Dynamic DNS](https://www.cloudns.net/dynamic-dns/)
    * [Secondary DNS](https://www.cloudns.net/secondary-dns/)
    * [Reverse DNS](https://www.cloudns.net/reverse-dns/)
    * [DNSSEC](https://www.cloudns.net/dnssec/)
...
The terms and conditions below govern the relationship between Cloud DNS Ltd (herein referred to as "ClouDNS") and any customer ("The Customer") of ClouDNS website ("The Website"). By accessing and using any part of The Website, The Customer agrees to be bound and abide by the terms and conditions in this section. In the event that The Customer does not agree to all or part of the terms and conditions described below, he/she shall not access or use The Website in any way.

The Customer’s agreement to be bound by these terms is acknowledged by his/her use of The Website which includes, but is not limited to visiting The Website, using its internal and external links for search of information, ordering any of The Company services, contacting The Company representatives, Support Services and/or any software made available to The Customer by The Company.

The Company reserves the right to modify or revise the Terms of Use by updating this section. The Customer is solely responsible for staying up to date with these conditions by visiting the Terms of Use section of The Website regularly and checking for any updates.

Copyright Notice
----------------

The content of this Website (including, but not limited to all included text, photographs, graphics, illustrations, video, sound, and other material) is copyright © 2010, ClouDNS. All rights reserved. Any content of The Website that is not the creation or product of the Company’s employees is published for descriptive purpose only. Such content is a registered trademark of its respective owners, who have granted the right for its use either publicly or directly to The Company.
...
By using ClouDNS services, The Customer agrees his business name and/or business logo to be shared on The Website and related marketing materials. The Customer can withdraw this approval anytime by contacting ClouDNS.
...
1\. DNS hosting services - ClouDNS offers an unconditional 7 days money-back guarantee on hosting services. If the customer wishes to cancel a hosting account within the initial 7-day period for any reason, he/she has to notify ClouDNS Support Team by chat or ticket, and the payment will be refunded with deducted transaction fees.

2\. Domain names

2.1. For new domain registrations some of the TLDs has an option to request refund in the initial few days from the registration. If The Customer have registered a domain name and want to delete it and get refund then please contact our technical support via chat or ticket as soon as possible to check the options for refunds with the TLD provider. If possible the payment will be refunded with deducted transaction and deletion fees if there are any charged by the registry.
...
4\. Google Workspace provides refunds only if the admin account is not created. If The Customer have created admin account, then the payment is non-refundable. In case The Customer still don't have admin account and want to cancel the google workspace purchase, he has to contact technical support team by ticket or live chat. The payment can be refunded with deducted transaction fees.

Payment Subscriptions & Billing Agreements
------------------------------------------

ClouDNS supports different options for Payment Subscriptions and Billing Agreements with Credit Cards and PayPal.

### Billing Agreements

Pre-Authorized Billing Agreements (Default Payment Methods) can be created from **Profile** » **Payment Methods**.

Pre-Authorized Billing Agreements (Default Payment Methods) can be canceled anytime without prior notice from **Profile** » **Payment Methods**.

PayPal Pre-Authorized Billing Agreements can be canceled from the PayPal web site. More details about this option can be seen [here](https://www.paypal.com/us/selfhelp/article/How-do-I-cancel-a-Billing-Agreement-FAQ2254).

### Subscriptions

Each service in ClouDNS can be subscribed for automatic renewals. This can be done from the page where the service is bought or renewed.

Subscriptions for automatic renewals can be managed and canceled anytime before the expiration of the service without prior notice from **Profile** » **Manage Subscriptions**.

DNS Hosting and Domain Names
----------------------------
...
2. is unlawful, threatening, abusive, harassing, defamatory, libelous, deceptive, fraudulent, invasive of another's privacy, tortuous, obscene, offensive, profane or which otherwise violates the Terms of Service;
3. constitutes unauthorized or unsolicited advertising, junk or bulk e-mail ("spamming");
4. imposes an unreasonable or disproportionately (in the sole judgment of ClouDNS) large load on ClouDNS computing, storage or communications infrastructure, or attempts to gain unauthorized access to the Service, other accounts, computer systems or networks connected to the Service, through password mining or otherwise;
5. contains software viruses or any other computer codes, files, or programs that are designed or intended to disrupt, damage, limit or interfere with the proper function of any software, hardware, or telecommunications equipment or to damage or obtain unauthorized access to any system, data or other information of ClouDNS or any third party; or
6. impersonates any person or entity, including, without limitation, any employee or representative of ClouDNS.
7. Customer will not use any robot, spider, scraper or other automated means to access the Service for any purpose without ClouDNS express written permission. Additionally, Customer will not: (i) interfere or attempt to interfere with the proper working of the Service or any activities conducted on the Service; or (ii) bypass any measures ClouDNS may use to prevent or restrict access to the Service.
8. Customer shall not (and Customer shall not permit others to), directly or indirectly, modify, translate, decompile, disassemble, or reverse engineer any part of the Service or any Content available through the Site (except to the limited extent applicable laws specifically prohibit such restriction); or copy, rent, lease, distribute, or otherwise transfer any or the rights that Customer receives hereunder. In addition, Customer shall not remove any proprietary notices or labels.
...
10. ClouDNS may remove any Content and Submissions at any time for any reason (including, but not limited to, upon receipt of claims or allegations from third parties or authorities relating to such Content or Submissions).
...
12. ClouDNS may, at its sole discretion, immediately terminate Customer's access to the Site and/or the Service should Customer's conduct fail to conform strictly and terms or conditions of these Terms of Service, including, without limitation, with any provision of this section.

3\. Personal data collection for domain names registration:

1. During the registration process, you will be asked in the wizard if you agree to our terms and conditions and the registry policies. The links to all documents will be provided. Your confirmation will be stored in our database together with a timestamp, IP address, and browser details.
2. The personal data we collect from you is processed for the purposes of managing your domain name registration, fulfilling legal obligations, and ensuring compliance with ICANN policies. This data may also be used for providing customer support and resolving any issues related to your domain services.
3. The personal data you provide will be shared with the Registry Operator responsible for the specific top-level domain (TLD) in which your domain name is registered. Additionally, we may share your data with third-party service providers involved in domain registration and management processes, as well as regulatory authorities when required by law.
4. Certain personal data fields are mandatory for completing your domain registration, such as your name, address, and contact information. You will be clearly informed which data is obligatory and which is optional during the registration process.
5. You have the right to access and correct the personal data we hold about you. If you wish to update your data or rectify any inaccuracies, please contact us [from Contact page](https://www.cloudns.net/contact/) or use the account management portal to make necessary changes.
6. By registering a domain name with us, you consent to the collection and processing of your personal data for the purposes outlined in this policy. This consent is necessary for us to provide you with domain registration services.
7. If you provide personal data of any third-party individuals (such as administrative or technical contacts) during the domain registration process, you represent that you have notified those individuals of the data processing and obtained their consent, as required under this policy.
8. We will not process the personal data you provide in a manner incompatible with the purposes outlined in this policy. Your data will only be processed in accordance with the purposes stated above, ensuring it is used solely for lawful and legitimate reasons.
9. We take reasonable precautions to protect your personal data from loss, misuse, unauthorized access, disclosure, alteration, or destruction. Our data security protocols are designed to maintain the confidentiality and integrity of the personal data you entrust to us.
10. All the personal data collected for the domain names registration is stored until the domain names are not deleted. Based on the TLD this period is up to 60 days after the expiration date.

4\. The customer agrees that his DNS zones can be deleted, if they are inactive (there are no DNS queries for the DNS zone) for over 30 days, especially if he is using free DNS hosting plan without prior notification.

**Stored DNS statistics**

**Premium users:** Yearly, monthly and daily DNS statistics will be stored forever. Hourly DNS statistics will be stored for last 1 month.  
**Free users:** Yearly, monthly and daily DNS statistics will be stored for last 1 year. Hourly DNS statistics will be not stored.

Unlimited definition
--------------------

ClouDNS provides multiple resources without a defined limit or with unlimited resources. Unlimited means there are no hard limits specified in the customer account for the mentioned resources. ClouDNS provides those unlimited resources under fair usage. Fair usage definition: The Customer can use as much of the unlimited resources he needs until the ClouDNS costs for the maintenance of those resources don't exceed the price of the hosting account of The Customer. In case of unfair usage of the unlimited resources, The Customer will get contacted by ClouDNS staff to discuss the setting of hard limits of the customer account or upgrade The Customer's hosting plan.
...
* Domain names do not have Money Back Grace Period. Domain names can be deleted until 2 days after their registration. Deletion fee is $3.00 per domain name. The difference between deletion fee and domain registration price will be refunded back to your account balance. If you want to delete a new registered domain name, please contact our Support Team from your control panel.
* Restoration fee after expiration of Renewal Grace Period: $85.00 USD
* Specific Domain Rules:
    * [.AU Domain Names Rules/Requirements](https://www.cloudns.net/wiki/article/94/)
    * [.EU Domain Names Rules/Requirements](https://www.cloudns.net/wiki/article/95/)
    * [.CN Domain Names Rules/Requirements](https://www.cloudns.net/wiki/article/93/)
    * [.CA Domains Registrant Agreement](https://www.cloudns.net/wiki/article/144/)
    * [Afilias TLDs Registrant Agreement](https://www.cloudns.net/wiki/article/357/)
    * [Special ccTLD Requirements](https://www.cloudns.net/wiki/article/139/)

Changes to These Terms of Service
---------------------------------

We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. We will make reasonable efforts to inform all our customers for the changes but without required prior notice to any new terms taking effect.

By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service. Additionally you can request deletion of your account and user data.
...
* KnowledgeBase
* [Blog](https://www.cloudns.net/blog/)
* [Wiki](https://www.cloudns.net/wiki/)
* [Case studies](https://www.cloudns.net/case-studies/)
* [Features](https://www.cloudns.net/features/)
* [FAQ](https://www.cloudns.net/faq/)
* HTTP API
* WHMCS module
* Hostbill module
* Payment methods
...
* [](https://www.cloudns.net/certificates/)
