[![HuntHalloween Logo](https://hunthalloween.com/assets/img/HuntHalloween.svg)](https://hunthalloween.com/ "HuntHalloween - Halloween 2022 Guide Home Page")

* [![Halloween Events](https://hunthalloween.com/assets/img/HuntHalloween.svg)](https://hunthalloween.com/ "HuntHalloween - Halloween 2022 Guide Home Page")
* [](# "Share this Page")
...
("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by HuntHalloween.com.

  

This Privacy Policy applies to our website, HuntHalloween.com, and its associated subdomains (collectively, our "Service").
...
* **Company:** when this policy mentions “Company,” “we,” “us,” or “our,” it refers to HuntHalloween.com that is responsible for your information under this Privacy Policy.  
    
* **Country:** where HuntHalloween.com or the owners/founders of HuntHalloween.com are based, in this case is United States.  
    
* **Customer:** refers to the company, organization or person that signs up to use the HuntHalloween.com Service to manage the relationships with your consumers or service users.  
    
* **Device:** any internet connected device such as a phone, tablet, computer or any other device that can be used to visit HuntHalloween.com and use the services.  
    
* **IP address:** Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.  
    
* **Personnel:** refers to those individuals who are employed by HuntHalloween.com or are under contract to perform a service on behalf of one of the parties.  
    
* **Personal Data:** any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.  
    
* **Service:** refers to the service provided by HuntHalloween.com as described in the relative terms (if available) and on this platform.  
    
* **Third-party service:** refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.  
    
* **Website:** HuntHalloween.com’s site, which can be accessed via this URL: HuntHalloween.com.  
    
* **You:** a person or entity that is registered with HuntHalloween.com to use the Services.  
...
* Via this Link: [HuntHalloween.com/pages/contact](https://hunthalloween.com/pages/contact)

© 2024 HuntHalloween.com

* [Home](https://hunthalloween.com/ "HuntHalloween Homepage")
* [Contact](https://hunthalloween.com/pages/contact "Contact Us")
* [Privacy](https://hunthalloween.com/pages/privacy "Privacy Policy")