...
[](#mobileHeadTos "Go to top")[Privacy Policy](https://legal.wysa.io/privacy-policy) Terms of Service
...
If You have any questions, comments, or concerns about this Agreement or practices, please contact us at [\[email protected\]](https://legal.wysa.io/cdn-cgi/l/email-protection) or by writing to:  
...
* A new section “Wysa use of Generative AI technology” to explain how Wysa uses this technology to improve App performance, safety and quality.
...
* Updated “Additional Service-related terms” section for terms to use Wysa commissioned controlled and real-world online research studies.
...
* Clearly identify all Services governed by the TOS
* Wysa email ID to [\[email protected\]](https://legal.wysa.io/cdn-cgi/l/email-protection)
* Corrected for grammatical constructs and errors.

**v4.1.0 | December 21, 2022**

**Additions**

* In-App products or services purchased via [Google Play Points](https://play.google.com/console/about/programs/googleplaypoints/) will be non-refundable.

**Updates**

* Included Cookie Policy along with this Terms of Service and the Privacy policy together being the “Agreement” or “Contract” that you have read, understood, and agree to be bound by during use of Wysa App and Services.

**v4.0.0 | December 06, 2022**

**Updates**

* Reorganization and reframing of sections to provide clarity, grammatical correctness and improved alignment to our current intent and purposes.
* Updates made to “Do Note” Section.
* Our Coach or therapist services are provided by global human well-being professionals. Changes made to reflect this across this terms of service including “About Wysa emotional well-being professional”.
...
* Made updates to text in both "indemnity" and "Warranty" sections
* Reworded the liabilities and limits within "Limitation of Liability" for improved clarity and transparency.
* Minor updates to "Governing Law and Dispute Resolution"
...
* Include coverage of agreement to Wysa USA and UK entities. Provide contact details of USA and UK offices.

**Updates**

* Explicit call out of guided-group meditation services, population/analytics dashboard services in the definition of Services.
* Include use of App for self-help and self-monitoring purposes.
* Explicit call out for any minor users (13-18 years) to provide parental consent prior to use of service.
* Explicit call out that independent research and clinical studies cannot be conducted by a third-party without explicit permissions from Wysa.
* Updates to Governing Law and dispute resolution.
...
**v3.2.0 | November 10, 2021**

**Additions**

* Included note on audio-video based session services available only in certain geographies.
* Included in the “Who can Use the Service?” section to highlight the need for informed consent and for providing emergency contact to use the Wysa Coach or Therapist Service.
* Included our other applications including Ascension Wysa app in scope of this Terms of Service. This Terms of Service replaces the existing Ascension Wysa's Terms of Service.

**Updates**

* Updated the “About Wysa Well-being Coach Service Or Wysa Therapist Service” section to highlight the text-messaging based and Audio-Video based conversation modes.
* Updated the “About Privacy, Security, Third Party Links and Monitoring” section to include any third party application and software being accessed external to Wysa App.
