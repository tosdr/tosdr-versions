Welcome to JonHosting
---------------------

These terms and conditions outline the rules and regulations for the use of JonHost's Website.

  

JonHosting is located at:  

  

By accessing this website we assume you accept these terms and conditions in full. Do not continue to use JonHost's website if you do not accept all of the terms and conditions stated on this page.
...
We employ the use of cookies. By using JonHost's website you consent to the use of cookies in accordance with JonHost's [privacy policy](https://jonhosting.com/legal/privacy.html).
...
Unless otherwise stated, JonHost and/or it's licensors own the intellectual property rights for all material on JonHost. All intellectual property rights are reserved. You may view and/or print pages from https://www.jonhosting.com/ for your own personal use subject to restrictions set in these terms and conditions.

You must not:

1. Republish material from https://www.jonhosting.com/
2. Sell, rent or sub-license material from https://www.jonhosting.com/
3. Reproduce, duplicate or copy material from https://www.jonhosting.com/

Redistribute content from JonHost (unless content is specifically made for redistribution).
...
No use of JonHost's logo or other artwork will be allowed for linking absent a trademark license agreement.
