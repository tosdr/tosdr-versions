...
This is the Cookie Policy for Organic Facts, accessible from https://www.organicfacts.net/
...
* The Media.net service we use to serve advertising uses a cookie to serve more relevant ads across the web and limit the number of times that a given ad is shown to you. For more information on Media.net see their official policy.

* The OneSignal web push is used to send notifications to all the users. They use a cookie to store the IP address to send the notification. For more information on OneSignal see the official product policy update.

* The Cloudflare service we use to speed up page load times uses cookies in order to improve user experience. For more information on Cloudflare see their official policy.

* We also use social media buttons and/or plugins on this site that allow you to connect with your social network in various ways. For these to work the following social media sites including; {Facebook, Twitter, Pinterest, GooglePlus}, will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.
...
* Email: [\[email protected\]](https://www.organicfacts.net/cdn-cgi/l/email-protection)

This page was last updated on September 03, 2020.
