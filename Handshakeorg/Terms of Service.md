...
* [Community](https://handshake.org/community)
* [Faq](https://handshake.org/faq)

[![](/images/landing/logo-dark.svg)![](/images/landing/logo-light.svg)](https://handshake.org/)
...
The content on this website may be reproduced under [the MIT License](https://opensource.org/licenses/MIT) or under the [Creative Commons ShareAlike 1.0 Generic (CC SA 1.0)](https://creativecommons.org/licenses/sa/1.0/) license (or dual licensed at your discretion). The stuff below was left over from a prior account settings page.

This website should not be used as an authoritative source on what Handshake _should_ be in the future, and no expectations should be made on people involved with Handshake.
...
* (b) you will maintain the accuracy of such information. You may delete your Account at any time, for any reason, by contacting [\[email protected\]](https://handshake.org/cdn-cgi/l/email-protection). Company may suspend or terminate your Account in accordance with Section 6.
...
Account forfeiture._In the event Handshake determines in its sole discretion that you have misrepresented yourself, then Handshake may delete that account and cancel your verification._
...
![Toggle expanded menu on mobile](/img/footer/down-caret.svg) ![Toggle expanded menu on mobile](/img/footer/up-caret.svg)

[Home](https://handshake.org/) [Community](https://handshake.org/community)

### Learn

![Toggle expanded menu on mobile](/img/footer/down-caret.svg) ![Toggle expanded menu on mobile](/img/footer/up-caret.svg)

[FAQ](https://handshake.org/faq) [Design Notes](https://handshake.org/files/handshake.txt)

### Develop

![Toggle expanded menu on mobile](/img/footer/down-caret.svg) ![Toggle expanded menu on mobile](/img/footer/up-caret.svg)

[Documentation](https://handshake-org.github.io/) [Run a full node](https://github.com/handshake-org/hsd) [Install an SPV resolver](https://github.com/handshake-org/hnsd) [Auction system guide](https://handshake-org.github.io/guides/auctions.html)

[Home](https://handshake.org/) [Terms of Use](https://handshake.org/terms-of-use) [Privacy Policy](https://handshake.org/privacy-policy) [Trademark Disclaimer](https://handshake.org/trademark-disclaimer)

 [![GitHub logo](/img/footer/github.svg)](https://github.com/handshake-org/)[![Twitter logo](/img/footer/twitter.svg)](https://twitter.com/hns)[![Reddit logo](/img/footer/reddit.svg)](https://reddit.com/r/handshake)