...
* [FAQ](https://upcloud.com/resources/faq)
* [API](https://developers.upcloud.com/)
* [Customer Support](https://upcloud.com/support)
...
* [Solutions](https://upcloud.com/solutions)
    * Solutions
        * [European Cloud](https://upcloud.com/solutions/european-cloud)
        * [Digital agencies](https://upcloud.com/solutions/digital-agencies)
        * [eCommerce](https://upcloud.com/solutions/ecommerce)
        * [Hosting providers](https://upcloud.com/solutions/hosting-providers)
        * [Software and Platforms](https://upcloud.com/solutions/software-development)
* [Products](https://upcloud.com/products)
    * Compute
        * [Cloud Servers](https://upcloud.com/products/cloud-servers)
        * [Private Cloud](https://upcloud.com/products/private-cloud)
        * [Managed Databases](https://upcloud.com/products/managed-databases)
        * [Managed Kubernetes](https://upcloud.com/products/managed-kubernetes)
    * Storage
        * [Block Storage](https://upcloud.com/products/block-storage)
        * [Object Storage](https://upcloud.com/products/object-storage)
        * [Simple Backup](https://upcloud.com/products/simple-backup)
    * Networking
        * [Managed Load Balancer](https://upcloud.com/products/managed-load-balancer)
        * [Software Defined Networking](https://upcloud.com/products/software-defined-networking)
        * [Zero-cost Egress](https://upcloud.com/products/zero-cost-egress)
* [Pricing](https://upcloud.com/pricing)
* [Insights](https://upcloud.com/insights)
    * Insights
        * [Blog](https://upcloud.com/blog)
        * [Case studies](https://upcloud.com/case-studies)
...
* [Resources](https://upcloud.com/resources)
    * Resources
        ...
        * [Tools](https://upcloud.com/resources/tools)
        * [FAQ](https://upcloud.com/resources/faq)
        * [API](https://developers.upcloud.com/)
        * [System status](https://status.upcloud.com/)
* [Company](https://upcloud.com/about/)
    * Company
        * [About us](https://upcloud.com/about)
        * [Careers](https://upcloud.com/careers)
        * [Contact us](https://upcloud.com/contact)
        * [Customer Support](https://upcloud.com/support)
        * [Data Centres](https://upcloud.com/data-centres)
        * [Media Centre](https://upcloud.com/media-centre)
        * [Partners](https://upcloud.com/partners)

[Login](https://hub.upcloud.com/)

[Sign up](https://signup.upcloud.com/)
...
[www.upcloud.com](http://www.upcloud.com/)

**Contact person:  
**UpCloud Support Team, email: [\[email protected\]](https://upcloud.com/cdn-cgi/l/email-protection)  
UpCloud’s Data Protection Officer, email: [\[email protected\]](https://upcloud.com/cdn-cgi/l/email-protection)
...
* UpCloud’s prospect customer or a representative of UpCloud’s prospect customer (“**Prospect Customer**”)
...
We use cookies and other analytics technologies to collect and process the technical data when Users interact with our service through UpCloud Control Panel at [https://hub.upcloud.com/](https://hub.upcloud.com/). This allows us to calculate the aggregate number of people accessing our service and to monitor the use of the service. This helps us to improve our services and better serve our Customers and Users. We also use cookies that make the use of the service easier, for example by remembering usernames, passwords and preferences, and to enable certain functions of the Control Panel, such as support chat. We may use website analytics to compile technical data and reports on the usage of our services to help us improve our services.
...
For more information about cookies used on our website, please see our Cookie Notice [https://upcloud.com/cookie-policy](https://upcloud.com/cookie-policy)
...
We process personal data to monitor and ensure that our Customers and Users comply with our [Terms of Service](http://www.upcloud.com/terms-of-service) and the applicable laws and regulations.
...
If you want to make a request to exercise any of the above rights, please contact UpCloud Support Team at [\[email protected\]](https://upcloud.com/cdn-cgi/l/email-protection). Please include the following information to your request: the full name, company name (if applicable), address, e-mail address, and phone number.
...
You have the right to make a complaint at any time to the supervisory authority in your country of residence. List of the EEA supervisory authorities can be found [here](https://edpb.europa.eu/about-edpb/about-edpb/members_en). The relevant supervisory authority overseeing UpCloud Oy is [The Finnish Data Protection Ombudsman](https://tietosuoja.fi/en/home). We would, however, appreciate the chance to deal with your concerns before you approach any supervisory authority.
...
If you have any questions about this Privacy Notice or the way UpCloud processes your personal data, please contact UpCloud’s Data Protection Officer at [\[email protected\]](https://upcloud.com/cdn-cgi/l/email-protection).

![](https://upcloud.com/media/privacy-policy-cables.png)
...
* [Company](https://upcloud.com/about)
    ...
    * [Media Centre](https://upcloud.com/media-centre)
    * [Partners](https://upcloud.com/partners)
    * [Reporting abuse](https://upcloud.com/reporting-abuse)
    * [Security & Privacy](https://upcloud.com/security-privacy)
    * [Vulnerability Disclosure Program](https://app.intigriti.com/programs/upcloud/upcloudvdp/detail)
    * [Whistleblowing Channel](https://app.falcony.io/upcloudwb/links/whistleblowing)
* [Competitors & Alternatives](https://upcloud.com/competitors-and-alternatives)
    * [AWS](https://upcloud.com/competitors-and-alternatives/aws)
    * [Azure](https://upcloud.com/competitors-and-alternatives/azure)
    * [DigitalOcean](https://upcloud.com/competitors-and-alternatives/digitalocean)
    * [Akamai Linode](https://upcloud.com/competitors-and-alternatives/akamai-linode)
    * [VMware](https://upcloud.com/vmware-alternative)
...
[Cookie Policy](https://upcloud.com/cookie-policy)

* [GitHub](https://github.com/UpCloudLtd)
* [Instagram](https://www.instagram.com/upcloud/)
* [LinkedIn](https://www.linkedin.com/company/upcloud/)
* [Twitter](https://twitter.com/upcloud)
* [Youtube](https://www.youtube.com/channel/UCkIkxF5pBTBLYgYHXDIUUuw)
