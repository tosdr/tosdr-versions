...
* Platform
    ...
    [![apm icon](/sites/default/files/2023-09/APM.svg)
    ...
    * [Infrastructure Monitoring](https://newrelic.com/platform/infrastructure)
    * [Kubernetes Monitoring](https://newrelic.com/platform/kubernetes-pixie)
    * [Network Monitoring](https://newrelic.com/platform/network-performance-monitoring)
    * [Prometheus Monitoring](https://newrelic.com/solutions/prometheus-monitoring)
    * [AWS Cloud Monitoring](https://newrelic.com/partners/aws-monitoring)
    * [Azure Cloud Monitoring](https://newrelic.com/solutions/partners/azure)
    * [Google Cloud Monitoring](https://newrelic.com/partners/gcp)
    ...
    * [New Relic AI](https://newrelic.com/platform/new-relic-ai)
    * [Errors Inbox](https://newrelic.com/platform/errors-inbox)
    * [Alerts](https://newrelic.com/platform/alerts)
    * [Dashboards](https://newrelic.com/platform/dashboards)
    * [Change Tracking](https://newrelic.com/platform/change-tracking)
...
* Solutions
    ...
    * [Amazon Web Services](https://newrelic.com/partners/aws-monitoring)
    * [Google Cloud Platform](https://newrelic.com/partners/gcp)
    * [Microsoft Azure](https://newrelic.com/solutions/partners/azure)
    * [Pivotal Cloud Foundry](https://newrelic.com/solutions/partners/pivotal)
    * [Prometheus Monitoring](https://newrelic.com/solutions/prometheus-monitoring)
    * [SAP Monitoring](https://newrelic.com/solutions/sap)
...
* Developers
    ...
    [![Kubernetes icon](/sites/default/files/2023-08/developers-kubernates.svg)
    
    Simple K8 Monitoring
    
    Simplify your Kubernetes monitoring with the New Relic operator.](https://newrelic.com/blog/how-to-relic/simplify-your-kubernetes-monitoring-with-the-new-relic-operator)
    
    [![Mobile monitoring icon](/sites/default/files/2023-08/developers-mobile-monitoring.svg)
    
    Monitor Mobile Apps
    
    Monitor hybrid mobile apps in minutes with quickstart installations.](https://newrelic.com/blog/how-to-relic/monitor-hybrid-mobile-apps)
    
    [![Browser monitoring icon](/sites/default/files/2023-08/developers-browser-tracking.svg)
    
    New Relic Browser Agent
    
    Custom instrumentation with the New Relic browser agent.](https://newrelic.com/blog/how-to-relic/custom-instrumentation-with-the-new-relic-browser-agent)
    ...
    * [Start ingesting data](https://docs.newrelic.com/docs/new-relic-solutions/get-started/quick-launch-guide/)
    * [Create custom dashboards](https://docs.newrelic.com/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/)
    * [Examine NRQL queries](https://docs.newrelic.com/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/)
    * [Forward logs using infrastructure agent](https://docs.newrelic.com/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/)
    ...
    Install](https://newrelic.com/instant-observability/python)
    
    [Java
    
    Install](https://newrelic.com/instant-observability/java)
    
    [PHP
    
    Install](https://newrelic.com/instant-observability/php)
    
    [Ruby
    
    Install](https://newrelic.com/instant-observability/ruby)
    ...
    Enhance security with New Relic APM's zero-day vulnerability alerts for proactive threat management and peace of mind.](https://newrelic.com/blog/how-to-relic/a-deep-dive-into-zero-day-vulnerability-alerts-with-new-relic-apm)
    
    [![Analysis icon](/sites/default/files/2024-04/mag-glass.svg)
    
    Root Cause Analysis
    
    Master root cause analysis with New Relic's guide to identify, solve, and prevent issues efficiently and effectively.](https://newrelic.com/blog/how-to-relic/performing-effective-root-cause-analysis)
...
* Resources
    ...
    * [Secure Developer](https://newrelic.com/solutions/secure-developer-program)
...
[Paid Accounts](https://newrelic.com/termsandconditions/paid)

* Customers that access New Relic’s platform through a paid subscription are governed by the Terms of Service set forth immediately above.

[Unpaid Accounts](https://newrelic.com/termsandconditions/unpaid)

* Customers that access New Relic’s platform on an unpaid (e.g. trials, proof of concepts, New Relic Developer Edition or ‘lite’) basis are governed by the Terms of Service set forth immediately above.

[Community Forums](https://newrelic.com/termsandconditions/communityterms)

* Community Forum participants ask and answer questions about New Relic’s platform.  Use of the Community Form is governed by the terms and conditions set forth immediately above.

[New Relic Data Processing Addendum](https://newrelic.com/termsandconditions/dataprotection)

* Customers who currently send, or intend to send, personal data to the New Relic Services for processing should download and complete the Data Processing Addendum set forth immediately above.

[Data Processing Addendum FAQ](https://newrelic.com/termsandconditions/dataprotectionFAQ)
...
[New Relic CCPA Service Provider Addendum](https://newrelic.com/termsandconditions/ccpa)

[New Relic CCPA Service Provider Addendum FAQ](https://newrelic.com/termsandconditions/ccpaFAQ)

[New Relic HIPAA BAA FAQ](https://newrelic.com/termsandconditions/hipaabaaFAQ)

[California Applicant Privacy Notice](https://newrelic.com/termsandconditions/california-applicant-privacy-notice)  
 
...
* [Deutsch](https://newrelic.com/de/termsandconditions/terms)
* [English](https://newrelic.com/termsandconditions/terms)
* [Español](https://newrelic.com/es/termsandconditions/terms)
* [Français](https://newrelic.com/fr/termsandconditions/terms)
* [日本語](https://newrelic.com/jp/termsandconditions/terms)
* [한국어](https://newrelic.com/kr/termsandconditions/terms)
* [Português](https://newrelic.com/pt/termsandconditions/terms)
