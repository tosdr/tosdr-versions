...
* [About](https://info.orcid.org/what-is-orcid)
    * * * [Our Mission](https://info.orcid.org/what-is-orcid/)
        ...
        * * [Team](https://info.orcid.org/orcid-team/)
            ...
            * [Our Community](https://info.orcid.org/orcid-community/)
        ...
        * * [Services](https://info.orcid.org/documentation/features/)
                ...
                * [Annual data files](https://info.orcid.org/what-is-orcid/features/annual-data-files/)
                * [Member API](https://info.orcid.org/what-is-orcid/features/member-api/)
                * [Public API](https://info.orcid.org/what-is-orcid/features/public-api/)
                * [ORCID Registry](https://info.orcid.org/what-is-orcid/features/orcid-registry/)
...
* [For Researchers](https://info.orcid.org/researchers/)
    * * * [Researcher FAQ](https://info.orcid.org/researcher-faq/)
...
* [Documentation](https://info.orcid.org/documentation/)
    * * * [Workflows](https://info.orcid.org/documentation/workflows/)
        ...
        * * [Integration Best Practices](https://info.orcid.org/documentation/integration-best-practices/)
                * [Collecting and sharing ORCID iDs](https://info.orcid.org/documentation/collecting-and-sharing-orcid-ids/)
...
You are here: [Home](https://info.orcid.org/) / ORCID Privacy Policy

ORCID Privacy Policy
====================

_This Policy was last updated 26 September 2024_
...
[2\. ORCID terms](#2_ORCID_terms)

[3\. Our responsibilities](#3_Our_responsibilities)

[4\. Your privacy rights and choices](#4_Your_privacy_rights_and_choices)

[5\. How and when we collect your data](#5_How_and_when_we_collect_your_data)

[6\. The data we use and why we use it](#6_The_data_we_use_and_why_we_use_it)

[7\. Sharing your personal data](#7_Sharing_your_personal_data)

[8 Data storage and international transfers](#8_Data_storage_and_international_transfers)

[9\. How long we keep your data](#9_How_long_we_keep_your_data)

[10\. Automated decision making and profiling](#10_Automated_decision_making_and_profiling)

[11\. Sensitive personal data](#11_Sensitive_personal_data)

[12\. Children](#12_Children)

[13\. Confidentiality and security of your data](#13_Confidentiality_and_security_of_your_data)

[14\. Questions and Concerns](#14_Questions_and_Concerns)

[15\. Other terms](#15_Other_terms)

[16\. Changes to this Policy](#16_Changes_to_this_Policy)

[17\. Additional privacy information](#17_Additional_privacy_information)

1\. Introduction
----------------

ORCID is a global, non-profit organization headquartered in the United States. We provide the ORCID iD, a free, unique, persistent identifier for individuals to use as they engage in research, scholarship, and innovation activities and other connected services to our community of researchers, member organizations and to the public. For more information on our services, see our [About](https://info.orcid.org/what-is-orcid/) page. 
...
If you have any questions, comments, complaints or requests regarding this Policy or our data collection, processing and protection practices, please contact our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection). If you prefer, you can also write to us. Our full mailing address is in the [Questions and Concerns section of this Policy](#questionsandconcerns).
...
* **Only Me Data**: Data from an ORCID Record that the Record Holder has given a visibility setting of “visible by only me”. Also referred to as “private data” (see more information about ORCID [Privacy Settings](https://support.orcid.org/hc/en-us/articles/25538671642519-Privacy-Settings))
* **Trusted Party Data**: Record Data that the Record Holder has given a visibility setting of “visible by trusted parties”. Also referred to as “limited access data” (see more information about ORCID [Privacy Settings](https://support.orcid.org/hc/en-us/articles/25538671642519-Privacy-Settings))
* **Everyone Data**: Record Data that the Record Holder has given a visibility setting of “visible by everyone”. Also referred to as “public data” (see more information about ORCID [Privacy Settings](https://support.orcid.org/hc/en-us/articles/25538671642519-Privacy-Settings)).
...
If you are a Record Holder you control the visibility of most of the data items in your ORCID Record. You can revoke Trusted Individual/Organization status at any time, download your data or deactivate your Account, which will result in the deletion of almost all the data we hold about you (see Section 9 for information about the data we retain.) We describe how you can make these privacy changes in our [privacy settings guidance](https://support.orcid.org/hc/en-us/articles/25538671642519-Privacy-Settings). 

You can also adjust frequency settings for email notifications we may send you and choose whether to receive our New Features and Tips notifications—see our [detailed guidance on notifications](https://support.orcid.org/hc/en-us/articles/360006972953-ORCID-inbox-notifications-and-frequency-settings).
...
* **Right to appeal**: This right enables you to appeal our denial of any request you make under this section. To exercise your right to appeal, please submit an appeal request by contacting our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).

### 4.3 How to exercise your rights

You are able to review, verify, correct and request erasure of your Record Data directly in the ORCID Registry—detailed guidance is available in our [Help Center](https://support.orcid.org/hc/en-us) . If you want to make a request in relation to any other personal data we hold about you, please contact our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).  
...
* Initiate or participate in a dispute investigation, in line with our [Dispute Procedures](https://info.orcid.org/dispute-procedures/)
...
* Your **Trusted Individuals** may edit, delete and deposit information in your Record. You may specifically designate or remove Trusted Individuals in the ORCID Registry from the Trusted Parties page of your Record—see [detailed guidance](https://support.orcid.org/hc/en-us/articles/360006973613-Add-a-trusted-individual-to-your-account) in our Help Center.
...
* **Member Creators.** Through 2015, there was an option for Member Organizations to create ORCID Records on behalf of their staff and students, including obtaining an ORCID iD, populating the record with data, and setting the initial settings for visibility & sharing. Such Members are referred to as ‘Member Creators’. [This functionality is no longer provided by ORCID](https://orcid.org/blog/2015/12/04/importance-opt), however, we describe how this functionality worked at our [Member Creators](https://support.orcid.org/hc/en-us/articles/360022266113-Member-Creators) page.
...
ORCID has a **legitimate interest** in providing, updating and maintaining our services, as well as in understanding usage and protecting the security of our Websites and Registry. Our use of the above data helps us to meet the needs of our community, in our and their interests.

### 6.2 Registering with ORCID

We use the following information to enable you to register with ORCID on our Websites and create an Account. Registering is not essential but allows you to create an ORCID Record, serve as a Trusted Individual and/or register a Public API client (sandbox or production).

* Name (at least your given or first name)
* Email address(es)
* Optionally, your affiliation information

If you sign in to your ORCID record using institutional credentials or social sign-in identity providers (e.g., Google or Facebook) we may also collect personal names, email addresses, and unique persistent identifiers. We will use this information to

* Enable you to register and sign in to your ORCID account
* Contact you by email with routine service messages related to or affecting your ORCID Account, and about Trusted Individual / Organization requests and changes. See further information on our [notifications preferences](https://support.orcid.org/hc/en-us/articles/360006894514-Notifications-preferences) page

#### **Lawful basis**

When you register with ORCID we primarily rely on your **consent** to process the personal data associated with your Account. 

We also have a **legitimate interest** in using the information you provide to communicate with you in relation to your Account / Record.

If you later choose to [deactivate your account](https://support.orcid.org/hc/en-us/articles/360006973813-Deactivating-an-ORCID-account) we have a **legitimate interest** in retaining minimal data, as described in section 9 (How long we keep your data). 

Where our lawful basis for processing your personal data is consent, you can withdraw your consent at any time, by deactivating your account or by contacting our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).
...
We may use the information we collect to train machine learning models that detect patterns of abuse in Registry usage. We use these models, as well as manual review processes, to detect and lock ORCID Records that may be in breach of our [Terms of Use](https://info.orcid.org/terms-of-use/) or otherwise contravene our policies, such as Records for business, organizations, and advertising content. 

Locked Records are not accessible by anyone other than the Record Holder, ORCID staff and our data processors. If we lock your Record, you will be notified by email. If you believe we have locked your Record erroneously, you may contact our [Helpdesk](https://support.orcid.org/hc/en-us/requests/new) so that we can review your data and if appropriate, reactivate the Record.

#### **La**w**ful basis**

When you (or a Trusted Individual acting on your behalf) create or update an ORCID Record we rely primarily on your **consent** to process the personal data contained within your Record. Where our lawful basis for processing your personal data is consent, you can withdraw your consent for processing this information at any time, by contacting [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).

We also have a **legitimate interest** in using the information you provide to help us operate, protect, evaluate and improve the provision (and, where relevant, [the public availability](#publishingdata)) of the ORCID Registry.
...
You can withdraw your consent at any time by clicking the Unsubscribe link in any emails we send you. Withdrawing your consent will mean we will stop sending you emails from this mailing list. You can also withdraw your consent by contacting [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).
...
For further information on our records retention, please contact our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).

10\. Automated decision making and profiling
--------------------------------------------

As noted in section 6.3 of this Policy, we use the information we collect about ORCID Records to train machine learning models that detect patterns of abuse in Registry usage and this may result in ORCID Records being locked. While this activity constitutes automated processing, we will always manually review any locked records upon request. If you think a Record has been wrongly locked please contact our [Helpdesk](https://support.orcid.org/hc/en-us/requests/new).
...
Any disclosure of sensitive personal data by those attending in-person events is purely optional and based on your consent, which you can withdraw at any time by contacting our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection).
...
If you are under 16 years old, please do not share any personal data with us, even if prompted by the Websites to do so. If you think you have provided personal data to us, please ask your parent(s) or guardian(s) to notify our [Helpdesk](https://support.orcid.org/hc/en-us/requests/new) and we will delete all such information about you.

13\. Confidentiality and security of your data
----------------------------------------------

We are committed to protecting the confidentiality of the personal data we process and use a range of technical and organizational measures to ensure its security. [We have published separate information](https://support.orcid.org/hc/en-us/articles/360006897574-ORCID-security) outlining some of the security measures we take. If you would like to know more, or have any questions about security on our Websites, please contact our [Helpdesk](https://support.orcid.org/hc/en-us/requests/new).

14\. Questions and Concerns
---------------------------

If you have any questions, comments, complaints or requests regarding this Policy or our data protection practices, please contact our Data Protection Officer by email in the first instance at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection). You can also write to us, addressing your letter to the Data Protection Officer, ORCID Inc., 10411 Motor City Drive, Suite 750, Bethesda MD 20817, USA.

### 14.1 Escalation process

If you have an unresolved privacy or data use concern that we have not addressed satisfactorily, please contact our US-based third party dispute resolution provider (free of charge) at [https://feedback-form.truste.com/watchdog/request](https://feedback-form.truste.com/watchdog/request).
...
We will post any changes to this Policy on this page and encourage you to check this page regularly to keep informed. If you would like to view our previous Privacy Policies, you can contact our Data Protection Officer at [\[email protected\]](https://info.orcid.org/cdn-cgi/l/email-protection). 
