...
[![](https://pub.mdpi-res.com/img/design/mdpi-pub-logo-black-small1.svg?da3a8dcae975a41c?1728973438 "MDPI Open Access Journals")](https://www.mdpi.com/)
...
* [Privacy Policy](#accordion_content_privacy_policy)
    
    * [Scope](#Scope)
    * [Automated data collection and processing by the browser](#Automated_data_collection_and_processing_by_the_browser)
    * [Cookies and tracking tools used on our website](#Cookies_and_tracking_tools_used_on_our_website)
    * [Data collection and processing of voluntarily provided data](#Data_collection_and_processing_of_voluntarily_provided_data)
    * [Disclosure to third parties](#Disclosure_to_third_parties)
    * [Duration of storage](#Duration_of_storage)
    * [Your rights](#Your_rights)
    
* [Terms and Conditions](https://www.mdpi.com/about/terms-and-conditions)
...
We have aligned this Privacy Policy with both the Swiss Data Protection Act (“SDPA”) and the EU General Data Protection Regulation (“GDPR”). The GDPR has established itself worldwide as a benchmark for strong data protection, therefore our company has set itself to implement the highest standards in data protection. As GDPR and SDPA may have slight differences in the definitions used, we base the following Privacy Policy text on GDPR definitions, which have the same meaning in SDPA. Notwithstanding the above, please note that whether and to what extent the GDPR or SDPA is applicable to you depends on the individual case.
...
We use a local installation of Matomo on our website. Matomo is an open source analytics tool ([http://www.matomo.org](http://www.matomo.org/)) that enables us to analyze the behavior of visitors in order to offer you a flawless user experience. As we have installed Matomo locally on our web server, no data is transferred to third parties. We use Matomo with an IP masking procedure (i.e. pseudonymization by shortening the IP address) to protect users. We also use cookies for the use of Matomo. Further information on this can be found in our cookie banner. The legal basis for the processing is your consent given via the cookie banner. If you are a registered user, we will also process your data according to section 4.2 below.
...
Please send your written request to MDPI AG, Grosspeteranlage 5, 4052 Basel, Switzerland or to the e-mail address: [\[email protected\]](https://www.mdpi.com/cdn-cgi/l/email-protection).
...
[\[email protected\]](https://www.mdpi.com/cdn-cgi/l/email-protection)[](https://twitter.com/intent/tweet?text=&hashtags=&url=https%3A%2F%2Fwww.mdpi.com%2Fabout%2Fprivacy&via=MDPIOpenAccess "Twitter")[](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.mdpi.com%2Fabout%2Fprivacy&title=%26source%3Dhttps%3A%2F%2Fwww.mdpi.com "LinkedIn")[](https://www.facebook.com/sharer.php?u=https://www.mdpi.com/about/privacy "facebook")[](javascript:void(0); "Wechat")[](http://www.reddit.com/submit?url=https://www.mdpi.com/about/privacy "Reddit")[](http://www.mendeley.com/import/?url=https://www.mdpi.com/about/privacy "Mendeley")[](http://www.citeulike.org/posturl?url=https://www.mdpi.com/about/privacy "CiteULike")
