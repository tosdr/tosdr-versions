...
**Personal Information You Provide And How It Is Used:** You may freely visit our Website anonymously and without being required to provide us with any personal information. However, certain features do require that you provide us with some personally identifying information. Please note that we only collect personal information that you voluntarily provide to us; personal information is data that can be used to identify you. Examples of instances in which we collect personal information include:

_Donate:_ If you make a donation through the Website via the “donate” button, you will be asked to provide certain personally identifying information as required by the payment processor for the payment method selected.

_Team Creation:_ If you opt to create a team to help raise donations, you will be asked to provide us with a “display” name and email address.

_E-Newsletter:_ If you opt to receive updates, we will ask you to provide your email address, first and last name.

_Shop:_ If you opt to buy an item from our online store, we will ask you to provide certain personally identifying information, such as your name and home address, as well as your payment information. Please note that we work with third parties to host and administer the shop, and to process your payment transactions, and any information you share will also be shared with such third parties.

**Non-Personal Information We Collect by Automated Means And How We Use It:** We also collect certain non-personal information (data in a form that does not support direct association with any specific person or individual) by automated means when you visit the Website. Much of this information is collected through the use of third-party tracking services, which includes Google Analytics and Hotjar. The information collected may include usage information, such as the numbers and frequency of users to the Website, pages visited, web browsing histories, your location and device, social networking activities and similar data. When gathered, this this data is used in the aggregate, and not in a manner that is intended to identify you personally. This type of aggregate information may be shared with third parties at any time, including marketers. In addition to the third-party tracking services mentioned above, we also collect this information through various other means, including "cookies,” as further explained below.
...
We may disclose all of the information (described herein) that we collect, as stated in this Privacy Policy including in accordance with the terms set forth in this section. Please note MrBeast works with a variety of third-party partners in order to allow us to make the Website available to you, to host and store the information we collect from you, and to provide certain functionality and features, such as to process payment/donation transactions, or to fulfill the orders you place with our online store. We will also share information related to your donation - for “transactional” purposes - with both the Ocean Conservancy and The Ocean Cleanup North Pacific Foundation, the two nonprofit organizations who are the recipients of the donations processed through the Website. Except as stated in this Privacy Policy, we do not reveal personally identifiable information about you to third parties for their independent use unless: (1) you expressly authorize MrBeast to do so, (2) it is necessary to allow MrBeast and its service providers or agents to provide services on MrBeast’s behalf, (3) it is to provide services to you, (4) it is disclosed to entities that perform marketing or data aggregation services for MrBeast, (5) it is necessary in connection with a sale of all or substantially all of the assets of MrBeast or the merger of MrBeast into another entity or any consolidation, share exchange, combination, reorganization, or like transaction in which MrBeast is not the survivor, (6) MrBeast is required or permitted to do so for any or all of the following reasons: (i) to comply with a subpoena, legal process, government request or any other legal obligation, (ii) to prevent, investigate, detect, or prosecute criminal offenses or attacks on the technical integrity of the Website or our network, and/or (iii) to protect the rights, privacy, property, business, or safety of MrBeast, its partners and employees, the visitors of the Website, the children or families that we serve, or the public.

### CHILDREN’S PRIVACY

Although we specifically require in our Terms of Use that anyone using our Website who is younger than 13 years of age first receive parental consent, we understand that children may still access the Website and provide us with information. In cases in which may collect, use, or disclose personally identifiable information about visitors to our Website that are less than 13 years of age, please note that we have a separate privacy disclosure statement to address our protocols related to such collection, located [HERE](https://teamseas.org/coppa-policy/). If you are the parent or guardian of a child under 13 years of age and you have any concerns related to the information we may be collecting and using, please contact us at [\[email protected\]](https://teamseas.org/cdn-cgi/l/email-protection), and be sure to include in your message the same username and email address that your child submitted, if applicable.
...
If you have any questions or concerns about our Privacy Policy, please contact us at [\[email protected\]](https://teamseas.org/cdn-cgi/l/email-protection).
...
The following provisions applies only to users residing in the European Economic Area, Switzerland and the United Kingdom.

Pursuant to the EU General Data Protection Regulation (“GDPR”), we are required to provide those residing in the European Economic Area, Switzerland and the United Kingdom (hereinafter, the “EU Users”) additional information and rights related to the “Personal Data” we collect about them. We summarize such information and rights below.

### HOW TO CONTACT US

MrBeastYouTube, LLC (the Data Controller) is the owner and operator of the Website. If you need to contact us for any reason related to this Privacy Policy or your use of the Website, please contact us at [\[email protected\]](https://teamseas.org/cdn-cgi/l/email-protection) or write to us at Legalese contact: 1300 19th St NW 8th floor, Washington, DC 20036.
...
MrBeast will process personal data that we receive from EU Users on the ground that it is in our legitimate interest for the effective administration of the Website, to fulfill and/or address your requests, or to provide the functionalities and features as further described herein.
...
### CHILDREN’S PRIVACY/NOTE TO PARENTS OF CHILDREN RESIDING IN THE EUROPEAN ECONOMIC AREA, SWITZERLAND AND UNITED KINGDOM

Although we specifically require that anyone using our Website who is not of the required age to act on their own behalf in their jurisdiction/country (“children” or “child”) first receive parental consent, we understand that children may still access the Website and provide us with information. In cases in which we may collect, use, or disclose personally identifiable information about children to our Website, please note that we have a separate privacy disclosure statement to address our protocols related to such collection, located HERE. If you are the parent or guardian of a child and you have any concerns related to the information we may be collecting and using, please contact us at [\[email protected\]](https://teamseas.org/cdn-cgi/l/email-protection), and be sure to include in your message the same username and email address that your child submitted, if applicable.

**PRIVACY POLICY EFFECTIVE DATE**

This Privacy Policy is effective as of October 27, 2021
