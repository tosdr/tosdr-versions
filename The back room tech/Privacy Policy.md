[The Back Room Tech](https://thebackroomtech.com/ "The Back Room Tech")

Search Menu

* [Server](#)
    * [Active Directory](https://thebackroomtech.com/category/active-directory/)
* [Client](#)
    * [Fixes](https://thebackroomtech.com/category/fixes/)
    * [Windows](https://thebackroomtech.com/category/windows/)
* [Tips](#)
    * [How-To](https://thebackroomtech.com/category/howto/)
    * [Linux](https://thebackroomtech.com/category/linux/)
    * [Script](https://thebackroomtech.com/category/script/)
    * [Troubleshooting](https://thebackroomtech.com/category/troubleshooting/)
    * [Utilities](https://thebackroomtech.com/category/utilities/)
    * [Virtualization](https://thebackroomtech.com/category/virtualization/)
* [Other](#)
    * [Microsoft Azure](https://thebackroomtech.com/category/microsoft-azure/)
...
* [About Back Room Tech](https://thebackroomtech.com/about-2/)
* [Privacy Policy](https://thebackroomtech.com/privacy-policy/)
...
![Author avatar](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2048%2048'%3E%3C/svg%3E)

![Author avatar](https://secure.gravatar.com/avatar/f7cb0b63500ae78f1a87456d4c3a59f5?s=48&d=mm&r=g)

Written by: [Aseem Kishore](https://thebackroomtech.com/author/akishoretbrt/)  
Posted on: August 20th, 2018 in:

**Privacy Policy for TheBackRoomTech.com**

The privacy of our visitors to TheBackRoomTech.com is very important to us.

At TheBackRoomTech.com, we recognize that privacy of your personal information is important. Here is information on what types of personal information we receive and collect when you use visit TheBackRoomTech.com, and how we safeguard your information.  We never sell your personal information to third parties.

**Ezoic Ads**

[g.ezoic.net/privacy/thebackroomtech.com](http://g.ezoic.net/privacy/thebackroomtech.com)
...
We also use third party advertisements on TheBackRoomTech.com to support our site.  Some of these advertisers may use technology such as cookies and web beacons when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP , the browser you used to visit our site, and in some cases, whether you have Flash installed.  This is generally used for geotargeting purposes (showing ads based on location or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).
...
Supreme caution has been taken to make sure that there are no copyright infringements in terms of the multimedia content and the subject matter that is posted in this blog. If you find anything that could be considered a violation of the copyright norms, please [contact me](https://thebackroomtech.com/contact/) immediately.

#### Daily Email Newsletter

 

[](https://twitter.com/backroom_tech)[](https://www.facebook.com/thebackroomtech)[](https://www.linkedin.com/company/thebackroomtech)[](mailto:thebackroomtech@gmail.com)[](https://thebackroomtech.com/feed/)
...
* [![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2080%2023'%3E%3C/svg%3E)
    ...
    ![](https://s11921.pcdn.co/wp-content/uploads/dell-poweredge-80x23.png.webp)](https://thebackroomtech.com/2008/03/13/a-dell-poweredge-server-windows-2003-x64-and-the-battle-over-sas-raid-drivers/ "A Dell PowerEdge Server, Windows 2003 x64, and the Battle Over SAS RAID Drivers")[A Dell PowerEdge Server, Windows 2003 x64, and the Battle Over SAS RAID Drivers](https://thebackroomtech.com/2008/03/13/a-dell-poweredge-server-windows-2003-x64-and-the-battle-over-sas-raid-drivers/ "A Dell PowerEdge Server, Windows 2003 x64, and the Battle Over SAS RAID Drivers")
* [![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2067%2052'%3E%3C/svg%3E)
    
    ![](https://s11921.pcdn.co/wp-content/uploads/112607-e1506710630187-67x52.jpg.webp)](https://thebackroomtech.com/2008/01/31/howto-use-the-windows-debugging-tools-to-analyze-a-crash-dump-bsod/ "Howto: Use the Windows Debugging Tools to analyze a crash dump (BSOD)")[Howto: Use the Windows Debugging Tools to analyze a crash dump (BSOD)](https://thebackroomtech.com/2008/01/31/howto-use-the-windows-debugging-tools-to-analyze-a-crash-dump-bsod/ "Howto: Use the Windows Debugging Tools to analyze a crash dump (BSOD)")
* [![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2080%2040'%3E%3C/svg%3E)
    
    ![](https://s11921.pcdn.co/wp-content/uploads/remove-framepkg-exe-80x40.png.webp)](https://thebackroomtech.com/2009/02/17/reinstalling-the-mcafee-common-management-agent-framework-framepkgexe-without-a-reboot/ "Reinstalling the McAfee Common Management Agent Framework (framepkg.exe) without a reboot")[Reinstalling the McAfee Common Management Agent Framework (framepkg.exe) without a reboot](https://thebackroomtech.com/2009/02/17/reinstalling-the-mcafee-common-management-agent-framework-framepkgexe-without-a-reboot/ "Reinstalling the McAfee Common Management Agent Framework (framepkg.exe) without a reboot")
* [![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2077%2052'%3E%3C/svg%3E)
    
    ![](https://s11921.pcdn.co/wp-content/uploads/1-xenapp-install-77x52.png.webp)](https://thebackroomtech.com/2018/04/09/simple-citrix-xenapp-install-and-deployment-step-by-step/ "Simple Citrix XenApp Install and Deployment – Step-by-Step")[Simple Citrix XenApp Install and Deployment – Step-by-Step](https://thebackroomtech.com/2018/04/09/simple-citrix-xenapp-install-and-deployment-step-by-step/ "Simple Citrix XenApp Install and Deployment – Step-by-Step")

#### Our Publishing Family

The Back Room Tech is part of the AK Internet Consulting publishing family.
...
#### About The Back Room Tech

Welcome to The Back Room Tech- a tech blog for those who work in server back rooms. My name is Aseem Kishore and I am a full-time professional blogger. I graduated from Emory University with a degree in Computer Science and Mathematics.

[Read More](https://thebackroomtech.com/about/)

[Home](https://thebackroomtech.com/) [About](https://thebackroomtech.com/about-2/) [Contact](https://thebackroomtech.com/contact/) [Privacy Policy](https://thebackroomtech.com/privacy-policy/)

Copyright © 2010-2024 The Back Room Tech.com, LLC All Rights Reserved