...
Nous avons défini dans le tableau ci-dessous la manière dont nous collectons vos données à caractère personnel ainsi que celles qui sont concernées :

| Moyens de collecte de vos données | Catégories de données collectées | Données collectées |
| --- | --- | --- |
| Vous nous fournissez certaines informations personnelles vous concernant, par vous-même | Données de Compte | Lors de la création de votre compte utilisateur, nous vous demandons de fournir certaines informations vous concernant comme votre **email**, votre **date de naissance**, votre **sexe** et **vos préférences éditoriales**. Vous avez également la possibilité de nous fournir des données personnelles complémentaires (par exemple votre **code postal**) afin de personnaliser encore davantage votre expérience. |
| Données de Services | Lors de la fourniture de certains services complémentaires (participation à nos jeux-concours, participation au casting d'un programme, demandes d’exercice de droits sur vos données personnelles …) **des informations complémentaires** complémentaires vous concernant pourront vous être demandées à condition qu'elles soient nécessaires, adéquates, proportionnées et légitimes au regard de l’objectif poursuivi (cet objectif vous étant systématiquement communiqué). |
| Nous collectons certaines données lors de votre utilisation de nos services, automatiquement | Données Comportementales | Nous recueillons des informations relatives à votre utilisation nos services qui peuvent inclure votre **historique de programmes visionnés**, votre **historique de navigation** et votre **temps de présence** sur les différents contenus et rubriques de nos services. Lorsque ces informations sont recueillies au moyen de cookies et de technologies similaires (comme des identifiants mobiles publicitaires), l’onglet « Gestion des traceurs et des paramètres de confidentialité » de notre espace de confidentialité a vocation à s’appliquer à l’utilisation de ces technologies. |
| Données Techniques | Nous recueillons des données de nature technique lors de l'utilisation de nos services qui peuvent inclure :<br><br>* vos **identifiants** d'applications ou de terminaux (cookies et identifiants mobiles publicitaires notamment),<br>* des informations sur vos **URL de provenance**,<br>* votre **adresse IP**,<br>* les **caractéristiques des périphériques** que vous utilisez pour accéder à nos services (modèle de périphérique, type de système d'exploitation, type et version de navigateur, langue d'utilisation),<br>* **le type de connexion au réseau** que vous utilisez (Wi-Fi, 4G, Bluetooth ...),<br>* les **informations permettant la gestion des droits numériques**,<br>* la **version de votre application mobile**. |
| Nous pouvons recueillir des informations vous concernant auprès de tiers | **Données Tierces** | Nous sommes susceptibles de recueillir certaines données vous concernant auprès des sociétés tierces (telles que des annonceurs, des sociétés auprès desquelles vous avez acheté des produits ou des services ou des fournisseurs de données). De même, si vous vous inscrivez à nos services via Facebook nous recevrons, de manière automatique, **vos prénom et nom déclarés** ainsi que votre **photo de profil**. |

Pour quelles raisons traitez-vous mes données ? Sur quelles bases légales ?

| Raisons du traitement | Description | Base légale |
| --- | --- | --- |
| Pour gérer votre compte utilisateur et vous fournir nos services | Nous utilisons vos **Données de Compte** et vos **Données Comportementales** pour administrer votre compte utilisateur, vous permettre de vous y connecter, vous contacter occasionnellement avec des messages de service et pour vous fournir nos services de média audiovisuel à la demande et nos services de télévision. En particulier, nous utilisons vos **Données Comportementales** pour vous proposer de reprendre votre programme à l’endroit où vous l’avez arrêté, quelque-soit l’appareil auquel vous êtes connecté à votre compte utilisateur (**Reprise de Lecture**). L’exigence de fourniture des données nécessaires à la gestion de votre compte utilisateur et à la fourniture de nos services (votre adresse email et votre date de naissance) a un caractère contractuel. En cas de non fourniture de ces données, vous ne pourrez pas accéder à notre service. | L’exécution du contrat |
| Pour améliorer la qualité de nos services et en développer de nouveaux | Nous réalisons des statistiques d'audience globales et agrégées à partir de vos **Données de Compte**, de vos **Données de Service**, de vos **Données Comportementales** et de vos **Données Techniques** pour rendre nos services plus attractifs pour vous mais également pour l'ensemble de nos utilisateurs. Dans ce cadre, nous ne réalisons aucune évaluation, aucune prédiction et ne tirons aucune conclusion concernant un individu en particulier, notamment concernant ses centres d’intérêt.<br><br>Lorsque les informations permettant de mesurer l’audience sont recueillies au moyen de cookies et de technologies similaires (comme des identifiants mobiles publicitaires), l’onglet « Gestion des traceurs et des paramètres de confidentialité » de notre espace de confidentialité a vocation à s’appliquer à l’utilisation de ces technologies. | Notre intérêt légitime à améliorer la qualité de notre service |
...
Qui vous fournit des données me concernant ? Pour quelles raisons ?
...
Vous pouvez à tout moment retirer votre consentement à l’utilisation de traceurs en cliquant sur le lien suivant https://www.rtlplay.be/parametres-cookies.
