...
* [Page](https://meta.miraheze.org/wiki/Terms_of_Use "View the content page [c]")
* [Discussion](https://meta.miraheze.org/wiki/Talk:Terms_of_Use "Discussion about the content page [t]")

 English

* [Read](https://meta.miraheze.org/wiki/Terms_of_Use)
* [View source](https://meta.miraheze.org/wiki/Terms_of_Use?action=edit "This page is protected.
    You can view its source [e]")
* [View history](https://meta.miraheze.org/wiki/Terms_of_Use?action=history "Past revisions of this page [h]")
...
* [Read](https://meta.miraheze.org/wiki/Terms_of_Use)
* [View source](https://meta.miraheze.org/wiki/Terms_of_Use?action=edit)
* [View history](https://meta.miraheze.org/wiki/Terms_of_Use?action=history)
* [Purge](https://meta.miraheze.org/wiki/Terms_of_Use?action=purge)

General

* [What links here](https://meta.miraheze.org/wiki/Special:WhatLinksHere/Terms_of_Use "A list of all wiki pages that link here [j]")
...
* [中文](https://meta.miraheze.org/wiki/Terms_of_Use/zh "使用条款 (88% translated)")
* [中文（中国大陆）](https://meta.miraheze.org/wiki/Terms_of_Use/zh-cn "使用条款 (36% translated)")
* [中文（简体）](https://meta.miraheze.org/wiki/Terms_of_Use/zh-hans "使用条款 (26% translated)")
* [中文（繁體）](https://meta.miraheze.org/wiki/Terms_of_Use/zh-hant "使用條款 (21% translated)")
...
By editing a wiki on Miraheze, you agree to the licensing terms displayed on that wiki at the time of the edit. By default, wikis have contents licensed under the Creative Commons Attribution-ShareAlike 4.0 License. Wiki owners can change this; see [Help:Changing your wiki license](https://meta.miraheze.org/wiki/Help:Changing_your_wiki_license "Help:Changing your wiki license"). Regardless of chosen license, by editing a wiki on Miraheze or hosting your wiki on Miraheze, you agree to grant Miraheze a limited, worldwide license to redistribute the contents of your contributions. However, Miraheze will respect the privacy of private wikis by not disclosing content to anyone except the wiki's authorized users and authorized personnel per our [Privacy Policy](https://meta.miraheze.org/wiki/Privacy_Policy "Privacy Policy").

By requesting and using a wiki provided by Miraheze, you agree to abide by US and international copyright laws, and to follow the [Copyright Policy](https://meta.miraheze.org/wiki/Copyright_Policy "Copyright Policy"). This applies equally to private and public Wikis.

In the event unauthorized copyrighted material is found on a wiki, you may report the contents to us via ts![@](https://upload.wikimedia.org/wikipedia/commons/8/88/At_sign.svg)miraheze.org. Miraheze will act in accordance with its Copyright Policy.
...
All wiki contents shall comply with the [Content Policy](https://meta.miraheze.org/wiki/Special:MyLanguage/Content_Policy "Special:MyLanguage/Content Policy"). Wikis that repeatedly violate this policy are subject to suspension, removal, and/or deletion by Miraheze.
...
By participating on Miraheze or in Miraheze-branded venues in any capacity you agree to abide by the [Global Conduct Policy](https://meta.miraheze.org/wiki/Global_Conduct_Policy "Global Conduct Policy") and other conduct policies enacted by the community.
