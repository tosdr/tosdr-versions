...
Our services are compliant with the [General Data Protection Regulation (GDPR)](https://en.wikipedia.org/wiki/General_Data_Protection_Regulation) European Union Regulation and [California Consumer Privacy Act (CCPA)](https://en.wikipedia.org/wiki/California_Consumer_Privacy_Act).
...
If you purchase the App directly through us and our payment processor ([Paddle](https://www.paddle.com/)), we and Paddle may store your personal information, namely email addresses, names and addresses for licensing management and troubleshooting purposes whenever you communicate with our support team.

If you purchase the App through other stores, including but not limited to [App Store](https://support.apple.com/apps), [Microsoft Store](https://www.microsoft.com/en-us/store/apps/windows), [Snap Store](https://snapcraft.io/store), your personal information is not shared with us and is subjected to the privacy policies of these stores.
...
WebCatalog's websites use cookies to personalize your experience on our sites. Cookies tell us which parts of our websites people have visited, help us measure the performance of ads, and give us insights into user behavior so we can improve our communications and products.
...
For further information on Google Analytics please refer to: [\[1\]](https://www.google.com/analytics/terms), [\[2\]](https://support.google.com/analytics/answer/6004245?hl=en) and [\[3\]](https://policies.google.com/privacy?hl=en&gl=en).

3.3. Deactivation of Cookies and Tools
--------------------------------------
...
[Desktop](https://webcatalog.io/en/desktop/)
