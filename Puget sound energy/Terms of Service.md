...
[Storm alert Updated Nov 05, 12:00 PM](#collapseOne)  

November Wind Storm
-------------------

The Nov. 4 damaging winds caused outages around our service area, with Island, Whatcom, and Skagit counties in the north and Thurston County in the south being most impacted.

Our crews have restored power to 99% of affected customers with over 150,000 customers being impacted throughout the course of this storm.

Calmer weather is expected for the rest of the day and crews will continue work until all customers are restored. As crews finish work in one area, they are assigned to repair damage in another.
...
If you have any question regarding the Services, please direct such questions to: [customercare@pse.com](mailto:customercare@pse.com).

#### Privacy Policy

Please refer to our [privacy policy](https://www.pse.com/en/pages/privacy) for information on how the company uses, collects, and shares information about you.
...
#### Text (SMS) Terms of Service Twilio Short Codes

When you opt-in to the service, we will send you a message to confirm your signup. **Message and data rates may apply. Number of texts each month will vary based on selected notifications.** Text "HELP" for help. Text "STOP" to cancel.

You can cancel this service at any time. Just reply to any text with STOP. After you send the message "STOP" to us, we will send you a reply message to confirm that you have been unsubscribed. After this, you will no longer receive messages from us. If you want to join again, just sign up as you did the first time and we will start sending messages to you again.

If at any time you forget what keywords are supported, reply to any text with "HELP“. After you send the message "HELP" to us, we will respond with instructions on how to use our service as well as how to unsubscribe.

**PSE notifications available for text (SMS):** Bill Notifications, Bill Due Reminders, Outage, and Accounts & Services notices.
...
For all questions about the services provided by this short code, you can respond to any text with HELP or call PSE at 1-888-225-5773.

If you have any questions regarding privacy, please read the PSE privacy policy and the Twilio [privacy policy](https://shortcodehelp.appspot.com/123456-US-Twilio/privacy "Twilio privacy policy").
