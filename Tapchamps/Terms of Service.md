...
Unless otherwise stated, we or our licensors own the intellectual property rights in the Site and material on the Site, including, without limitation, text, graphics, logos, button icons, images, audio clips and software. Subject to the licence below, all these intellectual property rights are reserved.

You are granted a limited licence solely to view, download for caching purposes only, and print pages from the Site for your own personal use, subject to the restrictions set out below and elsewhere in these terms of use.

You must not reproduce, duplicate, copy or otherwise exploit material on the Site for a commercial purpose that is not expressly permitted by us.
...
Only one User account is allowed per User. It is strictly forbidden to transfer or sell a User account to third parties. 

By using the Site, you warrant and represent that 

* all information you submit to the Site are accurate
* you will keep the accuracy of all such information
* You will not use a virtual private network (“VPN”), proxy or any other means to hide the real source of traffic
* you are not accessing the application through any kind of emulator 
* you are not using any autoclicker, web robot (“Bot”) or similar software that allows you to manipulate data relating to your phone's input, or that fakes phone usage, or that makes automated views, clicks or conversions.
* You are not using any software that can unlock in-game content for free or that can change the game play in any way.
* You will not access the Site through any device other than an Android mobile phone or tablet.
* You will not use disposable email addresses enabling you to automatically open verification links nor forward messages to alternate addresses.
* You are not using a rooted device or any device for which you have been granted privileged control. 
* You are not attempting to fraudulently earn rewards through any means other than playing games.
* You will be completely responsible for any use of your Account by you and anyone other than you. 

Your account may be indefinitely suspended without any warning if we believe that you infringe any of these Terms. Tapchamps reserves the right to nullify all rewards earned and to disable the redemption of rewards on any account that has been suspended, regardless of the reason of the suspension.

You will receive a notification to enable the "Display over Other Apps" setting. Allowing it will help us better suggest to you games you may like. 
...
You must not use the Site in any way, either knowingly or recklessly, that causes, or may cause, damage to the Site or impairment of the availability or accessibility of the Site; or in any way which is unlawful, illegal, fraudulent or harmful, or in connection with any unlawful, illegal, fraudulent or harmful purpose or activity.

You must not use the Site to copy, store, host, transmit, send, use, publish or distribute any material which consists of (or is linked to) any spyware, computer virus, Trojan horse, worm, keystroke logger, rootkit, logic bomb or other malicious or harmful computer software.
...
You may not be able to access certain areas of the Site which are restricted. We reserve the right to restrict access to other areas of the Site, or indeed the whole Site, at our discretion, including, without limitation, if we believe that particular conduct violates applicable law, is harmful to our interests or is in breach of these terms of use.

Confidentiality must be ensured at all times regarding the use of User ID and password. Credentials that are used to access restricted areas of the Site, content & services must be kept confidential.

You must notify Tapchamps in writing immediately if you become aware of any unauthorised use of your account or password.

You are responsible for any activity on the Site. If you fail to keep your password confidential you will be liable for any losses arising out of such a failure.

You must not use any other person's user ID and password to access the Site, unless you have that person's express permission to do so. We may disable your user ID and password at any time in our sole discretion with or without notice or explanation.
...
In these terms of use, "your content" means material (including, without limitation, text, images, audio material, video material and audio-visual material) that you submit to the Site, for whatever purpose.
...
Any content you upload to the Site will be considered non-confidential and non-proprietary, and we have the right to use, copy, distribute and disclose to third parties any such content for any purpose.
...
You must not submit any content to the Site that is or has ever been the subject of any threatened or actual legal proceedings or other similar complaint.

We reserve the right to edit or remove any material submitted to the Site, or stored on our servers, or hosted or published upon the Site.

The views expressed by other users on the Site do not represent our views or values.

Notwithstanding our rights under these terms of use in relation to your content, we do not undertake to monitor the submission of such content to, or the publication of such content on, the Site. We will not be responsible, or liable to any third party, for the content or accuracy of any content posted by you or any other user of the Site.
...
Except as expressly set out in these Terms of Use, all representations, warranties, terms and conditions whether express or implied in relation to the Site or the information contained herein are hereby excluded to the fullest extent permitted by law.

Due to the fact that we cannot guarantee that the Site will be fault free or that the information contained on the Site will be correct, we do not accept any liability for any loss or damage whatsoever arising out of or in connection with the Site or the contents thereof, whether under theories of contract, tort (including negligence), strict liability or otherwise.

Rewards earned may be redeemed ONLY in countries where related merchants are available. Tapchamps is not accountable for any reward that the user is unable to redeem due to their age or country of residence. Tapchamps is also not responsible for any lost or malfunctioning Rewards.
...
The Site may contain links to sites operated by third parties. Such links are provided for your convenience only. We have no control over these sites and we are not responsible for their availability or content. The inclusion on the Site of links to such other sites does not imply any endorsement of the material on such sites or any association with their operators. We will not be liable for any loss or damage that may arise from your use of them.
...
We may revise these terms of use and any documents referred to herein from time to time. Revised terms of use will apply to the use of the Site from the date of publication of the revised terms of use on the Site. The Site will specify the latest date on which the terms of use have been amended. Please check this page from time to time to take notice of any changes we have made, as they are binding on you if you continue to use the Site.
...
Subject to the first paragraph of Section 9, these terms of use, together with our privacy policy and DPA, constitute the entire agreement between you and us in relation to your use of the Site and supersede all previous agreements in respect of your use of the Site.
...
The full name of our company is Ad4Game Ireland Limited (all references to “we”, “us”, or “our” in these terms refer to Ad4Game).
...
You can contact us by email to [contact@tapchamps.com](mailto:contact@tapchamps.com)
