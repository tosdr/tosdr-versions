...
**JetBrains Software Product**. Any software product distributed or made available by JetBrains under the JetBrains Subscription Agreement or any other JetBrains Agreement, **excluding** third-party software. Any such third-party software is governed by its own terms and conditions and privacy policy.
...
**YouTube API Services.** We may display YouTube videos on the JetBrains Website using the API client. The API client uses [YouTube API Services](https://developers.google.com/youtube/terms/developer-policies#definition-youtube-api-services). By interacting with the video, you agree to [YouTube's Terms of Service](https://www.youtube.com/t/terms) and acknowledge [Google's Privacy Policy](https://www.google.com/policies/privacy). By interacting with the JetBrains Website, you acknowledge our Privacy Policy.
