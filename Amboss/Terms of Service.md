...
Commercial Register: AG Charlottenburg (Berlin), HRB 209607 B
...
**Welcome to** [**www.amboss.com**](https://www.amboss.com/) **(the “Website”). The following terms, policies and conditions (these “Terms”) represent the entire contract between you and AMBOSS with respect to the Website and the fee-based subscription therein. By entering the website and using the products, services, and other resources (the “Resources”) made available through** [](https://www.amboss.com/)**the website, you are agreeing to be bound by these Terms.  If you do not agree to the terms, policies and conditions of these Terms, you may not use the Website or its Resources.**
...
**Access**: You may access the Website during the Term from multiple places, locations, and computers, but you are not allowed to access the Licensed Materials from more than one place, location, or computer at the same time. You are responsible for making all arrangements necessary for you to have access to the Website and ensuring that all persons who access the Website through your internet connection are aware of these Terms of Use and comply with them.
...
**Fee Increase:** AMBOSS reserves the right to increase fees for any services, upon thirty (30) days’ prior written notice, effective on the start date of your subsequent subscription term.
...
Payment: Payment will be made by the following [methods of payment](https://www.amboss.com/de/zahlungsmittel).
...
**The withdrawing period will expire after 14 days from the day of conclusion of the contract. To exercise the right of withdrawal, you must inform us (AMBOSS GmbH, Von-Werth-Straße 12, 50670 Köln, Germany, Fax: +49 30 5770221-99, E-Mail:** [**info@amboss.com**](mailto:info@amboss.com)**) of your decision to withdraw from this contract by an unequivocal statement (e.g. a letter sent by post, fax or e-mail). You may use this attached model withdrawal form (**[**withdrawal form download**](https://s3-eu-west-1.amazonaws.com/manus-assets-staging.amboss.com/2019/05/withdrawal-form-english.pdf)**), but it is not obligatory.**
...
If you wish to make any use of material on the Website other than that set out in this section, please address your request to: info@amboss.com
...
**Disclaimer:** The contents of this website have been prepared with the utmost care. However, AMBOSS GmbH cannot guarantee that the information provided is complete, accurate, and up-to-date. The use of contents on the website is at the user’s own risk. The use of the AMBOSS GmbH website without registration shall not constitute a contractual relationship between the user and the provider. The provided contents and information are academic in nature and shall serve for information and study purposes only. AMBOSS GmbH does not make diagnoses and expressly does not give advice or recommendations regarding the treatment of specific individual cases of disease. The service is not suited for consultation in the treatment of specific individual cases of disease and shall not under any circumstance substitute for a visit to a health care professional. AMBOSS GmbH shall not assume liability for procedure, treatment, or dosage information. Any procedure, treatment, or dosage applied by the user is at the user’s own risk. The correctness of information regarding procedures, treatments, and dosages must be verified by the user on a case-by-case basis using the appropriate resources (manufacturer information, package inserts, etc.). Unless explicitly stated otherwise, treatment recommendations and dosages refer to adults. While the expert information made available by AMBOSS GmbH has been compiled by medical experts, it shall not be regarded as a substitute for a personal and professional consultation and treatment by a trained and certified specialist.

  
The Resources are intended for physicians, other healthcare professionals, and medical students. By using the Resources, you represent and warrant that you have the right, authority, and capacity to agree to and abide by these terms, policies and conditions, and that you are not prohibited from using the Resources or any portion thereof.
...
**  
Privacy**:  These Terms incorporate the entirety of our Privacy Policy, found at [**https://www.amboss.com/us/privacy**](https://www.amboss.com/us/privacy).
