...
* [**_How do we use Customer Personal Information?_**](#3)
* [**_How do we use Candidate Personal Information?_**](#4)
* [**_Do we disclose any Personal Information to outside parties?_**](#5)
* [**_What choices do you have about your Personal Information?_**](#6)
* [**_Location of our Site_**](#7)
* [**_How long do we retain your Personal Information?_**](#8)
* [**_Third party links_**](#9)
* [**_How do we protect your information?_**](#10)
* [**_Your California privacy rights_**](#11)
* [**_European residents_**](#12)
* [**_Do we collect Personal Information from children?_**](#13)
* [**_Contacting us_**](#14)
* [**_Changes to our Privacy Policy_**](#15)

How do we collect Candidate and Customer Personal Information?
--------------------------------------------------------------

Yello collects Personal Information relating to Candidates and Customers’ use of the Site and Apps in the following ways:
...
* **Through Analytics**. We use analytics services, including Google **Analytics 4**, to assist us with analyzing our website traffic through cookies and similar technologies.  To learn more about how Google Analytics 4 uses data, visit Google’s Privacy Policy and Google’s page on “How Google uses data when you use our partners’ sites or apps.” You may download the Google Analytics 4 Opt-out Browser Add-on for each web browser you use, but this does not prevent the use of other analytics tools. To learn more about Google Analytics 4 cookies, visit Google Analytics Cookie Usage on Websites.
...
We may collect a range of Personal Information. “Personal Information” means information that uniquely identifies, relates to, describes, or is reasonably capable of being associated with or linked to you. We collect Candidate Personal Information when Candidates register on the Site and enter their Personal Information and/or upload their resume. We may collect sensitive Personal Information of Candidates such as ethnic origin, race, religion, and gender. Our Customers and sourcing partners may also transfer Candidate Personal Information to us to enable us to share such Personal Information with our other Customers for recruitment and hiring purposes. Our sourcing partners may collect and share Personal Information, including sensitive Personal Information of Candidates such as ethnic origin, race, religion, and gender.

### Employment Information

If you apply for employment with us or through us, we will collect your employment and work history, as well as other Personal Information related to your potential employment. This may include your education and employment history, address and contact information, demographic information, and any other information included in your resume or application. We may also collect your account information, such as your username and password when submitting your resume or application.

### Communication Information

We may also collect audio, electronic, or visual information, which includes any data in files uploaded, emailed or otherwise provided by users, the contents of your communications with us, whether via email, social media, telephone or otherwise, and inferences we may make from other Personal Information we collect.

### Location Data

While navigating our Site, your mobile device or browser may share your location data, both through WiFi and GPS. We will collect this information based on the settings of your phone and browser. You may opt-out of having your location data collected by Yello at any time by editing the appropriate setting on your mobile device (which is usually located in the settings of your device).

### Customer Personal Information

Through the Site and Apps, we automatically gather certain information about the use of the Site and Apps, such as how frequently certain areas of the Site or Apps are visited or interacted with, and the date and time of Site or Mobile App visits, IP addresses and browser information, including through the use of cookies, web beacons, pixels, and other technologies. Through use of the Site and/or Apps, we may also collect Personal Information directly from Yello Customers who provide their Personal Information to Yello for marketing purposes. If our Customers utilize Yello owned devices in connection with the Apps or the Site, we may track such iPads or tablets, and you, as a U.S. based Customer, consent to us tracking such iPads or tablets using Global Positioning System (GPS) technology that is installed and active on such device(s). Such tracking will be utilized for the following purposes: (i) locating device(s) in the event that they are lost or stolen; and/or (ii) locating devices(s) in an anonymized fashion for use on a device heat-map to be used for internal and external marketing purposes and which constitutes a map of broad-scale user activity across the globe. Such GPS tracking will not involve any access to your Personal Information nor will it involve the tracking of your activity or behavior on such device(s). If you object to such tracking, please promptly contact us via email at [privacy@yello.co](mailto:privacy@yello.co).
...
We may disclose Personal Information (i) if we are required to do so by law, legal process, statute, rule, regulation, or professional standard, or to respond to a subpoena, search warrant, or other government official requests, (ii) when we believe disclosure is necessary or appropriate to prevent physical harm or financial loss, (iii) in connection with an investigation of a complaint, detect, prevent, or otherwise respond to fraud, security threat or technical concerns, or suspected or actual illegal activity; (iv) in connection with an internal audit; or (v) in the event that Yello is subject to  mergers, acquisitions, joint ventures, sales of assets, reorganizations, divestitures, dissolutions, bankruptcies, liquidations, or other types of business transactions. In these types of transactions, Personal Information may be shared, sold, or transferred, and it may be used subsequently by a third party.

What choices do you have about your Personal Information?
---------------------------------------------------------

We offer certain choices about how we communicate with you and what Personal Information we obtain about you, use, and share with others.
...
If you no longer wish to receive promotional or informational emails from us, you may opt-out from receiving future emails from us by following the instructions for unsubscribing in the promotional or informational emails we send you or by contacting us at [privacy@yello.co](mailto:privacy@yello.co). This opt-out does not apply to information provided to us as a result of product service experience requests.
...
| --- | --- | --- | --- | --- | --- | --- |
| **Identifiers** | Yes | Directly from you | See section above titled “How do we use Customer Personal Information?” | Service Providers | We do not sell or share this category of Personal Information | 1 year |
| **Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e))** | Yes | Directly from you | See section above titled “How do we use Customer Personal Information?” | Service Providers | We do not sell or share this category of Personal Information | 1 year |
| **Protected classification characteristics under California or federal law** | No  | N/A | N/A | N/A | N/A | N/A |
| **Commercial information** | No  | N/A | N/A | N/A | N/A | N/A |
| **Biometric information** | No  | N/A | N/A | N/A | N/A | N/A |
| **Internet or other similar network activity** | Yes | Cookies and other tracking technologies | See section above titled “How do we use Customer Personal Information?” | Service Providers | We do not sell or share this category of Personal Information | 1 year |
| **Geolocation data** | Yes | Cookies and other tracking technologies | See section above titled “How do we use Customer Personal Information?” | Service Providers | We do not sell or share this category of Personal Information | 1 year |
| **Sensory data** | No  | N/A | N/A | N/A | N/A | N/A |
...
| **Sensitive Personal Information** | No  | N/A | N/A | N/A | N/A | N/A |
...
| **Automated Decision Making** | You have the right to request information about the logic involved in automated decision-making and a description of the likely outcome of processes, and the right to opt out. Yello does not currently engage in any automated decision making practices. |
...
We do not solicit or knowingly collect any Personal Information from children under the age of 16. If a Customer or Candidate is not 16 or older, he or she must not use the Site or Apps. Parents should be aware there are parental control tools available online that can be used to prevent children from submitting information online without parental permission or from accessing material that is harmful to minors. If we learn we have collected or received Personal Information from a child under 16 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 16, please contact us at [privacy@yello.co](mailto:privacy@yello.co).
...
Privacy laws and guidelines are part of a constantly changing environment. We reserve the right, at our discretion, to change, modify, add, or remove portions of this Privacy Policy at any time. Customers and Candidates are responsible for reviewing this Privacy Policy periodically to ensure that they are aware of our current privacy practices, although we may also elect to notify Customers’ Authorized Users of material changes to our Privacy Policy, by posting a pop-up banner on the Yello Enterprise Customer-facing Site. Your continued use of the Site or Apps following any changes signifies your consent to and acceptance of the then-current Privacy Policy as posted for all data previously collected. If a Customer or Candidate does not consent to the changes to the Privacy Policy, he or she must immediately discontinue access to or use of the Site or the Apps, and may reach out to us at [privacy@yello.co](mailto:privacy@yello.co) to object and/or to obtain for more information.

[View Cookie Policy](https://yello.co/cookie-policy/)
