...
Your privacy is important to us, so KillerRoi, has created the following Privacy Policy ("[Policy](https://35.154.145.86/privacy-policy/)") to let you know what information we collect when you visit our Site https://35.154.145.86 ("[Site](https://35.154.145.86/)"), why we collect it and how we use it.  The terms "You," "Your," "Yours" and "User" refer to the entity/person/organization using our Site. When this Policy mentions "We", "Us," and "Our" it refers to KillerRoi and its subsidiaries and affiliates. 

For any questions regarding this Policy or any requests regarding the processing of personal data, please contact us at [killerroi@pm.me](mailto:killerroi@pm.me).

1\. INFORMATION WE COLLECT FROM YOU
-----------------------------------

* We collect the information You provide to us and this information is necessary for the adequate performance of the contractual arrangement which is in place between You and us and allow us to comply with our legal obligations. – Account Signup Information. When You create the account, we ask You to provide the signup information, such as Email, Name, Surname, Phone, Personal Number, Address. – Payment Information. To order and use features of Site, we may require you to provide certain financial information in order to facilitate the processing of payments.
* We never collect your Credit or debit card number, Credit or debit card type, Credit or debit card expiration date, we collect Billing address, Name and surname. – Other Personal Information Provided by You. Our Payment Gateway Provider “[RazorPay](http://razorpay.com/)” (You Can Read Their [“Privacy Policy”](https://razorpay.com/privacy/) & [“Terms of Use”](https://razorpay.com/terms/)) may collect Credit or debit card number, Credit or debit card type, Credit or debit card expiration date for the purpose of making sure that you’re the actual person who owns the payment method and are allowed to transact on this website using the said payment method.
* We may collect other data provided by You from surveys, feedback, financial information (purchase history), Steam Identification Number and other similar data.
...
We may share your information with third parties that we use to provide and support our Services:
 - Invoicing and Billing company - PayPal
 - Invoicing and Billing company - Stripe
 - Other - RazorPay
...
Please check our \[[Cookie Policy](https://35.154.145.86/cookie-policy/)) to find more information about cookies we use.
...
If you have any questions regarding the security of our Site or Services, you are welcome to contact us at [killerroi@pm.me](mailto:killerroi@pm.me).
