...
* [About Read the Docs](https://docs.readthedocs.io/en/stable/about/index.html)
    * [Policies and legal documents](https://docs.readthedocs.io/en/stable/reference/policies.html)
        ...
        * [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html)
        ...
        * [Read the Docs Terms of Service](#)
            ...
            * [API terms](#api-terms)
            * [Additional terms for Documentation Sites](#additional-terms-for-documentation-sites)
            * [Third party applications](#third-party-applications)
            * [Advertising on Documentation Sites](#advertising-on-documentation-sites)
            * [Payment](#payment)
            * [Cancellation and termination](#cancellation-and-termination)
            * [Communications with Read the Docs](#communications-with-read-the-docs)
...
* [Policies and legal documents](https://docs.readthedocs.io/en/stable/reference/policies.html)
* Read the Docs Terms of Service
* [Edit on GitHub](https://github.com/readthedocs/readthedocs.org/blob/d3606da9907bb4cd933abcf71c7bab9eb20435cd/docs/user/terms-of-service.rst)

* * *

Read the Docs Terms of Service[](#read-the-docs-terms-of-service "Link to this heading")
=========================================================================================
...
1. The “Agreement” refers, collectively, to all the terms, conditions, notices contained or referenced in this document (the “Terms of Service” or the “Terms”) and all other operating rules, policies (including our [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html)) and procedures that we may publish from time to time on our sites.
    
2. Our “Service” or “Services” refers to the applications, software, products, and services provided by Read the Docs (see [Our services](#our-services)).
...
These Websites are where Read the Docs hosts [User-Generated Content](#user-generated-content) on behalf of documentation authors.

Account terms[](#account-terms "Link to this heading")
-------------------------------------------------------
...
### Account controls[](#account-controls "Link to this heading")
...
### Required information[](#required-information "Link to this heading")
...
### Account requirements[](#account-requirements "Link to this heading")
...
* You will promptly [notify Read the Docs](https://docs.readthedocs.io/en/stable/security.html) if you become aware of any unauthorized use of, or access to, our Services through your Account, including any unauthorized use of your password or Account.
    

### Additional terms[](#additional-terms "Link to this heading")
...
Acceptable use[](#acceptable-use "Link to this heading")
---------------------------------------------------------

**Short version:** _Read the Docs hosts a wide variety of collaborative projects from all over the world, and that collaboration only works when our users are able to work together in good faith. While using the service, you must follow the terms of this section, which include some restrictions on content you can post, conduct on the service, and other limitations. In short, be excellent to each other._

Your use of our Websites and Services must not violate any applicable laws, including copyright or trademark laws, export control or sanctions laws, or other laws in your jurisdiction. You are responsible for making sure that your use of the Service is in compliance with laws and any applicable regulations.

User-Generated Content[](#user-generated-content "Link to this heading")
-------------------------------------------------------------------------

**Short version:** _You own content you create, but you allow us certain rights to it, so that we can display and share the content and documentation you post. You still have control over your content, and responsibility for it, and the rights you grant us are limited to those we need to provide the service. We have the right to remove content or close Accounts if we need to._

### Responsibility for User-Generated Content[](#responsibility-for-user-generated-content "Link to this heading")

You may create or upload User-Generated Content while using the Service. You are solely responsible for the content of, and for any harm resulting from, any User-Generated Content that you post, upload, link to or otherwise make available via the Service, regardless of the form of that Content. We are not responsible for any public display or misuse of your User-Generated Content.

### Read the Docs may remove Content[](#read-the-docs-may-remove-content "Link to this heading")
...
### License grant to other users[](#license-grant-to-other-users "Link to this heading")
...
Private projects[](#private-projects "Link to this heading")
-------------------------------------------------------------

**Short version:** _You may connect Read the Docs for Business to your private repositories or host documentation privately. We treat the content of these private projects as confidential, and we only access it for support reasons, with your consent, or if required to for security reasons._

### Confidentiality of private projects[](#confidentiality-of-private-projects "Link to this heading")
...
### Exclusions[](#exclusions "Link to this heading")

If we have reason to believe the contents of a private project are in violation of the law or of these Terms, we have the right to access, review, and remove them. Additionally, we may be [compelled by law](https://docs.readthedocs.io/en/stable/privacy-policy.html#how-we-respond-to-compelled-disclosure) to disclose the contents of your private projects.

Copyright infringement and DMCA policy[](#copyright-infringement-and-dmca-policy "Link to this heading")
---------------------------------------------------------------------------------------------------------

If you believe that content on our website violates your copyright or other rights, please contact us in accordance with our [Digital Millennium Copyright Act Policy](https://docs.readthedocs.io/en/stable/dmca/index.html). There may be legal consequences for sending a false or frivolous takedown notice. Before sending a takedown request, you must consider legal uses such as fair use and licensed uses.

We will terminate the Accounts of repeat infringers of this policy.

Intellectual property notice[](#intellectual-property-notice "Link to this heading")
-------------------------------------------------------------------------------------
...
### Read the Docs’ rights to content[](#read-the-docs-rights-to-content "Link to this heading")
...
**Short version:** _You agree to these Terms of Service, plus this Section, when using any of Read the Docs’ APIs (Application Provider Interface), including use of the API through a third party product that accesses Read the Docs._

### No abuse or overuse of the API[](#no-abuse-or-overuse-of-the-api "Link to this heading")
...
All use of the Read the Docs API is subject to these Terms of Service and our [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html).
...
Additional terms for Documentation Sites[](#additional-terms-for-documentation-sites "Link to this heading")
-------------------------------------------------------------------------------------------------------------

**Short version:** _Documentation Sites on Read the Docs are subject to certain rules, in addition to the rest of the Terms._

### Documentation Sites[](#documentation-sites "Link to this heading")
...
Third party applications[](#third-party-applications "Link to this heading")
-----------------------------------------------------------------------------

**Short version:** _You need to follow certain rules if you create an application for other Users._

### Creating applications[](#creating-applications "Link to this heading")
...
* You must comply with this Agreement and our [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html).
...
Advertising on Documentation Sites[](#advertising-on-documentation-sites "Link to this heading")
-------------------------------------------------------------------------------------------------

**Short version:** _We do not generally prohibit use of Documentation Sites for advertising. However, we expect our users to follow certain limitations, so Read the Docs does not become a spam haven. No one wants that._

### Our advertising[](#our-advertising "Link to this heading")

We host advertising on Documentation Sites on Read the Docs Community. This advertising is first-party advertising hosted by Read the Docs. We **do not** run any code from advertisers and all ad images are hosted on Read the Docs’ servers. For more details, see our document on [Advertising details](https://docs.readthedocs.io/en/stable/advertising/advertising-details.html).

### Acceptable advertising on Documentation Sites[](#acceptable-advertising-on-documentation-sites "Link to this heading")
...
### Spamming and inappropriate use of Read the Docs[](#spamming-and-inappropriate-use-of-read-the-docs "Link to this heading")
...
Payment[](#payment "Link to this heading")
-------------------------------------------

**Short version:** _You are responsible for any fees associated with your use of Read the Docs. We are responsible for communicating those fees to you clearly and accurately, and letting you know well in advance if those prices change._

### Pricing[](#pricing "Link to this heading")

Our pricing and payment terms are available at [https://readthedocs.com/pricing/](https://readthedocs.com/pricing/). If you agree to a subscription price, that will remain your price for the duration of the payment term; however, prices are subject to change at the end of a payment term.

### Upgrades, downgrades, and changes[](#upgrades-downgrades-and-changes "Link to this heading")
...
### Billing schedule; no refunds[](#billing-schedule-no-refunds "Link to this heading")
...
### Responsibility for payment[](#responsibility-for-payment "Link to this heading")

You are responsible for all fees, including taxes, associated with your use of the Service. By using the Service, you agree to pay Read the Docs any charge incurred in connection with your use of the Service. If you dispute the matter, [contact us](mailto:support%40readthedocs.org). You are responsible for providing us with a valid means of payment for paid Accounts. Free Accounts are not required to provide payment information.

Cancellation and termination[](#cancellation-and-termination "Link to this heading")
-------------------------------------------------------------------------------------

**Short version:** _You may close your Account at any time. If you do, we’ll treat your information responsibly._

### Account cancellation[](#account-cancellation "Link to this heading")
...
### Upon cancellation[](#upon-cancellation "Link to this heading")
...
### Read the Docs may terminate[](#read-the-docs-may-terminate "Link to this heading")
...
### Survival[](#survival "Link to this heading")
...
Communications with Read the Docs[](#communications-with-read-the-docs "Link to this heading")
-----------------------------------------------------------------------------------------------

**Short version:** _We use email and other electronic means to stay in touch with our users._

### Electronic communication required[](#electronic-communication-required "Link to this heading")
...
### Legal notice to Read the Docs must be in writing[](#legal-notice-to-read-the-docs-must-be-in-writing "Link to this heading")
...
### No phone support[](#no-phone-support "Link to this heading")
...
Disclaimer of warranties[](#disclaimer-of-warranties "Link to this heading")
-----------------------------------------------------------------------------
...
Limitation of liability[](#limitation-of-liability "Link to this heading")
---------------------------------------------------------------------------
...
Release and indemnification[](#release-and-indemnification "Link to this heading")
-----------------------------------------------------------------------------------
...
Changes to these terms[](#changes-to-these-terms "Link to this heading")
-------------------------------------------------------------------------
...
### Governing law[](#governing-law "Link to this heading")
...
### Non-assignability[](#non-assignability "Link to this heading")

Read the Docs may assign or delegate these Terms of Service and/or our [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html), in whole or in part, to any person or entity at any time with or without your consent, including the license grant in [License grant to us](#license-grant-to-us). You may not assign or delegate any rights or obligations under the Terms of Service or Privacy Policy without our prior written consent, and any unauthorized assignment and delegation by you is void.

### Section headings and summaries[](#section-headings-and-summaries "Link to this heading")

Throughout this Agreement, each section includes titles and brief summaries of the following terms and conditions. These section titles and brief summaries are not legally binding.

### Severability, no waiver, and survival[](#severability-no-waiver-and-survival "Link to this heading")
...
### Amendments; complete agreement[](#amendments-complete-agreement "Link to this heading")

This Agreement may only be modified by a written amendment signed by an authorized representative of Read the Docs, or by the posting by Read the Docs of a revised version in accordance with [Changes to these terms](#changes-to-these-terms). These Terms of Service, together with our [Privacy Policy](https://docs.readthedocs.io/en/stable/privacy-policy.html), represent the complete and exclusive statement of the agreement between you and us. This Agreement supersedes any proposal or prior agreement oral or written, and any other communications between you and Read the Docs relating to the subject matter of these terms including any confidentiality or nondisclosure agreements.

### Questions[](#questions "Link to this heading")

Questions about the Terms of Service? [Get in touch](mailto:support%40readthedocs.org).

[Previous](https://docs.readthedocs.io/en/stable/security.html "Security reports") [Next](https://docs.readthedocs.io/en/stable/dmca/index.html "DMCA takedown policy")
