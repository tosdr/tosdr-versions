[![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)](https://gamersafer.com/)

[**GAMERSAFER**](https://gamersafer.com/)

* [Home](https://gamersafer.com/)
* [GamerSafer for Esports](https://gamersafer.com/gamersafer-for-esports/)
* [GamerSafer for Multiplayer Games](https://gamersafer.com/gamersafer-for-multiplayer-games/)
* [GS Auth for Minecraft](https://minecraft.gamersafer.com/)
    * [GS For Parents and Kids](https://gamersafer.com/making-games-safer-and-more-fun-for-young-audiences/)
* [GS Defender for Discord](https://gamersafer.com/gs-defender/)
    * [GS Crosslink for Discord](https://gamersafer.com/crosslink/)
* [Resources](https://gamersafer.com/resources/)
* [Contact](https://gamersafer.com/contact/)
* [Blog](https://gamersafer.com/blog/)
* [Download our App!](https://gamersafer.app/)
...
**GamerSafer Privacy Policy**

**Effective date: March 30th, 2021**

**Updated: August 15th, 2022**

**GAMERSAFER INC. PRIVACY POLICY**
...
For purposes of the European General Data Protection Regulation (the “GDPR”), GamerSafer is the “data controller” of your personal information. Our data protection officer can be contacted at dpo@gamersafer.com 

This Privacy Policy applies whenever you use our “Services,” which means our mobile application (the “App”), our website, our plug-ins, our APIs, our bots, and all other content and related services (including online services) that we make available through our or third-party Apps, or on our or third-party websites, including but not limited to www.gamersafer.com and (collectively, the “Services”).  

We have prepared this Privacy Policy to help you as the user of the Services (“you” or “user”) understand how we collect, store, use, and manage information, including personal data, that you provide to us or we collect about you when you use the Service.  

  

When you use a Service, you consent to each of the collections, uses and disclosures of information (including recording and tracking) described in this Privacy Policy. Please read it carefully. **IF YOU DO NOT AGREE TO THIS PRIVACY POLICY, PLEASE DO NOT USE ANY SERVICE.**  
...
* Privacy policies of our bots 
* Security of your information  
* International transfers of your personal information  
* Changes to our privacy policy  
* Contact us  

If you have questions regarding this Privacy Policy or our collection and use of personal information, please contact us as described in the Section “Contact Us”.  
...
In general, we collect, store and use your information to provide you with a safe, smooth, efficient, fun, and customized experience, and we use it as necessary to provide you with the Service pursuant to the Terms of Use, for our legitimate interest to understand how our users navigate our website and App and to improve our Services, or on the basis of your consent. In litigation or for other legal purposes involving us or a third party, we may also need to transfer your personal information to countries with a lower standard of data protection laws than is applicable in your country of residence. We 
...
Based on user location and data of birth our registration system will redirect children to a dedicated user registration flow where the parent or legal responsible will be invited to join the account creation and be guided about our services, the data collected, the terms of service, the privacy policy and to provide consent to create the account for the children.  
...
2.     Parents can contact us to request access to, change, or delete their child’s personal information by sending an email to us at support@gamersafer.com. A valid request to delete personal information will be accommodated within a reasonable time.  
...
If you no longer want GamerSafer to make active use of your information, you can delete your account from the App (there is this option inside Account menu), you may alternatively send an e-mail to support@gamersafer.com . Place “Delete My Account” in the subject line and include your first name, last name, e-mail address and username from which you access our Services in the body of the e-mail. If you do so, you will no longer have access to the App or Services associated with your account. 
...
•  If you wish to review, change or correct the information we have about you, e-mail us at privacy@gamersafer.com.  
...
In the event that you wish to make a complaint about how we process your personal data, please contact us in the first instance at support@gamersafer.com and we will endeavor to deal with your request. This is without prejudice to your right to launch a claim with the data protection supervisory authority in the EU country in which you live or work where you think we have infringed data protection laws.  
...
Exercising your rights. You may exercise your California privacy rights described above by emailing us at support@gamersafer.com, or by contacting us via the “Contact Us” link on our website or in our App.  
...
**11\. PRIVACY POLICIES OF OUR BOTS**

Our Services may contain the use of bots and 3rd party applications with specific data collection and privacy concerns. 

**(a) GS CrossLink**  

GS CrossLink is a Service to identify and block malicious hyperlinks or attachments into online platforms wrapped as a bot (i.e. Discord bot) and/or API based Service. This Service collects for various reasons non PII information. 

(i) Analytics Data 

GS Crosslink will collect the following information for analytics events: 

● Resolvable links sent in the platform: This data includes the non-PII user ID for the sender of the link, the non-PII server ID for the platform and the resolved link object; A link object contains the domain of the link, the data generated by GS Crosslink about the link (safety, status, flags etc.) and the target URL; All events of this format logged are resolved first, eliminating the potential for personally identifiable short links from being collected & stored; Query string parameters will also be stripped from the target URL in the link object.  

● Platform server where GS Crosslink is added to and removed from: This data only contains the platform server ID. 

Analytics data is stored indefinitely & encrypted at rest. If you wish for all analytics data from your platform server to be completely anonymized or removed, please reach out to support@gamersafer.com with a relevant data removal request. We currently do not support do-not-track status on a per-server or per-user basis, so if you wish for no more data to be collected you must remove GS Crosslink from your platform. 

(ii) Link Data  

Links sent in the platform and detected by GS Crosslink will have several operations performed on them which extract various elements of data. Links will be resolved meaning a full redirect chain will be retained by GS Crosslink. DNS lookups will be performed on links meaning all DNS data will be collected but not retained by GS Crosslink. This data includes MX servers & other records. DNS data is considered public information, so it is freely collected without restrictions. WHOIS & RDAP records may be collected by GS Crosslink on domains it sees during operation. These records are not retained and contact information is discarded. This data is collected to help GS Crosslink build a profile of links it detects, and none is preserved in data later stored by GS Crosslink.  

(iii) Discord Event Data  

When working with Discord, GS Crosslink is required to collect certain event data from Discord for core functionality. This includes GS Crosslink’s commands run by end users & messages sent by end users. Currently no other events are tracked by GS Crosslink. GS Crosslink does not store full message content, it only retains links detected within message content/embeds and links to attachments sent within messages. Attachments sent in Discord are covered by Discord’s own Data policy, and will have all associated data removed once the attachment is removed from Discord’s CDN. Message content may be sent via a Discord message from the GS Crosslink bot to logs on a per-server/guild basis as configured by the relevant server’s staff. This logging only occurs when GS Crosslink detects a link type that has been configured to be logged in a message.  

(iv) 3rd Party Data  

GS Crosslink collects public data on links & domains from 3rd party providers  

**12. SECURITY OF YOUR INFORMATION**

We implement reasonable security measures to protect the security of your information both online and offline, and we are committed to the protection of customer information. While we take reasonable precautions against possible security breaches of our Services and our customer databases and records, we cannot guarantee that unauthorized access, hacking, data loss, or other breaches will never occur. Unfortunately, the transmission of information over the Internet is not completely secure. Although we strive to protect your personal data, we cannot guarantee the security of your data while it is being transmitted to our site; any transmission is at your own risk. Once we have received your information, we have procedures and security features in place to try to prevent unauthorized access. We urge you to take steps to keep your personal information safe (including your account username and password), and to log out of your account after use. If your account is hacked, this may lead to unauthorized access to our Services, so be careful to keep your account information secure. If you have questions about the security of our Services, please contact us at support@gamersafer.com.  

**13\. INTERNATIONAL TRANSFERS OF YOUR PERSONAL INFORMATION**

As you are contracting for the Services with GamerSafer, which is a US company, any information you provide to us, or that we collect through your use of the Services that is necessary to provide you the Services, will be stored, processed, and transferred within, or to, the United States. As a result, your information could be accessed by foreign governmental authorities, or otherwise, in accordance with applicable local laws. Please be aware that the US and jurisdictions other than the one in which you are located will not have the same data protection laws as your own jurisdiction. Your personal data is also processed by staff or service providers operating outside the EEA in the United States, who work for us. If we transfer your information outside of your country of residence, we will protect that information as described in this Privacy Policy. 

**14\. CHANGES TO OUR PRIVACY POLICY**

If we decide to make material changes to our Privacy Policy, we will notify you and other users by placing a notice on www.gamersafer.com or by sending you a notice to the e-mail address we have on file for you. We may supplement this process by placing notices in our Services and on other GamerSafer websites. It is your responsibility to periodically check this privacy page for updates. 

**15\. CONTACT US**

If you have any questions, comments or concerns regarding our Privacy Policy and/or practices, please send an e-mail to support@gamersafer.com.  We will seek to respond to any complaints within thirty (30) Days.  

**REGION-SPECIFIC ADDENDUM TO PRIVACY POLICY:**

The following additional information applies, and supplements the above Privacy Policy, if your personal information is collected from one of the countries below:  

Australia: You can opt out of receiving commercial electronic messages (such as emails) from us at any time by contacting support@gamersafer.com. Your consent to disclosure outside Australia under this policy means that we will not be accountable to you under the Privacy Act for acts and practices of recipients outside Australia.  

Canada: Personal information maintained and processed by us and third-party service providers in the U.S. and other foreign jurisdictions may be subject to disclosure pursuant to a lawful access request by U.S. or foreign courts or government authorities. We will not provide your information to third parties for marketing purposes without your prior consent. For more information about our privacy practices; to access, update or correct inaccuracies in your personal information; or if you have a question or complaint about the manner in which we or our service providers treat your personal information, please contact support@gamersafer.com.  

[Terms of Service](https://gamersafer.com/tos) – [Privacy Policy](https://gamersafer.com/privacy-policy)

© 2019-2023, GAMERSAFER, Inc. All rights reserved. GAMERSAFER trademarks are registered in the US.

We use cookies to allow us to better understand how the site is used. By continuing to use this site, you consent to this policy. [Click to learn more](https://gamersafer.com/privacy-policy/)