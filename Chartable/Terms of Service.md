...
Welcome to Chartable. By accessing the Chartable website ("Site") or using the services offered by Chartable ("Services") you agree and acknowledge to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms or to our Privacy Policy, please do not access the Site or use the Services. Chartable reserves the right to change these Terms at any time. We recommend that you periodically check this Site for changes.
...
We have the right to disable any user name, password or other identifier, whether chosen by you or provided by us, at any time in our sole discretion for any or no reason, including if, in our opinion, you have violated any provision of these Terms. You can always delete your Account by emailing us at [\[email protected\]](https://chartable.com/cdn-cgi/l/email-protection).

Payment Terms

All invoices are payable by you to Chartable net thirty (30) days from the invoice date. All amounts owed by you to Chartable for the Services (“Service Fees”) are in U.S. Dollars. Past due amounts shall bear a late payment charge, until paid, at the rate of 1.5% per month or the maximum amount permitted by law, whichever is higher. To the fullest extent permitted by applicable law, all Service Fees paid hereunder are non-refundable. To the extent Chartable requires payment via credit card for any Services, you hereby authorize Chartable to charge such credit card on the above basis for amounts due. You agree to maintain its credit card in an active status, and/or provide updated credit card and billing information to Chartable to allow for the payments. You agree to pay for all charges for Services if charges made to your credit card are unsuccessful for any reason. Chartable currently uses a third party payment processor to process credit card payments. The processing of credit card payment will be subject to the third party processor’s privacy policy.
...
* Use other customers' personal data for purposes other than establishing contact that is reasonably expected to be welcomed by such other customers.
...
* Submit materials of any third party without such third party's prior written consent, or materials that falsely express or imply that such materials are sponsored or endorsed by Chartable.
* Create a false or misleading identity of, including, but not limited to, a Chartable employee, or falsely state or otherwise misrepresent your affiliation with a person or entity, for the purpose of misleading others as to the identity of the sender or the origin of a message or to harvest or otherwise collect information about others.
...
* Modify, adapt, translate, or reverse engineer any portion of the Site, or use any robot, spider, site search/retrieval application, or other device to retrieve or index any portion or the Site.
...
* Interfere with another customer's use and enjoyment of the Site.
* Harvest or collect email addresses or other contact information of customers, including usernames, from the Site by electronic or other means.
...
By linking a feed to your account or giving us any information about accounts on other websites, you represent that you have the right to permit us to reproduce this content on the Chartable website and that the content is not obscene or illegal. You also agree that you have a lawful basis for collecting any personal data and that if you are using hosting services, the hosting services include a privacy policy that describes the lawful basis for the collection of any personal information.
...
The data protection terms set forth at [https://chartable.com/dpa](https://chartable.com/dpa) shall be incorporated by reference. Such data protection terms will supersede any previously entered data protection terms or similar documents between the parties.
...
These Terms are governed by the laws of the State of New York without reference to conflict of laws principles. The parties agree to submit to the federal or state courts in New York for exclusive jurisdiction of any dispute arising out of or related to your use of the Services or your breach of these Terms. Any notices must be sent to Chartable in English at [\[email protected\]](https://chartable.com/cdn-cgi/l/email-protection).

Chartable Dashboard Terms of Service

These Chartable Dashboard Terms of Service (“Dashboard Terms”) apply to our Chartable Dashboard and Chartable Analytics product family. The Dashboard Terms incorporate by reference Chartable’s Terms and Privacy Policy. In the event of a conflict between the Dashboard Terms and the Terms of Service, the Dashboard Terms control.
...
You agree that when using our Services, including the Chartable Dashboard, you will comply with all applicable laws, rules, regulations, directives, guides and guidance regarding the collection, use, disclosure, processing and security of data collected from or about end users and/or specific devices. You also agree that you will maintain an easily accessible privacy policy that shall comply with all applicable laws, rules and regulations.

If you have any questions about the foregoing, please contact us at [\[email protected\]](https://chartable.com/cdn-cgi/l/email-protection).
...
[Terms](https://chartable.com/terms)

[Privacy Policy](https://chartable.com/privacy)

Help

[FAQ](https://help.chartable.com/)
...
[![Certified by the IAB Tech Lab](/assets/iab-5b91a11e1be82ad7c72691d02ba2cf7f3a3859a1d5c5a5b39122091e43c96f39.png)](https://iabtechlab.com/compliance-programs/compliant-companies) [![SOC2 Type II Certified](/assets/soc2-aaebd39e4fa4fa30809af15e04daac0985035a8ee7864f3921d63517cf84d551.png)](https://aicpa.org/soc4so)

**Cookies**

We use cookies to enhance your experience, analyze site traffic, and serve tailored ads. By continuing to browse or closing this banner, you consent to our [terms of service](https://chartable.com/terms) and [privacy policy](https://chartable.com/privacy).

[Accept Cookies](https://chartable.com/accept_cookies)