...
Pour plus d’informations concernant les cookies, veuillez consulter notre Politique sur les cookies et autres traceurs, disponible à l’adresse suivante : https://www.jeuxvideo.com/cookies.htm.

* * *

### Pourquoi traitons-nous vos données personnelles et pendant combien de temps ?

Nous nous engageons à traiter vos données personnelles pour des finalités déterminées, légitimes et pertinentes.

Par ailleurs, et conformément au règlement 2016/679 du 27 avril 2016 relatif au traitement des données à caractère personnel (« RGPD »), nous avons défini un fondement juridique pour chacun des traitements.

Enfin, nous conservons vos données à caractère personnel pendant une durée conforme aux dispositions légales et réglementaires applicables et, à défaut, durant une période strictement nécessaire et proportionnée à la réalisation des finalités pour lesquelles vos données ont été collectées. Les critères que nous appliquons dans la définition de ces durées sont indiqués dans le tableau présenté ci-dessous.

Lorsque nous n’avons plus besoin d’utiliser vos données à caractère personnel, nous les effaçons de nos systèmes d’information ou nous les anonymisons afin d’empêcher leur identification de manière irréversible.

| Quand traitons-nous vos données personnelles ? | Pourquoi traitons-nous vos données personnelles ? | Quel fondement juridique justifie ce traitement ? | Combien de temps conservons-nous vos données personnelles ? |
| --- | --- | --- | --- |
| Navigation sur le Site jeuxvideo.com | * Permettre votre authentification<br>* Adapter le service à votre terminal et préférence de langue<br>* stocker votre consentement cookies<br>* Mesurer et qualifier l’audience du Site | Intérêt légitime | * le temps nécessaire pour atteindre leur finalité (par ex., pendant la durée d’une session pour les cookies d’identification de session). Cette période ne saurait excéder 13 mois à compter de leur premier dépôt dans votre équipement terminal. |
| Navigation sur le Site jeuxvideo.com | * Diffuser des publicités ciblées sur le Site<br>* Diffuser des publicités ciblées sur Facebook<br>* Réaliser des segments d’audience<br>* Pour en savoir plus sur les traitements des données issues des cookies, consultez notre Charte d’Utilisation des Cookies | Consentement | * le temps nécessaire pour atteindre leur finalité (par ex., pendant la durée d’une session pour les cookies d’identification de session). Cette période ne saurait excéder 13 mois à compter de leur premier dépôt dans votre équipement terminal. |
| Souscription à l’offre de 2 euros pendant 1 mois | * Vous permettre de consulter notre application mobile sans publicité | Exécution du contrat | * Paypal conserve les données personnelles pendant la durée minimale nécessaire pour remplir ses obligations légales ou réglementaires, et pour ses besoins opérationnels.Plus d’informations sur la durée de conservation des données collectées par Paypal : https://www.paypal.com/webapps/mpp/ua/privacy-full?country.x=FR&locale.x=fr\_FR#3 |
| Souscription à l’offre Premium [jeuxvideo.com](https://www.jeuxvideo.com/) (application mobile) | * Vous permettre d’accéder au contenu du Site sans cookies publicitaire | Exécution du contrat | * Ce traitement est géré par votre magasin d’applications. Pour en savoir plus, consultez les conditions générales des services Google Play et Apple |
| Création de votre compte personnel jeuxvideo.com | * Vous permettre d’accéder aux services du Site | Exécution du contrat | * jusqu’à ce que vous nous demandiez de les effacer, ou<br>* après 3 ans d’inactivité (aucune interaction active avec jeuxvideo.com). |
| Abonnement à la newsletter jeuxvideo.com au moment de la création du compte | * Vous informer au travers de newsletters sur toutes les nouvelles actualités | Intérêt légitime | * jusqu’à ce que vous procédiez à votre désabonnement, ou<br>* jusqu’à ce que vous nous demandiez de les effacer, ou<br>* 3 ans à l’issue d’une période d’inactivité (aucune ouverture de newsletter ou d’interaction active avec jeuxvideo.com). |
| Saisie reCapatcha au moment de l’inscription ou lors de l’utilisation des espaces de discussion | * Identifier les vraies inscriptions et filtrer les inscriptions massives générées par des robots (spam)<br>* Identifier et filtrer les contenus postés par des robots | Intérêt légitime | * Google est responsable de ce traitement. A ce titre, il détermine la durée de conservation des données collectées. Pour en savoir plus<br><br>cliquez ici |
| Inscription à la newsletter | * Vous informer au travers de  newsletters sur toutes les nouvelles actualités | Consentement | * jusqu’à ce que vous procédiez à votre désabonnement, ou<br>* jusqu’à ce que vous nous demandiez de les effacer, ou3 ans à l’issue d’une période d’inactivité (aucune ouverture de newsletter ou d’interaction active avec jeuxvideo.com). |
| Interactivité avec les newsletters jeuxvideo.com reçus dans votre boîte email (pixel) | * Évaluer votre intérêt pour ces newsletters<br>* Mesurer l’efficacité des publicités intégrées dans ces newsletters | Intérêt légitime | * 1 an pour les données mesurant votre intérêt<br>* 3 mois pour les données liées à la diffusion de publicité dans les emails |
| Rédaction et signalement de contenus postés par les utilisateurs | * Associer le contenu posté à compte jeuxvideo.com<br>* Modérer les commentaires signalés pour vérifier leur conformité à la charte jeuxvideo.com | Intérêt légitime | * jusqu’à ce que vous nous demandiez de les effacer ou<br>* après 3 ans d’inactivité (aucune interaction active avec jeuxvideo.com). |
| Participation aux jeux concours de Jeuxvideo.com | * Enregistrer vos participations<br>* vous contacter en cas de gain | Exécution du contrat | * Variable en fonction du jeu concours (généralement jusqu’à 2 mois après l’issue du jeu concours ou de l’envoi de la dotation). La durée exacte est indiquée dans le règlement du jeu concours concerné |
...
* **droit de retirer votre consentement** : pour les traitements fondés sur votre consentement (par exemple : envoi de newsletters) vous avez la possibilité de retirer votre consentement à tout moment, par le biais d’une modalité simple et équivalente à celle utilisée pour recueillir votre consentement
...
Webedia – DPO 2 rue Paul Vaillant Couturier 92300 Levallois-Perret Adresse e-mail: dpo-jeuxvideo.com@webedia-group.com
