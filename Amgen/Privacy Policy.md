...
* [Responsibility](https://wwwext.amgen.com/responsibility)
    ...
    * [Environmental, Social & Governance Report 2022](https://wwwext.amgen.com/responsibility/environmental-social-and-governance-report)
    ...
    * [A Healthy Amgen](https://wwwext.amgen.com/responsibility/a-healthy-amgen)
        ...
        * [Corporate Governance](https://wwwext.amgen.com/about/how-we-operate/corporate-governance)
        * [Business Ethics and Compliance](https://wwwext.amgen.com/responsibility/a-healthy-amgen/business-ethics-and-compliance)
        * [Ethical Research](https://wwwext.amgen.com/responsibility/a-healthy-amgen/ethical-research)
    ...
    * [Reporting and Metrics](https://wwwext.amgen.com/responsibility/reporting-and-metrics)
        * [Overview](https://wwwext.amgen.com/responsibility/reporting-and-metrics)
        * [Summary of Data](https://wwwext.amgen.com/responsibility/reporting-and-metrics/summary-of-data)
        * [CDP](https://wwwext.amgen.com/responsibility/reporting-and-metrics/cdp)
        * [Archived Reports](https://wwwext.amgen.com/responsibility/reporting-and-metrics/archived-reports)
...
* Third Parties and Vendors who help us maintain the accuracy of our data and data aggregators that help us complete and enhance our records
...
* **Divulgaciones de la Ley My Health My Data de Washington y Nevada.** Esta sección solo se aplica a los Consumidores, ya que el término "Consumidor" se define en la Ley My Health My Data de Washington y la Ley My Health My Data de Nevada, respectivamente. Los términos utilizados en esta sección que tienen significados definidos según la Ley My Health My Data de Washington o la Ley My Health My Data de Nevada tendrán el significado que se les otorga en esos estatutos, ya que esta sección se aplica a los Consumidores de esos estados. Recopilamos y compartimos las siguientes categorías de Datos de salud del consumidor de los consumidores, y procesamos dichas categorías de Datos de salud del consumidor para los fines y de la manera enumerada en la Sección E:
    ...
    * Funciones corporales, signos vitales, síntomas o mediciones de información de salud;
    * Diagnósticos o pruebas de diagnóstico, tratamiento o medicación;
    * Datos genéticos;
    * Información de ubicación precisa que podría indicar razonablemente el intento de un residente de adquirir o recibir servicios o suministros de salud;
    * Datos que identifican a un residente que busca servicios de atención médica; y
    * Cualquier inferencia de las categorías anteriores de datos de salud derivadas o extrapoladas de información no relacionada con la salud.
    
    Recopilamos estas categorías de Datos de salud del consumidor de las fuentes enumeradas en la Sección D y compartimos estas categorías de Datos de salud del consumidor con las categorías de entidades enumeradas en la Sección F, incluidas las siguientes afiliadas: Amgen Inc., Amgen USA Inc., Horizon Therapeutics USA, Inc. Los consumidores pueden ejercer sus derechos como sujetos de datos, incluida la obtención de acceso y la solicitud de cambios en sus Datos de salud del consumidor, según la Ley My Health My Data de Washington y la Ley My Health My Data de Nevada, comunicándose con nosotros a través de los métodos enumerados en Sección G. 
    
    Limitamos la recopilación de datos de salud del consumidor por parte de terceros a lo largo del tiempo y en diferentes sitios web o servicios en línea cuando el consumidor utiliza nuestros sitios web o servicios en línea. Hacemos esto asegurándonos de que las entidades cuyas cookies, balizas web, ossib y otros rastreadores en línea utilizamos en nuestros sitios web y servicios en línea sean nuestros Proveedores según las leyes de privacidad de EE. UU. Aplicables y las leyes My Health My Data de Washington y Nevada. No obstante, tenga en cuenta que es ossible que los terceros aún puedan recopilar sus datos de salud del consumidor a lo largo del tiempo y en diferentes sitios web, según su navegador, los complementos del navegador y los permisos asociados que haya configurado en su dispositivo. Esta recopilación de datos de salud del consumidor por parte de dichos terceros no está relacionada con la recopilación de datos de salud del consumidor que Amgen realiza de usted, y le recomendamos que consulte los avisos de privacidad de dichos terceros para obtener más información sobre su procesamiento de datos de salud del consumidor y los métodos que proporcionan para le permiten optar por no participar en dicho procesamiento.
    
* **Aviso de privacidad para residentes de Nevada.** No vendemos Información cubierta según lo define la ley de Nevada y, en general, no divulgamos ni compartimos información personal según lo define la ley de Nevada con fines comerciales. Según la ley de Nevada, usted tiene derecho a indicarnos que no vendamos ni concedamos licencias sobre su información personal a terceros. Para ejercer este derecho, si corresponde, usted o su representante autorizado pueden comunicarse con nuestro Departamento de Cumplimiento de Privacidad en [privacy@amgen.com](mailto:privacy@amgen.com).
...
[Contact Us](https://wwwext.amgen.com/contact-us) [Sitemap](https://wwwext.amgen.com/sitemap) [Privacy Statement](https://wwwext.amgen.com/privacy-statement) [Terms of Use](https://wwwext.amgen.com/terms-of-use) [Consumer Health Data Privacy Policy](https://wwwext.amgen.com/healthdataprivacypolicy) [Your Cookie Preferences](javascript:Cookiebot.renew())
