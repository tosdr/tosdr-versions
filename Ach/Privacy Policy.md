...
* [ACH](https://www.nacha.org/content/what-is-ach)
    
    * [What is ACH](https://www.nacha.org/content/what-is-ach)
        ...
        * [How ACH Payments Work](https://www.nacha.org/content/how-ach-payments-work)
            
        * [How the Rules are Made](https://www.nacha.org/content/rules-enforcement)
            
        * [ACH Volume and Value](https://www.nacha.org/content/ach-network-volume-and-value-statistics)
            
        * [ACH Network Fees](https://www.nacha.org/content/network-administration-fees)
            
        
    * [Rules and Compliance](https://www.nacha.org/content/rules-enforcement "Keeping the ACH Network secure and of high quality.")
        
        Ensuring the ACH Network remains a trusted payment system for all participants.
        
        * [New Rules](https://www.nacha.org/newrules)
            
        * [Proposed Rules](https://www.nacha.org/rules/proposed)
        ...
        * [Nacha Operating Rules Online](https://www.nachaoperatingrulesonline.org/)
    ...
    * [ACH Payment Types](https://www.nacha.org/resource-landing/same-day-ach-resource-center)
        ...
        * [Direct Deposit](https://www.nacha.org/content/direct-deposit-and-direct-payment#pageContent-1)
            
        * [International ACH (IAT)](https://www.nacha.org/content/international-ach-transactions)
            
        * [Healthcare EFT](https://www.nacha.org/healthcare-resources)
            
        * [Consumer Payments](https://www.nacha.org/content/consumer-payments)
            
        
    * [Risk Management](https://www.nacha.org/nacha-risk-management-portal "Protecting billions of transactions every year.")
        
        Assessing and managing risk are vital to keeping the ACH Network a secure payment system.
        
        * [Risk Management Portal and ACH Contact Registry](https://www.nacha.org/nacha-risk-management-portal)
...
* [Education](https://www.nacha.org/content/education)
    
    * [In-person Events](https://www.nacha.org/events?field_venue_target_id=314#block-views-block-event-listing-block-2)
        
        * [Smarter Faster Payments](https://payments.nacha.org/)
    ...
    * [Virtual Learning](https://www.nacha.org/events?field_venue_target_id=315#block-views-block-event-listing-block-2)
        ...
        * [Smarter Faster Payments Remote Connect](https://payments.nacha.org/remote-connect)
            
        * [TPI Home School](https://tpi.nacha.org/)
    ...
    * [Accreditation](https://www.nacha.org/content/thinking-about-nacha-accreditation)
        
        * [Accredited ACH Professional](https://www.nacha.org/accredited-ach-professional)
        ...
        * [Accreditation Course Licensing](https://www.nacha.org/accreditation-course-licensing)
            
        
    * [Resources](https://www.nacha.org/educational-resources)
        
        * [Publications & Store](https://www.nacha.org/store)
            
        * [ACH Quick Start Tool: B2B](https://www.nacha.org/quick-start-tool-b2b)
            
        * [ACH Quick Start Tool: B2C](https://www.nacha.org/b2cquickstart)
            
        * [Faster Payments Playbook](https://fasterpaymentsplaybook.org/)
            
        * [ACH for Developers Guide](https://achdevguide.nacha.org/)
            
        
    
* [Membership](https://www.nacha.org/membershipfinder)
    
    * [Nacha Affiliate Program](https://www.nacha.org/content/nacha-affiliate-program)
        
        * [About](https://www.nacha.org/content/nacha-affiliate-program)
    ...
    * [Payments Innovation Alliance](https://www.nacha.org/payments-innovation-alliance)
        ...
        * [About](https://www.nacha.org/payments-innovation-alliance)
            
        * [Alliance Membership Features](https://www.nacha.org/content/alliance-membership-features)
            
        * [Membership Directory](https://www.nacha.org/content/alliance-program-membership-directory)
            
        * [Meetings](https://www.nacha.org/payments-innovation-alliance#pageContent-173)
            
        * [Member Resources](https://www.nacha.org/resource-alliance)
            
        * [Leadership](https://www.nacha.org/content/alliance-leadership-team)
            
        * [Project Teams](https://www.nacha.org/content/alliance-project-teams)
            
        
    * [Nacha Direct Member](https://www.nacha.org/content/nacha-direct-member-0)
        
        * [About](https://www.nacha.org/content/nacha-direct-member)
            
        * [Benefits](https://www.nacha.org/content/nacha-direct-member#pageContent-2602)
...
* [Payments Enablement](https://www.nacha.org/content/payments-enablement)
    ...
    * [Phixius](https://www.nacha.org/content/phixius)
        ...
        * [About Phixius](https://www.nacha.org/content/phixius#pageContent-2287)
            
        * [Account Validation and Bank Account Name Validation](https://www.nacha.org/content/phixius#pageContent-2288)
            
        * [Phixius in the News](https://www.nacha.org/content/phixius#pageContent-2281)
            
        * [Contact us](https://www.nacha.org/content/schedule-phixius-demo)
            
        
    * [Standards](https://www.nacha.org/content/standards)
        
        * [Afinis APIs](https://www.nacha.org/content/afinis-interoperability-standards)
            
        * [Nacha Programs Supporting ISO 20022](https://www.nacha.org/content/iso-20022)
...
To learn more about your information collection choices and to opt-out of data collection, see sections below, and, for individuals located in the European Union/European Economic Area (“EU/EEA”), see also the “Your Rights” section below.
...
* to inform of events - including conferences, educational opportunities, and meetings - that you have purchased or registered for, and to provide you with information, and other materials, relating to the content of the event, the speakers, sponsors and other attendees;
* to provide data from your registrant profile including first and last name, company, address, and email if you allow your registrant badge to be scanned at exhibit booths;
* to provide data from your registrant profile including first and last name, company, address, and email in. a post-conference attendee list that Nacha shares with exhibitors, sponsors and media partners for one-time use;
...
Unless you have opted out of having your badge scanned for lead retrieval at an event, we may share your Personal Data for the purposes described in this Notice with:

* a member of our group;
* registered event attendees, sponsors, and exhibitors, if you are an attendee, speaker, sponsor or exhibitor of a Nacha-sponsored event; 
* Nacha webinar partners if you are attending a webinar and have opted-in to having your information provided to the Host;
...
We will never sell or rent your Personal Data to third parties. We do provide the contact information for in-person and virtual event attendees to exhibitors and sponsors at Nacha’s in-person and virtual events; however, in-person and virtual events attendees have the option of opting out of this distribution of their contact information.
...
Nacha will maintain confidentiality to the extent consistent with appropriate investigation and corrective action.

**RETALIATION**

Retaliation against an individual for reporting unethical behavior is a serious violation and is strictly prohibited. Acts of retaliation should be reported immediately and will be promptly addressed.
...
Please refer to the [Privacy Policy](#privacypolicy) for information on how we collect, use and disclose personally identifiable information from our users. By using this Site, you expressly acknowledge and agree to the terms of the Privacy Policy.

**2\. Ownership and Copyright**

The entire contents of this Site are copyrighted, unless otherwise indicated, by Nacha. All rights are reserved and content may not be reproduced, downloaded, disseminated, published, or transferred, in any form or by any means, except with the prior written agreement of Nacha or as indicated below. Users of this Site may download/print pages or other content for their personal, noncommercial use on a single computer.

**3\. Trademarks**

The Nacha logo, and the look and feel of the Site, including all graphics, icons, scripts, page headers, and layouts, are registered and/or common law trademarks and/or trade dress of Nacha, and may not be copied, imitated or used, in whole or in part, without the prior written permission of Nacha.
...
**7\. Use of Discussion Forums, Bulletin Boards, and Other Interactive Areas**

The Site may contain discussion forums, bulletin boards, or other methods by which you or third parties may post messages, images, or other information on the Site ("Interactive Areas"). You are solely responsible for your use of such Interactive Areas and use them at your own risk. By using any Interactive Areas, you expressly agree not to post, upload to, transmit, distribute, store, create or otherwise publish through the Site any of the following:
...
c. Content that may infringe any patent, trademark, service mark, trade secret, copyright or other intellectual or proprietary right of any party;
...
FOR A PARTICULAR PURPOSE, TITLE AND NONINFRINGEMENT AS TO THE SERVICES, INFORMATION, AND CONTENT ON THE SITE. NACHA DOES NOT REPRESENT OR WARRANT THAT MATERIALS IN THE SITE OR THE SERVICES ARE ACCURATE, COMPLETE, RELIABLE, OR CURRENT, AND EXPRESSLY DISCLAIMS ANY WARRANTY OR REPRESENTATION AS TO THE ACCURACY, COMPLETENESS, RELIABILITY, OR CURRENCY OF THE SITE, THE SITE CONTENT OR ANY PORTION THEREOF.

WHILE NACHA ATTEMPTS TO MAKE YOUR ACCESS TO AND USE OF THE SITE AND THE SERVICES SAFE, NACHA CANNOT AND DOES NOT REPRESENT OR WARRANT THAT THE SITE OR ITS SERVER(S) ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. IT IS YOUR RESPONSIBILITY TO SELECT, PURCHASE, AND USE SOFTWARE TO DETECT AND DISINFECT VIRUSES FROM ANY DOWNLOAD.
...
WITHOUT LIMITATION OF THE FOREGOING, NEITHER NACHA NOR ANY PARTIES PROVIDING SITE CONTENT SHALL BE LIABLE FOR ANY DIRECT, INDIRECT, SPECIAL, EXEMPLARY, PUNITIVE, OR CONSEQUENTIAL DAMAGES, OR ANY OTHER DAMAGES OF ANY KIND, INCLUDING BUT NOT LIMITED TO LOSS OF USE, LOSS OF PROFITS OR LOSS OF DATA, WHETHER IN AN ACTION IN CONTRACT, TORT (INCLUDING BUT NOT LIMITED TO NEGLIGENCE) OR OTHERWISE, ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OF THE SITE, THE SERVICES, THE SITE CONTENT OR THE MATERIALS CONTAINED IN OR ACCESSIBLE THROUGH THE SITE, INCLUDING WITHOUT LIMITATION ANY DAMAGES CAUSED BY OR RESULTING FROM YOUR RELIANCE ON ANY SITE CONTENT OR OTHER INFORMATION OBTAINED FROM NACHA OR ACCESSIBLE VIA THE SITE, OR THAT RESULT FROM MISTAKES, ERRORS, OMISSIONS, INTERRUPTIONS, DELETION OF FILES OR EMAIL, DEFECTS, VIRUSES, DELAYS IN OPERATION OR TRANSMISSION OR ANY FAILURE OF PERFORMANCE, WHETHER OR NOT RESULTING FROM ACTS OF GOD, COMMUNICATIONS FAILURE, THEFT, DESTRUCTION OR UNAUTHORIZED ACCESS TO NACHA’S RECORDS, PROGRAMS OR SERVICES. THE FOREGOING APPLIES EVEN IF NACHA HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
The Agreement is governed by the laws of the Commonwealth of Virginia without regard to its conflicts of law principles. You agree that any claims you may have against Nacha arising from or relating to the Site will be heard and resolved in a court of competent subject matter jurisdiction located in Virginia. You consent to the personal jurisdiction of such courts over you, stipulate to the fairness and convenience of proceeding in such courts, covenant not to assert any objection to proceeding in such courts, and you expressly waive any right to proceed in any other court.
...
[ACH](https://www.nacha.org/taxonomy/term/333)
...
[Rules Compliance](https://www.nacha.org/taxonomy/term/371)
...
[Direct Deposit](https://www.nacha.org/taxonomy/term/334)
...
* [Account Validation](https://www.nacha.org/search?keys=Account%20Validation)
* [Accreditation](https://www.nacha.org/search?keys=Accreditation)
* [ACH Quick Start Tool](https://www.nacha.org/search?keys=ACH%20Quick%20Start%20Tool)
* [B2B Payments](https://www.nacha.org/search?keys=B2B%20Payments)
* [Consulting](https://www.nacha.org/search?keys=Consulting)
* [Contact Registry](https://www.nacha.org/search?keys=contact%20registry)
* [Direct Deposit](https://www.nacha.org/search?keys=Direct%20Deposit)
* [Direct Access](https://www.nacha.org/search?keys=direct%20access)
* [Operating Rules 2024](https://www.nacha.org/search?keys=Operating%20Rules%202024)
* [Phixius](https://www.nacha.org/search?keys=phixius)
* [Risk Management](https://www.nacha.org/search?keys=Risk%20Management)
* [Same Day ACH](https://www.nacha.org/search?keys=Same%20day%20ach)

© 2024 Nacha. All Rights Reserved.

Social Media
------------

* [Twitter](https://twitter.com/NACHAOnline)
