[![](data:image/svg+xml;charset=utf-8,%3Csvg%20height='58'%20width='150'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%3E%3C/svg%3E)

![](https://images.ctfassets.net/6kz06gcm2189/2Rb7gHVVn0jp9xOGbkAC2x/277423d10a6587287bd352ef8e1c6f6d/logo.png?w=150&h=58&q=100&fm=png)](https://taxbit.com/)
...
Learn more about the newly finalized regulations and how to prepare

[Learn More](https://taxbit.com/digital-asset-broker-regulations/)
...
_Taxbit Network._ The Taxbit Network is a network of cryptocurrency exchanges that Taxbit supports to allow users on in-network exchanges to receive completed IRS 8949 and IRS Income tax forms at no charge. The Taxbit Network allows you to (1) connect in-network and other exchange accounts, (2) view tax computations related to in-network transactions, including cost basis assignment relating to deposits onto in-network platforms from other platforms, and (3) obtain IRS 8949 and Income tax forms (if applicable) for in-network cryptocurrency activity (“Services”). You may have to purchase a subscription to purchase additional features or to receive tax forms for out-of-network exchanges. You further acknowledge that Taxbit is a third party service and companies included in the Taxbit Network aren't liable for the services provided by Taxbit.
