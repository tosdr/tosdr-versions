...
Fellow Insights, Inc. (“Fellow”) takes your privacy very seriously. We have created this Privacy Policy (“Privacy Policy”) to outline how we collect, use and disclose Personal Data from Users of our website and web-application (the “Platform”), located at [**https://fellow.app**](https://fellow.app/) (“Site”), our Apps (e.g. Fellow for iOS/Android, Fellow for Mac/Windows, Fellow Browser Extension), and our Communications Platform Apps (e.g. Fellow for Slack, Fellow for MS Teams, etc…) and the related services described in our Terms of Use (collectively, the “Services”).

Please review the following text to understand our protocol with regards to Personal Data and how we treat it. By visiting [**https://fellow.app**](https://fellow.app/), signing up for our Platform, installing any of our Apps, or using our Communications Platform Apps, installing any of our you are providing your acceptance and consent to practices outlined here.

Background Information
----------------------

When we refer to “Users”, we are referring to both individual users (“Individual Users”) and Organizational users that hold an Account on the Site or have installed our Bots. The Services allow Users the opportunity to track and take notes on 1:1s and other meetings, exchange feedback, track goals/priorities and other items as they relate to working together. In the event that an Organization purchases a subscription to the Services, they will have access to aggregate reporting relating to usage of the Services by Users and other related analytics associated with their Organization. By default, Organizations will not have access to the content of Notes or Feedback Messages of Users who create this content. If an Organization’s policies require access to this data, then Fellow will comply. It is your responsibility to read and understand your Organization’s internal privacy policies.
...
1. “Notes” refers to any content written in relation to interactions that Users have with other Users (whether in a 1:1 or group setting).
...
3. “Organization” refers to the entity that entered into a subscription agreement with Fellow and that you provided to us when you created an Account with Fellow (or that we otherwise retrieve during the signup process). The Organization will generally be your employer, or a subsection of your employer (i.e. department).
4. “Personal Data” means data about a living individual who can be identified from those data (or from those and other information either in our possession or likely to come into our possession), and any information about the individual associated with that information.
5. “Work Network” is the group of employees, contractors or other authorized Users at your Organization.
...
532 Montréal Rd #275, Ottawa, ON K1K 4R4  
**privacy@fellow.app**

Children under 13
-----------------

Fellow does not knowingly offer its Services to children who are under 13 years of age. If we become aware of usage of its services by individuals in this age group, we will attempt to delete all related information immediately. If you have any information related to such usage, please report it to us at **privacy@fellow.app**

General Data Protection Regulation (GDPR) Compliance
----------------------------------------------------

For residents of the European Economic Area, Fellow generally processes Personal Data in order to fulfill contracts we have with the Organizations that are our customers and Users, as well as to pursue our legitimate business interests as set out in this Privacy Policy. Otherwise, Fellow will obtain consent from an Individual User in respect of processing of Personal Data.
...
We take security seriously and use appropriate technical measures corresponding to the types of Personal Data we store, and the risks associated with processing such data. In the event of a data breach we will contact those affected as well as any applicable regulators as required by law. You can learn more about Fellow’s security and compliance practices [**here**](https://help.fellow.app/en/articles/4302231-security-compliance).

Types of Data We Collect
------------------------

When using our Services, we collect information from you – some of which is considered “Personal Data” and can be used to identify you, and some of which is “Anonymous Data” which is not linked to any identifiable individual. In the following sections, we will outline the details of what we collect and how:
...
#### Analytics Software and Advertising Platforms
...
We participate in network advertising programs that display advertising about our services on other unaffiliated websites. We use third party social media platforms (e.g. Facebook, Linkedin, etc.) to show you [customized social media ads and interest-based ads](https://fellow.app/privacy-policy/advertising-definitions/).

### Information Collected from Others

By connecting your Calendar as mentioned earlier in this document, we will be able to determine who works with whom with your organization so as to offer you smart suggestions on how to improve your working relationships with people in your network, as well as allow the ability to take notes on each of your meetings.

Below we list the types of data we collect from the various Fellow apps for the communications platforms that we support. Each is only applicable if you or your organization has installed the respective app on the third party platform.

* **Fellow for Slack**: Information about the users in your Slack account and the individuals you interact with most often. In particular, if Fellow for Slack is connected: Avatars, Team Names, Channel Membership, Communications within the @Fellow bot and metadata derived from such communications and OAuth Tokens. We do NOT request access to the content of your direct messages (“DMs”) or the content of your private channels.
* **Fellow for Microsoft Teams**: Information about the users in your Teams account and the individuals you interact with most often. In particular, if Fellow for Microsoft Teams is connected: Avatars, Team Names, Team Memberships, Communications within the @Fellow bot, and metadata derived from such communications and OAuth Tokens. We do NOT request access to the content of your chat messages (“DMs”) or the content of your private channels.
* **Fellow for Zoom:** Information about you, and information about your meetings. In particular, if Fellow for Zoom is connected: Meeting titles and Times, Meeting recording links, and your user information (IDs and email addresses). We do NOT have any access to the content of your recordings (whether local or on Zoom Cloud).
* **Fellow for Zoom Chat:** Information about you, and individuals with whom you interact with most often. In particular, if Fellow for Zoom Chat is connected: Avatars, Team names, Channel memberships, Communications with the Fellow bot, and metadata derived from such communications and OAuth Tokens.  We do NOT request access to the content of your chat messages (“DMs”) or the content of your private channels.

Note that the Fellow for Microsoft Teams app is enabled by the Microsoft Bot Framework. The Microsoft Bot Framework is a set of web-services that enable intelligent services and connections using conversation channels you authorize. As a service provider, Microsoft will transmit content you provide to our bot/service in order to enable the service. For more information about Microsoft privacy policies please see their privacy statement here: [**http://go.microsoft.com/fwlink/?LinkId=521839**](https://go.microsoft.com/fwlink/?LinkId=521839). In addition, your interactions with this bot/service are also subject to the conversational channel’s applicable terms of use, privacy and data collection policies. To report abuse when using a bot that uses the Microsoft Bot Framework to Microsoft, please visit the Microsoft Bot Framework website at [https://www.botframework.com](https://www.botframework.com/) and use the “Report Abuse” link in the menu to contact Microsoft.
...
* Send you messages (via our Communications Bots, and Email and our Web Application) that relate to your usage of our system or security and administrative messages.
* Send you smart suggestions and feedback received from others in your Work Network.
* Send you communication requests for the purpose of improving our Services (i.e. request for phone call, completion of a survey).
...
We use anonymized data retrieved from our database (i.e. where personally identifiable information has been obfuscated) in order to create analytics that will help us surmise how to improve our Service. Some of the reports created with this anonymized data may be shared with your Organization so that they can understand the overall usage of our product by their employees/constituents.
...
#### Service Providers related to Fellow’s AI services

We use a set of third parties in order to offer you Artificial Intelligence (AI) Services such as processing intent, smart suggestions for your meetings, meeting recording services, transcription services, summarization, content creation, editing, question answering, intelligent search, etc…

The transfer of your organizations’ data to AI-related third party service providers can be controlled by administrators in your organization with a toggle in your Workspace settings in the Platform (Workspace Settings -> Security -> Artificial Intelligence). When this toggle is disabled, any features which rely on these third-party AI providers will also be disabled.  When the toggle is enabled, certain additional features will be available for your account that rely on these services (exclusively on a per-use basis of the respective features, not via background transfers). Any such features are appropriately decorated within the Platform with similar iconography.

A full list of our sub-processors, including our AI sub-processors is available [**here**](https://www.fellow.app/fellow-app-sub-processors/).
...
You may unsubscribe from our marketing communications by clicking on the “unsubscribe” link located on the bottom of our emails, or by sending us an email at **privacy@fellow.app**. Customers cannot opt out of receiving transactional emails related to their account with us or the Services.
...
You can opt-out of network advertising programs that track your activities across multiple websites to deliver personalized advertising content to you. Please visit:

* Digital Advertising Alliance of Canada Opt-Out Page: [http://youradchoices.ca/understanding-online-advertising](http://youradchoices.ca/understanding-online-advertising)
* NAI Opt-Out Page: [http://www.networkadvertising.org/managing/opt\_out.asp](http://www.networkadvertising.org/managing/opt_out.asp)
* Ad Choices Opt-Out Page: [http://www.aboutads.info/choices/](http://www.aboutads.info/choices/)

These websites provide tools that identify member companies that have placed cookies on your browser and provide tools to allow you to opt-out of those cookies. Please note that if you opt-out you may still receive online advertising from Fellow on other websites or applications; however, these advertisements will not be displayed to you based on your interests. Please also note that deleting browser cookies can remove your opt-out preferences, so you should use these tools periodically to ensure that your preferences are up-to-date.

### Customized Social Media Ads

To opt-out of customized social media ads, adjust your social advertising settings (for example, through the settings of your Facebook profile), or use the links provided in the ad itself.

### Access, Modification or Deletion of Your Data

You may contact us at **privacy@fellow.app** in order to request a copy, change or delete any Personal Data that we have on file for your Account. Please note that feedback exchanged cannot be deleted as it involves more than one party. As an Organizational customer, you may request the deletion of your entire Account (and all individual Users within that account). We will delete this information within 15 days of your request. Your information may stay on our backup servers for up to an additional 30 days but will no longer be present thereafter.
...
We periodically update this Privacy Policy. In the event of an update, we will post the new policy at [https://fellow.app/privacy-policy](https://fellow.app/privacy-policy) and update the “Last Updated” date above. Please check this page regularly for updates.