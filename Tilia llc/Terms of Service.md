...
**Tilia LLC User Terms of Service**  
...
**By registering for an Tilia Account (as defined below) and/or accessing or otherwise using any portion of the Tilia Service, you agree to be bound by these Terms.**

**Please read all provisions of these Terms carefully. If you do not agree to these Terms, you may not register for an Tilia Account or otherwise access or use any portion of the Tilia Service. THESE TERMS CONTAIN AN ARBITRATION PROVISION THAT AUTHORIZES EITHER PARTY TO ELECT MANDATORY AND BINDING ARBITRATION OF CERTAIN DISPUTES. THE TERMS OF THE ARBITRATION PROVISION ARE SET FORTH IN SECTION 13 BELOW, ENTITLED "DISPUTE RESOLUTION AND ARBITRATION." PLEASE READ THIS ARBITRATION PROVISION CAREFULLY.**

The Tilia Service is offered through Tilia’s integrations with online platforms (each, a "**Platform**") that are offered by third parties (each, a "**Publisher**"). Access to all or a portion of the Tilia Service through these Platforms and Publishers may be available or discontinued at the sole discretion of Tilia. You agree that your use of the Platform through which you access the Tilia Service is governed by the relevant Publisher's end user license agreement and/or terms of use, including, without limitation, password and account security policies (collectively, the "**Platform TOS**"). We do not assume any responsibility for the content, policies or practices of any Platform, Publisher or other third party, including any Platform TOS, and you hereby agree that we are not liable for any loss arising from your use of any Platform, any act or omission of any Publisher or other third party, or the terms of any Platform TOS. These Terms incorporate by reference all policies, guidelines, notices, representations, and other content regarding the Tilia Service that are published publicly at [www.tilia.io](https://tilia.io/) ("**Website**"). In the event of any material conflict or inconsistency between these Terms and any such policies, guidelines, notices, these Terms prevail with respect to the provision of the Tilia Service.

These Terms contain the above provisions and the following  sections. You may jump directly to any section by selecting the appropriate link below. The headings and subheadings are for reference only and do not limit the scope of each section. Underlined words in these Terms hyperlink to the relevant information.

1. [**The Tilia Service**](#tilia-service)
2. [**Our Relationship with You**](#our-relationship-with-you)
3. [**Payment Processing**](#payment-processing-service)
4. [**Stored Value Balances**](#stored-value-balance)
5. [**Digital Tokens**](#digital-tokens)
6. [**Disbursements**](#disbursements)
7. [**Intellectual Property and Licenses**](#intellectual-property)
8. [**Communications**](#communications)
9. [**Term and Termination**](#term-and-termination)
10. [**Fees**](#fees)
11. [**Customer Complaints – Money Transmission Activity**](#customer-complaints)
12. [**Releases, Disclaimers, Liability Limits and Identification**](#releases-disclaimers-liability)
13. [**Dispute Resolution and Arbitration**](#dispute-resolution)
...
> a) make payments to the Publisher and other third parties supported by the Publisher for digital goods and services (“**Digital Goods**”);

> b) use issued tokens on a Platform to use or access features or content within a Publisher’s Platform;

> c) hold and load funds/value in a Stored Value Balance (as defined below, which may be in the form of USD or Earned Tokens) as compensation from the Publisher on whose Platform you create and sell content or otherwise enhance the value and experience of the Platform (such creators referred to hereunder as “Creators,” a subset of Users);

> d) facilitate the use of in-Platform content, and access other related services within a Platform; and,

> e) receive funds from Publishers as part of its rewards or revenue sharing programs, if applicable.

While the Tilia Service is integrated into certain selected Platforms, the Tilia Service is offered by Tilia and not by the Publisher of the relevant Platform. Tilia will provide services to the Publisher to enable it to accept card payments by you to it, so that you can, for example, (i) pay the Publisher for subscriptions; (ii) purchase in-Platform tokens (known as Purchased Tokens) which may be used to pay for in-Platform Digital Goods from the Publisher; (iii) make other payments to the Publisher, or, (iv) remit funds on behalf of the Publisher as part of its rewards or revenue sharing programs, if applicable.
...
In order to be eligible to access and use the Tilia Service, youmust (i) be eighteen (18) years of age or older, (ii) have the legal ability toenter into and be bound by these Terms and the relevant Platform TOS, (iii) have accepted the Platform TOS applicable to the particular Platform through which you are accessing the Tilia Service and remain eligible to access and use such Platform, (iv) comply with these Terms, and (iv) establish and maintain an active and valid user account with Tilia (“**Tilia Account**”).

To create a Tilia Account and/or access certain features or functionality of the Tilia Service, we may require you to provide us with certain personal information and documentation that will enable us to identify you and otherwise comply with applicable law (please see Section 2.4 Identity Verification below). For further details on what we may collect, please see our [Privacy Policy](https://www.tilia.io/legal/privacy-policy).

You agree to provide accurate, current and complete information about yourself and to use the provided Tilia Account management tools to keep that information accurate, current and complete. We may request additional information from you in the future. We will review and validate the information you provide to us to ensure we have a reasonable belief of your identity. This is in accordance with our obligations under applicable anti-money laundering regulations.
...
When you do business with us, you agree to comply with all applicable laws, regulations or ordinances, and orders of governmental and governing authorities, including data protection and anti-money laundering laws. You agree not to use your Tilia Account or other portion of the Tilia Service for any unlawful purpose.

When using the Tilia Service and/or Website, you will not:

* use them in any unlawful manner, for any unlawful purpose, or in any manner inconsistent with or contravening these Terms;
* violate or infringe the rights of Tilia, any of its group companies, our users, or other third parties, including rights in respect of privacy, intellectual property, or other proprietary rights;
* provide false, inaccurate or misleading information;
* engage in any potentially fraudulent or suspicious activity and/or transactions, including receiving money which may be fraudulent or adding money to your Tilia Account which may be linked to criminal activities;
* refuse to cooperate with an investigation or provide any information we request, including with respect to verifying your identity;
...
* seek to harm Tilia, our group companies, or any of our users or customers; or
* access, use, copy, modify, distribute, display, otherwise exploit or prepare derivative works based upon and of the Tilia Service in impermissible or unauthorized manners, or in ways that harm us, our group companies, the Tilia Service, systems, users, or others. In particular you must not:
* reverse engineer, alter, modify, create derivative works from, decompile, or extract code from the Tilia Service, except to the extent permitted by law;
* send, store, or transmit viruses or other harmful computer code through or onto the Tilia Service;
* gain or attempt to gain unauthorized access to our systems or those of our group companies;
* create accounts for the Tilia Service through unauthorized means;
* collect the information of or about our users in any impermissible or unauthorized manner; and/or
* sell, resell, rent, or charge for the use of, the Tilia Service.
...
Protecting your privacy and your personal data is very important to Tilia. Our practices governing the collection and use of your personal data are detailed in our [Privacy Policy](https://www.tilia.io/legal/privacy-policy). Please review this policy before you provide us with your personal data in order to better understand our commitment to maintaining your privacy, as well as our use of your personal data.

Your decision to use the Tilia Service is purely voluntary and optional. However, as detailed above, to use the Tilia Service, you must have a Tilia Account for which we require certain of your personal data to create. If you elect not to provide the requisite personal data, you will not be able to create a Tilia Account or access or use the Tilia Service.

As the Tilia Service is integrated into Platforms offered by Publishers, you may be asked to provide certain personal data to a Publisher or other third party in connection with your use of a Platform. Such information is subject to the privacy policy of the relevant Publisher or other third party.

### **2.4. Identity Verification**

If you use certain aspects of the Tilia Service (specifically, holding a Stored Value Balance), applicable law requires that Tilia verify your identity. This means that Tilia requires you to provide certain personal information that will enable us to accurately identify you.

We may also ask you to provide certain documentation, e.g., driver’s license, at our sole discretion, at any time.  For more information on how we use this information and your rights in respect of such use, please see our [Privacy Policy](https://www.tilia.io/legal/privacy-policy).
...
> a) contact you regarding your Tilia Account;

> b) comply with applicable laws; and/or

> c) let you know about changes to these Terms.

Tilia reserves the right to close, suspend, or limit access to your Tilia Account and/or the Tilia Service in the event we are unable to obtain or verify information or your identity.

### **2.5. Security**

You are responsible for maintaining adequate security and control of any and all IDs, passwords, personal identification numbers (PINs), or any other codes that you use to access your Tilia Account or the Tilia Service.

You must not allow another person to:

> a) to use or otherwise access the Tilia Account assigned to you.

> b) use security information related to your Tilia Account;

> c) write down password(s) or any security information unless this is done in a way that would make it impossible for anyone else to recognize any of that information;

> d) disclose passwords or any security information, or otherwise make them available to any other person, whether verbally or by entering them in a way that allows them to be observed by others.

Any loss or compromise of your electronic device or your security details may result in unauthorized access to or use of your Tilia Account by third parties and the loss or theft of any funds and any associated accounts, including your bank account(s), account(s) held with payment service providers and electronic money issuers and/or payment card(s).
...
Tilia offers a service through which you may, using payment methods supported by Tilia, make payments to the relevant Publisher or other users of the Platform for products or services offered within the Platform and/or other amounts owed to the Publisher (such service, the “**Payment Processing Service**”).

In offering the Payment Processing Service, Tilia’s responsibilities to you are limited to remitting payment successfully received by Tilia from you to the relevant Publisher or user. Tilia is not responsible for any product or service purchased through your use of the Payment Processing Service, or for the amount or validity of any amount that may be charged by the relevant Publisher or user.

If the Payment Processing Service is enabled for a Platform that you use, you will be directed to a Tilia-hosted dialog box after selecting the option on the Platform to make a payment, at which time you will have the option to complete the transaction using one of the payment methods that Tilia supports. The different payment methods supported by the Payment Processing Service, such as credit cards, debit cards, etc., will be determined by Tilia in its sole discretion, and Tilia reserves the right to limit the payment methods made available for any particular transaction.

You may need to have an existing account or other access device in order to use a particular payment method, or meet other specific conditions imposed by the company responsible for offering such payment method (each a "Payment Services Provider" or "PSP"). Additionally, the PSP might have its own terms and conditions (including a privacy policy) that also apply to you and your use of the relevant payment method, even when such payment method is accessed through the Payment Processing Service. Tilia is not responsible for any terms and conditions, privacy policy, other policies and procedures, or any act or omission of any PSP.

In order to conduct a payment through the Payment Processing Service, you will need to provide your payment or account information, and any other information, required by Tilia and the PSP you have selected. The information required and the manner in which your transaction will be processed will vary depending upon the payment method you select. You are responsible for providing accurate transaction and payment information (including any relevant PSP credentials, preferences, or log-in information) in connection with your use of the Payment Processing Service. If you fail to provide accurate transaction or payment information, Tilia will not be able to complete the payment transaction.  You acknowledge that it is your responsibility to ensure that your credit or debit cards or other access devices accepted by Tilia continue to be valid and sufficient for such purposes and remain responsible to Tilia for the amount of any chargeback or returned payment. Without limiting any other rights or remedies of Tilia, Tilia may exercise its termination rights as provided in Section 9 of these Terms in the event of non-payment.
...
* accept and remit payments made by you using the payment methods supported by Tilia for purchases or other transactions enabled for the particular Platform or for amounts owed to the relevant Publisher or user plus any applicable taxes Tilia is required to collect or fees owed to Tilia;
...
* automatically charge, in accordance with the instructions you provide for any recurring payments, the credit or debit card or other payment method you have associated with your Tilia Account in order to pay recurring amounts to the relevant Publisher, as well as any applicable taxes Tilia is required to collect or fees owed to Tilia; and,
* maintain and utilize your PSP credentials, preferences, and log-in information.

**4\. Stored Value Balance**
----------------------------

### **4.1. General**

Tilia may offer a Stored Value Balance associated with your Tilia Account, which is a stored value account issued by Tilia in which you hold funds.

The Stored Value Balance services provided to you by Tilia are a hosted digital balance maintained by Tilia enabling you to store funds or Earned Tokens (defined below) electronically (the "**Stored Value Balance**"); and certain payment services enabling you to do the following:

> a) receive funds or Earned Tokens electronically in accordance with Section 4.2 below (i.e., funds can be received into the Stored Value Balance from you, other Platform users, the Publisher, or as a result of the exchange of Earned Tokens issued by Tilia on a Platform); and,

> b) redeem funds held in the Stored Value Balance in accordance with Section 4.3 below.

Depending on our arrangement with the Publisher, your Stored Value Balance may hold funds denominated in fiat or Earned Tokens, defined in Section 5 below, and we will show the balance that you hold, to the extent applicable. The default fiat for the Stored Value Balance will be United States Dollars (“**USD**”).
...
You will not grant to any third party any security interest in your Stored Value Balance.

### **4.2. Crediting the Stored Value Balance**

When you engage in activities on a Platform that enable you to earn compensation from the Publisher pursuant to the Platform TOS, e.g., creating Digital Goods, completing tasks, or otherwise enhancing the experience of a Platform, you are referred to as a “Creator” and such activity is hereinafter referred to as “Compensable Activity.”  Such compensation can be in the form of a load to your Stored Value Balance (or in the form of Earned Tokens, as defined below, in a token-based economy).

Tilia will fund your Stored Value Balance as instructed by Publisher.  Funding will not take place until Tilia has successfully completed necessary checks to comply with applicable law and its internal risk management processes and only when funds to support the Stored Value Balance load have been received by Tilia from the Publisher.

Depending on the Platform, you may also fund your Stored Value Balance denominated in fiat using any of our supported payment methods, which are set out and available on the Platform, such as credit or debit card or bank transfer.

Any associated fees (if applicable) will be published on the Platform.

Due to legal or regulatory reasons, we may need to impose certain restrictions on the methods you can use to pay money into your Stored Value Balance. We will try to keep you informed of any such changes.

The Stored Value Balance is not a deposit or investment account.

Fund we receive associated with your fiat-denominated Stored Value Balance will be deposited in a secure account, specifically for the purpose of redeeming transactions made from your Stored Value Balance. Funds will not be insured to you by the Federal Deposit Insurance Corporation or any other entity, and you will not be entitled to any interest with respect to such funds. In the event that we become insolvent, funds that you have loaded which have arrived with and been deposited by us are protected against the claims made by our creditors.

### **4.3. Withdrawals and Redemptions**

Subject to compliance with applicable law and our risk management processes, You may redeem all or part of any fiat-denominated balance held in your Stored Value Balance at any time. With respect to a Stored Value Balance denominated in Earned Tokens, only Earned Tokens acquired from the completion of Compensable Activity may be redeemed for fiat, either to fund your fiat-denominated Stored Value Balance or to be paid out directly to Your external financial account.  Digital Tokens that are “unearned” may not be redeemed for fiat.

Subject to compliance with applicable law and our risk management processes, funds will be transferred to your bank account or payment service provider which you have identified to us and which we support. For Earned Tokens, funds will be transferred to your Stored Value Balance denominated in fiat or may be sent directly to Your external financial account that is supported by Tilia. **Prior to loading your Stored Value Balance denominated in fiat, it is your responsibility to determine if funds can be transferred to the relevant payment service provider as certain payment service providers (e.g., PayPal) do not offer services in every jurisdiction.**
...
Prior to redeeming funds from your Stored Value Balance, we may conduct checks for the purposes of preventing fraud, money laundering, terrorist financing and other financial crimes. You may be prevented or delayed from withdrawing funds in the Stored Value Balance until those checks are completed to our reasonable satisfaction in order to comply with our regulatory requirements. If we find that you have been engaged in fraud, money laundering, terrorist financing or other financial crimes, you may lose all rights to any funds derived from such activity.
...
If these Terms are terminated or your Tilia Account is closed for any reason, we will redeem any funds remaining in your Stored Value Balance and transfer funds to the external financial account you have registered with us.
...
If applicable on a particular Platform, where a transaction is initiated from your Stored Value Balance using your security credentials, we will assume that you authorized such transaction, unless you notify us otherwise.
...
Where supported by the Publisher in a token-based economy, the Tilia Service may include Tilia issuing (or managing Publisher’s issuance of) digital tokens to you, which can be used to access services and content within a Platform (“**Digital Tokens**”). Furthermore, Digital Tokens that are acquired by you engaging in Compensable Activities on an applicable Platform are “**Earned Tokens**” and deemed stored value in accordance with Section 4 (Stored Value Balances). If there are any inconsistencies between the two sections, then Section 4 controls. Digital Tokens which may only be used and redeemed for content and services within a Platform are deemed “**Purchased Tokens**.”  Purchased Tokens can never be redeemed for fiat and cannot be utilized outside the Platform for which they are created. Depending on a Platform, Digital Tokens may be used as a mechanism to track Compensable Activities. Earned Tokens and Purchased Tokens will have naming conventions that are specific to a Publisher’s Platform.

The manner in which you obtain access or use the Digital Tokens will depend on the Publisher and will be disclosed to you by the Publisher in the Platform ToS or on the Website.

### **5.2. Accumulating Earned Tokens**

As indicated above, in the case of token-based economies, Creators may also receive compensation in the form of Earned Tokens for Compensable Activities. Earned Tokens are issued by Tilia.  Earned Tokens may be redeemed for fiat (e.g., USD).
...
We may revoke or terminate your access to Digital Tokens (other than Earned Tokens) in the event that:

> a) the Digital Token program is suspended or terminated by the relevant Publisher;

> b) we reasonably suspect or know that fraud or other illegal conduct is associated with your Tilia Account or your use of your Tilia Account or any aspects of the Tilia Service;
...
On Platforms where Publishers pay Creators directly for Compensable Activity, Tilia facilitates the transfer of funds from the Publisher to the Creator's external financial account (each such transfer called a “Disbursement”). All Disbursements are made pursuant to instructions received by Tilia from the Publisher and are subject to applicable law and Tilia’s risk management processes.
...
> a) These Terms of use, including updates to these Terms as discussed above;
...
> d) responses to claims or customer support inquiries filed in connection with your Tilia Account.

We will provide these Communications to you by posting them on the Tilia Website, emailing them to you at the primary email address listed in your Tilia Account, and/or through other electronic communication such as text message or mobile push notification.
...
These Terms shall commence on the date you receive confirmation from us of your successful application for Tilia Services and will continue until terminated by you, the Publisher, or Tilia.

### **9.2. Termination for Cause**

We may: (a) refuse to complete, or block, cancel or reverse a transaction you have authorized (even after funds have been debited from your Stored Value Balance); (b) suspend, restrict, or terminate your access to any or all of the Tilia Service; and/or (c) deactivate or cancel your Tilia Account with immediate effect for cause, including but not limited to where:
...
> iv. we have concerns that a transaction is erroneous or about the security of your Tilia Account or Stored Value Balance or we suspect the Tilia Services are being used in a fraudulent or unauthorized manner;
...
> vii. you breach the relevant Publisher’s terms of service;

> viii. the Publisher of the relevant Platform directs Tilia to terminate your access to any aspect of the Tilia Service;

> ix. use of your Tilia Account or Stored Value Balance is subject to any pending litigation, investigation, or government proceeding and / or we perceive a heightened risk of legal or regulatory non-compliance associated with your activity; and / or
...
We may suspend, restrict, or terminate your access to any or all of the Tilia Service and/or deactivate or cancel your Tilia Account, without reason by giving you two months’ notice. In such event, any funds associated with your Tilia Account will be subject to redemption in accordance with Section 4.3.

### **9.4. Termination by Publisher**
...
Any funds in your Stored Value Balance will be transferred to your external financial account in accordance with these Terms. You must pay immediately all outstanding fees due under these Terms and in the event of a negative balance in the Stored Value Balance, you must reimburse us such amount equal to the negative balance.

### **9.5. Termination – General**

You acknowledge that our decision to take certain actions, including limiting access to, suspending, or closing your Tilia Account, may be based on confidential criteria that are essential for the purposes of our risk management and security protocols. You agree that we are under no obligation to disclose the details of our risk management and security procedures to you.

You are not permitted to use the Tilia Services or your Tilia Account for any other purposes during these periods and we may, at our discretion, limit the functionality of the Website for you accordingly.

If we suspend or close your Tilia Account or terminate your use of Tilia Services for any reason, we reserve the right to require you to re-complete the procedures outlined at Section 2.4 (Identity Verification) before permitting you to transfer funds.

### **9.6. Closing Your Tilia Account**

You may close your Tilia Account at any time by following the instructions in your Tilia Account profile or terminating your account associated with the relevant Platform, unless prohibited by applicable law. Upon terminating your Tilia Account, we will cancel any transactions that you have pending, you will no longer be able to access the Tilia Service, and we will have no further obligation or liability to you under these Terms. Unless Tilia elects to process redemptions of the Stored Value Balance, you shall not be entitled to any compensation or other payment, remedy, recourse or refund upon terminating your Tilia Account. If you have funds associated with a Stored Value Balance, we will process redemptions at our discretion in accordance with Section 4.3.

You may not close your Tilia Account to evade an investigation. If you attempt to close your Tilia Account while we are conducting an investigation, we may hold any unused funds associated with your Stored Value Balance for up to 180 days to protect Tilia, its affiliates, a Publisher, or any other third party against the risk of any reversals, chargebacks, claims, fees, fines, penalties, and other liability. You will remain liable for all obligations related to your Tilia Account even after your Tilia Account is closed.

### **9.7. Abandoned Property**

If you leave funds in your Stored Value Balance unused for the period of time set forth by your state, country, or other governing body of residence in its unclaimed property laws, or if you close your Tilia Account and leave funds in your Stored Value Balance, or if we terminate your Tilia Account and you do not meet any conditions necessary to reinstate it within six (6) months, we may process your funds in accordance with our legal obligations, including by submitting your funds to the appropriate governing body as required by law.
...
**11\. Customer Complaints – Money Transmission Activity**
----------------------------------------------------------

### **11.1. Alaska Users**

If your issue is unresolved by Tilia LLC (855) 983-4646, please submit formal complaints with the State of Alaska, Division of Banking & Securities.
...
### **12.2. Tilia Service Provided on an “As is” Basis**
...
NO VALUE, EITHER EXPRESS OR IMPLIED, IS GUARANTEED OR WARRANTED WITH RESPECT TO ANY CONTENT, INCLUDING DIGITAL TOKENS OR STORED VALUE BALANCES.

Tilia does not ensure continuous, error-free, secure or virus-free operation of the Tilia Service or any component thereof, the Website, Tilia's servers (the "Servers"), or your Tilia Account, and you understand that you shall not be entitled to refunds or other compensation based on Tilia's failure to provide any of the foregoing other than as explicitly provided in these Terms.
...
### **12.3. Tilia Service Interruptions and Data Loss**
...
> e) losses incurred where a law, or guidance or instruction from an governmental authority, requires us to take action, for example to terminate these Terms and close your Tilia Account; or
...
Further, you and Tilia agree that, should resolution of the Dispute(s) occur in arbitration, such Dispute(s) will be arbitrated only on an individual basis and will not be consolidated with any other arbitration or other proceedings that involve any claim or controversy of any other party. But if, for any reason, any court with competent jurisdiction or any arbitrator selected pursuant to this arbitration provision holds that this restriction, limiting the arbitration to Dispute(s) between you and Tilia, is unenforceable, then our agreement above to arbitrate will not apply and the Dispute must be brought exclusively in court pursuant to Section 14.5 (Law and Venue).
...
AAA: 1.800.778.7879 or [www.adr.org](https://www.adr.org/)

JAMS: 1.800.352.5267 or [www.jamsadr.com](https://www.jamsadr.com/)
...
When we change these Terms, the then-current version of these Terms supersedes all prior versions and governs your access to and use of the Tilia Service. If you continue to maintain your Tilia Account or use any portion of the Tilia Service following any change, you are deemed to have accepted and agreed to any changes, as of the effective date of any such change. If you do not wish to be bound to the changes, you must close your Tilia Account (see Section 9.6 for details) and cease using the Tilia Service.
...
All provisions of these Terms which by their nature extend beyond the expiration or termination of these Terms, including, without limitation, the Sections relating to suspension or termination, the Tilia Account cancellation, debts owed to Tilia, general use of the Website, disputes with Tilia, and general provisions will continue to be binding and operate after the termination or expiration of these Terms.

### **14.6. No Equitable or Injunctive Relief**
