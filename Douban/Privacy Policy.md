...
（1）个性化内容推荐。你可以在豆瓣发布、浏览、播放、创建、关注、收藏、点赞、转发、标记有关内容。在你使用豆瓣的过程中，我们会根据你的个人上网记录信息（指通过日志储存的操作记录，包括网站登录记录、访问和浏览记录、点击记录、搜索记录、发布记录、收藏列表等）、广告互动信息、你填写的个人基本资料信息（性别、生日、居住地）、IP地址所属城市信息、设备信息（设备型号、操作系统）、交易记录，通过算法等自动化决策机制分析形成间接用户画像进行精细化运营，并在首页推荐、找书影音、豆瓣猜、发现小组、市集推荐、搜索建议等进行个性化内容推荐的场景中，为你推荐与你相关程度更高的动态、广播、日记、话题、讨论、小组、书影音条目、评论、运营活动、商品信息、搜索建议词等内容，有的可能不是你喜欢的内容。
...
你可以使用推送功能，为了将私信、回复、被关注、小组热门内容、书影音资源上架等通知消息推送到你的手机桌面，我们会收集和使用你的网络信息（接入网络的方式、类型、状态、网络质量数据、运营商信息）、设备信息（设备型号、硬件配置、操作系统、系统设置、用户标识ID、软件版本号），以保障功能实现。
