...
* [FAQ](https://www.buff.game/faq/)
    ...
    * [Buff Blog](https://www.buff.game/blog/)
    * [Players’ POV](https://www.buff.game/a/community)
* [Contact us](https://www.buff.game/contact-us/)
* [Premium](https://www.buff.game/premium/)
* [Buff Affiliate](https://www.buff.game/affiliates-program/)
* [Download (Windows)](https://download.overwolf.com/install/Download?PartnerId=3762)
...
BUFF reserves the right to authenticate and validate your information through Discord, Gmail and any social networks or other methods and to request any additional information as it may deem required at its sole discretion. BUFF may also, at its sole discretion, refuse the registration of any User.

For more information on what information, we collect and how we treat it please review our BUFF’s [Privacy Policy](https://www.buff.game/buff-privacy-policy/).
...
Refund/Cancellation: If you want to cancel an order then please contact us as soon as possible, [https://www.buff.game/contact-us](https://www.buff.game/contact-us/).  If your order has not been processed yet, we may be able to cancel your purchase and you will get a refund.
...
Buff may host community challenges from time to time. Participating users will have a chance to win different prizes. These challenges may be hosted in different formats, including but not limited to Community Showdown, a leaderboard-type challenge in which the top pre-decided number of players win the challenge prize. These challenges may be hosted in different regions, as announced per challenge. Users outside the participating regions will be prohibited from participating. The run dates of each challenge will be published separately. Buff reserves the right to terminate the campaign at any time at its sole discretion without any notice. Prizes and rewards will differ between each challenge. Users may be required to provide a valid shipping address within the region participating in the contest in order to receive physical prizes. The rewards of each challenge may be changed by Buff, in their sole discretion and without prior notice. Buff may disqualify any winner that does not, in its sole discretion, satisfy the foregoing requirements. Additionally, Buff has the right to exclude and disqualify any accounts which are suspected of fraud or any manipulation. Buff shall have no obligation to justify or explain the disqualification of any user. Games will also differ between each challenge and will be announced separately. Some challenges may include several games. Some game modes (within the participating games) may be prohibited (announced per challenge). Only eligible game modes can participate. Media Share- You may be given an option to share highlights from your gameplay to social media (mainly Twitter). Subject to the foregoing, by sharing any content related to such programs, participants grant Buff, and relevant challenge associates and their agents a worldwide, exclusive, royalty-free, perpetual and irrevocable license to copy, modify, create derivative works, publish, display, broadcast, rebroadcast, and distribute such content for any purpose, including but not limited to their name and likeness. Buff shall not be liable for any delay in performing or partial or total failure to perform any of its obligations to the participants under the challenge rules if such delay or failure is caused by circumstances beyond its reasonable control including without limitation delays, changes, disruptions, cancellations, diversions or substitutions however caused, including without limitation, as a result of war, terrorist action, strikes, hostilities, civil commotions, accidents, fire, flood or natural catastrophes. Buff may amend the Official Challenge Rules at any time in its sole discretion by posting an amended version thereof.
...
You may terminate your use of the BUFF Service at any time by sending an email through [https://www.buff.game/contact-us](https://www.buff.game/contact-us/) , following which BUFF will deactivate your Profile. Upon the deactivation of your Profile BUFF shall delete all your information from our systems, except for certain information required for archival purposes as further detailed in our Privacy Policy [https://www.buff.game/buff-privacy-policy](https://www.buff.game/buff-privacy-policy/)/.
...
* [Games](https://www.buff.game/#games)
* [Gamers' POV](https://www.buff.game/#pov)
* [Contact us](https://www.buff.game/contact-us/)
* [Premium](https://www.buff.game/premium)
* [Buff Affiliate](https://www.buff.game/affiliates-program/)
...
* [DOTA 2](https://www.buff.game/dota-2/)
* [COD Warzone](https://www.buff.game/cod-warzone/)
* [Rocket League](https://www.buff.game/rocket-league/)
* [Clash Royale](https://www.buff.game/clash-royale/)
* [Valorant](https://www.buff.game/valorant/)
* [Fortnite](https://www.buff.game/fortnite/)
* [League of Legends](https://www.buff.game/league-of-legends/)
* [Apex Legends](https://www.buff.game/apex-legends/)
...
[Discord](https://discord.gg/z5nmgbZZXw)
...
| trustedsite\_visit | 1 day | This cookie is set by the provider McAfee for website security. This cookie is used for storing the number of visits. |
...
| Cookie | Duration | Description |
| --- | --- | --- |
| \_rdt\_uuid | 3 months | No description available. |
