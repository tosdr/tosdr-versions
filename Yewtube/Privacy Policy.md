...
[](https://yewtu.be/toggle_theme?referer=%2Fprivacy "Toggle Theme")

[](https://yewtu.be/preferences?referer=%2Fprivacy "Preferences")

[Log in](https://yewtu.be/login?referer=%2Fprivacy)
...
Users can clear their watch history using the [clear watch history](https://yewtu.be/clear_watch_history) page.
...
To remove data that has been stored in the website's database, you can use the [delete my account](https://yewtu.be/delete_account) page.

[Original source code](https://github.com/iv-org/invidious) / [Modified source code](https://github.com/unixfox/invidious-custom) [Documentation](https://github.com/iv-org/documentation)
...
[Donate](https://yewtu.be/donate) Current version: 2024.10.26-48f84f1 @ master