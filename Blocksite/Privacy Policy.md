...
![People Cards Right](https://blocksite.co/wp-content/uploads/2024/02/right-teal-bg.93565222.svg)
...
| Identifiers | Includes direct identifiers, such as name, alias, account number or unique personal identifier; email address,      and other contact information; IP address and other online identifiers. | Affiliates      Advisors and agentsAdvertising networksData analytics providersSocial networksRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
| Customer Records | Incudes information such as name, user ID, account name, contact information, and other similar information. | Affiliates      Advisors and agentsRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
| Internet and Electronic Network Activity Information | Includes browsing history, clickstream data, search history, and information regarding interactions with our website and services, advertisements, or emails, including other usage data related to your use of any of our services or other similar online services. | Affiliates      Advisors and agentsRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
| Commercial Information | Includes records of products or services purchased, obtained, or considered, or other purchasing or use histories or tendencies. | Affiliates            Advisors and agentsRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
| Location Data | Such as general location information about a particular individual or device. | Affiliates            Advisors and agentsRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
| Audio, Video, and other Electronic Data | Includes audio, electronic, visual      and call recordings (e.g., of customer support calls). | Affiliates           Advisors and agentsRegulators, government entities, and law enforcement (if required to do so by law or court order)Others as required by law |
...
Reveal My Distractions](https://user.blocksite.co/suggestions-lp?utm_source=Privacy%20Policy%20Website%20and%20App)