...
Being part of Alignable means sharing information about yourself with other individuals and businesses, communicating with them, as well as working privately on your own. By default, your account is set up to share the information that we have found the vast majority of our Users are interested in sharing. But the amount and type of information you decide to share, and with whom you share it, is up to you. If you are not yet a part of Alignable (i.e. you have not setup an account using your email address and accepted our Terms of Service), and have questions on what information we collect and use please read our [cookie policy for non-members.](https://www.alignable.com/visitor-cookie-policy)

You can submit a request to download or delete your data. Please allow between 24-48 hours for our team to fulfill your request. If you request for your data to be deleted and have an account, your account will also be deactivated. [Submit a request to download or delete my data.](https://my.datasubject.com/6oZkySU6x8o31KAL/5611)
