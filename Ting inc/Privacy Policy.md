...
While you’re using this site, we collect the following information about you:

* Usage activity about how you interact with it, such as what content you viewed and which areas you visited;
    
* Information about your computer such as your IP address, browser type, referring/exit pages, and operating system;
    
* Anything you put into a form on this site.
    

In order to provide you with Internet and service for that Internet, we also collect the following personal information from you when you’re our customer or in other situations like when you’re still just considering if you’re going to be our customer:

* Contact information such as your name, email address, mailing address, service address, and phone number;
    
* Billing Information such as credit card number and billing address;
    
* Other unique Identifiers such as your user name, account number, and a hash of your password (this means we can’t see your actual password).
    

We use this information to:

* See how well we're doing with website design;
...
* Send you communications about how to use our services;
...
* Respond to your questions and concerns.  
    ...
    Be aware, this Privacy Statement does not apply to any third-party application or equipment providers: this means any equipment or app you may use with Ting Internet services but that are not controlled by us. If you set up an account with or receive services from one of these third parties, you will be subject to that third party’s privacy policy, terms and conditions, and acceptable use policy.  
    ‍
...
You may choose to stop receiving our newsletter or marketing emails by following the unsubscribe instructions included in these emails or you can [contact us](https://ting.com/contact-us).
...
We provide your personal information to our networking partners when you choose our internet so that they can provide equipment and technology to you at your specified address. We also use certain software vendors to manage our customer support, credit card processing, and fraud detection. Our contracts with each of these companies requires them to keep your information safe and secure and not to share the information with anyone other than Ting Internet. We take this seriously and only select partners we think we can trust with your information. We do not sell your information. We also don’t share your information with anyone we think will use it to market to you. The current list of third parties who may have access to information you give to us is:  
• Alianza  
• Amazon Connect  
• Apsona  
• Atlassian (Jira)  
...
We use technologies such as cookies to gather information about how you and others interact with our website. For example, we will know how many people access specific areas or features within our site and which links they clicked on. We use this aggregated information to understand and optimize how this site is used and to provide content and features that are of use and interest to you.
...
If you have any questions about security, you can [contact us.](https://ting.com/contact-us)

Data retention
--------------

We will retain your information for as long as your account is active or as needed to provide you services, fulfill our legal obligations, resolve disputes, and enforce our agreements. If you wish to cancel your account or request that we no longer use your information to provide you services, please [contact us](https://ting.com/contact-us).

Other information
-----------------

Our Web site includes publicly accessible blogs or community forums. You should be aware that any information you provide in these areas may be read, collected, and used by others who access them. To request removal of your personal information from our blog or community forum, [contact us](https://ting.com/contact-us). In some cases, we may not be able to remove your personal information, in which case we will let you know if we are unable to do so.
