...
[Text-to-Image](https://dezgo.com/txt2img)

[Controlled Text-to-Image](https://dezgo.com/controlnet)

[Image-to-Image](https://dezgo.com/image2image)

[Upscale](https://dezgo.com/upscale)

[Inpainting from text](https://dezgo.com/text-inpainting)

[Edit image from text](https://dezgo.com/edit-image)

[Remove background](https://dezgo.com/remove-background)

[Text-to-video \[BETA\]](https://dezgo.com/text2video)

* * *

[FAQ / Support](https://dezgo.com/info/faq)
...
[Twitter](https://twitter.com/dezgo)

[Discord](https://discord.gg/RQrGpUhPhx)
...
Dezgo offers a Software as a Service (SaaS) platform, enabling users to execute complex programs without the need for configuring or installing software and hardware. This is achieved by leveraging our computing resources and infrastructure.

  

This encompasses, but is not limited to, Artificial Intelligence (AI) services.

  

Access to the Service is granted via a web interface and a remote API, both of which are governed by the terms of this Agreement. Additionally, users are bound by the fees and charges in place at the moment of each request.

  

It is essential to understand that Dezgo does not guarantee the accuracy or completeness of the AI software's results. Users are responsible for validating these results and determining the subsequent actions.

  

Charges are based on the execution and computing resources consumed to run an algorithm or program. You are billed for this consumption irrespective of the correctness, adequacy, or satisfaction derived from the results.
...
Unless expressly stated in these Terms, all charges and payments are non-refundable, non-cancellable, and non-creditable, even if your Services are suspended, terminated, or transferred before the end of the Service term.

  

Billing operates on a prepaid account basis. You can top up your account at any time using any of the payment methods available on the Site. Once your payment is confirmed, your account will be credited with the amount paid. You can use the funds in your account to pay for any of the Services available on the Site.

  

Prepaid credit balances do not expire and are not subjected to any fees or charges.

  

The cost of each request sent to the Service will be deducted from your account balance.

  

You can preview the cost of your request before submitting it to the Service in the top right corner of the page.

  

The Company reserves the right to change any of the following:

\- the list of payment methods available on the Site.

\- the fees and charges associated with the payment methods on the Site.

\- the fees and charges associated with the Services on the Site.

\- the fees and charges related to account balances or expiration of balances.

\- the discounts and promotions available on the Site.
...
\- ensuring the security of your account, which includes any API keys, passwords, and access to the email address linked to your account.

  

The Company shall not be held liable for any failures in securing your account or for any unauthorized use of your account.

  

You agree to maintain a positive balance at all times. Should your balance become negative, you commit to paying the Company the amount of the negative balance promptly upon demand.

  

In case of a payment dispute, the disputed amount will be deducted from your Dezgo account balance, accompanied by a $25 USD fee.
...
This Agreement and any dispute or claim arising out of or in connection with it or its subject matter or formation shall be governed by and construed in accordance with the laws of France, to the exclusion of conflict of law rules.
...
Dezgo SAS is a simplified limited liability company with capital of €1,000 ; registered under no. 951 132 968 RCS Paris and whose registered office is situated at 60 rue François 1er, 75008 Paris, France.

  

The site is hosted by Cloudflare, Inc., located at 101 Townsend Street San Francisco, CA 94107 United States. Phone: +1 (650) 319-8930

  

#### CONTACT INFORMATION

If you have any questions about this Agreement, please contact us through our online contact form below:
