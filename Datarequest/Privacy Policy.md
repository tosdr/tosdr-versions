...
[#](#general-remarks "Link to this heading")
...
[#](#controller-and-contact-information "Link to this heading")
...
[#](#do-not-track "Link to this heading")
...
[#](#profiling "Link to this heading")
...
[#](#collected-data "Link to this heading")
...
[#](#data-we-process-automatically "Link to this heading")

#### Server connection data

[#](#server-connection-data "Link to this heading")
...
* Data disclosure: Our servers are operated by the following companies. They are exclusively EU companies, which we have carefully selected to meet our high data protection standards.
    * [Hetzner Online GmbH](https://www.datarequests.org/company/hetzner/), Industriestraße 25, 91710 Gunzenhausen, Germany ([privacy policy](https://www.hetzner.com/rechtliches/datenschutz))
    * [Uberspace](https://www.datarequests.org/company/uberspace/), Jonas Pasche, Kaiserstraße 15, 55116 Mainz, Germany ([privacy policy](https://uberspace.de/en/about/privacy/))
    * [BunnyWay d.o.o.](https://www.datarequests.org/company/bunnycdn/), Cesta komandanta Staneta 4A, 1215 Medvode, Slovenia ([privacy policy](https://bunnycdn.com/privacy))

#### Records in our company database

[#](#records-in-our-company-database "Link to this heading")
...
[#](#data-you-provide-to-us "Link to this heading")

#### User content (like comments and contributions to our company database)

[#](#user-content-like-comments-and-contributions-to-our-company-database "Link to this heading")
...
[#](#error-reports "Link to this heading")
...
[#](#membership-fees "Link to this heading")
...
[#](#single-and-recurring-donations "Link to this heading")
...
[#](#contacting-us "Link to this heading")
...
[#](#newsletter "Link to this heading")
...
[#](#external-services "Link to this heading")

In order to make our servives more interesting and efficient, we work with some external services.

#### CoinGate

[#](#coingate "Link to this heading")

We allow you to make payments to the association (especially donations and membership fees) through the payment gateway CoinGate. CoinGate is run by [UAB “Decentralized”](https://www.datarequests.org/company/coingate/), A. Goštauto g. 8, LT-01108 Vilnius, Lithuania.  
...
[#](#mollie "Link to this heading")

We allow you to make payments to the association (especially donations and membership fees) through the payment gateway CoinGate. Mollie is run by [Mollie B.V.](https://www.datarequests.org/company/mollie/), Keizersgracht 313, 1016 EE Amsterdam, Netherlands.  
...
[#](#paypal "Link to this heading")

We allow you to make payments to the association (especially donations and membership fees) through the payment gateway PayPal. PayPal is run by [PayPal (Europe) S.à.r.l. et Cie, S.C.A.](https://www.datarequests.org/company/paypal/), 22-24 Boulevard Royal L-2449, Luxembourg.  
...
[#](#your-rights "Link to this heading")
...
[#](#right-to-data-access "Link to this heading")
...
[#](#right-to-data-portability "Link to this heading")
...
[#](#right-to-rectification "Link to this heading")
...
[#](#right-to-erasure-right-to-be-forgotten "Link to this heading")
...
[#](#right-to-revoke-given-consent "Link to this heading")

According to Art. 7(3) GDPR you have the right to revoke your consent given to us at any time.

### Right to restriction of processing

[#](#right-to-restriction-of-processing "Link to this heading")
...
[#](#right-to-notification-to-recipients "Link to this heading")
...
[#](#right-to-object "Link to this heading")
...
[#](#right-to-lodge-a-complaint-with-a-supervisory-authority "Link to this heading")
...
[Die Landesbeauftragte für den Datenschutz Niedersachsen](https://www.datarequests.org/supervisory-authority/dendslfd/)  
Prinzenstraße 5  
30159 Hannover  
Germany
