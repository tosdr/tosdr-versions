...
[About](https://community.lambdageneration.com/about)[Rules](https://community.lambdageneration.com/rules)[Contact](https://community.lambdageneration.com/contact)

LambdaGeneration Terms of Service
=================================
...
* **Organization** (referred to as either "the Organization", "We", "Us" or "Our" in this Agreement) refers to LambdaGeneration.
* **Content** refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.
* **Country** refers to United States.
* **Feedback** means feedback, innovations or suggestions sent by You regarding the attributes, performance or features of our Service.
* **Promotions** refer to contests, sweepstakes or other promotions offered through the Service.
* **Service** refers to the Website.
* **Terms** mean these Terms of Service that form the entire agreement between You and The Organization regarding the use of the Service.
* **Community Rules** refers to our Community Rules available at [https://community.lambdageneration.com/rules](https://community.lambdageneration.com/rules)
* **Privacy Policy** refers to our Privacy Policy available at [https://community.lambdageneration.com/privacy](https://community.lambdageneration.com/privacy)
* **Third-party Social Media Service** means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.
* **Website** refers to LambdaGeneration, accessible from [https://community.lambdageneration.com/](https://community.lambdageneration.com/)
* **You** means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.

Your Access to the Service
--------------------------

These are the Terms governing the use of this Service and the agreement that operates between You and The Organization. These Terms set out the rights and obligations of all users regarding the use of the Service.

Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service.

By accessing or using the Service You agree to be bound by these Terms. If You disagree with any part of these Terms then You may not access the Service.

By accessing or using the Service You agree that You are 13 years of age or older.  If You are in the European Economic Area, You must be over the age required by the laws of Your country to create an account or otherwise use the Service, or we need to have received verifiable consent from Your parent or legal guardian.

If You are accepting these Terms and using the Service on behalf of a company, organization, government, or other legal entity, You represent and warrant that You are authorized to do so and have the authority to bind such entity to these Terms, in which case the words "You" and "Your" as used in these Terms shall refer to such entity.
...
As a condition of Your use of the Service, and without limiting Your other obligations under these Terms, You agree to comply with the restrictions and rules of use set forth in these Terms and our Community Rules as well as any additional restrictions or rules set forth in the Service. As an example, you agree not to use the Service in order to:

* Post, upload, transmit or otherwise disseminate information that is objectionable as outlined in our Community Rules.
* Defame, libel, ridicule, mock, stalk, threaten, harass, intimidate or abuse anyone.
* Engage in conduct that is fraudulent or unlawful or promotes unlawful activity or otherwise harmful to LambdaGeneration or any other user.
* Attempt to obtain passwords or other private information from other members.
* Violate the privacy of any third person.
* Impersonate any person or entity including The Organization and its employees or representatives.
* Engage in spam, machine – or randomly – generated, constituting unauthorized or unsolicited advertising, chain letters, any other form of unauthorized solicitation, or any form of lottery or gambling.
* Upload or transmit (or attempt to upload or transmit) viruses, worms, malware, trojan horses, or other content that is designed or intended to disrupt, damage, or limit the functioning of any software, hardware or telecommunications equipment or to damage or obtain unauthorized access to any data or other information of a third person.
...
* Improperly use support channels or complaint buttons to submit false reports to us.
...
Although regular backups of Content are performed, The Organization do not guarantee there will be no loss or corruption of data.
...
The Service may also link to third-party web sites or contain embeds of third-party web sites to facilitate its provision of services to you. Such third-party web sites or services are not owned or controlled by The Organization.
...
We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services that You visit or view.

Termination
-----------

We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms or our Community Rules.
...
* [Rules](https://community.lambdageneration.com/rules)
...
* [Twitter/X Bot](https://twitter.com/LambdaGenPosts)
* [Old Site](https://archive.lambdageneration.com/)

[](https://twitter.com/LambdaGen "Twitter")[](https://www.facebook.com/lambdageneration "Facebook")[](https://www.youtube.com/user/lambdagen "YouTube")[](https://discord.gg/2FcPh6j "Discord")

Made with ❤️ + 

 (+ ☕)

© LambdaGeneration 2024   LambdaGeneration is not affiliated with Valve Corporation.