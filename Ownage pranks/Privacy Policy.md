...
2. [TERMS OF SERVICE AGREEMENT & PRIVACY AGREEMENT](https://www.ownagepranks.com/tos-privacy-policy/)

TERMS OF SERVICE AGREEMENT & PRIVACY AGREEMENT
----------------------------------------------
...
4. You may not impersonate another person/company or represent yourself as affiliated with Ownage Labs or Ownage Labs’s staff.
...
7. You may not use URLs in your screen name or posts without prior written consent from Ownage Labs.
...
10. Ownage Labs does not control, is not responsible for and makes no representations or warranties with respect to any Content.
...
3. You may not create or submit unwanted email, messages, or comments to any Ownage Labs users ("Spam").
...
1. This Agreement’s Terms are concluded between you and Ownage Labs, and not with App Provider, and that, as between us and the App Provider, Ownage Labs is solely responsible for the Service.
...
5. In the event of any third-party claim that the Service or your possession and use of the Service infringes that third party’s intellectual property rights, Ownage Labs will be solely responsible for the investigation, defense, settlement, and discharge of any such intellectual property infringement claim to the extent required by these Terms.
...
7. Ownage Labs hereby grants you a limited, revocable, non-sublicensable license to reproduce and display the Ownage Labs Content (excluding any software code) solely for your personal use in connection with viewing postings and using the Service.
8. User acknowledges that it does not acquire any ownership rights by accessing or otherwise using copyrighted material. Except as provided within this Agreement, you may not copy, modify, create derivative works, publicly display, publicly perform, or digitally transmit any part of the Service.
...
11. By Posting to the Service, you waive any right to send a copyright-related or terms of service-related account “strike” on any of Ownage Labs’ third-party accounts based on the Content you Posted, or any work derived from that Content.
...
Ownage Labs’s Designated Agent to receive notification of alleged infringement under the DMCA can be contacted [via this form.](https://www.ownagepranks.com/contact-us/) Upon receipt of proper notification of claimed infringement, Ownage Labs will follow the procedures outlined herein and in the DMCA.
...
2. Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit Ownage Labs to locate the material;
3. Information reasonably sufficient to permit Ownage Labs to contact the complaining party, such as an address, telephone number, and, if available, an email address at which the complaining party may be contacted;
...
|     |     |     |
| --- | --- | --- |
| What Types of Personal Information | How/ When Personal Information is Collected | Why (Purpose) for Collection of Personal Data |
| Your or Requestor’s Contact Information (e.g., full name, birthdate, email address, and/or phone number) | * When you create an account on our Website or App.<br>* When you sign up to receive our newsletter. <br>* surveys and sign up for Our contests.<br>* When you submit a prank request. | * To provide you with our Services. <br>* To send You information about our Services; and/or information which You have requested (such as our newsletter) in accordance with Your specified preferences<br>* To customize your experience while using the Services. <br>* For internal analytics purposes, to analyze your use of our Services.<br>* To obtain authorization to share your call.<br>* For marketing purposes. |
| Requestor’s Payment Information (e.g. name, credit card number, billing address, billing zip code) | * You input this information when making a purchase on the Services.<br>* You input this information when making a prank request. | * To provide the Services requested by You. <br>* Payment information is required to complete the purchasing process. |
| Prank Recipient’s Contact Information and Background Information (e.g., name, phone number, state of residence, relationship with Requestor, and Prank Recipient’s personality traits) | * Requestor submits this information when submitting a prank request. | * To provide the Services requested by You.<br>* To obtain authorization to share Your call.<br>* For internal analytics purposes; to analyze your use of the Services.<br>* For marketing purposes. |
| Call Recording (only available on the App) | * Requestor must enable this setting on the App. Note that Call Recordings are only accessible by Requestor. Requestor may choose to share Call Recordings voluntarily. | * To provide the Services requested by You. |
| Information Collected from Third-Parties (e.g., name, account information, profile picture, phone number, email address, gender, date of birth and friends lists) | * create or log into your account through a social media site, we will have access to certain information from that site.<br>* Our mobile applications that are distributed through various "app" stores may also request permission to automatically collect other information from your mobile device, including your email address. We may only collect this information with your authorization in accordance with your device operating system's permission process. | * To provide the Services requested by You.<br>* To customize your experience while using the Services. |
...
|     |     |     |
| --- | --- | --- |
| What Types of Personal Information | How Personal Information is Collected | Purposed for Collection of Personal Data |
| Usage information including details of Your visits to our website or services (e.g. links you’ve clicked on, content response times, location data, logs, and other similar communication data and statistics about your interactions) | This information is automatically collected when You visit our website. | To improve and develop Our website and to enable us to improve our website, offer new features and material etc. |
| Device information includes information about Your computer and internet connection, including your Internet Protocol address, operating system, and browser type. | This information is automatically collected when You visit our website. | To provide our Services to you; To protect this website, our App, our company, our employees, and our users from malicious attacks, hacking, fraud, or other illegal or unauthorized activity |
| Location Information (only available on the App) | Your location may be collected if you enable Location settings on our App. | To improve and personalize the Services for You. |
...
You can generally opt-out of receiving personalized ads from third-party advertisers and ad networks who are members of the Network Advertising Initiative (NAI) or who follow the Digital Advertising Alliance’s Self-Regulatory Principles for Online Behavioral Advertising (DAA) by visiting the opt-out pages on the NAI website ([http://optout.networkadvertising.org](http://optout.networkadvertising.org/)) and DAA website ([http://www.aboutads.info/choices/](http://www.aboutads.info/choices/)).
...
* Contact Us: Subject to the Privacy Rights Section below, you may contact us to access, update or delete your personal information by contacting us [here](https://www.ownagepranks.com/contact-us/).
