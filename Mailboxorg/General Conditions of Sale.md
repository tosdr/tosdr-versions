[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation68)

* [Home](https://mailbox.org/en/ "Secure e-mail for private and business customers")

 

[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation140)
...
[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation2)
...
[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation58)
...
This English version is only for your convenience. The [German version](https://mailbox.org/de/agb-widerrufsbelehrung "Go to the German T&C and cancellation policy") is legally binding.
...
_Lapse of cancellation right  
_Your right to withdraw from this contract also expires when we begin performing the complete service before expiry of the cancellation period with the expressed agreement of the service user or the service subscriber has himself initiated the same.

  
_Model withdrawal form  
_(complete and return this form only if you wish to withdraw from the contract)
...
[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation152)
...
[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation153)
...
[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation154)

* [Legal information](https://mailbox.org/en/legal-information "Legal information")
* [Data protection](https://mailbox.org/en/data-protection "Data protection")
* **T&Cs | Cancellation policy**

 

* [DE](https://mailbox.org/de/agb-widerrufsbelehrung "AGB | Widerrufsbelehrung")
* **EN**

[Skip navigation](https://mailbox.org/en/t-cs-cancellation-policy#skipNavigation98)
