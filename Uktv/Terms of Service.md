...
1.3 These Terms and Conditions apply regardless of the type of device you use to access the Digital Services, for example computer, laptop, mobile phone or tablet. They also apply when you access the Digital Services from a social networking service, although you need to be aware that the social networking service's own terms of use (and privacy and cookie policies) may also apply.

##### 2 OUR DIGITAL SERVICES

2.1 All rights, including without limitation, copyright, database rights and trade mark rights in the Digital Services and its contents, whether audio, text, images, video or any other form (**"Content"**), are owned by or licensed to UKTV, or otherwise used by UKTV as permitted by applicable law. The Content is protected by copyright laws and treaties around the world. All such rights are reserved to UKTV and/or our licensors.

2.2 We give you permission to stream, access and view the Content on the Digital Services, provided you comply with these Terms and Conditions. You agree that your permission to stream, access and view the Content on the Digital Services is solely for your own private personal and domestic use and not for any commercial, business or public use purposes. You agree that you may not copy, reproduce, republish, download, post, adapt, create a derivative work from, distribute, store in any medium (including in any other website), broadcast, transmit, re-transmit, modify, or show in public all or any part of the Content without the prior written permission of UKTV or in accordance with the Copyright, Designs and Patents Act 1988. You must not use any illustrations, photographs, video or audio sequences or any graphics separately from any accompanying text. In addition, you may notdisplay any of the Content surrounded or framed or otherwise surrounded by material not originating from Us without Our consent. You may temporarily download, display and use the Content in accordance with these Terms and Conditions only on a single device screen at a time. Any use of the Content not expressly permitted by these Terms and Conditions is prohibited unless authorised in writing by UKTV.

2.3 If you print off, copy or download any part of the Digital Services in breach of these Terms and Conditions, your right to use the Digital Services will cease immediately and you must, at our option, return or destroy any copies of the materials you have made.

2.4 We may use content security technology or use other content protection measures. You agree that you will not circumvent, try to adjust or otherwise interfere with our security technology for any reason.

2.5 You agree not to make Content available on unauthorised websites or software applications and not to share content on P2P networks without our permission. We remind you that such conduct is prohibited by law.

2.6 The names, images and logos identifying UKTV and its businesses or third parties and their products and services are proprietary marks of UKTV and/or third parties. Nothing contained in these Terms and Conditions shall be construed as conferring any licence or right under any trade mark of UKTV or any other third party.

##### 3 REGISTRATION & YOUR PRIVACY

3.1 In order to access certain features and enjoy the full benefit of what Our Digital Services have to offer you will need to register with Us and create a user account (**"Account"**), which will require you to submit certain personal data. We take your privacy seriously. Please see our [Privacy Policy](https://corporate.uktv.co.uk/legal/privacy-policy) and Cookie policies for more information, including how and for what purposes UKTV will process the personal data you submit in the registration process or as otherwise may be requested or collected from time to time, and what rights you have in relation to your personal data.

3.2 You may not apply for or create more than one Account per email address without our prior written approval.
...
4.3 You will not, nor will you encourage any other party to, make any statement or introduce any content on, or in relation to, the Digital Services which includes:
...
5.2 Contributions submitted and/or read by minors are subject to the consent of their parent or guardian. We advise parents or guardians who permit minors to use the Digital Services that it is important to communicate with the minors about their safety online.

##### 6 OTHER TERMS & CONDITIONS

6.1 Other terms and conditions apply to Our competitions and other interactions by you with the Digital Services. If you wish to take part in any competition which is run on or through the Digital Services (**"Competition"**) you must at the time of entry confirm your agreement to be bound by the general competition rules ([UKTV General Competitions Terms & Conditions](https://corporate.uktv.co.uk/legal/competition-terms-conditions)) and any other competition specific rules that may apply from time to time and are made available to you as stated in a 'Competition Notice'. In respect of any other interaction, you will be asked to confirm your consent to any specific terms and conditions at the time. In the event of any inconsistency between such competition terms or other specific terms (collectively "Special Terms") and these Terms and Conditions, the Special Terms will apply.
...
7.1 While We take every care to ensure that the information on the Digital Services is accurate and complete, some of it is supplied to Us by third parties and We are unable to check its accuracy or completeness. You are advised to verify the accuracy of any information before relying on it. Further, the Digital Services, the Content and the information, names, images, video clips, pictures, logos and icons regarding or relating to UKTV, its products and services (or

to third party products and services), is provided "AS IS" and on an "AS AVAILABLE" basis without any representation or endorsement made and without warranty of any kind whether express or implied, including but not limited to the implied warranties of satisfactory quality, fitness for a particular purpose, non-infringement, compatibility, availability, security and accuracy. If there is a problem with the Digital Services, please contact Us as soon as reasonably possible. We will supply the Digital Services in conformity with these Terms and Conditions. There are certain legal rights you have and nothing in these Terms and Conditions will affect your legal rights. For more information on your rights as a consumer in the UK, please do visit the Citizens Advice website [www.citizensadvice.org.uk](https://www.citizensadvice.org.uk/) or call 0808 223 1133.
...
(ii) loss or damage not caused by Our breach or negligence;
...
* email to: [viewers@uktv.co.uk](mailto:viewers@uktv.co.uk)
* post to: UKTV, PO BOX 6996, CARDIFF, CF15 5DS
* phone: 020 3192 0504

11.2 The Digital Services include live and on-demand programme services. Ofcom is the regulator for the editorial content of broadcast and on-demand programme services. More information can be found at [ofcom.org.uk](https://www.ofcom.org.uk/about-ofcom/what-we-do/contact-us/).

11.3 The Digital Services contain advertising. The Advertising Standards Authority is the regulator for advertising across all media. More information can be found at [www.asa.org.uk](https://www.asa.org.uk/) and you can write to the Advertising Standards Authority at Advertising Standards Authority Ltd / Committees of Advertising Practice Ltd, Castle House, 37-45 Paul Street, Shoreditch, London, EC2A 4LS.