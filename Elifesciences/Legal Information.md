...
This Privacy Notice relates to data held and processed by eLife Sciences Publications, Ltd. For all queries relating to personal data and privacy, please contact us at [data@elifesciences.org](mailto:data@elifesciences.org).

General website users
---------------------

1. [What is your personal data used for, and why?](#users-for)
2. [What types of personal data do we hold?](#users-hold)
3. [Who do we share the data with, and why?](#users-share)
4. [How do we keep the data confidential?](#users-confidential)
5. [How long do we retain the data for?](#users-long)
6. [Your rights](#users-rights)
...
To exercise these rights please contact [data@elifesciences.org](mailto:data@elifesciences.org).
...
This section of the notice deals specifically with personal information held by eLife about the authors of manuscripts submitted for review. You should also refer to the [general website user section](#users) of the notice, that relates to all users of our website, and not just those submitting manuscripts.

1. [What is your personal data used for, and why?](#authors-for)
2. [What types of personal data do we hold?](#authors-hold)
3. [Who do we share the data with, and why?](#authors-share)
4. [How do we keep the data confidential?](#authors-confidential)
5. [How long do we retain the data for?](#authors-long)
6. [Your rights](#authors-rights)
...
This section of the notice deals specifically with personal information held by eLife about editors and reviewers  (editors include guest editors as well as members of the editorial board). You should also refer to the [general website user section](#users) of the notice , that relates to all users of our website.

1. [What is your personal data used for, and why?](#editors-for)
2. [What types of personal data do we hold?](#editors-hold)
3. [Who do we share the data with, and why?](#editors-share)
4. [How do we keep the data confidential?](#editors-confidential)
5. [How long do we retain the data for?](#editors-long)
6. [Your rights](#editors-rights)
