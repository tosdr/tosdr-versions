...
**We are Casa Inc. (“Casa”, “we”, “us” or “our”). Please read these Terms of Service (together with our** [**Privacy and Data Protection Policy**](https://keys.casa/privacy)**, the “Terms of Service” or “Terms”) fully and carefully before using** [**https://casa.io/**](https://casa.io/) **(the “Site”), our mobile applications for iOS and Android (each, an “App”), and the services, features, products, content or applications offered by Casa (together with the Site and the Apps, the “Services”).**

### 1\. Acceptance of Terms of Service  

1. These Terms of Service are a binding contract between you and Casa. By registering for and/or using the Services in any manner, including but not limited to visiting or browsing the Site or downloading one or both of the Apps, you agree to and accept these Terms of Service and all other rules, policies and procedures that may be published from time to time on the Site or such Apps by us, each of which is incorporated by reference and each of which may be updated from time to time.  
    
2. These Terms of Service apply to all users of the Services, registered or otherwise. Certain of the Services may be subject to additional terms and conditions specified by us from time to time; your use of such Services is subject to those additional terms and conditions, which are incorporated into these Terms of Service by reference. For example, additional terms and conditions may apply to you if you have purchased a Product, subscribed to a Paid Service (each term defined below); any such terms and conditions are hereby deemed a part of these Terms of Service.  
    
3. We are constantly trying to improve our Services, and may need to change these Terms of Service. We reserve the right to change the Terms of Service at any time, in our sole discretion, but if we do, we will bring it to your attention by placing a notice on the Site and/or sending you an electronic mail. If you don’t agree with the new Terms of Service, you are free to reject them; unfortunately, that means you will no longer be able to use the Services. If you use the Services in any way after a change to the Terms is effective, that means you agree to all of the changes.  
...
5. Certain Services may be subject to applicable United States export laws and regulations. You shall comply with all export laws and restrictions and regulations of the Department of Commerce, the United States Department of Treasury Office of Foreign Assets Control (“OFAC”), or other United States or foreign agency or authority, and you shall not export, or allow the export or re-export of the Software in violation of any such restrictions, laws or regulations. By downloading or using the App or any other Services, you agree to the foregoing and represent and warrant that you are not located in, under the control of, or a national or resident of any United States-embargoed or restricted country.  
    
6. We also reserve the right to access, read, preserve, and disclose any information as we believe is necessary to (i) satisfy any applicable law, regulation, legal process or governmental request, (ii) enforce these Terms of Service, including investigation of potential violations hereof, (iii) detect, prevent, or otherwise address fraud, security or technical issues, (iv) respond to user support requests, or (v) protect the rights, property or safety of us, our users and the public.  
...
7. **Auto-Renewal for Membership Services**. Unless you opt out of auto-renewal, which can be done by emailing [help@team.casa](mailto:help@team.casa), any Memberships you have signed up for will be automatically extended for successive renewal periods of the same duration as the subscription term originally selected, at the then-current non-promotional rate. To change or resign your Membership at any time, email [help@team.casa](mailto:help@team.casa). If you terminate a Membership (either by termination or opting out of auto-renewal), you may use your subscription until the end of your then-current term; your subscription will not be renewed after your then-current term expires. However, you won’t be eligible for a prorated refund of any portion of the subscription fee paid for the then-current subscription period. In the event you would like to reactivate your Membership, you will incur a reactivation fee as determined by us and you will be obligated to pay, in addition to the new subscription fee, the subscription fee for the period beginning on the date your Membership expired through the date of reactivation.  
...
9. **Free Trials and Other Promotions**. Casa may, in its sole discretion, offer you free introductory trial offerings to access any hardware, software, product, service, feature, functionality, or other technology that is either integrated with another offering or provided on a stand-alone basis by Casa and has been designated by Casa as part of a free trial (each, a “Trial Offering”).Each Trial Offering may be more fully described in documentation or other materials provided to you by Casa when you sign up or register for such Trial Offering or otherwise made available to you during the term of any such Trial Offering (a “Trial Offering Period”). Trial Offerings will automatically convert to Paid Services following the end of any Trial Offering Period. You acknowledge and agree that your use of the Trial Offering is subject to the Terms of Service. Casa does not provide and is not obligated to provide any maintenance or technical support for any Trial Offering during any Trial Offering Period. Casa reserves the right to modify, abandon, or impose any limitations on the use of any Trial Offering at any time, with or without notice, and without any obligation or liability. Any rules, policies, limitations, or procedures presented to you in connection with a Trial Offering shall govern such free trial and promotional offer and shall be incorporated into these Terms of Service. The Trial Offering Period commences as of the earliest date you first sign up for, register for, access, or use the Trial Offering and continues until (i) your Trial Offering automatically converts to Paid Services at the conclusion of the Trial Offering Period; (ii) you convert the Trial Offering to Paid Services during the Trial Offering Period; (iii) your access or use expires or otherwise ceases automatically, which normally will occur within 30 calendar days of the commencement of the Trial Offering if you have cancelled the Trial Offering during the Trial Offering Period; or (iv) either party terminates this Agreement as set forth below. Casa may terminate this Agreement at any time, with or without cause, upon delivery of written notice to you. You may terminate a Trial Offering at any time, with or without cause, by delivering at least thirty (30) days prior written notice to Casa or by terminating the Trial Offering via the site or in-app. Upon any termination of the Trial Offering by either party, your use of and access to the Trial Offering shall terminate at the end of the Trial Offering’s scheduled termination. Any access to a Paid Service via a Trial Offering must be used within the Trial Offering Period and may only be used once by any person or entity; using multiple e-mail addresses or online identities to circumvent this restriction is prohibited. You must cancel the Trial Offering before the end of any Trial Offering Period in order to prevent the Trial Offering from converting to an automatically-renewing Paid Service at the conclusion of the Trial Offering Period. If you cancel prior to the end of the Trial Offering Period and are inadvertently charged for a Paid Service, please contact us at [help@team.casa](mailto:help@team.casa).  
...
2. **Pricing**. Prices do not include any shipping and handling charges, or taxes, which will be noted in the payment terms presented to you during the checkout process.  
...
4. **Returns, Refunds, and Fees**. Please review our policy [here](https://keys.casa/refund-policy), which are incorporated into these Terms of Service by reference.  
    
5. **Customer Service**. If you have any questions about a particular Product, or you have questions about shipping, returns, or refunds, please contact us at [help@team.casa](mailto:help@team.casa).  
    

### **10\. For Premium (formerly “Platinum”) and Private Client (formerly “Diamond”) Account Members – Account Access by Third Parties**   

**​​Casa may permit you to sign up for a Membership jointly with another person (each such Membership, a “Shared Account”). Each member who has a Shared Account (each, a “Shared Account Member”), without the consent of the other Shared Account Member, may, and hereby is authorized by the other Shared Account Member, to conduct any transaction permitted under these Terms, the Membership, and any other agreement with Casa. Casa may require Shared Account Members to create separate usernames and passwords to access the Account associated with the Shared Account. By signing up for a Shared Account, you acknowledge and agree that on your death, the surviving Shared Account Member shall have sole rights to access the Account and will become the sole member with respect to the Shared Account, and Casa will not grant access to your Account to any other person on account of your death, including but not limited to your estate representative. If one or both Shared Account Members no longer wish to maintain a Shared Account, you must notify Casa in writing by emailing** [**help@team.casa**](mailto:help@team.casa)**, and Casa may require both Shared Account Members consent in writing to the addition, removal or replacement of any Shared Account Member to or from the Shared Account. All shared Account Members, jointly and severally, are liable for all transactions, changes, additions or cancellation of an Account or Membership, and for any charges, fees, losses or liabilities incurred for any transaction, change, addition or cancellation of an Account or Membership regardless of which member conducted or benefited from the transaction, change, addition or cancellation.  
**

### 11\. **For Private Client (formerly “Diamond”) Account Members – Account Access by Third Parties**  

1. **U.S.-resident Casa Account Members**: If you are a Casa Private Client Account member residing in the U.S. and enrolled in our Inheritance Program, Casa will grant third parties access to your Casa Private Client account as follows:  
    

1. 1\. On your death, Casa will:  
    

1. grant access to your Casa account including your Recovery Key to the person (the “Recovery Custodian”) you designate in the Inheritance Application using the email address set forth in the Inheritance Application, provided that the Recovery Custodian (i) provides Casa with a certified copy of your death certificate and photo identification bearing a name that matches the name of the Recovery Custodian in your Inheritance Application; and (ii) verifies the email address in your Inheritance Application pursuant to Casa’s procedures for verification; and  
    
2. transfer the Casa account to the Recovery Custodian and assist in recovering the bitcoin, ether, USDT and/or USDC if they are able to provide the necessary items in the previously assembled inheritance envelope.  
    

1. 2\. We will grant access to an agent acting pursuant to a valid power of attorney executed by you, provided that such agent provides all information required by Casa, which may include (i) a request for access to your account from the agent in writing; (ii) an original of the power of attorney that gives the agent specific authority over your Casa account or general authority to act on your behalf; (iii) a certification by the agent, under penalty of perjury, that the power of attorney is in effect; (iv) verification of Casa account information by the agent, and (v) such other information required by Casa to grant access to the agent; and provided further, that Casa may require your agent to pay Casa fees for such access.  
    

1. 3\. You may change your Recovery Custodian at any time. It is your sole responsibility to ensure that the Recovery Custodian is a person whom you wish to have access and control of your Casa Private Client account in the event of your death, and Casa shall have no liability to you or any person or entity for any actions taken by the Recovery Custodian with respect to your Casa Private Client account, Recovery Key, bitcoin and/or ether vault(s) or bitcoin, ether, USDT and/or USDC assets. You agree to indemnify and hold Casa harmless from any and all losses, damages, liabilities, deficiencies, actions, judgments, interest, awards, penalties, fines, costs, or expenses of whatever kind, including reasonable attorneys' fees and the cost of enforcing any right to indemnification hereunder and the cost of pursuing any insurance providers which Casa may incur as a result of Casa’s reliance upon instructions from you, including but not limited to your instructions as to the Recovery Custodian in the Inheritance Application. This Section 11 shall be binding on your Recovery Custodians, executors, administrators, heirs, and assigns. At the current time, our Inheritance Program is available exclusively for individuals and is not available for corporate, company or other entity clients.  
    

**b.** **Mexico-resident Casa Account Members****: If you are a Casa Private Client Account member residing in Mexico and enrolled in our Inheritance Program, Casa will grant third parties access to your Casa Private Client account as follows:  
**
...
1. 2\. You may change your Recovery Custodian at any time. It is your sole responsibility to ensure that the Recovery Custodian is a person whom you wish to have access and control of your Casa Private Client account in the event of your death, and Casa shall have no liability to you or any person or entity for any actions taken by the Recovery Custodian with respect to your Casa Private Client account, Recovery Key, bitcoin and/or ether vault(s) or bitcoin and/or ether assets. You agree to indemnify and hold Casa harmless from any and all losses, damages, liabilities, deficiencies, actions, judgments, interest, awards, penalties, fines, costs, or expenses of whatever kind, including reasonable attorneys' fees and the cost of enforcing any right to indemnification hereunder and the cost of pursuing any insurance providers which Casa may incur as a result of Casa’s reliance upon instructions from you, including but not limited to your instructions as to the Recovery Custodian in the Inheritance Application. This Section 11 shall be binding on your Recovery Custodians, executors, administrators, heirs, and assigns. At the current time, our Inheritance Program is available exclusively for individuals and is not available for corporate, company or other entity clients.  
    

### 12\. For Premium (formerly “Platinum”) and Private Client (formerly “Diamond”) Account Members – Account Access by Third Parties  

**If you are a Casa Premium or Private Client Account member, Casa will grant third parties access to your Casa Premium or Private Client account as follows:  
**

1. on your death, we will grant access to your Casa account including your Recovery Key to your estate representative, provided that the estate representative provides all information required by Casa, which may include (i) a request for access to your account from the estate representative in writing, (ii) a certified death certificate, (iii) a certified copy of the letter of appointment or small-estate affidavit or court order, in Casa’s sole discretion, (iv) verification of Casa account information by your estate representative, and (v) such other information required by Casa to grant access to the estate representative; and provided further, that Casa may require your estate representative to pay Casa service fees for such access; and  
    
2. we will grant access to your Casa account including your Recovery Key to an agent acting pursuant to a valid power of attorney executed by you, provided that such agent provides all information required by Casa, which may include (i) a request for access to your account from the agent in writing, (ii) an original of the power of attorney that gives the agent specific authority over your Casa account or general authority to act on your behalf; (iii) a certification by the agent, under penalty of perjury, that the power of attorney is in effect; (iv) verification of Casa account information by the agent, and (v) such other information required by Casa to grant access to the agent; and provided further, that Casa may require your agent to pay Casa service fees for such access.  
    
3. For the avoidance of doubt, Account Access by Third Parties is only offered on a case by case basis based on certain verification requirements in Casa’s sole discretion. This service is not offered for members who are not Premium or Private Client Account holders. Any exceptions will be made on a case by case basis in Casa’s sole discretion.  
    

**This Section 12 shall be binding on your executors, administrators, heirs, and assigns.  
**
...
2. If you are a natural person, the App is licensed to you on a limited, non-exclusive, non-transferrable, non-sublicensable basis, solely to be used in connection with the Services for your private, personal, non-commercial use, subject to all the terms and conditions of these Terms as they are applicable to the Services;  
    
3. If you are an entity, the App is licensed to your entity on a limited, non-exclusive, non-transferrable, non-sublicensable basis, solely to be used in connection with the Services for your entity’s internal use, subject to all the terms and conditions of these Terms as they are applicable to the Services;  
    
4. You will only use the App in connection with an Apple device that you own or control;  
    
5. You acknowledge and agree that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the App;  
    
6. In the event of any failure of the App to conform to any applicable warranty, including those implied by law, you may notify Apple of such failure; upon notification, Apple’s sole warranty obligation to you will be to refund to you the purchase price, if any, of the Application;  
    
7. You acknowledge and agree that Casa, and not Apple, is responsible for addressing any claims you or any third party may have in relation to the App;  
...
**TO THE FULLEST EXTENT ALLOWED BY APPLICABLE LAW, IN NO EVENT SHALL WE, NOR OUR DIRECTORS, EMPLOYEES, AGENTS, PARTNERS, SUPPLIERS OR CONTENT PROVIDERS, BE LIABLE UNDER CONTRACT, TORT, STRICT LIABILITY, PRODUCT LIABILITY, NEGLIGENCE OR ANY OTHER LEGAL OR EQUITABLE THEORY WITH RESPECT TO THE SERVICES OR PRODUCTS (I) FOR ANY LOST PROFITS, DATA LOSS, COST OF PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, OR SPECIAL, INDIRECT, INCIDENTAL, PUNITIVE, COMPENSATORY OR CONSEQUENTIAL DAMAGES OF ANY KIND WHATSOEVER (HOWEVER ARISING), (II) FOR ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE (REGARDLESS OF THE SOURCE OF ORIGINATION), OR (III) FOR ANY DIRECT DAMAGES IN EXCESS OF (IN THE AGGREGATE) OF the greater of (A) AS APPLICABLE, (1) fees paid to us for the particular Services during the immediately previous three (3) month period or (2) AMOUNTS paid to us for products purchased through the services that constitute the subject matter of the claim, or (B) $500.00.  
**
...
**  
Contact****. You may contact us at the following address: 1580 N. Logan St. Ste 660, PMB 78958, Denver, CO 80203-1942, United States  
  
****Effective Date of Terms of Service: October 24, 2023**
