...
Unless otherwise stated, all intellectual property rights in all material on AnyBookPDF are owned by AnyBookPDF and/or its licensors. All rights to intellectual property are reserved. You may use this for your own personal use from AnyBookPDF, subject to the restrictions set forth in these terms and conditions.

You must not:

* Republish material from AnyBookPDF
* Sell, rent or sub-license material from AnyBookPDF
* Reproduce, duplicate or copy material from AnyBookPDF
* Redistribute content from AnyBookPDF

Parts of this website allow users to post and exchange thoughts and information in designated places. Prior to their appearance on the Internet, AnyBookPDF does not filter, edit, publish or review Comments. The thoughts and opinions expressed in the comments do not reflect those of AnyBookPDF, its agents, or affiliates. The views and opinions expressed in comments reflect the views and opinions of the individual who posted them. AnyBookPDF shall not be liable for the Comments or for any liabilities, damages, or expenses caused and/or suffered as a result of the use of and/or posting of and/or appearance of the Comments on this website, to the extent permitted by applicable laws.

AnyBookPDF has the right to review all Comments and to remove any Comments that are inappropriate, offensive, or violate our Terms and Conditions.

You warrant and represent that:

* You have the essential rights and consents to post the Comments on our website, and you have been given permission to do so.
* No third-party intellectual property rights, such as copyright, patents, or trademarks, are infringed upon by the Comments.
* In the Comments, there is no defamatory, libellous, offensive, indecent, or otherwise unlawful content that constitutes a privacy invasion.
...
You hereby grant AnyBookPDF a non-exclusive license to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, and edit any of your Comments in any form, format, or media.
...
* Except for soliciting non-profit organisations, charity shopping malls, and charity fundraising clubs, which are not permitted to link to our website.
...
There will be no use of the AnyBookPDF logo or any artwork for linking without a trademark license agreement.
...
We offer no assurances that the information on this website is correct, complete, or accurate, or that the website will be available, or that the material on the website will be kept up to date.
...
* minimise or eliminate our or your responsibility in the case of death or personal injury
